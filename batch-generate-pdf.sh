...
npx docusaurus-prince-pdf -u http://localhost:4000/browser/introduction --prince-args="--page-size='a4' --page-margin='10mm'" -o ./pdf/whatap-browser-monitoring.pdf --include-index
