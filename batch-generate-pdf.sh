...
npx docusaurus-prince-pdf -u https://localhost:4000/openapi --prince-args="--page-size='a4' --page-margin='10mm'" -o ./static/pdf/whatap-open-api.pdf --dest ./static/pdf --include-index
...
# npx docusaurus-prince-pdf -u https://docs.whatap.io/release-notes/focus/focus-release-notes --prince-args="--page-size='a4' --page-margin='10mm'" -o ./static/pdf/release-notes/focus-release-notes.pdf --dest ./static/pdf/release-notes --include-index --selector 'none'
