...
# npx docusaurus-prince-pdf -u http://localhost:4000/best-practice-guides/about-apm-dbc --prince-args="--javascript --page-size='a4' --page-margin='10mm'" -o ./static/pdf/whatap-best-practice-guides-about-apm-dbc.pdf --dest ./static/pdf --include-index

# npx docusaurus-prince-pdf -u http://localhost:4000/best-practice-guides/using-browser-monitoring --prince-args="--javascript --page-size='a4' --page-margin='10mm'" -o ./static/pdf/whatap-best-practice-guides-using-browser-monitoring.pdf --dest ./static/pdf --include-index

# npx docusaurus-prince-pdf -u http://localhost:4000/best-practice-guides/about-apm-dashboard --prince-args="--javascript --page-size='a4' --page-margin='10mm'" -o ./static/pdf/whatap-best-practice-guides-about-apm-dashboard.pdf --dest ./static/pdf --include-index

# npx docusaurus-prince-pdf -u http://localhost:4000/best-practice-guides/about-server-dashboard --prince-args="--javascript --page-size='a4' --page-margin='10mm'" -o ./static/pdf/whatap-best-practice-guides-about-server-dashboard.pdf --dest ./static/pdf --include-index

# npx docusaurus-prince-pdf -u http://localhost:4000/best-practice-guides/about-apm-hitmap-class --prince-args="--javascript --page-size='a4' --page-margin='10mm'" -o ./static/pdf/whatap-best-practice-guides-about-apm-hitmap-class.pdf --dest ./static/pdf --include-index

# npx docusaurus-prince-pdf -u http://localhost:4000/release-notes/browser/browser-v1_3_1 --prince-args="--javascript --page-size='a4' --page-margin='10mm'" -o ./static/pdf/release-notes/browser-agent-v1.3.1.pdf --dest ./static/pdf/release-notes --include-index --selector 'none'
