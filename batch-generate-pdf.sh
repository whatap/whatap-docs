...
npx docusaurus-prince-pdf -u http://localhost:4000/docs/amazon-ecs/introduction --prince-args="--page-size='a4' --page-margin='10mm'" -o ./pdf/whatap-amazon-ecs.pdf --include-index
...
# npx docusaurus-prince-pdf -u http://localhost:4000/docs/best-practice-guides/about-apm-hitmap-class --prince-args="--page-size='a4' --page-margin='10mm'" -o ./pdf/whatap-best-practice-guides-about-apm-hitmap-class.pdf --include-index
