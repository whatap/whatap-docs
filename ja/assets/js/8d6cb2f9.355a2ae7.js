"use strict";
(self["webpackChunkwhatap_origin"] = self["webpackChunkwhatap_origin"] || []).push([[16767],{
...
const metadata = {
    ...
    "title": "アクティブトランザクション",
    "description": "現在のトランザクションのURL、SQL、HTTP呼び出し情報で異常トランザクションをすばやく特定し、詳細なトレースを通じて遅延間隔を詳細に分析できます。",
    "source": "@site/i18n/ja/docusaurus-plugin-content-docs/current/golang/dashboard-active-transaction.mdx",
    ...
    "next": {
        "title": "Flexボード",
        "permalink": "/ja/golang/flex-board"
    }
};
const assets = {};
const toc = [
