"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[90255],{
...
const metadata = {
  ...
  "title": "警告通知の受信設定",
  "description": "プロジェクトに含まれるメンバーの警告通知の受信に関連した各種機能を設定できます。",
  "source": "@site/i18n/ja/docusaurus-plugin-content-docs/current/log/set-receive-event.mdx",
  "sourceDirName": "log",
  "slug": "/log/set-receive-event",
  "permalink": "/ja/log/set-receive-event",
  "draft": false,
  "unlisted": false,
  ...
  "previous": {
    "title": "アラート通知",
    "permalink": "/ja/log/set-notice"
  },
  "next": {
    "title": "イベント履歴",
    "permalink": "/ja/log/set-event-history"
  }
};
const assets = {
