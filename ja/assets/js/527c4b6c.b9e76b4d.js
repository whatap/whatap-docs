"use strict";
(self["webpackChunkwhatap_origin"] = self["webpackChunkwhatap_origin"] || []).push([[94832],{
...
const metadata = {
    ...
    "title": "メトリックス",
    "description": "データベースモニタリング分析のメトリクスメニューについて学習します。",
    "source": "@site/i18n/ja/docusaurus-plugin-content-docs/current/postgresql-v1/metrics-intro.mdx",
    "sourceDirName": "postgresql-v1",
    "slug": "/postgresql-v1/metrics-intro",
    "permalink": "/ja/postgresql-v1/metrics-intro",
    "draft": false,
    ...
    "previous": {
        "title": "データベースパラメータ参照",
        "permalink": "/ja/postgresql-v1/analysis-databaseparameter"
    },
    "next": {
        "title": "PostgreSQLメトリクス",
        "permalink": "/ja/postgresql-v1/metrics-data-list"
    }
};
const assets = {};
