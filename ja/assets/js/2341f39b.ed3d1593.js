"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[99203],{
...
const metadata = {
  ...
  "title": "Kubernetesモニタリングの動作環境",
  "description": "Kubernetesモニタリングを開始する前に、動作環境について確認してください。",
  "source": "@site/i18n/ja/docusaurus-plugin-content-docs/current/kubernetes/supported-spec.mdx",
...
function _createMdxContent(props) {
  ...
  return (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.Fragment, {
    children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.p, {
      children: "Kubernetesモニタリングを開始する前に、次の対応事項を確認してください。WhaTap Kubernetesは、標準Kubernetes1.16~1.28バージョン及びそのバージョンに対応する次のKubernetes環境でインストールできます。"
