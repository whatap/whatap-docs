"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[66650],{
...
const metadata = {
  ...
  "title": "アラートメッセージユーザーの定義",
  "description": "プロジェクトメンバーに送信されるアラート通知メッセージを修正できるユーザー定義機能を提供します。",
  "source": "@site/i18n/ja/docusaurus-plugin-content-docs/current/python/set-notification-message.mdx",
  "sourceDirName": "python",
  "slug": "/python/set-notification-message",
  "permalink": "/ja/python/set-notification-message",
  "draft": false,
  "unlisted": false,
  ...
  "previous": {
    "title": "メトリクスアラートの通知",
    "permalink": "/ja/python/metric-warning-notice"
  },
  "next": {
    "title": "AIを利用したのヒットマップパターンのアラート通知",
    "permalink": "/ja/python/hitmap-notice"
  }
};
const assets = {
