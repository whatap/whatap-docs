"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[94046],{
...
const metadata = {
  ...
  "title": "インスタンスリスト",
  "description": "エージェントをインストールしたRedisデータベースサーバーの一覧を確認できます。",
  "source": "@site/i18n/ja/docusaurus-plugin-content-docs/current/redis/instance-list.mdx",
  "sourceDirName": "redis",
  "slug": "/redis/instance-list",
  "permalink": "/ja/redis/instance-list",
  "draft": false,
  "unlisted": false,
  ...
  "previous": {
    "title": "ダッシュボード",
    "permalink": "/ja/redis/dashboard-intro"
  },
  "next": {
    "title": "インスタンスモニタリング",
