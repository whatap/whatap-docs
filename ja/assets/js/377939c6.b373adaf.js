"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[2222],{
    ...
    children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.ul, {
      children: ["\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.li, {
        children: ["\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.p, {
          children: ["各ウィジェットで右上の ", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.img, {
            alt: "詳細アイコン",
            src: (__webpack_require__(71543)/* ["default"] */ .A) + "",
            width: "24",
            height: "24"
          }), "ボタンをクリックして、ウィジェットデータを全画面サイズで表示できます。"]
        }), "\n"]
      }), "\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.li, {
        children: ["\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.p, {
          children: ["ウィジェットの右上にある ", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.img, {
            ...
            width: "20",
            height: "20"
          }), "ボタンをクリックすると、チャート設定画面が表示されます。 チャートに表示するオプションを設定できます。"]
        }), "\n"]
      }), "\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.li, {
        children: ["\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.p, {
          children: ["ウェブブラウザーの画面サイズによってウィジェット右上のアイコンの表示が異なる場合があります。 ", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.img, {
            alt: "もっと見るアイコン",
            src: (__webpack_require__(22829)/* ["default"] */ .A) + "",
            width: "24",
            height: "24"
          }), "ボタンを選択すると、追加アイコンが表示できます。"]
        }), "\n"]
      }), "\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.li, {
        children: ["\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.p, {
          children: ["ウィジェット設定の詳細については ", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.a, {
...
/* harmony import */ var _dashboard_note_mdx__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(87726);
...
function _createMdxContent(props) {
  ...
  return (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.Fragment, {
    children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.p, {
      ...
      children: "リアルタイムデータと過去のデータを表示できるダッシュボードです。 ブラウザーアプリケーションのユーザー体験と性能をモニタリングします。 性能指標やブラウザー、地域など、様々な側面からデータを提供することで、状態の異常をすばやく特定できます。 また、ページロードイベントとAJAXイベントの性能データも提供します。"
    }), "\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.p, {
      children: "リアルタイムの統計データをチャート型ウィジェットで構成したダッシュボードです。 ページロード中心の統計データとウェブブラウザーで発生するAJAXデータをリアルタイムで確認できます。"
      ...
      children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.h2, {
        ...
        children: "ブラウザーアプリケーションの全体ページロード性能の情報を提供します。 ページロード時間と読み込み段階別プロセスを平均時間で示します。 これにより、ブラウザーアプリケーションの全体的な性能を把握できます。"
      }), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.p, {
        children: "各詳細段階の説明については、次を参照してください。"
      ...
      children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.h2, {
        id: "ページロード時間と読み込み数",
        children: "ページロード時間と読み込み数"
      }), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(ImgLang, {
        img: "browser-pageload-time-num.png",
        desc: "Page load widget"
      }), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.p, {
        children: "エンドユーザーがブラウザーアプリケーションを使用してウェブページにアクセスすると、各ページを読み込みにかかる時間と頻度をリアルタイムで確認できます。 この情報により、開発者はアクセス量の多いページと読み込み速度の遅いページを特定し、改善が必要なページに優先順位を付けることができます。"
      }), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.p, {
        children: "例えば、多くのユーザーがアクセスするページロードに時間がかかる場合、開発者はそのページの性能を改善することに集中できます。 逆に、読み込み速度が遅いページの接続量が大きくない場合、開発者はそのページの改善より、他のページを改善することに集中する方が効率的です。"
      }), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.admonition, {
        type: "note",
        children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.p, {
          children: ["全体の状態を確認するには、右上の", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.strong, {
            children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.em, {
              children: "ページグループ"
            })
          }), "を選択してください。 メトリクス一覧で", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.strong, {
            children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.em, {
              children: "全体"
            })
          }), "を選択してください。"]
        ...
        children: ["\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.li, {
          children: ["\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.p, {
            children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.strong, {
              children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.em, {
                children: "平均ページロード時間TopN"
              })
            })
          }), "\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.p, {
            children: "平均ページロード時間をページグループごとに表示します。 横棒チャートは、表示時間中に発生したページグループごとの読み込み時間の平均です。 上位8つまで表示されます。"
          }), "\n"]
        }), "\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.li, {
          children: ["\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.p, {
            children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.strong, {
              children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.em, {
                children: "ページロード数TopN"
              })
            })
          }), "\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.p, {
            children: "ページロード数をページグループごとに表示します。 横棒チャートは、表示時間中に発生したページグループごとの読み込み数の合計です。 上位8つまで表示されます。"
          }), "\n"]
        }), "\n"]
      })]
    }), "\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.section, {
      ...
      children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.h2, {
        ...
        }), "は、時間の経過に伴うページロードの応答時間を分布図チャートで表現します。"]
      }), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.ul, {
        children: ["\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.li, {
          children: ["\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.p, {
            children: "横軸はページロードイベントの終了時間、縦軸はページロードイベントの経過時間です。"
          }), "\n"]
        }), "\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.li, {
          children: ["\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.p, {
            children: "通常のページロードイベントは、→青色→藍色の順で表現します。"
          }), "\n"]
        }), "\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.li, {
          children: ["\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.p, {
            children: "エラー発生ページロードイベントは、黄色→オレンジ→赤色の順で表現します。 エラーページロードイベントは、ページロード中にブラウザーエラーが発生した場合です。"
          }), "\n"]
        }), "\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.li, {
          children: ["\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.p, {
            children: ["詳細を確認するには、チャートの特定の領域をドラッグしてください。 ", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.strong, {
              children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.em, {
                children: "ページロード詳細"
              })
            }), "ウィンドウが表示され、ドラッグした領域の読み込みイベントに関する詳細を確認できます。 関連する詳細については、", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.a, {
      ...
      children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.h2, {
        id: "ページ別メッセージ別エラー件数",
        children: "ページ別、メッセージ別エラー件数"
      }), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(ImgLang, {
        img: "browser-error-num.png",
        desc: "Error count"
      }), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.p, {
        children: "エンドユーザーがブラウザーアプリケーションの使用中に発生したブラウザーエラーを表示します。 ページごとに発生したエラーとエラーメッセージごとに表示します。 これにより、通常エラーが発生するページとエラーに関する内容をすばやく特定できます。"
      }), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.ul, {
        children: ["\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.li, {
          children: ["\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.p, {
            children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.strong, {
            ...
            children: "各ページで発生したすべてのエラー件数をページごとに表示します。 チャートにカーソルを合わせると、ページグループのエラー件数をツールチップ形式で確認できます。"
          }), "\n"]
        }), "\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.li, {
          children: ["\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.p, {
            children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.strong, {
              children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.em, {
                children: "エラーメッセージ別エラー件数"
              })
            })
          }), "\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.p, {
            children: "コンソールエラーではなく、ソースエラーおよびAJAXエラーに関するメッセージを表示します。 横棒チャートは、検索時に発生したエラーメッセージごとのエラー数の合計です。 上位8つまで表示されます。"
          }), "\n"]
        }), "\n"]
      })]
    }), "\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.section, {
      ...
      children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.h2, {
        id: "ユーザーセッション数ユーザーセッション",
        children: "ユーザーセッション数、ユーザーセッション"
      }), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(ImgLang, {
        img: "browser-user-session.png",
        desc: "User sessions"
      }), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.p, {
        children: "ブラウザーアプリケーションに接続したユーザーセッションの数をリアルタイムでモニタリングできます。 これにより、ブラウザーアプリケーションの使用量を把握できます。 セッション数が急激に増加する場合は、ユーザー数が増加したことを意味します。 一方、セッション数が減少した場合、ユーザーがアプリケーションを使用していないか、不快なエクスペリエンスを経験している可能性があります。"
      }), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.p, {
        children: "ユーザーセッションウィジェットと他のウィジェットを一緒に使用すると、アプリケーションの使用状況を総合的に把握できます。"
      }), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.ul, {
        children: ["\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.li, {
          children: ["\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.p, {
            children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.strong, {
            ...
            children: "表示時間を基準に重複削除したユーザーセッションの合計数を表示します。"
          }), "\n"]
        }), "\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.li, {
          children: ["\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.p, {
            children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.strong, {
            ...
            children: ["5秒、5分、1時間の間隔で重複していないユーザーセッションの数を表示します。 ウィジェット右上にある", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.img, {
              alt: "詳細表示アイコン",
              src: (__webpack_require__(22829)/* ["default"] */ .A) + "",
              width: "24",
              height: "24"
      ...
      children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.h2, {
        id: "平均ajaxレスポンス時間topn",
        children: "平均AJAXレスポンス時間TopN"
      }), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(ImgLang, {
        img: "browser-ajax-response-time.png",
        desc: "AJAX response time"
      }), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.p, {
        children: ["ブラウザーアプリケーションは、AJAXを通じてレンダリングに必要なデータを送受信します。 ページロード後もAJAXが発生し続けるページでは、AJAXの読み込みがブラウザーアプリケーションのユーザー体験において重要な指標になる可能性があります。 ", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.strong, {
          children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.em, {
            children: "平均AJAXレスポンス時間TopN"
          })
        }), "ウィジェットは、エンドユーザーがブラウザーアプリケーションを使用するときに発生するAJAXの平均レスポンス時間です。"]
      }), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.ul, {
        children: ["\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.li, {
          children: ["\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.p, {
            children: ["AJAXリクエストpath別にチャートを提供し、リクエストホスト別、リクエストページ別、全体平均基準で選択して確認することができます。 ウィジェット右上にある", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.img, {
              alt: "詳細表示アイコン",
              src: (__webpack_require__(22829)/* ["default"] */ .A) + "",
              width: "24",
              height: "24"
          ...
          children: ["\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.p, {
            children: ["デフォルトでは、参照時間別の上位10個のデータが表示されます。 データ個数を変更するには、ウィジェットの右上にある", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.img, {
              alt: "その他のアイコン",
              src: (__webpack_require__(22829)/* ["default"] */ .A) + "",
              width: "24",
              height: "24"
      ...
      children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.h2, {
        ...
        children: "AJAXエラーは、ステータスコードが400以上であるか、リクエストが失敗したためにキャンセルされたことを意味します。 ブラウザーアプリケーションで発生するAJAXエラー件数は、fetchまたはxhrタイプに分類して表示されます。"
      })]
    }), "\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.section, {
      className: "remark-sectionize-h2",
      children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.h2, {
        ...
        children: "ブラウザーアプリケーションで発生したAJAXリクエストをヒットマップチャート形式で提供し、各リクエストに対する詳細情報はテーブル形式で確認できます。 各AJAXを分析して性能異常の原因を特定できます。"
      }), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.admonition, {
        type: "note",
        children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.p, {
      ...
      children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.h3, {
        ...
        children: "AJAXヒットマップは、時間の経過に伴うAJAXリクエストのレスポンス時間を分布図チャートで表示します。"
      }), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.ul, {
        children: ["\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.li, {
          children: ["\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.p, {
            children: "横軸はAJAX終了時間、縦軸はAJAX読み込み時間です。"
          }), "\n"]
        }), "\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.li, {
          children: ["\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.p, {
            children: "正常のAJAXは、空色→青色→藍色の順で表現します。"
          }), "\n"]
        }), "\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.li, {
          children: ["\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.p, {
            children: ["エラーAJAXは、黄色→オレンジ→赤色の順で表現します。 ステータスコードが400の場合です。 チャートからエラーのみ確認する場合は、ウィジェットの右上にある", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.strong, {
              children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.em, {
                children: "エラー"
              })
            }), "ボタンを選択します。"]
          ...
          children: ["\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.p, {
            ...
            }), "ボタンがアクティブな場合、Y軸の最大値が分布図によって自動的に変更されます。 y軸を固定するには、", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.strong, {
              children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.em, {
                children: "Y軸自動"
              })
            }), "ボタンを選択して無効にします。"]
          ...
          children: ["\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.p, {
            children: ["詳細を確認するには、チャートの特定の領域をドラッグしてください。 ドラッグした領域のAJAXイベント一覧と詳細情報が確認できる", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(Cmdname, {
              sid: "ajax",
              className: "uitext"
      ...
      children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.h3, {
        ...
        children: "各 AJAX には、次の情報が含まれています。"
      }), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.ul, {
        children: ["\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.li, {
          children: ["\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.p, {
            children: "Ajax URL"
          ...
          children: ["\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.p, {
            children: "AJAX 要求を行ったページの URL"
          }), "\n"]
        }), "\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.li, {
          children: ["\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.p, {
            children: "ブラウザー、機器、OS環境情報"
          }), "\n"]
        }), "\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.li, {
          children: ["\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.p, {
            children: "エラーメッセージ情報"
      ...
      children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.h2, {
        id: "地域別ページロード時間とカウント",
        children: "地域別ページロード時間とカウント"
      }), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(ImgLang, {
        img: "browser-pageload-map.png",
        desc: "Pageload map"
      }), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.p, {
        children: "ブラウザアプリケーションのリージョン別のページロード時間とページロード数をマップチャートとテーブルで表現します。 地域ごとにウェブサイトの性能を簡単に比較できます。 ページロード時間は2秒間隔で凡例が表示され、ページロード数は、50、75、90、95の%間隔で凡例が表示されます。"
      }), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.p, {
        children: "照会時間に基づいて、ページロード数が最も多い国をウィジェットにデフォルトで表示します。"
      }), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.ul, {
        children: ["\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.li, {
          children: ["\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.p, {
      ...
      children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.h2, {
        id: "ブラウザ別ページロード",
        children: "ブラウザ別ページロード"
      }), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(ImgLang, {
        img: "browser-pageload-by-browser.png",
        desc: "Pageload by browser"
      }), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.p, {
        children: ["ブラウザーアプリケーションごとのページロード時間とページロード数を提供します。 ブラウザーごとの性能を簡単に比較できます。 ", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.strong, {
          children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.em, {
            children: "ページロード時間"
          })
        ...
        }), "にデータを変更するには、ウィジェットの右上にある", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.img, {
          alt: "もっと見るアイコン",
          src: (__webpack_require__(22829)/* ["default"] */ .A) + "",
          width: "24",
          height: "24"
        }), "ボタンを選択し、メトリクスボタンを選択してください。"]
      })]
    }), "\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.section, {
      className: "remark-sectionize-h2",
      children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.h2, {
        id: "コアウェブバイタル指標",
        children: "コアウェブバイタル指標"
      }), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.p, {
        children: "コアウェブバイタル(Core Web Vitals)は、グーグルが定義するユーザー体験に影響を与える様々な指標の中でウェブサイトの性能に関する3つの重要な指標です。 各指標は、Webサイトの読み込み方法とユーザーの操作方法に応じて異なる方法で表示されます。"
      }), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.ul, {
        children: ["\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.li, {
          children: ["\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.p, {
            children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.strong, {
              children: "最大視覚コンテンツの表示時間"
            }), "(", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.strong, {
              children: "Largest Contentful Paint"
            }), ")：ウェブサイトの最大コンテンツ要素が読み込まれる時間を意味する指標です。"]
          }), "\n"]
        }), "\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.li, {
          children: ["\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.p, {
            children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.strong, {
              children: "初回の入力までの遅延時間"
            }), "(", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.strong, {
              children: "First Input Delay"
            }), ")：ウェブサイトが読み込まれて、ユーザーが最初の入力を行うまでにかかる時間です。"]
          }), "\n"]
        }), "\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.li, {
          children: ["\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.p, {
            children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.strong, {
            ...
            }), ")：ウェブサイトの読み込み中にレイアウトがどのくらいの頻度で変更するかを示す指標です。"]
          }), "\n"]
        }), "\n"]
      }), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.p, {
        children: "これらの測定値は、ウェブサイトの性能を評価および改善する上で重要な役割を果たします。 コア ウェブバイタル指標を理解して測定することは、ユーザー体験を改善し、ウェブサイトの性能を最適化する上で非常に役立ちます。"
      })]
    }), "\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.section, {
      className: "remark-sectionize-h3",
      children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.h3, {
        id: "最大のコンテンツフルペイントlargest-contentful-paint",
        children: "最大のコンテンツフルペイント(Largest Contentful Paint)"
      }), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(ImgLang, {
        img: "browser-lcp-widget.png",
        desc: "LCP"
      }), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.p, {
        children: "ページのグループごとに、コンテンツフルの最大ペイント時間の平均を表示します。 表示時間中に発生した各ページグループの上位8つのグループの最大コンテンツフルペイントの表示時間の平均が横棒チャートとして表示されます。"
      })]
    }), "\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.section, {
      className: "remark-sectionize-h3",
      children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.h3, {
        id: "初回入力までの遅延時間first-input-delay",
        children: "初回入力までの遅延時間(First Input Delay)"
      }), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(ImgLang, {
        img: "browser-cls-widget.png",
        desc: "FID"
      }), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.p, {
        children: "各ページグループの平均初回入力待ち時間を表示します。 チャートにカーソルと合わせると、そのページグループの時間値が表示されます。"
      })]
    }), "\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.section, {
      className: "remark-sectionize-h3",
      children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.h3, {
        id: "累積レイアウトシフト数cumulative-layout-shift",
        children: "累積レイアウトシフト数(Cumulative Layout Shift)"
      }), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(ImgLang, {
        img: "browser-fid-widget.png",
        desc: "CLS"
      }), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.p, {
        children: "各ページのグループごとの累積レイアウトシフト数を表示します。 チャートにカーソルと合わせると、そのページグループの値が表示されます。"
      })]
    })]
  });
}
