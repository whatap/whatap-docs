"use strict";
(self["webpackChunkwhatap_origin"] = self["webpackChunkwhatap_origin"] || []).push([[66560],{
...
const metadata = {
    ...
    "title": "TXマップ",
    "description": "TXマップとは、終了した個々のトランザクションの応答時間を分布図形式で表現したチャートです。",
    "source": "@site/i18n/ja/docusaurus-plugin-content-docs/current/golang/dashboard-transactionmap.mdx",
    ...
    "next": {
        "title": "アクティブトランザクション",
        "permalink": "/ja/golang/dashboard-active-transaction"
    }
};
const assets = {};
const toc = [
