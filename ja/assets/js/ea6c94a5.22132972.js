"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[88949],{
...
const metadata = {
  "id": "oracle-v1/warning-notice",
  "title": "データベースアラート通知",
  "description": "データベースのメトリクスごとのイベント条件設定を使用してアラート通知を送信します。",
  "source": "@site/i18n/ja/docusaurus-plugin-content-docs/current/oracle-v1/warning-notice.mdx",
  "sourceDirName": "oracle-v1",
  "slug": "/oracle-v1/warning-notice",
  "permalink": "/ja/oracle-v1/warning-notice",
  "draft": false,
  "unlisted": false,
  "editUrl": "undefined/docs/oracle-v1/warning-notice.mdx",
  "tags": [],
  "version": "current",
  "frontMatter": {
    "id": "warning-notice",
