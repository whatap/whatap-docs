"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[11307],{
...
;// CONCATENATED MODULE: ./i18n/ja/docusaurus-plugin-content-docs/current/common-items/_log-basics-default.mdx
...
function _createMdxContent(props) {
  ...
  return (0,jsx_runtime.jsx)(_components.p, {
    children: "既存のエージェントにログ収集機能を追加しました。モニタリングエージェントがログファイルから追加で出力されたログを読み取り読み取り収集する方法を利用します。"
  });
}
...
;// CONCATENATED MODULE: ./i18n/ja/docusaurus-plugin-content-docs/current/common-items/_log-basics.mdx
...
function _log_basics_createMdxContent(props) {
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsx)(ImgLang, {
      ...
      children: "一般的なログ統合サービスは収集機、処理機、ストレージ、UIモジュールで構成されています。段階別設定と構成作業が必要なため、それぞれのモジュールを構築する過程が煩わしく、追加費用が発生します。"
    }), "\n", (0,jsx_runtime.jsx)(_components.p, {
      children: "WhaTapログモニタリングは簡単に適用できます。既存のモニタリングエージェントがコレクターとして機能するため、エージェントオプションをオンにするだけでログモニタリングを開始できます。"
      ...
      children: [(0,jsx_runtime.jsxs)(TabItem/* default */.A, {
        ...
        children: [(0,jsx_runtime.jsxs)(_components.ul, {
          children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
            children: ["\n", (0,jsx_runtime.jsx)(_components.p, {
              children: "出力されたファイルからログを読まずに、Javaアプリケーションのログライブラリに渡されるログを直接収集します。"
            }), "\n"]
          }), "\n", (0,jsx_runtime.jsxs)(_components.li, {
            children: ["\n", (0,jsx_runtime.jsx)(_components.p, {
              children: "ログを直接収集するため、ファイルI／Oを引き起こさず、システムに与える性能への影響が非常に低いです。"
            }), "\n"]
          }), "\n", (0,jsx_runtime.jsxs)(_components.li, {
            children: ["\n", (0,jsx_runtime.jsx)(_components.p, {
              children: "トランザクショントレースとログの接続を追跡する特徴を確保し、トレースからログを確認できます。"
            }), "\n"]
          }), "\n"]
          ...
          children: [(0,jsx_runtime.jsx)(_components.mdxAdmonitionTitle, {}), (0,jsx_runtime.jsx)(_components.p, {
            children: (0,jsx_runtime.jsx)(_components.strong, {
              children: "Javaログのライブラリ"
            })
          }), (0,jsx_runtime.jsx)(_components.p, {
            children: "典型的なJavaログライブラリはApache Log4j、Logbackです。"
          })]
        }), (0,jsx_runtime.jsx)(_components.admonition, {
          type: "caution",
          children: (0,jsx_runtime.jsx)(_components.p, {
            children: "Java Agent2.1.1バージョンから使用できます。"
          })
        })]
        ...
        children: [(0,jsx_runtime.jsxs)(_components.ul, {
          ...
          type: "caution",
          children: (0,jsx_runtime.jsx)(_components.p, {
            children: "PHP Agent2.3.2バージョンから使用できます。"
          })
        })]
      }), (0,jsx_runtime.jsxs)(TabItem/* default */.A, {
        value: "python",
        ...
        children: [(0,jsx_runtime.jsxs)(_components.ul, {
          children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
            ...
            children: ["\n", (0,jsx_runtime.jsx)(_components.p, {
              children: "ログにトランザクションIDを出力すると、トランザクショントレースとログの接続追跡性を確保し、トレースからログを確認できます。"
            }), "\n"]
          }), "\n"]
        }), (0,jsx_runtime.jsx)(_components.admonition, {
          type: "caution",
          children: (0,jsx_runtime.jsx)(_components.p, {
            children: "Python Agent1.2.2バージョンから使用できます。"
          })
        })]
        ...
        children: [(0,jsx_runtime.jsxs)(_components.ul, {
          ...
          type: "caution",
          children: (0,jsx_runtime.jsx)(_components.p, {
            children: "Server Agent2.1.2バージョンから使用できます。"
          })
        })]
      }), (0,jsx_runtime.jsxs)(TabItem/* default */.A, {
        value: "k8s",
        ...
        children: [(0,jsx_runtime.jsxs)(_components.ul, {
          children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
            children: ["\n", (0,jsx_runtime.jsx)(_components.p, {
              children: "Kubernetesコンテナにログを収集できます。"
            }), "\n"]
          }), "\n", (0,jsx_runtime.jsxs)(_components.li, {
            children: ["\n", (0,jsx_runtime.jsx)(_components.p, {
              children: "Kubernetesコンテナ内のアプリケーションからログを収集できます。"
            }), "\n"]
          }), "\n"]
        }), (0,jsx_runtime.jsx)(_components.admonition, {
          type: "caution",
          children: (0,jsx_runtime.jsx)(_components.p, {
            children: "Kubernetes Agent1.1.35バージョンから使用できます。"
          })
        })]
      })]
    })]
...
;// CONCATENATED MODULE: ./i18n/ja/docusaurus-plugin-content-docs/current/log/log-function.mdx
...
function log_function_createMdxContent(props) {
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: ["\n", (0,jsx_runtime.jsx)(_components.p, {
      children: "WhaTapログモニタリングサービスを利用するための基本的な使用方法について説明します。WhaTapログモニタリングは、追加のエージェントを構成やログの構文解析を適用する必要はありません。簡単な設定で迅速に起動できます。"
    }), "\n", "\n", "\n", (0,jsx_runtime.jsxs)(_components.section, {
      className: "remark-sectionize-h2",
      children: [(0,jsx_runtime.jsx)(_components.h2, {
        id: "how-log-works",
        children: "ログモニタリングの動作原理"
      }), (0,jsx_runtime.jsx)(_log_basics_MDXContent, {})]
    }), "\n", (0,jsx_runtime.jsxs)(_components.section, {
      className: "remark-sectionize-h2",
      children: [(0,jsx_runtime.jsx)(_components.h2, {
        id: "ログモニタリングを適用する",
        children: "ログモニタリングを適用する"
      }), (0,jsx_runtime.jsx)(_components.p, {
        children: "使用するアプリケーションによって適用方法を次のように提供します。ログモニタリングを適用する前に対応バージョン](#how-log-works)を確認してください。"
      }), (0,jsx_runtime.jsxs)(_components.ol, {
        children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
          children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
            children: ["対応するエージェントのバージョンを確認し、", (0,jsx_runtime.jsx)(_components.strong, {
              children: "アップデート"
            }), "してください。"]
          }), "\n"]
        }), "\n", (0,jsx_runtime.jsxs)(_components.li, {
          children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
            children: ["ログモニタリング", (0,jsx_runtime.jsx)(_components.strong, {
              children: "オプション"
            }), "を設定してください。"]
          }), "\n"]
        }), "\n", (0,jsx_runtime.jsxs)(_components.li, {
          children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
            children: ["ログモニタリングを", (0,jsx_runtime.jsx)(_components.strong, {
              children: "有効"
            }), "にしてください。"]
          }), "\n"]
        }), "\n"]
