"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[80154],{
...
const metadata = {
  ...
  "title": "警告通知の受信設定",
  "description": "プロジェクトに含まれるメンバーの警告通知の受信に関連した各種機能を設定できます。",
  "source": "@site/i18n/ja/docusaurus-plugin-content-docs/current/amazon-cloudwatch/set-receive-event.mdx",
  "sourceDirName": "amazon-cloudwatch",
  "slug": "/amazon-cloudwatch/set-receive-event",
  "permalink": "/ja/amazon-cloudwatch/set-receive-event",
  "draft": false,
  "unlisted": false,
  ...
  "previous": {
    "title": "メトリクスアラートの通知",
    "permalink": "/ja/amazon-cloudwatch/metric-warning-notice"
  },
  "next": {
    "title": "イベント履歴",
    "permalink": "/ja/amazon-cloudwatch/set-event-history"
  }
};
const assets = {
