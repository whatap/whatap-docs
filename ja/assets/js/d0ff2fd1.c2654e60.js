"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[13786],{
...
const metadata = {
  ...
  "title": "ウィジェットの管理",
  "description": "Flexボードに配置したウィジェットの追加、属性の変更、コピー、削除方法を案内します。 ユーザーはウィジェットを追加するか、既存のウィジェットの属性を調整してダッシュボードをパーソナライズできます。 ウィジェットのデータ照会条件の変更、時間設定、データのマージオプションの設定など、細かい管理機能により、ユーザーのモニタリング要求に合わせたダッシュボードを構成できます。",
  "source": "@site/i18n/ja/docusaurus-plugin-content-docs/current/altibase-v1/flexboard-widget-manage.mdx",
