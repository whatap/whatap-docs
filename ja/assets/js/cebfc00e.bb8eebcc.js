"use strict";
(self["webpackChunkwhatap_origin"] = self["webpackChunkwhatap_origin"] || []).push([[34554],{
...
const metadata = {
    ...
    "title": "メトリクスチャート",
    "description": "メトリック データはグラフで表示できます。",
    "source": "@site/i18n/ja/docusaurus-plugin-content-docs/current/mysql-v1/metrics-chart.mdx",
...
function MDXContent(_param) {
    ...
    return /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)(MDXLayout, _object_spread_props(_object_spread({}, layoutProps, props), {
        ...
        parentName: "strong"
    }, `マトリックスチャート`)), `メニューでは、モニタリング対象から収集されたメトリックデータを次のようにチャートが表示することができます。時間と指標を指定することは必須です。`), /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)(_site_src_components_ChangeImgName_js__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .Z, {
