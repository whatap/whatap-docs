"use strict";
(self["webpackChunkwhatap_origin"] = self["webpackChunkwhatap_origin"] || []).push([[99717],{
...
const metadata = {
    "unversionedId": "php/hitmap-notice",
    "id": "php/hitmap-notice",
    "title": "AIを利用したのヒートマップパターンのアラート通知",
    "description": "アプリケーションの実行の分布パターンをマシンラーニングを通じて自動的に認識し、アラート通知を送信します。",
    "source": "@site/i18n/ja/docusaurus-plugin-content-docs/current/php/hitmap-notice.mdx",
    "sourceDirName": "php",
...
function MDXContent(_param) {
    ...
    return /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)(MDXLayout, _object_spread_props(_object_spread({}, layoutProps, props), {
        ...
        parentName: "strong"
    }, `ヒートマップパターン`))), /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("p", null, `アプリケーション実行の分布パターンをマシンラーニングを使用して自動認識させてアラート通知を送信します。複雑な条件設定なしで問題の状況を迅速かつ正確に認知することができます。数多くのヒートマップパターンが学習されており、リアルタイムで収集されるデータから学習されたパターンと類似したパターンが発生するとアラート通知を受けることができます。`), /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)(ImgLang, {
        img: "ai-alert.png",
        desc: "ヒートマップパターン",
        mdxType: "ImgLang"
    ...
    }, `ヒートマップとヒートマップパターンの詳細については、`, /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("a", {
        parentName: "p",
        "href": "trs-view"
        ...
        parentName: "strong"
    }, `検出時間を除外`)), `：設定した時間より短いパターンを無視します。`)), /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("li", {
        parentName: "ul"
    }, /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("p", {
        parentName: "li"
    }, /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("strong", {
        ...
        parentName: "strong"
    }, `保存`)), `：設定した内容を保存して反映します。`))), /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("h2", {
        "id": "ヒートマップパターン"
    }, `ヒートマップパターン`), /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("p", null, `次のヒートマップパターンが発生した場合は、アラート通知を送信するように設定できます。各項目のトグルボタンを選択して、アラート通知をオンまたはオフにすることができます。`), /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("ul", null, /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("li", {
        parentName: "ul"
    }, /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("p", {
        parentName: "li"
    }, /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("strong", {
        ...
        parentName: "strong"
    }, `ヒートマップの横ラインパターン`)), `：複数のトランザクションが一定時間内に終了するパターンです。リソースを取得したり、外部HTTPS Callをしたりする場合にタイムアウトまたは遅延が発生します。`), /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("p", {
        parentName: "li"
        ...
        parentName: "strong"
    }, `ヒートマップ縦ラインパターン`)), `：呼び出しのタイミングが異なるが、同じ時点でトランザクションが終了するパターンです。トランザクションが使用する共通のリソースに一時的なボトルネックが発生します。`), /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("p", {
        parentName: "li"
    }, /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("img", {
        alt: "縦ラインパターン",
        ...
        parentName: "strong"
    }, `ヒートマップのフライングパターン`)), `：特定のリソースやログなどの一般的なリソース不足により、間隔をおいた波のようなパターンが発生します。`), /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("p", {
        parentName: "li"
    }, /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("img", {
        alt: "フライングパターン",
        ...
        parentName: "strong"
    }, `ヒートマップ過負荷パターン`)), `：全体または一部の応答に一時的な問題が発生すると、一時的にトランザクションが集中するパターンが発生します。`), /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("p", {
        parentName: "li"
    }, /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("img", {
        alt: "過負荷パターン",
        ...
        parentName: "strong"
    }, `ヒートマップの暴走パターン`)), `：過剰なトランザクションのリクエストや負荷が発生すると、応答時間が全体的に増加するパターンが発生します。`), /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("p", {
        parentName: "li"
    }, /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("img", {
        alt: "暴走パターン",
