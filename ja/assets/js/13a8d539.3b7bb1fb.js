"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[17541],{
...
const metadata = {
  ...
  "title": "ブラウザーエラー",
  "description": "ブラウザーエラーダッシュボードは、ブラウザーエラーに関連するウィジェットで構成されるリアルタイムの統計データのダッシュボードです。",
  "source": "@site/i18n/ja/docusaurus-plugin-content-docs/current/browser/browser-error-dashboard.mdx",
  ...
  return (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.Fragment, {
    children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.p, {
      ...
      children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(Cmdname, {
        sid: "side_rumErrorDashboard",
        className: "uitext"
      }), "ダッシュボードは、ブラウザアプリケーションのエラーをモニタリングおよび視覚化してリアルタイムで表示するダッシュボードです。 ダッシュボードを使用すると、迅速にエラーを把握し、原因を見つけて修正できます。 ページ別、エラータイプ別、AJAXエラー件数、ブラウザー別、エラーメッセージ別エラー件数などさまざまな情報を提供します。"]
      ...
      children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.h2, {
        ...
        children: "各ページで発生したすべてのエラー件数をページごとに表示します。 チャートにカーソルを合わせると、ページ グループのエラー件数をツールチップ形式で表示できます。 横棒チャートは、表示期間中に発生したページごとのエラー数の合計であり、上位8つまで表示します。"
      })]
    }), "\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.section, {
      className: "remark-sectionize-h2",
      children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.h2, {
        id: "TTL06201",
        children: "エラータイプ別のエラー件数"
      }), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(ImgLang, {
        img: "browser-error-by-types.png",
        desc: "Error count by types"
      }), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.p, {
        children: "コンソールエラーとソースエラーを表示します。 横棒チャートは、表示時間中に発生したエラータイプ別エラー数の合計であり、上位8つまで表示します。"
      })]
    }), "\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.section, {
      className: "remark-sectionize-h2",
      children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.h2, {
        ...
        children: "ブラウザーアプリケーションで発生するAJAXエラー件数は、fetchまたは、xhrタイプに分類して表示します。 AJAXエラーは、ステータスコードが400以上の場合、リクエスト自体ができなく、キャンセルされた場合を意味します。"
      })]
    }), "\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.section, {
      className: "remark-sectionize-h2",
      children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.h2, {
        id: "error_count_by_browser",
        children: "ブラウザ別のエラー件数"
      }), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(ImgLang, {
      ...
      children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.h2, {
        id: "TTL06189",
        children: "エラーメッセージ別のエラー件数"
      }), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(ImgLang, {
        img: "browser-error-by-messages.png",
        desc: "Error count by messages"
      }), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.p, {
        children: "コンソールエラーを除いたソースエラーおよびAJAXエラーに関するメッセージを表示します。 横棒チャートは、表示時間中に発生したエラーメッセージごとのエラー数の合計であり、上位8つまで表示します。"
      })]
    }), "\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.section, {
      className: "remark-sectionize-h2",
      children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.h2, {
      ...
      children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.h3, {
        ...
        children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(Cmdname, {
          ...
          sid: "table",
          className: "uitext"
        }), "一覧からエラーメッセージを選択すると、エラーメッセージに基づいてエラーに関する詳細な統計情報を確認できます。"]
      }), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(ImgLang, {
        ...
        children: ["\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.li, {
          children: ["\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.p, {
            ...
            children: "表示時間を基準に発生したエラーメッセージの一覧を確認することができます。 各エラーメッセージを選択すると、詳細を確認できます。"
          }), "\n"]
        }), "\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.li, {
          children: ["\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.p, {
            children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.img, {
            ...
            children: ["時間帯別の", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(Cmdname, {
              sid: "error",
              className: "uitext"
            }), " ", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(Cmdname, {
              sid: "count",
          ...
          children: ["\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.p, {
            ...
            children: ["時間別ごとに発生したエラーログを確認できます。 ", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(Cmdname, {
              sid: "error",
              className: "uitext"
            }), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(Cmdname, {
              sid: "stack",
              ...
              sid: "analysis",
              className: "uitext"
            }), "ボタンを選択すると、選択したエラーログのエラースタック情報を確認できるウィンドウが表示されます。 詳細については、", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.a, {
