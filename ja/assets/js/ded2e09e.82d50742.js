"use strict";
(self["webpackChunkwhatap_origin"] = self["webpackChunkwhatap_origin"] || []).push([[60793],{
...
const metadata = {
    ...
    "title": "アラートメッセージユーザーの定義",
    "description": "プロジェクトメンバーに伝えられるアラート通知メッセージを修正できるユーザー定義機能を提供します。",
    "source": "@site/i18n/ja/docusaurus-plugin-content-docs/current/mssql/set-notification-message.mdx",
    "sourceDirName": "mssql",
    "slug": "/mssql/set-notification-message",
    "permalink": "/ja/mssql/set-notification-message",
    "draft": false,
    ...
    "previous": {
        "title": "メトリックアラート通知",
        "permalink": "/ja/mssql/metric-warning-notice"
    },
    "next": {
        "title": "異常値検知の警告通知",
