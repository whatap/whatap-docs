"use strict";
(self["webpackChunkwhatap_origin"] = self["webpackChunkwhatap_origin"] || []).push([[73415],{
...
const metadata = {
    ...
    "title": "基本的な使い方",
    "description": "トポロジーメニューで基本的な作業を行う方法について説明します。",
    "source": "@site/i18n/ja/docusaurus-plugin-content-docs/current/php/topology-basic.mdx",
    "sourceDirName": "php",
    ...
    "next": {
        "title": "タイプ別トポロジー",
        "permalink": "/ja/php/topology-type"
    }
};
const assets = {};
const toc = [];
