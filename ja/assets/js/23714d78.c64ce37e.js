"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[93303],{
...
function _createMdxContent(props) {
  ...
  return (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.Fragment, {
    children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.p, {
      ...
      children: "エージェントをインストールしたデータベースサーバーの一覧を確認できます。主なパフォーマンス指標とステータスを確認できます。パフォーマンス指標は5秒間隔で更新され、一覧のカラムは設定を使用して順序を変更したり、任意の指標に変更することができます。"
      ...
      children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.p, {
        ...
        }), "カラムで正常でない状態アイコンをクリックすると", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.strong, {
          children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.em, {
            children: "イベント"
          })
...
/* harmony import */ var _common_items_db_instance_list_mdx__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(95916);
/* harmony import */ var _common_items_db_instance_list_set_name_guide_mdx__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(65992);
...
const metadata = {
  ...
  "title": "インスタンスリスト",
  "description": "エージェントをインストールしたデータベースサーバーの一覧を確認できます。",
  "source": "@site/i18n/ja/docusaurus-plugin-content-docs/current/mssql/instance-list.mdx",
  "sourceDirName": "mssql",
  ...
  "previous": {
    ...
    "permalink": "/ja/mssql/dashboard-intro"
  },
  "next": {
    "title": "インスタンスモニタリング",
