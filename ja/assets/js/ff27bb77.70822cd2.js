"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[78840],{
...
const metadata = {
  ...
  "title": "Featureプロジェク",
  "description": "この文書は、Featureプロジェクの紹介ページです。",
  "source": "@site/i18n/ja/docusaurus-plugin-content-docs/current/features/introduction.mdx",
    ...
    children: ["\n", "\n", "\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.p, {
      ...
      children: ["\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.li, {
        children: ["\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.p, {
          ...
          children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.strong, {
            children: "Featureプロジェク"
          }), "は、専用メニューを通じて簡単にインストールするだけでなく、必要なモニタリング構成を簡単に統合して管理できます。 ユーザーフレンドリーなインターフェイスとともに、統合モニタリングを体験します。"]
        }), "\n"]
      }), "\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.li, {
        children: ["\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.p, {
          children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.strong, {
          ...
          children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.strong, {
            children: "Featureプロジェク"
          }), "は、ユーザーが希望するソフトウェアの互換性を簡単に確認できるだけでなく、そのソフトウェア別にカスタマイズされたダッシュボードを提供します。 煩雑な設定なしで簡単にモニタリングします。"]
        }), "\n"]
      }), "\n"]
      ...
      children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.h2, {
        ...
        children: ["KAFKAは、データストリームの処理に使用される分散ストリーミングプラットフォームです。 WhaTapは、", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.strong, {
          children: "Featureプロジェク"
      ...
      children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.h2, {
        ...
        children: ["Aerospikeは、リアルタイムのデータ処理や大規模なデータ分析に最適化された高性能NoSQLデータベースです。 WhaTapは、", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.strong, {
          children: "Featureプロジェク"
        }), "方法で", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.strong, {
          children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.em, {
            children: "Aerospike"
          })
        }), "モニタリングを提供します。 クラスター性能、応答時間、データの一貫性などを、リアルタイムで追跡してシステムの安定性を維持し、最適化するのに役立ちます。"]
      })]
    }), "\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.section, {
      className: "remark-sectionize-h2",
      children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.h2, {
        ...
        children: ["Apache Pulsarは、拡張可能な高性能オープンソースのメッセージングおよびストリーミングプラットフォームです。 WhaTapは、", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.strong, {
          children: "Featureプロジェクト"
        }), "方法で", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.strong, {
          children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.em, {
            children: "Apache Pulsar"
          })
        }), "モニタリングを提供します。 クラスターの効率的な追跡を可能にするのに役立ちます。"]
