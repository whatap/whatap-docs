"use strict";
(self["webpackChunkwhatap_origin"] = self["webpackChunkwhatap_origin"] || []).push([[6147],{
...
function MDXContent(_param) {
    ...
    return /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)(MDXLayout, _object_spread_props(_object_spread({}, layoutProps, props), {
    ...
    }, `PHP`), `で開発したアプリケーションへのWhaTapエージェントのインストールを対応します。 `)), /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)(ImgLang, {
        ...
        "id": "アプリケーションダッシュボード"
    }, `アプリケーションダッシュボード`), /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("h3", {
        "id": "過去のデータ参照"
        ...
        "id": "エージェントの確認"
    }, `エージェントの確認`), /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("h4", {
        "id": "エージェント接続状態を確認する"
        ...
        width: "15",
        height: "19"
    }), `: 非アクティブ化されたエージェントを表示または非表示にすることができます。`))), /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("h4", {
        "id": "エージェント別モニタリング"
        ...
        parentName: "p"
    }, `whatap.onode`), `に分類されたエージェントの一覧のみをモニタリングします。`))), /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("h3", {
        "id": "ダッシュボードウィジェットの編集"
    }, `ダッシュボードウィジェットの編集`), /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("p", null, `ダッシュボードに配置したウィジェットは、ユーザーが希望するサイズに調整でき、目的の位置に配置できます。 不要と思われるウィジェットは削除して再度追加することもできます。`), /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("h4", {
        "id": "ウィジェットのサイズ変更"
        ...
        width: "50",
        height: "50"
    }), `要素を使用して、マウスでクリックした状態で目的のサイズにドラッグします。 幅と高さの比率が均一な均一なグリッドが表示され、グリッド単位でウィジェットのサイズを調整できます。`), /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("h4", {
        "id": "ウィジェットの移動"
    }, `ウィジェットの移動`), /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)(ImgLang, {
        img: "apm-dashboard-widget-move.png",
        desc: "ウィジェットを移動する",
        mdxType: "ImgLang"
    }), /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("p", null, `ウィジェットの上部にマウスカーソルを移動すると、カーソルの形が`, /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("img", {
        alt: "移動アイコン",
        src: (__webpack_require__(18766)/* ["default"] */ .Z),
        width: "88",
        height: "88"
    }), `の形に変更されます。 この時、マウスの左ボタンをクリックした状態で好きな位置にドラッグしてウィジェットを移動することができます。`), /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("h4", {
        "id": "ウィジェットを削除する"
        ...
        parentName: "strong"
    }, `削除`)), `ボタンをクリックすると、ウィジェットがダッシュボードから削除されます。`), /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("h4", {
        "id": "ウィジェットを追加する"
        ...
        parentName: "admonition"
    }, `現在追加できるウィジェットは固定されていますが、今後のアップデートでウィジェットサポートを追加していく計画です。`)), /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("h3", {
        "id": "プリセット"
        ...
        parentName: "strong"
    }, `Default`)), `)は変更できず、目的の形式でウィジェットのサイズを変更して配置して新しいプリセットを作成できます。`), /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("h4", {
        "id": "新しいプリセットを作成する"
        ...
        parentName: "li"
    }, `プリセットはユーザーアカウントに保存され、現在の他のユーザーと共有されません。 より良い機能を提供するために更新されます。`)))), /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("h4", {
        "id": "プリセット削除"
        ...
        parentName: "admonition"
    }, `ウィジェットによって使用可能なオプションは異なる場合があります。`)), /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("h3", {
        "id": "ウィジェットの詳細"
    ...
    }, `DB接続遅延とコネクションプール`))))), /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("h4", {
        "id": "エージェント関連ウィジェット"
        ...
        "id": "トランザクション関連ウィジェット"
    }, `トランザクション関連ウィジェット`), /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("p", null, `トランザクションによって確認できるトラブルの現状は、まず応答時間を通じて照会できます。 また、進行中のトランザクションが終了しない場合は、これもトラブルとして認識する必要があります。 WhaTapは、進行中の状態の時間に基づいて区間を分けて表示します。 `, /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("span", {
        class: "normal"
        ...
        class: "vslow"
    }, `赤色(Very slow)`), `は、応答時間が通常の 2 倍以上に遅いトランザクションを意味します。 これにより、ユーザーは直感的に素早くトラブルを認識できます。`), /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("h6", {
        "id": "アクティブトランザクションスピード"
        ...
        class: "vslow"
    }, `Very Slow`), `)で色分けして右上に数値として表示されます。 `), /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("h6", {
        "id": "active-trs"
    ...
    }, `次の文書`), `を参照してください。`)))))), /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("h6", {
        "id": "active-status"
        ...
        parentName: "strong"
    }, `METHOD`)), `：メソッドが実行されている状態です。 一般的な状況として青色で表示されます。`)), /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("li", {
        parentName: "ul"
    }, /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("p", {
        parentName: "li"
    }, /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("strong", {
        ...
        parentName: "strong"
    }, `SQL`)), `：SQLが実行されている状態です。 `, /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("strong", {
        parentName: "p"
    }, /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("em", {
        parentName: "strong"
        ...
        parentName: "strong"
    }, `HTTPC`)), `：外部APIを呼び出し中の状態です。 `, /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("strong", {
        parentName: "p"
    }, /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("em", {
        parentName: "strong"
    }, `HTTPC`)), ` 数が増えた場合は、外部接続されたサーバーの応答が正しく行われていないことを意味します。`)), /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("li", {
        parentName: "ul"
    }, /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("p", {
        parentName: "li"
    }, /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("strong", {
        ...
        parentName: "strong"
    }, `DBC`)), `：トランザクションがConnection Poolから新しいConnectionを取得(get)しようとしている状態です。 DB Connection Poolの数が不足すると、新しい接続リクエストが発生するたびに遅延が発生し、性能トラブルの原因となります。 この場合、`, /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("strong", {
        parentName: "p"
    }, /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("em", {
        parentName: "strong"
        ...
        parentName: "strong"
    }, `SOCKET`)), ` 数値が持続的に増加する場合は、外部システムとの接続がないために、障害が発生している可能性があります。`))), /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("h6", {
        "id": "ヒートマップ"
        ...
        parentName: "strong"
    }, `ヒートマップ`)), `チャートは、終了したトランザクションの応答時間を分布図で表現します。 横軸はトランザクションの終了時間です。 縦軸は実行時間です。 実行時間の長いトランザクションは、分布図の上部に位置します。 `, /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("strong", {
        parentName: "p"
    }, /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("em", {
        parentName: "strong"
        ...
        parentName: "li"
    }, `エージェント設定により、ポリシーを設定できます。 詳細については、`, /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("a", {
        parentName: "p",
        ...
        parentName: "li"
    }, `ヒートマップウィジェットを使用してトランザクションを分析するプロセスについては、次の文書を参照してください。`)))), /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("h4", {
        "id": "サービス関連ウィジェット"
    }, `サービス関連ウィジェット`), /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("p", null, `サービス関連ウィジェットは、アプリケーションのパフォーマンスチューニングの指標として使用できます。`), /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("h6", {
        "id": "tps"
        ...
        parentName: "p"
    }, `TPS`), `)は毎秒処理されるトランザクション数を意味し、サービスパフォーマンス指標の基準となります。 5秒ごとに処理されたトランザクション数を1秒あたりの数に換算してチャートで表現します。 直近10分間のTPSを表示します。`), /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("admonition", {
        "type": "note"
    }, /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("p", {
        parentName: "admonition"
        ...
        "id": "リソース関連ウィジェット"
    }, `リソース関連ウィジェット`), /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("h6", {
        "id": "コンテナcpu"
    }, `コンテナCPU`), /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)(ImgLang, {
        img: "k8s-ap-service-dashboard-cpu.png",
        desc: "コンテナCPU",
        mdxType: "ImgLang"
    }), /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("p", null, `コンテナCPU使用量です。 リアルタイムでCPU使用量の変化の推移を認することができます。`), /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("admonition", {
        "type": "note"
    }, /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("p", {
        parentName: "admonition"
    }, `TPS、応答時間、CPU 使用率分析の詳細については`, /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("a", {
        ...
        parentName: "admonition"
    }, `ヒープメモリおよびヒープメモリチャートの分析の詳細については、次のリンクを参照してください。`), /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("ul", {
        parentName: "admonition"
    }, /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("li", {
        parentName: "ul"
    }, /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("p", {
    ...
    }, `学習する: ヒープメモリメトリクスおよびメトリック通知設定`))), /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("li", {
        parentName: "ul"
    }, /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("p", {
        parentName: "li"
    }, /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("a", {
    ...
    }, `JAVAヒープメモリーチャートの分析：Ch.2 メモリリークとヒープダンプ分析`))))), /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("h4", {
        "id": "ユーザー関連ウィジェット"
    }, `ユーザー関連ウィジェット`), /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("h6", {
        "id": "同時接続ユーザー"
    }, `同時接続ユーザー`), /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)(ImgLang, {
        img: "apm-dashboard-realtime-user.png",
        desc: "同時接続ユーザー",
        mdxType: "ImgLang"
    }), /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("p", null, `リアルタイムブラウザのユーザー数を表示します。 5秒ごとに、過去5分以内にトランザクションを行ったユーザーを重複なくカウントされ、表示します。 ユーザーのブラウザのIPに基づいてカウントします。`), /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("admonition", {
        "type": "note"
        ...
        parentName: "li"
    }, `通常、接続ユーザーはネットワークに接続しているユーザーを意味します。 ただし、ウェブシステムは未接続のネットワークを使用するため異なります。 接続されているという意味ではなく、最近のリクエストを送信したユーザーが測定の対象になる可能性があります。`)), /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("li", {
        parentName: "ul"
    }, /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("p", {
        parentName: "li"
        ...
        parentName: "p"
    }, `HyperLogLog`), `は、非常に少ないメモリ内の要素の数を推定する確率的なデータ構造を意味します。`)))), /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("h4", {
        "id": "1日基準比較ウィジェット"
    }, `1日基準比較ウィジェット`), /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("h6", {
        "id": "本日tps"
        ...
        parentName: "strong"
    }, `日付別アプリケーションの現状`)), `メニューに移動します。`), /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("h6", {
        "id": "本日ユーザー"
        ...
        parentName: "strong"
    }, `日付別アプリケーションの現状`)), `メニューに移動します。`), /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("h3", {
        "id": "リアルタイム通知の確認"
