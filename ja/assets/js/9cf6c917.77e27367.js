"use strict";
(self["webpackChunkwhatap_origin"] = self["webpackChunkwhatap_origin"] || []).push([[85097],{
...
const metadata = {
    "unversionedId": "java/set-notification-message",
    "id": "java/set-notification-message",
    "title": "アラートメッセージユーザーの定義",
    "description": "プロジェクトメンバーに伝えられるアラート通知メッセージを修正できるユーザー定義機能を提供します。",
    "source": "@site/i18n/ja/docusaurus-plugin-content-docs/current/java/set-notification-message.mdx",
    "sourceDirName": "java",
    "slug": "/java/set-notification-message",
    "permalink": "/ja/java/set-notification-message",
    "draft": false,
    "editUrl": "undefined/docs/java/set-notification-message.mdx",
    "tags": [
        {
            "label": "Java",
    ...
    "previous": {
        "title": "メトリックアラート通知",
        "permalink": "/ja/java/metric-warning-notice"
    },
    "next": {
        "title": "AIを利用したのヒートマップパターンのアラート通知",
        "permalink": "/ja/java/hitmap-notice"
    }
};
const assets = {};
const toc = [
