"use strict";
(self["webpackChunkwhatap_origin"] = self["webpackChunkwhatap_origin"] || []).push([[20212],{
...
const metadata = {
    ...
    "title": "アプリケーション警告通知",
    "description": "アプリケーションのリソース使用量および進行中トランザクション、エラー状況のイベント条件を通じて警告通知を送信します。",
    "source": "@site/i18n/ja/docusaurus-plugin-content-docs/current/golang/warning-notice.mdx",
    "sourceDirName": "golang",
    "slug": "/golang/warning-notice",
    "permalink": "/ja/golang/warning-notice",
    "draft": false,
    ...
    "previous": {
        "title": "アラートの設定",
        "permalink": "/ja/golang/apm-set-notice"
    },
    "next": {
        "title": "メトリックアラート通知",
        "permalink": "/ja/golang/metric-warning-notice"
    }
};
const assets = {};
const toc = [
