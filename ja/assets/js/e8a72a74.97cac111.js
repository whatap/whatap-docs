"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[19374],{
...
const metadata = {
  ...
  "title": "メトリクスチャート",
  "description": "メトリクスデータをチャートで照会できます。",
  "source": "@site/i18n/ja/docusaurus-plugin-content-docs/current/redis/metrics-chart.mdx",
  "sourceDirName": "redis",
  ...
  "next": {
    "title": "メトリクス照会",
    "permalink": "/ja/redis/metrics-search"
  }
};
const assets = {
