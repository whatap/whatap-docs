"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[1167],{
...
const metadata = {
  ...
  "title": "データベースアラート通知",
  "description": "データベースのメトリクスごとのイベント条件設定を使用してアラート通知を送信します。",
  "source": "@site/i18n/ja/docusaurus-plugin-content-docs/current/tibero/warning-notice.mdx",
