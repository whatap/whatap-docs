"use strict";
(self["webpackChunkwhatap_origin"] = self["webpackChunkwhatap_origin"] || []).push([[36628],{
...
const metadata = {
    "unversionedId": "dotnet/warning-notice",
    "id": "dotnet/warning-notice",
    "title": "アプリケーション警告通知",
    "description": "アプリケーションのリソース使用量および進行中トランザクション、エラー状況のイベント条件を通じて警告通知を送信します。",
    "source": "@site/i18n/ja/docusaurus-plugin-content-docs/current/dotnet/warning-notice.mdx",
    "sourceDirName": "dotnet",
    "slug": "/dotnet/warning-notice",
    "permalink": "/ja/dotnet/warning-notice",
    "draft": false,
    "editUrl": "undefined/docs/dotnet/warning-notice.mdx",
    "tags": [
        {
            "label": ".NET",
