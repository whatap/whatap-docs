"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[79708],{
...
const metadata = {
  ...
  "title": "アプリケーションダッシュボード",
  "description": "ウェブアプリケーションサーバーのリソースをリアルタイムでモニタリングできます。",
  "source": "@site/i18n/ja/docusaurus-plugin-content-docs/current/golang/dashboard.mdx",
  ...
  "previous": {
    "title": "ダッシュボード",
    "permalink": "/ja/golang/dashboard-intro"
  },
  "next": {
    "title": "TXマップ",
