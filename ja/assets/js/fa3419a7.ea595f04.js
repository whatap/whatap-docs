"use strict";
(self["webpackChunkwhatap_origin"] = self["webpackChunkwhatap_origin"] || []).push([[59120],{
...
const metadata = {
    ...
    "title": "イベント履歴",
    "description": "イベント履歴メニューを通じて発生した警告通知の履歴が確認できます。",
    "source": "@site/i18n/ja/docusaurus-plugin-content-docs/current/mssql/set-event-history.mdx",
    "sourceDirName": "mssql",
    ...
    "next": {
        "title": "イベント受信フォーマット",
        "permalink": "/ja/mssql/set-event-format"
    }
};
const assets = {};
const toc = [];
