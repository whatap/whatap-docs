"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[58228],{
...
const metadata = {
  ...
  "title": "レポート",
  "description": "MongoDB製品の個別プロジェクトについてサービスの利用状況とトラブル履歴を報告するドキュメントについて説明します。",
  "source": "@site/i18n/ja/docusaurus-plugin-content-docs/current/mongodb/report-intro.mdx",
  "sourceDirName": "mongodb",
  "slug": "/mongodb/report-intro",
  "permalink": "/ja/mongodb/report-intro",
  "draft": false,
  "unlisted": false,
  ...
  "previous": {
    "title": "データベースのサイズ",
    "permalink": "/ja/mongodb/database-size"
  },
  "next": {
    "title": "ログ",
    "permalink": "/ja/mongodb/log-main"
  }
};
const assets = {
