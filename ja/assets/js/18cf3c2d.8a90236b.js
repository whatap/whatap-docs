"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[67915],{
...
const metadata = {
  ...
  "title": "アプリケーションダッシュボード",
  "description": "ウェブアプリケーションサーバーのリソースをリアルタイムでモニタリングできます。",
  "source": "@site/i18n/ja/docusaurus-plugin-content-docs/current/python/dashboard.mdx",
  "sourceDirName": "python",
  "slug": "/python/dashboard",
  "permalink": "/ja/python/dashboard",
  "draft": false,
  "unlisted": false,
  ...
  "previous": {
    "title": "ダッシュボード",
    "permalink": "/ja/python/dashboard-intro"
  },
  "next": {
    "title": "TXマップ",
    "permalink": "/ja/python/dashboard-transactionmap"
  }
};
const assets = {
