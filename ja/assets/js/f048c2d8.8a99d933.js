"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[20554],{
...
const metadata = {
  ...
  "title": "警告通知の受信設定",
  "description": "プロジェクトに含まれるメンバーの警告通知の受信に関連した各種機能を設定できます。",
  "source": "@site/i18n/ja/docusaurus-plugin-content-docs/current/mysql/set-receive-event.mdx",
  "sourceDirName": "mysql",
  "slug": "/mysql/set-receive-event",
  "permalink": "/ja/mysql/set-receive-event",
  "draft": false,
  "unlisted": false,
  ...
  "previous": {
    "title": "ログ通知の設定",
    "permalink": "/ja/mysql/set-event-log"
  },
  "next": {
    "title": "イベント履歴",
    "permalink": "/ja/mysql/set-event-history"
  }
};
const assets = {
