"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[27893],{
...
/* harmony import */ var _common_items_db_oracle_column_mdx__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(87813);
...
const metadata = {
  ...
  "title": "インスタンスモニタリング",
  "description": "インスタンスモニタリングメニューでは、データベースサーバーの主なメトリクスに関する詳細情報をリアルタイムに確認できます。",
  "source": "@site/i18n/ja/docusaurus-plugin-content-docs/current/oracle-pro/instance-monitoring.mdx",
  ...
  "previous": {
    "title": "インスタンスリスト",
    "permalink": "/ja/oracle-pro/instance-list"
  },
  "next": {
    "title": "マルチインスタンス",
