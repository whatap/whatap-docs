"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[73513],{
...
const metadata = {
  ...
  "title": "警告通知の受信設定",
  "description": "プロジェクトに含まれるメンバーの警告通知の受信に関連した各種機能を設定できます。",
  "source": "@site/i18n/ja/docusaurus-plugin-content-docs/current/java/set-receive-event.mdx",
  "sourceDirName": "java",
  "slug": "/java/set-receive-event",
  "permalink": "/ja/java/set-receive-event",
  "draft": false,
  "unlisted": false,
  ...
  "previous": {
    "title": "ログ警告通知",
    "permalink": "/ja/java/set-event-log"
  },
  "next": {
    "title": "イベント履歴",
