"use strict";
(self["webpackChunkwhatap_origin"] = self["webpackChunkwhatap_origin"] || []).push([[5503],{
...
const metadata = {
    "unversionedId": "postgresql-v1/set-notification-message",
    "id": "postgresql-v1/set-notification-message",
    "title": "アラートメッセージユーザーの定義",
    "description": "プロジェクトメンバーに伝えられるアラート通知メッセージを修正できるユーザー定義機能を提供します。",
    "source": "@site/i18n/ja/docusaurus-plugin-content-docs/current/postgresql-v1/set-notification-message.mdx",
    "sourceDirName": "postgresql-v1",
    "slug": "/postgresql-v1/set-notification-message",
    "permalink": "/ja/postgresql-v1/set-notification-message",
    "draft": false,
    "editUrl": "undefined/docs/postgresql-v1/set-notification-message.mdx",
    "tags": [
        {
            "label": "PostgreSQL",
    ...
    "previous": {
        "title": "メトリックアラート通知",
        "permalink": "/ja/postgresql-v1/metric-warning-notice"
    },
    "next": {
        "title": "異常値検知の警告通知",
