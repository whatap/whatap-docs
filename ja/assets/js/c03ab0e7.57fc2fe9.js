"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[90784],{
...
const metadata = {
  ...
  "title": "警告通知の受信設定",
  "description": "プロジェクトに含まれるメンバーの警告通知の受信に関連した各種機能を設定できます。",
  "source": "@site/i18n/ja/docusaurus-plugin-content-docs/current/oracle-cloud/set-receive-event.mdx",
  "sourceDirName": "oracle-cloud",
  "slug": "/oracle-cloud/set-receive-event",
  "permalink": "/ja/oracle-cloud/set-receive-event",
  "draft": false,
  "unlisted": false,
  ...
  "previous": {
    "title": "メトリクスアラートの通知",
    "permalink": "/ja/oracle-cloud/metric-warning-notice"
  },
  "next": {
    "title": "イベント履歴",
    "permalink": "/ja/oracle-cloud/set-event-history"
  }
};
const assets = {
