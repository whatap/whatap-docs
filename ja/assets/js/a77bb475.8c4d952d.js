"use strict";
(self["webpackChunkwhatap_origin"] = self["webpackChunkwhatap_origin"] || []).push([[45064],{
...
const metadata = {
    "unversionedId": "mongodb/set-notification-message",
    "id": "mongodb/set-notification-message",
    "title": "アラートメッセージユーザーの定義",
    "description": "プロジェクトメンバーに伝えられるアラート通知メッセージを修正できるユーザー定義機能を提供します。",
    "source": "@site/i18n/ja/docusaurus-plugin-content-docs/current/mongodb/set-notification-message.mdx",
    "sourceDirName": "mongodb",
    "slug": "/mongodb/set-notification-message",
    "permalink": "/ja/mongodb/set-notification-message",
    "draft": false,
    "editUrl": "undefined/docs/mongodb/set-notification-message.mdx",
    "tags": [
        {
            "label": "MongoDB",
    ...
    "previous": {
        "title": "メトリックアラート通知",
        "permalink": "/ja/mongodb/metric-warning-notice"
    },
    "next": {
        "title": "異常値検知の警告通知",
