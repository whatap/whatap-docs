"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[40280],{
...
const metadata = {
  ...
  "title": "メトリクスチャート",
  "description": "メトリクスデータをチャートで照会できます。",
  "source": "@site/i18n/ja/docusaurus-plugin-content-docs/current/mssql/metrics-chart.mdx",
  "sourceDirName": "mssql",
  ...
  "previous": {
    "title": "SQL Server 지표",
    "permalink": "/ja/mssql/metrics-data-list"
  },
  "next": {
    "title": "メトリクス照会",
    "permalink": "/ja/mssql/metrics-search"
  }
};
const assets = {
