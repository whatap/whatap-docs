"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[89716],{
...
const metadata = {
  "id": "mongodb/flexboard-widget-template",
  "title": "ウィジェットテンプレート",
  "description": "Flexボードでダッシュボードに配置できるウィジェットの種類を案内します。",
  "source": "@site/i18n/ja/docusaurus-plugin-content-docs/current/mongodb/flexboard-widget-template.mdx",
  "sourceDirName": "mongodb",
  "slug": "/mongodb/flexboard-widget-template",
  "permalink": "/ja/mongodb/flexboard-widget-template",
  "draft": false,
  "unlisted": false,
  "editUrl": "undefined/docs/mongodb/flexboard-widget-template.mdx",
  "tags": [],
  "version": "current",
  "frontMatter": {
    "id": "flexboard-widget-template",
