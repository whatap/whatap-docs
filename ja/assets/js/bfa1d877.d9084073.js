"use strict";
(self["webpackChunkwhatap_origin"] = self["webpackChunkwhatap_origin"] || []).push([[33071],{
...
const metadata = {
    ...
    "title": "アラートメッセージユーザーの定義",
    "description": "プロジェクトメンバーに伝えられるアラート通知メッセージを修正できるユーザー定義機能を提供します。",
    "source": "@site/i18n/ja/docusaurus-plugin-content-docs/current/mysql-v1/set-notification-message.mdx",
    "sourceDirName": "mysql-v1",
    "slug": "/mysql-v1/set-notification-message",
    "permalink": "/ja/mysql-v1/set-notification-message",
    "draft": false,
    ...
    "previous": {
        "title": "メトリックアラート通知",
        "permalink": "/ja/mysql-v1/metric-warning-notice"
    },
    "next": {
        "title": "異常値検知の警告通知",
