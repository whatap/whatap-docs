"use strict";
(self["webpackChunkwhatap_origin"] = self["webpackChunkwhatap_origin"] || []).push([[31332],{
...
const metadata = {
    ...
    "title": "メトリックス",
    "description": "データベースモニタリング分析のメトリクスメニューについて学習します。",
    "source": "@site/i18n/ja/docusaurus-plugin-content-docs/current/mysql-v1/metrics-intro.mdx",
    ...
    "previous": {
        "title": "ロックツリー & デッドロック",
        "permalink": "/ja/mysql-v1/analysis-lock-and-deadlock"
    },
    "next": {
        "title": "MySQL指標",
