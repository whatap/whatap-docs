"use strict";
(self["webpackChunkwhatap_origin"] = self["webpackChunkwhatap_origin"] || []).push([[60486],{
...
const metadata = {
    "unversionedId": "php/warning-notice",
    "id": "php/warning-notice",
    "title": "アプリケーション警告通知",
    "description": "アプリケーションのリソース使用量および進行中トランザクション、エラー状況のイベント条件を通じて警告通知を送信します。",
    "source": "@site/i18n/ja/docusaurus-plugin-content-docs/current/php/warning-notice.mdx",
    "sourceDirName": "php",
    "slug": "/php/warning-notice",
    "permalink": "/ja/php/warning-notice",
    "draft": false,
    "editUrl": "undefined/docs/php/warning-notice.mdx",
    "tags": [
        {
            "label": "PHP",
    ...
    "previous": {
        "title": "アラートの設定",
        "permalink": "/ja/php/apm-set-notice"
    },
    "next": {
        "title": "メトリックアラート通知",
