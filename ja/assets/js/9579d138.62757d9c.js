"use strict";
(self["webpackChunkwhatap_origin"] = self["webpackChunkwhatap_origin"] || []).push([[75154],{
...
const metadata = {
    ...
    "title": "アラートメッセージユーザーの定義",
    "description": "プロジェクトメンバーに伝えられるアラート通知メッセージを修正できるユーザー定義機能を提供します。",
    "source": "@site/i18n/ja/docusaurus-plugin-content-docs/current/oracle/set-notification-message.mdx",
    "sourceDirName": "oracle",
    "slug": "/oracle/set-notification-message",
    "permalink": "/ja/oracle/set-notification-message",
    "draft": false,
    ...
    "previous": {
        "title": "メトリックアラート通知",
        "permalink": "/ja/oracle/metric-warning-notice"
    },
    "next": {
        "title": "異常値検知の警告通知",
