"use strict";
(self["webpackChunkwhatap_origin"] = self["webpackChunkwhatap_origin"] || []).push([[8246],{
...
const metadata = {
    ...
    "title": "アラートメッセージユーザーの定義",
    "description": "プロジェクトメンバーに伝えられるアラート通知メッセージを修正できるユーザー定義機能を提供します。",
    "source": "@site/i18n/ja/docusaurus-plugin-content-docs/current/php/set-notification-message.mdx",
    "sourceDirName": "php",
    "slug": "/php/set-notification-message",
    "permalink": "/ja/php/set-notification-message",
    "draft": false,
    ...
    "previous": {
        "title": "メトリックアラート通知",
        "permalink": "/ja/php/metric-warning-notice"
    },
    "next": {
        "title": "AIを利用したのヒートマップパターンのアラート通知",
        "permalink": "/ja/php/hitmap-notice"
    }
};
const assets = {};
const toc = [
