"use strict";
(self["webpackChunkwhatap_origin"] = self["webpackChunkwhatap_origin"] || []).push([[5364],{
...
const metadata = {
    ...
    "title": "メトリクスチャート",
    "description": "メトリック データはグラフで表示できます。",
    "source": "@site/i18n/ja/docusaurus-plugin-content-docs/current/java/metrics-chart.mdx",
    "sourceDirName": "java",
    ...
    "previous": {
        "title": "メトリックス参照",
        "permalink": "/ja/java/metrics-search"
    },
    "next": {
        "title": "マトリックス異常検出",
        "permalink": "/ja/java/metrics-detect-anormal"
    }
};
const assets = {};
const toc = [
