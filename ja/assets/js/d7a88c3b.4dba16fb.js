"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[96143],{
...
const metadata = {
  "id": "kubernetes/flexboard-widget-template",
  "title": "ウィジェットテンプレート",
  "description": "Flexボードでダッシュボードに配置できるウィジェットの種類を案内します。",
  "source": "@site/i18n/ja/docusaurus-plugin-content-docs/current/kubernetes/flexboard-widget-template.mdx",
  "sourceDirName": "kubernetes",
  "slug": "/kubernetes/flexboard-widget-template",
  "permalink": "/ja/kubernetes/flexboard-widget-template",
  "draft": false,
  "unlisted": false,
  "editUrl": "undefined/docs/kubernetes/flexboard-widget-template.mdx",
  "tags": [],
  "version": "current",
  "frontMatter": {
    "id": "flexboard-widget-template",
