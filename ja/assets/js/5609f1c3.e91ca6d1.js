"use strict";
(self["webpackChunkwhatap_origin"] = self["webpackChunkwhatap_origin"] || []).push([[24234],{
...
const metadata = {
    "unversionedId": "tibero/multi-instance-monitoring",
    "id": "tibero/multi-instance-monitoring",
    "title": "マルチインスタンスモニタリング",
    "description": "複数のデータベースインスタンスの主要メトリクスを統合および表示できる機能を提供します。",
    "source": "@site/i18n/ja/docusaurus-plugin-content-docs/current/tibero/multi-instance-monitoring.mdx",
