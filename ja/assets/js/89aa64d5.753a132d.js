"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[67023],{
...
__webpack_require__.d(__webpack_exports__, {
  ...
  contentTitle: () => (/* binding */ dotnet_2_3_2_contentTitle),
  "default": () => (/* binding */ dotnet_2_3_2_MDXContent),
  frontMatter: () => (/* binding */ dotnet_2_3_2_frontMatter),
  metadata: () => (/* binding */ metadata),
  toc: () => (/* binding */ dotnet_2_3_2_toc)
});
...
const dotnet_2_3_2_frontMatter = {
	id: 'dotnet-2_3_2',
...
const dotnet_2_3_2_contentTitle = undefined;
const metadata = {
  "id": "release-notes/dotnet/dotnet-2_3_2",
  "title": ".NET Agent v2.3.2",
  "description": "2024년 09월 05일",
  "source": "@site/docs/release-notes/dotnet/dotnet-2.3.2.mdx",
  "sourceDirName": "release-notes/dotnet",
  "slug": "/release-notes/dotnet/dotnet-2_3_2",
  "permalink": "/ja/release-notes/dotnet/dotnet-2_3_2",
  "draft": false,
  "unlisted": false,
  "editUrl": "undefined/docs/release-notes/dotnet/dotnet-2.3.2.mdx",
  "tags": [],
  "version": "current",
  "frontMatter": {
    "id": "dotnet-2_3_2",
...
const dotnet_2_3_2_toc = [...toc];
function dotnet_2_3_2_createMdxContent(props) {
  const _components = {
    a: "a",
    admonition: "admonition",
    code: "code",
...
function dotnet_2_3_2_MDXContent(props = {}) {
  const {wrapper: MDXLayout} = {
    ...(0,lib/* useMDXComponents */.R)(),
    ...props.components
  };
  return MDXLayout ? (0,jsx_runtime.jsx)(MDXLayout, {
    ...props,
    children: (0,jsx_runtime.jsx)(dotnet_2_3_2_createMdxContent, {
      ...props
    })
  }) : dotnet_2_3_2_createMdxContent(props);
}
