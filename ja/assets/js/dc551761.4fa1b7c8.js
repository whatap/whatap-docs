"use strict";
(self["webpackChunkwhatap_origin"] = self["webpackChunkwhatap_origin"] || []).push([[92494],{
...
const metadata = {
    ...
    "title": "ウィジェットの管理",
    "description": "Flexボードに配置したウィジェットを管理します。",
    "source": "@site/i18n/ja/docusaurus-plugin-content-docs/current/java/flexboard-widget-manage.mdx",
    "sourceDirName": "java",
    ...
    "previous": {
        "title": "メトリクスウィジェット",
        "permalink": "/ja/java/flexboard-metric-widget"
    },
    "next": {
        "title": "Flexボード画面モード",
