"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[58270],{
...
const frontMatter = {
	...
	title: 'イベント設定',
	description: 'Redisデータベースのメトリクスごとのイベント条件設定を使用してアラート通知を送信します。',
	keywords: [
		'Redis',
		'データベース',
		'アラート通知',
...
const metadata = {
  ...
  "title": "イベント設定",
  "description": "Redisデータベースのメトリクスごとのイベント条件設定を使用してアラート通知を送信します。",
  "source": "@site/i18n/ja/docusaurus-plugin-content-docs/current/redis/warning-notice-v2.mdx",
  "sourceDirName": "redis",
