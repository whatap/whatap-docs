"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[67068],{
...
const metadata = {
  ...
  "title": "イベント履歴",
  "description": "イベント履歴メニューを通じて発生した警告通知の履歴が確認できます。",
  "source": "@site/i18n/ja/docusaurus-plugin-content-docs/current/oracle-v1/set-event-history.mdx",
  ...
  "next": {
    "title": "イベント受信フォーマット",
    "permalink": "/ja/oracle-v1/set-event-format"
  }
};
const assets = {
