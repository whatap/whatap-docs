"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[78467],{
...
const metadata = {
  ...
  "title": "レポート",
  "description": "個別のプロジェクトについてサービスの利用状況と障害履歴を報告するドキュメントについて説明します。",
  "source": "@site/i18n/ja/docusaurus-plugin-content-docs/current/oracle-v1/report-intro.mdx",
  "sourceDirName": "oracle-v1",
  "slug": "/oracle-v1/report-intro",
  "permalink": "/ja/oracle-v1/report-intro",
  "draft": false,
  "unlisted": false,
  ...
  "next": {
    "title": "アラート通知",
    "permalink": "/ja/oracle-v1/set-notice"
  }
};
const assets = {
