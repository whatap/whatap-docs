"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[55538],{
...
const metadata = {
  ...
  "title": "Telegrafとは",
  "description": "Telegrafについて案内します。",
  "source": "@site/i18n/ja/docusaurus-plugin-content-docs/current/telegraf/introduction.mdx",
  "sourceDirName": "telegraf",
  "slug": "/telegraf/introduction",
  "permalink": "/ja/telegraf/introduction",
  "draft": false,
  "unlisted": false,
  "editUrl": "undefined/docs/telegraf/introduction.mdx",
  "tags": [],
  "version": "current",
  "frontMatter": {
    "id": "introduction",
...
function _createMdxContent(props) {
  ...
  return (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.Fragment, {
    children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.p, {
      children: "Telegrafは、データベース、システム、IoTセンサーからメトリクスとイベントを収集および送信するためのプラグインベースのサーバーエージェントです。TelegrafはGoで作成されており、外部の依存関係のない単一のバイナリとしてコンパイルされ、最小限のメモリリソースを利用します。"
    }), "\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.ul, {
      children: ["\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.li, {
        children: ["\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.p, {
          children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.strong, {
            children: "全種類のデータ収集・送信"
          })
        }), "\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.ul, {
          children: ["\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.li, {
            children: ["\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.p, {
              ...
              children: "MongoDB、MySQL、Redisなどのデータソースに接続し、メトリクスを収集および送信します。"
            }), "\n"]
          }), "\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.li, {
            children: ["\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.p, {
              children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.strong, {
              ...
              children: "最新のクラウドプラットフォーム、コンテナ、オーケストレータースタックからメトリクスを収集します。"
            }), "\n"]
          }), "\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.li, {
            children: ["\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.p, {
              children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.strong, {
              ...
              children: "IoTセンサーとデバイスから重要なステータスの保存データ(圧力レベル、温度レベルなど)を収集します。"
            }), "\n"]
          }), "\n"]
        }), "\n"]
      }), "\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.li, {
        children: ["\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.p, {
          children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.strong, {
            children: "Telegrafプラグイン"
          })
        }), "\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.p, {
          children: "Telegrafは、メトリクスを収集、処理、集計、および作成するプラグインベースのエージェントです。入力、出力、アグリゲーター、プロセッサーを含む4つのカテゴリのプラグインを提供します。"
        }), "\n"]
      }), "\n"]
    }), "\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.p, {
      children: "TelegrafのWhaTap output pluginを活用し、WhaTapのTelegrafエージェントをインストールして、Telegrafで収集するメトリクスをWhaTap収集サーバーに送信できます。"
    }), "\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(ImgLang, {
      img: "telegraf-sync-structure.png",
      desc: "Telegraf - WhaTap連携"
    }), "\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.admonition, {
      type: "note",
      children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.p, {
        children: "Telegrafプラグインまたはエージェントは、ユーザーがサービスに直接インストールおよび設定する必要があります。"
      })
    }), "\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.p, {
      children: "プラグインまたはエージェントのインストール方法と使用例を次のように提供します。"
