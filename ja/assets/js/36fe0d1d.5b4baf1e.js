"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[12664],{
...
/* harmony import */ var _common_items_check_agent_connection_mdx__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(96894);
...
const metadata = {
  ...
  "title": "インストールチェックリスト",
  "description": "エージェントをインストールした後に確認する必要があります。",
  "source": "@site/i18n/ja/docusaurus-plugin-content-docs/current/golang/install-check.mdx",
...
function _createMdxContent(props) {
  ...
  return (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.section, {
    ...
    children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.h2, {
      ...
      children: "次のコマンドを使用して、WhaTapエージェント(whata-agent) サービスの状態を確認してください。"
