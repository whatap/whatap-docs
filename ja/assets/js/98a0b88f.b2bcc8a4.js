  ...
  return (0,jsx_runtime.jsxs)(_components.ul, {
    children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
      ...
      children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
        ...
        children: ["spring-boot ExceptionHandlerを通過する例外(exception)が発生すると、以前に発生した例外に置き換えできます。 ", (0,jsx_runtime.jsx)(Cmdname, {
          sid: "TTL06209",
          className: "uitext"
        }), "画面の", (0,jsx_runtime.jsx)(Cmdname, {
          sid: "TTL06125",
          className: "uitext"
        }), "タブで例外(exception)を、spring-bootのExceptionHandlerに登録した例外で表示できます。"]
      }), "\n"]
    }), "\n"]
  });
}
