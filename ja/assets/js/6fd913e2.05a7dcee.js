"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[92719],{
...
const metadata = {
  ...
  "title": "インスタンスモニタリング",
  "description": "インスタンスモニタリングメニューでは、データベースサーバーの主なメトリクスに関する詳細情報をリアルタイムに確認できます。",
  "source": "@site/i18n/ja/docusaurus-plugin-content-docs/current/mssql/instance-monitoring.mdx",
  "sourceDirName": "mssql",
  ...
  "previous": {
    "title": "インスタンスリスト",
    "permalink": "/ja/mssql/instance-list"
  },
  "next": {
    "title": "マルチインスタンス",
