...
__webpack_require__.d(__webpack_exports__, {
  ...
  contentTitle: () => (/* binding */ log_exp_contentTitle),
  "default": () => (/* binding */ log_exp_MDXContent),
  frontMatter: () => (/* binding */ log_exp_frontMatter),
  metadata: () => (/* binding */ metadata),
  toc: () => (/* binding */ log_exp_toc)
});
...
const log_exp_contentTitle = undefined;
const metadata = {
  "id": "altibase/log-exp",
  "title": "로그 트렌드",
  "description": "로그 모니터링의 로그 트렌드 메뉴를 안내합니다.",
...
const log_exp_toc = [..._log_exp_toc];
function log_exp_createMdxContent(props) {
  return (0,jsx_runtime.jsx)(_log_exp_MDXContent, {});
}
function log_exp_MDXContent(props = {}) {
  const {wrapper: MDXLayout} = {
    ...(0,lib/* useMDXComponents */.R)(),
    ...props.components
  };
  return MDXLayout ? (0,jsx_runtime.jsx)(MDXLayout, {
    ...props,
    children: (0,jsx_runtime.jsx)(log_exp_createMdxContent, {
      ...props
    })
  }) : log_exp_createMdxContent(props);
}
