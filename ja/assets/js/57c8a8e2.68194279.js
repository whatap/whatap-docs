"use strict";
(self["webpackChunkwhatap_origin"] = self["webpackChunkwhatap_origin"] || []).push([[12128],{
...
const metadata = {
    ...
    "title": "メトリクスチャート",
    "description": "メトリック データはグラフで表示できます。",
    "source": "@site/i18n/ja/docusaurus-plugin-content-docs/current/oracle/metrics-chart.mdx",
    ...
    "next": {
        "title": "マトリックス異常検出",
        "permalink": "/ja/oracle/metrics-detect-anormal"
    }
};
const assets = {};
const toc = [
