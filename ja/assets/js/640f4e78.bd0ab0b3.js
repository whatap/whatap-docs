"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[7427],{
...
__webpack_require__.d(__webpack_exports__, {
  ...
  contentTitle: () => (/* binding */ set_event_format_contentTitle),
  "default": () => (/* binding */ set_event_format_MDXContent),
  frontMatter: () => (/* binding */ set_event_format_frontMatter),
  metadata: () => (/* binding */ metadata),
  toc: () => (/* binding */ set_event_format_toc)
});
...
;// CONCATENATED MODULE: ./docs/common-items/_common-event-format.mdx
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsxs)(_components.section, {
      ...
      children: [(0,jsx_runtime.jsx)(_components.h3, {
        ...
        children: ["이벤트 메시지에 포함할 수 있는 정보입니다. ", (0,jsx_runtime.jsx)(_components.code, {
          children: "optional"
        }), "이 ", (0,jsx_runtime.jsx)(_components.code, {
          children: "false"
        }), "인 경우 항상 메시지에 포함합니다. ", (0,jsx_runtime.jsx)(_components.code, {
          children: "optional"
        }), "이 ", (0,jsx_runtime.jsx)(_components.code, {
          children: "true"
...
;// CONCATENATED MODULE: ./docs/altibase-v1/set-event-format.mdx


const set_event_format_frontMatter = {
	id: 'set-event-format',
	title: '이벤트 수신 포맷',
...
const set_event_format_contentTitle = undefined;
const metadata = {
  "id": "altibase-v1/set-event-format",
  "title": "이벤트 수신 포맷",
  "description": "데이터베이스 모니터링에서 제공하는 경고 알림의 이벤트 수신 포맷에 대해 알아봅니다.",
  "source": "@site/docs/altibase-v1/set-event-format.mdx",
  "sourceDirName": "altibase-v1",
  "slug": "/altibase-v1/set-event-format",
  "permalink": "/ja/altibase-v1/set-event-format",
  "draft": false,
  "unlisted": false,
  "editUrl": "undefined/docs/altibase-v1/set-event-format.mdx",
  "tags": [],
  "version": "current",
  "frontMatter": {
    "id": "set-event-format",
  ...
  "previous": {
    "title": "이벤트 기록",
    "permalink": "/ja/altibase-v1/set-event-history"
  },
  "next": {
    "title": "실험실",
...
const set_event_format_toc = [...toc];
function set_event_format_createMdxContent(props) {
  return (0,jsx_runtime.jsx)(MDXContent, {});
}
function set_event_format_MDXContent(props = {}) {
  const {wrapper: MDXLayout} = {
    ...(0,lib/* useMDXComponents */.R)(),
    ...props.components
  };
  return MDXLayout ? (0,jsx_runtime.jsx)(MDXLayout, {
    ...props,
    children: (0,jsx_runtime.jsx)(set_event_format_createMdxContent, {
      ...props
    })
  }) : set_event_format_createMdxContent(props);
}
