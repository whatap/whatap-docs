"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[79472],{
...
const metadata = {
  ...
  "title": "アプリケーション警告通知",
  "description": "アプリケーションのリソース使用量および進行中トランザクション、エラー状況のイベント条件を通じて警告通知を送信します。",
  "source": "@site/i18n/ja/docusaurus-plugin-content-docs/current/java/warning-notice.mdx",
  "sourceDirName": "java",
  "slug": "/java/warning-notice",
  "permalink": "/ja/java/warning-notice",
  "draft": false,
  "unlisted": false,
  ...
  "previous": {
    "title": "アラート通知",
    "permalink": "/ja/java/apm-set-notice"
  },
  "next": {
    "title": "イベント設定",
    "permalink": "/ja/java/warning-notice-v2"
  }
};
const assets = {
