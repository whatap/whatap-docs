"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[66554],{
...
/* harmony import */ var _common_items_db_oracle_column_mdx__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(87813);
...
const metadata = {
  ...
  "title": "並列クエリツリー",
  "description": "1日の間にParallel Queryが発生した傾向を分析できる機能を提供します。",
  "source": "@site/i18n/ja/docusaurus-plugin-content-docs/current/oracle/analysis-pq-tree.mdx",
  ...
  return (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.Fragment, {
    children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_common_items_import_v2_note_mdx__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .Ay, {
      ...
      children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(Cmdname, {
        sid: "side_dbPqTree",
        className: "uitext"
      }), "(Parallel Query Tree)は、1日の間にParallel Queryが発生した傾向を分析できる機能を提供します。 実際のタスクを実行するSlave Processと、それらにタスクを割り当てたCoordinator Processとを区別して表示し、全体の実行情報をわかりやすく表示します。 特定の時点で実行したParallel Query情報を提供し、どのような目的で使用されているかを確認するのに役立ちます。"]
      ...
      children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.h2, {
        ...
        children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(Cmdname, {
          sid: "time",
          className: "uitext"
        }), "項目で照会する時間を設定した後", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(Cmdname, {
          sid: "instance",
          className: "uitext"
        }), "項目で並列クエリ情報を照会するインスタンスを選択してください。"]
      }), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.p, {
        children: "グラフチャートで設定した条件に合ったパラレルクエリ情報の推移を確認することができます。CoordinatorとSlaveの構造をツリー形式で表現して提供します。"
