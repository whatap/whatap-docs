"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[46228],{
...
const metadata = {
  ...
  "title": "ウィジェットテンプレート",
  "description": "Flexボードでダッシュボードに配置できるウィジェットの種類を案内します。",
  "source": "@site/i18n/ja/docusaurus-plugin-content-docs/current/server/flexboard-widget-template.mdx",
