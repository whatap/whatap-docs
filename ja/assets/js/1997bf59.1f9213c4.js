"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[36915],{
...
const metadata = {
  ...
  "title": "参照文書",
  "description": "WhaTap Docsで使用される主要な概念と用語に関する資料集です。",
  "source": "@site/i18n/ja/docusaurus-plugin-content-docs/current/reference.mdx",
  "sourceDirName": ".",
  "slug": "/reference",
...
function _createMdxContent(props) {
  ...
  return (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.Fragment, {
    children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.p, {
      children: ["WhaTap Docsで使用する主要な概念と用語に関する資料集です。 以下の資料に加えて、技術文書について質問や追加内容の要望などのフィードバックを", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.a, {
