"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[21589],{
...
const metadata = {
  ...
  "title": "OpenAPIの呼び出し",
  "description": "プロジェクト関連のOpen API呼び出し方法の説明です。",
  "source": "@site/i18n/ja/docusaurus-plugin-content-docs/current/apidoc/openapi-call.mdx",
...
function _createMdxContent(props) {
  ...
  return (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.Fragment, {
    children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.p, {
      children: "Open API呼び出し時、ACCOUNTAPI TOKENまたはプロジェクトコードとPROJECT API TOKENをヘッダーへ送信します。本文では、curlによる呼び出しの例を示します。"
