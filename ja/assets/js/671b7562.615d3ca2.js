"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[10411],{
...
const metadata = {
  ...
  "title": "アラートメッセージユーザーの定義",
  "description": "プロジェクトメンバーに送信されるアラート通知メッセージを修正できるユーザー定義機能を提供します。",
  "source": "@site/i18n/ja/docusaurus-plugin-content-docs/current/oracle-v1/set-notification-message.mdx",
  "sourceDirName": "oracle-v1",
  "slug": "/oracle-v1/set-notification-message",
  "permalink": "/ja/oracle-v1/set-notification-message",
  "draft": false,
  "unlisted": false,
  ...
  "previous": {
    "title": "メトリクスアラートの通知",
    "permalink": "/ja/oracle-v1/metric-warning-notice"
  },
  "next": {
    "title": "異常値検知の警告通知",
    "permalink": "/ja/oracle-v1/set-event-detect-anomal"
  }
};
const assets = {
