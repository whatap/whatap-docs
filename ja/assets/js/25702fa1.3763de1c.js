"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[59295],{
...
const metadata = {
  ...
  "title": "アプリケーションダッシュボード",
  "description": "ウェブアプリケーションサーバーのリソースをリアルタイムでモニタリングできます。",
  "source": "@site/i18n/ja/docusaurus-plugin-content-docs/current/nodejs/dashboard.mdx",
  "sourceDirName": "nodejs",
  "slug": "/nodejs/dashboard",
  "permalink": "/ja/nodejs/dashboard",
  "draft": false,
  "unlisted": false,
  ...
  "previous": {
    "title": "ダッシュボード",
    "permalink": "/ja/nodejs/dashboard-intro"
  },
  "next": {
    "title": "TXマップ",
    "permalink": "/ja/nodejs/dashboard-transactionmap"
  }
};
const assets = {
