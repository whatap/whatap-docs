"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[66692],{
...
const metadata = {
  "id": "altibase/flexboard-widget-template",
  "title": "ウィジェットテンプレート",
  "description": "Flexボードでダッシュボードに配置できるウィジェットの種類を案内します。",
  "source": "@site/i18n/ja/docusaurus-plugin-content-docs/current/altibase/flexboard-widget-template.mdx",
  "sourceDirName": "altibase",
  "slug": "/altibase/flexboard-widget-template",
  "permalink": "/ja/altibase/flexboard-widget-template",
  "draft": false,
  "unlisted": false,
  "editUrl": "undefined/docs/altibase/flexboard-widget-template.mdx",
  "tags": [],
  "version": "current",
  "frontMatter": {
    "id": "flexboard-widget-template",
