"use strict";
(self["webpackChunkwhatap_origin"] = self["webpackChunkwhatap_origin"] || []).push([[90138],{
...
const metadata = {
    "unversionedId": "altibase/multi-instance-monitoring",
    "id": "altibase/multi-instance-monitoring",
    "title": "マルチインスタンスモニタリング",
    "description": "複数のデータベースインスタンスの主要メトリクスを統合および表示できる機能を提供します。",
    "source": "@site/i18n/ja/docusaurus-plugin-content-docs/current/altibase/multi-instance-monitoring.mdx",
