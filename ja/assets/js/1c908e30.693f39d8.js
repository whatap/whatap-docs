"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[39536],{
...
function _createMdxContent(props) {
  ...
  return (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.section, {
    ...
    children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.h2, {
      id: "カラム表示または非表示",
      children: "カラム表示または非表示"
    }), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.p, {
      children: ["インスタンスリストのパフォーマンスのインジケータカラムを表示または非表示にすることができます。画面右上の", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(Cmdname, {
        sid: "column_select",
        className: "uitext"
      }), "ボタンをクリックしてください。目的の項目を選択または、選択を解除してください。カラムを表示または非表示にすることができます。"]
    })]
  });
}
...
function _createMdxContent(props) {
  ...
  return (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.section, {
    ...
    children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.h2, {
      id: "インスタンス性能指標の比較",
      children: "インスタンス性能指標の比較"
    }), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.p, {
      children: ["2つ以上のインスタンスを選択して、性能指標を比較できます。性能指標を比較するインスタンスを一覧から選択すると、画面右上の", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(Cmdname, {
        sid: "multi_view",
        className: "uitext"
      }), "ボタンが活性化されます。", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(Cmdname, {
        sid: "multi_view",
        className: "uitext"
      }), "ボタンを選択すると、 ", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(Cmdname, {
        sid: "side_multiInstance",
        className: "uitext"
      }), "メニューに移動します。主要な性能指標のデータを比較したグラフチャートとアクティブセッション、ロックツリーに関する詳細情報を確認できます。"]
      ...
      children: ["\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.li, {
        children: ["\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.p, {
          children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.img, {
            ...
            width: "35",
            height: "35"
          }), "領域は、プロジェクトに設定されているインスタンスの状態を表示します。表示されたステータス情報は、インスタンスの合計数と一致し、テーブルの", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(Cmdname, {
            sid: "status",
            className: "uitext"
          }), "カラム情報と一致します。"]
            ...
            children: ["\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.li, {
              ...
              children: ["\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.p, {
                children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("span", {
                  ...
                  sid: "side_eventNoti",
                  className: "uitext"
                }), "メニューで設定したイベントの臨界値が", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("span", {
                  class: "slow",
                  children: "警告"
                }), "レベルを超えたエージェントの数です。"]
              }), "\n"]
        ...
        children: ["\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.p, {
          children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(Cmdname, {
            sid: "status",
            className: "uitext"
          }), "カラムで正常でない状態アイコンをクリックすると", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(Cmdname, {
            sid: "event",
            className: "uitext"
          }), "ウィンドウが表示されます。そのインスタンスで発生したイベントの履歴を確認できます。"]
        }), "\n"]
      }), "\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.li, {
        children: ["\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.p, {
          children: ["各インスタンスを選択すると、", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(Cmdname, {
            sid: "side_dbMonitoring",
            className: "uitext"
          }), "メニューが表示されます。選択したインスタンスの詳細をリアルタイムでモニタリングできます。"]
        }), "\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.admonition, {
          type: "note",
          children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.p, {
            children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(Cmdname, {
        ...
        children: ["\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.p, {
          children: ["主要なパフォーマンス指標をグラフチャート形式で提供します。最も高い数値をチャートに表示します。チャートにカーソルを合わせると、その場所の数値が表示されます。パフォーマンス指標の詳細については、", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.a, {
        ...
        children: ["\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.li, {
          children: ["\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.p, {
            children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(Cmdname, {
              ...
              sid: "server_name",
              className: "uitext"
            }), "カラムに表示された", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("span", {
              class: "mark master",
              children: "M"
              ...
              class: "mark master",
              children: "C"
            }), "は、それぞれMaster、Slave、Clusterを意味します。Replicationで構成したDBの場合に表示します。"]
          }), "\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.p, {
            children: ["Replicationインスタンスが異常な状態の場合", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(LinkImage, {
      ...
      children: ["\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.li, {
        children: ["\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.p, {
          children: ["画面右上の", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.img, {
            ...
            width: "24",
            height: "24"
          }), "ボタンをクリックすると、リアルタイムの通知が確認できます。通知設定の詳細については、", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.a, {
            href: "set-notice",
            children: "次の文書"
          }), "を参照してください。"]
        }), "\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.admonition, {
          type: "note",
          children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.p, {
            children: ["画面のにある固定領域の詳細については、", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.a, {
...
function _createMdxContent(props) {
  ...
  return (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.Fragment, {
    children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.p, {
      ...
      children: "エージェントをインストールしたデータベースサーバーの一覧を表示し、各インスタンスの主要なパフォーマンス指標と状態を把握することができます。パフォーマンス指標は、5秒間隔で更新され、カラム設定を使用して順序を変更したり、目的の指標に変更することができます。"
    })]
  });
}
function MDXContent(props = {}) {
...
/* harmony import */ var _common_items_db_instance_list_desc_mdx__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(84016);
/* harmony import */ var _common_items_db_instance_list_basic_usage_mdx__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(18331);
/* harmony import */ var _common_items_db_comapre_instance_performance_mdx__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(20940);
/* harmony import */ var _common_items_db_column_display_hide_mdx__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(71030);
...
const metadata = {
  ...
  "title": "インスタンスリスト",
  "description": "エージェントをインストールしたデータベースサーバーの一覧を確認できます。",
  "source": "@site/i18n/ja/docusaurus-plugin-content-docs/current/oracle/instance-list.mdx",
  ...
  "previous": {
    "title": "ダッシュボード",
    "permalink": "/ja/oracle/dashboard-intro"
  },
  "next": {
    "title": "インスタンスモニタリング",
