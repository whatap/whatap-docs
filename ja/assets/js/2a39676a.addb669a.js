"use strict";
(self["webpackChunkwhatap_origin"] = self["webpackChunkwhatap_origin"] || []).push([[67733],{
...
const metadata = {
    ...
    "title": "メトリクスチャート",
    "description": "メトリック データはグラフで表示できます。",
    "source": "@site/i18n/ja/docusaurus-plugin-content-docs/current/server/metrics-chart.mdx",
    "sourceDirName": "server",
    "slug": "/server/metrics-chart",
    "permalink": "/ja/server/metrics-chart",
    "draft": false,
