"use strict";
(self["webpackChunkwhatap_origin"] = self["webpackChunkwhatap_origin"] || []).push([[3654],{
...
const metadata = {
    "unversionedId": "tibero/agent-settings",
    "id": "tibero/agent-settings",
    "title": "設定",
    "description": "データベースエージェントサーバーのwhatap.confファイルを使用して設定できるオプションについて説明します。",
    "source": "@site/i18n/ja/docusaurus-plugin-content-docs/current/tibero/agent-settings.mdx",
    "sourceDirName": "tibero",
    "slug": "/tibero/agent-settings",
    "permalink": "/ja/tibero/agent-settings",
    "draft": false,
    "editUrl": "undefined/docs/tibero/agent-settings.mdx",
    "tags": [
        {
            "label": "Tibero",
...
function MDXContent(_param) {
    ...
    return /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)(MDXLayout, _object_spread_props(_object_spread({}, layoutProps, props), {
        ...
        mdxType: "MDXLayout"
    }), /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("p", null, `WhaTapエージェントの構成について学習したり、様々なオプション設定して、モニタリング対象DBサーバーのリソースをモニタリングすることもできます。`), /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)(_theme_DocCardList__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .Z, {
        mdxType: "DocCardList"
    }));
}
