"use strict";
(self["webpackChunkwhatap_origin"] = self["webpackChunkwhatap_origin"] || []).push([[94878],{
...
const metadata = {
    "unversionedId": "server/set-agent",
    "id": "server/set-agent",
    "title": "設定",
    "description": "サーバーエージェントのオプションについて説明します。",
    "source": "@site/i18n/ja/docusaurus-plugin-content-docs/current/server/set-agent.mdx",
    "sourceDirName": "server",
    "slug": "/server/set-agent",
    "permalink": "/ja/server/set-agent",
    "draft": false,
    "editUrl": "undefined/docs/server/set-agent.mdx",
    "tags": [
        {
            "label": "Server",
...
function MDXContent(_param) {
    ...
    return /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)(MDXLayout, _object_spread_props(_object_spread({}, layoutProps, props), {
        ...
        mdxType: "MDXLayout"
    }), /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("p", null, `WhaTapエージェントは、エージェントごとに必要な設定を`, /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("em", {
        parentName: "p"
    }, `whatap.conf`), `ファイルにに書き込みます。 エージェントは、環境変数を使用して設定ファイルを見つけて読み込みます。 `, /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("em", {
        parentName: "p"
    }, `whatap.conf`), `ファイルを使用して設定できるオプションは次のとおりです。`), /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)(_theme_DocCardList__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .Z, {
        mdxType: "DocCardList"
    }));
}
