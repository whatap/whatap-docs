"use strict";
(self["webpackChunkwhatap_origin"] = self["webpackChunkwhatap_origin"] || []).push([[91050],{
...
const metadata = {
    "unversionedId": "browser/flexboard-widget-manage",
    "id": "browser/flexboard-widget-manage",
    "title": "ウィジェットの管理",
    "description": "Flexボードに配置したウィジェットを管理します。",
    "source": "@site/i18n/ja/docusaurus-plugin-content-docs/current/browser/flexboard-widget-manage.mdx",
    "sourceDirName": "browser",
    "slug": "/browser/flexboard-widget-manage",
    "permalink": "/ja/browser/flexboard-widget-manage",
    "draft": false,
    "editUrl": "undefined/docs/browser/flexboard-widget-manage.mdx",
    "tags": [
        {
            "label": "ブラウザーモニタリング",
    ...
    "previous": {
        "title": "メトリクスウィジェット",
        "permalink": "/ja/browser/flexboard-metric-widget"
    },
    "next": {
        "title": "Flexボード画面モード",
