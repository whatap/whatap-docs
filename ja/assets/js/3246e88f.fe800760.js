"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[48727],{
...
const metadata = {
  "id": "altibase-v1/flexboard-manage",
  "title": "Flexボード管理",
  "description": "Flexボードでダッシュボードを編集し管理する方法を案内します。 ダッシュボードの名前変更、プロジェクトの選択、レイアウトの調整などの案内とウィジェットの追加、移動、サイズ調整、削除方法も案内します。 また、ウィジェットのデータソースを選択する方法と、ダッシュボードのjson形式への書き出し機能も説明します。",
  "source": "@site/i18n/ja/docusaurus-plugin-content-docs/current/altibase-v1/flexboard-manage.mdx",
  "sourceDirName": "altibase-v1",
  "slug": "/altibase-v1/flexboard-manage",
  "permalink": "/ja/altibase-v1/flexboard-manage",
  "draft": false,
  "unlisted": false,
  "editUrl": "undefined/docs/altibase-v1/flexboard-manage.mdx",
  "tags": [],
  "version": "current",
  "frontMatter": {
    "id": "flexboard-manage",
  ...
  "previous": {
    "title": "Flexボードの作成",
    "permalink": "/ja/altibase-v1/flexboard-create"
  },
  "next": {
    "title": "メトリクスウィジェット",
