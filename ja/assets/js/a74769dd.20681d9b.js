"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[39723],{
...
const metadata = {
  ...
  "title": "イベント設定",
  "description": "データベースのメトリクスごとのイベント条件設定を使用してアラート通知を送信します。",
  "source": "@site/i18n/ja/docusaurus-plugin-content-docs/current/mssql/warning-notice-v2.mdx",
  "sourceDirName": "mssql",
  "slug": "/mssql/warning-notice-v2",
  "permalink": "/ja/mssql/warning-notice-v2",
  "draft": false,
  "unlisted": false,
