...
__webpack_require__.d(__webpack_exports__, {
  ...
  contentTitle: () => (/* binding */ log_nodejs_contentTitle),
  "default": () => (/* binding */ log_nodejs_MDXContent),
  frontMatter: () => (/* binding */ log_nodejs_frontMatter),
  metadata: () => (/* binding */ metadata),
  toc: () => (/* binding */ log_nodejs_toc)
});
...
;// CONCATENATED MODULE: ./docs/common-items/_import_log-agent-setting-check.mdx
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsxs)(_components.p, {
      ...
      children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
        children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
          children: ["프로젝트 메뉴 하위에 ", (0,jsx_runtime.jsx)(_components.em, {
            children: (0,jsx_runtime.jsx)(_components.strong, {
              children: "관리"
            })
          }), " > ", (0,jsx_runtime.jsx)(_components.em, {
        ...
        children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
          ...
          }), "을 선택하세요. 입력창에 다음과 같이 ", (0,jsx_runtime.jsx)(_components.code, {
...
;// CONCATENATED MODULE: ./docs/common-items/_log-java-start.mdx


const _log_java_start_frontMatter = {};
const _log_java_start_contentTitle = (/* unused pure expression or super */ null && (undefined));





const _log_java_start_toc = [];
function _log_java_start_createMdxContent(props) {
  const _components = {
    img: "img",
    li: "li",
    ul: "ul",
  ...
  if (!ImgLang) _log_java_start_missingMdxReference("ImgLang", true);
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
...
function _log_java_start_MDXContent(props = {}) {
  const {wrapper: MDXLayout} = {
    ...(0,lib/* useMDXComponents */.R)(),
    ...props.components
  };
  return MDXLayout ? (0,jsx_runtime.jsx)(MDXLayout, {
    ...props,
    children: (0,jsx_runtime.jsx)(_log_java_start_createMdxContent, {
      ...props
    })
  }) : _log_java_start_createMdxContent(props);
}
function _log_java_start_missingMdxReference(id, component) {
  throw new Error("Expected " + (component ? "component" : "object") + " `" + id + "` to be defined: you likely forgot to import, pass, or provide it.");
}


;// CONCATENATED MODULE: ./docs/common-items/_log-active-note.mdx


const _log_active_note_frontMatter = {};
const _log_active_note_contentTitle = (/* unused pure expression or super */ null && (undefined));





const _log_active_note_toc = [];
function _log_active_note_createMdxContent(props) {
  const _components = {
    a: "a",
  ...
  return (0,jsx_runtime.jsxs)(_components.admonition, {
    ...
    children: [(0,jsx_runtime.jsx)(_components.p, {
      ...
      children: ["에이전트 설치 후 프로젝트에 대한 ", (0,jsx_runtime.jsx)(_components.strong, {
        children: "수정 권한"
...
function _log_active_note_MDXContent(props = {}) {
  const {wrapper: MDXLayout} = {
    ...(0,lib/* useMDXComponents */.R)(),
    ...props.components
  };
  return MDXLayout ? (0,jsx_runtime.jsx)(MDXLayout, {
    ...props,
    children: (0,jsx_runtime.jsx)(_log_active_note_createMdxContent, {
      ...props
    })
  }) : _log_active_note_createMdxContent(props);
}
...
const log_nodejs_contentTitle = undefined;
const metadata = {
  "id": "log/log-nodejs",
  "title": "Node.js",
  "description": "Node.js 애플리케이션에서 로그를 수집하는 방법을 안내합니다.",
...
const log_nodejs_toc = [{
  ...
  "id": "로그-모니터링-활성화",
  "level": 2
}, ..._log_java_start_toc, ..._log_active_note_toc];
function log_nodejs_createMdxContent(props) {
  const _components = {
    a: "a",
    code: "code",
    em: "em",
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsx)(_components.p, {
      ...
      }), (0,jsx_runtime.jsx)(_log_java_start_MDXContent, {}), (0,jsx_runtime.jsx)(_log_active_note_MDXContent, {})]
    })]
  });
}
function log_nodejs_MDXContent(props = {}) {
  const {wrapper: MDXLayout} = {
    ...(0,lib/* useMDXComponents */.R)(),
    ...props.components
  };
  return MDXLayout ? (0,jsx_runtime.jsx)(MDXLayout, {
    ...props,
    children: (0,jsx_runtime.jsx)(log_nodejs_createMdxContent, {
      ...props
    })
  }) : log_nodejs_createMdxContent(props);
}
