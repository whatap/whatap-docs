"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[93258],{
...
const metadata = {
  ...
  "title": "迅速なエージェント設定",
  "description": "DBXエージェントの構成ファイルの中でsetup.shファイルを実行すると、エージェントの設定を迅速かつ簡単に進めることができます。",
  "source": "@site/i18n/ja/docusaurus-plugin-content-docs/current/mysql/install-agent-quick-setup.mdx",
  "sourceDirName": "mysql",
