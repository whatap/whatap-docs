"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[65458],{
...
const metadata = {
  "id": "altibase-v1/metrics-search",
  "title": "メトリクス照会",
  "description": "メトリクスのRaw Dataを参照することができます。",
  "source": "@site/i18n/ja/docusaurus-plugin-content-docs/current/altibase-v1/metrics-search.mdx",
  "sourceDirName": "altibase-v1",
  "slug": "/altibase-v1/metrics-search",
  "permalink": "/ja/altibase-v1/metrics-search",
  "draft": false,
  "unlisted": false,
  "editUrl": "undefined/docs/altibase-v1/metrics-search.mdx",
  "tags": [],
  "version": "current",
  "frontMatter": {
    "id": "metrics-search",
  ...
  "next": {
    "title": "マトリックス異常検出",
    "permalink": "/ja/altibase-v1/metrics-detect-anormal"
  }
};
const assets = {
