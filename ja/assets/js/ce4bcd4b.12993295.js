"use strict";
(self["webpackChunkwhatap_origin"] = self["webpackChunkwhatap_origin"] || []).push([[57754],{
...
const metadata = {
    "unversionedId": "altibase/flexboard-widget-manage",
    "id": "altibase/flexboard-widget-manage",
    "title": "ウィジェットの管理",
    "description": "Flexボードに配置したウィジェットを管理します。",
    "source": "@site/i18n/ja/docusaurus-plugin-content-docs/current/altibase/flexboard-widget-manage.mdx",
    "sourceDirName": "altibase",
    "slug": "/altibase/flexboard-widget-manage",
    "permalink": "/ja/altibase/flexboard-widget-manage",
    "draft": false,
    "editUrl": "undefined/docs/altibase/flexboard-widget-manage.mdx",
    "tags": [
        {
            "label": "Altibase",
    ...
    "previous": {
        "title": "メトリクスウィジェット",
        "permalink": "/ja/altibase/flexboard-metric-widget"
    },
    "next": {
        "title": "Flexボード画面モード",
        "permalink": "/ja/altibase/flexboard-mode"
    }
};
const assets = {};
const toc = [
