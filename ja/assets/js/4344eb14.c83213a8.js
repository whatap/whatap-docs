"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[3214],{
...
const metadata = {
  "id": "mssql/metrics-search",
  "title": "メトリクス照会",
  "description": "メトリクスのRaw Dataを参照することができます。",
  "source": "@site/i18n/ja/docusaurus-plugin-content-docs/current/mssql/metrics-search.mdx",
  "sourceDirName": "mssql",
  "slug": "/mssql/metrics-search",
  "permalink": "/ja/mssql/metrics-search",
  "draft": false,
  "unlisted": false,
  "editUrl": "undefined/docs/mssql/metrics-search.mdx",
  "tags": [],
  "version": "current",
  "frontMatter": {
    "id": "metrics-search",
