...
const metadata = {
    ...
    "title": "アプリケーション警告通知",
    "description": "アプリケーションのリソース使用量および進行中トランザクション、エラー状況のイベント条件を通じて警告通知を送信します。",
    "source": "@site/i18n/ja/docusaurus-plugin-content-docs/current/nodejs/warning-notice.mdx",
    "sourceDirName": "nodejs",
    "slug": "/nodejs/warning-notice",
    "permalink": "/ja/nodejs/warning-notice",
    "draft": false,
    ...
    "previous": {
        "title": "アラートの設定",
        "permalink": "/ja/nodejs/apm-set-notice"
    },
    "next": {
        "title": "メトリックアラート通知",
