"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[17591],{
...
const metadata = {
  "id": "amazon-ecs/flexboard-widget-template",
  "title": "ウィジェットテンプレート",
  "description": "Flexボードでダッシュボードに配置できるウィジェットの種類を案内します。",
  "source": "@site/i18n/ja/docusaurus-plugin-content-docs/current/amazon-ecs/flexboard-widget-template.mdx",
  "sourceDirName": "amazon-ecs",
  "slug": "/amazon-ecs/flexboard-widget-template",
  "permalink": "/ja/amazon-ecs/flexboard-widget-template",
  "draft": false,
  "unlisted": false,
  "editUrl": "undefined/docs/amazon-ecs/flexboard-widget-template.mdx",
  "tags": [],
  "version": "current",
  "frontMatter": {
    "id": "flexboard-widget-template",
