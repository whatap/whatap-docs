"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[76593],{
...
const metadata = {
  ...
  "title": "警告通知の受信設定",
  "description": "プロジェクトに含まれるメンバーの警告通知の受信に関連した各種機能を設定できます。",
  "source": "@site/i18n/ja/docusaurus-plugin-content-docs/current/cubrid/set-receive-event.mdx",
  "sourceDirName": "cubrid",
  "slug": "/cubrid/set-receive-event",
  "permalink": "/ja/cubrid/set-receive-event",
  "draft": false,
  "unlisted": false,
  ...
  "next": {
    "title": "イベント履歴",
    "permalink": "/ja/cubrid/set-event-history"
  }
};
const assets = {
