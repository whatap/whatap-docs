"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[35971],{
...
const metadata = {
  ...
  "title": "SQL統計",
  "description": "Oracleのデータベースごとの統計データを提供します。",
  "source": "@site/i18n/ja/docusaurus-plugin-content-docs/current/oracle-v1/stat.mdx",
  "sourceDirName": "oracle-v1",
  "slug": "/oracle-v1/stat",
  "permalink": "/ja/oracle-v1/stat",
  "draft": false,
  "unlisted": false,
  ...
  "previous": {
    "title": "マトリックス異常検出",
    "permalink": "/ja/oracle-v1/metrics-detect-anormal"
  },
  "next": {
    "title": "テーブルスペースサイズ",
    "permalink": "/ja/oracle-v1/table-space-size"
  }
};
const assets = {
