"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[23375],{
...
const metadata = {
  ...
  "title": "警告通知の受信設定",
  "description": "プロジェクトに含まれるメンバーの警告通知の受信に関連した各種機能を設定できます。",
  "source": "@site/i18n/ja/docusaurus-plugin-content-docs/current/tibero/set-receive-event.mdx",
  "sourceDirName": "tibero",
  "slug": "/tibero/set-receive-event",
  "permalink": "/ja/tibero/set-receive-event",
  "draft": false,
  "unlisted": false,
  ...
  "next": {
    "title": "イベント履歴",
    "permalink": "/ja/tibero/set-event-history"
  }
};
const assets = {
