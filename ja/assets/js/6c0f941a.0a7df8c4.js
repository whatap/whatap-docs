"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[97793],{
...
const metadata = {
  ...
  "title": "アラートメッセージユーザーの定義",
  "description": "プロジェクトメンバーに送信されるアラート通知メッセージを修正できるユーザー定義機能を提供します。",
  "source": "@site/i18n/ja/docusaurus-plugin-content-docs/current/altibase/set-notification-message.mdx",
  "sourceDirName": "altibase",
  "slug": "/altibase/set-notification-message",
  "permalink": "/ja/altibase/set-notification-message",
  "draft": false,
  "unlisted": false,
  ...
  "previous": {
    "title": "メトリクスアラートの通知",
    "permalink": "/ja/altibase/metric-warning-notice"
  },
  "next": {
    "title": "異常値検知の警告通知",
