"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[75137],{
...
;// CONCATENATED MODULE: ./docs/common-items/_import_metrics-intro-exam.mdx
...
function _createMdxContent(props) {
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsxs)(_components.p, {
      children: ["수집한 데이터를 조회하려면 홈 화면에서 프로젝트를 선택한 다음 ", (0,jsx_runtime.jsx)(_components.em, {
      ...
      children: ["예를 들어 ", (0,jsx_runtime.jsx)("code", {
        children: props.category
      }), "라는 이름의 카테고리를 선택하고 관련 지표를 조회하면 다음과 같이 카테고리에 해당하는 태그(", (0,jsx_runtime.jsx)("b", {
        children: "Tags"
      }), ")와 필드(", (0,jsx_runtime.jsx)("b", {
        children: "Fields"
      }), ") 항목을 확인할 수 있습니다."]
    })]
  });
...
;// CONCATENATED MODULE: ./docs/common-items/_metrics-intro.desc.mdx


const _metrics_intro_desc_frontMatter = {};
const _metrics_intro_desc_contentTitle = (/* unused pure expression or super */ null && (undefined));





const _metrics_intro_desc_toc = [{
  "value": "메트릭스란?",
  "id": "메트릭스란",
  "level": 2
}];
function _metrics_intro_desc_createMdxContent(props) {
  const _components = {
    em: "em",
    h2: "h2",
    li: "li",
  ...
  return (0,jsx_runtime.jsxs)(_components.section, {
    ...
    children: [(0,jsx_runtime.jsx)(_components.h2, {
      ...
      children: ["와탭은 모니터링 대상으로부터 데이터를 수집해서 사용자에게 제공합니다. 에이전트로부터 수집되는 데이터를 ", (0,jsx_runtime.jsx)(_components.strong, {
        children: "메트릭스"
      }), "라고 부릅니다."]
...
function _metrics_intro_desc_MDXContent(props = {}) {
  const {wrapper: MDXLayout} = {
    ...(0,lib/* useMDXComponents */.R)(),
    ...props.components
  };
  return MDXLayout ? (0,jsx_runtime.jsx)(MDXLayout, {
    ...props,
    children: (0,jsx_runtime.jsx)(_metrics_intro_desc_createMdxContent, {
      ...props
    })
  }) : _metrics_intro_desc_createMdxContent(props);
}
...
;// CONCATENATED MODULE: ./docs/common-items/_metrics-intro-data-search-desc.mdx


const _metrics_intro_data_search_desc_frontMatter = {};
const _metrics_intro_data_search_desc_contentTitle = (/* unused pure expression or super */ null && (undefined));





const _metrics_intro_data_search_desc_toc = [{
  "value": "메트릭스 데이터 조회 및 시각화",
  "id": "메트릭스-데이터-조회-및-시각화",
  "level": 2
}];
function _metrics_intro_data_search_desc_createMdxContent(props) {
  const _components = {
    h2: "h2",
    p: "p",
    section: "section",
  ...
  if (!Cmdname) _metrics_intro_data_search_desc_missingMdxReference("Cmdname", true);
  if (!ImgLang) _metrics_intro_data_search_desc_missingMdxReference("ImgLang", true);
  return (0,jsx_runtime.jsxs)(_components.section, {
    className: "remark-sectionize-h2",
    children: [(0,jsx_runtime.jsx)(_components.h2, {
      id: "메트릭스-데이터-조회-및-시각화",
      ...
      children: ["와탭은 사용자가 지정한 조건에 따라 수집한 원본 데이터 목록과 편의성을 위해 다양하게 시각화한 차트를 다음과 같이 제공합니다. 메트릭스의 원본 데이터를 조회할 수 있는 ", (0,jsx_runtime.jsx)(Cmdname, {
        sid: "tag_count",
        className: "uitext"
      }), ", 시각화한 차트를 통해 메트릭스 데이터를 조회할 수 있는 ", (0,jsx_runtime.jsx)(Cmdname, {
        sid: "tag_count_chart",
        className: "uitext"
      }), ", AI가 학습한 메트릭스 지표의 패턴과 비교해 예상 패턴을 벗어난 이상을 탐지할 수 있는 ", (0,jsx_runtime.jsx)(Cmdname, {
...
function _metrics_intro_data_search_desc_MDXContent(props = {}) {
  const {wrapper: MDXLayout} = {
    ...(0,lib/* useMDXComponents */.R)(),
    ...props.components
  };
  return MDXLayout ? (0,jsx_runtime.jsx)(MDXLayout, {
    ...props,
    children: (0,jsx_runtime.jsx)(_metrics_intro_data_search_desc_createMdxContent, {
      ...props
    })
  }) : _metrics_intro_data_search_desc_createMdxContent(props);
}
function _metrics_intro_data_search_desc_missingMdxReference(id, component) {
  throw new Error("Expected " + (component ? "component" : "object") + " `" + id + "` to be defined: you likely forgot to import, pass, or provide it.");
}


;// CONCATENATED MODULE: ./docs/altibase-v1/metrics-intro.mdx
...
const metadata = {
  ...
  "title": "메트릭스",
  "description": "데이터베이스 모니터링 분석을 위한 메트릭스 메뉴에 대해 알아봅니다.",
  "source": "@site/docs/altibase-v1/metrics-intro.mdx",
  "sourceDirName": "altibase-v1",
  "slug": "/altibase-v1/metrics-intro",
  "permalink": "/ja/altibase-v1/metrics-intro",
  "draft": false,
  "unlisted": false,
  "editUrl": "undefined/docs/altibase-v1/metrics-intro.mdx",
  "tags": [],
  "version": "current",
  "frontMatter": {
    "id": "metrics-intro",
...
const metrics_intro_toc = [..._metrics_intro_desc_toc, ...toc, ..._metrics_intro_data_search_desc_toc];
function metrics_intro_createMdxContent(props) {
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: ["\n", "\n", (0,jsx_runtime.jsx)(_metrics_intro_desc_MDXContent, {}), "\n", (0,jsx_runtime.jsx)(MDXContent, {
      category: "db_altibase_counter"
    }), "\n", (0,jsx_runtime.jsx)(ChangeImgName/* default */.A, {
      img: "metrics-example-00.png",
      desc: ""
    }), "\n", "\n", "\n", (0,jsx_runtime.jsx)(_metrics_intro_data_search_desc_MDXContent, {})]
  });
}
