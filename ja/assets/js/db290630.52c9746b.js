"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[42941],{
...
const metadata = {
  ...
  "title": "Flexボード画面モード",
  "description": "Flexボードの画面モードに応じて提供する機能について案内します。",
  "source": "@site/i18n/ja/docusaurus-plugin-content-docs/current/server/flexboard-mode.mdx",
  "sourceDirName": "server",
  "slug": "/server/flexboard-mode",
  "permalink": "/ja/server/flexboard-mode",
  "draft": false,
  "unlisted": false,
  ...
  "previous": {
    "title": "ウィジェットテンプレート",
    "permalink": "/ja/server/flexboard-widget-template"
  },
  "next": {
    "title": "Flexボード共有",
    "permalink": "/ja/server/flexboard-share"
  }
};
const assets = {
