"use strict";
(self["webpackChunkwhatap_origin"] = self["webpackChunkwhatap_origin"] || []).push([[98652],{
...
const metadata = {
    ...
    "title": "ウィジェットの管理",
    "description": "Flexボードに配置したウィジェットを管理します。",
    "source": "@site/i18n/ja/docusaurus-plugin-content-docs/current/azure/flexboard-widget-manage.mdx",
    "sourceDirName": "azure",
    ...
    "previous": {
        "title": "メトリクスウィジェット",
        "permalink": "/ja/azure/flexboard-metric-widget"
    },
    "next": {
        "title": "Flexボード画面モード",
