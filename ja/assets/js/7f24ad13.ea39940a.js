"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[65405],{
...
const metadata = {
  ...
  "title": "警告通知の受信設定",
  "description": "プロジェクトに含まれるメンバーの警告通知の受信に関連した各種機能を設定できます。",
  "source": "@site/i18n/ja/docusaurus-plugin-content-docs/current/browser/set-receive-event.mdx",
  "sourceDirName": "browser",
  "slug": "/browser/set-receive-event",
  "permalink": "/ja/browser/set-receive-event",
  "draft": false,
  "unlisted": false,
  ...
  "previous": {
    "title": "イベント設定",
    "permalink": "/ja/browser/warning-notice-v2"
  },
  "next": {
    "title": "イベント履歴",
