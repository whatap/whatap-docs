"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[82246],{
...
const metadata = {
  ...
  "title": "コンテナイメージ",
  "description": "コンテナで使用しているイメージ情報を提供します。",
  "source": "@site/i18n/ja/docusaurus-plugin-content-docs/current/kubernetes/container-images.mdx",
  ...
  return (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.Fragment, {
    children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.p, {
      ...
      children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(Cmdname, {
        sid: "containerImages",
        className: "uitext"
      }), "メニューを通じてコンテナで使用しているイメージ情報とそのイメージに基づいて実行中のコンテナの個数及びCPU、Memory使用総量をリスト形式で確認することができます。"]
      ...
      children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.h3, {
        ...
        children: ["フィルターのウィンドウで", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(Cmdname, {
          sid: "TTL06740",
          className: "uitext"
        }), "選択時、", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.strong, {
      ...
      children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.h3, {
        ...
        children: ["上段右側の", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(Cmdname, {
          ...
          className: "uitext"
        }), "ボタンを選択すると、元のデータを_CSV_形式のファイルとしてダウンロードできます。 ファイル名は、", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.code, {
          children: "kubernetes_container_images_"
        }), "後にプロジェクトコードとデータ照会時点のタイムスタンプを加えて作成します。"]
      ...
      children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.h3, {
        ...
        children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.strong, {
        ...
        }), " カラム右の", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.img, {
          alt: "詳細を見るアイコン",
          ...
          sid: "TLT07247",
          className: "uitext"
        }), "アイコンを選択すると、そのイメージが検索された", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(Cmdname, {
          sid: "container_list",
          className: "uitext"
        }), "メニューに移動します。"]
      })]
