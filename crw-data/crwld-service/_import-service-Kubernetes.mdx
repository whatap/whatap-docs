...
- <code class="Feature">Feature</code> <Cmdname sid="side_management" className="uitext" /> 메뉴 하위로 <Cmdname sid="side_correlatedProjectManagement" className="uitext" /> 메뉴 추가: 연계 프로젝트 등록, 조회, 삭제 기능 <code class='changelog-service'><a href="https://docs.whatap.io/release-notes/service/service-2_0_x"><code class='changelog-service'>Service 2.0.0​</code></a></code>
...
- <code class="Feature">Feature</code> <Cmdname sid="side_resource" className="uitext" /> 메뉴 하위로 다음의 메뉴 추가 <code class='changelog-service'><a href="https://docs.whatap.io/release-notes/service/service-2_0_x"><code class='changelog-service'>Service 2.0.0​</code></a></code>
...
- <code class="Changed">Changed</code> <UI>오브젝트 매니페스트</UI> 지원 마스터 에이전트 버전 <b>1.5.2</b>로 변경 <code class='changelog-service'><a href="https://docs.whatap.io/release-notes/service/service-2_1_x"><code class='changelog-service'>Service 2.1.3​</code></a></code>대시보드​

- <code class="New">New</code> <Cmdname sid="side_kubeApiserverDashboard" className="uitext" /> 메뉴 추가 <code class='changelog-service'><a href="https://docs.whatap.io/release-notes/service/service-2_2_x"><code class='changelog-service'>Service 2.2.0​</code></a></code>

- <code class="New">New</code> <Cmdname sid="side_kubernetesAgentList" className="uitext" /> 메뉴 추가 <code class='changelog-service'><a href="https://docs.whatap.io/release-notes/service/service-2_2_x"><code class='changelog-service'>Service 2.2.0​</code></a></code>

- <code class="Changed">Changed</code> <Cmdname sid="side_cluster" className="uitext" /> &gt; <Cmdname sid="side_objectManifest" className="uitext" /> 메뉴에서 <Cmdname sid="compare" className="uitext" /> 기능의 UI 수정 및 목차 기능 추가 <code class='changelog-service'><a href="https://docs.whatap.io/release-notes/service/service-2_2_x"><code class='changelog-service'>Service 2.2.0​</code></a></code>

- <code class="Changed">Changed</code> <Cmdname sid="container" className="uitext" /> &gt; <Cmdname sid="side_containerList" className="uitext" /> 메뉴에서 비교하기 기능 이용 시 <Cmdname sid="kube_default" className="uitext" />, <Cmdname sid="cpu" className="uitext" /> 탭에 <span class="uitext">Container CPU Usage</span> 차트 추가 <code class='changelog-service'><a href="https://docs.whatap.io/release-notes/service/service-2_2_x"><code class='changelog-service'>Service 2.2.0​</code></a></code>

- <code class="Feature">Feature</code> <Cmdname sid="side_dashboard" className="uitext" /> &gt; <Cmdname sid="side_containerMap" className="uitext" /> 메뉴에서 레플리케이션 컨트롤러(ReplicationController) 그룹화 옵션 추가 <code class='changelog-service'><a href="https://docs.whatap.io/release-notes/service/service-2_2_x"><code class='changelog-service'>Service 2.2.0​</code></a></code>

- <code class="New">New</code> <Cmdname sid="side_kubeApiserverMetricsSearch" className="uitext" /> 메뉴 추가 <code class='changelog-service'><a href="https://docs.whatap.io/release-notes/service/service-2_3_x"><code class='changelog-service'>Service 2.3.0​</code></a></code>

- <code class="New">New</code> <Cmdname sid="side_deploymentList" className="uitext" /> 메뉴 추가 <code class='changelog-service'><a href="https://docs.whatap.io/release-notes/service/service-2_3_x"><code class='changelog-service'>Service 2.3.0​</code></a></code>
...
- <code class="Feature">Feature</code> <Cmdname sid="side_dashboard" className="uitext" /> &gt; <Cmdname sid="side_containerMap" className="uitext" /> 메뉴에서 목록 메뉴로 이동하는 링크 추가 <code class='changelog-service'><a href="https://docs.whatap.io/release-notes/service/service-2_3_x"><code class='changelog-service'>Service 2.3.0​</code></a></code>
...
- <code class="Feature">Feature</code> <Cmdname sid="side_management" className="uitext" /> &gt; <Cmdname sid="agentInstall" className="uitext" /> 메뉴에서 Helm을 이용한 에이전트 설치 안내 추가 <code class='changelog-service'><a href="https://docs.whatap.io/release-notes/service/service-2_3_x"><code class='changelog-service'>Service 2.3.2​</code></a></code>
...
- <code class="Feature">Feature</code> <Cmdname sid="side_kubeEventList" className="uitext" />: 프로젝트 단위로 쿠버네티스 이벤트에 대한 조회와 검색 기능 추가 <code class='changelog-service'><a href="https://docs.whatap.io/release-notes/service/service-2_0_x"><code class='changelog-service'>Service 2.0.0​</code></a></code>

- <code class="Feature">Feature</code> <Cmdname sid="side_whatapEventList" className="uitext" />: <code>#WhatapEvent</code> 카테고리의 로그 데이터 조회 기능 추가 <code class='changelog-service'><a href="https://docs.whatap.io/release-notes/service/service-2_0_x"><code class='changelog-service'>Service 2.0.0​</code></a></code>

- <code class="Feature">Feature</code> <Cmdname sid="side_event" className="uitext" /> &gt; <Cmdname sid="side_eventSetting" className="uitext" /> 메뉴에서 복합 메트릭스 이벤트 템플릿 추가 <code class='changelog-service'><a href="https://docs.whatap.io/release-notes/service/service-2_3_x"><code class='changelog-service'>Service 2.3.5​</code></a></code>
