"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[83075],{
...
const metadata = {
  ...
  "title": "알림 메시지 사용자 정의",
  "description": "프로젝트 멤버에게 전달되는 경고 알림 메시지를 수정할 수 있는 사용자 정의 기능을 제공합니다.",
  "source": "@site/docs/oracle-pro/set-notification-message.mdx",
  "sourceDirName": "oracle-pro",
  "slug": "/oracle-pro/set-notification-message",
  "permalink": "/oracle-pro/set-notification-message",
  "draft": false,
  "unlisted": false,
  ...
  "next": {
    "title": "이상치 탐지 경고 알림",
    "permalink": "/oracle-pro/set-event-detect-anomal"
  }
};
const assets = {
