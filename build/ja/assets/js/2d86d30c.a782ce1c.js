"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[79371],{
...
const metadata = {
  ...
  "title": "アラートメッセージユーザーの定義",
  "description": "プロジェクトメンバーに送信されるアラート通知メッセージを修正できるユーザー定義機能を提供します。",
  "source": "@site/i18n/ja/docusaurus-plugin-content-docs/current/cubrid/set-notification-message.mdx",
  "sourceDirName": "cubrid",
  "slug": "/cubrid/set-notification-message",
  "permalink": "/ja/cubrid/set-notification-message",
  "draft": false,
  "unlisted": false,
  ...
  "previous": {
    "title": "メトリクスアラートの通知",
    "permalink": "/ja/cubrid/metric-warning-notice"
  },
  "next": {
    "title": "異常値検知の警告通知",
    "permalink": "/ja/cubrid/set-event-detect-anomal"
  }
};
const assets = {
