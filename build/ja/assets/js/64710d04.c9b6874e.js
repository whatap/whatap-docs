"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[3065],{
...
const metadata = {
  ...
  "title": "Node.js環境設定",
  "description": "Node.jsエージェントに推奨される手順を提供します。",
  "source": "@site/i18n/ja/docusaurus-plugin-content-docs/current/nodejs/set-agent.mdx",
...
function _createMdxContent(props) {
  ...
  return (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.Fragment, {
    children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.p, {
      ...
      }), "ファイルに書き込みます。エージェントは、環境変数を使用して構成ファイルを見つけてロードします。コンテナやPaaS環境でNode.jsサーバーが実行されている場合、環境変数を使用してエージェント設定を構成します。ユーザーの利便性を高めるため、", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.a, {
        href: "https://service.whatap.io",
        children: "WhaTapモニタリングサービス"
      }), "は、エージェント設定機能を用意しています。"]
