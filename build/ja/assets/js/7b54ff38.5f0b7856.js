"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[15850],{
...
const metadata = {
  ...
  "title": "ダッシュボード",
  "description": "WhaTapモニタリングダッシュボードは、プロジェクトの全体的なステータスを一目で確認する機能を提供します。",
  "source": "@site/i18n/ja/docusaurus-plugin-content-docs/current/oracle-pro/dashboard-intro.mdx",
  "sourceDirName": "oracle-pro",
  "slug": "/oracle-pro/dashboard-intro",
  "permalink": "/ja/oracle-pro/dashboard-intro",
  "draft": false,
  "unlisted": false,
  "editUrl": "undefined/docs/oracle-pro/dashboard-intro.mdx",
  "tags": [
    {
      "inline": true,
      "label": "Oracle Pro",
