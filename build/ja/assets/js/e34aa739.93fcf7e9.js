"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[23698],{
...
const metadata = {
  "id": "oracle-pro/flexboard-manage",
  "title": "Flexボード管理",
  "description": "Flexボードでダッシュボードを編集し管理する方法を案内します。 ダッシュボードの名前変更、プロジェクトの選択、レイアウトの調整などの案内とウィジェットの追加、移動、サイズ調整、削除方法も案内します。 また、ウィジェットのデータソースを選択する方法と、ダッシュボードのjson形式への書き出し機能も説明します。",
  "source": "@site/i18n/ja/docusaurus-plugin-content-docs/current/oracle-pro/flexboard-manage.mdx",
  "sourceDirName": "oracle-pro",
  "slug": "/oracle-pro/flexboard-manage",
  "permalink": "/ja/oracle-pro/flexboard-manage",
  "draft": false,
  "unlisted": false,
  "editUrl": "undefined/docs/oracle-pro/flexboard-manage.mdx",
  "tags": [
    {
      "inline": true,
      "label": "Oracle Pro",
