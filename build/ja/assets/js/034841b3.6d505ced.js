"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[55844],{
...
const metadata = {
  ...
  "title": "警告通知の受信設定",
  "description": "プロジェクトに含まれるメンバーの警告通知の受信に関連した各種機能を設定できます。",
  "source": "@site/i18n/ja/docusaurus-plugin-content-docs/current/nodejs/set-receive-event.mdx",
  "sourceDirName": "nodejs",
  "slug": "/nodejs/set-receive-event",
  "permalink": "/ja/nodejs/set-receive-event",
  "draft": false,
  "unlisted": false,
  ...
  "previous": {
    "title": "異常値検知の警告通知",
    "permalink": "/ja/nodejs/set-event-detect-anomal"
  },
  "next": {
    "title": "イベント履歴",
