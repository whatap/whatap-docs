"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[28138],{
...
const metadata = {
  ...
  "title": "警告通知の受信設定",
  "description": "プロジェクトに含まれるメンバーの警告通知の受信に関連した各種機能を設定できます。",
  "source": "@site/i18n/ja/docusaurus-plugin-content-docs/current/npm/set-receive-event.mdx",
  "sourceDirName": "npm",
  "slug": "/npm/set-receive-event",
  "permalink": "/ja/npm/set-receive-event",
  "draft": false,
  "unlisted": false,
  ...
  "previous": {
    "title": "イベント設定",
    "permalink": "/ja/npm/warning-notice-v2"
  },
  "next": {
    "title": "イベント履歴",
    "permalink": "/ja/npm/set-event-history"
  }
};
const assets = {
