"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[58871],{
...
function _createMdxContent(props) {
  ...
  return (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.Fragment, {
    children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.p, {
      ...
      children: "アプリケーション実行の分布パターンをマシンラーニングを使用して自動認識させてアラート通知を送信します。複雑な条件設定なしで問題の状況を迅速かつ正確に認知することができます。数多くのヒットマップパターンが学習されており、リアルタイムで収集されるデータから学習されたパターンと類似したパターンが発生するとアラート通知を受けることができます。"
      ...
      type: "note",
      children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.p, {
        children: ["ヒットマップとヒットマップパターンの詳細については、", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.a, {
          href: "trs-view",
          children: "次の文書"
        }), " を参照してください。"]
      })
      ...
      children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.h2, {
        ...
        children: "次のヒットマップパターンが発生した場合は、アラート通知を送信するように設定できます。各項目のトグルボタンを選択して、アラート通知をオンまたはオフにすることができます。"
      }), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.ul, {
        children: ["\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.li, {
          children: ["\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.p, {
            children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(Cmdname, {
              ...
              className: "uitext"
            }), "：複数のトランザクションが一定時間内に終了するパターンです。リソースを取得したり、外部HTTPS Callをしたりする場合にタイムアウトまたは遅延が発生します。"]
          }), "\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.p, {
          ...
          children: ["\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.p, {
            children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(Cmdname, {
              ...
              className: "uitext"
            }), "：呼び出しのタイミングが異なるが、同じ時点でトランザクションが終了するパターンです。トランザクションが使用する共通のリソースに一時的なボトルネックが発生します。"]
          }), "\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.p, {
            children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.img, {
              alt: "縦ラインパターン",
          ...
          children: ["\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.p, {
            children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(Cmdname, {
              ...
              className: "uitext"
            }), "：特定のリソースやログなどの一般的なリソース不足により、間隔をおいた波のようなパターンが発生します。"]
          }), "\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.p, {
            children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.img, {
              alt: "フライングパターン",
          ...
          children: ["\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.p, {
            children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(Cmdname, {
              ...
              className: "uitext"
            }), "：全体または一部の応答に一時的な問題が発生すると、一時的にトランザクションが集中するパターンが発生します。"]
          }), "\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.p, {
            children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.img, {
              alt: "過負荷パターン",
          ...
          children: ["\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.p, {
            children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(Cmdname, {
              ...
              className: "uitext"
            }), "：過剰なトランザクションのリクエストや負荷が発生すると、応答時間が全体的に増加するパターンが発生します。"]
          }), "\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.p, {
            children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.img, {
              alt: "暴走パターン",
...
/* harmony import */ var _common_items_hitmap_pattern_notice_mdx__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(68816);
...
const metadata = {
  ...
  "title": "AIを利用したのヒットマップパターンのアラート通知",
  "description": "アプリケーションの実行の分布パターンをマシンラーニングを通じて自動的に認識し、アラート通知を送信します。",
  "source": "@site/i18n/ja/docusaurus-plugin-content-docs/current/kubernetes/hitmap-notice.mdx",
