"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[65560],{
...
const metadata = {
  "id": "oracle-v1/set-event-detect-anomal",
  "title": "異常値検知の警告通知",
  "description": "予期しないパターンを検出する一連の動作を検知し、警告通知を送信するように設定できます。",
  "source": "@site/i18n/ja/docusaurus-plugin-content-docs/current/oracle-v1/set-event-detect-anomal.mdx",
  "sourceDirName": "oracle-v1",
  "slug": "/oracle-v1/set-event-detect-anomal",
  "permalink": "/ja/oracle-v1/set-event-detect-anomal",
  "draft": false,
  "unlisted": false,
  "editUrl": "undefined/docs/oracle-v1/set-event-detect-anomal.mdx",
  "tags": [
    {
      "inline": true,
      "label": "Oracle",
