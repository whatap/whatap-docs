"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[79808],{
...
const metadata = {
  ...
  "title": "ダッシュボード",
  "description": "WhaTapモニタリングダッシュボードは、プロジェクトの全体的なステータスを一目で確認する機能を提供します。",
  "source": "@site/i18n/ja/docusaurus-plugin-content-docs/current/oracle-v1/dashboard-intro.mdx",
  "sourceDirName": "oracle-v1",
  "slug": "/oracle-v1/dashboard-intro",
  "permalink": "/ja/oracle-v1/dashboard-intro",
  "draft": false,
  "unlisted": false,
  "editUrl": "undefined/docs/oracle-v1/dashboard-intro.mdx",
  "tags": [
    {
      "inline": true,
      "label": "Oracle",
  ...
  "next": {
    "title": "インスタンスリスト",
    "permalink": "/ja/oracle-v1/instance-list"
  }
};
const assets = {
