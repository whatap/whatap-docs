"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[19475],{
...
const metadata = {
  ...
  "title": "アラートメッセージユーザーの定義",
  "description": "プロジェクトメンバーに送信されるアラート通知メッセージを修正できるユーザー定義機能を提供します。",
  "source": "@site/i18n/ja/docusaurus-plugin-content-docs/current/redis/set-notification-message.mdx",
  "sourceDirName": "redis",
  "slug": "/redis/set-notification-message",
  "permalink": "/ja/redis/set-notification-message",
  "draft": false,
  "unlisted": false,
  ...
  "next": {
    "title": "異常値検知の警告通知",
    "permalink": "/ja/redis/set-event-detect-anomal"
  }
};
const assets = {
