...
;// CONCATENATED MODULE: ./i18n/ja/docusaurus-plugin-content-docs/current/common-items/_php-restart-apache.mdx
...
;// CONCATENATED MODULE: ./i18n/ja/docusaurus-plugin-content-docs/current/php/agent-remove.mdx
...
const metadata = {
  ...
  "title": "エージェント削除",
  "description": "PHPエージェントを削除する方法を提供します。",
  "source": "@site/i18n/ja/docusaurus-plugin-content-docs/current/php/agent-remove.mdx",
  "sourceDirName": "php",
...
function agent_remove_createMdxContent(props) {
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsx)(_components.p, {
      children: "インストールスクリプトを使用してトレーサー、PHP拡張モジュール、およびwhatap-phpサービスデーモンを削除します。その後、パッケージ(yum、 apt-get) の削除に進み、必要に応じて*/usr/whatap/php*のログファイルおよびその他のファイルを削除します。"
    }), "\n", (0,jsx_runtime.jsxs)(_components.ol, {
      children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
        children: ["\n", (0,jsx_runtime.jsx)(_components.p, {
          children: "PHP 拡張モジュールとwhatap-php サービスを削除します。"
