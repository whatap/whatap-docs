"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[9584],{
...
const metadata = {
  "id": "mysql/metrics-search",
  "title": "メトリクス照会",
  "description": "メトリクスのRaw Dataを参照することができます。",
  "source": "@site/i18n/ja/docusaurus-plugin-content-docs/current/mysql/metrics-search.mdx",
  "sourceDirName": "mysql",
  "slug": "/mysql/metrics-search",
  "permalink": "/ja/mysql/metrics-search",
  "draft": false,
  "unlisted": false,
  "editUrl": "undefined/docs/mysql/metrics-search.mdx",
  "tags": [
    {
      "inline": true,
      "label": "メトリクス",
