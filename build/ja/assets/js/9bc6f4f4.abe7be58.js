"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[64109],{
...
const metadata = {
  ...
  "title": "XOSエージェント設定",
  "description": "Redisデータベースサーバーのリソースを追加でモニタリングするための設定方法を提供します。",
  "source": "@site/i18n/ja/docusaurus-plugin-content-docs/current/redis/agent-xos-settings.mdx",
  "sourceDirName": "redis",
