"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[32000],{
...
const metadata = {
  ...
  "title": "メトリクスアラートの通知",
  "description": "特定の複雑なイベントを設定するには、メトリクスイベント設定を使用します。",
  "source": "@site/i18n/ja/docusaurus-plugin-content-docs/current/ncloud/metric-warning-notice.mdx",
  ...
  "previous": {
    "title": "アラート通知",
    "permalink": "/ja/ncloud/set-notice"
  },
  "next": {
    "title": "警告通知の受信設定",
