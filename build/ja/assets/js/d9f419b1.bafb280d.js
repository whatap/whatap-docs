"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[1913],{
...
const metadata = {
  ...
  "title": "ダッシュボード",
  "description": "WhaTapモニタリングダッシュボードは、Redisデータベースプロジェクトの全体的なステータスを一目で確認する機能を提供します。",
  "source": "@site/i18n/ja/docusaurus-plugin-content-docs/current/redis/dashboard-intro.mdx",
  "sourceDirName": "redis",
  ...
  "previous": {
    "title": "管理",
    "permalink": "/ja/redis/agent-manage"
  },
  "next": {
    "title": "インスタンスリスト",
