"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[64368],{
...
const metadata = {
  "id": "redis/metrics-search",
  "title": "メトリクス照会",
  "description": "メトリクスのRaw Dataを参照することができます。",
  "source": "@site/i18n/ja/docusaurus-plugin-content-docs/current/redis/metrics-search.mdx",
  "sourceDirName": "redis",
  "slug": "/redis/metrics-search",
  "permalink": "/ja/redis/metrics-search",
  "draft": false,
  "unlisted": false,
  "editUrl": "undefined/docs/redis/metrics-search.mdx",
  "tags": [
    {
      "inline": true,
      "label": "メトリクス",
