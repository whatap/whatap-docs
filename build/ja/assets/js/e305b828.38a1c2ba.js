"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[93198],{
...
const metadata = {
  ...
  "title": "警告通知の受信設定",
  "description": "プロジェクトに含まれるメンバーの警告通知の受信に関連した各種機能を設定できます。",
  "source": "@site/i18n/ja/docusaurus-plugin-content-docs/current/azure/set-receive-event.mdx",
  "sourceDirName": "azure",
  "slug": "/azure/set-receive-event",
  "permalink": "/ja/azure/set-receive-event",
  "draft": false,
  "unlisted": false,
  ...
  "previous": {
    "title": "メトリクスアラートの通知",
    "permalink": "/ja/azure/metric-warning-notice"
  },
  "next": {
    "title": "イベント履歴",
    "permalink": "/ja/azure/set-event-history"
  }
};
const assets = {
