"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[5829],{
...
const metadata = {
  ...
  "title": "異常値検知の警告通知",
  "description": "予期しないパターンを検出する一連の動作を検知し、警告通知を送信するように設定できます。",
  "source": "@site/i18n/ja/docusaurus-plugin-content-docs/current/golang/set-event-detect-anomal.mdx",
  "sourceDirName": "golang",
  "slug": "/golang/set-event-detect-anomal",
  "permalink": "/ja/golang/set-event-detect-anomal",
  "draft": false,
  "unlisted": false,
  ...
  "previous": {
    ...
    "permalink": "/ja/golang/hitmap-notice"
  },
  "next": {
    "title": "ログ警告通知",
