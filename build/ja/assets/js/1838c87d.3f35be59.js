"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[62901],{
...
const metadata = {
  ...
  "title": "警告通知の受信設定",
  "description": "プロジェクトに含まれるメンバーの警告通知の受信に関連した各種機能を設定できます。",
  "source": "@site/i18n/ja/docusaurus-plugin-content-docs/current/oracle-v1/set-receive-event.mdx",
  "sourceDirName": "oracle-v1",
  "slug": "/oracle-v1/set-receive-event",
  "permalink": "/ja/oracle-v1/set-receive-event",
  "draft": false,
  "unlisted": false,
  ...
  "next": {
    "title": "イベント履歴",
    "permalink": "/ja/oracle-v1/set-event-history"
  }
};
const assets = {
