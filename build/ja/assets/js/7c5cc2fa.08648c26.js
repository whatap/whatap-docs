"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[51485],{
...
const metadata = {
  ...
  "title": "Log",
  "description": "コンテナまたはコンテナ内で実行中のアプリケーションによって出力されたログをすぐに確認できます。",
  "source": "@site/i18n/ja/docusaurus-plugin-content-docs/current/kubernetes/container-map-log.mdx",
...
- WhaTapモニタリングサービスページで、**_管理_** > **_エージェント設定_**画面で、`logsink_enabled=true`設定を追加
- クラスタープロジェクト全体のノードを対象に設定を追加するには、**_プロジェクトのデフォルト_** > **_ノード_**を対象に設定を追加
...
const toc = [{
  ...
  "value": "最近のログメッセージ (コンテナStdout／Stderr)",
  "id": "最近のログメッセージ-コンテナstdoutstderr",
  "level": 2
}, {
  "value": "ログ検索",
  "id": "ログ検索",
  ...
  "value": "Standard OutのNodeエージェント設定の追加",
  "id": "standard-outのnodeエージェント設定の追加",
  "level": 4
}, {
  "value": "コンテナ内部のアプリケーションログ収集用のアプリケーションエージェント設定の追加",
  "id": "コンテナ内部のアプリケーションログ収集用のアプリケーションエージェント設定の追加",
  "level": 4
}];
  ...
  return (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.Fragment, {
    children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.p, {
      ...
      children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.h2, {
        id: "kubernetesログ",
        children: "Kubernetesログ"
      }), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.p, {
        children: "WhaTap Kubernetesモニタリング サービスは、Kubernetesで発生するログを収集して保存します。"
      }), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.p, {
        children: "Kubernetesには、次の2種類のログがあります。"
      }), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.ul, {
        children: ["\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.li, {
          children: ["\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.p, {
            children: "各コンテナのStandard Out(標準出力) ログ"
          }), "\n"]
        }), "\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.li, {
          children: ["\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.p, {
            children: "各コンテナの内で実行中のアプリケーションによって出力されたログ"
          }), "\n"]
        }), "\n"]
      }), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.p, {
        children: "これらのログは、コンテナの状態やメトリクス情報では確認しにくいモニタリングの盲点を補正する役割を果たします。このログを確認する方法は次のとおりです。"
      }), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.ul, {
        children: ["\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.li, {
          children: ["\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.p, {
            children: ["各コンテナのStandard Outログの場合は、コンテナを入力せずに、Kubernetesが提供する", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.code, {
              children: "kubectl logs"
            }), "コマンドで確認できます。"]
          }), "\n"]
        }), "\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.li, {
          children: ["\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.p, {
            children: "各コンテナ内のアプリケーションログは、コンテナを入力して確認するか、個別のログ収集方法を確率する必要があります。"
          }), "\n"]
        }), "\n"]
      })]
    }), "\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.section, {
      ...
      children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.h2, {
        id: "最近のログメッセージ-コンテナstdoutstderr",
        children: "最近のログメッセージ (コンテナStdout／Stderr)"
      }), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.p, {
        children: "現在のコンテナログをすぐに確認できる機能です。クラスター環境から直接ログを取得して、選択したコンテナのリアルタイムログまたは選択したPod内アプリケーションのリアルタイムログを確認できます。通常、コンテナログを確認するには、次のコマンドを使用します。"
      }), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.pre, {
        children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.code, {
          className: "language-bash",
          children: "kubectl logs pod/<Pod名> -n <Namespace名>\n"
        })
      }), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.p, {
        children: "Pod内に2つ以上のコンテナがある場合は、個々のコンテナを選択してログを確認します。"
      }), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.pre, {
        children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.code, {
          className: "language-bash",
          children: "kubectl logs pod/<Pod名> -c <コンテナ名> -n <Namespace名>\n"
        })
      }), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.p, {
        children: ["ログを確認する度にターミナル画面にアクセスしてコマンドラインツールを実行するのは非常に不便です。WhaTap Kubernetesモニタリングの", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.strong, {
          children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.em, {
            children: "ログ"
          })
        }), "機能を使用すると、現在のログを簡単に確認できます。"]
      }), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(ImgLang, {
        img: "k8s-container-log.png",
        desc: "最近のログメッセージ"
      }), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.p, {
        children: ["ただし、注意点があります。まず、コンテナを終了すると、ログが確認できなくなります。また、コンテナが実行中であっても、特定の期間または特定の時間のログだけしか確認できないデメリットがあります。WhaTapの最近のログメッセージ(", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.strong, {
          children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.em, {
            children: "コンテナStdout/Stderr"
          })
        }), ") 機能は、Kubernetes環境からのログをWhaTapを通じて確認できる機能であり、ユーザー環境から消えたログは、WhaTapでは確認できません。"]
      }), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.p, {
        children: "したがって、ログデータを安定的かつ継続的に管理するためには、別な管理方法が不可欠です。特にマイクロサービスアーキテクチャの採用が広がり、ビジネスを構成するコンテナ数が増加するにつれてログの検証と管理はますます複雑になっています。"
      }), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.p, {
        children: "良い方法はありますか？"
      })]
    }), "\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.section, {
      ...
      children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.h2, {
        ...
        children: ["コンテナを終了すると、関連するログはすべて消えますが、", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.strong, {
          children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.em, {
            children: "ログ検索"
          })
        }), "機能を使用して、選択したコンテナまたはPodで過去に発生したログを確認できます。コンテナStandardOutログを保存する場合、希望する保存期間が設定でき、特定の対象固有の情報の確認や相関分析をができます。"]
      }), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(ImgLang, {
        ...
        children: ["\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.li, {
          children: ["\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.p, {
            children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.img, {
              ...
              width: "35",
              height: "35"
            }), "時間セレクターを使用すると、データを表示するタイミングを選択できます。"]
          }), "\n"]
        }), "\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.li, {
          children: ["\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.p, {
            children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.img, {
              ...
              width: "35",
              height: "35"
            }), "左側のカテゴリオプションでカテゴリを指定して表示することができます。表示できるカテゴリの説明については、次の", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.a, {
              href: "#block",
              children: "ブロック"
          ...
          children: ["\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.p, {
            children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.img, {
              ...
              width: "35",
              height: "35"
            }), "右側の", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.strong, {
              children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.em, {
                children: "タグを非表示"
              })
            }), "を選択すると、ログ収集時のタグ情報を除く", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.strong, {
              children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.em, {
                children: "タイムスタンプ"
              })
          ...
          children: ["\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.p, {
            ...
            }), "ボタンをクリックすると、フィルター機能で詳細を確認できる", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.strong, {
              children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.em, {
                children: "ログ"
              })
            }), " > ", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.strong, {
          ...
          children: ["\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.p, {
            ...
            }), "アイコンを選択すると、解析されたキーと値のログとログメッセージを確認できます。詳細については、", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.a, {
              href: "../log/log-search",
              children: "次の文書"
            }), "を参照してください。"]
          }), "\n"]
      ...
      children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.h4, {
        ...
        children: ["\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.li, {
          children: ["\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.p, {
            ...
            children: ["コンテナマップの1つのポリゴンをブロックといいます。ログの", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.code, {
              children: "containerStdout"
            }), "カテゴリーでは、", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.code, {
          ...
          children: ["\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.p, {
            ...
            children: ["エージェントがインストールされているブロックをマイクロブロックと呼びます。", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.code, {
              children: "containerStdout"
            }), "カテゴリーだけでなく、", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.code, {
              children: "AppLog"
              ...
              children: "App*"
            }), "関連カテゴリも確認できます。カテゴリを選択する場合、", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.code, {
              children: "microOid"
            }), "(ブロック内のエージェントid)が一致するログ情報を確認できます。"]
          }), "\n"]
        }), "\n"]
      })]
    }), "\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.section, {
      ...
      children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.h4, {
        ...
        }), "画面で全体ブロックを選択した場合、または", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.strong, {
          children: "詳細を見る"
        }), "画面のカードでブロックを複数選択した場合、そのマルチブロックをグループと呼びます。グループを選択すると、", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.strong, {
          children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.em, {
            children: "ログ検索"
          })
        }), "タブで", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.code, {
          children: "containerStdout"
        }), "カテゴリと", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.code, {
          children: "App*"
        }), "カテゴリのすべてのログを確認できます。"]
      })]
    }), "\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.section, {
      ...
      children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.h4, {
        id: "standard-outのnodeエージェント設定の追加",
        children: "Standard OutのNodeエージェント設定の追加"
      }), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.p, {
        children: ["WhaTapログサービスをコンテナのStandard Outputを保存するには、WhaTapクバネティスノードエージェントで ", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.code, {
          children: "logsink_enabled=true"
        }), "オプションを設定する必要があります。設定およびWhaTapログモニタリングサービスの詳細については、", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.a, {
      ...
      children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.h4, {
        id: "コンテナ内部のアプリケーションログ収集用のアプリケーションエージェント設定の追加",
        children: "コンテナ内部のアプリケーションログ収集用のアプリケーションエージェント設定の追加"
      }), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.p, {
        children: ["WhaTapログサービスをコンテナ上で実行されるアプリケーションのログを収集するには", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.a, {
          href: "../log/log-k8s#k8s-log-app",
          children: "次の文書"
        }), "を参照してください。Java、Python、Goをサポートしています。"]
      }), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.admonition, {
        type: "caution",
        children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.p, {
          children: ["WhaTapログサービスを有効にして、コンテナのStandard Outputログ保存機能を使用する場合、それに伴う追加費用が請求されます。関連する料金の詳細については、", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.a, {
        ...
        children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.p, {
          children: "一部の古いバージョンのエージェントは、コンテナStandard Outputログ保存機能を提供しません。エージェントのアップグレード方法は、次のとおりです。"
        }), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.pre, {
          children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.code, {
          ...
          children: ["WhaTap Kubernetesエージェントバージョンについては、 ", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.a, {
