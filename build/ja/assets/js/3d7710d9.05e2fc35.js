"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[44390],{
...
// EXTERNAL MODULE: ./i18n/ja/docusaurus-plugin-content-docs/current/common-items/_db-update-agent.mdx
var _db_update_agent = __webpack_require__(21867);
// EXTERNAL MODULE: ./i18n/ja/docusaurus-plugin-content-docs/current/common-items/_db-uninstall-agent-installed-server.mdx
var _db_uninstall_agent_installed_server = __webpack_require__(20205);
// EXTERNAL MODULE: ./i18n/ja/docusaurus-plugin-content-docs/current/common-items/_db-unistall-agent-in-service.mdx
var _db_unistall_agent_in_service = __webpack_require__(36860);
;// CONCATENATED MODULE: ./i18n/ja/docusaurus-plugin-content-docs/current/common-items/_db-v1-management.mdx
...
function _createMdxContent(props) {
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsx)(Title, {
      ...
      children: "ダッシュボードメニューの機能を改善したデータベースモニタリングV2サービス画面を利用できます。"
      ...
      children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
        ...
        children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
          children: [(0,jsx_runtime.jsx)(Cmdname, {
            ...
            sid: "TTL06145",
            className: "uitext"
          }), "を", (0,jsx_runtime.jsx)(_components.em, {
      ...
      children: (0,jsx_runtime.jsxs)(_components.ul, {
        children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
          children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
            children: ["過去のデータを表示した時に画面に表示されないデータが見つかった場合は、", (0,jsx_runtime.jsx)(Cmdname, {
              sid: "TTL06145",
              className: "uitext"
            }), "を", (0,jsx_runtime.jsx)(_components.em, {
              children: (0,jsx_runtime.jsx)(_components.strong, {
...
;// CONCATENATED MODULE: ./i18n/ja/docusaurus-plugin-content-docs/current/oracle-v1/agent-manage.mdx
...
const metadata = {
  ...
  "title": "管理",
  "description": "whatap.confファイルを使用してデータベースエージェントを管理できます。",
  "source": "@site/i18n/ja/docusaurus-plugin-content-docs/current/oracle-v1/agent-manage.mdx",
  "sourceDirName": "oracle-v1",
  "slug": "/oracle-v1/agent-manage",
  "permalink": "/ja/oracle-v1/agent-manage",
  "draft": false,
  "unlisted": false,
  ...
  "next": {
    "title": "ダッシュボード",
    "permalink": "/ja/oracle-v1/dashboard-intro"
  }
};
const assets = {
