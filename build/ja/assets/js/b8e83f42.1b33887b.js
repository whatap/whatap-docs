"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[70291],{
    ...
    children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(InDoc, {
      ...
      children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.p, {
        children: ["ホーム画面>プロジェクト選択> ", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(Cmdname, {
          ...
          sid: "AA002",
          className: "uitext"
        }), "ウィジェットの", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.img, {
          alt: "ショートカットアイコン",
      ...
      children: "実行中のトランザクションのURL、SQL、HTTP呼び出し情報から異常トランザクションをすばやく特定し、詳細なトレースを通じて遅延部分を詳細に分析できます。"
      ...
      children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.h2, {
        ...
        children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.img, {
          ...
          children: "エージェント別のアクティブトランザクション"
        })]
      }), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.p, {
        children: ["すべてのアプリケーションサーバーの一覧と稼働中のトランザクションの合計数を表示します。チャート内の各グラフにカーソルを合わせると、トランザクションステータスが表示されます。トランザクションステータスの速度", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("span", {
          class: "normal",
          children: "Normal"
        ...
        children: ["アプリケーションサーバーの一覧と進行中のトランザクションの合計数を表示します。該当アプリケーション サーバーを選択すると", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.img, {
          alt: "指示線3",
          src: (__webpack_require__(60293)/* ["default"] */ .A) + "",
          width: "35",
          height: "35"
        }), "トランザクション一覧に詳細が表示されます。"]
      }), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.p, {
        children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.img, {
          alt: "指示線3",
          src: (__webpack_require__(60293)/* ["default"] */ .A) + "",
        ...
        children: ["進行中のトランザクションのURL、SQL、HTTP呼び出し情報の詳細を表示します。Top 10項目タブを選択すると、各項目別の経過時間が高い順にソートされている表を確認できます。同様に、トランザクションステータスの速度は", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("span", {
          class: "normal",
          children: "Normal"
        }), "、", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("span", {
          class: "slow",
        ...
        product: "java",
        children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.p, {
          children: ["トランザクション一覧から項目を選択すると、選択したトランザクションに関する詳細情報が確認できる", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(Cmdname, {
          ...
          children: ["\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.li, {
            children: ["\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.p, {
              children: "実行中のトランザクションに関する詳細情報や外部呼び出し、クエリ、コールスタックなどを確認できます。"
            }), "\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.ul, {
              children: ["\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.li, {
                children: ["\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.p, {
                ...
                children: ["\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.p, {
                  children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(Cmdname, {
                    sid: "stop_thread",
                    className: "uitext"
                  }), "：進行中のトランザクションを停止できます。スレッド中止のためには、", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(Cmdname, {
                    sid: "secret_key",
                    className: "uitext"
                  }), "が必要です。", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(Cmdname, {
                    sid: "secret_key",
                    className: "uitext"
              ...
              children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.p, {
                children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(Cmdname, {
                  sid: "stop_thread",
                  className: "uitext"
                }), "機能は、アプリケーションで実行されているスレッドを強制的に終了する機能です。ただし、この機能は動作しない場合があります。例えば、スレッドがIOタスクを実行している場合、スレッドをすぐに中止できません。"]
              }), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.p, {
                children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(Cmdname, {
                  sid: "stop_thread",
                  className: "uitext"
                }), "機能を使用すると、スレッドがIOタスクを実行中であっても終了を試みます。しかし、スレッドがIOタスクを完了するまでは中止されません。つまり、スレッドは中止要求を受け入れますが、作業が完了して次の作業に移るまで中止されません。"]
              }), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.p, {
                children: "スレッドを強制終了させると、ビジネスロジックに問題が発生する恐れがあり、予期しない動作を引き起こすため、お勧めしません。それでもスレッドを中止させる必要がある場合は、アプリケーション全体を中止してから再起動する必要があります。"
              })]
            }), "\n"]
          }), "\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.li, {
            children: ["\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.p, {
              children: ["すでに終了したトランザクションであれば", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(Cmdname, {
                sid: "show_trace",
                className: "uitext"
              }), "ボタンが表示されます。ボタンを選択すると", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(Cmdname, {
                sid: "TTL06527",
                className: "uitext"
      ...
      children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.h2, {
        ...
        children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.img, {
          ...
          children: "エージェント一覧"
        }), "でフィルタリング対象を選択または検索して、トランザクション一覧で個々の対象を確認できます。"]
      }), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.ul, {
        children: ["\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.li, {
          children: ["\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.p, {
            children: ["活性化されたエージェントを確認するには、", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(Cmdname, {
              sid: "active_only",
              className: "uitext"
            }), "チェックボックスを選択します。"]
          }), "\n"]
          ...
          children: ["\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.p, {
            children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(Cmdname, {
              sid: "all_agents",
              className: "uitext"
            }), "一覧ボックスをクリックすると、エージェントをカテゴリごとに分類して確認できます。"]
          }), "\n"]
        }), "\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.li, {
          children: ["\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.p, {
            children: ["実行中のトランザクション情報をエージェントごとに確認する場合は、エージェントを選択し、", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(Cmdname, {
              sid: "apply",
              className: "uitext"
            }), "ボタンをクリックします。選択を取り消すには、", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.img, {
              alt: "リセットアイコン",
      ...
      children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.h2, {
        ...
        children: ["実行中のトランザクション情報を設定した間隔で自動更新できます。", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(Cmdname, {
          sid: "auto_refresh_sec",
          className: "uitext"
        }), "トグルボタンでオプションを有効にし、右側の入力欄に更新間隔を入力します。"]
      }), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.p, {
        children: ["自動更新設定を無効にするには、", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(Cmdname, {
          sid: "auto_refresh_sec",
          className: "uitext"
        }), "トグルボタンをもう一度選択します。"]
        ...
        children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.ul, {
          children: ["\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.li, {
            children: "時間は秒単位で更新します。"
          }), "\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.li, {
            children: ["自動更新設定を無効した状態でトランザクション一覧を更新するには、", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.img, {
              alt: "自動更新アイコン",
      ...
      children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.h2, {
        ...
        children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.img, {
          ...
          children: "トランザクション一覧"
        }), "でURLまたはIPアドレスを検索してフィルタリングできます。右上の", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.strong, {
          children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.em, {
            children: "URL / IP"
          })
        }), "の入力欄にフィルタリングする対象を入力し、Enterキーまたは", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.img, {
          alt: "検索アイコン",
          src: (__webpack_require__(63427)/* ["default"] */ .A) + "",
          width: "24",
          height: "24"
        }), "ボタンを選択します。トランザクション一覧は、入力値でフィルタリングされます。"]
      }), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.p, {
        children: ["フィルタリングした一覧を初期化するには右上の", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.strong, {
          children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.em, {
            children: "URL / IP"
          })
        }), "テキスト入力ボックスのテキストを削除し、Enterキーまたは", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.img, {
          alt: "検索アイコン",
          src: (__webpack_require__(63427)/* ["default"] */ .A) + "",
          width: "24",
          height: "24"
...
/* harmony import */ var _common_items_dashboard_active_transaction_mdx__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(68435);
...
const metadata = {
  ...
  "title": "アクティブトランザクション",
  "description": "Javaモニタリングで現在進行中のトランザクションをリアルタイムでモニタリングして分析するアクティブトランザクション機能を案内します。アプリケーションのトランザクションURL、SQL、HTTP呼び出し情報を照会し、トランザクションの状態を区分して把握することができます。これにより、遅延区間を識別し、トラブルシューティングに必要な詳細情報を取得できます。",
  "source": "@site/i18n/ja/docusaurus-plugin-content-docs/current/java/dashboard-active-transaction.mdx",
  "sourceDirName": "java",
...
function _createMdxContent(props) {
  ...
  return (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.Fragment, {
    children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_common_items_dashboard_active_transaction_mdx__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .Ay, {}), "\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.admonition, {
      type: "note",
      children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.p, {
        children: ["アクティブトランザクション設定の詳細については、", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.a, {
