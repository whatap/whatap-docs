"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[23511],{
...
const metadata = {
  ...
  "title": "警告通知の受信設定",
  "description": "プロジェクトに含まれるメンバーの警告通知の受信に関連した各種機能を設定できます。",
  "source": "@site/i18n/ja/docusaurus-plugin-content-docs/current/redis/set-receive-event.mdx",
  "sourceDirName": "redis",
  "slug": "/redis/set-receive-event",
  "permalink": "/ja/redis/set-receive-event",
  "draft": false,
  "unlisted": false,
