"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[36973],{
...
const metadata = {
  "id": "python/flexboard-widget-manage",
  "title": "Managing the widgets",
  "description": "The following explains how to add, change, copy, and delete widgets placed on the Flex Board. You can customize the dashboard by adding widgets or adjusting the properties of existing widgets. You can configure a dashboard that suits your monitoring needs through detailed controls such as changing widget data search conditions, setting the time, and setting the data merge options.",
  "source": "@site/i18n/en/docusaurus-plugin-content-docs/current/python/flexboard-widget-manage.mdx",
  "sourceDirName": "python",
  "slug": "/python/flexboard-widget-manage",
  "permalink": "/en/python/flexboard-widget-manage",
  "draft": false,
  "unlisted": false,
  "editUrl": "undefined/docs/python/flexboard-widget-manage.mdx",
  "tags": [
    {
      "inline": true,
      "label": "Python",
  ...
  "previous": {
    ...
    "permalink": "/en/python/flexboard-metric-widget"
  },
  "next": {
    "title": "Flex board screen modes",
    "permalink": "/en/python/flexboard-mode"
  }
};
const assets = {
