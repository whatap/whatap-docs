"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[68969],{
...
const frontMatter = {
	...
	title: 'Event Setting',
	description: 'Alerts are sent through event condition settings per metric in the MongoDB database.',
	tags: [
		'MongoDB',
		'Database',
		'Alert',
...
const metadata = {
  ...
  "title": "Event Setting",
  "description": "Alerts are sent through event condition settings per metric in the MongoDB database.",
  "source": "@site/i18n/en/docusaurus-plugin-content-docs/current/mongodb/warning-notice-v2.mdx",
