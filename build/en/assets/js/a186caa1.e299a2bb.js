"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[98901],{
...
const metadata = {
  "id": "oracle-v1/set-notification-message",
  "title": "Notification message customization",
  "description": "It provides the customization function to modify the alert notification messages that are delivered to project members.",
  "source": "@site/i18n/en/docusaurus-plugin-content-docs/current/oracle-v1/set-notification-message.mdx",
  "sourceDirName": "oracle-v1",
  "slug": "/oracle-v1/set-notification-message",
  "permalink": "/en/oracle-v1/set-notification-message",
  "draft": false,
  "unlisted": false,
  "editUrl": "undefined/docs/oracle-v1/set-notification-message.mdx",
  "tags": [
    {
      "inline": true,
      "label": "Oracle",
