"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[51256],{
...
const metadata = {
  ...
  "title": "Configuration",
  "description": "Learn about additional options you can set through the whatap.conf file on the database agent server.",
  "source": "@site/i18n/en/docusaurus-plugin-content-docs/current/tibero/agent-settings.mdx",
...
const toc = [..._common_items_db_agent_settings_desc_mdx__WEBPACK_IMPORTED_MODULE_1__/* .toc */ .RM];
function _createMdxContent(props) {
