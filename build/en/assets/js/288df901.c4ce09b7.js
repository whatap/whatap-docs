"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[44663],{
...
const metadata = {
  "id": "oracle-pro/set-notification-message",
  "title": "Notification message customization",
  "description": "It provides the customization function to modify the alert notification messages that are delivered to project members.",
  "source": "@site/i18n/en/docusaurus-plugin-content-docs/current/oracle-pro/set-notification-message.mdx",
  "sourceDirName": "oracle-pro",
  "slug": "/oracle-pro/set-notification-message",
  "permalink": "/en/oracle-pro/set-notification-message",
  "draft": false,
  "unlisted": false,
  "editUrl": "undefined/docs/oracle-pro/set-notification-message.mdx",
  "tags": [
    {
      "inline": true,
      "label": "Oracle Pro",
