"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[7820],{
...
const frontMatter = {
	id: 'report-intro',
	title: 'Report',
	description: 'Let\'s learn about the documents that report the service usage and failure records for individual projects of the PostgreSQL product.',
	tags: [
		'PostgreSQL',
		'Database',
		'Report'
...
const metadata = {
  ...
  "title": "Report",
  "description": "Let's learn about the documents that report the service usage and failure records for individual projects of the PostgreSQL product.",
  "source": "@site/i18n/en/docusaurus-plugin-content-docs/current/postgresql/report-intro.mdx",
  ...
  "next": {
    "title": "Log",
    "permalink": "/en/postgresql/log-main"
  }
};
const assets = {
