"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[38482],{
...
const metadata = {
  "id": "cubrid/flexboard-widget-manage",
  "title": "Managing the widgets",
  "description": "The following explains how to add, change, copy, and delete widgets placed on the Flex Board. You can customize the dashboard by adding widgets or adjusting the properties of existing widgets. You can configure a dashboard that suits your monitoring needs through detailed controls such as changing widget data search conditions, setting the time, and setting the data merge options.",
  "source": "@site/i18n/en/docusaurus-plugin-content-docs/current/cubrid/flexboard-widget-manage.mdx",
  "sourceDirName": "cubrid",
  "slug": "/cubrid/flexboard-widget-manage",
  "permalink": "/en/cubrid/flexboard-widget-manage",
  "draft": false,
  "unlisted": false,
  "editUrl": "undefined/docs/cubrid/flexboard-widget-manage.mdx",
  "tags": [
    {
      "inline": true,
      "label": "CUBRID",
  ...
  "next": {
    ...
    "permalink": "/en/cubrid/flexboard-mode"
  }
};
const assets = {
