"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[89017],{
...
const metadata = {
  "id": "oracle-v1/metric-warning-notice",
  "title": "Metrics alert",
  "description": "Use the metrics event settings to set specific and complex events.",
  "source": "@site/i18n/en/docusaurus-plugin-content-docs/current/oracle-v1/metric-warning-notice.mdx",
  "sourceDirName": "oracle-v1",
  "slug": "/oracle-v1/metric-warning-notice",
  "permalink": "/en/oracle-v1/metric-warning-notice",
  "draft": false,
  "unlisted": false,
  "editUrl": "undefined/docs/oracle-v1/metric-warning-notice.mdx",
  "tags": [
    {
      "inline": true,
      "label": "Oracle",
  ...
  "previous": {
    "title": "Event Setting",
    "permalink": "/en/oracle-v1/warning-notice-v2"
  },
  "next": {
    "title": "Notification message customization",
    "permalink": "/en/oracle-v1/set-notification-message"
  }
};
const assets = {
