"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[49542],{
...
const metadata = {
  "id": "server/metrics-detect-anormal",
  "title": "Metric Anomaly Detection",
  "description": "You can compare the patterns of various metrics with the expected patterns learned by the AI.",
  "source": "@site/i18n/en/docusaurus-plugin-content-docs/current/server/metrics-detect-anormal.mdx",
  "sourceDirName": "server",
  "slug": "/server/metrics-detect-anormal",
  "permalink": "/en/server/metrics-detect-anormal",
  "draft": false,
  "unlisted": false,
  "editUrl": "undefined/docs/server/metrics-detect-anormal.mdx",
  "tags": [
    {
      "inline": true,
      "label": "Server",
