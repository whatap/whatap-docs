"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[98034],{
...
const frontMatter = {
	...
	title: 'Event Setting',
	description: 'Alerts are sent through event condition settings per metric in the Redis database.',
	tags: [
		'Redis',
		'Database',
		'Alert',
...
const metadata = {
  ...
  "title": "Event Setting",
  "description": "Alerts are sent through event condition settings per metric in the Redis database.",
  "source": "@site/i18n/en/docusaurus-plugin-content-docs/current/redis/warning-notice-v2.mdx",
  "sourceDirName": "redis",
