...
const frontMatter = {
	...
	description: 'You can check the problems that may occur during Redis database agent installation.',
	tags: [
		'Redis',
		'Database',
		'Troubleshooting',
...
const metadata = {
  ...
  "title": "Troubleshooting",
  "description": "You can check the problems that may occur during Redis database agent installation.",
  "source": "@site/i18n/en/docusaurus-plugin-content-docs/current/redis/troubleshooting.mdx",
  "sourceDirName": "redis",
