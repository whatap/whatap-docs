"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[74302],{
...
const frontMatter = {
	...
	title: 'Event Setting',
	description: 'Alerts are sent through the event condition settings per metric on the browser.',
	tags: [
		'Browser',
		'Alert',
		'Event Setting'
...
const metadata = {
  ...
  "title": "Event Setting",
  "description": "Alerts are sent through the event condition settings per metric on the browser.",
  "source": "@site/i18n/en/docusaurus-plugin-content-docs/current/browser/warning-notice-v2.mdx",
