"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[47161],{
...
const metadata = {
  "id": "mysql/metrics-chart",
  "title": "Metrics Chart",
  "description": "You can see the metrics data through a chart.",
  "source": "@site/i18n/en/docusaurus-plugin-content-docs/current/mysql/metrics-chart.mdx",
  "sourceDirName": "mysql",
  "slug": "/mysql/metrics-chart",
  "permalink": "/en/mysql/metrics-chart",
  "draft": false,
  "unlisted": false,
  "editUrl": "undefined/docs/mysql/metrics-chart.mdx",
  "tags": [
    {
      "inline": true,
      "label": "Metrics",
  ...
  "next": {
    ...
    "permalink": "/en/mysql/metrics-search"
  }
};
const assets = {
