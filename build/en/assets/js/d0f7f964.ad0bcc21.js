"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[3891],{
...
const metadata = {
  "id": "aws-log/flexboard-widget-manage",
  "title": "Managing the widgets",
  "description": "The following explains how to add, change, copy, and delete widgets placed on the Flex Board. You can customize the dashboard by adding widgets or adjusting the properties of existing widgets. You can configure a dashboard that suits your monitoring needs through detailed controls such as changing widget data search conditions, setting the time, and setting the data merge options.",
  "source": "@site/i18n/en/docusaurus-plugin-content-docs/current/aws-log/flexboard-widget-manage.mdx",
  "sourceDirName": "aws-log",
  "slug": "/aws-log/flexboard-widget-manage",
  "permalink": "/en/aws-log/flexboard-widget-manage",
  "draft": false,
  "unlisted": false,
  "editUrl": "undefined/docs/aws-log/flexboard-widget-manage.mdx",
  "tags": [
    {
      "inline": true,
      "label": "Flex Board",
  ...
  "previous": {
    ...
    "permalink": "/en/aws-log/flexboard-metric-widget"
  },
  "next": {
    "title": "Flex board screen modes",
    "permalink": "/en/aws-log/flexboard-mode"
  }
};
const assets = {
