"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[62114],{
...
const metadata = {
  ...
  "title": "Support environment for Kubernetes Monitoring",
  "description": "Before starting Kubernetes Monitoring, let's learn about the support environment.",
  "source": "@site/i18n/en/docusaurus-plugin-content-docs/current/kubernetes/supported-spec.mdx",
...
function _createMdxContent(props) {
  ...
  return (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.Fragment, {
    children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.p, {
      children: "Before starting the Kubernetes monitoring, check out the following supports. WhaTap Kubernetes can be installed on standard Kubernetes versions 1.16 to 1.28 and the equivalent Kubernetes environments."
