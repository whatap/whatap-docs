"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[98403],{
...
const metadata = {
  "id": "nodejs/flexboard-widget-manage",
  "title": "Managing the widgets",
  "description": "The following explains how to add, change, copy, and delete widgets placed on the Flex Board. You can customize the dashboard by adding widgets or adjusting the properties of existing widgets. You can configure a dashboard that suits your monitoring needs through detailed controls such as changing widget data search conditions, setting the time, and setting the data merge options.",
  "source": "@site/i18n/en/docusaurus-plugin-content-docs/current/nodejs/flexboard-widget-manage.mdx",
  "sourceDirName": "nodejs",
  "slug": "/nodejs/flexboard-widget-manage",
  "permalink": "/en/nodejs/flexboard-widget-manage",
  "draft": false,
  "unlisted": false,
  "editUrl": "undefined/docs/nodejs/flexboard-widget-manage.mdx",
  "tags": [
    {
      "inline": true,
      "label": "Node.js",
  ...
  "previous": {
    ...
    "permalink": "/en/nodejs/flexboard-metric-widget"
  },
  "next": {
    "title": "Flex board screen modes",
    "permalink": "/en/nodejs/flexboard-mode"
  }
};
const assets = {
