"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[29179],{
...
const metadata = {
  ...
  "title": "DBX Agent Setting",
  "description": "The following provides the options you can set through the whatap.conf file on the MongoDB database.",
  "source": "@site/i18n/en/docusaurus-plugin-content-docs/current/mongodb/agent-dbx-settings.mdx",
  "sourceDirName": "mongodb",
  "slug": "/mongodb/agent-dbx-settings",
  "permalink": "/en/mongodb/agent-dbx-settings",
  "draft": false,
  "unlisted": false,
  ...
  "next": {
    ...
    "permalink": "/en/mongodb/agent-xos-settings"
  }
};
const assets = {
