"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[33358],{
...
const metadata = {
  ...
  "title": "Hitmap",
  "description": "The following explains how to configure the detailed transaction profiling in the application. The transaction profiling allows you to collect and analyze the performance data for each transaction in the application, which can help improve the performance of the application.",
  "source": "@site/i18n/en/docusaurus-plugin-content-docs/current/java/analysis-hitmap.mdx",
  "sourceDirName": "java",
