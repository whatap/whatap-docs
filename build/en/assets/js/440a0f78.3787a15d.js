"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[75533],{
...
const metadata = {
  "id": "oracle-v1/flexboard-widget-manage",
  "title": "Managing the widgets",
  "description": "The following explains how to add widgets, change their properties, and copy and delete widgets on Flex Board. You can customize your dashboard by adding widgets or adjusting the properties of existing widgets. You can configure a dashboard that suits your monitoring needs through detailed management behaviors such as changing widget data search conditions, setting the times, and setting the data merge options.",
  "source": "@site/i18n/en/docusaurus-plugin-content-docs/current/oracle-v1/flexboard-widget-manage.mdx",
  "sourceDirName": "oracle-v1",
  "slug": "/oracle-v1/flexboard-widget-manage",
  "permalink": "/en/oracle-v1/flexboard-widget-manage",
  "draft": false,
  "unlisted": false,
  "editUrl": "undefined/docs/oracle-v1/flexboard-widget-manage.mdx",
  "tags": [
    {
      "inline": true,
      "label": "Oracle",
  ...
  "previous": {
    ...
    "permalink": "/en/oracle-v1/flexboard-metric-widget"
  },
  "next": {
    "title": "Flex board screen modes",
    "permalink": "/en/oracle-v1/flexboard-mode"
  }
};
const assets = {
