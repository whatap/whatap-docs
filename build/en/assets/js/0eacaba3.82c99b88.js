"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[41203],{
...
const metadata = {
  "id": "oracle-v1/set-event-format",
  "title": "Event reception format",
  "description": "Learn about the event reception format of alerts provided by database monitoring.",
  "source": "@site/i18n/en/docusaurus-plugin-content-docs/current/oracle-v1/set-event-format.mdx",
  "sourceDirName": "oracle-v1",
  "slug": "/oracle-v1/set-event-format",
  "permalink": "/en/oracle-v1/set-event-format",
  "draft": false,
  "unlisted": false,
  "editUrl": "undefined/docs/oracle-v1/set-event-format.mdx",
  "tags": [
    {
      "inline": true,
      "label": "Oracle",
