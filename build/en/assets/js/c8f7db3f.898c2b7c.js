"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[99022],{
...
const frontMatter = {
	id: 'agent-settings',
	title: 'Configuration',
	description: 'Learn about additional options you can set through the whatap.conf file on the MongoDB database agent server.',
	tags: [
		'MongoDB',
		'Database',
		'Agent CONFIG.'
...
const metadata = {
  ...
  "title": "Configuration",
  "description": "Learn about additional options you can set through the whatap.conf file on the MongoDB database agent server.",
  "source": "@site/i18n/en/docusaurus-plugin-content-docs/current/mongodb/agent-settings.mdx",
