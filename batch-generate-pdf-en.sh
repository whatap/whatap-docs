...
npx docusaurus-prince-pdf -u https://docs.whatap.io/en/cover-oracle --prince-args="--javascript --page-size='a4' --page-margin='10mm' --style='$PATH_NAME/print.css'" -o ./pdf/whatap-db-oracle-v2-monitoring-en.pdf --dest ./pdf --include-index

pdfcpu annot remove -pages 1 ./pdf/whatap-db-oracle-v2-monitoring-en.pdf

npx docusaurus-prince-pdf -u https://docs.whatap.io/en/cover-oracle-pro --prince-args="--javascript --page-size='a4' --page-margin='10mm' --style='$PATH_NAME/print.css'" -o ./pdf/whatap-db-oracle-pro-monitoring-en.pdf --dest ./pdf --include-index
