"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[98414],{
...
const metadata = {
  "id": "oracle-v1/troubleshooting",
  "title": "Troubleshooting",
  "description": "You can check the problems that may occur during database agent installation.",
  "source": "@site/i18n/en/docusaurus-plugin-content-docs/current/oracle-v1/troubleshooting.mdx",
  "sourceDirName": "oracle-v1",
  "slug": "/oracle-v1/troubleshooting",
  "permalink": "/en/oracle-v1/troubleshooting",
  "draft": false,
  "unlisted": false,
  "editUrl": "undefined/docs/oracle-v1/troubleshooting.mdx",
  "tags": [],
  "version": "current",
  "frontMatter": {
    "id": "troubleshooting",
  ...
  "previous": {
    ...
    "permalink": "/en/oracle-v1/after-install-agent"
  },
  "next": {
    "title": "Configuration",
    "permalink": "/en/oracle-v1/agent-settings"
  }
};
const assets = {
