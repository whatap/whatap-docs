"use strict";
(self["webpackChunkwhatap_origin"] = self["webpackChunkwhatap_origin"] || []).push([[33500],{
...
const metadata = {
    "unversionedId": "java/metrics-search",
    "id": "java/metrics-search",
    "title": "Metrics Search",
    "description": "You can search the metrics raw data.",
    "source": "@site/i18n/en/docusaurus-plugin-content-docs/current/java/metrics-search.mdx",
    "sourceDirName": "java",
    "slug": "/java/metrics-search",
    "permalink": "/en/java/metrics-search",
    "draft": false,
    "editUrl": "undefined/docs/java/metrics-search.mdx",
    "tags": [
        {
            "label": "Metrics",
    ...
    "next": {
        "title": "Metrics Chart",
        "permalink": "/en/java/metrics-chart"
    }
};
const assets = {};
const toc = [
