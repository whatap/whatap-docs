"use strict";
(self["webpackChunkwhatap_origin"] = self["webpackChunkwhatap_origin"] || []).push([[92208],{
...
const metadata = {
    "unversionedId": "nodejs/set-agent",
    "id": "nodejs/set-agent",
    "title": "Node.js environment configuration",
    "description": "The following explains how to configure the default settings of the Node.js agent.",
    "source": "@site/i18n/en/docusaurus-plugin-content-docs/current/nodejs/set-agent.mdx",
    "sourceDirName": "nodejs",
    "slug": "/nodejs/set-agent",
    "permalink": "/en/nodejs/set-agent",
    "draft": false,
    "editUrl": "undefined/docs/nodejs/set-agent.mdx",
    "tags": [
        {
            "label": "Node.js",
...
function MDXContent(_param) {
    ...
    return /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)(MDXLayout, _object_spread_props(_object_spread({}, layoutProps, props), {
        ...
        parentName: "p"
    }, `whatap.conf`), `. The agent locates and loads the configuration file through the environment variables. When the Node.js server operates in a container or PaaS environment, the agent settings are configured using environment variables. For user convenience, the `, /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("a", {
        parentName: "p",
        "href": "https://service.whatap.io"
