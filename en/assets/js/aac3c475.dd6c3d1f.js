"use strict";
(self["webpackChunkwhatap_origin"] = self["webpackChunkwhatap_origin"] || []).push([[34733],{
...
const frontMatter = {
    id: 'set-agent',
    title: 'Agent CONFIG.',
    description: 'The following explains how to configure the basic settings of the Python agent.',
    tags: [
        'Python',
        'Configuration'
    ]
...
const metadata = {
    "unversionedId": "python/set-agent",
    "id": "python/set-agent",
    "title": "Agent CONFIG.",
    "description": "The following explains how to configure the basic settings of the Python agent.",
    "source": "@site/i18n/en/docusaurus-plugin-content-docs/current/python/set-agent.mdx",
    "sourceDirName": "python",
    "slug": "/python/set-agent",
    "permalink": "/en/python/set-agent",
    "draft": false,
    "editUrl": "undefined/docs/python/set-agent.mdx",
    "tags": [
        {
            "label": "Python",
...
function MDXContent(_param) {
    ...
    return /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)(MDXLayout, _object_spread_props(_object_spread({}, layoutProps, props), {
        ...
        parentName: "p"
    }, `whatap.conf`), `. The agent locates and loads the configuration file through the environment variables. For user convenience, the `, /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("a", {
        parentName: "p",
        "href": "https://service.whatap.io"
