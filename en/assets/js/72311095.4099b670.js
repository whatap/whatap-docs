"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[52081],{
...
const metadata = {
  ...
  "title": "Event reception format",
  "description": "Learn about the event reception format of alerts provided by database monitoring.",
  "source": "@site/i18n/en/docusaurus-plugin-content-docs/current/cubrid/set-event-format.mdx",
  "sourceDirName": "cubrid",
  "slug": "/cubrid/set-event-format",
  "permalink": "/en/cubrid/set-event-format",
  "draft": false,
  "unlisted": false,
