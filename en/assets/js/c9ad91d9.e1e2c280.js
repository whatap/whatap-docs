"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[32635],{
...
__webpack_require__.d(__webpack_exports__, {
  ...
  contentTitle: () => (/* binding */ agent_settings_contentTitle),
  "default": () => (/* binding */ agent_settings_MDXContent),
  frontMatter: () => (/* binding */ agent_settings_frontMatter),
  metadata: () => (/* binding */ metadata),
  toc: () => (/* binding */ agent_settings_toc)
});
...
;// CONCATENATED MODULE: ./docs/common-items/_db-agent-settings-desc.mdx
...
;// CONCATENATED MODULE: ./docs/altibase-v1/agent-settings.mdx


const agent_settings_frontMatter = {
	id: 'agent-settings',
	title: '설정하기',
...
const agent_settings_contentTitle = undefined;
const metadata = {
  "id": "altibase-v1/agent-settings",
  "title": "설정하기",
  "description": "데이터베이스 에이전트 서버에 있는 whatap.conf 파일을 통해 설정할 수 있는 옵션에 대해 알아봅니다.",
  "source": "@site/docs/altibase-v1/agent-settings.mdx",
  "sourceDirName": "altibase-v1",
  "slug": "/altibase-v1/agent-settings",
  "permalink": "/en/altibase-v1/agent-settings",
  "draft": false,
  "unlisted": false,
  "editUrl": "undefined/docs/altibase-v1/agent-settings.mdx",
  "tags": [],
  "version": "current",
  "frontMatter": {
    "id": "agent-settings",
  ...
  "previous": {
    "title": "설치 문제 해결",
    "permalink": "/en/altibase-v1/troubleshooting"
  },
  "next": {
    "title": "에이전트 네트워크 통신",
...
const agent_settings_toc = [...toc];
function agent_settings_createMdxContent(props) {
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsx)(MDXContent, {}), "\n", "\n", (0,jsx_runtime.jsx)(DocCardList/* default */.A, {})]
  });
}
function agent_settings_MDXContent(props = {}) {
  const {wrapper: MDXLayout} = {
    ...(0,lib/* useMDXComponents */.R)(),
    ...props.components
  };
  return MDXLayout ? (0,jsx_runtime.jsx)(MDXLayout, {
    ...props,
    children: (0,jsx_runtime.jsx)(agent_settings_createMdxContent, {
      ...props
    })
  }) : agent_settings_createMdxContent(props);
}
