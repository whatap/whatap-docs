"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[80266],{
...
const metadata = {
  ...
  "title": "Flex board screen modes",
  "description": "Let's learn the provided functions according to the screen mode of the Flex board.",
  "source": "@site/i18n/en/docusaurus-plugin-content-docs/current/java/flexboard-mode.mdx",
  "sourceDirName": "java",
  ...
  "previous": {
    "title": "위젯 템플릿",
    "permalink": "/en/java/flexboard-widget-template"
  },
  "next": {
    "title": "Sharing the Flex board",
    "permalink": "/en/java/flexboard-share"
  }
};
const assets = {
