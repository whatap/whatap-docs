"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[13415],{
...
// EXTERNAL MODULE: ./i18n/en/docusaurus-plugin-content-docs/current/common-items/_db-instance-monitoring-desc.mdx
var _db_instance_monitoring_desc = __webpack_require__(36448);
// EXTERNAL MODULE: ./i18n/en/docusaurus-plugin-content-docs/current/common-items/_db-v2-instance-monitoring-select.mdx
var _db_v2_instance_monitoring_select = __webpack_require__(33004);
// EXTERNAL MODULE: ./i18n/en/docusaurus-plugin-content-docs/current/common-items/_db-v2-instance-monitoring-widget.mdx
var _db_v2_instance_monitoring_widget = __webpack_require__(75868);
;// CONCATENATED MODULE: ./i18n/en/docusaurus-plugin-content-docs/current/common-items/_db-v2-instance-monitoring-activesession-desc-redis.mdx
...
const toc = [{
  "value": " Active sessions / Process Info",
  "id": "-active-sessions--process-info",
  "level": 3
}];
function _createMdxContent(props) {
  const _components = {
  ...
  return (0,jsx_runtime.jsxs)(_components.section, {
    ...
    children: [(0,jsx_runtime.jsxs)(_components.h3, {
      ...
      children: [(0,jsx_runtime.jsx)(_components.img, {
        ...
        width: "35",
        height: "35"
      }), " Active sessions / Process Info"]
    }), (0,jsx_runtime.jsxs)(_components.p, {
      children: ["You can view the active sessions and process information in real time. If you select a specific time of the chart in the widget, the ", (0,jsx_runtime.jsx)(_components.strong, {
        children: "real-time inquiry"
...
// EXTERNAL MODULE: ./i18n/en/docusaurus-plugin-content-docs/current/common-items/_db-dashboard-activesession-desc.mdx
var _db_dashboard_activesession_desc = __webpack_require__(26271);
// EXTERNAL MODULE: ./i18n/en/docusaurus-plugin-content-docs/current/common-items/_db-dashborad-process-info-desc.mdx
var _db_dashborad_process_info_desc = __webpack_require__(37927);
// EXTERNAL MODULE: ./i18n/en/docusaurus-plugin-content-docs/current/common-items/_db-v2-instance-monitoring-activesession-note.mdx
var _db_v2_instance_monitoring_activesession_note = __webpack_require__(89599);
// EXTERNAL MODULE: ./i18n/en/docusaurus-plugin-content-docs/current/common-items/_db-v2-instance-monitoring-select-metrics.mdx
var _db_v2_instance_monitoring_select_metrics = __webpack_require__(29412);
// EXTERNAL MODULE: ./i18n/en/docusaurus-plugin-content-docs/current/common-items/_db-v2-instance-monitoring-add-metrics.mdx
var _db_v2_instance_monitoring_add_metrics = __webpack_require__(9843);
// EXTERNAL MODULE: ./i18n/en/docusaurus-plugin-content-docs/current/common-items/_db-v2-instance-monitoring-change-merics.mdx
var _db_v2_instance_monitoring_change_merics = __webpack_require__(3116);
// EXTERNAL MODULE: ./i18n/en/docusaurus-plugin-content-docs/current/common-items/_db-v2-instance-monitoring-delete-metrics.mdx
var _db_v2_instance_monitoring_delete_metrics = __webpack_require__(82701);
// EXTERNAL MODULE: ./i18n/en/docusaurus-plugin-content-docs/current/common-items/_db-v2-instance-monitoring-preset.mdx
var _db_v2_instance_monitoring_preset = __webpack_require__(59165);
// EXTERNAL MODULE: ./i18n/en/docusaurus-plugin-content-docs/current/common-items/_db-using-area-active-session.mdx
var _db_using_area_active_session = __webpack_require__(16462);
// EXTERNAL MODULE: ./i18n/en/docusaurus-plugin-content-docs/current/common-items/_db-folding-activesession-table.mdx
var _db_folding_activesession_table = __webpack_require__(6849);
// EXTERNAL MODULE: ./i18n/en/docusaurus-plugin-content-docs/current/common-items/_db-v2-data-edit-column.mdx
var _db_v2_data_edit_column = __webpack_require__(67405);
// EXTERNAL MODULE: ./i18n/en/docusaurus-plugin-content-docs/current/common-items/_db-table-data-filtering.mdx
var _db_table_data_filtering = __webpack_require__(79850);
// EXTERNAL MODULE: ./i18n/en/docusaurus-plugin-content-docs/current/common-items/_db-redis-info-of-column.mdx
var _db_redis_info_of_column = __webpack_require__(26205);
;// CONCATENATED MODULE: ./i18n/en/docusaurus-plugin-content-docs/current/redis/instance-monitoring.mdx
...
const metadata = {
  ...
  "title": "Monitoring a Database Instance",
  "description": "In the instance monitoring menu, you can check the information details on key metrics of the Redis database server in real time.",
  "source": "@site/i18n/en/docusaurus-plugin-content-docs/current/redis/instance-monitoring.mdx",
  "sourceDirName": "redis",
