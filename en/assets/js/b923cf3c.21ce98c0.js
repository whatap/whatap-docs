"use strict";
(self["webpackChunkwhatap_origin"] = self["webpackChunkwhatap_origin"] || []).push([[86102],{
...
const metadata = {
    ...
    "title": "Increasing or decreasing the table size",
    "description": "It collects the usage of table and index on a daily basis and provides overall and each table's usage increase over time.",
    "source": "@site/i18n/en/docusaurus-plugin-content-docs/current/mysql-v1/table-size.mdx",
