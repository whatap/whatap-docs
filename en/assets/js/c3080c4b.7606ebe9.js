"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[34044],{
...
;// CONCATENATED MODULE: ./docs/common-items/_agent-signup-guide.mdx
...
;// CONCATENATED MODULE: ./docs/getting-started/_create-project-v2.mdx


const _create_project_v2_frontMatter = {};
const _create_project_v2_contentTitle = (/* unused pure expression or super */ null && (undefined));





const _create_project_v2_toc = [{
  "value": "프로젝트 생성하기",
  "id": "create-project",
  "level": 2
}];
function _create_project_v2_createMdxContent(props) {
  const _components = {
    a: "a",
  ...
  if (!Cmdname) _create_project_v2_missingMdxReference("Cmdname", true);
  if (!ImgLang) _create_project_v2_missingMdxReference("ImgLang", true);
  if (!InDoc) _create_project_v2_missingMdxReference("InDoc", true);
  if (!Xclude) _create_project_v2_missingMdxReference("Xclude", true);
  return (0,jsx_runtime.jsxs)(_components.section, {
    ...
    children: [(0,jsx_runtime.jsx)(_components.h2, {
      ...
      product: "kafka",
      children: [(0,jsx_runtime.jsxs)(_components.p, {
        children: ["에이전트를 설치하기 전에 먼저 ", (0,jsx_runtime.jsx)(_components.strong, {
          children: "피처 프로젝트"
        ...
        children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
          ...
          children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
            children: ["프로젝트를 생성하려면 화면 왼쪽 사이드 메뉴에서 ", (0,jsx_runtime.jsx)(Cmdname, {
              sid: "BTN07332",
              className: "uitext"
          ...
          children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
            children: [(0,jsx_runtime.jsx)(Cmdname, {
              sid: "TTL07073",
              className: "uitext"
            }), " 화면에서 프로젝트에 설치할 ", (0,jsx_runtime.jsx)(_components.strong, {
              children: "피처 상품"
            }), "을 선택하세요."]
          }), "\n"]
        }), "\n", (0,jsx_runtime.jsxs)(_components.li, {
          ...
          children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
            children: ["모든 설정을 완료한 다음에는 ", (0,jsx_runtime.jsx)(Cmdname, {
      ...
      children: (0,jsx_runtime.jsxs)(_components.ul, {
        children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
          ...
          children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
            children: ["여러 개의 프로젝트를 그룹으로 묶어 관리하려면 ", (0,jsx_runtime.jsx)(Cmdname, {
              sid: "project_groups",
              className: "uitext"
            }), "에서 그룹을 선택하거나 그룹을 추가하세요. 그룹에 대한 자세한 설명은 ", (0,jsx_runtime.jsx)(_components.a, {
              href: "../project/group",
              children: "다음 문서"
            }), "를 참조하세요."]
          }), "\n"]
          ...
          children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
            children: ["조직을 선택한 상태에서 프로젝트를 추가할 경우 ", (0,jsx_runtime.jsx)(Cmdname, {
...
function _create_project_v2_MDXContent(props = {}) {
  const {wrapper: MDXLayout} = {
    ...(0,lib/* useMDXComponents */.R)(),
    ...props.components
  };
  return MDXLayout ? (0,jsx_runtime.jsx)(MDXLayout, {
    ...props,
    children: (0,jsx_runtime.jsx)(_create_project_v2_createMdxContent, {
      ...props
    })
  }) : _create_project_v2_createMdxContent(props);
}
function _create_project_v2_missingMdxReference(id, component) {
  throw new Error("Expected " + (component ? "component" : "object") + " `" + id + "` to be defined: you likely forgot to import, pass, or provide it.");
}


;// CONCATENATED MODULE: ./docs/getting-started/_accesskey.mdx


const _accesskey_frontMatter = {};
const _accesskey_contentTitle = (/* unused pure expression or super */ null && (undefined));





const _accesskey_toc = [{
  "value": "프로젝트 액세스 키 확인",
  "id": "check-accesskey",
  "level": 2
}];
function _accesskey_createMdxContent(props) {
  const _components = {
    admonition: "admonition",
    h2: "h2",
    p: "p",
  ...
  if (!Cmdname) _accesskey_missingMdxReference("Cmdname", true);
  if (!Xclude) _accesskey_missingMdxReference("Xclude", true);
  return (0,jsx_runtime.jsxs)(_components.section, {
    className: "remark-sectionize-h2",
    children: [(0,jsx_runtime.jsx)(_components.h2, {
      id: "check-accesskey",
      ...
      children: ["설치 안내 섹션에서 ", (0,jsx_runtime.jsx)(Cmdname, {
        sid: "issue_project_access_key",
        className: "uitext"
      }), " 버튼을 선택하세요. ", (0,jsx_runtime.jsx)(_components.strong, {
        children: "프로젝트 액세스 키"
      ...
      children: (0,jsx_runtime.jsx)(_components.admonition, {
        type: "tip",
        children: (0,jsx_runtime.jsxs)(_components.p, {
          children: ["프로젝트를 생성한 다음에는 자동으로 ", (0,jsx_runtime.jsx)(Cmdname, {
            sid: "agent_installation",
            className: "uitext"
          }), " 페이지로 이동합니다. ", (0,jsx_runtime.jsx)(Cmdname, {
            sid: "agent_installation",
            className: "uitext"
          }), " 페이지로 이동하지 않는다면 왼쪽 메뉴에서 ", (0,jsx_runtime.jsx)(Cmdname, {
            sid: "all_projects",
            className: "uitext"
...
function _accesskey_MDXContent(props = {}) {
  const {wrapper: MDXLayout} = {
    ...(0,lib/* useMDXComponents */.R)(),
    ...props.components
  };
  return MDXLayout ? (0,jsx_runtime.jsx)(MDXLayout, {
    ...props,
    children: (0,jsx_runtime.jsx)(_accesskey_createMdxContent, {
      ...props
    })
  }) : _accesskey_createMdxContent(props);
}
function _accesskey_missingMdxReference(id, component) {
  throw new Error("Expected " + (component ? "component" : "object") + " `" + id + "` to be defined: you likely forgot to import, pass, or provide it.");
}


;// CONCATENATED MODULE: ./docs/common-items/_db-install-agent-steps.mdx


const _db_install_agent_steps_frontMatter = {};
const _db_install_agent_steps_contentTitle = (/* unused pure expression or super */ null && (undefined));





const _db_install_agent_steps_toc = [];
function _db_install_agent_steps_createMdxContent(props) {
  const _components = {
    a: "a",
    admonition: "admonition",
    code: "code",
  ...
  if (!Cmdname) _db_install_agent_steps_missingMdxReference("Cmdname", true);
  if (!Details) _db_install_agent_steps_missingMdxReference("Details", true);
  if (!InDoc) _db_install_agent_steps_missingMdxReference("InDoc", true);
  if (!UI) _db_install_agent_steps_missingMdxReference("UI", true);
  if (!Xclude) _db_install_agent_steps_missingMdxReference("Xclude", true);
  return (0,jsx_runtime.jsxs)(_components.ol, {
    children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
      children: ["\n", (0,jsx_runtime.jsx)(_components.p, {
        ...
        children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
          children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
            children: ["와탭 모니터링 서비스 화면에서 ", (0,jsx_runtime.jsx)(_components.em, {
              children: (0,jsx_runtime.jsx)(_components.strong, {
                children: "Download"
              })
            ...
            children: [(0,jsx_runtime.jsx)(_components.thead, {
              ...
              children: [(0,jsx_runtime.jsxs)(_components.tr, {
                children: [(0,jsx_runtime.jsx)(_components.td, {
                  ...
                  children: ["데이터베이스 서버의 데이터를 수집하는 수집 서버의 주소와 서버의 프로젝트 액세스 키를 입력하는 파일입니다. 에이전트 설정에 관한 자세한 내용은 ", (0,jsx_runtime.jsx)(_components.a, {
                    href: "agent-settings",
                    children: "다음 문서"
                  }), "를 참조하세요."]
                })]
                ...
                children: [(0,jsx_runtime.jsxs)(_components.td, {
                  children: [(0,jsx_runtime.jsx)("sup", {
                    children: "*"
            ...
            children: [(0,jsx_runtime.jsx)(_components.thead, {
              ...
              children: [(0,jsx_runtime.jsxs)(_components.tr, {
                ...
                children: [(0,jsx_runtime.jsx)(_components.td, {
                  ...
                  children: ["SQL 텍스트 수집과 지표 계산을 수행하는 부가 에이전트 파일이 들어있는 디렉터리입니다. 데이터베이스 서버에 설치해야 합니다.", (0,jsx_runtime.jsx)("br", {}), "* CUBRID 모니터링을 위한 부가 에이전트를 위한 디렉터리입니다."]
                })]
              }), (0,jsx_runtime.jsxs)(_components.tr, {
                children: [(0,jsx_runtime.jsxs)(_components.td, {
                  children: ["⎿ ", (0,jsx_runtime.jsx)(_components.em, {
                  ...
                  children: ["데이터베이스 및 부가 에이전트 연결 정보를 입력하는 파일 입니다.", (0,jsx_runtime.jsx)("br", {}), "* CUBRID 모니터링을 위한 부가 에이전트의 설정 파일입니다. 자세한 내용은 ", (0,jsx_runtime.jsx)(_components.a, {
...
function _db_install_agent_steps_MDXContent(props = {}) {
  const {wrapper: MDXLayout} = {
    ...(0,lib/* useMDXComponents */.R)(),
    ...props.components
  };
  return MDXLayout ? (0,jsx_runtime.jsx)(MDXLayout, {
    ...props,
    children: (0,jsx_runtime.jsx)(_db_install_agent_steps_createMdxContent, {
      ...props
    })
  }) : _db_install_agent_steps_createMdxContent(props);
}
function _db_install_agent_steps_missingMdxReference(id, component) {
  throw new Error("Expected " + (component ? "component" : "object") + " `" + id + "` to be defined: you likely forgot to import, pass, or provide it.");
}


;// CONCATENATED MODULE: ./docs/common-items/_db-create-monitoring-account.mdx


const _db_create_monitoring_account_frontMatter = {};
const _db_create_monitoring_account_contentTitle = (/* unused pure expression or super */ null && (undefined));





const _db_create_monitoring_account_toc = [{
  "value": "계정 생성",
  "id": "uid",
  "level": 2
}];
function _db_create_monitoring_account_createMdxContent(props) {
  const _components = {
    a: "a",
    admonition: "admonition",
    code: "code",
  ...
  if (!InDoc) _db_create_monitoring_account_missingMdxReference("InDoc", true);
  if (!Xclude) _db_create_monitoring_account_missingMdxReference("Xclude", true);
  return (0,jsx_runtime.jsxs)(_components.section, {
    className: "remark-sectionize-h2",
    children: [(0,jsx_runtime.jsx)(_components.h2, {
      id: "uid",
      ...
      children: [(0,jsx_runtime.jsx)(Xclude, {
        ...
        children: (0,jsx_runtime.jsxs)(_components.ul, {
          children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
            children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
              children: ["이미 있는 계정을 사용하고 싶다면 ", (0,jsx_runtime.jsx)(_components.a, {
                href: "#create-db-user",
            ...
            children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
              children: ["예시 코드에서 ", (0,jsx_runtime.jsx)(_components.code, {
                children: "whatap"
        ...
        children: (0,jsx_runtime.jsxs)(_components.ul, {
          children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
            children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
              children: ["권한을 가진 계정이 있다면 이 단계를 생략하고 ", (0,jsx_runtime.jsx)(_components.a, {
        ...
        children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
          children: ["예시 코드의 ", (0,jsx_runtime.jsx)(_components.code, {
...
function _db_create_monitoring_account_MDXContent(props = {}) {
  const {wrapper: MDXLayout} = {
    ...(0,lib/* useMDXComponents */.R)(),
    ...props.components
  };
  return MDXLayout ? (0,jsx_runtime.jsx)(MDXLayout, {
    ...props,
    children: (0,jsx_runtime.jsx)(_db_create_monitoring_account_createMdxContent, {
      ...props
    })
  }) : _db_create_monitoring_account_createMdxContent(props);
}
function _db_create_monitoring_account_missingMdxReference(id, component) {
  throw new Error("Expected " + (component ? "component" : "object") + " `" + id + "` to be defined: you likely forgot to import, pass, or provide it.");
}


;// CONCATENATED MODULE: ./docs/common-items/_db-create-db-user-file.mdx


const _db_create_db_user_file_frontMatter = {};
const _db_create_db_user_file_contentTitle = (/* unused pure expression or super */ null && (undefined));





const _db_create_db_user_file_toc = [];
function _db_create_db_user_file_createMdxContent(props) {
  const _components = {
    a: "a",
    admonition: "admonition",
    code: "code",
  ...
  if (!TabItem) _db_create_db_user_file_missingMdxReference("TabItem", true);
  if (!Tabs) _db_create_db_user_file_missingMdxReference("Tabs", true);
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsx)(_components.p, {
      ...
      children: [(0,jsx_runtime.jsx)(_components.em, {
        ...
        children: "uid.bat"
      }), " 배치 파일)은 와탭 데이터베이스 에이전트를 설치한 경로에서 찾을 수 있습니다. user 없이 암호만 있는 경우 ", (0,jsx_runtime.jsx)(_components.code, {
        children: "DB_USER"
        ...
        children: [(0,jsx_runtime.jsx)(_components.pre, {
          ...
          children: (0,jsx_runtime.jsxs)(_components.ul, {
            children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
              ...
              children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
                children: ["DB 유저 파일을 생성하기 위해서는 프로젝트 액세스 키가 ", (0,jsx_runtime.jsx)(_components.em, {
                  children: "whatap.conf"
                }), " 파일에 입력되어 있어야 합니다. ", (0,jsx_runtime.jsx)(_components.a, {
                  href: "#check-accesskey",
                  children: "프로젝트 액세스 키 확인"
                })]
              }), "\n"]
              ...
              children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
                children: ["Azure Database 환경의 경우 ", (0,jsx_runtime.jsx)(_components.code, {
                  children: "DB_USER"
        ...
        children: [(0,jsx_runtime.jsx)(_components.pre, {
          ...
          children: (0,jsx_runtime.jsxs)(_components.ul, {
            children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
              ...
              children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
                children: ["Windows 환경에서는 패스워드의 특수 문자에 Escape Character가 필요 없습니다. 패스워드에 따옴표(", (0,jsx_runtime.jsx)(_components.code, {
                  children: "\""
                }), ")를 사용한 경우에는 필요합니다."]
              }), "\n"]
            }), "\n"]
...
function _db_create_db_user_file_MDXContent(props = {}) {
  const {wrapper: MDXLayout} = {
    ...(0,lib/* useMDXComponents */.R)(),
    ...props.components
  };
  return MDXLayout ? (0,jsx_runtime.jsx)(MDXLayout, {
    ...props,
    children: (0,jsx_runtime.jsx)(_db_create_db_user_file_createMdxContent, {
      ...props
    })
  }) : _db_create_db_user_file_createMdxContent(props);
}
function _db_create_db_user_file_missingMdxReference(id, component) {
  throw new Error("Expected " + (component ? "component" : "object") + " `" + id + "` to be defined: you likely forgot to import, pass, or provide it.");
}


;// CONCATENATED MODULE: ./docs/common-items/_db-run-agent.mdx


const _db_run_agent_frontMatter = {};
const _db_run_agent_contentTitle = (/* unused pure expression or super */ null && (undefined));





const _db_run_agent_toc = [{
  "value": "모니터링 시작하기",
  "id": "start-monitoring",
  "level": 2
}];
function _db_run_agent_createMdxContent(props) {
  const _components = {
    a: "a",
    admonition: "admonition",
    code: "code",
  ...
  if (!InDoc) _db_run_agent_missingMdxReference("InDoc", true);
  if (!TabItem) _db_run_agent_missingMdxReference("TabItem", true);
  if (!Tabs) _db_run_agent_missingMdxReference("Tabs", true);
  if (!Xclude) _db_run_agent_missingMdxReference("Xclude", true);
  return (0,jsx_runtime.jsxs)(_components.section, {
    className: "remark-sectionize-h2",
    children: [(0,jsx_runtime.jsx)(_components.h2, {
      id: "start-monitoring",
      ...
      children: [(0,jsx_runtime.jsxs)(Tabs, {
        ...
        children: [(0,jsx_runtime.jsxs)(TabItem, {
          ...
          children: [(0,jsx_runtime.jsx)(_components.pre, {
            ...
            children: ["데몬처럼 사용하고 싶은 경우에는 다음 명령어를 실행하세요. 단 ", (0,jsx_runtime.jsx)(_components.strong, {
              children: "nohup"
            }), "을 설치한 환경에서만 동작합니다."]
          }), (0,jsx_runtime.jsx)(_components.pre, {
            children: (0,jsx_runtime.jsx)(_components.code, {
          ...
          children: [(0,jsx_runtime.jsx)(_components.pre, {
            ...
            children: (0,jsx_runtime.jsxs)(_components.p, {
              children: [(0,jsx_runtime.jsx)(_components.strong, {
                ...
                children: "서비스"
              }), "(services.msc)에서 ", (0,jsx_runtime.jsx)(_components.strong, {
                children: "WhatapDBXAgent"
              }), " 서비스를 시작하거나 중지할 수 있습니다. 사용하는 Windows 버전에 따라 ", (0,jsx_runtime.jsx)(_components.strong, {
                children: "서비스"
              }), " 경로는 다를 수 있습니다."]
            })
          })]
        ...
        children: ["데이터베이스 모니터링을 위한 에이전트 설치를 완료했습니다. ", (0,jsx_runtime.jsx)(_components.a, {
...
function _db_run_agent_MDXContent(props = {}) {
  const {wrapper: MDXLayout} = {
    ...(0,lib/* useMDXComponents */.R)(),
    ...props.components
  };
  return MDXLayout ? (0,jsx_runtime.jsx)(MDXLayout, {
    ...props,
    children: (0,jsx_runtime.jsx)(_db_run_agent_createMdxContent, {
      ...props
    })
  }) : _db_run_agent_createMdxContent(props);
}
function _db_run_agent_missingMdxReference(id, component) {
  throw new Error("Expected " + (component ? "component" : "object") + " `" + id + "` to be defined: you likely forgot to import, pass, or provide it.");
}
...
const _db_install_xos_agent_frontMatter = {};
...
function _db_install_xos_agent_createMdxContent(props) {
  ...
  if (!Cmdname) _db_install_xos_agent_missingMdxReference("Cmdname", true);
  if (!ImgLang) _db_install_xos_agent_missingMdxReference("ImgLang", true);
  if (!InDoc) _db_install_xos_agent_missingMdxReference("InDoc", true);
  if (!TabItem) _db_install_xos_agent_missingMdxReference("TabItem", true);
  if (!Tabs) _db_install_xos_agent_missingMdxReference("Tabs", true);
  if (!UI) _db_install_xos_agent_missingMdxReference("UI", true);
  return (0,jsx_runtime.jsxs)(_components.section, {
    className: "remark-sectionize-h2",
    children: [(0,jsx_runtime.jsx)(_components.h2, {
      id: "apply-xos-agent",
        ...
        children: [(0,jsx_runtime.jsxs)(TabItem, {
          ...
          children: [(0,jsx_runtime.jsxs)(_components.p, {
            ...
            children: [(0,jsx_runtime.jsxs)(_components.ul, {
              ...
              children: (0,jsx_runtime.jsxs)(_components.ul, {
                children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
                  children: ["AWS 인증을 위한 ", (0,jsx_runtime.jsx)(_components.code, {
                    children: "aws_arn"
...
function _db_install_xos_agent_missingMdxReference(id, component) {
  throw new Error("Expected " + (component ? "component" : "object") + " `" + id + "` to be defined: you likely forgot to import, pass, or provide it.");
}
...
const metadata = {
  "id": "altibase-v1/install-agent",
  "title": "에이전트 설치",
  "description": "와탭 데이터베이스 모니터링 서비스 이용을 위한 기본 설치 방법을 안내합니다.",
  "source": "@site/docs/altibase-v1/install-agent.mdx",
  "sourceDirName": "altibase-v1",
  "slug": "/altibase-v1/install-agent",
  "permalink": "/en/altibase-v1/install-agent",
  "draft": false,
  "unlisted": false,
  "editUrl": "undefined/docs/altibase-v1/install-agent.mdx",
  "tags": [],
  "version": "current",
  "frontMatter": {
    "id": "install-agent",
  ...
  "previous": {
    "title": "지원 환경",
    "permalink": "/en/altibase-v1/monitoring-support"
  },
  "next": {
    "title": "설치 점검 사항",
    "permalink": "/en/altibase-v1/after-install-agent"
  }
};
const assets = {
...
const install_agent_toc = [...toc, ..._create_project_v2_toc, ..._accesskey_toc, {
  "value": "와탭 데이터베이스 에이전트 다운로드",
  "id": "와탭-데이터베이스-에이전트-다운로드",
  "level": 2
}, ..._db_install_agent_steps_toc, ..._db_create_monitoring_account_toc, {
  "value": "DB 유저 파일 생성",
  "id": "create-db-user",
  "level": 2
}, ..._db_create_db_user_file_toc, ..._db_run_agent_toc, ..._db_install_xos_agent_toc];
function install_agent_createMdxContent(props) {
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsx)(_components.p, {
      ...
      en: "MIo3HRIOt8M",
      ja: "MIo3HRIOt8M"
    }), "\n", "\n", (0,jsx_runtime.jsx)(_create_project_v2_MDXContent, {}), "\n", "\n", (0,jsx_runtime.jsx)(_accesskey_MDXContent, {}), "\n", (0,jsx_runtime.jsxs)(_components.section, {
      className: "remark-sectionize-h2",
      children: [(0,jsx_runtime.jsx)(_components.h2, {
        id: "와탭-데이터베이스-에이전트-다운로드",
        children: "와탭 데이터베이스 에이전트 다운로드"
      }), (0,jsx_runtime.jsx)(_db_install_agent_steps_MDXContent, {}), (0,jsx_runtime.jsxs)(_components.ol, {
        start: "3",
        children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
          children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
      ...
      }), (0,jsx_runtime.jsx)(_db_create_monitoring_account_MDXContent, {}), (0,jsx_runtime.jsx)(_components.pre, {
        children: (0,jsx_runtime.jsx)(_components.code, {
          className: "language-bash",
      ...
      children: [(0,jsx_runtime.jsx)(_components.h2, {
        id: "create-db-user",
        children: "DB 유저 파일 생성"
      }), (0,jsx_runtime.jsx)(_db_create_db_user_file_MDXContent, {}), (0,jsx_runtime.jsx)(_db_run_agent_MDXContent, {}), (0,jsx_runtime.jsx)(_db_install_xos_agent_MDXContent, {})]
    })]
  });
}
