"use strict";
(self["webpackChunkwhatap_origin"] = self["webpackChunkwhatap_origin"] || []).push([[78586],{
...
const metadata = {
    "unversionedId": "mssql/agent-settings",
    "id": "mssql/agent-settings",
    "title": "Configuration",
    "description": "Learn about additional options you can set through the whatap.conf file on the database agent server.",
    "source": "@site/i18n/en/docusaurus-plugin-content-docs/current/mssql/agent-settings.mdx",
    "sourceDirName": "mssql",
    "slug": "/mssql/agent-settings",
    "permalink": "/en/mssql/agent-settings",
    "draft": false,
    "editUrl": "undefined/docs/mssql/agent-settings.mdx",
    "tags": [
        {
            "label": "SQL Server",
    ...
    "previous": {
        ...
        "permalink": "/en/mssql/troubleshooting"
    },
    "next": {
...
function MDXContent(_param) {
    ...
    return /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)(MDXLayout, _object_spread_props(_object_spread({}, layoutProps, props), {
        ...
        mdxType: "MDXLayout"
    }), /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("p", null, `You can take a look at the structure of the WhaTap agent, set additional functions through various options, and monitor the resources of the DB server to be monitored.`), /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)(_theme_DocCardList__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .Z, {
        mdxType: "DocCardList"
    }));
}
