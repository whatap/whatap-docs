"use strict";
(self["webpackChunkwhatap_origin"] = self["webpackChunkwhatap_origin"] || []).push([[68213],{
...
const metadata = {
    "unversionedId": "redis/set-notification-message",
    "id": "redis/set-notification-message",
    "title": "Notification message customization",
    "description": "It provides the customization function to modify the alert notification messages that are delivered to project members.",
    "source": "@site/i18n/en/docusaurus-plugin-content-docs/current/redis/set-notification-message.mdx",
    "sourceDirName": "redis",
    "slug": "/redis/set-notification-message",
    "permalink": "/en/redis/set-notification-message",
    "draft": false,
    "editUrl": "undefined/docs/redis/set-notification-message.mdx",
    "tags": [
        {
            "label": "Redis",
