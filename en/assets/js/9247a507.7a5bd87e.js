"use strict";
(self["webpackChunkwhatap_origin"] = self["webpackChunkwhatap_origin"] || []).push([[33640],{
...
const metadata = {
    "unversionedId": "azure/metrics-search",
    "id": "azure/metrics-search",
    "title": "Metrics Search",
    "description": "You can search the metrics raw data.",
    "source": "@site/i18n/en/docusaurus-plugin-content-docs/current/azure/metrics-search.mdx",
    "sourceDirName": "azure",
    "slug": "/azure/metrics-search",
    "permalink": "/en/azure/metrics-search",
    "draft": false,
    "editUrl": "undefined/docs/azure/metrics-search.mdx",
    "tags": [
        {
            "label": "Metrics",
