"use strict";
(self["webpackChunkwhatap_origin"] = self["webpackChunkwhatap_origin"] || []).push([[23963],{
...
const metadata = {
    "unversionedId": "mysql/flexboard-widget-manage",
    "id": "mysql/flexboard-widget-manage",
    "title": "Managing the widgets",
    "description": "Manage the widgets placed on the Flex board.",
    "source": "@site/i18n/en/docusaurus-plugin-content-docs/current/mysql/flexboard-widget-manage.mdx",
    "sourceDirName": "mysql",
    "slug": "/mysql/flexboard-widget-manage",
    "permalink": "/en/mysql/flexboard-widget-manage",
    "draft": false,
    "editUrl": "undefined/docs/mysql/flexboard-widget-manage.mdx",
    "tags": [
        {
            "label": "MySQL",
    ...
    "previous": {
        ...
        "permalink": "/en/mysql/flexboard-metric-widget"
    },
    "next": {
        "title": "Flex board screen modes",
        "permalink": "/en/mysql/flexboard-mode"
    }
};
const assets = {};
...
function MDXContent(_param) {
    ...
    return /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)(MDXLayout, _object_spread_props(_object_spread({}, layoutProps, props), {
        ...
        product: "MySQL",
        link: "../mysql-v1/flexboard-widget-manage",
        mdxType: "Note"
