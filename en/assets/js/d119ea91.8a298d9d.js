"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[6236],{
...
;// CONCATENATED MODULE: ./docs/common-items/_import_v2-file-option-note.mdx
...
const _db_agent_xos_settings_desc_frontMatter = {};
const _db_agent_xos_settings_desc_contentTitle = (/* unused pure expression or super */ null && (undefined));





const _db_agent_xos_settings_desc_toc = [];
function _db_agent_xos_settings_desc_createMdxContent(props) {
  const _components = {
    admonition: "admonition",
    p: "p",
    ...(0,lib/* useMDXComponents */.R)(),
...
function _db_agent_xos_settings_desc_MDXContent(props = {}) {
  const {wrapper: MDXLayout} = {
    ...(0,lib/* useMDXComponents */.R)(),
    ...props.components
  };
  return MDXLayout ? (0,jsx_runtime.jsx)(MDXLayout, {
    ...props,
    children: (0,jsx_runtime.jsx)(_db_agent_xos_settings_desc_createMdxContent, {
      ...props
    })
  }) : _db_agent_xos_settings_desc_createMdxContent(props);
}
...
function _db_xos_conf_createMdxContent(props) {
  ...
  if (!Cmdname) _db_xos_conf_missingMdxReference("Cmdname", true);
  if (!InDoc) _db_xos_conf_missingMdxReference("InDoc", true);
  return (0,jsx_runtime.jsxs)(_components.section, {
    className: "remark-sectionize-h2",
    children: [(0,jsx_runtime.jsx)(_components.h2, {
      id: "xosconf-파일-설정",
...
function _db_xos_conf_missingMdxReference(id, component) {
  throw new Error("Expected " + (component ? "component" : "object") + " `" + id + "` to be defined: you likely forgot to import, pass, or provide it.");
}
...
;// CONCATENATED MODULE: ./docs/altibase/agent-xos-settings.mdx
...
const metadata = {
  "id": "altibase/agent-xos-settings",
  "title": "XOS 에이전트 설정",
  "description": "데이터베이스 프로세스 모니터링 설정에 대해 알아봅니다.",
  "source": "@site/docs/altibase/agent-xos-settings.mdx",
  "sourceDirName": "altibase",
  "slug": "/altibase/agent-xos-settings",
  "permalink": "/en/altibase/agent-xos-settings",
  "draft": false,
  "unlisted": false,
  "editUrl": "undefined/docs/altibase/agent-xos-settings.mdx",
  "tags": [],
  "version": "current",
  "frontMatter": {
    "id": "agent-xos-settings",
...
const agent_xos_settings_toc = [..._db_agent_xos_settings_desc_toc, ..._db_xos_whatap_conf_toc, ..._db_xos_conf_toc, ...toc, ..._db_run_xos_toc];
function agent_xos_settings_createMdxContent(props) {
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsx)(_db_agent_xos_settings_desc_MDXContent, {}), "\n", "\n", (0,jsx_runtime.jsx)(_db_xos_whatap_conf_MDXContent, {}), "\n", "\n", (0,jsx_runtime.jsx)(_db_xos_conf_MDXContent, {}), "\n", (0,jsx_runtime.jsx)(MDXContent, {
      ver: "1.9.0"
