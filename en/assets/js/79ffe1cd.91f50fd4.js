"use strict";
(self["webpackChunkwhatap_origin"] = self["webpackChunkwhatap_origin"] || []).push([[28461],{
...
const metadata = {
    "unversionedId": "postgresql/set-notification-message",
    "id": "postgresql/set-notification-message",
    "title": "Notification message customization",
    "description": "It provides the customization function to modify the alert notification messages that are delivered to project members.",
    "source": "@site/i18n/en/docusaurus-plugin-content-docs/current/postgresql/set-notification-message.mdx",
    "sourceDirName": "postgresql",
    "slug": "/postgresql/set-notification-message",
    "permalink": "/en/postgresql/set-notification-message",
    "draft": false,
    "editUrl": "undefined/docs/postgresql/set-notification-message.mdx",
    "tags": [
        {
            "label": "PostgreSQL",
...
function MDXContent(_param) {
    ...
    return /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)(MDXLayout, _object_spread_props(_object_spread({}, layoutProps, props), {
        ...
        product: "PostgreSQL",
        link: "../postgresql-v1/set-notification-message",
        mdxType: "Note"
