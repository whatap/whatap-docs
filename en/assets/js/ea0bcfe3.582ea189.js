"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[71260],{
...
;// CONCATENATED MODULE: ./i18n/en/docusaurus-plugin-content-docs/current/common-items/_common-whatap-topology-map.mdx
  ...
  return (0,jsx_runtime.jsxs)(_components.ul, {
    children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
      children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
        ...
        children: ["It creates the topology statistics by using transactions. If the value of the ", (0,jsx_runtime.jsx)(_components.code, {
...
;// CONCATENATED MODULE: ./i18n/en/docusaurus-plugin-content-docs/current/common-items/_topology-settings-whatap.mdx
...
function _topology_settings_whatap_createMdxContent(props) {
  ...
  return (0,jsx_runtime.jsxs)(_components.section, {
    ...
    children: [(0,jsx_runtime.jsx)(_components.h2, {
      ...
      children: ["The following data collection options can be set in ", (0,jsx_runtime.jsx)(_components.em, {
...
/* harmony import */ var _common_items_topology_settings_whatap_mdx__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(74270);
...
const metadata = {
  ...
  "title": "Setting the agent options",
  "description": "It explains how to apply the options to an agent for using the topology functions.",
  "source": "@site/i18n/en/docusaurus-plugin-content-docs/current/dotnet/topology-settings.mdx",
