"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[34007],{
...
const metadata = {
  "id": "redis/metrics-chart",
  "title": "Metrics Chart",
  "description": "You can see the metrics data through a chart.",
  "source": "@site/i18n/en/docusaurus-plugin-content-docs/current/redis/metrics-chart.mdx",
  "sourceDirName": "redis",
  "slug": "/redis/metrics-chart",
  "permalink": "/en/redis/metrics-chart",
  "draft": false,
  "unlisted": false,
  "editUrl": "undefined/docs/redis/metrics-chart.mdx",
  "tags": [],
  "version": "current",
  "frontMatter": {
    "id": "metrics-chart",
  ...
  "next": {
    ...
    "permalink": "/en/redis/metrics-search"
  }
};
const assets = {
