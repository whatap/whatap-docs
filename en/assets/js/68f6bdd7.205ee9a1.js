"use strict";
(self["webpackChunkwhatap_origin"] = self["webpackChunkwhatap_origin"] || []).push([[7405],{
...
const metadata = {
    "unversionedId": "dotnet/dashboard-hitmap-trace",
    "id": "dotnet/dashboard-hitmap-trace",
    "title": "HITMAP - Trace analysis",
    "description": "You can see the transaction list and steps under each transaction at once by opening the trace analysis window through the Hitmap widget.",
    "source": "@site/i18n/en/docusaurus-plugin-content-docs/current/dotnet/dashboard-hitmap-trace.mdx",
    ...
    "next": {
        ...
        "permalink": "/en/dotnet/dashboard-transactionmap"
    }
};
const assets = {};
const toc = [
