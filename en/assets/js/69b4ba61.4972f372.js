"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[29506],{
...
__webpack_require__.d(__webpack_exports__, {
  ...
  contentTitle: () => (/* binding */ log_main_contentTitle),
  "default": () => (/* binding */ log_main_MDXContent),
  frontMatter: () => (/* binding */ log_main_frontMatter),
  metadata: () => (/* binding */ metadata),
  toc: () => (/* binding */ log_main_toc)
});
...
;// CONCATENATED MODULE: ./docs/common-items/_log-learn-main-menu.mdx
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsx)(_components.p, {
      ...
      children: [(0,jsx_runtime.jsx)(Cmdname, {
        sid: "side_log",
        className: "uitext"
      }), " 메뉴는 조회 및 분석과 옵션 설정 등의 기능을 제공합니다. ", (0,jsx_runtime.jsx)(Cmdname, {
      ...
      children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
        children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
          ...
          children: ["와탭 모니터링 서비스 초기 화면에서 프로젝트를 선택한 다음 프로젝트 메뉴 하위에 ", (0,jsx_runtime.jsx)(Cmdname, {
            sid: "side_log",
            className: "uitext"
        ...
        children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
          ...
          children: ["와탭 모니터링 서비스 초기 화면에서 프로젝트를 선택한 다음 프로젝트 메뉴 하위에 ", (0,jsx_runtime.jsx)(Cmdname, {
            sid: "side_event",
            className: "uitext"
          }), " 메뉴를 선택해 ", (0,jsx_runtime.jsx)(Cmdname, {
            sid: "side_eventSetting",
            className: "uitext"
...
;// CONCATENATED MODULE: ./docs/altibase/log-main.mdx


const log_main_frontMatter = {
	id: 'log-main',
	title: '로그',
...
const log_main_contentTitle = undefined;
const metadata = {
  "id": "altibase/log-main",
  "title": "로그",
  "description": "로그 모니터링의 주요 메뉴를 안내합니다.",
  "source": "@site/docs/altibase/log-main.mdx",
  "sourceDirName": "altibase",
  "slug": "/altibase/log-main",
  "permalink": "/en/altibase/log-main",
  "draft": false,
  "unlisted": false,
  "editUrl": "undefined/docs/altibase/log-main.mdx",
  "tags": [],
  "version": "current",
  "frontMatter": {
    "id": "log-main",
...
const log_main_toc = [...toc];
function log_main_createMdxContent(props) {
  return (0,jsx_runtime.jsx)(MDXContent, {});
}
function log_main_MDXContent(props = {}) {
  const {wrapper: MDXLayout} = {
    ...(0,lib/* useMDXComponents */.R)(),
    ...props.components
  };
  return MDXLayout ? (0,jsx_runtime.jsx)(MDXLayout, {
    ...props,
    children: (0,jsx_runtime.jsx)(log_main_createMdxContent, {
      ...props
    })
  }) : log_main_createMdxContent(props);
}
