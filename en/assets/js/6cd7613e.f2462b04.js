"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[75574],{
...
const metadata = {
  ...
  "title": "Configuration",
  "description": "Learn about additional options you can set through the whatap.conf file on the database agent server.",
  "source": "@site/i18n/en/docusaurus-plugin-content-docs/current/oracle-v1/agent-settings.mdx",
  "sourceDirName": "oracle-v1",
  "slug": "/oracle-v1/agent-settings",
  "permalink": "/en/oracle-v1/agent-settings",
  "draft": false,
  "unlisted": false,
  "editUrl": "undefined/docs/oracle-v1/agent-settings.mdx",
  "tags": [],
  "version": "current",
  "frontMatter": {
    "id": "agent-settings",
