"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[59922],{
...
const metadata = {
  "id": "golang/analysis-msa",
  "title": "MSA Analysis",
  "description": "The MSA analysis function analyzes the proportion of calls between transactions collected through the WhaTap's MTRACE (multi-server tracing) function.",
  "source": "@site/i18n/en/docusaurus-plugin-content-docs/current/golang/analysis-msa.mdx",
  "sourceDirName": "golang",
  "slug": "/golang/analysis-msa",
  "permalink": "/en/golang/analysis-msa",
  "draft": false,
  "unlisted": false,
  "editUrl": "undefined/docs/golang/analysis-msa.mdx",
  "tags": [],
  "version": "current",
  "frontMatter": {
    "id": "analysis-msa",
