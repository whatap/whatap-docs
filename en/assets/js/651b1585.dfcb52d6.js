"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[33346],{
...
const metadata = {
  ...
  "title": "Agent network communication",
  "description": "The following lists the settings related to network communication of the database agent.",
  "source": "@site/i18n/en/docusaurus-plugin-content-docs/current/mssql/agent-network.mdx",
  "sourceDirName": "mssql",
  "slug": "/mssql/agent-network",
  "permalink": "/en/mssql/agent-network",
  "draft": false,
  "unlisted": false,
  ...
  "previous": {
    "title": "Configuration",
    "permalink": "/en/mssql/agent-settings"
  },
  "next": {
