"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[80903],{
...
const metadata = {
  ...
  "title": "Notification message customization",
  "description": "It provides the customization function to modify the alert notification messages that are delivered to project members.",
  "source": "@site/i18n/en/docusaurus-plugin-content-docs/current/java/set-notification-message.mdx",
  "sourceDirName": "java",
  ...
  "next": {
    ...
    "permalink": "/en/java/hitmap-notice"
  }
};
const assets = {
