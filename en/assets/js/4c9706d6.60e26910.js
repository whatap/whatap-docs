"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[9704],{
...
const metadata = {
  "id": "aws-log/set-receive-event",
  "title": "Alert Notification Settings",
  "description": "You can set various functions related to reception of alerts by project members.",
  "source": "@site/i18n/en/docusaurus-plugin-content-docs/current/aws-log/set-receive-event.mdx",
  "sourceDirName": "aws-log",
  "slug": "/aws-log/set-receive-event",
  "permalink": "/en/aws-log/set-receive-event",
  "draft": false,
  "unlisted": false,
  "editUrl": "undefined/docs/aws-log/set-receive-event.mdx",
  "tags": [],
  "version": "current",
  "frontMatter": {
    "id": "set-receive-event",
  ...
  "previous": {
    ...
    "permalink": "/en/aws-log/set-notice"
  },
  "next": {
    "title": "Event History",
    "permalink": "/en/aws-log/set-event-history"
  }
};
const assets = {
