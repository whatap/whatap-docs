"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[32900],{
...
const metadata = {
  ...
  "title": "Notification message customization",
  "description": "It provides the customization function to modify the alert notification messages that are delivered to project members.",
  "source": "@site/i18n/en/docusaurus-plugin-content-docs/current/mysql/set-notification-message.mdx",
  "sourceDirName": "mysql",
  ...
  "next": {
    ...
    "permalink": "/en/mysql/set-event-detect-anomal"
  }
};
const assets = {
