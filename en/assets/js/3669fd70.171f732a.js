"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[85072],{
...
;// CONCATENATED MODULE: ./docs/common-items/_db-server-naming.mdx
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsxs)(_components.section, {
      ...
      children: [(0,jsx_runtime.jsx)(_components.h3, {
        ...
        children: ["기본 패턴에 대한 변경은 ", (0,jsx_runtime.jsx)(_components.em, {
      ...
      children: [(0,jsx_runtime.jsx)(_components.h3, {
        ...
        children: (0,jsx_runtime.jsxs)(_components.p, {
          children: ["에이전트 이름 설정과 관련한 whatap.conf 파일의 설정은 ", (0,jsx_runtime.jsx)(_components.a, {
            href: "agent-naming",
            children: "다음 문서"
          }), "를 참조하세요."]
        })
...
;// CONCATENATED MODULE: ./docs/common-items/_db-update-agent.mdx


const _db_update_agent_frontMatter = {};
const _db_update_agent_contentTitle = (/* unused pure expression or super */ null && (undefined));





const _db_update_agent_toc = [{
  "value": "에이전트 업데이트",
  "id": "에이전트-업데이트",
  "level": 2
}, {
...
function _db_update_agent_createMdxContent(props) {
  const _components = {
    admonition: "admonition",
    code: "code",
    em: "em",
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsx)(_components.section, {
      ...
      children: [(0,jsx_runtime.jsx)(_components.h3, {
        ...
        children: ["에이전트를 업데이트하면 최신 버전의 에이전트 파일을 에이전트 설치 경로(", (0,jsx_runtime.jsx)(_components.em, {
        ...
        children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
          children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
            children: ["업데이트할 수 있는 에이전트는 ", (0,jsx_runtime.jsx)(Cmdname, {
              sid: "TTL06230",
              className: "uitext"
            }), " 버튼이 활성화됩니다."]
          }), "\n"]
          ...
          children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
            children: ["에이전트를 개별로 업데이트하려면 각 에이전트 항목의 오른쪽에 ", (0,jsx_runtime.jsx)(Cmdname, {
              sid: "TTL06230",
              className: "uitext"
            }), " 버튼을 선택하세요."]
          }), "\n"]
          ...
          children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
            children: ["모든 에이전트를 한번에 업데이트하려면 ", (0,jsx_runtime.jsx)(Cmdname, {
              sid: "DSC07289",
              className: "uitext"
            }), " 버튼을 선택하세요."]
          }), "\n"]
      ...
      children: [(0,jsx_runtime.jsx)(_components.h4, {
        ...
        children: ["업데이트 과정에서 다운로드 성공 메세지가 표시된 이후 에이전트 버전이 최신으로 자동 변경되지 않는다면, 수동으로 에이전트를 재시작해야 합니다. 에이전트 설치 경로(", (0,jsx_runtime.jsx)(_components.em, {
          children: (0,jsx_runtime.jsx)(_components.strong, {
            children: "agent path"
          })
        ...
        children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
          ...
          children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
            children: [(0,jsx_runtime.jsx)(Cmdname, {
              ...
              className: "uitext"
            }), " 섹션의 2번 항목에서 ", (0,jsx_runtime.jsx)("span", {
              class: "uitext",
              children: "Download"
          ...
          children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
            ...
            }), " 파일만 에이전트 설치 경로(", (0,jsx_runtime.jsx)(_components.em, {
              children: (0,jsx_runtime.jsx)(_components.strong, {
                children: "agent path"
              })
            }), ")에 업로드하세요."]
      ...
      children: [(0,jsx_runtime.jsx)(_components.h3, {
        ...
        children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
          ...
          children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
            children: ["선택한 버전으로 되돌릴 에이전트 항목에서 ", (0,jsx_runtime.jsx)(Cmdname, {
              sid: "download",
              className: "uitext"
            }), " 버튼을 선택하세요."]
          }), "\n"]
          ...
          children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
            children: ["에이전트 설치 경로에서 상위 버전의 ", (0,jsx_runtime.jsxs)(_components.em, {
              children: ["whatap.agent.dbx-", (0,jsx_runtime.jsx)(_components.code, {
                children: "X.Y.Z"
              }), ".jar"]
            }), " 파일을 삭제하세요."]
...
function _db_update_agent_MDXContent(props = {}) {
  const {wrapper: MDXLayout} = {
    ...(0,lib/* useMDXComponents */.R)(),
    ...props.components
  };
  return MDXLayout ? (0,jsx_runtime.jsx)(MDXLayout, {
    ...props,
    children: (0,jsx_runtime.jsx)(_db_update_agent_createMdxContent, {
      ...props
    })
  }) : _db_update_agent_createMdxContent(props);
}
...
;// CONCATENATED MODULE: ./docs/common-items/_db-uninstall-agent.mdx


const _db_uninstall_agent_frontMatter = {};
const _db_uninstall_agent_contentTitle = (/* unused pure expression or super */ null && (undefined));
...
const _db_uninstall_agent_toc = [{
  "value": "에이전트 삭제",
  "id": "에이전트-삭제",
  "level": 2
}];
function _db_uninstall_agent_createMdxContent(props) {
  const _components = {
    code: "code",
    h2: "h2",
    p: "p",
...
function _db_uninstall_agent_MDXContent(props = {}) {
  const {wrapper: MDXLayout} = {
    ...(0,lib/* useMDXComponents */.R)(),
    ...props.components
  };
  return MDXLayout ? (0,jsx_runtime.jsx)(MDXLayout, {
    ...props,
    children: (0,jsx_runtime.jsx)(_db_uninstall_agent_createMdxContent, {
      ...props
    })
  }) : _db_uninstall_agent_createMdxContent(props);
}


;// CONCATENATED MODULE: ./docs/altibase-v1/agent-manage.mdx
...
const metadata = {
  "id": "altibase-v1/agent-manage",
  "title": "관리하기",
  "description": "whatap.conf 파일을 통해 데이터베이스 에이전트를 관리할 수 있습니다.",
  "source": "@site/docs/altibase-v1/agent-manage.mdx",
  "sourceDirName": "altibase-v1",
  "slug": "/altibase-v1/agent-manage",
  "permalink": "/en/altibase-v1/agent-manage",
  "draft": false,
  "unlisted": false,
  "editUrl": "undefined/docs/altibase-v1/agent-manage.mdx",
  "tags": [],
  "version": "current",
  "frontMatter": {
    "id": "agent-manage",
  ...
  "previous": {
    "title": "에이전트 데이터 수집",
    "permalink": "/en/altibase-v1/agent-data"
  },
  "next": {
    "title": "실시간 데이터베이스 성능 지표 확인",
    "permalink": "/en/altibase-v1/dashboard-intro"
  }
};
const assets = {
