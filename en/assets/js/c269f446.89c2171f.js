"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[12587],{
...
const metadata = {
  "id": "oracle/metrics-chart",
  "title": "Metrics Chart",
  "description": "You can see the metrics data through a chart.",
  "source": "@site/i18n/en/docusaurus-plugin-content-docs/current/oracle/metrics-chart.mdx",
  "sourceDirName": "oracle",
  "slug": "/oracle/metrics-chart",
  "permalink": "/en/oracle/metrics-chart",
  "draft": false,
  "unlisted": false,
  "editUrl": "undefined/docs/oracle/metrics-chart.mdx",
  "tags": [],
  "version": "current",
  "frontMatter": {
    "id": "metrics-chart",
  ...
  "previous": {
    "title": "메트릭스 차트",
    "permalink": "/en/oracle/metrics-chart-v2"
  },
  "next": {
    "title": "Metrics Search",
    "permalink": "/en/oracle/metrics-search"
  }
};
const assets = {
