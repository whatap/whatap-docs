"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[64115],{
...
const metadata = {
  "id": "oracle-v1/metrics-detect-anormal",
  "title": "Metric Anomaly Detection",
  "description": "You can compare the patterns of various metrics with the expected patterns learned by the AI.",
  "source": "@site/i18n/en/docusaurus-plugin-content-docs/current/oracle-v1/metrics-detect-anormal.mdx",
  "sourceDirName": "oracle-v1",
  "slug": "/oracle-v1/metrics-detect-anormal",
  "permalink": "/en/oracle-v1/metrics-detect-anormal",
  "draft": false,
  "unlisted": false,
  "editUrl": "undefined/docs/oracle-v1/metrics-detect-anormal.mdx",
  "tags": [],
  "version": "current",
  "frontMatter": {
    "id": "metrics-detect-anormal",
