"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[46840],{
...
const metadata = {
  ...
  "title": "Analyzing the database",
  "description": "It describes the database performance metrics that can be analyzed using the real-time monitoring.",
  "source": "@site/i18n/en/docusaurus-plugin-content-docs/current/mssql/analysis-function.mdx",
  "sourceDirName": "mssql",
  ...
  "previous": {
    ...
    "permalink": "/en/mssql/metrics-detect-anormal"
  },
  "next": {
