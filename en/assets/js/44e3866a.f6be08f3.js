"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[24554],{
...
__webpack_require__.d(__webpack_exports__, {
  ...
  contentTitle: () => (/* binding */ agent_remove_contentTitle),
  "default": () => (/* binding */ agent_remove_MDXContent),
  frontMatter: () => (/* binding */ agent_remove_frontMatter),
  metadata: () => (/* binding */ metadata),
  toc: () => (/* binding */ agent_remove_toc)
});
...
;// CONCATENATED MODULE: ./i18n/en/docusaurus-plugin-content-docs/current/common-items/_php-restart-apache.mdx
...
function _createMdxContent(props) {
  ...
  return (0,jsx_runtime.jsx)(_components.p, {
    children: "Apache or PHP-FPM service is started."
  });
}
...
;// CONCATENATED MODULE: ./i18n/en/docusaurus-plugin-content-docs/current/php/agent-remove.mdx


const agent_remove_frontMatter = {
	id: 'agent-remove',
...
const agent_remove_contentTitle = undefined;
const metadata = {
  "id": "php/agent-remove",
  "title": "Agent deletion",
  "description": "It provides the method how to delete the PHP agent.",
  "source": "@site/i18n/en/docusaurus-plugin-content-docs/current/php/agent-remove.mdx",
  "sourceDirName": "php",
  ...
  "previous": {
    ...
    "permalink": "/en/php/agent-temp-st"
  },
  "next": {
    "title": "Dashboard",
...
const agent_remove_toc = [...toc];
function agent_remove_createMdxContent(props) {
  const _components = {
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsxs)(_components.p, {
      children: ["Delete the tracers that are the PHP extension module and whatap-php service daemon by using the installation script. Afterward, delete the package (yum, apt-get) and then if necessary, delete the log file and other files under ", (0,jsx_runtime.jsx)(_components.em, {
        children: "/usr/whatap/php"
      }), "."]
    }), "\n", (0,jsx_runtime.jsxs)(_components.ol, {
      children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
        children: ["\n", (0,jsx_runtime.jsx)(_components.p, {
          children: "Delete the PHP extension module and whatap-php service."
        ...
        children: ["\n", (0,jsx_runtime.jsx)(_components.p, {
          ...
          children: [(0,jsx_runtime.jsx)(TabItem/* default */.A, {
            ...
            children: (0,jsx_runtime.jsx)(_components.pre, {
              children: (0,jsx_runtime.jsx)(_components.code, {
                className: "language-bash",
                children: "$ sudo yum remove whatap-php\n"
              })
            })
            ...
            children: (0,jsx_runtime.jsx)(_components.pre, {
              children: (0,jsx_runtime.jsx)(_components.code, {
                className: "language-bash",
                children: "$ sudo apt-get purge whatap-php\n"
              })
            })
          }), (0,jsx_runtime.jsx)(TabItem/* default */.A, {
            value: "frbsd",
            ...
            children: (0,jsx_runtime.jsx)(_components.pre, {
              children: (0,jsx_runtime.jsx)(_components.code, {
                className: "language-bash",
                children: "$ pkg delete whatap-php\n"
              })
            })
          })]
        }), "\n"]
...
function agent_remove_MDXContent(props = {}) {
  const {wrapper: MDXLayout} = {
    ...(0,lib/* useMDXComponents */.R)(),
    ...props.components
  };
  return MDXLayout ? (0,jsx_runtime.jsx)(MDXLayout, {
    ...props,
    children: (0,jsx_runtime.jsx)(agent_remove_createMdxContent, {
      ...props
    })
  }) : agent_remove_createMdxContent(props);
}
