"use strict";
(self["webpackChunkwhatap_origin"] = self["webpackChunkwhatap_origin"] || []).push([[52323],{
...
const metadata = {
    ...
    "title": "Event History",
    "description": "You can see the history of alerts that occurred through Event History.",
    "source": "@site/i18n/en/docusaurus-plugin-content-docs/current/php/set-event-history.mdx",
    "sourceDirName": "php",
    ...
    "next": {
        ...
        "permalink": "/en/php/set-event-format"
    }
};
const assets = {};
const toc = [];
