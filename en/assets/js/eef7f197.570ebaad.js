"use strict";
(self["webpackChunkwhatap_origin"] = self["webpackChunkwhatap_origin"] || []).push([[95914],{
...
const metadata = {
    "unversionedId": "dotnet/set-notification-message",
    "id": "dotnet/set-notification-message",
    "title": "Notification message customization",
    "description": "It provides the customization function to modify the alert notification messages that are delivered to project members.",
    "source": "@site/i18n/en/docusaurus-plugin-content-docs/current/dotnet/set-notification-message.mdx",
    "sourceDirName": "dotnet",
    "slug": "/dotnet/set-notification-message",
    "permalink": "/en/dotnet/set-notification-message",
    "draft": false,
    "editUrl": "undefined/docs/dotnet/set-notification-message.mdx",
    "tags": [
        {
            "label": ".NET",
    ...
    "next": {
        ...
        "permalink": "/en/dotnet/hitmap-notice"
    }
};
const assets = {};
const toc = [
