"use strict";
(self["webpackChunkwhatap_origin"] = self["webpackChunkwhatap_origin"] || []).push([[53106],{
...
const metadata = {
    "unversionedId": "python/warning-notice",
    "id": "python/warning-notice",
    "title": "Application alert",
    "description": "Alerts are sent through the resource usage, active transactions, and event conditions of error conditions of the application.",
    "source": "@site/i18n/en/docusaurus-plugin-content-docs/current/python/warning-notice.mdx",
    "sourceDirName": "python",
    "slug": "/python/warning-notice",
    "permalink": "/en/python/warning-notice",
    "draft": false,
    "editUrl": "undefined/docs/python/warning-notice.mdx",
    "tags": [
        {
            "label": "Python",
    ...
    "previous": {
        ...
        "permalink": "/en/python/apm-set-notice"
    },
    "next": {
        "title": "Metrics alert",
