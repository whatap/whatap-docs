"use strict";
(self["webpackChunkwhatap_origin"] = self["webpackChunkwhatap_origin"] || []).push([[92842],{
...
const metadata = {
    "unversionedId": "kubernetes/metrics-search",
    "id": "kubernetes/metrics-search",
    "title": "Metrics Search",
    "description": "You can search the metrics raw data.",
    "source": "@site/i18n/en/docusaurus-plugin-content-docs/current/kubernetes/metrics-search.mdx",
    "sourceDirName": "kubernetes",
    "slug": "/kubernetes/metrics-search",
    "permalink": "/en/kubernetes/metrics-search",
    "draft": false,
    "editUrl": "undefined/docs/kubernetes/metrics-search.mdx",
    "tags": [
        {
            "label": "Metrics",
