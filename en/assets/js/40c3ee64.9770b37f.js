"use strict";
(self["webpackChunkwhatap_origin"] = self["webpackChunkwhatap_origin"] || []).push([[57665],{
...
const metadata = {
    "unversionedId": "python/set-notification-message",
    "id": "python/set-notification-message",
    "title": "Notification message customization",
    "description": "It provides the customization function to modify the alert notification messages that are delivered to project members.",
    "source": "@site/i18n/en/docusaurus-plugin-content-docs/current/python/set-notification-message.mdx",
    "sourceDirName": "python",
    "slug": "/python/set-notification-message",
    "permalink": "/en/python/set-notification-message",
    "draft": false,
    "editUrl": "undefined/docs/python/set-notification-message.mdx",
    "tags": [
        {
            "label": "Python",
    ...
    "next": {
        ...
        "permalink": "/en/python/hitmap-notice"
    }
};
const assets = {};
const toc = [
