"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[22142],{
...
const metadata = {
  ...
  "title": "Agent Installation",
  "description": "The following guides you to the basic installation method for using the WhaTap database monitoring service.",
  "source": "@site/i18n/en/docusaurus-plugin-content-docs/current/oracle-v1/install-agent.mdx",
  "sourceDirName": "oracle-v1",
  "slug": "/oracle-v1/install-agent",
  "permalink": "/en/oracle-v1/install-agent",
  "draft": false,
  "unlisted": false,
  ...
  "previous": {
    "title": "지원 환경",
    "permalink": "/en/oracle-v1/monitoring-support"
  },
  "next": {
