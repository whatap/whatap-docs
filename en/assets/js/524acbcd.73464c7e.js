"use strict";
(self["webpackChunkwhatap_origin"] = self["webpackChunkwhatap_origin"] || []).push([[4565],{
...
const metadata = {
    "unversionedId": "mysql-v1/set-notification-message",
    "id": "mysql-v1/set-notification-message",
    "title": "Notification message customization",
    "description": "It provides the customization function to modify the alert notification messages that are delivered to project members.",
    "source": "@site/i18n/en/docusaurus-plugin-content-docs/current/mysql-v1/set-notification-message.mdx",
    "sourceDirName": "mysql-v1",
    "slug": "/mysql-v1/set-notification-message",
    "permalink": "/en/mysql-v1/set-notification-message",
    "draft": false,
    "editUrl": "undefined/docs/mysql-v1/set-notification-message.mdx",
    "tags": [
        {
            "label": "MySQL",
