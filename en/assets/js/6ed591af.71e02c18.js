"use strict";
(self["webpackChunkwhatap_origin"] = self["webpackChunkwhatap_origin"] || []).push([[40865],{
...
const metadata = {
    "unversionedId": "nodejs/set-notification-message",
    "id": "nodejs/set-notification-message",
    "title": "Notification message customization",
    "description": "It provides the customization function to modify the alert notification messages that are delivered to project members.",
    "source": "@site/i18n/en/docusaurus-plugin-content-docs/current/nodejs/set-notification-message.mdx",
    "sourceDirName": "nodejs",
    "slug": "/nodejs/set-notification-message",
    "permalink": "/en/nodejs/set-notification-message",
    "draft": false,
    "editUrl": "undefined/docs/nodejs/set-notification-message.mdx",
    "tags": [
        {
            "label": "Node.js",
    ...
    "next": {
        ...
        "permalink": "/en/nodejs/hitmap-notice"
    }
};
const assets = {};
const toc = [
