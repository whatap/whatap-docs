"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[94323],{
...
const metadata = {
  "id": "altibase/metrics-chart",
  "title": "Metrics Chart",
  "description": "You can see the metrics data through a chart.",
  "source": "@site/i18n/en/docusaurus-plugin-content-docs/current/altibase/metrics-chart.mdx",
  "sourceDirName": "altibase",
  "slug": "/altibase/metrics-chart",
  "permalink": "/en/altibase/metrics-chart",
  "draft": false,
  "unlisted": false,
  "editUrl": "undefined/docs/altibase/metrics-chart.mdx",
  "tags": [],
  "version": "current",
  "frontMatter": {
    "id": "metrics-chart",
  ...
  "previous": {
    "title": "메트릭스 차트",
    "permalink": "/en/altibase/metrics-chart-v2"
  },
  "next": {
    "title": "Metrics Search",
    "permalink": "/en/altibase/metrics-search"
  }
};
const assets = {
