"use strict";
(self["webpackChunkwhatap_origin"] = self["webpackChunkwhatap_origin"] || []).push([[8904],{
...
const metadata = {
    "unversionedId": "mssql/set-notification-message",
    "id": "mssql/set-notification-message",
    "title": "Notification message customization",
    "description": "It provides the customization function to modify the alert notification messages that are delivered to project members.",
    "source": "@site/i18n/en/docusaurus-plugin-content-docs/current/mssql/set-notification-message.mdx",
    "sourceDirName": "mssql",
    "slug": "/mssql/set-notification-message",
    "permalink": "/en/mssql/set-notification-message",
    "draft": false,
    "editUrl": "undefined/docs/mssql/set-notification-message.mdx",
    "tags": [
        {
            "label": "SQL Server",
