"use strict";
(self["webpackChunkwhatap_origin"] = self["webpackChunkwhatap_origin"] || []).push([[50016],{
...
const metadata = {
    "unversionedId": "oracle/set-notification-message",
    "id": "oracle/set-notification-message",
    "title": "Notification message customization",
    "description": "It provides the customization function to modify the alert notification messages that are delivered to project members.",
    "source": "@site/i18n/en/docusaurus-plugin-content-docs/current/oracle/set-notification-message.mdx",
    "sourceDirName": "oracle",
    "slug": "/oracle/set-notification-message",
    "permalink": "/en/oracle/set-notification-message",
    "draft": false,
    "editUrl": "undefined/docs/oracle/set-notification-message.mdx",
    "tags": [
        {
            "label": "Oracle",
