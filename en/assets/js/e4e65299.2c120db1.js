"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[48550],{
...
__webpack_require__.d(__webpack_exports__, {
  ...
  contentTitle: () => (/* binding */ monitoring_support_contentTitle),
  "default": () => (/* binding */ monitoring_support_MDXContent),
  frontMatter: () => (/* binding */ monitoring_support_frontMatter),
  metadata: () => (/* binding */ metadata),
  toc: () => (/* binding */ monitoring_support_toc)
});
...
;// CONCATENATED MODULE: ./docs/common-items/_db-type-of-support-db.mdx
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsx)(_components.p, {
      ...
      children: [(0,jsx_runtime.jsx)(_components.h2, {
        ...
        children: ["DBX에서는 다음의 데이터베이스들을 지원합니다. ", (0,jsx_runtime.jsx)(_components.strong, {
          children: "Java 8"
        }), " 이상 ", (0,jsx_runtime.jsx)(_components.strong, {
          children: "JDK"
        }), "를 설치해야 합니다."]
      })]
    })]
...
;// CONCATENATED MODULE: ./docs/common-items/_db-support-env-common.mdx


const _db_support_env_common_frontMatter = {};
const _db_support_env_common_contentTitle = (/* unused pure expression or super */ null && (undefined));





const _db_support_env_common_toc = [];
function _db_support_env_common_createMdxContent(props) {
  const _components = {
...
function _db_support_env_common_MDXContent(props = {}) {
  const {wrapper: MDXLayout} = {
    ...(0,lib/* useMDXComponents */.R)(),
    ...props.components
  };
  return MDXLayout ? (0,jsx_runtime.jsx)(MDXLayout, {
    ...props,
    children: (0,jsx_runtime.jsx)(_db_support_env_common_createMdxContent, {
      ...props
    })
  }) : _db_support_env_common_createMdxContent(props);
}
...
;// CONCATENATED MODULE: ./docs/getting-started/_supported-browser.mdx


const _supported_browser_frontMatter = {};
const _supported_browser_contentTitle = (/* unused pure expression or super */ null && (undefined));





const _supported_browser_toc = [];
function _supported_browser_createMdxContent(props) {
  const _components = {
    a: "a",
    admonition: "admonition",
    li: "li",
  ...
  if (!InDoc) _supported_browser_missingMdxReference("InDoc", true);
  if (!Xclude) _supported_browser_missingMdxReference("Xclude", true);
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsx)(_components.p, {
      ...
      children: (0,jsx_runtime.jsxs)(_components.admonition, {
        ...
        children: [(0,jsx_runtime.jsx)(_components.p, {
          ...
          children: ["와탭의 웹 인터페이스는 모바일 브라우저에 대한 지원을 제공하지 않습니다. 모바일 기기에서 와탭에 접속하려면 안드로이드 앱 또는 iOS 앱을 설치하세요. 와탭 모바일 앱은 모바일 기기에서 최적의 성능을 발휘하도록 설계되었습니다. 와탭 모바일 앱에 대한 자세한 내용은 ", (0,jsx_runtime.jsx)(_components.a, {
            href: "../mobile-app",
            children: "다음 문서"
          }), "를 참조하세요."]
        })]
...
function _supported_browser_MDXContent(props = {}) {
  const {wrapper: MDXLayout} = {
    ...(0,lib/* useMDXComponents */.R)(),
    ...props.components
  };
  return MDXLayout ? (0,jsx_runtime.jsx)(MDXLayout, {
    ...props,
    children: (0,jsx_runtime.jsx)(_supported_browser_createMdxContent, {
      ...props
    })
  }) : _supported_browser_createMdxContent(props);
}
function _supported_browser_missingMdxReference(id, component) {
  throw new Error("Expected " + (component ? "component" : "object") + " `" + id + "` to be defined: you likely forgot to import, pass, or provide it.");
}


;// CONCATENATED MODULE: ./docs/getting-started/_proxy.mdx


const _proxy_frontMatter = {};
const _proxy_contentTitle = (/* unused pure expression or super */ null && (undefined));
...
const _proxy_toc = [];
function _proxy_createMdxContent(props) {
  const _components = {
    p: "p",
    strong: "strong",
    table: "table",
  ...
  if (!ImgLang) _proxy_missingMdxReference("ImgLang", true);
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsxs)(_components.p, {
      children: ["와탭 에이전트는 수집 서버 ", (0,jsx_runtime.jsx)(_components.strong, {
        children: "TCP 6600"
...
function _proxy_MDXContent(props = {}) {
  const {wrapper: MDXLayout} = {
    ...(0,lib/* useMDXComponents */.R)(),
    ...props.components
  };
  return MDXLayout ? (0,jsx_runtime.jsx)(MDXLayout, {
    ...props,
    children: (0,jsx_runtime.jsx)(_proxy_createMdxContent, {
      ...props
    })
  }) : _proxy_createMdxContent(props);
}
function _proxy_missingMdxReference(id, component) {
  throw new Error("Expected " + (component ? "component" : "object") + " `" + id + "` to be defined: you likely forgot to import, pass, or provide it.");
}


;// CONCATENATED MODULE: ./docs/getting-started/_mobile-app.mdx


const _mobile_app_frontMatter = {};
const _mobile_app_contentTitle = (/* unused pure expression or super */ null && (undefined));





const _mobile_app_toc = [];
function _mobile_app_createMdxContent(props) {
  const _components = {
    a: "a",
    img: "img",
    p: "p",
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsxs)(_components.p, {
      children: ["와탭 모바일 앱은 안드로이드와 iOS 환경을 지원합니다. 다음 링크로 이동하거나 QR 코드를 스캔해 앱을 설치할 수 있습니다. 모바일 앱에 대한 자세한 설명은 ", (0,jsx_runtime.jsx)(_components.a, {
        ...
        children: (0,jsx_runtime.jsxs)(_components.tr, {
          children: [(0,jsx_runtime.jsxs)(_components.td, {
            ...
            children: [(0,jsx_runtime.jsx)(_components.img, {
              ...
              width: "600",
              height: "600"
            }), (0,jsx_runtime.jsx)("br", {}), "iOS 12 버전 이상"]
            ...
            children: [(0,jsx_runtime.jsx)(_components.img, {
              ...
              width: "600",
              height: "600"
            }), (0,jsx_runtime.jsx)("br", {}), "Android 5.0 버전 이상"]
          })]
        })
      })]
    })]
...
function _mobile_app_MDXContent(props = {}) {
  const {wrapper: MDXLayout} = {
    ...(0,lib/* useMDXComponents */.R)(),
    ...props.components
  };
  return MDXLayout ? (0,jsx_runtime.jsx)(MDXLayout, {
    ...props,
    children: (0,jsx_runtime.jsx)(_mobile_app_createMdxContent, {
      ...props
    })
  }) : _mobile_app_createMdxContent(props);
}


;// CONCATENATED MODULE: ./docs/altibase-v1/monitoring-support.mdx


const monitoring_support_frontMatter = {
...
const monitoring_support_contentTitle = undefined;
const metadata = {
  "id": "altibase-v1/monitoring-support",
  "title": "지원 환경",
  "description": "데이터베이스 모니터링을 시작하기 전에 지원하는 데이터베이스 종류에 대해서 알아보세요.",
  "source": "@site/docs/altibase-v1/monitoring-support.mdx",
  "sourceDirName": "altibase-v1",
  "slug": "/altibase-v1/monitoring-support",
  "permalink": "/en/altibase-v1/monitoring-support",
  "draft": false,
  "unlisted": false,
  "editUrl": "undefined/docs/altibase-v1/monitoring-support.mdx",
  "tags": [],
  "version": "current",
  "frontMatter": {
    "id": "monitoring-support",
  ...
  "previous": {
    "title": "Altibase V1 모니터링",
    "permalink": "/en/altibase-v1/monitoring-intro"
  },
  "next": {
    "title": "에이전트 설치",
...
const monitoring_support_toc = [...toc, {
  "value": "데이터베이스 지원 버전",
  "id": "데이터베이스-지원-버전",
  "level": 2
}, ..._db_support_env_common_toc, {
  "value": "지원 기능",
  "id": "지원-기능",
  "level": 3
}, {
...
function monitoring_support_createMdxContent(props) {
  const _components = {
    h2: "h2",
    h3: "h3",
    p: "p",
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsx)(MDXContent, {}), "\n", (0,jsx_runtime.jsxs)(_components.section, {
      ...
      children: [(0,jsx_runtime.jsx)(_components.h2, {
        ...
        children: "Altibase 6 버전 이상을 지원합니다."
      }), (0,jsx_runtime.jsx)(_db_support_env_common_MDXContent, {})]
    }), "\n", (0,jsx_runtime.jsxs)(_components.section, {
      ...
      children: [(0,jsx_runtime.jsx)(_components.h2, {
        id: "브라우저-지원",
        children: "브라우저 지원"
      }), (0,jsx_runtime.jsx)(_supported_browser_MDXContent, {})]
    }), "\n", (0,jsx_runtime.jsxs)(_components.section, {
      className: "remark-sectionize-h2",
      children: [(0,jsx_runtime.jsx)(_components.h2, {
        id: "방화벽",
        children: "방화벽"
      }), (0,jsx_runtime.jsx)(_proxy_MDXContent, {})]
    }), "\n", (0,jsx_runtime.jsxs)(_components.section, {
      className: "remark-sectionize-h2",
      children: [(0,jsx_runtime.jsx)(_components.h2, {
        id: "모바일-앱",
        children: "모바일 앱"
      }), (0,jsx_runtime.jsx)(_mobile_app_MDXContent, {})]
    })]
  });
}
function monitoring_support_MDXContent(props = {}) {
  const {wrapper: MDXLayout} = {
    ...(0,lib/* useMDXComponents */.R)(),
    ...props.components
  };
  return MDXLayout ? (0,jsx_runtime.jsx)(MDXLayout, {
    ...props,
    children: (0,jsx_runtime.jsx)(monitoring_support_createMdxContent, {
      ...props
    })
  }) : monitoring_support_createMdxContent(props);
}
