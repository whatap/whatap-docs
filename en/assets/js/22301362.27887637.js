"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[73614],{
...
const metadata = {
  ...
  "title": "Event reception format",
  "description": "Learn about the event reception format of alerts provided by database monitoring.",
  "source": "@site/i18n/en/docusaurus-plugin-content-docs/current/oracle-pro/set-event-format.mdx",
  "sourceDirName": "oracle-pro",
  "slug": "/oracle-pro/set-event-format",
  "permalink": "/en/oracle-pro/set-event-format",
  "draft": false,
  "unlisted": false,
