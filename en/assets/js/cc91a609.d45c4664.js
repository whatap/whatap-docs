"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[17715],{
...
__webpack_require__.d(__webpack_exports__, {
  ...
  contentTitle: () => (/* binding */ flexboard_create_contentTitle),
  "default": () => (/* binding */ flexboard_create_MDXContent),
  frontMatter: () => (/* binding */ flexboard_create_frontMatter),
  metadata: () => (/* binding */ metadata),
  toc: () => (/* binding */ flexboard_create_toc)
});
...
;// CONCATENATED MODULE: ./docs/common-items/_create-flex-board.mdx
...
function _createMdxContent(props) {
  ...
  return (0,jsx_runtime.jsxs)(_components.section, {
    ...
    children: [(0,jsx_runtime.jsx)(_components.h2, {
      ...
      children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
        children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
          children: [(0,jsx_runtime.jsx)(Cmdname, {
            sid: "side_flexboard",
            className: "uitext"
          }), " 메뉴에서 오른쪽 위에 ", (0,jsx_runtime.jsx)(Cmdname, {
        ...
        children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
          children: ["위젯 배치 방법을 선택해 ", (0,jsx_runtime.jsx)(Cmdname, {
            sid: "create_dashboard",
            className: "uitext"
          }), " 버튼을 클릭하세요."]
          ...
          children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
            ...
            children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
              children: [(0,jsx_runtime.jsx)(Cmdname, {
                ...
                className: "uitext"
              }), ": 브라우저 사이즈 기준으로 그리드 반응형 레이아웃을 제공합니다. ", (0,jsx_runtime.jsx)(Cmdname, {
                sid: "flexible_flexboard",
                className: "uitext"
              }), "를 선택하면 그리드를 설정한 다음 ", (0,jsx_runtime.jsx)(Cmdname, {
                sid: "create_dashboard",
                className: "uitext"
              }), " 버튼을 선택하세요."]
            }), "\n"]
        ...
        children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
          children: [(0,jsx_runtime.jsx)(Cmdname, {
            sid: "widget_template",
            className: "uitext"
          }), " 선택 화면에서 대시보드에 배치할 위젯을 선택하세요. 메트릭스 위젯을 추가하려면 ", (0,jsx_runtime.jsx)(Cmdname, {
            sid: "widget_template",
            className: "uitext"
          }), "의 오른쪽에 ", (0,jsx_runtime.jsx)(_components.em, {
          ...
          children: (0,jsx_runtime.jsxs)(_components.ul, {
            children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
              ...
              children: [(0,jsx_runtime.jsx)(Cmdname, {
                sid: "all_metrics",
                className: "uitext"
              }), ": 사용자의 프로젝트에서 수집 중인 모든 메트릭스 데이터를 기준으로 위젯을 생성할 때 사용합니다. 메트릭스 위젯에 대한 자세한 설명은 ", (0,jsx_runtime.jsx)(_components.a, {
        ...
        children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
          children: ["추가할 위젯을 모두 배치를 완료한 다음 ", (0,jsx_runtime.jsx)(Cmdname, {
            sid: "view_mode",
            className: "uitext"
          }), "를 선택해 레이아웃을 확인하세요. 레이아웃을 다시 수정하려면 ", (0,jsx_runtime.jsx)(Cmdname, {
            sid: "edit_mode",
            className: "uitext"
          }), "를 선택해 위젯의 배치를 변경하세요."]
        }), "\n"]
      ...
      children: ["모든 과정을 완료했다면 오른쪽 위에 ", (0,jsx_runtime.jsx)(_components.img, {
        alt: "목록으로 가기 아이콘",
      ...
      children: (0,jsx_runtime.jsxs)(_components.p, {
        children: ["고객의 의견을 반영해 대시보드 템플릿 또는 위젯을 추가하려고 합니다. 필요한 대시보드 템플릿 또는 위젯이 있다면 ", (0,jsx_runtime.jsx)(_components.a, {
...
const flexboard_create_frontMatter = {
	id: 'flexboard-create',
	title: 'Flex 보드 만들기',
...
const flexboard_create_contentTitle = undefined;
const metadata = {
  "id": "altibase-v1/flexboard-create",
  "title": "Flex 보드 만들기",
  "description": "Flex 보드 메뉴에서 대시보드를 생성하고, 위젯을 배치하여 사용자 정의 대시보드를 만드는 과정을 안내합니다. 고정 레이아웃과 반응형 레이아웃 중에서 선택할 수 있으며, 메트릭스 위젯 추가 및 사전 정의된 위젯 템플릿을 활용할 수 있습니다. 사용자는 위젯의 위치를 조정하고, 크기를 변경하여 자신만의 대시보드 레이아웃을 완성할 수 있습니다.",
  "source": "@site/docs/altibase-v1/flexboard-create.mdx",
  "sourceDirName": "altibase-v1",
  "slug": "/altibase-v1/flexboard-create",
  "permalink": "/en/altibase-v1/flexboard-create",
  "draft": false,
  "unlisted": false,
  "editUrl": "undefined/docs/altibase-v1/flexboard-create.mdx",
  "tags": [],
  "version": "current",
  "frontMatter": {
    "id": "flexboard-create",
  ...
  "previous": {
    "title": "사전 템플릿 적용",
    "permalink": "/en/altibase-v1/flexboard-template"
  },
  "next": {
    "title": "Flex 보드 관리하기",
...
const flexboard_create_toc = [...toc];
function flexboard_create_createMdxContent(props) {
  return (0,jsx_runtime.jsx)(MDXContent, {});
}
function flexboard_create_MDXContent(props = {}) {
  const {wrapper: MDXLayout} = {
    ...(0,lib/* useMDXComponents */.R)(),
    ...props.components
  };
  return MDXLayout ? (0,jsx_runtime.jsx)(MDXLayout, {
    ...props,
    children: (0,jsx_runtime.jsx)(flexboard_create_createMdxContent, {
      ...props
    })
  }) : flexboard_create_createMdxContent(props);
}
