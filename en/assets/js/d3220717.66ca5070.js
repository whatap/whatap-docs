"use strict";
(self["webpackChunkwhatap_origin"] = self["webpackChunkwhatap_origin"] || []).push([[32292],{
...
const metadata = {
    "unversionedId": "java/warning-notice",
    "id": "java/warning-notice",
    "title": "Application alert",
    "description": "Alerts are sent through the resource usage, active transactions, and event conditions of error conditions of the application.",
    "source": "@site/i18n/en/docusaurus-plugin-content-docs/current/java/warning-notice.mdx",
    "sourceDirName": "java",
    "slug": "/java/warning-notice",
    "permalink": "/en/java/warning-notice",
    "draft": false,
    "editUrl": "undefined/docs/java/warning-notice.mdx",
    "tags": [
        {
            "label": "Java",
