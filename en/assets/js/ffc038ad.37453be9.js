"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[240],{
...
const metadata = {
  "id": "oracle-v1/report-intro",
  "title": "Report",
  "description": "Let's learn about the documents that report the service usage and failure records for individual projects.",
  "source": "@site/i18n/en/docusaurus-plugin-content-docs/current/oracle-v1/report-intro.mdx",
  "sourceDirName": "oracle-v1",
  "slug": "/oracle-v1/report-intro",
  "permalink": "/en/oracle-v1/report-intro",
  "draft": false,
  "unlisted": false,
  "editUrl": "undefined/docs/oracle-v1/report-intro.mdx",
  "tags": [],
  "version": "current",
  "frontMatter": {
    "id": "report-intro",
  ...
  "next": {
    ...
    "permalink": "/en/oracle-v1/set-notice"
  }
};
const assets = {
