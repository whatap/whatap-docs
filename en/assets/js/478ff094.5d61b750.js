"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[24543],{
...
__webpack_require__.d(__webpack_exports__, {
  ...
  contentTitle: () => (/* binding */ log_lt_contentTitle),
  "default": () => (/* binding */ log_lt_MDXContent),
  frontMatter: () => (/* binding */ log_lt_frontMatter),
  metadata: () => (/* binding */ metadata),
  toc: () => (/* binding */ log_lt_toc)
});
...
;// CONCATENATED MODULE: ./docs/common-items/_log-lt.mdx
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsx)(_log_role_view/* default */.Ay, {}), "\n", (0,jsx_runtime.jsx)(Xclude, {
      ...
      children: [(0,jsx_runtime.jsx)(Cmdname, {
        sid: "side_logTail",
        className: "uitext"
      }), " 메뉴에서 복잡한 로그들도 손쉽게 접근 가능합니다. 필요에 따라 ", (0,jsx_runtime.jsx)(Cmdname, {
        sid: "filter",
        className: "uitext"
      }), " 혹은 ", (0,jsx_runtime.jsx)(Cmdname, {
        sid: "highlight",
        className: "uitext"
      }), " 등의 기능을 활용해 실시간으로 조회할 수 있습니다. 로그 데이터 조회 주기는 2초입니다. ", (0,jsx_runtime.jsx)(_log_ui_main_term/* default */.Ay, {})]
...
;// CONCATENATED MODULE: ./docs/altibase/log-lt.mdx


const log_lt_frontMatter = {
	id: 'log-lt',
	title: '라이브 테일',
...
const log_lt_contentTitle = undefined;
const metadata = {
  "id": "altibase/log-lt",
  "title": "라이브 테일",
  "description": "로그 모니터링 라이브 테일을 안내합니다.",
  "source": "@site/docs/altibase/log-lt.mdx",
  "sourceDirName": "altibase",
  "slug": "/altibase/log-lt",
  "permalink": "/en/altibase/log-lt",
  "draft": false,
  "unlisted": false,
  "editUrl": "undefined/docs/altibase/log-lt.mdx",
  "tags": [],
  "version": "current",
  "frontMatter": {
    "id": "log-lt",
  ...
  "previous": {
    "title": "적용하기",
    "permalink": "/en/altibase/log-db"
  },
  "next": {
    "title": "로그 트렌드",
    "permalink": "/en/altibase/log-exp"
  }
};
const assets = {
...
const log_lt_toc = [...toc];
function log_lt_createMdxContent(props) {
  return (0,jsx_runtime.jsx)(MDXContent, {});
}
function log_lt_MDXContent(props = {}) {
  const {wrapper: MDXLayout} = {
    ...(0,lib/* useMDXComponents */.R)(),
    ...props.components
  };
  return MDXLayout ? (0,jsx_runtime.jsx)(MDXLayout, {
    ...props,
    children: (0,jsx_runtime.jsx)(log_lt_createMdxContent, {
      ...props
    })
  }) : log_lt_createMdxContent(props);
}
