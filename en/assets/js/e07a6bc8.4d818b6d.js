"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[95157],{
...
const metadata = {
  "id": "oracle-v1/metrics-chart",
  "title": "Metrics Chart",
  "description": "You can see the metrics data through a chart.",
  "source": "@site/i18n/en/docusaurus-plugin-content-docs/current/oracle-v1/metrics-chart.mdx",
  "sourceDirName": "oracle-v1",
  "slug": "/oracle-v1/metrics-chart",
  "permalink": "/en/oracle-v1/metrics-chart",
  "draft": false,
  "unlisted": false,
  "editUrl": "undefined/docs/oracle-v1/metrics-chart.mdx",
  "tags": [],
  "version": "current",
  "frontMatter": {
    "id": "metrics-chart",
  ...
  "next": {
    ...
    "permalink": "/en/oracle-v1/metrics-search"
  }
};
const assets = {
