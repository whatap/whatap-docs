"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["31319"], {
...
"37379": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_java_dashboard_mdx_581_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-java-dashboard-mdx-581.json
var site_docs_java_dashboard_mdx_581_namespaceObject = JSON.parse('{"id":"java/dashboard","title":"애플리케이션 대시보드","description":"자바(Java) 애플리케이션의 핵심 지표를 실시간으로 모니터링하고 과거 데이터를 조회할 수 있는 방법을 안내합니다. CPU, 메모리 사용량, 트랜잭션 상태 등의 정보를 포함하여 문제를 빠르게 식별하고 분석할 수 있는 대시보드 설정과 사용법을 확인할 수 있습니다. 에이전트의 연결 상태 확인, 분류별 에이전트 모니터링, 대시보드 위젯의 편집과 프리셋 관리 방법 등을 포함하고 있습니다.","source":"@site/docs/java/dashboard.mdx","sourceDirName":"java","slug":"/java/dashboard","permalink":"/java/dashboard","draft":false,"unlisted":false,"editUrl":"undefined/docs/java/dashboard.mdx","tags":[],"version":"current","frontMatter":{"id":"dashboard","title":"애플리케이션 대시보드","description":"자바(Java) 애플리케이션의 핵심 지표를 실시간으로 모니터링하고 과거 데이터를 조회할 수 있는 방법을 안내합니다. CPU, 메모리 사용량, 트랜잭션 상태 등의 정보를 포함하여 문제를 빠르게 식별하고 분석할 수 있는 대시보드 설정과 사용법을 확인할 수 있습니다. 에이전트의 연결 상태 확인, 분류별 에이전트 모니터링, 대시보드 위젯의 편집과 프리셋 관리 방법 등을 포함하고 있습니다.","keywords":["Java","대시보드","애플리케이션"],"isTranslationMissing":false},"sidebar":"javaSidebar","previous":{"title":"대시보드","permalink":"/java/dashboard-intro"},"next":{"title":"트랜잭션 맵","permalink":"/java/dashboard-transactionmap"}}')
...
;// CONCATENATED MODULE: ./docs/java/dashboard.mdx
