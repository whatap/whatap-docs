"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["5598"], {
...
"91490": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_mysql_flexboard_share_mdx_b5c_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-mysql-flexboard-share-mdx-b5c.json
var site_docs_mysql_flexboard_share_mdx_b5c_namespaceObject = JSON.parse('{"id":"mysql/flexboard-share","title":"Flex 보드 공유하기","description":"Flex 보드를 다른 계정의 사용자와 공유하고 재사용할 수 있습니다.","source":"@site/docs/mysql/flexboard-share.mdx","sourceDirName":"mysql","slug":"/mysql/flexboard-share","permalink":"/mysql/flexboard-share","draft":false,"unlisted":false,"editUrl":"undefined/docs/mysql/flexboard-share.mdx","tags":[],"version":"current","frontMatter":{"id":"flexboard-share","title":"Flex 보드 공유하기","description":"Flex 보드를 다른 계정의 사용자와 공유하고 재사용할 수 있습니다.","keywords":["MySQL","Flex 보드"],"isTranslationMissing":false},"sidebar":"mysqlSidebar","previous":{"title":"Flex 보드 화면 모드","permalink":"/mysql/flexboard-mode"},"next":{"title":"카운트 추이 비교","permalink":"/mysql/analysis-count-trend"}}')
...
;// CONCATENATED MODULE: ./docs/mysql/flexboard-share.mdx
