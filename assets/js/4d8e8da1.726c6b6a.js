"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["76686"], {
...
"38002": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_python_flexboard_share_mdx_4d8_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-python-flexboard-share-mdx-4d8.json
var site_docs_python_flexboard_share_mdx_4d8_namespaceObject = JSON.parse('{"id":"python/flexboard-share","title":"Flex 보드 공유하기","description":"Flex 보드를 다른 계정의 사용자와 공유하고 재사용할 수 있습니다.","source":"@site/docs/python/flexboard-share.mdx","sourceDirName":"python","slug":"/python/flexboard-share","permalink":"/python/flexboard-share","draft":false,"unlisted":false,"editUrl":"undefined/docs/python/flexboard-share.mdx","tags":[],"version":"current","frontMatter":{"id":"flexboard-share","title":"Flex 보드 공유하기","description":"Flex 보드를 다른 계정의 사용자와 공유하고 재사용할 수 있습니다.","keywords":["Python","Flex 보드"],"isTranslationMissing":false},"sidebar":"pySidebar","previous":{"title":"Flex 보드 화면 모드","permalink":"/python/flexboard-mode"},"next":{"title":"분석","permalink":"/python/analysis-report-intro"}}')
...
;// CONCATENATED MODULE: ./docs/python/flexboard-share.mdx
