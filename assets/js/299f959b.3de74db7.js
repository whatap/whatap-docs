"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[11738],{
...
function _createMdxContent(props) {
  ...
  return (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.section, {
    ...
    children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.h3, {
      ...
      product: "cubrid,mysql,oracle,postgresql,redis,tibero,altibase,mongodb,mssql,oracle-pro,oracle-v2",
...
const metadata = {
  "id": "oracle-v2/metrics-chart",
  "title": "메트릭스 차트",
  "description": "메트릭스 데이터를 차트로 조회할 수 있습니다.",
  "source": "@site/docs/oracle-v2/metrics-chart.mdx",
  "sourceDirName": "oracle-v2",
  "slug": "/oracle-v2/metrics-chart",
  "permalink": "/whatap-docs/oracle-v2/metrics-chart",
  "draft": false,
  "unlisted": false,
  "editUrl": "undefined/docs/oracle-v2/metrics-chart.mdx",
  "tags": [
    {
      "inline": true,
      "label": "메트릭스",
  ...
  "next": {
    "title": "메트릭스 조회",
    "permalink": "/whatap-docs/oracle-v2/metrics-search"
  }
};
const assets = {
