"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["62847"], {
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_mssql_v_1_set_event_format_mdx_ebc_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-mssql-v-1-set-event-format-mdx-ebc.json
var site_docs_mssql_v_1_set_event_format_mdx_ebc_namespaceObject = JSON.parse('{"id":"mssql-v1/set-event-format","title":"이벤트 수신 포맷","description":"데이터베이스 모니터링에서 제공하는 경고 알림의 이벤트 수신 포맷에 대해 알아봅니다.","source":"@site/docs/mssql-v1/set-event-format.mdx","sourceDirName":"mssql-v1","slug":"/mssql-v1/set-event-format","permalink":"/mssql-v1/set-event-format","draft":false,"unlisted":false,"editUrl":"undefined/docs/mssql-v1/set-event-format.mdx","tags":[],"version":"current","frontMatter":{"id":"set-event-format","title":"이벤트 수신 포맷","description":"데이터베이스 모니터링에서 제공하는 경고 알림의 이벤트 수신 포맷에 대해 알아봅니다.","keywords":["SQL Server","경고 알림","이벤트","데이터베이스","데이터베이스 모니터링","이벤트 수신 포맷"],"isTranslationMissing":false},"sidebar":"mssqlV1Sidebar","previous":{"title":"이벤트 기록","permalink":"/mssql-v1/set-event-history"},"next":{"title":"실시간 알림","permalink":"/mssql-v1/real-time-notification"}}')
...
;// CONCATENATED MODULE: ./docs/mssql-v1/set-event-format.mdx
