"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["17564"], {
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_cubrid_v_1_troubleshooting_mdx_5b2_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-cubrid-v-1-troubleshooting-mdx-5b2.json
var site_docs_cubrid_v_1_troubleshooting_mdx_5b2_namespaceObject = JSON.parse('{"id":"cubrid-v1/troubleshooting","title":"설치 문제 해결","description":"데이터베이스 에이전트 설치 시 발생할 수 있는 문제를 확인할 수 있습니다.","source":"@site/docs/cubrid-v1/troubleshooting.mdx","sourceDirName":"cubrid-v1","slug":"/cubrid-v1/troubleshooting","permalink":"/cubrid-v1/troubleshooting","draft":false,"unlisted":false,"editUrl":"undefined/docs/cubrid-v1/troubleshooting.mdx","tags":[],"version":"current","frontMatter":{"id":"troubleshooting","title":"설치 문제 해결","description":"데이터베이스 에이전트 설치 시 발생할 수 있는 문제를 확인할 수 있습니다.","keywords":["CUBRID","데이터베이스","문제 해결","에이전트"],"isTranslationMissing":false},"sidebar":"cubridV1Sidebar","previous":{"title":"설치 점검 사항","permalink":"/cubrid-v1/after-install-agent"},"next":{"title":"설정하기","permalink":"/cubrid-v1/agent-settings"}}')
...
;// CONCATENATED MODULE: ./docs/cubrid-v1/troubleshooting.mdx
