...
"79179": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_altibase_v_1_agent_settings_mdx_c9a_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-altibase-v-1-agent-settings-mdx-c9a.json
var site_docs_altibase_v_1_agent_settings_mdx_c9a_namespaceObject = JSON.parse('{"id":"altibase-v1/agent-settings","title":"설정하기","description":"데이터베이스 에이전트 서버에 있는 whatap.conf 파일을 통해 설정할 수 있는 옵션에 대해 알아봅니다.","source":"@site/docs/altibase-v1/agent-settings.mdx","sourceDirName":"altibase-v1","slug":"/altibase-v1/agent-settings","permalink":"/altibase-v1/agent-settings","draft":false,"unlisted":false,"editUrl":"undefined/docs/altibase-v1/agent-settings.mdx","tags":[],"version":"current","frontMatter":{"id":"agent-settings","title":"설정하기","description":"데이터베이스 에이전트 서버에 있는 whatap.conf 파일을 통해 설정할 수 있는 옵션에 대해 알아봅니다.","keywords":["Altibase","데이터베이스","데이터베이스 모니터링"],"isTranslationMissing":false},"sidebar":"altibasev1Sidebar","previous":{"title":"설치 문제 해결","permalink":"/altibase-v1/troubleshooting"},"next":{"title":"에이전트 네트워크 통신","permalink":"/altibase-v1/agent-network"}}')
...
const toc = [..._db_agent_settings_desc/* toc */.d$];
