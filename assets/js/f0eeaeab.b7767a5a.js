"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[63156],{
...
const metadata = {
  "id": "browser/real-time-notification",
  "title": "실시간 알림",
  "description": "이벤트 설정 메뉴를 통해서 설정한 경고 알림을 실시간으로 확인할 수 있습니다.",
  "source": "@site/docs/browser/real-time-notification.mdx",
  "sourceDirName": "browser",
  "slug": "/browser/real-time-notification",
  "permalink": "/whatap-docs/browser/real-time-notification",
  "draft": false,
  "unlisted": false,
  "editUrl": "undefined/docs/browser/real-time-notification.mdx",
  "tags": [],
  "version": "current",
  "frontMatter": {
    "id": "real-time-notification",
