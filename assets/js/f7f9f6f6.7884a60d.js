"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["46044"], {
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_oracle_cloud_labs_mdx_f7f_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-oracle-cloud-labs-mdx-f7f.json
var site_docs_oracle_cloud_labs_mdx_f7f_namespaceObject = JSON.parse('{"id":"oracle-cloud/labs","title":"실험실","description":"사용자에게 새로운 기능 또는 실험적인 기능을 제공하는 메뉴인 실험실에 대해 안내합니다.","source":"@site/docs/oracle-cloud/labs.mdx","sourceDirName":"oracle-cloud","slug":"/oracle-cloud/labs","permalink":"/oracle-cloud/labs","draft":false,"unlisted":false,"editUrl":"undefined/docs/oracle-cloud/labs.mdx","tags":[],"version":"current","frontMatter":{"id":"labs","title":"실험실","description":"사용자에게 새로운 기능 또는 실험적인 기능을 제공하는 메뉴인 실험실에 대해 안내합니다.","keywords":["Oracle Cloud Monitor","클라우드","실험실"],"isTranslationMissing":false},"sidebar":"oracleSidebar","previous":{"title":"시스템 이벤트 안내","permalink":"/oracle-cloud/common-alert"}}')
...
;// CONCATENATED MODULE: ./docs/oracle-cloud/labs.mdx
