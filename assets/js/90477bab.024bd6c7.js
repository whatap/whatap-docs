"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["4935"], {
...
"62176": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_python_track_transactions_intro_mdx_904_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-python-track-transactions-intro-mdx-904.json
var site_docs_python_track_transactions_intro_mdx_904_namespaceObject = JSON.parse('{"id":"python/track-transactions-intro","title":"트랜잭션","description":"트랜잭션의 개요를 안내합니다.","source":"@site/docs/python/track-transactions-intro.mdx","sourceDirName":"python","slug":"/python/track-transactions-intro","permalink":"/python/track-transactions-intro","draft":false,"unlisted":false,"editUrl":"undefined/docs/python/track-transactions-intro.mdx","tags":[],"version":"current","frontMatter":{"id":"track-transactions-intro","title":"트랜잭션","description":"트랜잭션의 개요를 안내합니다.","keywords":["Python","트랜잭션"],"isTranslationMissing":false},"sidebar":"pySidebar","previous":{"title":"메트릭스 이상 탐지","permalink":"/python/metrics-detect-anormal"},"next":{"title":"트랜잭션 분석하기","permalink":"/python/trs-view"}}')
...
;// CONCATENATED MODULE: ./docs/python/track-transactions-intro.mdx
