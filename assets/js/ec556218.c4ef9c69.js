"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["79817"], {
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_python_set_event_format_mdx_ec5_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-python-set-event-format-mdx-ec5.json
var site_docs_python_set_event_format_mdx_ec5_namespaceObject = JSON.parse('{"id":"python/set-event-format","title":"이벤트 수신 포맷","description":"애플리케이션 모니터링에서 제공하는 경고 알림의 이벤트 수신 포맷에 대해 알아봅니다.","source":"@site/docs/python/set-event-format.mdx","sourceDirName":"python","slug":"/python/set-event-format","permalink":"/python/set-event-format","draft":false,"unlisted":false,"editUrl":"undefined/docs/python/set-event-format.mdx","tags":[],"version":"current","frontMatter":{"id":"set-event-format","title":"이벤트 수신 포맷","description":"애플리케이션 모니터링에서 제공하는 경고 알림의 이벤트 수신 포맷에 대해 알아봅니다.","keywords":["Python","경고 알림","이벤트","애플리케이션","애플리케이션 모니터링","이벤트 수신 포맷"],"isTranslationMissing":false},"sidebar":"pySidebar","previous":{"title":"이벤트 기록","permalink":"/python/set-event-history"},"next":{"title":"실시간 알림","permalink":"/python/real-time-notification"}}')
...
;// CONCATENATED MODULE: ./docs/python/set-event-format.mdx
