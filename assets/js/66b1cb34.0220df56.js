"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["99471"], {
...
"47962": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_nodejs_analysis_trace_mtx_mdx_66b_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-nodejs-analysis-trace-mtx-mdx-66b.json
var site_docs_nodejs_analysis_trace_mtx_mdx_66b_namespaceObject = JSON.parse('{"id":"nodejs/analysis-trace-mtx","title":"멀티 트랜잭션 추적","description":"시스템 내 또는 시스템 간에 발생하는 다양한 호출 관계를 한 눈에 파악하고 어느 부분에서 문제가 발생했는지 식별하여 개선할 수 있도록 트랜잭션과 트레이스 정보를 제공합니다.","source":"@site/docs/nodejs/analysis-trace-mtx.mdx","sourceDirName":"nodejs","slug":"/nodejs/analysis-trace-mtx","permalink":"/nodejs/analysis-trace-mtx","draft":false,"unlisted":false,"editUrl":"undefined/docs/nodejs/analysis-trace-mtx.mdx","tags":[],"version":"current","frontMatter":{"id":"analysis-trace-mtx","title":"멀티 트랜잭션 추적","description":"시스템 내 또는 시스템 간에 발생하는 다양한 호출 관계를 한 눈에 파악하고 어느 부분에서 문제가 발생했는지 식별하여 개선할 수 있도록 트랜잭션과 트레이스 정보를 제공합니다.","keywords":["Node.js","애플리케이션","멀티 트랜잭션"],"isTranslationMissing":false},"sidebar":"nodejsSidebar","previous":{"title":"히트맵","permalink":"/nodejs/analysis-hitmap"},"next":{"title":"트랜잭션 검색","permalink":"/nodejs/tx-profile"}}')
...
;// CONCATENATED MODULE: ./docs/nodejs/analysis-trace-mtx.mdx
