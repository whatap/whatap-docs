"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["55514"], {
"80199": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_altibase_instance_monitoring_mdx_0a1_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-altibase-instance-monitoring-mdx-0a1.json
var site_docs_altibase_instance_monitoring_mdx_0a1_namespaceObject = JSON.parse('{"id":"altibase/instance-monitoring","title":"인스턴스 모니터링","description":"인스턴스 모니터링 메뉴에서는 데이터베이스 서버의 핵심 지표들에 대한 상세 정보를 실시간으로 확인할 수 있습니다.","source":"@site/docs/altibase/instance-monitoring.mdx","sourceDirName":"altibase","slug":"/altibase/instance-monitoring","permalink":"/altibase/instance-monitoring","draft":false,"unlisted":false,"editUrl":"undefined/docs/altibase/instance-monitoring.mdx","tags":[],"version":"current","frontMatter":{"id":"instance-monitoring","title":"인스턴스 모니터링","description":"인스턴스 모니터링 메뉴에서는 데이터베이스 서버의 핵심 지표들에 대한 상세 정보를 실시간으로 확인할 수 있습니다.","keywords":["Altibase","인스턴스","대시보드","데이터베이스 모니터링"],"isTranslationMissing":false},"sidebar":"altibaseSidebar","previous":{"title":"인스턴스 목록","permalink":"/altibase/instance-list"},"next":{"title":"멀티 인스턴스 모니터링","permalink":"/altibase/multi-instance-monitoring"}}')
