"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["34169"], {
...
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_amazon_ecs_metrics_chart_mdx_8d7_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-amazon-ecs-metrics-chart-mdx-8d7.json
var site_docs_amazon_ecs_metrics_chart_mdx_8d7_namespaceObject = JSON.parse('{"id":"amazon-ecs/metrics-chart","title":"메트릭스 차트","description":"메트릭스 데이터를 차트로 조회할 수 있습니다.","source":"@site/docs/amazon-ecs/metrics-chart.mdx","sourceDirName":"amazon-ecs","slug":"/amazon-ecs/metrics-chart","permalink":"/amazon-ecs/metrics-chart","draft":false,"unlisted":false,"editUrl":"undefined/docs/amazon-ecs/metrics-chart.mdx","tags":[],"version":"current","frontMatter":{"id":"metrics-chart","title":"메트릭스 차트","description":"메트릭스 데이터를 차트로 조회할 수 있습니다.","keywords":["Amazon ECS","메트릭스","메트릭스 차트","UI"],"isTranslationMissing":false},"sidebar":"awsecsSidebar","previous":{"title":"메트릭스 큐브","permalink":"/amazon-ecs/metrics-cube"},"next":{"title":"메트릭스 이상 탐지","permalink":"/amazon-ecs/metrics-detect-anormal"}}')
...
;// CONCATENATED MODULE: ./docs/amazon-ecs/metrics-chart.mdx
