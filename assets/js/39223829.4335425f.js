"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["33744"], {
...
"90335": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_nodejs_dashboard_mdx_392_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-nodejs-dashboard-mdx-392.json
var site_docs_nodejs_dashboard_mdx_392_namespaceObject = JSON.parse('{"id":"nodejs/dashboard","title":"애플리케이션 대시보드","description":"웹 애플리케이션 서버의 리소스를 실시간으로 모니터링할 수 있습니다.","source":"@site/docs/nodejs/dashboard.mdx","sourceDirName":"nodejs","slug":"/nodejs/dashboard","permalink":"/nodejs/dashboard","draft":false,"unlisted":false,"editUrl":"undefined/docs/nodejs/dashboard.mdx","tags":[],"version":"current","frontMatter":{"id":"dashboard","title":"애플리케이션 대시보드","description":"웹 애플리케이션 서버의 리소스를 실시간으로 모니터링할 수 있습니다.","keywords":["Node.js","대시보드","애플리케이션","애플리케이션 모니터링"],"isTranslationMissing":false},"sidebar":"nodejsSidebar","previous":{"title":"대시보드","permalink":"/nodejs/dashboard-intro"},"next":{"title":"트랜잭션 맵","permalink":"/nodejs/dashboard-transactionmap"}}')
...
;// CONCATENATED MODULE: ./docs/nodejs/dashboard.mdx
