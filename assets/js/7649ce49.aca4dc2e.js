"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["79237"], {
...
"80144": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_mongodb_flexboard_mode_mdx_764_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-mongodb-flexboard-mode-mdx-764.json
var site_docs_mongodb_flexboard_mode_mdx_764_namespaceObject = JSON.parse('{"id":"mongodb/flexboard-mode","title":"Flex 보드 화면 모드","description":"Flex 보드의 화면 모드에 따라 제공하는 기능에 대해 알아보세요.","source":"@site/docs/mongodb/flexboard-mode.mdx","sourceDirName":"mongodb","slug":"/mongodb/flexboard-mode","permalink":"/mongodb/flexboard-mode","draft":false,"unlisted":false,"editUrl":"undefined/docs/mongodb/flexboard-mode.mdx","tags":[],"version":"current","frontMatter":{"id":"flexboard-mode","title":"Flex 보드 화면 모드","description":"Flex 보드의 화면 모드에 따라 제공하는 기능에 대해 알아보세요.","keywords":["MongoDB","DB","데이터베이스","데이터베이스 모니터링","Flex 보드"],"isTranslationMissing":false},"sidebar":"mongodbSidebar","previous":{"title":"위젯 템플릿","permalink":"/mongodb/flexboard-widget-template"},"next":{"title":"Flex 보드 공유하기","permalink":"/mongodb/flexboard-share"}}')
...
;// CONCATENATED MODULE: ./docs/mongodb/flexboard-mode.mdx
