"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[71570],{
...
const metadata = {
  "id": "cubrid-v1/after-install-agent",
  "title": "설치 점검 사항",
  "description": "데이터베이스 모니터링 설치를 모두 완료했습니다. 설치 후 확인 사항을 점검하세요.",
  "source": "@site/docs/cubrid-v1/after-install-agent.mdx",
  "sourceDirName": "cubrid-v1",
  "slug": "/cubrid-v1/after-install-agent",
  "permalink": "/whatap-docs/cubrid-v1/after-install-agent",
  "draft": false,
  "unlisted": false,
  "editUrl": "undefined/docs/cubrid-v1/after-install-agent.mdx",
  "tags": [],
  "version": "current",
  "frontMatter": {
    "id": "after-install-agent",
