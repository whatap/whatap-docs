"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[61444],{
...
const metadata = {
  ...
  "title": "지원 환경",
  "description": "데이터베이스 모니터링을 시작하기 전에 지원하는 데이터베이스 종류에 대해서 알아보세요.",
  "source": "@site/docs/oracle-v2/monitoring-support.mdx",
  "sourceDirName": "oracle-v2",
  "slug": "/oracle-v2/monitoring-support",
  "permalink": "/whatap-docs/oracle-v2/monitoring-support",
  "draft": false,
  "unlisted": false,
  "editUrl": "undefined/docs/oracle-v2/monitoring-support.mdx",
  "tags": [
    {
      "inline": true,
      "label": "데이터베이스",
  ...
  "previous": {
    ...
    "permalink": "/whatap-docs/oracle-v2/monitoring-intro"
  },
  "next": {
    "title": "에이전트 설치",
