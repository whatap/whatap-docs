"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["66389"], {
...
"57180": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_mssql_log_main_mdx_450_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-mssql-log-main-mdx-450.json
var site_docs_mssql_log_main_mdx_450_namespaceObject = JSON.parse('{"id":"mssql/log-main","title":"로그","description":"로그 모니터링의 주요 메뉴를 안내합니다.","source":"@site/docs/mssql/log-main.mdx","sourceDirName":"mssql","slug":"/mssql/log-main","permalink":"/mssql/log-main","draft":false,"unlisted":false,"editUrl":"undefined/docs/mssql/log-main.mdx","tags":[],"version":"current","frontMatter":{"id":"log-main","title":"로그","description":"로그 모니터링의 주요 메뉴를 안내합니다.","keywords":["SQL Server","로그 모니터링","UI"],"isTranslationMissing":false},"sidebar":"mssqlSidebar","previous":{"title":"백업/복구 내역","permalink":"/mssql/backup-recovery-history"},"next":{"title":"적용하기","permalink":"/mssql/log-db"}}')
...
;// CONCATENATED MODULE: ./docs/mssql/log-main.mdx
