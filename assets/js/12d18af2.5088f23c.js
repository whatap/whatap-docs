"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["11332"], {
...
"59518": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_mssql_warning_notice_mdx_12d_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-mssql-warning-notice-mdx-12d.json
var site_docs_mssql_warning_notice_mdx_12d_namespaceObject = JSON.parse('{"id":"mssql/warning-notice","title":"데이터베이스 경고 알림","description":"데이터베이스의 지표별 이벤트 조건 설정을 통해 경고 알림을 보냅니다.","source":"@site/docs/mssql/warning-notice.mdx","sourceDirName":"mssql","slug":"/mssql/warning-notice","permalink":"/mssql/warning-notice","draft":false,"unlisted":false,"editUrl":"undefined/docs/mssql/warning-notice.mdx","tags":[],"version":"current","frontMatter":{"id":"warning-notice","title":"데이터베이스 경고 알림","description":"데이터베이스의 지표별 이벤트 조건 설정을 통해 경고 알림을 보냅니다.","keywords":["SQL Server","경고 알림","데이터베이스","데이터베이스 모니터링"],"isTranslationMissing":false},"sidebar":"mssqlSidebar","previous":{"title":"알림 설정하기","permalink":"/mssql/set-notice"},"next":{"title":"이벤트 설정","permalink":"/mssql/warning-notice-v2"}}')
...
;// CONCATENATED MODULE: ./docs/mssql/warning-notice.mdx
