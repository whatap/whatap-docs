"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["18680"], {
...
"20974": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_mssql_v_1_warning_notice_mdx_516_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-mssql-v-1-warning-notice-mdx-516.json
var site_docs_mssql_v_1_warning_notice_mdx_516_namespaceObject = JSON.parse('{"id":"mssql-v1/warning-notice","title":"데이터베이스 경고 알림","description":"데이터베이스의 지표별 이벤트 조건 설정을 통해 경고 알림을 보냅니다.","source":"@site/docs/mssql-v1/warning-notice.mdx","sourceDirName":"mssql-v1","slug":"/mssql-v1/warning-notice","permalink":"/mssql-v1/warning-notice","draft":false,"unlisted":false,"editUrl":"undefined/docs/mssql-v1/warning-notice.mdx","tags":[],"version":"current","frontMatter":{"id":"warning-notice","title":"데이터베이스 경고 알림","description":"데이터베이스의 지표별 이벤트 조건 설정을 통해 경고 알림을 보냅니다.","keywords":["SQL Server","경고 알림","데이터베이스","데이터베이스 모니터링"],"isTranslationMissing":false},"sidebar":"mssqlV1Sidebar","previous":{"title":"알림 설정하기","permalink":"/mssql-v1/set-notice"},"next":{"title":"이벤트 설정","permalink":"/mssql-v1/warning-notice-v2"}}')
...
;// CONCATENATED MODULE: ./docs/mssql-v1/warning-notice.mdx
