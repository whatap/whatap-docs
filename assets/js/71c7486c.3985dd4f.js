"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[5460],{
...
const metadata = {
  ...
  "title": "메트릭스 차트",
  "description": "메트릭스 데이터를 차트로 조회할 수 있습니다.",
  "source": "@site/docs/redis/metrics-chart-v2.mdx",
  "sourceDirName": "redis",
  "slug": "/redis/metrics-chart-v2",
  "permalink": "/whatap-docs/redis/metrics-chart-v2",
  "draft": false,
  "unlisted": false,
  "editUrl": "undefined/docs/redis/metrics-chart-v2.mdx",
  "tags": [],
  "version": "current",
  "frontMatter": {
    "id": "metrics-chart-v2",
