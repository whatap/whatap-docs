"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["48590"], {
"68068": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_php_agent_remove_mdx_a8a_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-php-agent-remove-mdx-a8a.json
var site_docs_php_agent_remove_mdx_a8a_namespaceObject = JSON.parse('{"id":"php/agent-remove","title":"에이전트 삭제","description":"PHP 에이전트 삭제 방법을 제공합니다.","source":"@site/docs/php/agent-remove.mdx","sourceDirName":"php","slug":"/php/agent-remove","permalink":"/php/agent-remove","draft":false,"unlisted":false,"editUrl":"undefined/docs/php/agent-remove.mdx","tags":[],"version":"current","frontMatter":{"id":"agent-remove","title":"에이전트 삭제","description":"PHP 에이전트 삭제 방법을 제공합니다.","keywords":["PHP","에이전트 삭제","관리하기","애플리케이션"],"isTranslationMissing":false},"sidebar":"phpSidebar","previous":{"title":"모니터링 일시 중지","permalink":"/php/agent-temp-st"},"next":{"title":"대시보드","permalink":"/php/dashboard-intro"}}')
