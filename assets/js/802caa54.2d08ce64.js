"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["15776"], {
...
"51545": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_mysql_cloudsettings_mdx_802_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-mysql-cloudsettings-mdx-802.json
var site_docs_mysql_cloudsettings_mdx_802_namespaceObject = JSON.parse('{"id":"mysql/cloudsettings","title":"클라우드 설정","description":"클라우드 데이터베이스 서버의 자원 현황을 수집하고 모니터링할 수 있습니다.","source":"@site/docs/mysql/cloudsettings.mdx","sourceDirName":"mysql","slug":"/mysql/cloudsettings","permalink":"/mysql/cloudsettings","draft":false,"unlisted":false,"editUrl":"undefined/docs/mysql/cloudsettings.mdx","tags":[],"version":"current","frontMatter":{"id":"cloudsettings","title":"클라우드 설정","description":"클라우드 데이터베이스 서버의 자원 현황을 수집하고 모니터링할 수 있습니다.","keywords":["MySQL","데이터베이스","클라우드"],"isTranslationMissing":false},"sidebar":"mysqlSidebar","previous":{"title":"XOS 에이전트 설정","permalink":"/mysql/agent-xos-settings"},"next":{"title":"관리하기","permalink":"/mysql/agent-manage"}}')
...
;// CONCATENATED MODULE: ./docs/mysql/cloudsettings.mdx
