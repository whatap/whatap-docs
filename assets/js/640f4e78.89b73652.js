"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["80155"], {
...
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_altibase_v_1_set_event_format_mdx_640_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-altibase-v-1-set-event-format-mdx-640.json
var site_docs_altibase_v_1_set_event_format_mdx_640_namespaceObject = JSON.parse('{"id":"altibase-v1/set-event-format","title":"이벤트 수신 포맷","description":"데이터베이스 모니터링에서 제공하는 경고 알림의 이벤트 수신 포맷에 대해 알아봅니다.","source":"@site/docs/altibase-v1/set-event-format.mdx","sourceDirName":"altibase-v1","slug":"/altibase-v1/set-event-format","permalink":"/altibase-v1/set-event-format","draft":false,"unlisted":false,"editUrl":"undefined/docs/altibase-v1/set-event-format.mdx","tags":[],"version":"current","frontMatter":{"id":"set-event-format","title":"이벤트 수신 포맷","description":"데이터베이스 모니터링에서 제공하는 경고 알림의 이벤트 수신 포맷에 대해 알아봅니다.","keywords":["Altibase","경고 알림","이벤트","데이터베이스","데이터베이스 모니터링","이벤트 수신 포맷"],"isTranslationMissing":false},"sidebar":"altibasev1Sidebar","previous":{"title":"이벤트 기록","permalink":"/altibase-v1/set-event-history"},"next":{"title":"실시간 알림","permalink":"/altibase-v1/real-time-notification"}}')
