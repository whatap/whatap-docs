"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["92744"], {
...
"40876": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_mssql_v_1_flexboard_mode_mdx_420_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-mssql-v-1-flexboard-mode-mdx-420.json
var site_docs_mssql_v_1_flexboard_mode_mdx_420_namespaceObject = JSON.parse('{"id":"mssql-v1/flexboard-mode","title":"Flex 보드 화면 모드","description":"Flex 보드의 화면 모드에 따라 제공하는 기능에 대해 알아보세요.","source":"@site/docs/mssql-v1/flexboard-mode.mdx","sourceDirName":"mssql-v1","slug":"/mssql-v1/flexboard-mode","permalink":"/mssql-v1/flexboard-mode","draft":false,"unlisted":false,"editUrl":"undefined/docs/mssql-v1/flexboard-mode.mdx","tags":[],"version":"current","frontMatter":{"id":"flexboard-mode","title":"Flex 보드 화면 모드","description":"Flex 보드의 화면 모드에 따라 제공하는 기능에 대해 알아보세요.","keywords":["SQL Server","DB","데이터베이스","데이터베이스 모니터링","Flex 보드"],"isTranslationMissing":false},"sidebar":"mssqlV1Sidebar","previous":{"title":"위젯 템플릿","permalink":"/mssql-v1/flexboard-widget-template"},"next":{"title":"Flex 보드 공유하기","permalink":"/mssql-v1/flexboard-share"}}')
...
;// CONCATENATED MODULE: ./docs/mssql-v1/flexboard-mode.mdx
