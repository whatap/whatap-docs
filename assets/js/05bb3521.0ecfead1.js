"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["53666"], {
...
"24375": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_mssql_set_receive_event_mdx_05b_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-mssql-set-receive-event-mdx-05b.json
var site_docs_mssql_set_receive_event_mdx_05b_namespaceObject = JSON.parse('{"id":"mssql/set-receive-event","title":"이벤트 수신 설정","description":"프로젝트에 포함하는 멤버들의 경고 알림 수신과 관련한 다양한 기능을 설정할 수 있습니다.","source":"@site/docs/mssql/set-receive-event.mdx","sourceDirName":"mssql","slug":"/mssql/set-receive-event","permalink":"/mssql/set-receive-event","draft":false,"unlisted":false,"editUrl":"undefined/docs/mssql/set-receive-event.mdx","tags":[],"version":"current","frontMatter":{"id":"set-receive-event","title":"이벤트 수신 설정","description":"프로젝트에 포함하는 멤버들의 경고 알림 수신과 관련한 다양한 기능을 설정할 수 있습니다.","keywords":["SQL Server","경고 알림","이벤트 수신 태그","데이터베이스 모니터링"],"isTranslationMissing":false},"sidebar":"mssqlSidebar","previous":{"title":"이상치 탐지 경고 알림","permalink":"/mssql/set-event-detect-anomal"},"next":{"title":"이벤트 기록","permalink":"/mssql/set-event-history"}}')
...
;// CONCATENATED MODULE: ./docs/mssql/set-receive-event.mdx
