"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["76459"], {
...
"66928": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_dotnet_common_alert_mdx_013_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-dotnet-common-alert-mdx-013.json
var site_docs_dotnet_common_alert_mdx_013_namespaceObject = JSON.parse('{"id":"dotnet/common-alert","title":"시스템 이벤트 안내","description":"와탭 모니터링에서는 플랫폼 전반에서 자동으로 탐지 및 생성되는 공용 이벤트에 대해 안내합니다.","source":"@site/docs/dotnet/common-alert.mdx","sourceDirName":"dotnet","slug":"/dotnet/common-alert","permalink":"/dotnet/common-alert","draft":false,"unlisted":false,"editUrl":"undefined/docs/dotnet/common-alert.mdx","tags":[],"version":"current","frontMatter":{"id":"common-alert","title":"시스템 이벤트 안내","description":"와탭 모니터링에서는 플랫폼 전반에서 자동으로 탐지 및 생성되는 공용 이벤트에 대해 안내합니다.","keywords":["와탭","경고 알림","시스템 이벤트"],"isTranslationMissing":false},"sidebar":"dotNetSidebar","previous":{"title":"실시간 알림","permalink":"/dotnet/real-time-notification"},"next":{"title":"인스턴스 성능 관리","permalink":"/dotnet/instance-performance-analysis"}}')
...
;// CONCATENATED MODULE: ./docs/dotnet/common-alert.mdx
