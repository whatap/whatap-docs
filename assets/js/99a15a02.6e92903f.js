"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[62439],{
...
const metadata = {
  "id": "dotnet/real-time-notification",
  "title": "실시간 알림",
  "description": "이벤트 설정 메뉴를 통해서 설정한 경고 알림을 실시간으로 확인할 수 있습니다.",
  "source": "@site/docs/dotnet/real-time-notification.mdx",
  "sourceDirName": "dotnet",
  "slug": "/dotnet/real-time-notification",
  "permalink": "/whatap-docs/dotnet/real-time-notification",
  "draft": false,
  "unlisted": false,
  "editUrl": "undefined/docs/dotnet/real-time-notification.mdx",
  "tags": [],
  "version": "current",
  "frontMatter": {
    "id": "real-time-notification",
  ...
  "next": {
    "title": "시스템 이벤트 안내",
    "permalink": "/whatap-docs/dotnet/common-alert"
  }
};
const assets = {
