"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["36706"], {
...
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_dotnet_agent_network_mdx_65c_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-dotnet-agent-network-mdx-65c.json
var site_docs_dotnet_agent_network_mdx_65c_namespaceObject = JSON.parse('{"id":"dotnet/agent-network","title":"에이전트 통신 설정","description":"에이전트와 서버 간의 연결에 관한 설정입니다.","source":"@site/docs/dotnet/agent-network.mdx","sourceDirName":"dotnet","slug":"/dotnet/agent-network","permalink":"/dotnet/agent-network","draft":false,"unlisted":false,"editUrl":"undefined/docs/dotnet/agent-network.mdx","tags":[],"version":"current","frontMatter":{"id":"agent-network","title":"에이전트 통신 설정","description":"에이전트와 서버 간의 연결에 관한 설정입니다.","keywords":[".NET","통신","네트워크"],"isTranslationMissing":false},"sidebar":"dotNetSidebar","previous":{"title":"에이전트 기능 제어","permalink":"/dotnet/agent-control-function"},"next":{"title":"에이전트 성능","permalink":"/dotnet/agent-performance"}}')
