...
"13859": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_nodejs_install_agent_nextjs_mdx_09a_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-nodejs-install-agent-nextjs-mdx-09a.json
var site_docs_nodejs_install_agent_nextjs_mdx_09a_namespaceObject = JSON.parse('{"id":"nodejs/install-agent-nextjs","title":"Next.js 환경 설치","description":"Next.js와 같은 서버 사이드 렌더링(SSR) 프레임워크에서 Node.js 애플리케이션 모니터링을 위해 Custom Server 설정을 안내합니다.","source":"@site/docs/nodejs/install-agent-nextjs.mdx","sourceDirName":"nodejs","slug":"/nodejs/install-agent-nextjs","permalink":"/nodejs/install-agent-nextjs","draft":false,"unlisted":false,"editUrl":"undefined/docs/nodejs/install-agent-nextjs.mdx","tags":[],"version":"current","frontMatter":{"id":"install-agent-nextjs","title":"Next.js 환경 설치","description":"Next.js와 같은 서버 사이드 렌더링(SSR) 프레임워크에서 Node.js 애플리케이션 모니터링을 위해 Custom Server 설정을 안내합니다.","keywords":["Node.js","Next.js","에이전트"],"isTranslationMissing":false},"sidebar":"nodejsSidebar","previous":{"title":"Docker 환경 설치","permalink":"/nodejs/install-agent-docker"},"next":{"title":"Nuxt.js 환경 설치","permalink":"/nodejs/install-agent-nuxtjs"}}')
...
;// CONCATENATED MODULE: ./docs/nodejs/install-agent-nextjs.mdx
    ...
    children: [(0,jsx_runtime.jsxs)(_components.p, {
      ...
      children: [(0,jsx_runtime.jsx)(_components.h3, {
        ...
        children: ["다음 코드에서 ", (0,jsx_runtime.jsx)(_components.code, {
          children: "dev"
        }), "는 개발 모드 여부를 나타내며, ", (0,jsx_runtime.jsx)(_components.code, {
          children: "hostname"
