"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["6190"], {
...
"51555": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_nodejs_set_receive_event_mdx_a4f_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-nodejs-set-receive-event-mdx-a4f.json
var site_docs_nodejs_set_receive_event_mdx_a4f_namespaceObject = JSON.parse('{"id":"nodejs/set-receive-event","title":"이벤트 수신 설정","description":"프로젝트에 포함하는 멤버들의 경고 알림 수신과 관련한 다양한 기능을 설정할 수 있습니다.","source":"@site/docs/nodejs/set-receive-event.mdx","sourceDirName":"nodejs","slug":"/nodejs/set-receive-event","permalink":"/nodejs/set-receive-event","draft":false,"unlisted":false,"editUrl":"undefined/docs/nodejs/set-receive-event.mdx","tags":[],"version":"current","frontMatter":{"id":"set-receive-event","title":"이벤트 수신 설정","description":"프로젝트에 포함하는 멤버들의 경고 알림 수신과 관련한 다양한 기능을 설정할 수 있습니다.","keywords":["Node.js","경고 알림","이벤트 수신 태그","애플리케이션 모니터링"],"isTranslationMissing":false},"sidebar":"nodejsSidebar","previous":{"title":"이상치 탐지 경고 알림","permalink":"/nodejs/set-event-detect-anomal"},"next":{"title":"이벤트 기록","permalink":"/nodejs/set-event-history"}}')
...
;// CONCATENATED MODULE: ./docs/nodejs/set-receive-event.mdx
