"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["39495"], {
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_nodejs_set_event_history_mdx_cf1_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-nodejs-set-event-history-mdx-cf1.json
var site_docs_nodejs_set_event_history_mdx_cf1_namespaceObject = JSON.parse('{"id":"nodejs/set-event-history","title":"이벤트 기록","description":"이벤트 기록 메뉴를 통해 발생한 경고 알림 이력을 확인할 수 있습니다.","source":"@site/docs/nodejs/set-event-history.mdx","sourceDirName":"nodejs","slug":"/nodejs/set-event-history","permalink":"/nodejs/set-event-history","draft":false,"unlisted":false,"editUrl":"undefined/docs/nodejs/set-event-history.mdx","tags":[],"version":"current","frontMatter":{"id":"set-event-history","title":"이벤트 기록","description":"이벤트 기록 메뉴를 통해 발생한 경고 알림 이력을 확인할 수 있습니다.","keywords":["Node.js","경고 알림","이벤트 기록","애플리케이션 모니터링"],"isTranslationMissing":false},"sidebar":"nodejsSidebar","previous":{"title":"이벤트 수신 설정","permalink":"/nodejs/set-receive-event"},"next":{"title":"이벤트 수신 포맷","permalink":"/nodejs/set-event-format"}}')
...
;// CONCATENATED MODULE: ./docs/nodejs/set-event-history.mdx
