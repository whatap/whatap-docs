"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["41645"], {
...
"31530": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_mssql_flexboard_mode_mdx_ff9_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-mssql-flexboard-mode-mdx-ff9.json
var site_docs_mssql_flexboard_mode_mdx_ff9_namespaceObject = JSON.parse('{"id":"mssql/flexboard-mode","title":"Flex 보드 화면 모드","description":"Flex 보드의 화면 모드에 따라 제공하는 기능에 대해 알아보세요.","source":"@site/docs/mssql/flexboard-mode.mdx","sourceDirName":"mssql","slug":"/mssql/flexboard-mode","permalink":"/mssql/flexboard-mode","draft":false,"unlisted":false,"editUrl":"undefined/docs/mssql/flexboard-mode.mdx","tags":[],"version":"current","frontMatter":{"id":"flexboard-mode","title":"Flex 보드 화면 모드","description":"Flex 보드의 화면 모드에 따라 제공하는 기능에 대해 알아보세요.","keywords":["SQL Server","DB","데이터베이스","데이터베이스 모니터링","Flex 보드"],"isTranslationMissing":false},"sidebar":"mssqlSidebar","previous":{"title":"위젯 템플릿","permalink":"/mssql/flexboard-widget-template"},"next":{"title":"Flex 보드 공유하기","permalink":"/mssql/flexboard-share"}}')
...
;// CONCATENATED MODULE: ./docs/mssql/flexboard-mode.mdx
