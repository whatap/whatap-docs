"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["12671"], {
"26827": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_altibase_v_1_flexboard_mode_mdx_ce8_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-altibase-v-1-flexboard-mode-mdx-ce8.json
var site_docs_altibase_v_1_flexboard_mode_mdx_ce8_namespaceObject = JSON.parse('{"id":"altibase-v1/flexboard-mode","title":"Flex 보드 화면 모드","description":"Flex 보드의 화면 모드에 따라 제공하는 기능에 대해 알아보세요.","source":"@site/docs/altibase-v1/flexboard-mode.mdx","sourceDirName":"altibase-v1","slug":"/altibase-v1/flexboard-mode","permalink":"/altibase-v1/flexboard-mode","draft":false,"unlisted":false,"editUrl":"undefined/docs/altibase-v1/flexboard-mode.mdx","tags":[],"version":"current","frontMatter":{"id":"flexboard-mode","title":"Flex 보드 화면 모드","description":"Flex 보드의 화면 모드에 따라 제공하는 기능에 대해 알아보세요.","keywords":["Altibase","DB","데이터베이스","데이터베이스 모니터링","Flex 보드"],"isTranslationMissing":false},"sidebar":"altibasev1Sidebar","previous":{"title":"위젯 관리하기","permalink":"/altibase-v1/flexboard-widget-manage"},"next":{"title":"Flex 보드 공유하기","permalink":"/altibase-v1/flexboard-share"}}')
