"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["77371"], {
...
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_aws_log_flexboard_mode_mdx_115_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-aws-log-flexboard-mode-mdx-115.json
var site_docs_aws_log_flexboard_mode_mdx_115_namespaceObject = JSON.parse('{"id":"aws-log/flexboard-mode","title":"Flex 보드 화면 모드","description":"Flex 보드의 화면 모드에 따라 제공하는 기능에 대해 알아보세요.","source":"@site/docs/aws-log/flexboard-mode.mdx","sourceDirName":"aws-log","slug":"/aws-log/flexboard-mode","permalink":"/aws-log/flexboard-mode","draft":false,"unlisted":false,"editUrl":"undefined/docs/aws-log/flexboard-mode.mdx","tags":[],"version":"current","frontMatter":{"id":"flexboard-mode","title":"Flex 보드 화면 모드","description":"Flex 보드의 화면 모드에 따라 제공하는 기능에 대해 알아보세요.","keywords":["Flex 보드","AWS Log"],"isTranslationMissing":false},"sidebar":"awslogSidebar","previous":{"title":"위젯 템플릿","permalink":"/aws-log/flexboard-widget-template"},"next":{"title":"Flex 보드 공유하기","permalink":"/aws-log/flexboard-share"}}')
...
;// CONCATENATED MODULE: ./docs/aws-log/flexboard-mode.mdx
