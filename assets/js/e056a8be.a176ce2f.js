"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["63987"], {
"84710": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_server_agent_update_mdx_e05_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-server-agent-update-mdx-e05.json
var site_docs_server_agent_update_mdx_e05_namespaceObject = JSON.parse('{"id":"server/agent-update","title":"에이전트 업데이트","description":"서버 에이전트 업데이트 방법에 대해 안내합니다.","source":"@site/docs/server/agent-update.mdx","sourceDirName":"server","slug":"/server/agent-update","permalink":"/server/agent-update","draft":false,"unlisted":false,"editUrl":"undefined/docs/server/agent-update.mdx","tags":[],"version":"current","frontMatter":{"id":"agent-update","title":"에이전트 업데이트","description":"서버 에이전트 업데이트 방법에 대해 안내합니다.","keywords":["Server","업데이트","관리하기"],"isTranslationMissing":false},"sidebar":"serverSidebar","previous":{"title":"고급 기능","permalink":"/server/advanced-feature"},"next":{"title":"에이전트 삭제","permalink":"/server/agent-remove"}}')
...
;// CONCATENATED MODULE: ./docs/server/agent-update.mdx
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsx)(_components.admonition, {
      ...
      children: (0,jsx_runtime.jsxs)(_components.p, {
        children: ["이전 버전을 설치하려면 ", (0,jsx_runtime.jsx)(_components.a, {
      ...
      children: [(0,jsx_runtime.jsx)(_components.h2, {
        ...
        children: ["설치된 에이전트를 최신 버전으로 업데이트하려면 ", (0,jsx_runtime.jsx)(Cmdname, {
          sid: "side_management",
          className: "uitext"
        }), " > ", (0,jsx_runtime.jsx)(Cmdname, {
          sid: "side_agentInstall",
          className: "uitext"
        }), " 메뉴로 이동하세요. ", (0,jsx_runtime.jsx)(Cmdname, {
          sid: "agent-setup-guide",
          className: "uitext"
        }), " 섹션의 ", (0,jsx_runtime.jsx)(Cmdname, {
          sid: "server_installAgent_win_download",
          className: "uitext"
        }), " 안내에 따라 윈도우 서버 운영 체제용 설치 파일을 다운로드 후 ", (0,jsx_runtime.jsx)(_components.em, {
          children: "whatap_infra.exe"
        }), " 파일을 실행하세요. 에이전트 업데이트 후 서비스가 재시작됩니다."]
      }), (0,jsx_runtime.jsx)(_components.admonition, {
        type: "note",
        children: (0,jsx_runtime.jsxs)(_components.p, {
          children: ["보안 설정 때문에 ", (0,jsx_runtime.jsx)(_components.em, {
            children: ".exe"
          }), " 형식의 파일이 받아지지 않는 사용자를 위해 ", (0,jsx_runtime.jsx)(_components.em, {
            children: ".zip"
          }), " 형식의 파일도 함께 제공합니다. 자세한 내용은 ", (0,jsx_runtime.jsx)(_components.a, {
