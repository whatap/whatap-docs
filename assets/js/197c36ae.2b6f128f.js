"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["34256"], {
...
"61095": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_redis_metrics_intro_mdx_197_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-redis-metrics-intro-mdx-197.json
var site_docs_redis_metrics_intro_mdx_197_namespaceObject = JSON.parse('{"id":"redis/metrics-intro","title":"메트릭스","description":"데이터베이스 모니터링 분석을 위한 메트릭스 메뉴에 대해 알아봅니다.","source":"@site/docs/redis/metrics-intro.mdx","sourceDirName":"redis","slug":"/redis/metrics-intro","permalink":"/redis/metrics-intro","draft":false,"unlisted":false,"editUrl":"undefined/docs/redis/metrics-intro.mdx","tags":[],"version":"current","frontMatter":{"id":"metrics-intro","title":"메트릭스","description":"데이터베이스 모니터링 분석을 위한 메트릭스 메뉴에 대해 알아봅니다.","keywords":["Redis","메트릭스","데이터베이스","데이터베이스 모니터링"],"isTranslationMissing":false},"sidebar":"redisSidebar","previous":{"title":"데이터베이스 파라미터","permalink":"/redis/analysis-databaseparameter"},"next":{"title":"Redis 지표","permalink":"/redis/metrics-data-list"}}')
...
;// CONCATENATED MODULE: ./docs/redis/metrics-intro.mdx
