"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["60135"], {
...
"45166": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_redis_agent_settings_mdx_6b8_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-redis-agent-settings-mdx-6b8.json
var site_docs_redis_agent_settings_mdx_6b8_namespaceObject = JSON.parse('{"id":"redis/agent-settings","title":"설정하기","description":"Redis 데이터베이스 에이전트 서버에 있는 whatap.conf 파일을 통해 설정할 수 있는 옵션에 대해 알아봅니다.","source":"@site/docs/redis/agent-settings.mdx","sourceDirName":"redis","slug":"/redis/agent-settings","permalink":"/redis/agent-settings","draft":false,"unlisted":false,"editUrl":"undefined/docs/redis/agent-settings.mdx","tags":[],"version":"current","frontMatter":{"id":"agent-settings","title":"설정하기","description":"Redis 데이터베이스 에이전트 서버에 있는 whatap.conf 파일을 통해 설정할 수 있는 옵션에 대해 알아봅니다.","keywords":["Redis","데이터베이스","에이전트 설정"],"isTranslationMissing":false},"sidebar":"redisSidebar","previous":{"title":"설치 문제 해결","permalink":"/redis/troubleshooting"},"next":{"title":"DBX 에이전트 설정","permalink":"/redis/agent-dbx-settings"}}')
...
;// CONCATENATED MODULE: ./docs/redis/agent-settings.mdx
