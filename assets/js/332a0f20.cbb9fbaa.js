"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["79376"], {
...
"27043": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_python_collect_stacks_mdx_332_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-python-collect-stacks-mdx-332.json
var site_docs_python_collect_stacks_mdx_332_namespaceObject = JSON.parse('{"id":"python/collect-stacks","title":"트랜잭션 스텝 수집 방식","description":"트랜잭션 스텝 수집 방식을 안내합니다.","source":"@site/docs/python/collect-stacks.mdx","sourceDirName":"python","slug":"/python/collect-stacks","permalink":"/python/collect-stacks","draft":false,"unlisted":false,"editUrl":"undefined/docs/python/collect-stacks.mdx","tags":[],"version":"current","frontMatter":{"id":"collect-stacks","title":"트랜잭션 스텝 수집 방식","description":"트랜잭션 스텝 수집 방식을 안내합니다.","keywords":["Python","트랜잭션"],"isTranslationMissing":false},"sidebar":"pySidebar","previous":{"title":"트랜잭션 엔드포인트 설정","permalink":"/python/trs-endpoint-setting"},"next":{"title":"토폴로지","permalink":"/python/topology"}}')
...
;// CONCATENATED MODULE: ./docs/python/collect-stacks.mdx
