"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["8181"], {
...
"63331": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_golang_set_event_format_mdx_119_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-golang-set-event-format-mdx-119.json
var site_docs_golang_set_event_format_mdx_119_namespaceObject = JSON.parse('{"id":"golang/set-event-format","title":"이벤트 수신 포맷","description":"애플리케이션 모니터링에서 제공하는 경고 알림의 이벤트 수신 포맷에 대해 알아봅니다.","source":"@site/docs/golang/set-event-format.mdx","sourceDirName":"golang","slug":"/golang/set-event-format","permalink":"/golang/set-event-format","draft":false,"unlisted":false,"editUrl":"undefined/docs/golang/set-event-format.mdx","tags":[],"version":"current","frontMatter":{"id":"set-event-format","title":"이벤트 수신 포맷","description":"애플리케이션 모니터링에서 제공하는 경고 알림의 이벤트 수신 포맷에 대해 알아봅니다.","keywords":["Go","경고 알림","이벤트","애플리케이션","애플리케이션 모니터링","이벤트 수신 포맷"],"isTranslationMissing":false},"sidebar":"goSidebar","previous":{"title":"이벤트 기록","permalink":"/golang/set-event-history"},"next":{"title":"실시간 알림","permalink":"/golang/real-time-notification"}}')
...
;// CONCATENATED MODULE: ./docs/golang/set-event-format.mdx
