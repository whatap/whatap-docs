"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["40726"], {
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_dotnet_labs_mdx_7ab_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-dotnet-labs-mdx-7ab.json
var site_docs_dotnet_labs_mdx_7ab_namespaceObject = JSON.parse('{"id":"dotnet/labs","title":"실험실","description":"사용자에게 새로운 기능 또는 실험적인 기능을 제공하는 메뉴인 실험실에 대해 안내합니다.","source":"@site/docs/dotnet/labs.mdx","sourceDirName":"dotnet","slug":"/dotnet/labs","permalink":"/dotnet/labs","draft":false,"unlisted":false,"editUrl":"undefined/docs/dotnet/labs.mdx","tags":[],"version":"current","frontMatter":{"id":"labs","title":"실험실","description":"사용자에게 새로운 기능 또는 실험적인 기능을 제공하는 메뉴인 실험실에 대해 안내합니다.","keywords":[".NET","애플리케이션","실험실"],"isTranslationMissing":false},"sidebar":"dotNetSidebar","previous":{"title":"연계 프로젝트 관리","permalink":"/dotnet/linked-projects"}}')
...
;// CONCATENATED MODULE: ./docs/dotnet/labs.mdx
