"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["31825"], {
...
"99138": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_php_metric_warning_notice_new_mdx_f63_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-php-metric-warning-notice-new-mdx-f63.json
var site_docs_php_metric_warning_notice_new_mdx_f63_namespaceObject = JSON.parse('{"id":"php/metric-warning-notice-new","title":"메트릭스 경고 알림","description":"구체적이고 복잡한 이벤트를 설정하려면 메트릭스 이벤트 설정을 사용하세요.","source":"@site/docs/php/metric-warning-notice-new.mdx","sourceDirName":"php","slug":"/php/metric-warning-notice-new","permalink":"/php/metric-warning-notice-new","draft":false,"unlisted":false,"editUrl":"undefined/docs/php/metric-warning-notice-new.mdx","tags":[],"version":"current","frontMatter":{"id":"metric-warning-notice-new","title":"메트릭스 경고 알림","description":"구체적이고 복잡한 이벤트를 설정하려면 메트릭스 이벤트 설정을 사용하세요.","displayed_sidebar":"phpSidebar","keywords":["PHP","경고 알림","메트릭스 이벤트"],"isTranslationMissing":false},"sidebar":"phpSidebar"}')
...
;// CONCATENATED MODULE: ./docs/php/metric-warning-notice-new.mdx
