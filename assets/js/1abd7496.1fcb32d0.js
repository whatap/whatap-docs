"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[18559],{
...
const metadata = {
  "id": "mssql-v1/flexboard-widget-template",
  "title": "위젯 템플릿",
  "description": "Flex 보드에서 대시보드에 배치할 수 있는 위젯의 종류를 안내합니다.",
  "source": "@site/docs/mssql-v1/flexboard-widget-template.mdx",
  "sourceDirName": "mssql-v1",
  "slug": "/mssql-v1/flexboard-widget-template",
  "permalink": "/whatap-docs/mssql-v1/flexboard-widget-template",
  "draft": false,
  "unlisted": false,
  "editUrl": "undefined/docs/mssql-v1/flexboard-widget-template.mdx",
  "tags": [],
  "version": "current",
  "frontMatter": {
    "id": "flexboard-widget-template",
  ...
  "previous": {
    "title": "위젯 관리하기",
    "permalink": "/whatap-docs/mssql-v1/flexboard-widget-manage"
  },
  "next": {
    "title": "Flex 보드 화면 모드",
