"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["10172"], {
...
"45562": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_oracle_instance_list_mdx_62a_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-oracle-instance-list-mdx-62a.json
var site_docs_oracle_instance_list_mdx_62a_namespaceObject = JSON.parse('{"id":"oracle/instance-list","title":"인스턴스 목록","description":"에이전트를 설치한 데이터베이스 서버들의 목록을 확인할 수 있습니다.","source":"@site/docs/oracle/instance-list.mdx","sourceDirName":"oracle","slug":"/oracle/instance-list","permalink":"/oracle/instance-list","draft":false,"unlisted":false,"editUrl":"undefined/docs/oracle/instance-list.mdx","tags":[],"version":"current","frontMatter":{"id":"instance-list","title":"인스턴스 목록","description":"에이전트를 설치한 데이터베이스 서버들의 목록을 확인할 수 있습니다.","keywords":["Oracle","인스턴스","대시보드","데이터베이스"],"isTranslationMissing":false},"sidebar":"dboracleV2Sidebar","previous":{"title":"대시보드","permalink":"/oracle/dashboard-intro"},"next":{"title":"인스턴스 모니터링","permalink":"/oracle/instance-monitoring"}}')
...
;// CONCATENATED MODULE: ./docs/oracle/instance-list.mdx
