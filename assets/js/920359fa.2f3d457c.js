"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["39149"], {
"22086": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_amazon_ecs_metric_warning_notice_mdx_920_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-amazon-ecs-metric-warning-notice-mdx-920.json
var site_docs_amazon_ecs_metric_warning_notice_mdx_920_namespaceObject = JSON.parse('{"id":"amazon-ecs/metric-warning-notice","title":"메트릭스 경고 알림","description":"구체적이고 복잡한 이벤트를 설정하려면 메트릭스 이벤트 설정을 사용하세요.","source":"@site/docs/amazon-ecs/metric-warning-notice.mdx","sourceDirName":"amazon-ecs","slug":"/amazon-ecs/metric-warning-notice","permalink":"/amazon-ecs/metric-warning-notice","draft":false,"unlisted":false,"editUrl":"undefined/docs/amazon-ecs/metric-warning-notice.mdx","tags":[],"version":"current","frontMatter":{"id":"metric-warning-notice","title":"메트릭스 경고 알림","description":"구체적이고 복잡한 이벤트를 설정하려면 메트릭스 이벤트 설정을 사용하세요.","keywords":["경고 알림","메트릭스 이벤트","Amazon ECS"],"isTranslationMissing":false},"sidebar":"awsecsSidebar","previous":{"title":"알림 설정하기","permalink":"/amazon-ecs/set-notice"},"next":{"title":"이벤트 수신 설정","permalink":"/amazon-ecs/set-receive-event"}}')
...
;// CONCATENATED MODULE: ./docs/amazon-ecs/metric-warning-notice.mdx
...
const toc = [..._metrics_warning_notice/* toc */.d$, ..._composite_metrics_warning_notice/* toc */.d$, ..._metrics_event_modify_delete/* toc */.d$, ..._metrics_event_condition_select_target_guide/* toc */.d$];
