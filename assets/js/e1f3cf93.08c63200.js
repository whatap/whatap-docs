"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["5441"], {
...
"65929": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_mssql_v_1_set_receive_event_mdx_e1f_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-mssql-v-1-set-receive-event-mdx-e1f.json
var site_docs_mssql_v_1_set_receive_event_mdx_e1f_namespaceObject = JSON.parse('{"id":"mssql-v1/set-receive-event","title":"이벤트 수신 설정","description":"프로젝트에 포함하는 멤버들의 경고 알림 수신과 관련한 다양한 기능을 설정할 수 있습니다.","source":"@site/docs/mssql-v1/set-receive-event.mdx","sourceDirName":"mssql-v1","slug":"/mssql-v1/set-receive-event","permalink":"/mssql-v1/set-receive-event","draft":false,"unlisted":false,"editUrl":"undefined/docs/mssql-v1/set-receive-event.mdx","tags":[],"version":"current","frontMatter":{"id":"set-receive-event","title":"이벤트 수신 설정","description":"프로젝트에 포함하는 멤버들의 경고 알림 수신과 관련한 다양한 기능을 설정할 수 있습니다.","keywords":["SQL Server","경고 알림","이벤트 수신 태그","데이터베이스 모니터링"],"isTranslationMissing":false},"sidebar":"mssqlV1Sidebar","previous":{"title":"이상치 탐지 경고 알림","permalink":"/mssql-v1/set-event-detect-anomal"},"next":{"title":"이벤트 기록","permalink":"/mssql-v1/set-event-history"}}')
...
;// CONCATENATED MODULE: ./docs/mssql-v1/set-receive-event.mdx
