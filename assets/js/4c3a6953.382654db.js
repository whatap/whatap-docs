"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["71043"], {
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_oracle_common_alert_mdx_4c3_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-oracle-common-alert-mdx-4c3.json
var site_docs_oracle_common_alert_mdx_4c3_namespaceObject = JSON.parse('{"id":"oracle/common-alert","title":"시스템 이벤트 안내","description":"와탭 모니터링에서는 플랫폼 전반에서 자동으로 탐지 및 생성되는 공용 이벤트에 대해 안내합니다.","source":"@site/docs/oracle/common-alert.mdx","sourceDirName":"oracle","slug":"/oracle/common-alert","permalink":"/oracle/common-alert","draft":false,"unlisted":false,"editUrl":"undefined/docs/oracle/common-alert.mdx","tags":[],"version":"current","frontMatter":{"id":"common-alert","title":"시스템 이벤트 안내","description":"와탭 모니터링에서는 플랫폼 전반에서 자동으로 탐지 및 생성되는 공용 이벤트에 대해 안내합니다.","keywords":["와탭","경고 알림","시스템 이벤트"],"isTranslationMissing":false},"sidebar":"dboracleV2Sidebar","previous":{"title":"실시간 알림","permalink":"/oracle/real-time-notification"},"next":{"title":"연계 프로젝트 관리","permalink":"/oracle/linked-projects"}}')
...
;// CONCATENATED MODULE: ./docs/oracle/common-alert.mdx
