"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[90501],{
...
/* harmony import */ var _common_items_analysis_msa_mdx__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(58718);
...
const metadata = {
  "id": "python/analysis-msa",
  "title": "MSA 분석",
  "description": "MSA 분석 기능은 와탭의 MTRACE(멀티 서버간 추적)기능을 통해서 수집된 트랜잭션들 사이의 호출 비중이 어떠한지를 분석합니다.",
  "source": "@site/docs/python/analysis-msa.mdx",
  "sourceDirName": "python",
  "slug": "/python/analysis-msa",
  "permalink": "/whatap-docs/python/analysis-msa",
  "draft": false,
  "unlisted": false,
  "editUrl": "undefined/docs/python/analysis-msa.mdx",
  "tags": [
    {
      "label": "Python",
