"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["82334"], {
...
"18982": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_tibero_sga_size_mdx_1b3_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-tibero-sga-size-mdx-1b3.json
var site_docs_tibero_sga_size_mdx_1b3_namespaceObject = JSON.parse('{"id":"tibero/sga-size","title":"SGA 사이즈","description":"Tibero 서버 메모리 영역인 SGA 요약 정보를 매 시간 저장하여 시간별 변화량을 모니터링할 수 있습니다.","source":"@site/docs/tibero/sga-size.mdx","sourceDirName":"tibero","slug":"/tibero/sga-size","permalink":"/tibero/sga-size","draft":false,"unlisted":false,"editUrl":"undefined/docs/tibero/sga-size.mdx","tags":[],"version":"current","frontMatter":{"id":"sga-size","title":"SGA 사이즈","description":"Tibero 서버 메모리 영역인 SGA 요약 정보를 매 시간 저장하여 시간별 변화량을 모니터링할 수 있습니다.","keywords":["Tibero","데이터베이스","통계"],"isTranslationMissing":false},"sidebar":"tiberoSidebar","previous":{"title":"테이블스페이스 사이즈","permalink":"/tibero/table-space-size"},"next":{"title":"보고서","permalink":"/tibero/report-intro"}}')
