"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[59987],{
...
const metadata = {
  ...
  "title": "대시보드",
  "description": "와탭 모니터링 대시보드는 프로젝트의 전체 현황을 한 눈에 파악하기 위한 기능을 제공합니다.",
  "source": "@site/docs/cubrid-v1/dashboard-intro.mdx",
  "sourceDirName": "cubrid-v1",
  "slug": "/cubrid-v1/dashboard-intro",
  "permalink": "/whatap-docs/cubrid-v1/dashboard-intro",
  "draft": false,
  "unlisted": false,
  "editUrl": "undefined/docs/cubrid-v1/dashboard-intro.mdx",
  "tags": [],
  "version": "current",
  "frontMatter": {
    "id": "dashboard-intro",
