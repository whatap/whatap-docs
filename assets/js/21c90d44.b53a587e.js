"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["8820"], {
...
"70982": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_php_dashboard_mdx_21c_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-php-dashboard-mdx-21c.json
var site_docs_php_dashboard_mdx_21c_namespaceObject = JSON.parse('{"id":"php/dashboard","title":"애플리케이션 대시보드","description":"웹 애플리케이션 서버의 리소스를 실시간으로 모니터링할 수 있습니다.","source":"@site/docs/php/dashboard.mdx","sourceDirName":"php","slug":"/php/dashboard","permalink":"/php/dashboard","draft":false,"unlisted":false,"editUrl":"undefined/docs/php/dashboard.mdx","tags":[],"version":"current","frontMatter":{"id":"dashboard","title":"애플리케이션 대시보드","description":"웹 애플리케이션 서버의 리소스를 실시간으로 모니터링할 수 있습니다.","keywords":["PHP","대시보드","애플리케이션","애플리케이션 모니터링"],"isTranslationMissing":false},"sidebar":"phpSidebar","previous":{"title":"대시보드","permalink":"/php/dashboard-intro"},"next":{"title":"트랜잭션 맵","permalink":"/php/dashboard-transactionmap"}}')
...
;// CONCATENATED MODULE: ./docs/php/dashboard.mdx
