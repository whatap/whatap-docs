"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["6074"], {
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_oracle_cloudsettings_mdx_872_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-oracle-cloudsettings-mdx-872.json
var site_docs_oracle_cloudsettings_mdx_872_namespaceObject = JSON.parse('{"id":"oracle/cloudsettings","title":"클라우드 설정","description":"클라우드 데이터베이스 서버의 자원 현황을 수집하고 모니터링할 수 있습니다.","source":"@site/docs/oracle/cloudsettings.mdx","sourceDirName":"oracle","slug":"/oracle/cloudsettings","permalink":"/oracle/cloudsettings","draft":false,"unlisted":false,"editUrl":"undefined/docs/oracle/cloudsettings.mdx","tags":[],"version":"current","frontMatter":{"id":"cloudsettings","title":"클라우드 설정","description":"클라우드 데이터베이스 서버의 자원 현황을 수집하고 모니터링할 수 있습니다.","keywords":["Oracle","데이터베이스","클라우드"],"isTranslationMissing":false},"sidebar":"dboracleV2Sidebar","previous":{"title":"XOS 에이전트 설정","permalink":"/oracle/agent-xos-settings"},"next":{"title":"관리하기","permalink":"/oracle/agent-manage"}}')
...
;// CONCATENATED MODULE: ./docs/oracle/cloudsettings.mdx
