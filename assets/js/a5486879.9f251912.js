"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["39785"], {
...
"8868": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_redis_log_parser_mdx_a54_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-redis-log-parser-mdx-a54.json
var site_docs_redis_log_parser_mdx_a54_namespaceObject = JSON.parse('{"id":"redis/log-parser","title":"로그 파싱하기","description":"와탭이 제공하는 로그 파서에 대해 안내합니다.","source":"@site/docs/redis/log-parser.mdx","sourceDirName":"redis","slug":"/redis/log-parser","permalink":"/redis/log-parser","draft":false,"unlisted":false,"editUrl":"undefined/docs/redis/log-parser.mdx","tags":[],"version":"current","frontMatter":{"id":"log-parser","title":"로그 파싱하기","description":"와탭이 제공하는 로그 파서에 대해 안내합니다.","toc_max_heading_level":3,"keywords":["로그","로그 모니터링","설정하기","로그 파서","로그 파싱","Redis"],"isTranslationMissing":false},"sidebar":"redisSidebar","previous":{"title":"로그 설정","permalink":"/redis/log-setting"},"next":{"title":"알림 설정하기","permalink":"/redis/set-notice"}}')
...
;// CONCATENATED MODULE: ./docs/redis/log-parser.mdx
