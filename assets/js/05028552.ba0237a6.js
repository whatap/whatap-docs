"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["76916"], {
...
"76011": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_php_trs_multi_trace_mdx_050_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-php-trs-multi-trace-mdx-050.json
var site_docs_php_trs_multi_trace_mdx_050_namespaceObject = JSON.parse('{"id":"php/trs-multi-trace","title":"멀티 트랜잭션","description":"멀티 트랜잭션 추적을 안내합니다.","source":"@site/docs/php/trs-multi-trace.mdx","sourceDirName":"php","slug":"/php/trs-multi-trace","permalink":"/php/trs-multi-trace","draft":false,"unlisted":false,"editUrl":"undefined/docs/php/trs-multi-trace.mdx","tags":[],"version":"current","frontMatter":{"id":"trs-multi-trace","title":"멀티 트랜잭션","description":"멀티 트랜잭션 추적을 안내합니다.","keywords":["PHP","트랜잭션","멀티 트랜잭션","UI","애플리케이션","애플리케이션 모니터링"],"isTranslationMissing":false},"sidebar":"phpSidebar","previous":{"title":"트랜잭션 트레이싱","permalink":"/php/trs-profile"},"next":{"title":"트랜잭션 스텝 수집 방식","permalink":"/php/collect-stacks"}}')
...
;// CONCATENATED MODULE: ./docs/php/trs-multi-trace.mdx
