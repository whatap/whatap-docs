"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["18183"], {
...
"83667": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_java_flexboard_metric_widget_mdx_768_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-java-flexboard-metric-widget-mdx-768.json
var site_docs_java_flexboard_metric_widget_mdx_768_namespaceObject = JSON.parse('{"id":"java/flexboard-metric-widget","title":"메트릭스 위젯","description":"프로젝트의 성능 지표를 나타내는 메트릭스 데이터를 위젯 형태로 대시보드에 추가하는 방법을 안내합니다. 메트릭스는 카테고리로 분류되고, 태그를 이용해 데이터를 탐색할 수 있으며, 테이블 위젯과 시리즈 위젯 두 가지 유형으로 제공합니다.","source":"@site/docs/java/flexboard-metric-widget.mdx","sourceDirName":"java","slug":"/java/flexboard-metric-widget","permalink":"/java/flexboard-metric-widget","draft":false,"unlisted":false,"editUrl":"undefined/docs/java/flexboard-metric-widget.mdx","tags":[],"version":"current","frontMatter":{"id":"flexboard-metric-widget","title":"메트릭스 위젯","description":"프로젝트의 성능 지표를 나타내는 메트릭스 데이터를 위젯 형태로 대시보드에 추가하는 방법을 안내합니다. 메트릭스는 카테고리로 분류되고, 태그를 이용해 데이터를 탐색할 수 있으며, 테이블 위젯과 시리즈 위젯 두 가지 유형으로 제공합니다.","keywords":["Java","Flex 보드","메트릭스","위젯"],"isTranslationMissing":false},"sidebar":"javaSidebar","previous":{"title":"Flex 보드 관리하기","permalink":"/java/flexboard-manage"},"next":{"title":"위젯 관리하기","permalink":"/java/flexboard-widget-manage"}}')
...
;// CONCATENATED MODULE: ./docs/java/flexboard-metric-widget.mdx
