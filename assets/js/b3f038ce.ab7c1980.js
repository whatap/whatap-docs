"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["11092"], {
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_cubrid_flexboard_share_mdx_b3f_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-cubrid-flexboard-share-mdx-b3f.json
var site_docs_cubrid_flexboard_share_mdx_b3f_namespaceObject = JSON.parse('{"id":"cubrid/flexboard-share","title":"Flex 보드 공유하기","description":"Flex 보드를 다른 계정의 사용자와 공유하고 재사용할 수 있습니다.","source":"@site/docs/cubrid/flexboard-share.mdx","sourceDirName":"cubrid","slug":"/cubrid/flexboard-share","permalink":"/cubrid/flexboard-share","draft":false,"unlisted":false,"editUrl":"undefined/docs/cubrid/flexboard-share.mdx","tags":[],"version":"current","frontMatter":{"id":"flexboard-share","title":"Flex 보드 공유하기","description":"Flex 보드를 다른 계정의 사용자와 공유하고 재사용할 수 있습니다.","keywords":["CUBRID","Flex 보드"],"isTranslationMissing":false},"sidebar":"cubridSidebar","previous":{"title":"Flex 보드 화면 모드","permalink":"/cubrid/flexboard-mode"},"next":{"title":"카운트 추이 비교","permalink":"/cubrid/analysis-count-trend"}}')
...
;// CONCATENATED MODULE: ./docs/cubrid/flexboard-share.mdx
