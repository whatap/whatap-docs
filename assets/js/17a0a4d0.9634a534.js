"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["14285"], {
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_nodejs_dashboard_intro_mdx_17a_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-nodejs-dashboard-intro-mdx-17a.json
var site_docs_nodejs_dashboard_intro_mdx_17a_namespaceObject = JSON.parse('{"id":"nodejs/dashboard-intro","title":"대시보드","description":"와탭 모니터링 대시보드는 프로젝트의 전체 현황을 한 눈에 파악하기 위한 기능을 제공합니다.","source":"@site/docs/nodejs/dashboard-intro.mdx","sourceDirName":"nodejs","slug":"/nodejs/dashboard-intro","permalink":"/nodejs/dashboard-intro","draft":false,"unlisted":false,"editUrl":"undefined/docs/nodejs/dashboard-intro.mdx","tags":[],"version":"current","frontMatter":{"id":"dashboard-intro","title":"대시보드","description":"와탭 모니터링 대시보드는 프로젝트의 전체 현황을 한 눈에 파악하기 위한 기능을 제공합니다.","keywords":["대시보드","Node.js","애플리케이션","애플리케이션 모니터링"],"isTranslationMissing":false},"sidebar":"nodejsSidebar","previous":{"title":"관리하기","permalink":"/nodejs/agent-manage"},"next":{"title":"애플리케이션 대시보드","permalink":"/nodejs/dashboard"}}')
...
;// CONCATENATED MODULE: ./docs/nodejs/dashboard-intro.mdx
