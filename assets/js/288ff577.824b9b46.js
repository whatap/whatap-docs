...
const metadata = {
  "id": "cubrid-v1/warning-notice",
  "title": "데이터베이스 경고 알림",
  "description": "데이터베이스의 지표별 이벤트 조건 설정을 통해 경고 알림을 보냅니다.",
  "source": "@site/docs/cubrid-v1/warning-notice.mdx",
  "sourceDirName": "cubrid-v1",
  "slug": "/cubrid-v1/warning-notice",
  "permalink": "/whatap-docs/cubrid-v1/warning-notice",
  "draft": false,
  "unlisted": false,
  "editUrl": "undefined/docs/cubrid-v1/warning-notice.mdx",
  "tags": [],
  "version": "current",
  "frontMatter": {
    "id": "warning-notice",
