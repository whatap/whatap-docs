"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["76458"], {
"89149": (function (__unused_webpack_module, __unused_webpack___webpack_exports__, __webpack_require__) {
...
"8243": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_cubrid_v_1_metrics_intro_mdx_9f4_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-cubrid-v-1-metrics-intro-mdx-9f4.json
var site_docs_cubrid_v_1_metrics_intro_mdx_9f4_namespaceObject = JSON.parse('{"id":"cubrid-v1/metrics-intro","title":"메트릭스","description":"데이터베이스 모니터링 분석을 위한 메트릭스 메뉴에 대해 알아봅니다.","source":"@site/docs/cubrid-v1/metrics-intro.mdx","sourceDirName":"cubrid-v1","slug":"/cubrid-v1/metrics-intro","permalink":"/cubrid-v1/metrics-intro","draft":false,"unlisted":false,"editUrl":"undefined/docs/cubrid-v1/metrics-intro.mdx","tags":[],"version":"current","frontMatter":{"id":"metrics-intro","title":"메트릭스","description":"데이터베이스 모니터링 분석을 위한 메트릭스 메뉴에 대해 알아봅니다.","keywords":["CUBRID","메트릭스","데이터베이스","데이터베이스 모니터링"],"isTranslationMissing":false},"sidebar":"cubridV1Sidebar","previous":{"title":"락 트리","permalink":"/cubrid-v1/analysis-lock-and-deadlock"},"next":{"title":"CUBRID 지표","permalink":"/cubrid-v1/metrics-data-list"}}')
...
// EXTERNAL MODULE: ./docs/common-items/_import_metrics-chart-example-desc.mdx
var _import_metrics_chart_example_desc = __webpack_require__("89149");
...
;// CONCATENATED MODULE: ./docs/cubrid-v1/metrics-intro.mdx
