"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[58746],{
...
const metadata = {
  "id": "oracle-v2/set-receive-event",
  "title": "경고 알림 수신 설정",
  "description": "프로젝트에 포함하는 멤버들의 경고 알림 수신과 관련한 다양한 기능을 설정할 수 있습니다.",
  "source": "@site/docs/oracle-v2/set-receive-event.mdx",
  "sourceDirName": "oracle-v2",
  "slug": "/oracle-v2/set-receive-event",
  "permalink": "/whatap-docs/oracle-v2/set-receive-event",
  "draft": false,
  "unlisted": false,
  "editUrl": "undefined/docs/oracle-v2/set-receive-event.mdx",
  "tags": [
    {
      "inline": true,
      "label": "Oracle",
  ...
  "next": {
    "title": "이벤트 기록",
    "permalink": "/whatap-docs/oracle-v2/set-event-history"
  }
};
const assets = {
