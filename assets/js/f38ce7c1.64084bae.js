"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["89119"], {
...
"27170": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_mssql_metrics_intro_mdx_f38_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-mssql-metrics-intro-mdx-f38.json
var site_docs_mssql_metrics_intro_mdx_f38_namespaceObject = JSON.parse('{"id":"mssql/metrics-intro","title":"메트릭스","description":"데이터베이스 모니터링 분석을 위한 메트릭스 메뉴에 대해 알아봅니다.","source":"@site/docs/mssql/metrics-intro.mdx","sourceDirName":"mssql","slug":"/mssql/metrics-intro","permalink":"/mssql/metrics-intro","draft":false,"unlisted":false,"editUrl":"undefined/docs/mssql/metrics-intro.mdx","tags":[],"version":"current","frontMatter":{"id":"metrics-intro","title":"메트릭스","description":"데이터베이스 모니터링 분석을 위한 메트릭스 메뉴에 대해 알아봅니다.","keywords":["SQL Server","메트릭스","데이터베이스","데이터베이스 모니터링"],"isTranslationMissing":false},"sidebar":"mssqlSidebar","previous":{"title":"데이터베이스 파라미터","permalink":"/mssql/analysis-databaseparameter"},"next":{"title":"SQL Server 지표","permalink":"/mssql/metrics-data-list"}}')
...
;// CONCATENATED MODULE: ./docs/mssql/metrics-intro.mdx
