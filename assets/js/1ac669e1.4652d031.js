"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["56070"], {
...
"74915": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_oracle_pro_after_install_agent_mdx_1ac_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-oracle-pro-after-install-agent-mdx-1ac.json
var site_docs_oracle_pro_after_install_agent_mdx_1ac_namespaceObject = JSON.parse('{"id":"oracle-pro/after-install-agent","title":"설치 점검 사항","description":"데이터베이스 모니터링 설치를 모두 완료했습니다. 설치 후 확인 사항을 점검하세요.","source":"@site/docs/oracle-pro/after-install-agent.mdx","sourceDirName":"oracle-pro","slug":"/oracle-pro/after-install-agent","permalink":"/oracle-pro/after-install-agent","draft":false,"unlisted":false,"editUrl":"undefined/docs/oracle-pro/after-install-agent.mdx","tags":[],"version":"current","frontMatter":{"id":"after-install-agent","title":"설치 점검 사항","description":"데이터베이스 모니터링 설치를 모두 완료했습니다. 설치 후 확인 사항을 점검하세요.","keywords":["Oracle Pro","데이터베이스","에이전트"],"isTranslationMissing":false},"sidebar":"dboracledmaSidebar","previous":{"title":"에이전트 설치","permalink":"/oracle-pro/install-agent"},"next":{"title":"설치 문제 해결","permalink":"/oracle-pro/troubleshooting"}}')
...
;// CONCATENATED MODULE: ./docs/oracle-pro/after-install-agent.mdx
...
const toc = [..._db_check_agent_log/* toc */.d$, ..._db_check_db_logs/* toc */.d$, {
  "value": "에이전트 프로세스 확인하기",
  "id": "에이전트-프로세스-확인하기",
  "level": 2
}, ..._db_check_monitoring_agent_lists/* toc */.d$];
function _createMdxContent(props) {
  const _components = {
    admonition: "admonition",
    code: "code",
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsx)(_components.p, {
      ...
      children: (0,jsx_runtime.jsxs)(_components.p, {
        children: ["DMX 에이전트를 실행하면 ", (0,jsx_runtime.jsx)(_components.strong, {
          children: "dmx"
      ...
      children: [(0,jsx_runtime.jsx)(_components.h2, {
        ...
        children: "다음 명령어를 통해 동작 중인 와탭 DMX 에이전트 프로세스와 prx 프로세스를 확인할 수 있습니다."
      }), (0,jsx_runtime.jsx)(_components.pre, {
        children: (0,jsx_runtime.jsx)(_components.code, {
          className: "language-bash",
          children: "$ ps -ef|grep dmx\n\n$ ps -ef|grep prx\n"
        })
