"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["76198"], {
...
"30930": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_java_trs_endpoint_setting_mdx_fca_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-java-trs-endpoint-setting-mdx-fca.json
var site_docs_java_trs_endpoint_setting_mdx_fca_namespaceObject = JSON.parse('{"id":"java/trs-endpoint-setting","title":"트랜잭션 엔드포인트 설정","description":"트랜잭션 엔드포인트 설정을 안내합니다.","source":"@site/docs/java/trs-endpoint-setting.mdx","sourceDirName":"java","slug":"/java/trs-endpoint-setting","permalink":"/java/trs-endpoint-setting","draft":false,"unlisted":false,"editUrl":"undefined/docs/java/trs-endpoint-setting.mdx","tags":[],"version":"current","frontMatter":{"id":"trs-endpoint-setting","title":"트랜잭션 엔드포인트 설정","description":"트랜잭션 엔드포인트 설정을 안내합니다.","keywords":["Java","트랜잭션"],"isTranslationMissing":false},"sidebar":"javaSidebar","previous":{"title":"멀티 트랜잭션","permalink":"/java/trs-multi-trace"},"next":{"title":"트랜잭션 스텝 수집 방식","permalink":"/java/collect-stacks"}}')
...
const trs_endpoint_setting_toc = [..._edp_def/* toc */.d$, {
  "value": "NON HTTP 추적",
  "id": "non-http-추적",
  "level": 2
