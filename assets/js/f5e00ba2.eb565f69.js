"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["32285"], {
...
"81725": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_oracle_v_1_flexboard_widget_template_mdx_f5e_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-oracle-v-1-flexboard-widget-template-mdx-f5e.json
var site_docs_oracle_v_1_flexboard_widget_template_mdx_f5e_namespaceObject = JSON.parse('{"id":"oracle-v1/flexboard-widget-template","title":"위젯 템플릿","description":"Flex 보드에서 대시보드에 배치할 수 있는 위젯의 종류를 안내합니다.","source":"@site/docs/oracle-v1/flexboard-widget-template.mdx","sourceDirName":"oracle-v1","slug":"/oracle-v1/flexboard-widget-template","permalink":"/oracle-v1/flexboard-widget-template","draft":false,"unlisted":false,"editUrl":"undefined/docs/oracle-v1/flexboard-widget-template.mdx","tags":[],"version":"current","frontMatter":{"id":"flexboard-widget-template","title":"위젯 템플릿","description":"Flex 보드에서 대시보드에 배치할 수 있는 위젯의 종류를 안내합니다.","keywords":["Flex 보드","위젯","템플릿"],"isTranslationMissing":false},"sidebar":"dboracleSidebar","previous":{"title":"위젯 관리하기","permalink":"/oracle-v1/flexboard-widget-manage"},"next":{"title":"Flex 보드 화면 모드","permalink":"/oracle-v1/flexboard-mode"}}')
...
;// CONCATENATED MODULE: ./docs/oracle-v1/flexboard-widget-template.mdx
