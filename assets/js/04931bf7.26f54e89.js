"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["66765"], {
...
"34811": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_php_set_event_detect_anomal_mdx_049_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-php-set-event-detect-anomal-mdx-049.json
var site_docs_php_set_event_detect_anomal_mdx_049_namespaceObject = JSON.parse('{"id":"php/set-event-detect-anomal","title":"이상치 탐지 경고 알림","description":"예상치 못한 패턴을 찾는 일련의 활동을 탐지해 경고 알림을 보내도록 설정할 수 있습니다.","source":"@site/docs/php/set-event-detect-anomal.mdx","sourceDirName":"php","slug":"/php/set-event-detect-anomal","permalink":"/php/set-event-detect-anomal","draft":false,"unlisted":false,"editUrl":"undefined/docs/php/set-event-detect-anomal.mdx","tags":[],"version":"current","frontMatter":{"id":"set-event-detect-anomal","title":"이상치 탐지 경고 알림","description":"예상치 못한 패턴을 찾는 일련의 활동을 탐지해 경고 알림을 보내도록 설정할 수 있습니다.","keywords":["PHP","경고 알림","이상치 탐지","애플리케이션 모니터링"],"isTranslationMissing":false},"sidebar":"phpSidebar","previous":{"title":"AI 기반의 히트맵 패턴 경고 알림","permalink":"/php/hitmap-notice"},"next":{"title":"로그 경고 알림","permalink":"/php/set-event-log"}}')
...
;// CONCATENATED MODULE: ./docs/php/set-event-detect-anomal.mdx
