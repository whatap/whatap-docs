"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["21876"], {
...
"45282": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_oracle_metric_warning_notice_mdx_912_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-oracle-metric-warning-notice-mdx-912.json
var site_docs_oracle_metric_warning_notice_mdx_912_namespaceObject = JSON.parse('{"id":"oracle/metric-warning-notice","title":"메트릭스 경고 알림","description":"구체적이고 복잡한 이벤트를 설정하려면 메트릭스 이벤트 설정을 사용하세요.","source":"@site/docs/oracle/metric-warning-notice.mdx","sourceDirName":"oracle","slug":"/oracle/metric-warning-notice","permalink":"/oracle/metric-warning-notice","draft":false,"unlisted":false,"editUrl":"undefined/docs/oracle/metric-warning-notice.mdx","tags":[],"version":"current","frontMatter":{"id":"metric-warning-notice","title":"메트릭스 경고 알림","description":"구체적이고 복잡한 이벤트를 설정하려면 메트릭스 이벤트 설정을 사용하세요.","keywords":["Oracle","경고 알림","메트릭스 이벤트","데이터베이스"],"isTranslationMissing":false},"sidebar":"dboracleV2Sidebar","previous":{"title":"이벤트 설정","permalink":"/oracle/warning-notice-v2"},"next":{"title":"알림 메시지 사용자 정의","permalink":"/oracle/set-notification-message"}}')
...
;// CONCATENATED MODULE: ./docs/oracle/metric-warning-notice.mdx
