"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["99358"], {
"99710": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_server_set_agent_mdx_204_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-server-set-agent-mdx-204.json
var site_docs_server_set_agent_mdx_204_namespaceObject = JSON.parse('{"id":"server/set-agent","title":"설정하기","description":"서버 에이전트 옵션에 대해 알아봅니다.","source":"@site/docs/server/set-agent.mdx","sourceDirName":"server","slug":"/server/set-agent","permalink":"/server/set-agent","draft":false,"unlisted":false,"editUrl":"undefined/docs/server/set-agent.mdx","tags":[],"version":"current","frontMatter":{"id":"set-agent","title":"설정하기","description":"서버 에이전트 옵션에 대해 알아봅니다.","keywords":["Server","설정하기"],"isTranslationMissing":false},"sidebar":"serverSidebar","previous":{"title":"설치 점검 사항","permalink":"/server/install-check"},"next":{"title":"에이전트 이름 식별","permalink":"/server/agent-name"}}')
...
;// CONCATENATED MODULE: ./docs/server/set-agent.mdx
