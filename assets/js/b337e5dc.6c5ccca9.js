"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["84347"], {
"25136": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_dotnet_agent_static_mdx_b33_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-dotnet-agent-static-mdx-b33.json
var site_docs_dotnet_agent_static_mdx_b33_namespaceObject = JSON.parse('{"id":"dotnet/agent-static","title":"통계","description":"에이전트가 수집한 데이터의 통계 수집 기능과 관련한 옵션입니다.","source":"@site/docs/dotnet/agent-static.mdx","sourceDirName":"dotnet","slug":"/dotnet/agent-static","permalink":"/dotnet/agent-static","draft":false,"unlisted":false,"editUrl":"undefined/docs/dotnet/agent-static.mdx","tags":[],"version":"current","frontMatter":{"id":"agent-static","title":"통계","description":"에이전트가 수집한 데이터의 통계 수집 기능과 관련한 옵션입니다.","keywords":[".NET","통계"],"isTranslationMissing":false},"sidebar":"dotNetSidebar","previous":{"title":"사용자 수","permalink":"/dotnet/agent-number-of-user"},"next":{"title":"토폴로지 맵","permalink":"/dotnet/agent-topology"}}')
