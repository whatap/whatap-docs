"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["14809"], {
"61334": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_aws_log_set_receive_event_mdx_c33_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-aws-log-set-receive-event-mdx-c33.json
var site_docs_aws_log_set_receive_event_mdx_c33_namespaceObject = JSON.parse('{"id":"aws-log/set-receive-event","title":"이벤트 수신 설정","description":"프로젝트에 포함하는 멤버들의 경고 알림 수신과 관련한 다양한 기능을 설정할 수 있습니다.","source":"@site/docs/aws-log/set-receive-event.mdx","sourceDirName":"aws-log","slug":"/aws-log/set-receive-event","permalink":"/aws-log/set-receive-event","draft":false,"unlisted":false,"editUrl":"undefined/docs/aws-log/set-receive-event.mdx","tags":[],"version":"current","frontMatter":{"id":"set-receive-event","title":"이벤트 수신 설정","description":"프로젝트에 포함하는 멤버들의 경고 알림 수신과 관련한 다양한 기능을 설정할 수 있습니다.","keywords":["AWS Log","경고 알림","이벤트 수신 태그"],"isTranslationMissing":false},"sidebar":"awslogSidebar","previous":{"title":"알림 설정하기","permalink":"/aws-log/set-notice"},"next":{"title":"이벤트 기록","permalink":"/aws-log/set-event-history"}}')
...
;// CONCATENATED MODULE: ./docs/aws-log/set-receive-event.mdx
