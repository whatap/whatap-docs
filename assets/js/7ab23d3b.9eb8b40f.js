"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["24957"], {
...
"77309": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_tibero_analysis_lock_and_deadlock_mdx_7ab_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-tibero-analysis-lock-and-deadlock-mdx-7ab.json
var site_docs_tibero_analysis_lock_and_deadlock_mdx_7ab_namespaceObject = JSON.parse('{"id":"tibero/analysis-lock-and-deadlock","title":"락 트리","description":"하루 동안 발생한 Lock 추이를 분석하고 교착 상태의 쿼리를 확인할 수 있습니다.","source":"@site/docs/tibero/analysis-lock-and-deadlock.mdx","sourceDirName":"tibero","slug":"/tibero/analysis-lock-and-deadlock","permalink":"/tibero/analysis-lock-and-deadlock","draft":false,"unlisted":false,"editUrl":"undefined/docs/tibero/analysis-lock-and-deadlock.mdx","tags":[],"version":"current","frontMatter":{"id":"analysis-lock-and-deadlock","title":"락 트리","description":"하루 동안 발생한 Lock 추이를 분석하고 교착 상태의 쿼리를 확인할 수 있습니다.","keywords":["Tibero","데이터베이스","Lock","락 트리"],"isTranslationMissing":false},"sidebar":"tiberoSidebar","previous":{"title":"카운트 추이 및 비교","permalink":"/tibero/analysis-count-trend"},"next":{"title":"병렬 쿼리 트리","permalink":"/tibero/analysis-pq-tree"}}')
...
;// CONCATENATED MODULE: ./docs/tibero/analysis-lock-and-deadlock.mdx
...
const toc = [..._db_locktree_desc/* toc */.d$, ..._db_locktree_using_basic/* toc */.d$, ..._db_tibero_column/* toc */.d$];
function _createMdxContent(props) {
