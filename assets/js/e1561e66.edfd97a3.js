"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["61658"], {
...
"20929": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_kubernetes_metrics_chart_v_2_mdx_e15_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-kubernetes-metrics-chart-v-2-mdx-e15.json
var site_docs_kubernetes_metrics_chart_v_2_mdx_e15_namespaceObject = JSON.parse('{"id":"kubernetes/metrics-chart-v2","title":"메트릭스 차트","description":"메트릭스 데이터를 차트로 조회할 수 있습니다.","source":"@site/docs/kubernetes/metrics-chart-v2.mdx","sourceDirName":"kubernetes","slug":"/kubernetes/metrics-chart-v2","permalink":"/kubernetes/metrics-chart-v2","draft":false,"unlisted":false,"editUrl":"undefined/docs/kubernetes/metrics-chart-v2.mdx","tags":[],"version":"current","frontMatter":{"id":"metrics-chart-v2","title":"메트릭스 차트","description":"메트릭스 데이터를 차트로 조회할 수 있습니다.","keywords":["Kubernetes","메트릭스","메트릭스 차트"],"isTranslationMissing":false},"sidebar":"kubeSidebar","previous":{"title":"메트릭스 조회","permalink":"/kubernetes/metrics-search"},"next":{"title":"메트릭스 차트","permalink":"/kubernetes/metrics-chart"}}')
...
;// CONCATENATED MODULE: ./docs/kubernetes/metrics-chart-v2.mdx
