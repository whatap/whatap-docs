"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["61560"], {
...
"45075": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_nodejs_metric_warning_notice_mdx_d6c_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-nodejs-metric-warning-notice-mdx-d6c.json
var site_docs_nodejs_metric_warning_notice_mdx_d6c_namespaceObject = JSON.parse('{"id":"nodejs/metric-warning-notice","title":"메트릭스 경고 알림","description":"구체적이고 복잡한 이벤트를 설정하려면 메트릭스 이벤트 설정을 사용하세요.","source":"@site/docs/nodejs/metric-warning-notice.mdx","sourceDirName":"nodejs","slug":"/nodejs/metric-warning-notice","permalink":"/nodejs/metric-warning-notice","draft":false,"unlisted":false,"editUrl":"undefined/docs/nodejs/metric-warning-notice.mdx","tags":[],"version":"current","frontMatter":{"id":"metric-warning-notice","title":"메트릭스 경고 알림","description":"구체적이고 복잡한 이벤트를 설정하려면 메트릭스 이벤트 설정을 사용하세요.","keywords":["Node.js","경고 알림","메트릭스 이벤트","애플리케이션 모니터링"],"isTranslationMissing":false},"sidebar":"nodejsSidebar","previous":{"title":"이벤트 설정","permalink":"/nodejs/warning-notice-v2"},"next":{"title":"알림 메시지 사용자 정의","permalink":"/nodejs/set-notification-message"}}')
...
;// CONCATENATED MODULE: ./docs/nodejs/metric-warning-notice.mdx
...
const toc = [..._metrics_warning_notice/* toc */.d$, ..._composite_metrics_warning_notice/* toc */.d$, ..._metrics_event_modify_delete/* toc */.d$, ..._metrics_event_condition_select_target_guide/* toc */.d$, ..._metrics_warning_notice_apm/* toc */.d$];
function _createMdxContent(props) {
