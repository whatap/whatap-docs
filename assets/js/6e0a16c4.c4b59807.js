"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["37100"], {
...
"14389": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_oracle_metrics_intro_mdx_6e0_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-oracle-metrics-intro-mdx-6e0.json
var site_docs_oracle_metrics_intro_mdx_6e0_namespaceObject = JSON.parse('{"id":"oracle/metrics-intro","title":"메트릭스","description":"데이터베이스 모니터링 분석을 위한 메트릭스 메뉴에 대해 알아봅니다.","source":"@site/docs/oracle/metrics-intro.mdx","sourceDirName":"oracle","slug":"/oracle/metrics-intro","permalink":"/oracle/metrics-intro","draft":false,"unlisted":false,"editUrl":"undefined/docs/oracle/metrics-intro.mdx","tags":[],"version":"current","frontMatter":{"id":"metrics-intro","title":"메트릭스","description":"데이터베이스 모니터링 분석을 위한 메트릭스 메뉴에 대해 알아봅니다.","keywords":["Oracle","메트릭스","데이터베이스","데이터베이스"],"isTranslationMissing":false},"sidebar":"dboracleV2Sidebar","previous":{"title":"데이터베이스 파라미터","permalink":"/oracle/analysis-databaseparameter"},"next":{"title":"Oracle 지표","permalink":"/oracle/metrics-data-list"}}')
...
;// CONCATENATED MODULE: ./docs/oracle/metrics-intro.mdx
