"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[64360],{
...
const metadata = {
  "id": "oracle-dma/metric-warning-notice",
  "title": "메트릭스 경고 알림",
  "description": "구체적이고 복잡한 이벤트를 설정하려면 메트릭스 이벤트 설정을 사용하세요.",
  "source": "@site/docs/oracle-dma/metric-warning-notice.mdx",
  "sourceDirName": "oracle-dma",
  "slug": "/oracle-dma/metric-warning-notice",
  "permalink": "/whatap-docs/oracle-dma/metric-warning-notice",
  "draft": false,
  "unlisted": false,
  "editUrl": "undefined/docs/oracle-dma/metric-warning-notice.mdx",
  "tags": [
    {
      "label": "Oracle DMA",
