"use strict";
(self["webpackChunkwhatap_origin"] = self["webpackChunkwhatap_origin"] || []).push([[59548],{
...
const metadata = {
    "unversionedId": "python/metrics-chart",
    "id": "python/metrics-chart",
    "title": "메트릭스 차트",
    "description": "메트릭스 데이터를 차트로 조회할 수 있습니다.",
    "source": "@site/docs/python/metrics-chart.mdx",
    "sourceDirName": "python",
    "slug": "/python/metrics-chart",
    "permalink": "/whatap-docs/python/metrics-chart",
    "draft": false,
    "editUrl": "undefined/docs/python/metrics-chart.mdx",
    "tags": [
        {
            "label": "메트릭스",
