"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["68437"], {
...
"26476": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_mongodb_monitoring_support_mdx_59a_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-mongodb-monitoring-support-mdx-59a.json
var site_docs_mongodb_monitoring_support_mdx_59a_namespaceObject = JSON.parse('{"id":"mongodb/monitoring-support","title":"지원 환경","description":"데이터베이스 모니터링을 시작하기 전에 지원하는 데이터베이스 종류에 대해서 알아보세요.","source":"@site/docs/mongodb/monitoring-support.mdx","sourceDirName":"mongodb","slug":"/mongodb/monitoring-support","permalink":"/mongodb/monitoring-support","draft":false,"unlisted":false,"editUrl":"undefined/docs/mongodb/monitoring-support.mdx","tags":[],"version":"current","frontMatter":{"id":"monitoring-support","title":"지원 환경","description":"데이터베이스 모니터링을 시작하기 전에 지원하는 데이터베이스 종류에 대해서 알아보세요.","keywords":["MongoDB","데이터베이스","데이터베이스 모니터링"],"isTranslationMissing":false},"sidebar":"mongodbSidebar","previous":{"title":"MongoDB 모니터링","permalink":"/mongodb/monitoring-intro"},"next":{"title":"에이전트 설치","permalink":"/mongodb/install-agent"}}')
...
;// CONCATENATED MODULE: ./docs/mongodb/monitoring-support.mdx
