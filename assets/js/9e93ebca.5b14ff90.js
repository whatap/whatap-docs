"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["89777"], {
...
"29380": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_oracle_v_1_install_agent_mdx_9e9_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-oracle-v-1-install-agent-mdx-9e9.json
var site_docs_oracle_v_1_install_agent_mdx_9e9_namespaceObject = JSON.parse('{"id":"oracle-v1/install-agent","title":"에이전트 설치","description":"와탭 데이터베이스 모니터링 서비스 이용을 위한 기본 설치 방법을 안내합니다.","source":"@site/docs/oracle-v1/install-agent.mdx","sourceDirName":"oracle-v1","slug":"/oracle-v1/install-agent","permalink":"/oracle-v1/install-agent","draft":false,"unlisted":false,"editUrl":"undefined/docs/oracle-v1/install-agent.mdx","tags":[],"version":"current","frontMatter":{"id":"install-agent","title":"에이전트 설치","description":"와탭 데이터베이스 모니터링 서비스 이용을 위한 기본 설치 방법을 안내합니다.","keywords":["Oracle","데이터베이스 모니터링","에이전트"],"isTranslationMissing":false},"sidebar":"dboracleSidebar","previous":{"title":"지원 환경","permalink":"/oracle-v1/monitoring-support"},"next":{"title":"설치 점검 사항","permalink":"/oracle-v1/after-install-agent"}}')
// EXTERNAL MODULE: ./node_modules/react/jsx-runtime.js
var jsx_runtime = __webpack_require__("85893");
// EXTERNAL MODULE: ./node_modules/@mdx-js/react/lib/index.js
var lib = __webpack_require__("50065");
...
;// CONCATENATED MODULE: ./docs/oracle-v1/install-agent.mdx
...
const toc = [..._agent_signup_guide/* toc */.d$, ..._create_project_v2/* toc */.d$, ..._accesskey/* toc */.d$, {
  ...
  "id": "create-db-user",
  "level": 2
}, ..._import_db_create_db_user_desc/* toc */.d$, ..._db_create_db_user_file_body/* toc */.d$, ..._db_run_agent/* toc */.d$, ..._db_install_xos_agent/* toc */.d$];
function _createMdxContent(props) {
  const _components = {
    a: "a",
    code: "code",
