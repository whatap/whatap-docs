"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["76808"], {
...
"81830": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_npm_set_receive_event_mdx_e83_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-npm-set-receive-event-mdx-e83.json
var site_docs_npm_set_receive_event_mdx_e83_namespaceObject = JSON.parse('{"id":"npm/set-receive-event","title":"이벤트 수신 설정","description":"프로젝트에 포함하는 멤버들의 경고 알림 수신과 관련한 다양한 기능을 설정할 수 있습니다.","source":"@site/docs/npm/set-receive-event.mdx","sourceDirName":"npm","slug":"/npm/set-receive-event","permalink":"/npm/set-receive-event","draft":false,"unlisted":false,"editUrl":"undefined/docs/npm/set-receive-event.mdx","tags":[],"version":"current","frontMatter":{"id":"set-receive-event","title":"이벤트 수신 설정","description":"프로젝트에 포함하는 멤버들의 경고 알림 수신과 관련한 다양한 기능을 설정할 수 있습니다.","keywords":["네트워크 성능 모니터링","경고 알림","이벤트 수신 태그"],"isTranslationMissing":false},"sidebar":"npmsidebar","previous":{"title":"이벤트 설정","permalink":"/npm/warning-notice-v2"},"next":{"title":"이벤트 기록","permalink":"/npm/set-event-history"}}')
...
;// CONCATENATED MODULE: ./docs/npm/set-receive-event.mdx
