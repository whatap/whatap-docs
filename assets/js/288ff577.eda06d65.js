"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["22310"], {
...
"53260": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_cubrid_v_1_warning_notice_mdx_288_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-cubrid-v-1-warning-notice-mdx-288.json
var site_docs_cubrid_v_1_warning_notice_mdx_288_namespaceObject = JSON.parse('{"id":"cubrid-v1/warning-notice","title":"데이터베이스 경고 알림","description":"데이터베이스의 지표별 이벤트 조건 설정을 통해 경고 알림을 보냅니다.","source":"@site/docs/cubrid-v1/warning-notice.mdx","sourceDirName":"cubrid-v1","slug":"/cubrid-v1/warning-notice","permalink":"/cubrid-v1/warning-notice","draft":false,"unlisted":false,"editUrl":"undefined/docs/cubrid-v1/warning-notice.mdx","tags":[],"version":"current","frontMatter":{"id":"warning-notice","title":"데이터베이스 경고 알림","description":"데이터베이스의 지표별 이벤트 조건 설정을 통해 경고 알림을 보냅니다.","keywords":["CUBRID","경고 알림","데이터베이스","데이터베이스 모니터링"],"isTranslationMissing":false},"sidebar":"cubridV1Sidebar","previous":{"title":"알림 설정하기","permalink":"/cubrid-v1/set-notice"},"next":{"title":"이벤트 설정","permalink":"/cubrid-v1/warning-notice-v2"}}')
...
;// CONCATENATED MODULE: ./docs/cubrid-v1/warning-notice.mdx
