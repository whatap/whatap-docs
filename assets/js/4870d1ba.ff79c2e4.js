"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["68064"], {
...
"28578": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_mssql_agent_manage_mdx_487_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-mssql-agent-manage-mdx-487.json
var site_docs_mssql_agent_manage_mdx_487_namespaceObject = JSON.parse('{"id":"mssql/agent-manage","title":"관리하기","description":"whatap.conf 파일을 통해 데이터베이스 에이전트를 관리할 수 있습니다.","source":"@site/docs/mssql/agent-manage.mdx","sourceDirName":"mssql","slug":"/mssql/agent-manage","permalink":"/mssql/agent-manage","draft":false,"unlisted":false,"editUrl":"undefined/docs/mssql/agent-manage.mdx","tags":[],"version":"current","frontMatter":{"id":"agent-manage","title":"관리하기","description":"whatap.conf 파일을 통해 데이터베이스 에이전트를 관리할 수 있습니다.","keywords":["SQL Server","데이터베이스"],"isTranslationMissing":false},"sidebar":"mssqlSidebar","previous":{"title":"클라우드 설정","permalink":"/mssql/cloudsettings"},"next":{"title":"대시보드","permalink":"/mssql/dashboard-intro"}}')
...
;// CONCATENATED MODULE: ./docs/mssql/agent-manage.mdx
...
const toc = [..._import_v2_note/* toc */.d$, ..._db_update_agent/* toc */.d$, {
  "value": "에이전트 삭제",
  "id": "에이전트-삭제",
  "level": 2
