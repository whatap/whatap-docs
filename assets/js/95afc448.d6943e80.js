"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[6697],{
...
const metadata = {
  ...
  "title": "MSA 분석",
  "description": "MSA 분석 기능은 와탭의 MTRACE(멀티 서버간 추적)기능을 통해서 수집된 트랜잭션들 사이의 호출 비중이 어떠한지를 분석합니다.",
  "source": "@site/docs/php/analysis-msa.mdx",
  "sourceDirName": "php",
  "slug": "/php/analysis-msa",
  "permalink": "/whatap-docs/php/analysis-msa",
  "draft": false,
  "unlisted": false,
  "editUrl": "undefined/docs/php/analysis-msa.mdx",
  "tags": [
    {
      "label": "PHP",
