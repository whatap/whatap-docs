"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["25088"], {
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_server_set_event_detect_anomal_mdx_125_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-server-set-event-detect-anomal-mdx-125.json
var site_docs_server_set_event_detect_anomal_mdx_125_namespaceObject = JSON.parse('{"id":"server/set-event-detect-anomal","title":"이상치 탐지 경고 알림","description":"예상치 못한 패턴을 찾는 일련의 활동을 탐지해 경고 알림을 보내도록 설정할 수 있습니다.","source":"@site/docs/server/set-event-detect-anomal.mdx","sourceDirName":"server","slug":"/server/set-event-detect-anomal","permalink":"/server/set-event-detect-anomal","draft":false,"unlisted":false,"editUrl":"undefined/docs/server/set-event-detect-anomal.mdx","tags":[],"version":"current","frontMatter":{"id":"set-event-detect-anomal","title":"이상치 탐지 경고 알림","description":"예상치 못한 패턴을 찾는 일련의 활동을 탐지해 경고 알림을 보내도록 설정할 수 있습니다.","keywords":["경고 알림","이상치 탐지","서버"],"isTranslationMissing":false},"sidebar":"serverSidebar","previous":{"title":"알림 메시지 사용자 정의","permalink":"/server/set-notification-message"},"next":{"title":"로그 경고 알림","permalink":"/server/set-event-log"}}')
...
;// CONCATENATED MODULE: ./docs/server/set-event-detect-anomal.mdx
