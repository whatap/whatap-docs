"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["34611"], {
...
"67538": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_php_set_receive_event_mdx_409_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-php-set-receive-event-mdx-409.json
var site_docs_php_set_receive_event_mdx_409_namespaceObject = JSON.parse('{"id":"php/set-receive-event","title":"이벤트 수신 설정","description":"프로젝트에 포함하는 멤버들의 경고 알림 수신과 관련한 다양한 기능을 설정할 수 있습니다.","source":"@site/docs/php/set-receive-event.mdx","sourceDirName":"php","slug":"/php/set-receive-event","permalink":"/php/set-receive-event","draft":false,"unlisted":false,"editUrl":"undefined/docs/php/set-receive-event.mdx","tags":[],"version":"current","frontMatter":{"id":"set-receive-event","title":"이벤트 수신 설정","description":"프로젝트에 포함하는 멤버들의 경고 알림 수신과 관련한 다양한 기능을 설정할 수 있습니다.","keywords":["PHP","경고 알림","이벤트 수신 태그","애플리케이션 모니터링"],"isTranslationMissing":false},"sidebar":"phpSidebar","previous":{"title":"로그 경고 알림","permalink":"/php/set-event-log"},"next":{"title":"이벤트 기록","permalink":"/php/set-event-history"}}')
...
;// CONCATENATED MODULE: ./docs/php/set-receive-event.mdx
