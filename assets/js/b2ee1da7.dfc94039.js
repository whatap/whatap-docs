"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["89039"], {
"51180": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_altibase_agent_manage_mdx_b2e_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-altibase-agent-manage-mdx-b2e.json
var site_docs_altibase_agent_manage_mdx_b2e_namespaceObject = JSON.parse('{"id":"altibase/agent-manage","title":"관리하기","description":"whatap.conf 파일을 통해 데이터베이스 에이전트를 관리할 수 있습니다.","source":"@site/docs/altibase/agent-manage.mdx","sourceDirName":"altibase","slug":"/altibase/agent-manage","permalink":"/altibase/agent-manage","draft":false,"unlisted":false,"editUrl":"undefined/docs/altibase/agent-manage.mdx","tags":[],"version":"current","frontMatter":{"id":"agent-manage","title":"관리하기","description":"whatap.conf 파일을 통해 데이터베이스 에이전트를 관리할 수 있습니다.","keywords":["Altibase","데이터베이스","데이터베이스 모니터링"],"isTranslationMissing":false},"sidebar":"altibaseSidebar","previous":{"title":"XOS 에이전트 설정","permalink":"/altibase/agent-xos-settings"},"next":{"title":"대시보드","permalink":"/altibase/dashboard-intro"}}')
...
;// CONCATENATED MODULE: ./docs/altibase/agent-manage.mdx
