"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[59621],{
...
const metadata = {
  "id": "mssql-v1/real-time-notification",
  "title": "실시간 알림",
  "description": "이벤트 설정 메뉴를 통해서 설정한 경고 알림을 실시간으로 확인할 수 있습니다.",
  "source": "@site/docs/mssql-v1/real-time-notification.mdx",
  "sourceDirName": "mssql-v1",
  "slug": "/mssql-v1/real-time-notification",
  "permalink": "/whatap-docs/mssql-v1/real-time-notification",
  "draft": false,
  "unlisted": false,
  "editUrl": "undefined/docs/mssql-v1/real-time-notification.mdx",
  "tags": [],
  "version": "current",
  "frontMatter": {
    "id": "real-time-notification",
  ...
  "previous": {
    "title": "이벤트 수신 포맷",
    "permalink": "/whatap-docs/mssql-v1/set-event-format"
  },
  "next": {
    "title": "시스템 이벤트 안내",
    "permalink": "/whatap-docs/mssql-v1/common-alert"
  }
};
const assets = {
