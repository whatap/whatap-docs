"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[9951],{
...
const metadata = {
  "id": "oracle-dma/report-intro",
  "title": "보고서",
  "description": "개별 프로젝트에 대해 서비스 이용 현황과 장애 발생 기록을 보고하는 문서에 대해 알아봅니다.",
  "source": "@site/docs/oracle-dma/report-intro.mdx",
  "sourceDirName": "oracle-dma",
  "slug": "/oracle-dma/report-intro",
  "permalink": "/whatap-docs/oracle-dma/report-intro",
  "draft": false,
  "unlisted": false,
  "editUrl": "undefined/docs/oracle-dma/report-intro.mdx",
  "tags": [
    {
      "inline": true,
      "label": "Oracle Pro",
