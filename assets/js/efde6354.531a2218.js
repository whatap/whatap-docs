"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["92545"], {
...
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_altibase_set_event_detect_anomal_mdx_efd_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-altibase-set-event-detect-anomal-mdx-efd.json
var site_docs_altibase_set_event_detect_anomal_mdx_efd_namespaceObject = JSON.parse('{"id":"altibase/set-event-detect-anomal","title":"이상치 탐지 경고 알림","description":"예상치 못한 패턴을 찾는 일련의 활동을 탐지해 경고 알림을 보내도록 설정할 수 있습니다.","source":"@site/docs/altibase/set-event-detect-anomal.mdx","sourceDirName":"altibase","slug":"/altibase/set-event-detect-anomal","permalink":"/altibase/set-event-detect-anomal","draft":false,"unlisted":false,"editUrl":"undefined/docs/altibase/set-event-detect-anomal.mdx","tags":[],"version":"current","frontMatter":{"id":"set-event-detect-anomal","title":"이상치 탐지 경고 알림","description":"예상치 못한 패턴을 찾는 일련의 활동을 탐지해 경고 알림을 보내도록 설정할 수 있습니다.","keywords":["Altibase","경고 알림","이상치 탐지","데이터베이스 모니터링"],"isTranslationMissing":false},"sidebar":"altibaseSidebar","previous":{"title":"알림 메시지 사용자 정의","permalink":"/altibase/set-notification-message"},"next":{"title":"이벤트 수신 설정","permalink":"/altibase/set-receive-event"}}')
...
;// CONCATENATED MODULE: ./docs/altibase/set-event-detect-anomal.mdx
