"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["71113"], {
...
"40844": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_cubrid_set_receive_event_mdx_8d8_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-cubrid-set-receive-event-mdx-8d8.json
var site_docs_cubrid_set_receive_event_mdx_8d8_namespaceObject = JSON.parse('{"id":"cubrid/set-receive-event","title":"이벤트 수신 설정","description":"프로젝트에 포함하는 멤버들의 경고 알림 수신과 관련한 다양한 기능을 설정할 수 있습니다.","source":"@site/docs/cubrid/set-receive-event.mdx","sourceDirName":"cubrid","slug":"/cubrid/set-receive-event","permalink":"/cubrid/set-receive-event","draft":false,"unlisted":false,"editUrl":"undefined/docs/cubrid/set-receive-event.mdx","tags":[],"version":"current","frontMatter":{"id":"set-receive-event","title":"이벤트 수신 설정","description":"프로젝트에 포함하는 멤버들의 경고 알림 수신과 관련한 다양한 기능을 설정할 수 있습니다.","keywords":["CUBRID","경고 알림","이벤트 수신 태그","데이터베이스 모니터링"],"isTranslationMissing":false},"sidebar":"cubridSidebar","previous":{"title":"이상치 탐지 경고 알림","permalink":"/cubrid/set-event-detect-anomal"},"next":{"title":"이벤트 기록","permalink":"/cubrid/set-event-history"}}')
...
;// CONCATENATED MODULE: ./docs/cubrid/set-receive-event.mdx
