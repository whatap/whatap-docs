"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["86083"], {
...
"48832": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_golang_set_receive_event_mdx_cd8_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-golang-set-receive-event-mdx-cd8.json
var site_docs_golang_set_receive_event_mdx_cd8_namespaceObject = JSON.parse('{"id":"golang/set-receive-event","title":"이벤트 수신 설정","description":"프로젝트에 포함하는 멤버들의 경고 알림 수신과 관련한 다양한 기능을 설정할 수 있습니다.","source":"@site/docs/golang/set-receive-event.mdx","sourceDirName":"golang","slug":"/golang/set-receive-event","permalink":"/golang/set-receive-event","draft":false,"unlisted":false,"editUrl":"undefined/docs/golang/set-receive-event.mdx","tags":[],"version":"current","frontMatter":{"id":"set-receive-event","title":"이벤트 수신 설정","description":"프로젝트에 포함하는 멤버들의 경고 알림 수신과 관련한 다양한 기능을 설정할 수 있습니다.","keywords":["Go","경고 알림","이벤트 수신 태그","애플리케이션 모니터링"],"isTranslationMissing":false},"sidebar":"goSidebar","previous":{"title":"로그 경고 알림","permalink":"/golang/set-event-log"},"next":{"title":"이벤트 기록","permalink":"/golang/set-event-history"}}')
...
;// CONCATENATED MODULE: ./docs/golang/set-receive-event.mdx
