"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["99186"], {
...
"16615": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_golang_metrics_app_mdx_8db_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-golang-metrics-app-mdx-8db.json
var site_docs_golang_metrics_app_mdx_8db_namespaceObject = JSON.parse('{"id":"golang/metrics-app","title":"애플리케이션 지표","description":"애플리케이션 지표를 안내합니다.","source":"@site/docs/golang/metrics-app.mdx","sourceDirName":"golang","slug":"/golang/metrics-app","permalink":"/golang/metrics-app","draft":false,"unlisted":false,"editUrl":"undefined/docs/golang/metrics-app.mdx","tags":[],"version":"current","frontMatter":{"id":"metrics-app","title":"애플리케이션 지표","description":"애플리케이션 지표를 안내합니다.","toc_max_heading_level":2,"keywords":["Go","메트릭스","애플리케이션","UI"],"isTranslationMissing":false},"sidebar":"goSidebar","previous":{"title":"메트릭스","permalink":"/golang/metrics-intro"},"next":{"title":"애플리케이션 성능 카운터","permalink":"/golang/metrics-performance-counter"}}')
...
;// CONCATENATED MODULE: ./docs/golang/metrics-app.mdx
