"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["36701"], {
"77021": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_kubernetes_install_docker_nodejs_mdx_8b1_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-kubernetes-install-docker-nodejs-mdx-8b1.json
var site_docs_kubernetes_install_docker_nodejs_mdx_8b1_namespaceObject = JSON.parse('{"id":"kubernetes/install-docker-nodejs","title":"Docker Node.js 설치","description":"컨테이너 내 Node.js 애플리케이션을 모니터링하기 위한 에이전트 설치 단계입니다.","source":"@site/docs/kubernetes/install-docker-nodejs.mdx","sourceDirName":"kubernetes","slug":"/kubernetes/install-docker-nodejs","permalink":"/kubernetes/install-docker-nodejs","draft":false,"unlisted":false,"editUrl":"undefined/docs/kubernetes/install-docker-nodejs.mdx","tags":[],"version":"current","frontMatter":{"id":"install-docker-nodejs","title":"Docker Node.js 설치","description":"컨테이너 내 Node.js 애플리케이션을 모니터링하기 위한 에이전트 설치 단계입니다.","keywords":["쿠버네티스","쿠버네티스 모니터링","애플리케이션 설치","Node.js"],"isTranslationMissing":false},"sidebar":"kubeSidebar","previous":{"title":"Docker Java 설치","permalink":"/kubernetes/install-docker-java"},"next":{"title":"Docker Python 설치","permalink":"/kubernetes/install-docker-python"}}')
