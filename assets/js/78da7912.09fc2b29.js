"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["87350"], {
"80592": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_altibase_v_1_after_install_agent_mdx_78d_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-altibase-v-1-after-install-agent-mdx-78d.json
var site_docs_altibase_v_1_after_install_agent_mdx_78d_namespaceObject = JSON.parse('{"id":"altibase-v1/after-install-agent","title":"설치 점검 사항","description":"데이터베이스 모니터링 설치를 모두 완료했습니다. 설치 후 확인 사항을 점검하세요.","source":"@site/docs/altibase-v1/after-install-agent.mdx","sourceDirName":"altibase-v1","slug":"/altibase-v1/after-install-agent","permalink":"/altibase-v1/after-install-agent","draft":false,"unlisted":false,"editUrl":"undefined/docs/altibase-v1/after-install-agent.mdx","tags":[],"version":"current","frontMatter":{"id":"after-install-agent","title":"설치 점검 사항","description":"데이터베이스 모니터링 설치를 모두 완료했습니다. 설치 후 확인 사항을 점검하세요.","keywords":["Altibase","데이터베이스 모니터링","에이전트"],"isTranslationMissing":false},"sidebar":"altibasev1Sidebar","previous":{"title":"에이전트 설치","permalink":"/altibase-v1/install-agent"},"next":{"title":"설치 문제 해결","permalink":"/altibase-v1/troubleshooting"}}')
