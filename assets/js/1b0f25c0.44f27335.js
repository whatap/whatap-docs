"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["53537"], {
...
"17929": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_oracle_cloud_set_receive_event_mdx_1b0_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-oracle-cloud-set-receive-event-mdx-1b0.json
var site_docs_oracle_cloud_set_receive_event_mdx_1b0_namespaceObject = JSON.parse('{"id":"oracle-cloud/set-receive-event","title":"이벤트 수신 설정","description":"프로젝트에 포함하는 멤버들의 경고 알림 수신과 관련한 다양한 기능을 설정할 수 있습니다.","source":"@site/docs/oracle-cloud/set-receive-event.mdx","sourceDirName":"oracle-cloud","slug":"/oracle-cloud/set-receive-event","permalink":"/oracle-cloud/set-receive-event","draft":false,"unlisted":false,"editUrl":"undefined/docs/oracle-cloud/set-receive-event.mdx","tags":[],"version":"current","frontMatter":{"id":"set-receive-event","title":"이벤트 수신 설정","description":"프로젝트에 포함하는 멤버들의 경고 알림 수신과 관련한 다양한 기능을 설정할 수 있습니다.","keywords":["경고 알림","이벤트 수신 태그","Oracle Cloud Monitor","클라우드"],"isTranslationMissing":false},"sidebar":"oracleSidebar","previous":{"title":"메트릭스 경고 알림","permalink":"/oracle-cloud/metric-warning-notice"},"next":{"title":"이벤트 기록","permalink":"/oracle-cloud/set-event-history"}}')
...
;// CONCATENATED MODULE: ./docs/oracle-cloud/set-receive-event.mdx
