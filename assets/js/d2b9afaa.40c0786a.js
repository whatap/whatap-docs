...
"53443": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_mysql_set_event_log_mdx_d2b_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-mysql-set-event-log-mdx-d2b.json
var site_docs_mysql_set_event_log_mdx_d2b_namespaceObject = JSON.parse('{"id":"mysql/set-event-log","title":"로그 알림 설정하기","description":"로그 이벤트 알림 메뉴를 안내합니다.","source":"@site/docs/mysql/set-event-log.mdx","sourceDirName":"mysql","slug":"/mysql/set-event-log","permalink":"/mysql/set-event-log","draft":false,"unlisted":false,"editUrl":"undefined/docs/mysql/set-event-log.mdx","tags":[],"version":"current","frontMatter":{"id":"set-event-log","title":"로그 알림 설정하기","description":"로그 이벤트 알림 메뉴를 안내합니다.","keywords":["로그 모니터링","알림","UI","MySQL"],"isTranslationMissing":false},"sidebar":"mysqlSidebar","previous":{"title":"이상치 탐지 경고 알림","permalink":"/mysql/set-event-detect-anomal"},"next":{"title":"이벤트 수신 설정","permalink":"/mysql/set-receive-event"}}')
...
;// CONCATENATED MODULE: ./docs/mysql/set-event-log.mdx
