"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["61839"], {
...
"21629": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_mssql_analysis_databaseparameter_mdx_c65_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-mssql-analysis-databaseparameter-mdx-c65.json
var site_docs_mssql_analysis_databaseparameter_mdx_c65_namespaceObject = JSON.parse('{"id":"mssql/analysis-databaseparameter","title":"데이터베이스 파라미터","description":"데이터베이스의 파라미터 값을 조회하고 날짜별로 비교할 수 있습니다.","source":"@site/docs/mssql/analysis-databaseparameter.mdx","sourceDirName":"mssql","slug":"/mssql/analysis-databaseparameter","permalink":"/mssql/analysis-databaseparameter","draft":false,"unlisted":false,"editUrl":"undefined/docs/mssql/analysis-databaseparameter.mdx","tags":[],"version":"current","frontMatter":{"id":"analysis-databaseparameter","title":"데이터베이스 파라미터","description":"데이터베이스의 파라미터 값을 조회하고 날짜별로 비교할 수 있습니다.","keywords":["SQL Server","데이터베이스","분석","데이터베이스 파라미터"],"isTranslationMissing":false},"sidebar":"mssqlSidebar","previous":{"title":"데드락","permalink":"/mssql/analysis-deadlock"},"next":{"title":"메트릭스","permalink":"/mssql/metrics-intro"}}')
...
;// CONCATENATED MODULE: ./docs/mssql/analysis-databaseparameter.mdx
