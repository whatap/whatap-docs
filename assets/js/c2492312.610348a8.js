"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["69265"], {
...
"38114": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_dotnet_trs_multi_trace_mdx_c24_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-dotnet-trs-multi-trace-mdx-c24.json
var site_docs_dotnet_trs_multi_trace_mdx_c24_namespaceObject = JSON.parse('{"id":"dotnet/trs-multi-trace","title":"멀티 트랜잭션","description":"멀티 트랜잭션 추적을 안내합니다.","source":"@site/docs/dotnet/trs-multi-trace.mdx","sourceDirName":"dotnet","slug":"/dotnet/trs-multi-trace","permalink":"/dotnet/trs-multi-trace","draft":false,"unlisted":false,"editUrl":"undefined/docs/dotnet/trs-multi-trace.mdx","tags":[],"version":"current","frontMatter":{"id":"trs-multi-trace","title":"멀티 트랜잭션","description":"멀티 트랜잭션 추적을 안내합니다.","keywords":[".NET","트랜잭션","멀티 트랜잭션","UI","애플리케이션"],"isTranslationMissing":false},"sidebar":"dotNetSidebar","previous":{"title":"액티브 트랜잭션","permalink":"/dotnet/active-transactions"},"next":{"title":"트랜잭션 스텝 수집 방식","permalink":"/dotnet/collect-stacks"}}')
...
;// CONCATENATED MODULE: ./docs/dotnet/trs-multi-trace.mdx
