"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["50661"], {
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_oracle_v_1_set_notification_message_mdx_db3_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-oracle-v-1-set-notification-message-mdx-db3.json
var site_docs_oracle_v_1_set_notification_message_mdx_db3_namespaceObject = JSON.parse('{"id":"oracle-v1/set-notification-message","title":"알림 메시지 사용자 정의","description":"프로젝트 멤버에게 전달되는 경고 알림 메시지를 수정할 수 있는 사용자 정의 기능을 제공합니다.","source":"@site/docs/oracle-v1/set-notification-message.mdx","sourceDirName":"oracle-v1","slug":"/oracle-v1/set-notification-message","permalink":"/oracle-v1/set-notification-message","draft":false,"unlisted":false,"editUrl":"undefined/docs/oracle-v1/set-notification-message.mdx","tags":[],"version":"current","frontMatter":{"id":"set-notification-message","title":"알림 메시지 사용자 정의","description":"프로젝트 멤버에게 전달되는 경고 알림 메시지를 수정할 수 있는 사용자 정의 기능을 제공합니다.","keywords":["Oracle","데이터베이스","경고 알림","메트릭스 이벤트","알림 메시지"],"isTranslationMissing":false},"sidebar":"dboracleSidebar","previous":{"title":"메트릭스 경고 알림","permalink":"/oracle-v1/metric-warning-notice"},"next":{"title":"이상치 탐지 경고 알림","permalink":"/oracle-v1/set-event-detect-anomal"}}')
...
;// CONCATENATED MODULE: ./docs/oracle-v1/set-notification-message.mdx
