"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[38588],{
...
const metadata = {
  "id": "altibase-v1/multi-instance-monitoring",
  "title": "멀티 인스턴스 모니터링",
  "description": "다수의 데이터베이스 인스턴스 핵심 지표를 통합해 확인할 수 있는 기능을 제공합니다.",
  "source": "@site/docs/altibase-v1/multi-instance-monitoring.mdx",
  "sourceDirName": "altibase-v1",
  "slug": "/altibase-v1/multi-instance-monitoring",
  "permalink": "/whatap-docs/altibase-v1/multi-instance-monitoring",
  "draft": false,
  "unlisted": false,
  "editUrl": "undefined/docs/altibase-v1/multi-instance-monitoring.mdx",
  "tags": [],
  "version": "current",
  "frontMatter": {
    "id": "multi-instance-monitoring",
