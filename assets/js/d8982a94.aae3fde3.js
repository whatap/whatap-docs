"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["71333"], {
...
"36453": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_cubrid_v_1_set_event_history_mdx_d89_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-cubrid-v-1-set-event-history-mdx-d89.json
var site_docs_cubrid_v_1_set_event_history_mdx_d89_namespaceObject = JSON.parse('{"id":"cubrid-v1/set-event-history","title":"이벤트 기록","description":"이벤트 기록 메뉴를 통해 발생한 경고 알림 이력을 확인할 수 있습니다.","source":"@site/docs/cubrid-v1/set-event-history.mdx","sourceDirName":"cubrid-v1","slug":"/cubrid-v1/set-event-history","permalink":"/cubrid-v1/set-event-history","draft":false,"unlisted":false,"editUrl":"undefined/docs/cubrid-v1/set-event-history.mdx","tags":[],"version":"current","frontMatter":{"id":"set-event-history","title":"이벤트 기록","description":"이벤트 기록 메뉴를 통해 발생한 경고 알림 이력을 확인할 수 있습니다.","keywords":["CUBRID","경고 알림","이벤트 기록","데이터베이스 모니터링"],"isTranslationMissing":false},"sidebar":"cubridV1Sidebar","previous":{"title":"이벤트 수신 설정","permalink":"/cubrid-v1/set-receive-event"},"next":{"title":"이벤트 수신 포맷","permalink":"/cubrid-v1/set-event-format"}}')
...
;// CONCATENATED MODULE: ./docs/cubrid-v1/set-event-history.mdx
