...
const metadata = {
  "id": "oracle-cloud/real-time-notification",
  "title": "실시간 알림",
  "description": "이벤트 설정 메뉴를 통해서 설정한 경고 알림을 실시간으로 확인할 수 있습니다.",
  "source": "@site/docs/oracle-cloud/real-time-notification.mdx",
  "sourceDirName": "oracle-cloud",
  "slug": "/oracle-cloud/real-time-notification",
  "permalink": "/whatap-docs/oracle-cloud/real-time-notification",
  "draft": false,
  "unlisted": false,
  "editUrl": "undefined/docs/oracle-cloud/real-time-notification.mdx",
  "tags": [],
  "version": "current",
  "frontMatter": {
    "id": "real-time-notification",
  ...
  "next": {
    "title": "시스템 이벤트 안내",
    "permalink": "/whatap-docs/oracle-cloud/common-alert"
  }
};
const assets = {
