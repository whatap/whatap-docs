"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["90176"], {
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_golang_metric_warning_notice_mdx_787_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-golang-metric-warning-notice-mdx-787.json
var site_docs_golang_metric_warning_notice_mdx_787_namespaceObject = JSON.parse('{"id":"golang/metric-warning-notice","title":"메트릭스 경고 알림","description":"구체적이고 복잡한 이벤트를 설정하려면 메트릭스 이벤트 설정을 사용하세요.","source":"@site/docs/golang/metric-warning-notice.mdx","sourceDirName":"golang","slug":"/golang/metric-warning-notice","permalink":"/golang/metric-warning-notice","draft":false,"unlisted":false,"editUrl":"undefined/docs/golang/metric-warning-notice.mdx","tags":[],"version":"current","frontMatter":{"id":"metric-warning-notice","title":"메트릭스 경고 알림","description":"구체적이고 복잡한 이벤트를 설정하려면 메트릭스 이벤트 설정을 사용하세요.","keywords":["Go","경고 알림","메트릭스 이벤트","애플리케이션 모니터링"],"isTranslationMissing":false},"sidebar":"goSidebar","previous":{"title":"이벤트 설정","permalink":"/golang/warning-notice-v2"},"next":{"title":"알림 메시지 사용자 정의","permalink":"/golang/set-notification-message"}}')
...
;// CONCATENATED MODULE: ./docs/golang/metric-warning-notice.mdx
