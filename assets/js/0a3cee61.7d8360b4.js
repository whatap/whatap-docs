"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["53211"], {
...
"42658": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_dotnet_set_receive_event_mdx_0a3_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-dotnet-set-receive-event-mdx-0a3.json
var site_docs_dotnet_set_receive_event_mdx_0a3_namespaceObject = JSON.parse('{"id":"dotnet/set-receive-event","title":"이벤트 수신 설정","description":"프로젝트에 포함하는 멤버들의 경고 알림 수신과 관련한 다양한 기능을 설정할 수 있습니다.","source":"@site/docs/dotnet/set-receive-event.mdx","sourceDirName":"dotnet","slug":"/dotnet/set-receive-event","permalink":"/dotnet/set-receive-event","draft":false,"unlisted":false,"editUrl":"undefined/docs/dotnet/set-receive-event.mdx","tags":[],"version":"current","frontMatter":{"id":"set-receive-event","title":"이벤트 수신 설정","description":"프로젝트에 포함하는 멤버들의 경고 알림 수신과 관련한 다양한 기능을 설정할 수 있습니다.","keywords":[".NET","경고 알림","이벤트 수신 태그","애플리케이션 모니터링"],"isTranslationMissing":false},"sidebar":"dotNetSidebar","previous":{"title":"이상치 탐지 경고 알림","permalink":"/dotnet/set-event-detect-anomal"},"next":{"title":"이벤트 기록","permalink":"/dotnet/set-event-history"}}')
...
;// CONCATENATED MODULE: ./docs/dotnet/set-receive-event.mdx
