"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["91472"], {
"83035": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_altibase_labs_mdx_84c_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-altibase-labs-mdx-84c.json
var site_docs_altibase_labs_mdx_84c_namespaceObject = JSON.parse('{"id":"altibase/labs","title":"실험실","description":"사용자에게 새로운 기능 또는 실험적인 기능을 제공하는 메뉴인 실험실에 대해 안내합니다.","source":"@site/docs/altibase/labs.mdx","sourceDirName":"altibase","slug":"/altibase/labs","permalink":"/altibase/labs","draft":false,"unlisted":false,"editUrl":"undefined/docs/altibase/labs.mdx","tags":[],"version":"current","frontMatter":{"id":"labs","title":"실험실","description":"사용자에게 새로운 기능 또는 실험적인 기능을 제공하는 메뉴인 실험실에 대해 안내합니다.","keywords":["Altibase","데이터베이스","실험실"],"isTranslationMissing":false},"sidebar":"altibaseSidebar","previous":{"title":"시스템 이벤트 안내","permalink":"/altibase/common-alert"}}')
...
;// CONCATENATED MODULE: ./docs/altibase/labs.mdx
