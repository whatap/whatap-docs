"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["66767"], {
"79324": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_release_notes_server_server_2_3_2_mdx_27a_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-release-notes-server-server-2-3-2-mdx-27a.json
var site_docs_release_notes_server_server_2_3_2_mdx_27a_namespaceObject = JSON.parse('{"id":"release-notes/server/server-2_3_2","title":"Server Agent v2.3.2","description":"배포 내역","source":"@site/docs/release-notes/server/server-2.3.2.mdx","sourceDirName":"release-notes/server","slug":"/release-notes/server/server-2_3_2","permalink":"/release-notes/server/server-2_3_2","draft":false,"unlisted":false,"editUrl":"undefined/docs/release-notes/server/server-2.3.2.mdx","tags":[],"version":"current","frontMatter":{"id":"server-2_3_2","title":"Server Agent v2.3.2","toc_max_heading_level":2,"displayed_sidebar":"releaseSidebar","isTranslationMissing":false},"sidebar":"releaseSidebar"}')
...
;// CONCATENATED MODULE: ./docs/release-notes/server/server-2.3.2.mdx
