"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["64597"], {
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_oracle_set_event_history_mdx_c2a_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-oracle-set-event-history-mdx-c2a.json
var site_docs_oracle_set_event_history_mdx_c2a_namespaceObject = JSON.parse('{"id":"oracle/set-event-history","title":"이벤트 기록","description":"이벤트 기록 메뉴를 통해 발생한 경고 알림 이력을 확인할 수 있습니다.","source":"@site/docs/oracle/set-event-history.mdx","sourceDirName":"oracle","slug":"/oracle/set-event-history","permalink":"/oracle/set-event-history","draft":false,"unlisted":false,"editUrl":"undefined/docs/oracle/set-event-history.mdx","tags":[],"version":"current","frontMatter":{"id":"set-event-history","title":"이벤트 기록","description":"이벤트 기록 메뉴를 통해 발생한 경고 알림 이력을 확인할 수 있습니다.","keywords":["Oracle","경고 알림","이벤트 기록","데이터베이스"],"isTranslationMissing":false},"sidebar":"dboracleV2Sidebar","previous":{"title":"이벤트 수신 설정","permalink":"/oracle/set-receive-event"},"next":{"title":"이벤트 수신 포맷","permalink":"/oracle/set-event-format"}}')
...
;// CONCATENATED MODULE: ./docs/oracle/set-event-history.mdx
