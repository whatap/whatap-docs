"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["54053"], {
...
"39237": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_mssql_log_setting_mdx_bec_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-mssql-log-setting-mdx-bec.json
var site_docs_mssql_log_setting_mdx_bec_namespaceObject = JSON.parse('{"id":"mssql/log-setting","title":"로그 설정","description":"로그 모니터링 설정 방법을 안내합니다.","source":"@site/docs/mssql/log-setting.mdx","sourceDirName":"mssql","slug":"/mssql/log-setting","permalink":"/mssql/log-setting","draft":false,"unlisted":false,"editUrl":"undefined/docs/mssql/log-setting.mdx","tags":[],"version":"current","frontMatter":{"id":"log-setting","title":"로그 설정","description":"로그 모니터링 설정 방법을 안내합니다.","toc_max_heading_level":3,"keywords":["로그","로그 모니터링","설정하기","SQL Server"],"isTranslationMissing":false},"sidebar":"mssqlSidebar","previous":{"title":"로그 검색","permalink":"/mssql/log-search"},"next":{"title":"로그 파싱하기","permalink":"/mssql/log-parser"}}')
...
;// CONCATENATED MODULE: ./docs/mssql/log-setting.mdx
