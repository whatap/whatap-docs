"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["87695"], {
...
"51856": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_kubernetes_log_mdx_062_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-kubernetes-log-mdx-062.json
var site_docs_kubernetes_log_mdx_062_namespaceObject = JSON.parse('{"id":"kubernetes/log","title":"로그","description":"쿠버네티스 관련 다양한 로그를 확인할 수 있습니다.","source":"@site/docs/kubernetes/log.mdx","sourceDirName":"kubernetes","slug":"/kubernetes/log","permalink":"/kubernetes/log","draft":false,"unlisted":false,"editUrl":"undefined/docs/kubernetes/log.mdx","tags":[],"version":"current","frontMatter":{"id":"log","title":"로그","description":"쿠버네티스 관련 다양한 로그를 확인할 수 있습니다.","keywords":["쿠버네티스","쿠버네티스 모니터링","로그"],"isTranslationMissing":false},"sidebar":"kubeSidebar","previous":{"title":"메트릭스 이상 탐지","permalink":"/kubernetes/metrics-detect-anormal"},"next":{"title":"보고서","permalink":"/kubernetes/report-intro"}}')
...
const toc = [..._import_k8s_log_filter/* toc */.d$, {
  "value": "라이브 테일",
  "id": "라이브-테일",
  "level": 2
}, {
