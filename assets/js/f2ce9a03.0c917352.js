"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["13398"], {
...
"30710": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_java_dashboard_active_transaction_mdx_f2c_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-java-dashboard-active-transaction-mdx-f2c.json
var site_docs_java_dashboard_active_transaction_mdx_f2c_namespaceObject = JSON.parse('{"id":"java/dashboard-active-transaction","title":"액티브 트랜잭션","description":"자바(Java) 모니터링에서 현재 진행 중인 트랜잭션을 실시간으로 모니터링하고 분석하는 액티브 트랜잭션 기능을 안내합니다. 애플리케이션의 트랜잭션 URL, SQL, HTTP 호출 정보를 조회하고, 트랜잭션의 상태를 구분하여 파악할 수 있습니다. 이를 통해 지연 구간을 식별하고 문제 해결에 필요한 상세 정보를 얻을 수 있습니다.","source":"@site/docs/java/dashboard-active-transaction.mdx","sourceDirName":"java","slug":"/java/dashboard-active-transaction","permalink":"/java/dashboard-active-transaction","draft":false,"unlisted":false,"editUrl":"undefined/docs/java/dashboard-active-transaction.mdx","tags":[],"version":"current","frontMatter":{"id":"dashboard-active-transaction","title":"액티브 트랜잭션","description":"자바(Java) 모니터링에서 현재 진행 중인 트랜잭션을 실시간으로 모니터링하고 분석하는 액티브 트랜잭션 기능을 안내합니다. 애플리케이션의 트랜잭션 URL, SQL, HTTP 호출 정보를 조회하고, 트랜잭션의 상태를 구분하여 파악할 수 있습니다. 이를 통해 지연 구간을 식별하고 문제 해결에 필요한 상세 정보를 얻을 수 있습니다.","keywords":["Java","액티브 트랜잭션","대시보드","애플리케이션"],"isTranslationMissing":false},"sidebar":"javaSidebar","previous":{"title":"트랜잭션 맵","permalink":"/java/dashboard-transactionmap"},"next":{"title":"히트맵 - 트레이스 분석","permalink":"/java/dashboard-hitmap-trace"}}')
...
;// CONCATENATED MODULE: ./docs/java/dashboard-active-transaction.mdx
