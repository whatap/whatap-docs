"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["60695"], {
...
"21668": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_tibero_agent_manage_mdx_07a_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-tibero-agent-manage-mdx-07a.json
var site_docs_tibero_agent_manage_mdx_07a_namespaceObject = JSON.parse('{"id":"tibero/agent-manage","title":"관리하기","description":"whatap.conf 파일을 통해 데이터베이스 에이전트를 관리할 수 있습니다.","source":"@site/docs/tibero/agent-manage.mdx","sourceDirName":"tibero","slug":"/tibero/agent-manage","permalink":"/tibero/agent-manage","draft":false,"unlisted":false,"editUrl":"undefined/docs/tibero/agent-manage.mdx","tags":[],"version":"current","frontMatter":{"id":"agent-manage","title":"관리하기","description":"whatap.conf 파일을 통해 데이터베이스 에이전트를 관리할 수 있습니다.","keywords":["Tibero","데이터베이스"],"isTranslationMissing":false},"sidebar":"tiberoSidebar","previous":{"title":"XOS 에이전트 설정","permalink":"/tibero/agent-xos-settings"},"next":{"title":"대시보드","permalink":"/tibero/dashboard-intro"}}')
...
;// CONCATENATED MODULE: ./docs/tibero/agent-manage.mdx
