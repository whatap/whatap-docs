"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["99366"], {
...
"25632": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_mssql_v_1_stat_mdx_a5d_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-mssql-v-1-stat-mdx-a5d.json
var site_docs_mssql_v_1_stat_mdx_a5d_namespaceObject = JSON.parse('{"id":"mssql-v1/stat","title":"SQL 통계","description":"SQL Server의 데이터베이스별 통계 데이터를 제공합니다.","source":"@site/docs/mssql-v1/stat.mdx","sourceDirName":"mssql-v1","slug":"/mssql-v1/stat","permalink":"/mssql-v1/stat","draft":false,"unlisted":false,"editUrl":"undefined/docs/mssql-v1/stat.mdx","tags":[],"version":"current","frontMatter":{"id":"stat","title":"SQL 통계","description":"SQL Server의 데이터베이스별 통계 데이터를 제공합니다.","keywords":["SQL Server","데이터베이스","통계"],"isTranslationMissing":false},"sidebar":"mssqlV1Sidebar","previous":{"title":"메트릭스 이상 탐지","permalink":"/mssql-v1/metrics-detect-anormal"},"next":{"title":"보고서","permalink":"/mssql-v1/report-intro"}}')
...
;// CONCATENATED MODULE: ./docs/mssql-v1/stat.mdx
