...
const metadata = {
  ...
  "title": "지원 환경",
  "description": "데이터베이스 모니터링을 시작하기 전에 지원하는 데이터베이스 종류에 대해서 알아보세요.",
  "source": "@site/docs/cubrid-v1/monitoring-support.mdx",
  "sourceDirName": "cubrid-v1",
  "slug": "/cubrid-v1/monitoring-support",
  "permalink": "/whatap-docs/cubrid-v1/monitoring-support",
  "draft": false,
  "unlisted": false,
  "editUrl": "undefined/docs/cubrid-v1/monitoring-support.mdx",
  "tags": [],
  "version": "current",
  "frontMatter": {
    "id": "monitoring-support",
  ...
  "previous": {
    ...
    "permalink": "/whatap-docs/cubrid-v1/monitoring-intro"
  },
  "next": {
    "title": "에이전트 설치",
    "permalink": "/whatap-docs/cubrid-v1/install-agent"
  }
};
const assets = {
