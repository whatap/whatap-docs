"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["71937"], {
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_cubrid_set_event_history_mdx_462_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-cubrid-set-event-history-mdx-462.json
var site_docs_cubrid_set_event_history_mdx_462_namespaceObject = JSON.parse('{"id":"cubrid/set-event-history","title":"이벤트 기록","description":"이벤트 기록 메뉴를 통해 발생한 경고 알림 이력을 확인할 수 있습니다.","source":"@site/docs/cubrid/set-event-history.mdx","sourceDirName":"cubrid","slug":"/cubrid/set-event-history","permalink":"/cubrid/set-event-history","draft":false,"unlisted":false,"editUrl":"undefined/docs/cubrid/set-event-history.mdx","tags":[],"version":"current","frontMatter":{"id":"set-event-history","title":"이벤트 기록","description":"이벤트 기록 메뉴를 통해 발생한 경고 알림 이력을 확인할 수 있습니다.","keywords":["CUBRID","경고 알림","이벤트 기록","데이터베이스 모니터링"],"isTranslationMissing":false},"sidebar":"cubridSidebar","previous":{"title":"이벤트 수신 설정","permalink":"/cubrid/set-receive-event"},"next":{"title":"이벤트 수신 포맷","permalink":"/cubrid/set-event-format"}}')
...
;// CONCATENATED MODULE: ./docs/cubrid/set-event-history.mdx
