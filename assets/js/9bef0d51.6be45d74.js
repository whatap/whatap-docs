...
const metadata = {
  "id": "tibero/agent-dbx-settings",
  "title": "DBX 에이전트 설정",
  "description": "whatap.conf 파일에 설정할 수 있는 옵션에 대해 안내합니다.",
  "source": "@site/docs/tibero/agent-dbx-setttings.mdx",
  "sourceDirName": "tibero",
  "slug": "/tibero/agent-dbx-settings",
  "permalink": "/whatap-docs/tibero/agent-dbx-settings",
  "draft": false,
  "unlisted": false,
  "editUrl": "undefined/docs/tibero/agent-dbx-setttings.mdx",
  "tags": [],
  "version": "current",
  "frontMatter": {
    "id": "agent-dbx-settings",
  ...
  "next": {
    "title": "XOS 에이전트 설정",
    "permalink": "/whatap-docs/tibero/agent-xos-settings"
  }
};
const assets = {
