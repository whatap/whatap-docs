"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["76624"], {
...
"72445": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_postgresql_set_event_history_mdx_bd9_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-postgresql-set-event-history-mdx-bd9.json
var site_docs_postgresql_set_event_history_mdx_bd9_namespaceObject = JSON.parse('{"id":"postgresql/set-event-history","title":"이벤트 기록","description":"이벤트 기록 메뉴를 통해 발생한 경고 알림 이력을 확인할 수 있습니다.","source":"@site/docs/postgresql/set-event-history.mdx","sourceDirName":"postgresql","slug":"/postgresql/set-event-history","permalink":"/postgresql/set-event-history","draft":false,"unlisted":false,"editUrl":"undefined/docs/postgresql/set-event-history.mdx","tags":[],"version":"current","frontMatter":{"id":"set-event-history","title":"이벤트 기록","description":"이벤트 기록 메뉴를 통해 발생한 경고 알림 이력을 확인할 수 있습니다.","keywords":["PostgreSQL","경고 알림","이벤트 기록","데이터베이스 모니터링"],"isTranslationMissing":false},"sidebar":"postgreSidebar","previous":{"title":"이벤트 수신 설정","permalink":"/postgresql/set-receive-event"},"next":{"title":"이벤트 수신 포맷","permalink":"/postgresql/set-event-format"}}')
...
;// CONCATENATED MODULE: ./docs/postgresql/set-event-history.mdx
