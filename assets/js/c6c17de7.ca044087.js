"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["71258"], {
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_redis_agent_dbx_settings_mdx_c6c_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-redis-agent-dbx-settings-mdx-c6c.json
var site_docs_redis_agent_dbx_settings_mdx_c6c_namespaceObject = JSON.parse('{"id":"redis/agent-dbx-settings","title":"DBX 에이전트 설정","description":"Redis 데이터베이스에서 whatap.conf 파일에 설정할 수 있는 옵션에 대해 안내합니다.","source":"@site/docs/redis/agent-dbx-settings.mdx","sourceDirName":"redis","slug":"/redis/agent-dbx-settings","permalink":"/redis/agent-dbx-settings","draft":false,"unlisted":false,"editUrl":"undefined/docs/redis/agent-dbx-settings.mdx","tags":[],"version":"current","frontMatter":{"id":"agent-dbx-settings","title":"DBX 에이전트 설정","description":"Redis 데이터베이스에서 whatap.conf 파일에 설정할 수 있는 옵션에 대해 안내합니다.","keywords":["Redis","데이터베이스","DBX 에이전트"],"isTranslationMissing":false},"sidebar":"redisSidebar","previous":{"title":"설정하기","permalink":"/redis/agent-settings"},"next":{"title":"XOS 에이전트 설정","permalink":"/redis/agent-xos-settings"}}')
...
;// CONCATENATED MODULE: ./docs/redis/agent-dbx-settings.mdx
