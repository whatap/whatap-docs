"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["23850"], {
...
"87094": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_log_set_receive_event_mdx_39b_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-log-set-receive-event-mdx-39b.json
var site_docs_log_set_receive_event_mdx_39b_namespaceObject = JSON.parse('{"id":"log/set-receive-event","title":"이벤트 수신 설정","description":"프로젝트에 포함하는 멤버들의 경고 알림 수신과 관련한 다양한 기능을 설정할 수 있습니다.","source":"@site/docs/log/set-receive-event.mdx","sourceDirName":"log","slug":"/log/set-receive-event","permalink":"/log/set-receive-event","draft":false,"unlisted":false,"editUrl":"undefined/docs/log/set-receive-event.mdx","tags":[],"version":"current","frontMatter":{"id":"set-receive-event","title":"이벤트 수신 설정","description":"프로젝트에 포함하는 멤버들의 경고 알림 수신과 관련한 다양한 기능을 설정할 수 있습니다.","keywords":["로그 모니터링","경고 알림","이벤트 수신 태그"],"isTranslationMissing":false},"sidebar":"logSidebar","previous":{"title":"알림 설정하기","permalink":"/log/set-notice"},"next":{"title":"이벤트 기록","permalink":"/log/set-event-history"}}')
...
;// CONCATENATED MODULE: ./docs/log/set-receive-event.mdx
