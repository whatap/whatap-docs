...
"2137": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_nodejs_supported_spec_mdx_3bc_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-nodejs-supported-spec-mdx-3bc.json
var site_docs_nodejs_supported_spec_mdx_3bc_namespaceObject = JSON.parse('{"id":"nodejs/supported-spec","title":"Node.js 지원 환경","description":"와탭 모니터링 서비스가 동작하는 Node.js 애플리케이션 서버의 기본 사양을 알아보세요.","source":"@site/docs/nodejs/supported-spec.mdx","sourceDirName":"nodejs","slug":"/nodejs/supported-spec","permalink":"/nodejs/supported-spec","draft":false,"unlisted":false,"editUrl":"undefined/docs/nodejs/supported-spec.mdx","tags":[],"version":"current","frontMatter":{"id":"supported-spec","title":"Node.js 지원 환경","description":"와탭 모니터링 서비스가 동작하는 Node.js 애플리케이션 서버의 기본 사양을 알아보세요.","keywords":["Node.js"],"isTranslationMissing":false},"sidebar":"nodejsSidebar","previous":{"title":"Node.js 모니터링","permalink":"/nodejs/introduction"},"next":{"title":"Node.js 에이전트 설치","permalink":"/nodejs/install-agent"}}')
...
;// CONCATENATED MODULE: ./docs/nodejs/supported-spec.mdx
