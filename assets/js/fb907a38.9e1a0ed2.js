"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["98781"], {
"48454": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_browser_metric_warning_notice_new_mdx_fb9_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-browser-metric-warning-notice-new-mdx-fb9.json
var site_docs_browser_metric_warning_notice_new_mdx_fb9_namespaceObject = JSON.parse('{"id":"browser/metric-warning-notice-new","title":"메트릭스 경고 알림","description":"구체적이고 복잡한 이벤트를 설정하려면 메트릭스 이벤트 설정을 사용하세요.","source":"@site/docs/browser/metric-warning-notice-new.mdx","sourceDirName":"browser","slug":"/browser/metric-warning-notice-new","permalink":"/browser/metric-warning-notice-new","draft":false,"unlisted":false,"editUrl":"undefined/docs/browser/metric-warning-notice-new.mdx","tags":[],"version":"current","frontMatter":{"id":"metric-warning-notice-new","title":"메트릭스 경고 알림","description":"구체적이고 복잡한 이벤트를 설정하려면 메트릭스 이벤트 설정을 사용하세요.","displayed_sidebar":"rumsSidebar","keywords":["브라우저","경고 알림","메트릭스 이벤트"],"isTranslationMissing":false},"sidebar":"rumsSidebar"}')
...
// EXTERNAL MODULE: ./docs/common-items/_metrics-warning-notice-browser.mdx
var _metrics_warning_notice_browser = __webpack_require__("89748");
;// CONCATENATED MODULE: ./docs/browser/metric-warning-notice-new.mdx
...
const toc = [..._metric_warning_notice_new/* toc */.d$, ..._event_config_v3_json_share/* toc */.d$, ..._event_config_v2_search/* toc */.d$, ..._metrics_event_condition_select_target_guide/* toc */.d$, ..._metrics_warning_notice_browser/* toc */.d$];
...
"89748": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
__webpack_require__.d(__webpack_exports__, {
  ZP: function() { return MDXContent; },
  d$: function() { return toc; }
});
