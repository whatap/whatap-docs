"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["79698"], {
...
"41309": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_postgresql_agent_xos_settings_mdx_449_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-postgresql-agent-xos-settings-mdx-449.json
var site_docs_postgresql_agent_xos_settings_mdx_449_namespaceObject = JSON.parse('{"id":"postgresql/agent-xos-settings","title":"XOS 에이전트 설정","description":"데이터베이스 서버의 자원을 추가로 모니터링하기 위한 설정 방법을 제공합니다.","source":"@site/docs/postgresql/agent-xos-settings.mdx","sourceDirName":"postgresql","slug":"/postgresql/agent-xos-settings","permalink":"/postgresql/agent-xos-settings","draft":false,"unlisted":false,"editUrl":"undefined/docs/postgresql/agent-xos-settings.mdx","tags":[],"version":"current","frontMatter":{"id":"agent-xos-settings","title":"XOS 에이전트 설정","description":"데이터베이스 서버의 자원을 추가로 모니터링하기 위한 설정 방법을 제공합니다.","keywords":["PostgreSQL","데이터베이스 모니터링","XOS 에이전트"],"isTranslationMissing":false},"sidebar":"postgreSidebar","previous":{"title":"DBX 에이전트 설정","permalink":"/postgresql/agent-dbx-settings"},"next":{"title":"클라우드 설정","permalink":"/postgresql/cloudsettings"}}')
...
;// CONCATENATED MODULE: ./docs/postgresql/agent-xos-settings.mdx
