"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["682"], {
"21610": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_browser_ipload_stat_mdx_194_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-browser-ipload-stat-mdx-194.json
var site_docs_browser_ipload_stat_mdx_194_namespaceObject = JSON.parse('{"id":"browser/ipload-stat","title":"IP 로드 통계","description":"IP 로드 통계는 웹 사이트에 접속한 IP 주소별 로드 성능 정보를 제공합니다.","source":"@site/docs/browser/ipload-stat.mdx","sourceDirName":"browser","slug":"/browser/ipload-stat","permalink":"/browser/ipload-stat","draft":false,"unlisted":false,"editUrl":"undefined/docs/browser/ipload-stat.mdx","tags":[],"version":"current","frontMatter":{"id":"ipload-stat","title":"IP 로드 통계","description":"IP 로드 통계는 웹 사이트에 접속한 IP 주소별 로드 성능 정보를 제공합니다.","keywords":["브라우저 모니터링","페이지 로드","통계"],"isTranslationMissing":false},"sidebar":"rumsSidebar","previous":{"title":"페이지 로드 통계","permalink":"/browser/pageload-stat"},"next":{"title":"메트릭스","permalink":"/browser/metrics-intro"}}')
