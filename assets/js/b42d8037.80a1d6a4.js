"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[87165],{
...
const metadata = {
  "id": "server/flexboard-widget-template",
  "title": "위젯 템플릿",
  "description": "Flex 보드에서 대시보드에 배치할 수 있는 위젯의 종류를 안내합니다.",
  "source": "@site/docs/server/flexboard-widget-template.mdx",
  "sourceDirName": "server",
  "slug": "/server/flexboard-widget-template",
  "permalink": "/whatap-docs/server/flexboard-widget-template",
  "draft": false,
  "unlisted": false,
  "editUrl": "undefined/docs/server/flexboard-widget-template.mdx",
  "tags": [],
  "version": "current",
  "frontMatter": {
    "id": "flexboard-widget-template",
