"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[55598],{
...
const metadata = {
  "id": "mssql-v1/set-event-detect-anomal",
  "title": "이상치 탐지 경고 알림",
  "description": "예상치 못한 패턴을 찾는 일련의 활동을 탐지해 경고 알림을 보내도록 설정할 수 있습니다.",
  "source": "@site/docs/mssql-v1/set-event-detect-anomal.mdx",
  "sourceDirName": "mssql-v1",
  "slug": "/mssql-v1/set-event-detect-anomal",
  "permalink": "/whatap-docs/mssql-v1/set-event-detect-anomal",
  "draft": false,
  "unlisted": false,
  "editUrl": "undefined/docs/mssql-v1/set-event-detect-anomal.mdx",
  "tags": [],
  "version": "current",
  "frontMatter": {
    "id": "set-event-detect-anomal",
