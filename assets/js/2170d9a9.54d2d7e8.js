"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[64630],{
...
const metadata = {
  "id": "mssql/common-alert",
  "title": "시스템 이벤트 안내",
  "description": "와탭 모니터링에서는 플랫폼 전반에서 자동으로 탐지 및 생성되는 공용 이벤트에 대해 안내합니다.",
  "source": "@site/docs/mssql/common-alert.mdx",
  "sourceDirName": "mssql",
  "slug": "/mssql/common-alert",
  "permalink": "/whatap-docs/mssql/common-alert",
  "draft": false,
  "unlisted": false,
  "editUrl": "undefined/docs/mssql/common-alert.mdx",
  "tags": [],
  "version": "current",
  "frontMatter": {
    "id": "common-alert",
