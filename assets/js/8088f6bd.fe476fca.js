"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["26801"], {
...
"26296": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_oracle_pro_stat_mdx_808_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-oracle-pro-stat-mdx-808.json
var site_docs_oracle_pro_stat_mdx_808_namespaceObject = JSON.parse('{"id":"oracle-pro/stat","title":"SQL 통계","description":"Oracle의 데이터베이스별 통계 데이터를 제공합니다.","source":"@site/docs/oracle-pro/stat.mdx","sourceDirName":"oracle-pro","slug":"/oracle-pro/stat","permalink":"/oracle-pro/stat","draft":false,"unlisted":false,"editUrl":"undefined/docs/oracle-pro/stat.mdx","tags":[],"version":"current","frontMatter":{"id":"stat","title":"SQL 통계","description":"Oracle의 데이터베이스별 통계 데이터를 제공합니다.","keywords":["Oracle Pro","데이터베이스","통계"],"isTranslationMissing":false},"sidebar":"dboracledmaSidebar","previous":{"title":"메트릭스 이상 탐지","permalink":"/oracle-pro/metrics-detect-anormal"},"next":{"title":"테이블스페이스 사이즈","permalink":"/oracle-pro/table-space-size"}}')
...
;// CONCATENATED MODULE: ./docs/oracle-pro/stat.mdx
...
const toc = [..._db_stat_sql_desc/* toc */.d$, ..._db_stat_sql_basic/* toc */.d$, ..._db_stat_sql_view_query/* toc */.d$, ..._db_stat_sql_view_query_details_summary/* toc */.d$, ..._db_product_sql_stat_query_details/* toc */.d$, ..._db_sql_filter/* toc */.d$, ..._db_v2_data_edit_column/* toc */.d$];
function _createMdxContent(props) {
