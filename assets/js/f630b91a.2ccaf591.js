"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["8078"], {
...
"67282": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_cubrid_labs_mdx_f63_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-cubrid-labs-mdx-f63.json
var site_docs_cubrid_labs_mdx_f63_namespaceObject = JSON.parse('{"id":"cubrid/labs","title":"실험실","description":"사용자에게 새로운 기능 또는 실험적인 기능을 제공하는 메뉴인 실험실에 대해 안내합니다.","source":"@site/docs/cubrid/labs.mdx","sourceDirName":"cubrid","slug":"/cubrid/labs","permalink":"/cubrid/labs","draft":false,"unlisted":false,"editUrl":"undefined/docs/cubrid/labs.mdx","tags":[],"version":"current","frontMatter":{"id":"labs","title":"실험실","description":"사용자에게 새로운 기능 또는 실험적인 기능을 제공하는 메뉴인 실험실에 대해 안내합니다.","keywords":["CUBRID","데이터베이스","실험실"],"isTranslationMissing":false},"sidebar":"cubridSidebar","previous":{"title":"시스템 이벤트 안내","permalink":"/cubrid/common-alert"}}')
...
;// CONCATENATED MODULE: ./docs/cubrid/labs.mdx
