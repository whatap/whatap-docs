"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["92637"], {
...
"32274": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_mysql_agent_settings_mdx_7ce_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-mysql-agent-settings-mdx-7ce.json
var site_docs_mysql_agent_settings_mdx_7ce_namespaceObject = JSON.parse('{"id":"mysql/agent-settings","title":"설정하기","description":"데이터베이스 에이전트 서버에 있는 whatap.conf 파일을 통해 설정할 수 있는 옵션에 대해 알아봅니다.","source":"@site/docs/mysql/agent-settings.mdx","sourceDirName":"mysql","slug":"/mysql/agent-settings","permalink":"/mysql/agent-settings","draft":false,"unlisted":false,"editUrl":"undefined/docs/mysql/agent-settings.mdx","tags":[],"version":"current","frontMatter":{"id":"agent-settings","title":"설정하기","description":"데이터베이스 에이전트 서버에 있는 whatap.conf 파일을 통해 설정할 수 있는 옵션에 대해 알아봅니다.","keywords":["MySQL","데이터베이스","데이터베이스 모니터링"],"isTranslationMissing":false},"sidebar":"mysqlSidebar","previous":{"title":"설치 문제 해결","permalink":"/mysql/troubleshooting"},"next":{"title":"DBX 에이전트 설정","permalink":"/mysql/agent-dbx-settings"}}')
...
;// CONCATENATED MODULE: ./docs/mysql/agent-settings.mdx
