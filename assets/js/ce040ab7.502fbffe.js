"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["50693"], {
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_oracle_pro_set_event_detect_anomal_mdx_ce0_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-oracle-pro-set-event-detect-anomal-mdx-ce0.json
var site_docs_oracle_pro_set_event_detect_anomal_mdx_ce0_namespaceObject = JSON.parse('{"id":"oracle-pro/set-event-detect-anomal","title":"이상치 탐지 경고 알림","description":"예상치 못한 패턴을 찾는 일련의 활동을 탐지해 경고 알림을 보내도록 설정할 수 있습니다.","source":"@site/docs/oracle-pro/set-event-detect-anomal.mdx","sourceDirName":"oracle-pro","slug":"/oracle-pro/set-event-detect-anomal","permalink":"/oracle-pro/set-event-detect-anomal","draft":false,"unlisted":false,"editUrl":"undefined/docs/oracle-pro/set-event-detect-anomal.mdx","tags":[],"version":"current","frontMatter":{"id":"set-event-detect-anomal","title":"이상치 탐지 경고 알림","description":"예상치 못한 패턴을 찾는 일련의 활동을 탐지해 경고 알림을 보내도록 설정할 수 있습니다.","keywords":["Oracle Pro","경고 알림","이상치 탐지","데이터베이스"],"isTranslationMissing":false},"sidebar":"dboracledmaSidebar","previous":{"title":"알림 메시지 사용자 정의","permalink":"/oracle-pro/set-notification-message"},"next":{"title":"이벤트 수신 설정","permalink":"/oracle-pro/set-receive-event"}}')
...
;// CONCATENATED MODULE: ./docs/oracle-pro/set-event-detect-anomal.mdx
