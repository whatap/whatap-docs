"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["44037"], {
...
"70460": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_mssql_report_intro_mdx_101_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-mssql-report-intro-mdx-101.json
var site_docs_mssql_report_intro_mdx_101_namespaceObject = JSON.parse('{"id":"mssql/report-intro","title":"보고서","description":"개별 프로젝트에 대해 서비스 이용 현황과 장애 발생 기록을 보고하는 문서에 대해 알아봅니다.","source":"@site/docs/mssql/report-intro.mdx","sourceDirName":"mssql","slug":"/mssql/report-intro","permalink":"/mssql/report-intro","draft":false,"unlisted":false,"editUrl":"undefined/docs/mssql/report-intro.mdx","tags":[],"version":"current","frontMatter":{"id":"report-intro","title":"보고서","description":"개별 프로젝트에 대해 서비스 이용 현황과 장애 발생 기록을 보고하는 문서에 대해 알아봅니다.","keywords":["SQL Server","데이터베이스","보고서"],"isTranslationMissing":false},"sidebar":"mssqlSidebar","previous":{"title":"데이터베이스 사이즈","permalink":"/mssql/database-size"},"next":{"title":"Job 수행내역","permalink":"/mssql/job-info"}}')
...
;// CONCATENATED MODULE: ./docs/mssql/report-intro.mdx
