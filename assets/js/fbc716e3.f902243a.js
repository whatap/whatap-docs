"use strict";
(self["webpackChunkwhatap_origin"] = self["webpackChunkwhatap_origin"] || []).push([[24878],{
...
const metadata = {
    "unversionedId": "kubernetes/set-notification-message",
    "id": "kubernetes/set-notification-message",
    "title": "알림 메시지 사용자 정의",
    "description": "프로젝트 멤버에게 전달되는 경고 알림 메시지를 수정할 수 있는 사용자 정의 기능을 제공합니다.",
    "source": "@site/docs/kubernetes/set-notification-message.mdx",
    "sourceDirName": "kubernetes",
    "slug": "/kubernetes/set-notification-message",
    "permalink": "/whatap-docs/kubernetes/set-notification-message",
    "draft": false,
    "editUrl": "undefined/docs/kubernetes/set-notification-message.mdx",
    "tags": [
        {
            "label": "쿠버네티스",
    ...
    "next": {
        ...
        "permalink": "/whatap-docs/kubernetes/hitmap-notice"
    }
};
const assets = {};
const toc = [
