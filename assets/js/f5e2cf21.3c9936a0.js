"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["37678"], {
...
"99770": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_tibero_flexboard_share_mdx_f5e_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-tibero-flexboard-share-mdx-f5e.json
var site_docs_tibero_flexboard_share_mdx_f5e_namespaceObject = JSON.parse('{"id":"tibero/flexboard-share","title":"Flex 보드 공유하기","description":"Flex 보드를 다른 계정의 사용자와 공유하고 재사용할 수 있습니다.","source":"@site/docs/tibero/flexboard-share.mdx","sourceDirName":"tibero","slug":"/tibero/flexboard-share","permalink":"/tibero/flexboard-share","draft":false,"unlisted":false,"editUrl":"undefined/docs/tibero/flexboard-share.mdx","tags":[],"version":"current","frontMatter":{"id":"flexboard-share","title":"Flex 보드 공유하기","description":"Flex 보드를 다른 계정의 사용자와 공유하고 재사용할 수 있습니다.","keywords":["Tibero","Flex 보드"],"isTranslationMissing":false},"sidebar":"tiberoSidebar","previous":{"title":"Flex 보드 화면 모드","permalink":"/tibero/flexboard-mode"},"next":{"title":"카운트 추이 및 비교","permalink":"/tibero/analysis-count-trend"}}')
...
;// CONCATENATED MODULE: ./docs/tibero/flexboard-share.mdx
