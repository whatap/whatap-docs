"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["32054"], {
...
"61033": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_postgresql_set_receive_event_mdx_a5f_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-postgresql-set-receive-event-mdx-a5f.json
var site_docs_postgresql_set_receive_event_mdx_a5f_namespaceObject = JSON.parse('{"id":"postgresql/set-receive-event","title":"이벤트 수신 설정","description":"프로젝트에 포함하는 멤버들의 경고 알림 수신과 관련한 다양한 기능을 설정할 수 있습니다.","source":"@site/docs/postgresql/set-receive-event.mdx","sourceDirName":"postgresql","slug":"/postgresql/set-receive-event","permalink":"/postgresql/set-receive-event","draft":false,"unlisted":false,"editUrl":"undefined/docs/postgresql/set-receive-event.mdx","tags":[],"version":"current","frontMatter":{"id":"set-receive-event","title":"이벤트 수신 설정","description":"프로젝트에 포함하는 멤버들의 경고 알림 수신과 관련한 다양한 기능을 설정할 수 있습니다.","keywords":["PostgreSQL","경고 알림","이벤트 수신 태그","데이터베이스 모니터링"],"isTranslationMissing":false},"sidebar":"postgreSidebar","previous":{"title":"로그 알림 설정하기","permalink":"/postgresql/set-event-log"},"next":{"title":"이벤트 기록","permalink":"/postgresql/set-event-history"}}')
...
;// CONCATENATED MODULE: ./docs/postgresql/set-receive-event.mdx
