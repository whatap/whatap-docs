"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["65444"], {
"8449": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_azure_set_event_history_mdx_fa9_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-azure-set-event-history-mdx-fa9.json
var site_docs_azure_set_event_history_mdx_fa9_namespaceObject = JSON.parse('{"id":"azure/set-event-history","title":"이벤트 기록","description":"이벤트 기록 메뉴를 통해 발생한 경고 알림 이력을 확인할 수 있습니다.","source":"@site/docs/azure/set-event-history.mdx","sourceDirName":"azure","slug":"/azure/set-event-history","permalink":"/azure/set-event-history","draft":false,"unlisted":false,"editUrl":"undefined/docs/azure/set-event-history.mdx","tags":[],"version":"current","frontMatter":{"id":"set-event-history","title":"이벤트 기록","description":"이벤트 기록 메뉴를 통해 발생한 경고 알림 이력을 확인할 수 있습니다.","keywords":["Azure Monitor","클라우드","경고 알림","이벤트 기록"],"isTranslationMissing":false},"sidebar":"azuremonitorSidebar","previous":{"title":"이벤트 수신 설정","permalink":"/azure/set-receive-event"},"next":{"title":"실시간 알림","permalink":"/azure/real-time-notification"}}')
...
;// CONCATENATED MODULE: ./docs/azure/set-event-history.mdx
