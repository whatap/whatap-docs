"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["91572"], {
"95839": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_browser_labs_mdx_f02_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-browser-labs-mdx-f02.json
var site_docs_browser_labs_mdx_f02_namespaceObject = JSON.parse('{"id":"browser/labs","title":"실험실","description":"사용자에게 새로운 기능 또는 실험적인 기능을 제공하는 메뉴인 실험실에 대해 안내합니다.","source":"@site/docs/browser/labs.mdx","sourceDirName":"browser","slug":"/browser/labs","permalink":"/browser/labs","draft":false,"unlisted":false,"editUrl":"undefined/docs/browser/labs.mdx","tags":[],"version":"current","frontMatter":{"id":"labs","title":"실험실","description":"사용자에게 새로운 기능 또는 실험적인 기능을 제공하는 메뉴인 실험실에 대해 안내합니다.","keywords":["브라우저","실험실"],"isTranslationMissing":false},"sidebar":"rumsSidebar","previous":{"title":"브라우저 에이전트 수집 데이터","permalink":"/browser/collect-data"}}')
...
;// CONCATENATED MODULE: ./docs/browser/labs.mdx
