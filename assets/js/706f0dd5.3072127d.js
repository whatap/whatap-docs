"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["50491"], {
...
"41519": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_oracle_cloud_set_event_history_mdx_706_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-oracle-cloud-set-event-history-mdx-706.json
var site_docs_oracle_cloud_set_event_history_mdx_706_namespaceObject = JSON.parse('{"id":"oracle-cloud/set-event-history","title":"이벤트 기록","description":"이벤트 기록 메뉴를 통해 발생한 경고 알림 이력을 확인할 수 있습니다.","source":"@site/docs/oracle-cloud/set-event-history.mdx","sourceDirName":"oracle-cloud","slug":"/oracle-cloud/set-event-history","permalink":"/oracle-cloud/set-event-history","draft":false,"unlisted":false,"editUrl":"undefined/docs/oracle-cloud/set-event-history.mdx","tags":[],"version":"current","frontMatter":{"id":"set-event-history","title":"이벤트 기록","description":"이벤트 기록 메뉴를 통해 발생한 경고 알림 이력을 확인할 수 있습니다.","keywords":["Oracle Cloud Monitor","클라우드","경고 알림","이벤트 기록"],"isTranslationMissing":false},"sidebar":"oracleSidebar","previous":{"title":"이벤트 수신 설정","permalink":"/oracle-cloud/set-receive-event"},"next":{"title":"실시간 알림","permalink":"/oracle-cloud/real-time-notification"}}')
...
;// CONCATENATED MODULE: ./docs/oracle-cloud/set-event-history.mdx
