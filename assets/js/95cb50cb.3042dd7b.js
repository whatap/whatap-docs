"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["46826"], {
...
"51016": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_php_metrics_performance_counter_mdx_95c_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-php-metrics-performance-counter-mdx-95c.json
var site_docs_php_metrics_performance_counter_mdx_95c_namespaceObject = JSON.parse('{"id":"php/metrics-performance-counter","title":"애플리케이션 성능 카운터","description":"성능 카운터를 안내합니다.","source":"@site/docs/php/metrics-performance-counter.mdx","sourceDirName":"php","slug":"/php/metrics-performance-counter","permalink":"/php/metrics-performance-counter","draft":false,"unlisted":false,"editUrl":"undefined/docs/php/metrics-performance-counter.mdx","tags":[],"version":"current","frontMatter":{"id":"metrics-performance-counter","title":"애플리케이션 성능 카운터","description":"성능 카운터를 안내합니다.","keywords":["PHP","메트릭스","애플리케이션","성능 카운터","UI"],"isTranslationMissing":false},"sidebar":"phpSidebar","previous":{"title":"애플리케이션 지표","permalink":"/php/metrics-app"},"next":{"title":"메트릭스 차트","permalink":"/php/metrics-chart-v2"}}')
...
;// CONCATENATED MODULE: ./docs/php/metrics-performance-counter.mdx
