"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["22487"], {
...
"12540": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_tibero_agent_xos_settings_mdx_cf7_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-tibero-agent-xos-settings-mdx-cf7.json
var site_docs_tibero_agent_xos_settings_mdx_cf7_namespaceObject = JSON.parse('{"id":"tibero/agent-xos-settings","title":"XOS 에이전트 설정","description":"데이터베이스 프로세스 모니터링 설정에 대해 알아봅니다.","source":"@site/docs/tibero/agent-xos-settings.mdx","sourceDirName":"tibero","slug":"/tibero/agent-xos-settings","permalink":"/tibero/agent-xos-settings","draft":false,"unlisted":false,"editUrl":"undefined/docs/tibero/agent-xos-settings.mdx","tags":[],"version":"current","frontMatter":{"id":"agent-xos-settings","title":"XOS 에이전트 설정","description":"데이터베이스 프로세스 모니터링 설정에 대해 알아봅니다.","keywords":["Tibero","데이터베이스","에이전트","XOS"],"isTranslationMissing":false},"sidebar":"tiberoSidebar","previous":{"title":"DBX 에이전트 설정","permalink":"/tibero/agent-dbx-settings"},"next":{"title":"관리하기","permalink":"/tibero/agent-manage"}}')
