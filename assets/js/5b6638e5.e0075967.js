"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["50"], {
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_focus_focus_usage_mdx_5b6_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-focus-focus-usage-mdx-5b6.json
var site_docs_focus_focus_usage_mdx_5b6_namespaceObject = JSON.parse('{"id":"focus/focus-usage","title":"사용 예시","description":"와탭 Focus의 사용 예시를 안내합니다.","source":"@site/docs/focus/focus-usage.mdx","sourceDirName":"focus","slug":"/focus/focus-usage","permalink":"/focus/focus-usage","draft":false,"unlisted":false,"editUrl":"undefined/docs/focus/focus-usage.mdx","tags":[],"version":"current","frontMatter":{"id":"focus-usage","title":"사용 예시","description":"와탭 Focus의 사용 예시를 안내합니다.","keywords":["Focus","사용 예시"],"isTranslationMissing":false},"sidebar":"pluginSidebar","previous":{"title":"설정하기","permalink":"/focus/focus-setting"},"next":{"title":"Telegraf란?","permalink":"/telegraf/introduction"}}')
...
;// CONCATENATED MODULE: ./docs/focus/focus-usage.mdx
