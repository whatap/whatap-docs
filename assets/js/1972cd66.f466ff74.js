"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["63462"], {
...
"90321": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_dotnet_trs_view_mdx_197_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-dotnet-trs-view-mdx-197.json
var site_docs_dotnet_trs_view_mdx_197_namespaceObject = JSON.parse('{"id":"dotnet/trs-view","title":"트랜잭션 분석하기","description":"트랜잭션 관련 메뉴 화면을 안내합니다.","source":"@site/docs/dotnet/trs-view.mdx","sourceDirName":"dotnet","slug":"/dotnet/trs-view","permalink":"/dotnet/trs-view","draft":false,"unlisted":false,"editUrl":"undefined/docs/dotnet/trs-view.mdx","tags":[],"version":"current","frontMatter":{"id":"trs-view","title":"트랜잭션 분석하기","description":"트랜잭션 관련 메뉴 화면을 안내합니다.","keywords":[".NET","트랜잭션","트랜잭션 분석하기","히트맵","UI"],"isTranslationMissing":false},"sidebar":"dotNetSidebar","previous":{"title":"트랜잭션","permalink":"/dotnet/track-transactions-intro"},"next":{"title":"트랜잭션 트레이싱","permalink":"/dotnet/trs-profile"}}')
...
;// CONCATENATED MODULE: ./docs/dotnet/trs-view.mdx
