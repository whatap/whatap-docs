"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[59335],{
...
const metadata = {
  ...
  "title": "설정하기",
  "description": "데이터베이스 에이전트 서버에 있는 whatap.conf 파일을 통해 설정할 수 있는 옵션에 대해 알아봅니다.",
  "source": "@site/docs/cubrid/agent-settings.mdx",
  "sourceDirName": "cubrid",
  "slug": "/cubrid/agent-settings",
  "permalink": "/whatap-docs/cubrid/agent-settings",
  "draft": false,
  "unlisted": false,
  "editUrl": "undefined/docs/cubrid/agent-settings.mdx",
  "tags": [],
  "version": "current",
  "frontMatter": {
    "id": "agent-settings",
