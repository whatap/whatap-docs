"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["5947"], {
...
"90818": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_cubrid_log_db_mdx_fb4_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-cubrid-log-db-mdx-fb4.json
var site_docs_cubrid_log_db_mdx_fb4_namespaceObject = JSON.parse('{"id":"cubrid/log-db","title":"적용하기","description":"데이터베이스와 AWS RDS의 로그를 수집하는 방법을 안내합니다.","source":"@site/docs/cubrid/log-db.mdx","sourceDirName":"cubrid","slug":"/cubrid/log-db","permalink":"/cubrid/log-db","draft":false,"unlisted":false,"editUrl":"undefined/docs/cubrid/log-db.mdx","tags":[],"version":"current","frontMatter":{"id":"log-db","title":"적용하기","description":"데이터베이스와 AWS RDS의 로그를 수집하는 방법을 안내합니다.","keywords":["로그 모니터링","데이터베이스","CUBRID"],"isTranslationMissing":false},"sidebar":"cubridSidebar","previous":{"title":"로그","permalink":"/cubrid/log-main"},"next":{"title":"라이브 테일","permalink":"/cubrid/log-lt"}}')
...
;// CONCATENATED MODULE: ./docs/cubrid/log-db.mdx
