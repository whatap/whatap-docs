"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[47013],{
...
const metadata = {
  "id": "oracle-v2/report-intro",
  "title": "보고서",
  "description": "개별 프로젝트에 대해 서비스 이용 현황과 장애 발생 기록을 보고하는 문서에 대해 알아봅니다.",
  "source": "@site/docs/oracle-v2/report-intro.mdx",
  "sourceDirName": "oracle-v2",
  "slug": "/oracle-v2/report-intro",
  "permalink": "/whatap-docs/oracle-v2/report-intro",
  "draft": false,
  "unlisted": false,
  "editUrl": "undefined/docs/oracle-v2/report-intro.mdx",
  "tags": [
    {
      "inline": true,
      "label": "Oracle",
