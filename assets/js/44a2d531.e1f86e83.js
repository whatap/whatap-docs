"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["55937"], {
...
"35383": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_oracle_log_db_mdx_44a_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-oracle-log-db-mdx-44a.json
var site_docs_oracle_log_db_mdx_44a_namespaceObject = JSON.parse('{"id":"oracle/log-db","title":"적용하기","description":"데이터베이스와 AWS RDS의 로그를 수집하는 방법을 안내합니다.","source":"@site/docs/oracle/log-db.mdx","sourceDirName":"oracle","slug":"/oracle/log-db","permalink":"/oracle/log-db","draft":false,"unlisted":false,"editUrl":"undefined/docs/oracle/log-db.mdx","tags":[],"version":"current","frontMatter":{"id":"log-db","title":"적용하기","description":"데이터베이스와 AWS RDS의 로그를 수집하는 방법을 안내합니다.","keywords":["로그 모니터링","데이터베이스","Oracle"],"isTranslationMissing":false},"sidebar":"dboracleV2Sidebar","previous":{"title":"로그","permalink":"/oracle/log-main"},"next":{"title":"라이브 테일","permalink":"/oracle/log-lt"}}')
...
;// CONCATENATED MODULE: ./docs/oracle/log-db.mdx
