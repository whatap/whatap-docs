"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["70958"], {
...
"80112": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_mysql_stat_mdx_5db_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-mysql-stat-mdx-5db.json
var site_docs_mysql_stat_mdx_5db_namespaceObject = JSON.parse('{"id":"mysql/stat","title":"SQL 통계","description":"MySQL의 데이터베이스별 통계 데이터를 제공합니다.","source":"@site/docs/mysql/stat.mdx","sourceDirName":"mysql","slug":"/mysql/stat","permalink":"/mysql/stat","draft":false,"unlisted":false,"editUrl":"undefined/docs/mysql/stat.mdx","tags":[],"version":"current","frontMatter":{"id":"stat","title":"SQL 통계","description":"MySQL의 데이터베이스별 통계 데이터를 제공합니다.","keywords":["MySQL","데이터베이스","통계"],"isTranslationMissing":false},"sidebar":"mysqlSidebar","previous":{"title":"메트릭스 이상 탐지","permalink":"/mysql/metrics-detect-anormal"},"next":{"title":"MYSQL SQL 통계","permalink":"/mysql/mysql-sql-stat"}}')
...
;// CONCATENATED MODULE: ./docs/mysql/stat.mdx
