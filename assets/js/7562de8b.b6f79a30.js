"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["61406"], {
...
"36037": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_mysql_set_event_format_mdx_756_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-mysql-set-event-format-mdx-756.json
var site_docs_mysql_set_event_format_mdx_756_namespaceObject = JSON.parse('{"id":"mysql/set-event-format","title":"이벤트 수신 포맷","description":"데이터베이스 모니터링에서 제공하는 경고 알림의 이벤트 수신 포맷에 대해 알아봅니다.","source":"@site/docs/mysql/set-event-format.mdx","sourceDirName":"mysql","slug":"/mysql/set-event-format","permalink":"/mysql/set-event-format","draft":false,"unlisted":false,"editUrl":"undefined/docs/mysql/set-event-format.mdx","tags":[],"version":"current","frontMatter":{"id":"set-event-format","title":"이벤트 수신 포맷","description":"데이터베이스 모니터링에서 제공하는 경고 알림의 이벤트 수신 포맷에 대해 알아봅니다.","keywords":["MySQL","경고 알림","이벤트","데이터베이스","데이터베이스 모니터링","이벤트 수신 포맷"],"isTranslationMissing":false},"sidebar":"mysqlSidebar","previous":{"title":"이벤트 기록","permalink":"/mysql/set-event-history"},"next":{"title":"실시간 알림","permalink":"/mysql/real-time-notification"}}')
...
;// CONCATENATED MODULE: ./docs/mysql/set-event-format.mdx
