"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["30992"], {
"69879": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_server_server_os_sv_other_mdx_2e8_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-server-server-os-sv-other-mdx-2e8.json
var site_docs_server_server_os_sv_other_mdx_2e8_namespaceObject = JSON.parse('{"id":"server/server-os/server-other","title":"서버 컴퓨터 이외의 경우","description":"서버 컴퓨터가 아닌 환경에서 와탭 서버 모니터링 에이전트를 설치하는 방법을 제공합니다.","source":"@site/docs/server/server-os/sv-other.mdx","sourceDirName":"server/server-os","slug":"/server/server-os/server-other","permalink":"/server/server-os/server-other","draft":false,"unlisted":false,"editUrl":"undefined/docs/server/server-os/sv-other.mdx","tags":[],"version":"current","frontMatter":{"id":"server-other","title":"서버 컴퓨터 이외의 경우","description":"서버 컴퓨터가 아닌 환경에서 와탭 서버 모니터링 에이전트를 설치하는 방법을 제공합니다.","keywords":["Server","설치하기","Linux","Windows"],"isTranslationMissing":false},"sidebar":"serverSidebar","previous":{"title":"Windows","permalink":"/server/server-os/server-windows"},"next":{"title":"Elastic Beanstalk","permalink":"/server/server-os/server-aws"}}')
...
;// CONCATENATED MODULE: ./docs/server/server-os/sv-other.mdx
...
function _createMdxContent(props) {
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsx)(_components.p, {
      children: "노트북과 같이 서버 컴퓨터가 아닌 개인용 컴퓨터 및 아이피가 변하는 wifi를 사용하는 환경에서는 다음 옵션을 적용하세요."
      ...
      children: [(0,jsx_runtime.jsx)(TabItem/* default */.Z, {
        ...
        children: (0,jsx_runtime.jsx)(_components.pre, {
          children: (0,jsx_runtime.jsx)(_components.code, {
            ...
            metastring: "title=SH",
            children: "echo \"ipreg=false\" | sudo tee -a /usr/whatap/infra/conf/whatap.conf\nsudo service whatap-infra restart\n"
          })
        })
      ...
      type: "note",
      children: (0,jsx_runtime.jsx)(_components.p, {
        children: "IP가 변경될 때마다 자동으로 다시 등록되지 않아 편리하게 사용할 수 있습니다."
      })
    })]
  });
}
