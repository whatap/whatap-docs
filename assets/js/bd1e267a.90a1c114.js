"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["32975"], {
...
"28577": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_postgresql_log_setting_mdx_bd1_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-postgresql-log-setting-mdx-bd1.json
var site_docs_postgresql_log_setting_mdx_bd1_namespaceObject = JSON.parse('{"id":"postgresql/log-setting","title":"로그 설정","description":"로그 모니터링 설정 방법을 안내합니다.","source":"@site/docs/postgresql/log-setting.mdx","sourceDirName":"postgresql","slug":"/postgresql/log-setting","permalink":"/postgresql/log-setting","draft":false,"unlisted":false,"editUrl":"undefined/docs/postgresql/log-setting.mdx","tags":[],"version":"current","frontMatter":{"id":"log-setting","title":"로그 설정","description":"로그 모니터링 설정 방법을 안내합니다.","toc_max_heading_level":3,"keywords":["로그","로그 모니터링","설정하기","PostgreSQL"],"isTranslationMissing":false},"sidebar":"postgreSidebar","previous":{"title":"로그 검색","permalink":"/postgresql/log-search"},"next":{"title":"로그 파싱하기","permalink":"/postgresql/log-parser"}}')
...
;// CONCATENATED MODULE: ./docs/postgresql/log-setting.mdx
