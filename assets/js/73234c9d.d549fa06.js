"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["31341"], {
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_php_hitmap_notice_mdx_732_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-php-hitmap-notice-mdx-732.json
var site_docs_php_hitmap_notice_mdx_732_namespaceObject = JSON.parse('{"id":"php/hitmap-notice","title":"AI 기반의 히트맵 패턴 경고 알림","description":"애플리케이션 실행 분포 패턴을 머신 러닝을 통해 자동 인식하여 경고 알림을 보냅니다.","source":"@site/docs/php/hitmap-notice.mdx","sourceDirName":"php","slug":"/php/hitmap-notice","permalink":"/php/hitmap-notice","draft":false,"unlisted":false,"editUrl":"undefined/docs/php/hitmap-notice.mdx","tags":[],"version":"current","frontMatter":{"id":"hitmap-notice","title":"AI 기반의 히트맵 패턴 경고 알림","description":"애플리케이션 실행 분포 패턴을 머신 러닝을 통해 자동 인식하여 경고 알림을 보냅니다.","keywords":["PHP","히트맵","경고 알림","애플리케이션","애플리케이션 모니터링"],"isTranslationMissing":false},"sidebar":"phpSidebar","previous":{"title":"알림 메시지 사용자 정의","permalink":"/php/set-notification-message"},"next":{"title":"이상치 탐지 경고 알림","permalink":"/php/set-event-detect-anomal"}}')
...
;// CONCATENATED MODULE: ./docs/php/hitmap-notice.mdx
...
function _createMdxContent(props) {
  return (0,jsx_runtime.jsx)(_hitmap_pattern_notice/* default */.ZP, {});
}
function MDXContent(props = {}) {
  const {wrapper: MDXLayout} = {
