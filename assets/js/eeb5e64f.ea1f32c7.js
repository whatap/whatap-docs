"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["10347"], {
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_mysql_database_size_mdx_eeb_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-mysql-database-size-mdx-eeb.json
var site_docs_mysql_database_size_mdx_eeb_namespaceObject = JSON.parse('{"id":"mysql/database-size","title":"데이터베이스 사이즈","description":"데이터베이스별 테이블의 사이즈를 집계하여 추이 정보를 차트로 제공합니다.","source":"@site/docs/mysql/database-size.mdx","sourceDirName":"mysql","slug":"/mysql/database-size","permalink":"/mysql/database-size","draft":false,"unlisted":false,"editUrl":"undefined/docs/mysql/database-size.mdx","tags":[],"version":"current","frontMatter":{"id":"database-size","title":"데이터베이스 사이즈","description":"데이터베이스별 테이블의 사이즈를 집계하여 추이 정보를 차트로 제공합니다.","keywords":["MySQL","데이터베이스","데이터베이스 사이즈"],"isTranslationMissing":false},"sidebar":"mysqlSidebar","previous":{"title":"테이블 사이즈 증감","permalink":"/mysql/table-size"},"next":{"title":"보고서","permalink":"/mysql/report-intro"}}')
...
;// CONCATENATED MODULE: ./docs/mysql/database-size.mdx
