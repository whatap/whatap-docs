"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[96961],{
...
const metadata = {
  "id": "azure/real-time-notification",
  "title": "실시간 알림",
  "description": "이벤트 설정 메뉴를 통해서 설정한 경고 알림을 실시간으로 확인할 수 있습니다.",
  "source": "@site/docs/azure/real-time-notification.mdx",
  "sourceDirName": "azure",
  "slug": "/azure/real-time-notification",
  "permalink": "/whatap-docs/azure/real-time-notification",
  "draft": false,
  "unlisted": false,
  "editUrl": "undefined/docs/azure/real-time-notification.mdx",
  "tags": [],
  "version": "current",
  "frontMatter": {
    "id": "real-time-notification",
