"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[30464],{
...
const metadata = {
  "id": "oracle-v2/after-install-agent",
  "title": "설치 점검 사항",
  "description": "데이터베이스 모니터링 설치를 모두 완료했습니다. 설치 후 확인 사항을 점검하세요.",
  "source": "@site/docs/oracle-v2/after-install-agent.mdx",
  "sourceDirName": "oracle-v2",
  "slug": "/oracle-v2/after-install-agent",
  "permalink": "/whatap-docs/oracle-v2/after-install-agent",
  "draft": false,
  "unlisted": false,
  "editUrl": "undefined/docs/oracle-v2/after-install-agent.mdx",
  "tags": [
    {
      "inline": true,
      "label": "Oracle",
