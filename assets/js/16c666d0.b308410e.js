"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["84124"], {
...
"90384": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_golang_set_event_log_mdx_16c_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-golang-set-event-log-mdx-16c.json
var site_docs_golang_set_event_log_mdx_16c_namespaceObject = JSON.parse('{"id":"golang/set-event-log","title":"로그 경고 알림","description":"로그 메시지를 필터링해 경고 알림을 설정할 수 있습니다.","source":"@site/docs/golang/set-event-log.mdx","sourceDirName":"golang","slug":"/golang/set-event-log","permalink":"/golang/set-event-log","draft":false,"unlisted":false,"editUrl":"undefined/docs/golang/set-event-log.mdx","tags":[],"version":"current","frontMatter":{"id":"set-event-log","title":"로그 경고 알림","description":"로그 메시지를 필터링해 경고 알림을 설정할 수 있습니다.","keywords":["Go","경고 알림","로그","애플리케이션","애플리케이션 모니터링"],"isTranslationMissing":false},"sidebar":"goSidebar","previous":{"title":"이상치 탐지 경고 알림","permalink":"/golang/set-event-detect-anomal"},"next":{"title":"이벤트 수신 설정","permalink":"/golang/set-receive-event"}}')
...
;// CONCATENATED MODULE: ./docs/golang/set-event-log.mdx
