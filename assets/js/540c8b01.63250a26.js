"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["80083"], {
...
"16493": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_python_topology_add_function_mdx_540_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-python-topology-add-function-mdx-540.json
var site_docs_python_topology_add_function_mdx_540_namespaceObject = JSON.parse('{"id":"python/topology-add-function","title":"부가 기능","description":"토폴로지 메뉴에서 이용할 수 있는 부가 기능에 대한 설명을 제공합니다.","source":"@site/docs/python/topology-add-function.mdx","sourceDirName":"python","slug":"/python/topology-add-function","permalink":"/python/topology-add-function","draft":false,"unlisted":false,"editUrl":"undefined/docs/python/topology-add-function.mdx","tags":[],"version":"current","frontMatter":{"id":"topology-add-function","title":"부가 기능","description":"토폴로지 메뉴에서 이용할 수 있는 부가 기능에 대한 설명을 제공합니다.","keywords":["Python","토폴로지"],"isTranslationMissing":false},"sidebar":"pySidebar","previous":{"title":"유형별 토폴로지","permalink":"/python/topology-type"},"next":{"title":"통계","permalink":"/python/analysis-apm-trs"}}')
...
;// CONCATENATED MODULE: ./docs/python/topology-add-function.mdx
