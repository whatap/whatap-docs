"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["17321"], {
...
"64695": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_oracle_pro_metrics_intro_mdx_541_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-oracle-pro-metrics-intro-mdx-541.json
var site_docs_oracle_pro_metrics_intro_mdx_541_namespaceObject = JSON.parse('{"id":"oracle-pro/metrics-intro","title":"메트릭스","description":"데이터베이스 모니터링 분석을 위한 메트릭스 메뉴에 대해 알아봅니다.","source":"@site/docs/oracle-pro/metrics-intro.mdx","sourceDirName":"oracle-pro","slug":"/oracle-pro/metrics-intro","permalink":"/oracle-pro/metrics-intro","draft":false,"unlisted":false,"editUrl":"undefined/docs/oracle-pro/metrics-intro.mdx","tags":[],"version":"current","frontMatter":{"id":"metrics-intro","title":"메트릭스","description":"데이터베이스 모니터링 분석을 위한 메트릭스 메뉴에 대해 알아봅니다.","keywords":["Oracle Pro","메트릭스","데이터베이스","데이터베이스"],"isTranslationMissing":false},"sidebar":"dboracledmaSidebar","previous":{"title":"데이터베이스 파라미터","permalink":"/oracle-pro/analysis-databaseparameter"},"next":{"title":"Oracle Pro 지표","permalink":"/oracle-pro/metrics-data-list"}}')
...
;// CONCATENATED MODULE: ./docs/oracle-pro/metrics-intro.mdx
