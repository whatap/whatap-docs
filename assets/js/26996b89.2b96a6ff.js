...
"63804": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_java_analysis_msa_mdx_269_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-java-analysis-msa-mdx-269.json
var site_docs_java_analysis_msa_mdx_269_namespaceObject = JSON.parse('{"id":"java/analysis-msa","title":"MSA 분석","description":"MSA 분석 기능은 와탭의 MTRACE(멀티 서버간 추적)기능을 통해서 수집된 트랜잭션들 사이의 호출 비중이 어떠한지를 분석합니다.","source":"@site/docs/java/analysis-msa.mdx","sourceDirName":"java","slug":"/java/analysis-msa","permalink":"/java/analysis-msa","draft":false,"unlisted":false,"editUrl":"undefined/docs/java/analysis-msa.mdx","tags":[],"version":"current","frontMatter":{"id":"analysis-msa","title":"MSA 분석","description":"MSA 분석 기능은 와탭의 MTRACE(멀티 서버간 추적)기능을 통해서 수집된 트랜잭션들 사이의 호출 비중이 어떠한지를 분석합니다.","keywords":["Java","애플리케이션","분석","MSA"],"isTranslationMissing":false},"sidebar":"javaSidebar","previous":{"title":"트랜잭션 검색","permalink":"/java/tx-profile"},"next":{"title":"메트릭스","permalink":"/java/metrics-intro"}}')
...
;// CONCATENATED MODULE: ./docs/java/analysis-msa.mdx
