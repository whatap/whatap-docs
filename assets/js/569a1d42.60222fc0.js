"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["76266"], {
...
"76248": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_oracle_dashboard_intro_mdx_569_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-oracle-dashboard-intro-mdx-569.json
var site_docs_oracle_dashboard_intro_mdx_569_namespaceObject = JSON.parse('{"id":"oracle/dashboard-intro","title":"대시보드","description":"와탭 모니터링 대시보드는 프로젝트의 전체 현황을 한 눈에 파악하기 위한 기능을 제공합니다.","source":"@site/docs/oracle/dashboard-intro.mdx","sourceDirName":"oracle","slug":"/oracle/dashboard-intro","permalink":"/oracle/dashboard-intro","draft":false,"unlisted":false,"editUrl":"undefined/docs/oracle/dashboard-intro.mdx","tags":[],"version":"current","frontMatter":{"id":"dashboard-intro","title":"대시보드","description":"와탭 모니터링 대시보드는 프로젝트의 전체 현황을 한 눈에 파악하기 위한 기능을 제공합니다.","keywords":["Oracle","대시보드","인스턴스","데이터베이스"],"isTranslationMissing":false},"sidebar":"dboracleV2Sidebar","previous":{"title":"관리하기","permalink":"/oracle/agent-manage"},"next":{"title":"인스턴스 목록","permalink":"/oracle/instance-list"}}')
...
;// CONCATENATED MODULE: ./docs/oracle/dashboard-intro.mdx
