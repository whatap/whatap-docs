"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["86650"], {
...
"53950": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_golang_collect_stacks_mdx_461_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-golang-collect-stacks-mdx-461.json
var site_docs_golang_collect_stacks_mdx_461_namespaceObject = JSON.parse('{"id":"golang/collect-stacks","title":"트랜잭션 스텝 수집 방식","description":"트랜잭션 스텝 수집 방식을 안내합니다.","source":"@site/docs/golang/collect-stacks.mdx","sourceDirName":"golang","slug":"/golang/collect-stacks","permalink":"/golang/collect-stacks","draft":false,"unlisted":false,"editUrl":"undefined/docs/golang/collect-stacks.mdx","tags":[],"version":"current","frontMatter":{"id":"collect-stacks","title":"트랜잭션 스텝 수집 방식","description":"트랜잭션 스텝 수집 방식을 안내합니다.","keywords":["Go","트랜잭션"],"isTranslationMissing":false},"sidebar":"goSidebar","previous":{"title":"멀티 트랜잭션","permalink":"/golang/trs-multi-trace"},"next":{"title":"토폴로지","permalink":"/golang/topology"}}')
...
;// CONCATENATED MODULE: ./docs/golang/collect-stacks.mdx
