"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["74980"], {
...
"19007": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_log_log_setting_mdx_a15_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-log-log-setting-mdx-a15.json
var site_docs_log_log_setting_mdx_a15_namespaceObject = JSON.parse('{"id":"log/log-setting","title":"로그 설정","description":"로그 모니터링 설정 방법을 안내합니다.","source":"@site/docs/log/log-setting.mdx","sourceDirName":"log","slug":"/log/log-setting","permalink":"/log/log-setting","draft":false,"unlisted":false,"editUrl":"undefined/docs/log/log-setting.mdx","tags":[],"version":"current","frontMatter":{"id":"log-setting","title":"로그 설정","description":"로그 모니터링 설정 방법을 안내합니다.","toc_max_heading_level":3,"keywords":["로그","로그 모니터링","설정하기"],"isTranslationMissing":false},"sidebar":"logSidebar","previous":{"title":"Kubernetes","permalink":"/log/log-k8s"},"next":{"title":"로그 파싱하기","permalink":"/log/log-parser"}}')
...
;// CONCATENATED MODULE: ./docs/log/log-setting.mdx
