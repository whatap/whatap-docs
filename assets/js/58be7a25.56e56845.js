"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["55435"], {
...
"61867": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_java_add_jvm_opt_docker_mdx_58b_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-java-add-jvm-opt-docker-mdx-58b.json
var site_docs_java_add_jvm_opt_docker_mdx_58b_namespaceObject = JSON.parse('{"id":"java/add-jvm-opt/docker","title":"Docker","description":"도커(Docker) 환경에서 Java 애플리케이션에 와탭 자바(Java) 모니터링 에이전트를 적용하는 방법을 단계별로 안내합니다. 사용자는 기존 Docker 이미지에 와탭 자바(Java) 에이전트 설정을 추가하여 새로운 이미지를 빌드하는 과정, whatap.conf 파일 생성, Dockerfile 작성, JAVA_OPT 수정 방법 등을 확인할 수 있습니다. 또한, Java 17 이상의 버전에서 필요한 추가 JVM 옵션과 다양한 Java 버전에 따른 힙 히스토그램 조회 설정 방법도 제공합니다.","source":"@site/docs/java/add-jvm-opt/docker.mdx","sourceDirName":"java/add-jvm-opt","slug":"/java/add-jvm-opt/docker","permalink":"/java/add-jvm-opt/docker","draft":false,"unlisted":false,"editUrl":"undefined/docs/java/add-jvm-opt/docker.mdx","tags":[],"version":"current","frontMatter":{"id":"docker","title":"Docker","description":"도커(Docker) 환경에서 Java 애플리케이션에 와탭 자바(Java) 모니터링 에이전트를 적용하는 방법을 단계별로 안내합니다. 사용자는 기존 Docker 이미지에 와탭 자바(Java) 에이전트 설정을 추가하여 새로운 이미지를 빌드하는 과정, whatap.conf 파일 생성, Dockerfile 작성, JAVA_OPT 수정 방법 등을 확인할 수 있습니다. 또한, Java 17 이상의 버전에서 필요한 추가 JVM 옵션과 다양한 Java 버전에 따른 힙 히스토그램 조회 설정 방법도 제공합니다.","keywords":["Java","Docker","애플리케이션","에이전트"],"isTranslationMissing":false},"sidebar":"javaSidebar","previous":{"title":"Elastic Beanstalk","permalink":"/java/add-jvm-opt/elastic-beanstalk"},"next":{"title":"배치 애플리케이션","permalink":"/java/add-jvm-opt/batch-app"}}')
...
;// CONCATENATED MODULE: ./docs/java/add-jvm-opt/docker.mdx
...
const toc = [{
  ...
  "value": "Docker 빌드 디렉터리 생성하기",
  "id": "docker-빌드-디렉터리-생성하기",
  "level": 3
}, {
  "value": "에이전트 설정 파일 생성하기",
  "id": "에이전트-설정-파일-생성하기",
  "level": 3
}, {
  "value": "Dockerfile 생성하기",
  "id": "dockerfile-생성하기",
  "level": 3
}, {
  "value": "<code>JAVA_OPTS</code> 적용하기",
  "id": "java_opts-적용하기",
  "level": 3
}, {
  "value": "Docker 빌드하기",
...
function _createMdxContent(props) {
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsx)(_components.p, {
      children: "Docker는 컨테이너 기반의 가상화 플랫폼으로 Java 애플리케이션을 Docker 컨테이너 내에서 실행할 때 JVM 옵션을 추가하여 애플리케이션의 성능 및 자원 사용을 조정할 수 있습니다. 이 문서에서는 Dockerfile을 수정하여 JVM 옵션을 추가하는 방법을 안내합니다."
    }), "\n", (0,jsx_runtime.jsx)(_components.admonition, {
      type: "note",
      children: (0,jsx_runtime.jsx)(_components.p, {
        children: "Docker가 설치되어 있어야 하며, Java 애플리케이션의 Docker 이미지를 빌드할 수 있어야 합니다."
      })
      ...
      children: [(0,jsx_runtime.jsx)(_components.h2, {
        ...
        children: (0,jsx_runtime.jsxs)(_components.p, {
          children: ["이 문서에서는 Java 에이전트를 설치하는 경우만을 다룹니다. 와탭 쿠버네티스 모니터링과 함께 적용하는 경우 ", (0,jsx_runtime.jsx)(_components.a, {
      ...
      children: [(0,jsx_runtime.jsx)(_components.h3, {
        id: "dockerfile-생성하기",
        children: "Dockerfile 생성하기"
      }), (0,jsx_runtime.jsxs)(_components.p, {
        children: ["이미지를 빌드하려면 와탭 이미지에서 ", (0,jsx_runtime.jsx)(_components.code, {
          children: "-javaagent"
      ...
      children: [(0,jsx_runtime.jsx)(_components.h3, {
        ...
        type: "note",
        children: [(0,jsx_runtime.jsxs)(_components.p, {
          children: ["Java 에이전트 파일 이름은 ", (0,jsx_runtime.jsx)(_components.code, {
            children: "Rename"
          }), " 기능을 활용해 수정할 수 있습니다. Java 에이전트의 이름을 수정했다면 ", (0,jsx_runtime.jsx)(_components.code, {
            children: "JAVA_OPTS"
