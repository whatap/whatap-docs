"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["85082"], {
"5234": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_altibase_install_agent_mdx_3dd_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-altibase-install-agent-mdx-3dd.json
var site_docs_altibase_install_agent_mdx_3dd_namespaceObject = JSON.parse('{"id":"altibase/install-agent","title":"에이전트 설치","description":"와탭 데이터베이스 모니터링 서비스 이용을 위한 기본 설치 방법을 안내합니다.","source":"@site/docs/altibase/install-agent.mdx","sourceDirName":"altibase","slug":"/altibase/install-agent","permalink":"/altibase/install-agent","draft":false,"unlisted":false,"editUrl":"undefined/docs/altibase/install-agent.mdx","tags":[],"version":"current","frontMatter":{"id":"install-agent","title":"에이전트 설치","description":"와탭 데이터베이스 모니터링 서비스 이용을 위한 기본 설치 방법을 안내합니다.","keywords":["Altibase","데이터베이스 모니터링","에이전트"],"isTranslationMissing":false},"sidebar":"altibaseSidebar","previous":{"title":"지원 환경","permalink":"/altibase/monitoring-support"},"next":{"title":"설치 점검 사항","permalink":"/altibase/after-install-agent"}}')
...
;// CONCATENATED MODULE: ./docs/altibase/install-agent.mdx
