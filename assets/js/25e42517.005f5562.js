"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["48032"], {
...
"21826": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_server_metrics_chart_mdx_25e_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-server-metrics-chart-mdx-25e.json
var site_docs_server_metrics_chart_mdx_25e_namespaceObject = JSON.parse('{"id":"server/metrics-chart","title":"메트릭스 차트","description":"메트릭스 데이터를 차트로 조회할 수 있습니다.","source":"@site/docs/server/metrics-chart.mdx","sourceDirName":"server","slug":"/server/metrics-chart","permalink":"/server/metrics-chart","draft":false,"unlisted":false,"editUrl":"undefined/docs/server/metrics-chart.mdx","tags":[],"version":"current","frontMatter":{"id":"metrics-chart","title":"메트릭스 차트","description":"메트릭스 데이터를 차트로 조회할 수 있습니다.","keywords":["메트릭스","메트릭스 차트","UI"],"isTranslationMissing":false},"sidebar":"serverSidebar","previous":{"title":"메트릭스 조회","permalink":"/server/metrics-search"},"next":{"title":"메트릭스 이상 탐지","permalink":"/server/metrics-detect-anormal"}}')
...
;// CONCATENATED MODULE: ./docs/server/metrics-chart.mdx
