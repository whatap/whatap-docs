"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[14255],{
...
const metadata = {
  "id": "mssql-v1/warning-notice",
  "title": "데이터베이스 경고 알림",
  "description": "데이터베이스의 지표별 이벤트 조건 설정을 통해 경고 알림을 보냅니다.",
  "source": "@site/docs/mssql-v1/warning-notice.mdx",
  "sourceDirName": "mssql-v1",
  "slug": "/mssql-v1/warning-notice",
  "permalink": "/whatap-docs/mssql-v1/warning-notice",
  "draft": false,
  "unlisted": false,
  "editUrl": "undefined/docs/mssql-v1/warning-notice.mdx",
  "tags": [],
  "version": "current",
  "frontMatter": {
    "id": "warning-notice",
  ...
  "next": {
    "title": "이벤트 설정",
    "permalink": "/whatap-docs/mssql-v1/warning-notice-v2"
  }
};
const assets = {
