"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["86236"], {
...
"62098": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_mssql_log_db_mdx_5b8_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-mssql-log-db-mdx-5b8.json
var site_docs_mssql_log_db_mdx_5b8_namespaceObject = JSON.parse('{"id":"mssql/log-db","title":"적용하기","description":"데이터베이스와 AWS RDS의 로그를 수집하는 방법을 안내합니다.","source":"@site/docs/mssql/log-db.mdx","sourceDirName":"mssql","slug":"/mssql/log-db","permalink":"/mssql/log-db","draft":false,"unlisted":false,"editUrl":"undefined/docs/mssql/log-db.mdx","tags":[],"version":"current","frontMatter":{"id":"log-db","title":"적용하기","description":"데이터베이스와 AWS RDS의 로그를 수집하는 방법을 안내합니다.","keywords":["로그 모니터링","데이터베이스","SQL Server"],"isTranslationMissing":false},"sidebar":"mssqlSidebar","previous":{"title":"로그","permalink":"/mssql/log-main"},"next":{"title":"라이브 테일","permalink":"/mssql/log-lt"}}')
...
;// CONCATENATED MODULE: ./docs/mssql/log-db.mdx
