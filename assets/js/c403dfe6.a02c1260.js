"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["66269"], {
...
"33516": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_oracle_pro_set_event_history_mdx_c40_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-oracle-pro-set-event-history-mdx-c40.json
var site_docs_oracle_pro_set_event_history_mdx_c40_namespaceObject = JSON.parse('{"id":"oracle-pro/set-event-history","title":"이벤트 기록","description":"이벤트 기록 메뉴를 통해 발생한 경고 알림 이력을 확인할 수 있습니다.","source":"@site/docs/oracle-pro/set-event-history.mdx","sourceDirName":"oracle-pro","slug":"/oracle-pro/set-event-history","permalink":"/oracle-pro/set-event-history","draft":false,"unlisted":false,"editUrl":"undefined/docs/oracle-pro/set-event-history.mdx","tags":[],"version":"current","frontMatter":{"id":"set-event-history","title":"이벤트 기록","description":"이벤트 기록 메뉴를 통해 발생한 경고 알림 이력을 확인할 수 있습니다.","keywords":["Oracle Pro","경고 알림","이벤트 기록","데이터베이스"],"isTranslationMissing":false},"sidebar":"dboracledmaSidebar","previous":{"title":"이벤트 수신 설정","permalink":"/oracle-pro/set-receive-event"},"next":{"title":"이벤트 수신 포맷","permalink":"/oracle-pro/set-event-format"}}')
...
;// CONCATENATED MODULE: ./docs/oracle-pro/set-event-history.mdx
