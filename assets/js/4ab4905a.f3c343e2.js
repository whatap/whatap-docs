"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["6822"], {
"76219": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_amazon_cloudwatch_metric_warning_notice_mdx_4ab_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-amazon-cloudwatch-metric-warning-notice-mdx-4ab.json
var site_docs_amazon_cloudwatch_metric_warning_notice_mdx_4ab_namespaceObject = JSON.parse('{"id":"amazon-cloudwatch/metric-warning-notice","title":"메트릭스 경고 알림","description":"구체적이고 복잡한 이벤트를 설정하려면 메트릭스 이벤트 설정을 사용하세요.","source":"@site/docs/amazon-cloudwatch/metric-warning-notice.mdx","sourceDirName":"amazon-cloudwatch","slug":"/amazon-cloudwatch/metric-warning-notice","permalink":"/amazon-cloudwatch/metric-warning-notice","draft":false,"unlisted":false,"editUrl":"undefined/docs/amazon-cloudwatch/metric-warning-notice.mdx","tags":[],"version":"current","frontMatter":{"id":"metric-warning-notice","title":"메트릭스 경고 알림","description":"구체적이고 복잡한 이벤트를 설정하려면 메트릭스 이벤트 설정을 사용하세요.","keywords":["경고 알림","메트릭스 이벤트","클라우드","Amazon CloudWatch"],"isTranslationMissing":false},"sidebar":"amazoncloudwatchSidebar","previous":{"title":"알림 설정하기","permalink":"/amazon-cloudwatch/set-notice"},"next":{"title":"이벤트 수신 설정","permalink":"/amazon-cloudwatch/set-receive-event"}}')
...
;// CONCATENATED MODULE: ./docs/amazon-cloudwatch/metric-warning-notice.mdx
