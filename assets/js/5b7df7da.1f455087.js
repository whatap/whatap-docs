"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["65558"], {
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_mysql_flexboard_mode_mdx_5b7_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-mysql-flexboard-mode-mdx-5b7.json
var site_docs_mysql_flexboard_mode_mdx_5b7_namespaceObject = JSON.parse('{"id":"mysql/flexboard-mode","title":"Flex 보드 화면 모드","description":"Flex 보드의 화면 모드에 따라 제공하는 기능에 대해 알아보세요.","source":"@site/docs/mysql/flexboard-mode.mdx","sourceDirName":"mysql","slug":"/mysql/flexboard-mode","permalink":"/mysql/flexboard-mode","draft":false,"unlisted":false,"editUrl":"undefined/docs/mysql/flexboard-mode.mdx","tags":[],"version":"current","frontMatter":{"id":"flexboard-mode","title":"Flex 보드 화면 모드","description":"Flex 보드의 화면 모드에 따라 제공하는 기능에 대해 알아보세요.","keywords":["MySQL","DB","데이터베이스","데이터베이스 모니터링","Flex 보드"],"isTranslationMissing":false},"sidebar":"mysqlSidebar","previous":{"title":"위젯 템플릿","permalink":"/mysql/flexboard-widget-template"},"next":{"title":"Flex 보드 공유하기","permalink":"/mysql/flexboard-share"}}')
...
;// CONCATENATED MODULE: ./docs/mysql/flexboard-mode.mdx
