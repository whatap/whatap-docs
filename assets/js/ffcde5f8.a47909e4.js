"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["37902"], {
...
"82447": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_kubernetes_supported_spec_mdx_ffc_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-kubernetes-supported-spec-mdx-ffc.json
var site_docs_kubernetes_supported_spec_mdx_ffc_namespaceObject = JSON.parse('{"id":"kubernetes/supported-spec","title":"쿠버네티스 모니터링 지원 환경","description":"쿠버네티스 모니터링을 시작하기 전에 지원 환경에 대해 알아보세요.","source":"@site/docs/kubernetes/supported-spec.mdx","sourceDirName":"kubernetes","slug":"/kubernetes/supported-spec","permalink":"/kubernetes/supported-spec","draft":false,"unlisted":false,"editUrl":"undefined/docs/kubernetes/supported-spec.mdx","tags":[],"version":"current","frontMatter":{"id":"supported-spec","title":"쿠버네티스 모니터링 지원 환경","description":"쿠버네티스 모니터링을 시작하기 전에 지원 환경에 대해 알아보세요.","keywords":["쿠버네티스","쿠버네티스 모니터링","지원 환경"],"isTranslationMissing":false},"sidebar":"kubeSidebar","previous":{"title":"에이전트 아키텍쳐","permalink":"/kubernetes/agent-architecture"},"next":{"title":"NVIDIA GPU 지원","permalink":"/kubernetes/nvidia-gpu"}}')
...
;// CONCATENATED MODULE: ./docs/kubernetes/supported-spec.mdx
