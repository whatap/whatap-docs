"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["68709"], {
...
"56134": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_php_labs_mdx_c64_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-php-labs-mdx-c64.json
var site_docs_php_labs_mdx_c64_namespaceObject = JSON.parse('{"id":"php/labs","title":"실험실","description":"사용자에게 새로운 기능 또는 실험적인 기능을 제공하는 메뉴인 실험실에 대해 안내합니다.","source":"@site/docs/php/labs.mdx","sourceDirName":"php","slug":"/php/labs","permalink":"/php/labs","draft":false,"unlisted":false,"editUrl":"undefined/docs/php/labs.mdx","tags":[],"version":"current","frontMatter":{"id":"labs","title":"실험실","description":"사용자에게 새로운 기능 또는 실험적인 기능을 제공하는 메뉴인 실험실에 대해 안내합니다.","keywords":["PHP","애플리케이션","실험실"],"isTranslationMissing":false},"sidebar":"phpSidebar","previous":{"title":"Log 모니터링","permalink":"/log/introduction"}}')
...
;// CONCATENATED MODULE: ./docs/php/labs.mdx
