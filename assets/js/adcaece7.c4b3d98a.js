"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["15920"], {
...
"56154": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_python_agent_transaction_mdx_adc_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-python-agent-transaction-mdx-adc.json
var site_docs_python_agent_transaction_mdx_adc_namespaceObject = JSON.parse('{"id":"python/agent-transaction","title":"트랜잭션","description":"Python 트랜잭션과 관련된 설정을 제공합니다.","source":"@site/docs/python/agent-transaction.mdx","sourceDirName":"python","slug":"/python/agent-transaction","permalink":"/python/agent-transaction","draft":false,"unlisted":false,"editUrl":"undefined/docs/python/agent-transaction.mdx","tags":[],"version":"current","frontMatter":{"id":"agent-transaction","title":"트랜잭션","description":"Python 트랜잭션과 관련된 설정을 제공합니다.","keywords":["Python","트랜잭션","설정하기"],"isTranslationMissing":false},"sidebar":"pySidebar","previous":{"title":"에이전트 로그","permalink":"/python/agent-log"},"next":{"title":"DB, SQL","permalink":"/python/agent-dbsql"}}')
...
const _python_trs_profile_frontMatter = (/* unused pure expression or super */ null && ({}));
...
const _python_track_http_trs_frontMatter = (/* unused pure expression or super */ null && ({}));
...
const _python_track_non_http_trs_frontMatter = (/* unused pure expression or super */ null && ({}));
...
const _python_track_non_http_trs_toc = [..._edp_def/* toc */.d$, ..._edp_track_non_http/* toc */.d$, {
  "value": "대상 선정",
  "id": "대상-선정",
  "level": 3
}, ..._edp_select/* toc */.d$, {
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsxs)(_components.ul, {
      children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
        ...
        }), "\n", (0,jsx_runtime.jsx)(_edp_def/* default */.ZP, {}), "\n"]
      }), "\n", (0,jsx_runtime.jsxs)(_components.li, {
        children: ["\n", (0,jsx_runtime.jsx)(_components.p, {
          children: (0,jsx_runtime.jsx)(_components.strong, {
...
const _python_multi_trace_frontMatter = (/* unused pure expression or super */ null && ({}));
