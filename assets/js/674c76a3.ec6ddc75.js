"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["49521"], {
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_postgresql_warning_notice_mdx_674_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-postgresql-warning-notice-mdx-674.json
var site_docs_postgresql_warning_notice_mdx_674_namespaceObject = JSON.parse('{"id":"postgresql/warning-notice","title":"데이터베이스 경고 알림","description":"데이터베이스의 지표별 이벤트 조건 설정을 통해 경고 알림을 보냅니다.","source":"@site/docs/postgresql/warning-notice.mdx","sourceDirName":"postgresql","slug":"/postgresql/warning-notice","permalink":"/postgresql/warning-notice","draft":false,"unlisted":false,"editUrl":"undefined/docs/postgresql/warning-notice.mdx","tags":[],"version":"current","frontMatter":{"id":"warning-notice","title":"데이터베이스 경고 알림","description":"데이터베이스의 지표별 이벤트 조건 설정을 통해 경고 알림을 보냅니다.","keywords":["PostgreSQL","경고 알림","데이터베이스","데이터베이스 모니터링"],"isTranslationMissing":false},"sidebar":"postgreSidebar","previous":{"title":"알림 설정하기","permalink":"/postgresql/set-notice"},"next":{"title":"이벤트 설정","permalink":"/postgresql/warning-notice-v2"}}')
...
;// CONCATENATED MODULE: ./docs/postgresql/warning-notice.mdx
