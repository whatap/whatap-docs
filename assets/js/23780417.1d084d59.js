"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["95520"], {
...
"55881": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_php_metrics_chart_mdx_237_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-php-metrics-chart-mdx-237.json
var site_docs_php_metrics_chart_mdx_237_namespaceObject = JSON.parse('{"id":"php/metrics-chart","title":"메트릭스 차트","description":"메트릭스 데이터를 차트로 조회할 수 있습니다.","source":"@site/docs/php/metrics-chart.mdx","sourceDirName":"php","slug":"/php/metrics-chart","permalink":"/php/metrics-chart","draft":false,"unlisted":false,"editUrl":"undefined/docs/php/metrics-chart.mdx","tags":[],"version":"current","frontMatter":{"id":"metrics-chart","title":"메트릭스 차트","description":"메트릭스 데이터를 차트로 조회할 수 있습니다.","keywords":["메트릭스","메트릭스 차트","UI"],"isTranslationMissing":false},"sidebar":"phpSidebar","previous":{"title":"메트릭스 차트","permalink":"/php/metrics-chart-v2"},"next":{"title":"메트릭스 조회","permalink":"/php/metrics-search"}}')
...
;// CONCATENATED MODULE: ./docs/php/metrics-chart.mdx
