"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["33936"], {
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_postgresql_set_event_log_mdx_57b_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-postgresql-set-event-log-mdx-57b.json
var site_docs_postgresql_set_event_log_mdx_57b_namespaceObject = JSON.parse('{"id":"postgresql/set-event-log","title":"로그 알림 설정하기","description":"로그 이벤트 알림 메뉴를 안내합니다.","source":"@site/docs/postgresql/set-event-log.mdx","sourceDirName":"postgresql","slug":"/postgresql/set-event-log","permalink":"/postgresql/set-event-log","draft":false,"unlisted":false,"editUrl":"undefined/docs/postgresql/set-event-log.mdx","tags":[],"version":"current","frontMatter":{"id":"set-event-log","title":"로그 알림 설정하기","description":"로그 이벤트 알림 메뉴를 안내합니다.","keywords":["로그 모니터링","알림","UI","PostgreSQL"],"isTranslationMissing":false},"sidebar":"postgreSidebar","previous":{"title":"이상치 탐지 경고 알림","permalink":"/postgresql/set-event-detect-anomal"},"next":{"title":"이벤트 수신 설정","permalink":"/postgresql/set-receive-event"}}')
...
;// CONCATENATED MODULE: ./docs/postgresql/set-event-log.mdx
