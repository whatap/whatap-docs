"use strict";
(self["webpackChunkwhatap_origin"] = self["webpackChunkwhatap_origin"] || []).push([[62260],{
...
const metadata = {
    ...
    "title": "AI 기반의 히트맵 패턴 경고 알림",
    "description": "애플리케이션 실행 분포 패턴을 머신 러닝을 통해 자동 인식하여 경고 알림을 보냅니다.",
    "source": "@site/docs/python/hitmap-notice.mdx",
    ...
    "next": {
        "title": "이상치 탐지 경고 알림",
        "permalink": "/python/set-event-detect-anomal"
    }
};
const assets = {};
const toc = [
