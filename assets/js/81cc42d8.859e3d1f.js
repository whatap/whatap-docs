"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["58652"], {
...
"37916": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_mongodb_log_setting_mdx_81c_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-mongodb-log-setting-mdx-81c.json
var site_docs_mongodb_log_setting_mdx_81c_namespaceObject = JSON.parse('{"id":"mongodb/log-setting","title":"로그 설정","description":"로그 모니터링 설정 방법을 안내합니다.","source":"@site/docs/mongodb/log-setting.mdx","sourceDirName":"mongodb","slug":"/mongodb/log-setting","permalink":"/mongodb/log-setting","draft":false,"unlisted":false,"editUrl":"undefined/docs/mongodb/log-setting.mdx","tags":[],"version":"current","frontMatter":{"id":"log-setting","title":"로그 설정","description":"로그 모니터링 설정 방법을 안내합니다.","toc_max_heading_level":3,"keywords":["로그","로그 모니터링","설정하기","MongoDB"],"isTranslationMissing":false},"sidebar":"mongodbSidebar","previous":{"title":"로그 검색","permalink":"/mongodb/log-search"},"next":{"title":"로그 파싱하기","permalink":"/mongodb/log-parser"}}')
...
;// CONCATENATED MODULE: ./docs/mongodb/log-setting.mdx
