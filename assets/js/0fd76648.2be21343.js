"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["33602"], {
...
"81334": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_dotnet_dashboard_mdx_0fd_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-dotnet-dashboard-mdx-0fd.json
var site_docs_dotnet_dashboard_mdx_0fd_namespaceObject = JSON.parse('{"id":"dotnet/dashboard","title":"애플리케이션 대시보드","description":"웹 애플리케이션 서버의 리소스를 실시간으로 모니터링할 수 있습니다.","source":"@site/docs/dotnet/dashboard.mdx","sourceDirName":"dotnet","slug":"/dotnet/dashboard","permalink":"/dotnet/dashboard","draft":false,"unlisted":false,"editUrl":"undefined/docs/dotnet/dashboard.mdx","tags":[],"version":"current","frontMatter":{"id":"dashboard","title":"애플리케이션 대시보드","description":"웹 애플리케이션 서버의 리소스를 실시간으로 모니터링할 수 있습니다.","keywords":[".NET","대시보드","애플리케이션","애플리케이션 모니터링"],"isTranslationMissing":false},"sidebar":"dotNetSidebar","previous":{"title":"대시보드","permalink":"/dotnet/dashboard-intro"},"next":{"title":"트랜잭션 맵","permalink":"/dotnet/dashboard-transactionmap"}}')
...
;// CONCATENATED MODULE: ./docs/dotnet/dashboard.mdx
