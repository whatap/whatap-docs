"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["61093"], {
...
"85764": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_features_kafka_introduction_mdx_08a_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-features-kafka-introduction-mdx-08a.json
var site_docs_features_kafka_introduction_mdx_08a_namespaceObject = JSON.parse('{"id":"features/kafka-introduction","title":"KAFKA 모니터링","description":"이 문서는 KAFKA 모니터링 상품에 대한 소개 페이지입니다.","source":"@site/docs/features/kafka-introduction.mdx","sourceDirName":"features","slug":"/features/kafka-introduction","permalink":"/features/kafka-introduction","draft":false,"unlisted":false,"editUrl":"undefined/docs/features/kafka-introduction.mdx","tags":[],"version":"current","frontMatter":{"id":"kafka-introduction","title":"KAFKA 모니터링","description":"이 문서는 KAFKA 모니터링 상품에 대한 소개 페이지입니다.","displayed_sidebar":"featuremonitorSidebar","toc_max_heading_level":2,"keywords":["KAFKA","Feature"],"isTranslationMissing":false},"sidebar":"featuremonitorSidebar","previous":{"title":"피쳐 프로젝트","permalink":"/features/introduction"},"next":{"title":"Aerospike","permalink":"/features/aerospike-introduction"}}')
