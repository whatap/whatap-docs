"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["22596"], {
...
"35966": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_oracle_v_1_after_install_agent_mdx_21e_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-oracle-v-1-after-install-agent-mdx-21e.json
var site_docs_oracle_v_1_after_install_agent_mdx_21e_namespaceObject = JSON.parse('{"id":"oracle-v1/after-install-agent","title":"설치 점검 사항","description":"데이터베이스 모니터링 설치를 모두 완료했습니다. 설치 후 확인 사항을 점검하세요.","source":"@site/docs/oracle-v1/after-install-agent.mdx","sourceDirName":"oracle-v1","slug":"/oracle-v1/after-install-agent","permalink":"/oracle-v1/after-install-agent","draft":false,"unlisted":false,"editUrl":"undefined/docs/oracle-v1/after-install-agent.mdx","tags":[],"version":"current","frontMatter":{"id":"after-install-agent","title":"설치 점검 사항","description":"데이터베이스 모니터링 설치를 모두 완료했습니다. 설치 후 확인 사항을 점검하세요.","keywords":["Oracle","데이터베이스 모니터링","에이전트"],"isTranslationMissing":false},"sidebar":"dboracleSidebar","previous":{"title":"에이전트 설치","permalink":"/oracle-v1/install-agent"},"next":{"title":"설치 문제 해결","permalink":"/oracle-v1/troubleshooting"}}')
...
;// CONCATENATED MODULE: ./docs/oracle-v1/after-install-agent.mdx
