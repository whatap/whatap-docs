...
"59045": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_php_topology_type_mdx_8b2_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-php-topology-type-mdx-8b2.json
var site_docs_php_topology_type_mdx_8b2_namespaceObject = JSON.parse('{"id":"php/topology-type","title":"유형별 토폴로지","description":"유형별 토폴로지에서 제공하는 기능을 알아봅니다.","source":"@site/docs/php/topology-type.mdx","sourceDirName":"php","slug":"/php/topology-type","permalink":"/php/topology-type","draft":false,"unlisted":false,"editUrl":"undefined/docs/php/topology-type.mdx","tags":[],"version":"current","frontMatter":{"id":"topology-type","title":"유형별 토폴로지","description":"유형별 토폴로지에서 제공하는 기능을 알아봅니다.","keywords":["PHP","토폴로지"],"isTranslationMissing":false},"sidebar":"phpSidebar","previous":{"title":"기본 사용법","permalink":"/php/topology-basic"},"next":{"title":"부가 기능","permalink":"/php/topology-add-function"}}')
...
;// CONCATENATED MODULE: ./docs/php/topology-type.mdx
