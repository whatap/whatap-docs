"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["25346"], {
...
"39357": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_oracle_cloud_flexboard_share_mdx_a8d_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-oracle-cloud-flexboard-share-mdx-a8d.json
var site_docs_oracle_cloud_flexboard_share_mdx_a8d_namespaceObject = JSON.parse('{"id":"oracle-cloud/flexboard-share","title":"Flex 보드 공유하기","description":"Flex 보드를 다른 계정의 사용자와 공유하고 재사용할 수 있습니다.","source":"@site/docs/oracle-cloud/flexboard-share.mdx","sourceDirName":"oracle-cloud","slug":"/oracle-cloud/flexboard-share","permalink":"/oracle-cloud/flexboard-share","draft":false,"unlisted":false,"editUrl":"undefined/docs/oracle-cloud/flexboard-share.mdx","tags":[],"version":"current","frontMatter":{"id":"flexboard-share","title":"Flex 보드 공유하기","description":"Flex 보드를 다른 계정의 사용자와 공유하고 재사용할 수 있습니다.","keywords":["Flex 보드","Oracle Cloud Monitor","클라우드"],"isTranslationMissing":false},"sidebar":"oracleSidebar","previous":{"title":"Flex 보드 화면 모드","permalink":"/oracle-cloud/flexboard-mode"},"next":{"title":"메트릭스","permalink":"/oracle-cloud/metrics-intro"}}')
...
;// CONCATENATED MODULE: ./docs/oracle-cloud/flexboard-share.mdx
