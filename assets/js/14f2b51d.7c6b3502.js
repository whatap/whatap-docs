"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["96154"], {
"54530": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_browser_set_event_history_mdx_14f_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-browser-set-event-history-mdx-14f.json
var site_docs_browser_set_event_history_mdx_14f_namespaceObject = JSON.parse('{"id":"browser/set-event-history","title":"이벤트 기록","description":"이벤트 기록 메뉴를 통해 발생한 경고 알림 이력을 확인할 수 있습니다.","source":"@site/docs/browser/set-event-history.mdx","sourceDirName":"browser","slug":"/browser/set-event-history","permalink":"/browser/set-event-history","draft":false,"unlisted":false,"editUrl":"undefined/docs/browser/set-event-history.mdx","tags":[],"version":"current","frontMatter":{"id":"set-event-history","title":"이벤트 기록","description":"이벤트 기록 메뉴를 통해 발생한 경고 알림 이력을 확인할 수 있습니다.","keywords":["경고 알림","이벤트 기록","브라우저 모니터링"],"isTranslationMissing":false},"sidebar":"rumsSidebar","previous":{"title":"이벤트 수신 설정","permalink":"/browser/set-receive-event"},"next":{"title":"실시간 알림","permalink":"/browser/real-time-notification"}}')
...
;// CONCATENATED MODULE: ./docs/browser/set-event-history.mdx
