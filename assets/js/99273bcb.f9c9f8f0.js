"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["99386"], {
...
"51147": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_php_flexboard_mode_mdx_992_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-php-flexboard-mode-mdx-992.json
var site_docs_php_flexboard_mode_mdx_992_namespaceObject = JSON.parse('{"id":"php/flexboard-mode","title":"Flex 보드 화면 모드","description":"Flex 보드의 화면 모드에 따라 제공하는 기능에 대해 알아보세요.","source":"@site/docs/php/flexboard-mode.mdx","sourceDirName":"php","slug":"/php/flexboard-mode","permalink":"/php/flexboard-mode","draft":false,"unlisted":false,"editUrl":"undefined/docs/php/flexboard-mode.mdx","tags":[],"version":"current","frontMatter":{"id":"flexboard-mode","title":"Flex 보드 화면 모드","description":"Flex 보드의 화면 모드에 따라 제공하는 기능에 대해 알아보세요.","keywords":["PHP","애플리케이션","애플리케이션 모니터링","Flex 보드"],"isTranslationMissing":false},"sidebar":"phpSidebar","previous":{"title":"위젯 템플릿","permalink":"/php/flexboard-widget-template"},"next":{"title":"Flex 보드 공유하기","permalink":"/php/flexboard-share"}}')
...
;// CONCATENATED MODULE: ./docs/php/flexboard-mode.mdx
