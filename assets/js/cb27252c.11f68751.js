"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["8460"], {
...
"85624": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_php_agent_transaction_mdx_cb2_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-php-agent-transaction-mdx-cb2.json
var site_docs_php_agent_transaction_mdx_cb2_namespaceObject = JSON.parse('{"id":"php/agent-transaction","title":"트랜잭션","description":"PHP 애플리케이션 내 각 트랜잭션의 성능 데이터를 에이전트가 추적하고 분석할 수 있는 설정 방법을 안내합니다. 트랜잭션의 요청 처리, 응답 시간, 자원 사용량 등을 추적하여 애플리케이션 성능을 평가합니다.","source":"@site/docs/php/agent-transaction.mdx","sourceDirName":"php","slug":"/php/agent-transaction","permalink":"/php/agent-transaction","draft":false,"unlisted":false,"editUrl":"undefined/docs/php/agent-transaction.mdx","tags":[],"version":"current","frontMatter":{"id":"agent-transaction","title":"트랜잭션","description":"PHP 애플리케이션 내 각 트랜잭션의 성능 데이터를 에이전트가 추적하고 분석할 수 있는 설정 방법을 안내합니다. 트랜잭션의 요청 처리, 응답 시간, 자원 사용량 등을 추적하여 애플리케이션 성능을 평가합니다.","keywords":["PHP","트랜잭션","설정하기","애플리케이션"],"isTranslationMissing":false},"sidebar":"phpSidebar","previous":{"title":"에이전트 로그 설정","permalink":"/php/agent-log"},"next":{"title":"DB, SQL","permalink":"/php/agent-dbsql"}}')
...
const toc = [..._php_restart_apply/* toc */.d$, ..._php_restart_apply/* toc */.d$, ..._php_restart_apply/* toc */.d$, ..._php_restart_apply/* toc */.d$, ..._php_restart_apply/* toc */.d$, ..._php_restart_apply/* toc */.d$, ..._php_restart_apply/* toc */.d$, ..._php_restart_apply/* toc */.d$];
function _createMdxContent(props) {
  const _components = {
    admonition: "admonition",
    code: "code",
...
const _php_track_trs_frontMatter = (/* unused pure expression or super */ null && ({}));
...
const _php_track_http_trs_frontMatter = (/* unused pure expression or super */ null && ({}));
...
const _php_multi_trace_frontMatter = (/* unused pure expression or super */ null && ({}));
