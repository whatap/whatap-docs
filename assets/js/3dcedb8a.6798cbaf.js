"use strict";
(self["webpackChunkwhatap_origin"] = self["webpackChunkwhatap_origin"] || []).push([[98913],{
...
const metadata = {
    ...
    "title": "알림 메시지 사용자 정의",
    "description": "프로젝트 멤버에게 전달되는 경고 알림 메시지를 수정할 수 있는 사용자 정의 기능을 제공합니다.",
    "source": "@site/docs/python/set-notification-message.mdx",
    "sourceDirName": "python",
    "slug": "/python/set-notification-message",
    "permalink": "/python/set-notification-message",
    "draft": false,
    ...
    "next": {
        ...
        "permalink": "/python/hitmap-notice"
    }
};
const assets = {};
const toc = [
