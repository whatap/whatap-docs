"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["54551"], {
...
"34206": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_cubrid_v_1_metric_warning_notice_mdx_edd_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-cubrid-v-1-metric-warning-notice-mdx-edd.json
var site_docs_cubrid_v_1_metric_warning_notice_mdx_edd_namespaceObject = JSON.parse('{"id":"cubrid-v1/metric-warning-notice","title":"메트릭스 경고 알림","description":"구체적이고 복잡한 이벤트를 설정하려면 메트릭스 이벤트 설정을 사용하세요.","source":"@site/docs/cubrid-v1/metric-warning-notice.mdx","sourceDirName":"cubrid-v1","slug":"/cubrid-v1/metric-warning-notice","permalink":"/cubrid-v1/metric-warning-notice","draft":false,"unlisted":false,"editUrl":"undefined/docs/cubrid-v1/metric-warning-notice.mdx","tags":[],"version":"current","frontMatter":{"id":"metric-warning-notice","title":"메트릭스 경고 알림","description":"구체적이고 복잡한 이벤트를 설정하려면 메트릭스 이벤트 설정을 사용하세요.","keywords":["CUBRID","경고 알림","메트릭스 이벤트","데이터베이스 모니터링"],"isTranslationMissing":false},"sidebar":"cubridV1Sidebar","previous":{"title":"이벤트 설정","permalink":"/cubrid-v1/warning-notice-v2"},"next":{"title":"알림 메시지 사용자 정의","permalink":"/cubrid-v1/set-notification-message"}}')
...
;// CONCATENATED MODULE: ./docs/cubrid-v1/metric-warning-notice.mdx
