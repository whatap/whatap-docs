"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["23340"], {
...
"53062": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_golang_install_agent_docker_mdx_098_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-golang-install-agent-docker-mdx-098.json
var site_docs_golang_install_agent_docker_mdx_098_namespaceObject = JSON.parse('{"id":"golang/install-agent-docker","title":"Docker 환경 설치","description":"Docker 환경에서 컨테이너 내 Go 애플리케이션을 모니터링하기 위한 에이전트 설치를 안내합니다.","source":"@site/docs/golang/install-agent-docker.mdx","sourceDirName":"golang","slug":"/golang/install-agent-docker","permalink":"/golang/install-agent-docker","draft":false,"unlisted":false,"editUrl":"undefined/docs/golang/install-agent-docker.mdx","tags":[],"version":"current","frontMatter":{"id":"install-agent-docker","title":"Docker 환경 설치","description":"Docker 환경에서 컨테이너 내 Go 애플리케이션을 모니터링하기 위한 에이전트 설치를 안내합니다.","keywords":["Go","에이전트 설치","Docker","컨테이너","애플리케이션"],"isTranslationMissing":false},"sidebar":"goSidebar","previous":{"title":"에이전트 설치","permalink":"/golang/install-agent"},"next":{"title":"API 가이드","permalink":"/golang/api-guide"}}')
...
;// CONCATENATED MODULE: ./docs/golang/install-agent-docker.mdx
...
function _createMdxContent(props) {
  return (0,jsx_runtime.jsx)(_docker_go/* default */.ZP, {});
}
function MDXContent(props = {}) {
  const {wrapper: MDXLayout} = {
