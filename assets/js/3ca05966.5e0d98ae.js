"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["41547"], {
...
"49284": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_java_flexboard_share_mdx_3ca_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-java-flexboard-share-mdx-3ca.json
var site_docs_java_flexboard_share_mdx_3ca_namespaceObject = JSON.parse('{"id":"java/flexboard-share","title":"Flex 보드 공유하기","description":"Flex 보드를 다른 계정의 사용자와 공유하거나 재사용할 수 있습니다.","source":"@site/docs/java/flexboard-share.mdx","sourceDirName":"java","slug":"/java/flexboard-share","permalink":"/java/flexboard-share","draft":false,"unlisted":false,"editUrl":"undefined/docs/java/flexboard-share.mdx","tags":[],"version":"current","frontMatter":{"id":"flexboard-share","title":"Flex 보드 공유하기","description":"Flex 보드를 다른 계정의 사용자와 공유하거나 재사용할 수 있습니다.","keywords":["Java","Flex 보드"],"isTranslationMissing":false},"sidebar":"javaSidebar","previous":{"title":"Flex 보드 화면 모드","permalink":"/java/flexboard-mode"},"next":{"title":"분석","permalink":"/java/analysis-report-intro"}}')
...
;// CONCATENATED MODULE: ./docs/java/flexboard-share.mdx
