"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[59046],{
...
const metadata = {
  ...
  "title": "CUBRID V1 모니터링",
  "description": "와탭 데이터베이스 모니터링 서비스(DBX)은 Query 기반으로 데이터를 수집하여 성능 모니터링 서비스를 제공합니다.",
  "source": "@site/docs/cubrid-v1/monitoring-intro.mdx",
  "sourceDirName": "cubrid-v1",
  "slug": "/cubrid-v1/monitoring-intro",
  "permalink": "/whatap-docs/cubrid-v1/monitoring-intro",
  "draft": false,
  "unlisted": false,
  "editUrl": "undefined/docs/cubrid-v1/monitoring-intro.mdx",
  "tags": [],
  "version": "current",
  "frontMatter": {
    "id": "monitoring-intro",
