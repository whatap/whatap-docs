"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["97508"], {
"36481": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_altibase_v_1_labs_mdx_f27_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-altibase-v-1-labs-mdx-f27.json
var site_docs_altibase_v_1_labs_mdx_f27_namespaceObject = JSON.parse('{"id":"altibase-v1/labs","title":"실험실","description":"사용자에게 새로운 기능 또는 실험적인 기능을 제공하는 메뉴인 실험실에 대해 안내합니다.","source":"@site/docs/altibase-v1/labs.mdx","sourceDirName":"altibase-v1","slug":"/altibase-v1/labs","permalink":"/altibase-v1/labs","draft":false,"unlisted":false,"editUrl":"undefined/docs/altibase-v1/labs.mdx","tags":[],"version":"current","frontMatter":{"id":"labs","title":"실험실","description":"사용자에게 새로운 기능 또는 실험적인 기능을 제공하는 메뉴인 실험실에 대해 안내합니다.","keywords":["Altibase","데이터베이스","실험실"],"isTranslationMissing":false},"sidebar":"altibasev1Sidebar","previous":{"title":"시스템 이벤트 안내","permalink":"/altibase-v1/common-alert"}}')
