"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["23457"], {
...
"90823": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_ncloud_flexboard_mode_mdx_f10_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-ncloud-flexboard-mode-mdx-f10.json
var site_docs_ncloud_flexboard_mode_mdx_f10_namespaceObject = JSON.parse('{"id":"ncloud/flexboard-mode","title":"Flex 보드 화면 모드","description":"Flex 보드의 화면 모드에 따라 제공하는 기능에 대해 알아보세요.","source":"@site/docs/ncloud/flexboard-mode.mdx","sourceDirName":"ncloud","slug":"/ncloud/flexboard-mode","permalink":"/ncloud/flexboard-mode","draft":false,"unlisted":false,"editUrl":"undefined/docs/ncloud/flexboard-mode.mdx","tags":[],"version":"current","frontMatter":{"id":"flexboard-mode","title":"Flex 보드 화면 모드","description":"Flex 보드의 화면 모드에 따라 제공하는 기능에 대해 알아보세요.","keywords":["Flex 보드","Naver Cloud Monitoring","클라우드"],"isTranslationMissing":false},"sidebar":"ncloudSidebar","previous":{"title":"위젯 템플릿","permalink":"/ncloud/flexboard-widget-template"},"next":{"title":"Flex 보드 공유하기","permalink":"/ncloud/flexboard-share"}}')
...
;// CONCATENATED MODULE: ./docs/ncloud/flexboard-mode.mdx
