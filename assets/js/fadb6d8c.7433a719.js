"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["52252"], {
...
"49255": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_redis_set_notification_message_mdx_fad_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-redis-set-notification-message-mdx-fad.json
var site_docs_redis_set_notification_message_mdx_fad_namespaceObject = JSON.parse('{"id":"redis/set-notification-message","title":"알림 메시지 사용자 정의","description":"프로젝트 멤버에게 전달되는 경고 알림 메시지를 수정할 수 있는 사용자 정의 기능을 제공합니다.","source":"@site/docs/redis/set-notification-message.mdx","sourceDirName":"redis","slug":"/redis/set-notification-message","permalink":"/redis/set-notification-message","draft":false,"unlisted":false,"editUrl":"undefined/docs/redis/set-notification-message.mdx","tags":[],"version":"current","frontMatter":{"id":"set-notification-message","title":"알림 메시지 사용자 정의","description":"프로젝트 멤버에게 전달되는 경고 알림 메시지를 수정할 수 있는 사용자 정의 기능을 제공합니다.","keywords":["Redis","데이터베이스","경고 알림","메트릭스 이벤트","알림 메시지"],"isTranslationMissing":false},"sidebar":"redisSidebar","previous":{"title":"메트릭스 경고 알림","permalink":"/redis/metric-warning-notice"},"next":{"title":"이상치 탐지 경고 알림","permalink":"/redis/set-event-detect-anomal"}}')
...
;// CONCATENATED MODULE: ./docs/redis/set-notification-message.mdx
