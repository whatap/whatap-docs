"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["95431"], {
...
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_aws_log_log_parser_mdx_cc4_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-aws-log-log-parser-mdx-cc4.json
var site_docs_aws_log_log_parser_mdx_cc4_namespaceObject = JSON.parse('{"id":"aws-log/log-parser","title":"로그 파싱하기","description":"와탭이 제공하는 로그 파서에 대해 안내합니다.","source":"@site/docs/aws-log/log-parser.mdx","sourceDirName":"aws-log","slug":"/aws-log/log-parser","permalink":"/aws-log/log-parser","draft":false,"unlisted":false,"editUrl":"undefined/docs/aws-log/log-parser.mdx","tags":[],"version":"current","frontMatter":{"id":"log-parser","title":"로그 파싱하기","description":"와탭이 제공하는 로그 파서에 대해 안내합니다.","toc_max_heading_level":3,"keywords":["로그","AWS Log","로그 모니터링","설정하기","로그 파서","로그 파싱"],"isTranslationMissing":false},"sidebar":"awslogSidebar","previous":{"title":"설정하기","permalink":"/aws-log/aws-log-setting"},"next":{"title":"라이브 테일","permalink":"/aws-log/aws-log-lt"}}')
...
;// CONCATENATED MODULE: ./docs/aws-log/log-parser.mdx
