"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["79586"], {
...
"82002": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_kubernetes_dashboard_hitmap_trace_mdx_7d0_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-kubernetes-dashboard-hitmap-trace-mdx-7d0.json
var site_docs_kubernetes_dashboard_hitmap_trace_mdx_7d0_namespaceObject = JSON.parse('{"id":"kubernetes/dashboard-hitmap-trace","title":"히트맵 - 트레이스 분석","description":"히트맵 위젯을 통해 트레이스 분석 창을 열어 트랜잭션 목록과 각 트랜잭션 하위의 스텝 정보를 한 번에 확인할 수 있습니다.","source":"@site/docs/kubernetes/dashboard-hitmap-trace.mdx","sourceDirName":"kubernetes","slug":"/kubernetes/dashboard-hitmap-trace","permalink":"/kubernetes/dashboard-hitmap-trace","draft":false,"unlisted":false,"editUrl":"undefined/docs/kubernetes/dashboard-hitmap-trace.mdx","tags":[],"version":"current","frontMatter":{"id":"dashboard-hitmap-trace","title":"히트맵 - 트레이스 분석","description":"히트맵 위젯을 통해 트레이스 분석 창을 열어 트랜잭션 목록과 각 트랜잭션 하위의 스텝 정보를 한 번에 확인할 수 있습니다.","keywords":["쿠버네티스","애플리케이션","히트맵","트레이스"],"isTranslationMissing":false},"sidebar":"kubeSidebar","previous":{"title":"애플리케이션 서비스 대시보드","permalink":"/kubernetes/dashboard"},"next":{"title":"일자별 애플리케이션 현황","permalink":"/kubernetes/application-daily-stat"}}')
...
;// CONCATENATED MODULE: ./docs/kubernetes/dashboard-hitmap-trace.mdx
