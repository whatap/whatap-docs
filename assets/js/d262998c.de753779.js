"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["34465"], {
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_server_integrated_report_mdx_d26_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-server-integrated-report-mdx-d26.json
var site_docs_server_integrated_report_mdx_d26_namespaceObject = JSON.parse('{"id":"server/integrated-report","title":"통합 보고서","description":"통합 보고서를 안내합니다.","source":"@site/docs/server/integrated-report.mdx","sourceDirName":"server","slug":"/server/integrated-report","permalink":"/server/integrated-report","draft":false,"unlisted":false,"editUrl":"undefined/docs/server/integrated-report.mdx","tags":[],"version":"current","frontMatter":{"id":"integrated-report","title":"통합 보고서","description":"통합 보고서를 안내합니다.","keywords":["통합 보고서","분석하기","UI"],"isTranslationMissing":false},"sidebar":"serverSidebar","previous":{"title":"서버 보고서","permalink":"/server/report"},"next":{"title":"알림 설정하기","permalink":"/server/set-notice"}}')
...
;// CONCATENATED MODULE: ./docs/server/integrated-report.mdx
