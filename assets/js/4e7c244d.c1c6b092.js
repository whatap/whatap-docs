...
"17185": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_release_notes_dotnet_dotnet_2_3_3_mdx_4e7_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-release-notes-dotnet-dotnet-2-3-3-mdx-4e7.json
var site_docs_release_notes_dotnet_dotnet_2_3_3_mdx_4e7_namespaceObject = JSON.parse('{"id":"release-notes/dotnet/dotnet-2_3_3","title":".NET Agent v2.3.3","description":"2024년 09월 25일","source":"@site/docs/release-notes/dotnet/dotnet-2.3.3.mdx","sourceDirName":"release-notes/dotnet","slug":"/release-notes/dotnet/dotnet-2_3_3","permalink":"/release-notes/dotnet/dotnet-2_3_3","draft":false,"unlisted":false,"editUrl":"undefined/docs/release-notes/dotnet/dotnet-2.3.3.mdx","tags":[],"version":"current","frontMatter":{"id":"dotnet-2_3_3","title":".NET Agent v2.3.3","toc_max_heading_level":2,"pagination_next":"release-notes/dotnet/dotnet-2_3_2","displayed_sidebar":"releaseSidebar","isTranslationMissing":false},"sidebar":"releaseSidebar","previous":{"title":".NET Agent v2.3.4","permalink":"/release-notes/dotnet/dotnet-2_3_4"},"next":{"title":".NET Agent v2.3.2","permalink":"/release-notes/dotnet/dotnet-2_3_2"}}')
...
;// CONCATENATED MODULE: ./docs/release-notes/dotnet/dotnet-2.3.3.mdx
      ...
      children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
        ...
        children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
          children: [(0,jsx_runtime.jsx)(Status, {
            priority: "0",
            children: "Fixed"
          }), " .NET Core 버전의 에이전트를 설치한 후 삭제하지 않은 상태에서, .NET Framework 버전을 추가로 설치하면 액티브 스택이 수집되지 않는 버그 수정"]
        }), "\n"]
      }), "\n"]
