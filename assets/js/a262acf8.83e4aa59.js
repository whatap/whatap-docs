"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["53229"], {
...
"77065": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_dotnet_dashboard_hitmap_trace_mdx_a26_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-dotnet-dashboard-hitmap-trace-mdx-a26.json
var site_docs_dotnet_dashboard_hitmap_trace_mdx_a26_namespaceObject = JSON.parse('{"id":"dotnet/dashboard-hitmap-trace","title":"히트맵 - 트레이스 분석","description":"히트맵 위젯을 통해 트레이스 분석 창을 열어 트랜잭션 목록과 각 트랜잭션 하위의 스텝 정보를 한 번에 확인할 수 있습니다.","source":"@site/docs/dotnet/dashboard-hitmap-trace.mdx","sourceDirName":"dotnet","slug":"/dotnet/dashboard-hitmap-trace","permalink":"/dotnet/dashboard-hitmap-trace","draft":false,"unlisted":false,"editUrl":"undefined/docs/dotnet/dashboard-hitmap-trace.mdx","tags":[],"version":"current","frontMatter":{"id":"dashboard-hitmap-trace","title":"히트맵 - 트레이스 분석","description":"히트맵 위젯을 통해 트레이스 분석 창을 열어 트랜잭션 목록과 각 트랜잭션 하위의 스텝 정보를 한 번에 확인할 수 있습니다.","keywords":[".NET","애플리케이션","히트맵","트레이스"],"isTranslationMissing":false},"sidebar":"dotNetSidebar","previous":{"title":"IIS 성능 카운트","permalink":"/dotnet/dashboard-iis-perf-count"},"next":{"title":"Flex 보드","permalink":"/dotnet/flex-board"}}')
...
;// CONCATENATED MODULE: ./docs/dotnet/dashboard-hitmap-trace.mdx
