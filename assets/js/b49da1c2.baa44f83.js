"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["78673"], {
...
"21694": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_postgresql_dashboard_intro_mdx_b49_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-postgresql-dashboard-intro-mdx-b49.json
var site_docs_postgresql_dashboard_intro_mdx_b49_namespaceObject = JSON.parse('{"id":"postgresql/dashboard-intro","title":"대시보드","description":"와탭 모니터링 대시보드는 프로젝트의 전체 현황을 한 눈에 파악하기 위한 기능을 제공합니다.","source":"@site/docs/postgresql/dashboard-intro.mdx","sourceDirName":"postgresql","slug":"/postgresql/dashboard-intro","permalink":"/postgresql/dashboard-intro","draft":false,"unlisted":false,"editUrl":"undefined/docs/postgresql/dashboard-intro.mdx","tags":[],"version":"current","frontMatter":{"id":"dashboard-intro","title":"대시보드","description":"와탭 모니터링 대시보드는 프로젝트의 전체 현황을 한 눈에 파악하기 위한 기능을 제공합니다.","keywords":["PostgreSQL","대시보드","인스턴스","데이터베이스 모니터링"],"isTranslationMissing":false},"sidebar":"postgreSidebar","previous":{"title":"관리하기","permalink":"/postgresql/agent-manage"},"next":{"title":"인스턴스 목록","permalink":"/postgresql/instance-list"}}')
...
;// CONCATENATED MODULE: ./docs/postgresql/dashboard-intro.mdx
