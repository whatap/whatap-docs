"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["77149"], {
"65252": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_browser_flexboard_share_mdx_818_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-browser-flexboard-share-mdx-818.json
var site_docs_browser_flexboard_share_mdx_818_namespaceObject = JSON.parse('{"id":"browser/flexboard-share","title":"Flex 보드 공유하기","description":"Flex 보드를 다른 계정의 사용자와 공유하고 재사용할 수 있습니다.","source":"@site/docs/browser/flexboard-share.mdx","sourceDirName":"browser","slug":"/browser/flexboard-share","permalink":"/browser/flexboard-share","draft":false,"unlisted":false,"editUrl":"undefined/docs/browser/flexboard-share.mdx","tags":[],"version":"current","frontMatter":{"id":"flexboard-share","title":"Flex 보드 공유하기","description":"Flex 보드를 다른 계정의 사용자와 공유하고 재사용할 수 있습니다.","keywords":["브라우저 모니터링","Flex 보드"],"isTranslationMissing":false},"sidebar":"rumsSidebar","previous":{"title":"Flex 보드 화면 모드","permalink":"/browser/flexboard-mode"},"next":{"title":"페이지 로드 분석하기","permalink":"/browser/analyze-pageload"}}')
...
;// CONCATENATED MODULE: ./docs/browser/flexboard-share.mdx
