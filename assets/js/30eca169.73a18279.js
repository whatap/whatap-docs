"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["42193"], {
"86425": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
"20680": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_java_agent_number_of_user_mdx_30e_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-java-agent-number-of-user-mdx-30e.json
var site_docs_java_agent_number_of_user_mdx_30e_namespaceObject = JSON.parse('{"id":"java/agent-number-of-user","title":"사용자 수","description":"자바(Java) 웹 애플리케이션 서버에 연결된 사용자 수를 에이전트 설정을 통해 집계하는 방법을 안내합니다. 실시간 사용자 집계 활성화 여부 설정, 사용자 수를 집계하기 위한 쿠키 제한 설정, IP 주소 또는 HTTP 헤더 특정 값을 기준으로 한 사용자 집계 방법, 클라이언트 IP 정보 추적을 위한 HTTP 헤더 설정 등을 포함합니다.","source":"@site/docs/java/agent-number-of-user.mdx","sourceDirName":"java","slug":"/java/agent-number-of-user","permalink":"/java/agent-number-of-user","draft":false,"unlisted":false,"editUrl":"undefined/docs/java/agent-number-of-user.mdx","tags":[],"version":"current","frontMatter":{"id":"agent-number-of-user","title":"사용자 수","description":"자바(Java) 웹 애플리케이션 서버에 연결된 사용자 수를 에이전트 설정을 통해 집계하는 방법을 안내합니다. 실시간 사용자 집계 활성화 여부 설정, 사용자 수를 집계하기 위한 쿠키 제한 설정, IP 주소 또는 HTTP 헤더 특정 값을 기준으로 한 사용자 집계 방법, 클라이언트 IP 정보 추적을 위한 HTTP 헤더 설정 등을 포함합니다.","keywords":["Java","애플리케이션","에이전트"],"isTranslationMissing":false},"sidebar":"javaSidebar","previous":{"title":"스크립트 플러그인","permalink":"/java/script-plugin"},"next":{"title":"부하량 제어","permalink":"/java/agent-load-amount"}}')
// EXTERNAL MODULE: ./node_modules/react/jsx-runtime.js
var jsx_runtime = __webpack_require__("85893");
// EXTERNAL MODULE: ./node_modules/@mdx-js/react/lib/index.js
var lib = __webpack_require__("50065");
// EXTERNAL MODULE: ./docs/common-items/_common-collect-user.mdx
var _common_collect_user = __webpack_require__("86425");
;// CONCATENATED MODULE: ./docs/java/agent-number-of-user.mdx
...
const toc = [..._common_collect_user/* toc */.d$];
function _createMdxContent(props) {
  const _components = {
    admonition: "admonition",
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    ...
    }), "\n", "\n", (0,jsx_runtime.jsx)(_common_collect_user/* default */.ZP, {})]
  });
}
function MDXContent(props = {}) {
  const {wrapper: MDXLayout} = {
