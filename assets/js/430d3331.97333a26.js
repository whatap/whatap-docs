"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["10503"], {
...
"93721": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_redis_log_db_mdx_430_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-redis-log-db-mdx-430.json
var site_docs_redis_log_db_mdx_430_namespaceObject = JSON.parse('{"id":"redis/log-db","title":"적용하기","description":"데이터베이스와 AWS RDS의 로그를 수집하는 방법을 안내합니다.","source":"@site/docs/redis/log-db.mdx","sourceDirName":"redis","slug":"/redis/log-db","permalink":"/redis/log-db","draft":false,"unlisted":false,"editUrl":"undefined/docs/redis/log-db.mdx","tags":[],"version":"current","frontMatter":{"id":"log-db","title":"적용하기","description":"데이터베이스와 AWS RDS의 로그를 수집하는 방법을 안내합니다.","keywords":["로그 모니터링","데이터베이스","Redis"],"isTranslationMissing":false},"sidebar":"redisSidebar","previous":{"title":"로그","permalink":"/redis/log-main"},"next":{"title":"라이브 테일","permalink":"/redis/log-lt"}}')
...
;// CONCATENATED MODULE: ./docs/redis/log-db.mdx
