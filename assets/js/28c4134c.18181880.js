"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["70535"], {
...
"54198": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_java_add_jvm_opt_tomcat_mdx_28c_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-java-add-jvm-opt-tomcat-mdx-28c.json
var site_docs_java_add_jvm_opt_tomcat_mdx_28c_namespaceObject = JSON.parse('{"id":"java/add-jvm-opt/tomcat","title":"Tomcat","description":"와탭 모니터링 솔루션을 톰캣(Tomcat) 애플리케이션에 통합하기 위한 JVM(Java Virtual Machine) 옵션 추가 방법에 대한 상세한 안내를 제공합니다. 사용자는 본 문서를 통해 자바(Java) 에이전트 설치 후 톰캣(Tomcat) 애플리케이션의 성능 및 가용성 모니터링을 위해 필요한 JVM 설정을 적용하는 방법을 단계별로 확인할 수 있습니다. 에이전트 설치 과정 중 필수 JVM 옵션의 구성과 톰캣(Tomcat)과의 원활한 통합을 위한 최적의 설정 방법, 힙스토그램 조회 방법을 포함하고 있습니다.","source":"@site/docs/java/add-jvm-opt/tomcat.mdx","sourceDirName":"java/add-jvm-opt","slug":"/java/add-jvm-opt/tomcat","permalink":"/java/add-jvm-opt/tomcat","draft":false,"unlisted":false,"editUrl":"undefined/docs/java/add-jvm-opt/tomcat.mdx","tags":[],"version":"current","frontMatter":{"id":"tomcat","title":"Tomcat","description":"와탭 모니터링 솔루션을 톰캣(Tomcat) 애플리케이션에 통합하기 위한 JVM(Java Virtual Machine) 옵션 추가 방법에 대한 상세한 안내를 제공합니다. 사용자는 본 문서를 통해 자바(Java) 에이전트 설치 후 톰캣(Tomcat) 애플리케이션의 성능 및 가용성 모니터링을 위해 필요한 JVM 설정을 적용하는 방법을 단계별로 확인할 수 있습니다. 에이전트 설치 과정 중 필수 JVM 옵션의 구성과 톰캣(Tomcat)과의 원활한 통합을 위한 최적의 설정 방법, 힙스토그램 조회 방법을 포함하고 있습니다.","keywords":["Java","Tomcat","애플리케이션","에이전트"],"isTranslationMissing":false},"sidebar":"javaSidebar","previous":{"title":"에이전트 설치","permalink":"/java/install-agent"},"next":{"title":"JBoss","permalink":"/java/add-jvm-opt/jboss"}}')
...
;// CONCATENATED MODULE: ./docs/java/add-jvm-opt/tomcat.mdx
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsxs)(_components.section, {
      ...
      children: [(0,jsx_runtime.jsx)(_components.h3, {
        ...
        }), " 파일 상단에 ", (0,jsx_runtime.jsx)(_components.code, {
          children: "JAVA_OPTS"
        }), " 환경 변수를 추가하세요."]
              ...
              children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
                children: [(0,jsx_runtime.jsx)(_components.em, {
                  ...
                  children: (0,jsx_runtime.jsxs)(_components.strong, {
                    children: ["Apache Tomcat ", (0,jsx_runtime.jsx)(_components.code, {
                      children: "X.Y.Z."
                    })]
                  })
                }), " > ", (0,jsx_runtime.jsx)(_components.em, {
      ...
      }), (0,jsx_runtime.jsx)(_java_17/* default */.ZP, {}), (0,jsx_runtime.jsx)(_set_heap_memory/* default */.ZP, {}), (0,jsx_runtime.jsx)(_apm_next_step/* default */.ZP, {})]
    })]
  });
}
function MDXContent(props = {}) {
