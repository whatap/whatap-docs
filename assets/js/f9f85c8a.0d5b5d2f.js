"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[48435],{
...
const metadata = {
  ...
  "title": "지원 환경",
  "description": "데이터베이스 모니터링을 시작하기 전에 지원하는 데이터베이스 종류에 대해서 알아보세요.",
  "source": "@site/docs/mssql-v1/monitoring-support.mdx",
  "sourceDirName": "mssql-v1",
  "slug": "/mssql-v1/monitoring-support",
  "permalink": "/whatap-docs/mssql-v1/monitoring-support",
  "draft": false,
  "unlisted": false,
  "editUrl": "undefined/docs/mssql-v1/monitoring-support.mdx",
  "tags": [],
  "version": "current",
  "frontMatter": {
    "id": "monitoring-support",
