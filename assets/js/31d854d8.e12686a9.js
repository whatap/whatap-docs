"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["51213"], {
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_log_set_notice_mdx_31d_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-log-set-notice-mdx-31d.json
var site_docs_log_set_notice_mdx_31d_namespaceObject = JSON.parse('{"id":"log/set-notice","title":"알림 설정하기","description":"로그 이벤트 알림 메뉴를 안내합니다.","source":"@site/docs/log/set-notice.mdx","sourceDirName":"log","slug":"/log/set-notice","permalink":"/log/set-notice","draft":false,"unlisted":false,"editUrl":"undefined/docs/log/set-notice.mdx","tags":[],"version":"current","frontMatter":{"id":"set-notice","title":"알림 설정하기","description":"로그 이벤트 알림 메뉴를 안내합니다.","keywords":["로그 모니터링","알림","UI"],"isTranslationMissing":false},"sidebar":"logSidebar","previous":{"title":"로그 검색","permalink":"/log/log-search"},"next":{"title":"이벤트 수신 설정","permalink":"/log/set-receive-event"}}')
...
;// CONCATENATED MODULE: ./docs/log/set-notice.mdx
