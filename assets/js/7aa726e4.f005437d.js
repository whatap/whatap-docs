"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["48109"], {
...
"33830": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_oracle_cloud_flexboard_mod_mdx_7aa_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-oracle-cloud-flexboard-mod-mdx-7aa.json
var site_docs_oracle_cloud_flexboard_mod_mdx_7aa_namespaceObject = JSON.parse('{"id":"oracle-cloud/flexboard-mode","title":"Flex 보드 화면 모드","description":"Flex 보드의 화면 모드에 따라 제공하는 기능에 대해 알아보세요.","source":"@site/docs/oracle-cloud/flexboard-mod.mdx","sourceDirName":"oracle-cloud","slug":"/oracle-cloud/flexboard-mode","permalink":"/oracle-cloud/flexboard-mode","draft":false,"unlisted":false,"editUrl":"undefined/docs/oracle-cloud/flexboard-mod.mdx","tags":[],"version":"current","frontMatter":{"id":"flexboard-mode","title":"Flex 보드 화면 모드","description":"Flex 보드의 화면 모드에 따라 제공하는 기능에 대해 알아보세요.","keywords":["Flex 보드","Oracle Cloud Monitor","클라우드"],"isTranslationMissing":false},"sidebar":"oracleSidebar","previous":{"title":"위젯 템플릿","permalink":"/oracle-cloud/flexboard-widget-template"},"next":{"title":"Flex 보드 공유하기","permalink":"/oracle-cloud/flexboard-share"}}')
...
;// CONCATENATED MODULE: ./docs/oracle-cloud/flexboard-mod.mdx
