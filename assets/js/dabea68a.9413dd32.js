"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["68103"], {
...
"15780": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_dotnet_report_apm_mdx_dab_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-dotnet-report-apm-mdx-dab.json
var site_docs_dotnet_report_apm_mdx_dab_namespaceObject = JSON.parse('{"id":"dotnet/report-apm","title":"애플리케이션 보고서","description":"애플리케이션의 주요 성능에 대한 보고서를 제공합니다.","source":"@site/docs/dotnet/report-apm.mdx","sourceDirName":"dotnet","slug":"/dotnet/report-apm","permalink":"/dotnet/report-apm","draft":false,"unlisted":false,"editUrl":"undefined/docs/dotnet/report-apm.mdx","tags":[],"version":"current","frontMatter":{"id":"report-apm","title":"애플리케이션 보고서","description":"애플리케이션의 주요 성능에 대한 보고서를 제공합니다.","toc_max_heading_level":3,"keywords":[".NET","애플리케이션","보고서"],"isTranslationMissing":false},"sidebar":"dotNetSidebar","previous":{"title":"보고서","permalink":"/dotnet/report-intro"},"next":{"title":"통합 보고서","permalink":"/dotnet/integrated-report"}}')
...
;// CONCATENATED MODULE: ./docs/dotnet/report-apm.mdx
