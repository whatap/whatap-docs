"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["90016"], {
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_python_real_time_notification_mdx_ac1_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-python-real-time-notification-mdx-ac1.json
var site_docs_python_real_time_notification_mdx_ac1_namespaceObject = JSON.parse('{"id":"python/real-time-notification","title":"실시간 알림","description":"이벤트 설정 메뉴를 통해서 설정한 경고 알림을 실시간으로 확인할 수 있습니다.","source":"@site/docs/python/real-time-notification.mdx","sourceDirName":"python","slug":"/python/real-time-notification","permalink":"/python/real-time-notification","draft":false,"unlisted":false,"editUrl":"undefined/docs/python/real-time-notification.mdx","tags":[],"version":"current","frontMatter":{"id":"real-time-notification","title":"실시간 알림","description":"이벤트 설정 메뉴를 통해서 설정한 경고 알림을 실시간으로 확인할 수 있습니다.","keywords":["실시간 알림"],"isTranslationMissing":false},"sidebar":"pySidebar","previous":{"title":"이벤트 수신 포맷","permalink":"/python/set-event-format"},"next":{"title":"시스템 이벤트 안내","permalink":"/python/common-alert"}}')
...
;// CONCATENATED MODULE: ./docs/python/real-time-notification.mdx
