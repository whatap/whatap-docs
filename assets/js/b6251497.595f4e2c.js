"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["14510"], {
...
"48515": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_oracle_log_lt_mdx_b62_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-oracle-log-lt-mdx-b62.json
var site_docs_oracle_log_lt_mdx_b62_namespaceObject = JSON.parse('{"id":"oracle/log-lt","title":"라이브 테일","description":"로그 모니터링 라이브 테일을 안내합니다.","source":"@site/docs/oracle/log-lt.mdx","sourceDirName":"oracle","slug":"/oracle/log-lt","permalink":"/oracle/log-lt","draft":false,"unlisted":false,"editUrl":"undefined/docs/oracle/log-lt.mdx","tags":[],"version":"current","frontMatter":{"id":"log-lt","title":"라이브 테일","description":"로그 모니터링 라이브 테일을 안내합니다.","keywords":["로그 모니터링","라이브 테일","UI","Oracle"],"isTranslationMissing":false},"sidebar":"dboracleV2Sidebar","previous":{"title":"적용하기","permalink":"/oracle/log-db"},"next":{"title":"로그 트렌드","permalink":"/oracle/log-exp"}}')
...
;// CONCATENATED MODULE: ./docs/oracle/log-lt.mdx
