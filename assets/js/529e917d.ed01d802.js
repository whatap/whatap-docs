...
"8041": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_altibase_warning_notice_mdx_529_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-altibase-warning-notice-mdx-529.json
var site_docs_altibase_warning_notice_mdx_529_namespaceObject = JSON.parse('{"id":"altibase/warning-notice","title":"데이터베이스 경고 알림","description":"데이터베이스의 지표별 이벤트 조건 설정을 통해 경고 알림을 보냅니다.","source":"@site/docs/altibase/warning-notice.mdx","sourceDirName":"altibase","slug":"/altibase/warning-notice","permalink":"/altibase/warning-notice","draft":false,"unlisted":false,"editUrl":"undefined/docs/altibase/warning-notice.mdx","tags":[],"version":"current","frontMatter":{"id":"warning-notice","title":"데이터베이스 경고 알림","description":"데이터베이스의 지표별 이벤트 조건 설정을 통해 경고 알림을 보냅니다.","keywords":["Altibase","경고 알림","데이터베이스","데이터베이스 모니터링"],"isTranslationMissing":false},"sidebar":"altibaseSidebar","previous":{"title":"알림 설정하기","permalink":"/altibase/set-notice"},"next":{"title":"이벤트 설정","permalink":"/altibase/warning-notice-v2"}}')
...
;// CONCATENATED MODULE: ./docs/altibase/warning-notice.mdx
