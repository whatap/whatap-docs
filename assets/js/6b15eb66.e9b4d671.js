"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["33476"], {
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_dotnet_metrics_app_mdx_6b1_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-dotnet-metrics-app-mdx-6b1.json
var site_docs_dotnet_metrics_app_mdx_6b1_namespaceObject = JSON.parse('{"id":"dotnet/metrics-app","title":"애플리케이션 지표","description":"애플리케이션 지표를 안내합니다.","source":"@site/docs/dotnet/metrics-app.mdx","sourceDirName":"dotnet","slug":"/dotnet/metrics-app","permalink":"/dotnet/metrics-app","draft":false,"unlisted":false,"editUrl":"undefined/docs/dotnet/metrics-app.mdx","tags":[],"version":"current","frontMatter":{"id":"metrics-app","title":"애플리케이션 지표","description":"애플리케이션 지표를 안내합니다.","toc_max_heading_level":2,"keywords":[".NET","메트릭스","애플리케이션","UI"],"isTranslationMissing":false},"sidebar":"dotNetSidebar","previous":{"title":"메트릭스","permalink":"/dotnet/metrics-intro"},"next":{"title":"애플리케이션 성능 카운터","permalink":"/dotnet/metrics-performance-counter"}}')
...
;// CONCATENATED MODULE: ./docs/dotnet/metrics-app.mdx
