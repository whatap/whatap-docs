"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["64721"], {
"50035": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_altibase_log_lt_mdx_478_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-altibase-log-lt-mdx-478.json
var site_docs_altibase_log_lt_mdx_478_namespaceObject = JSON.parse('{"id":"altibase/log-lt","title":"라이브 테일","description":"로그 모니터링 라이브 테일을 안내합니다.","source":"@site/docs/altibase/log-lt.mdx","sourceDirName":"altibase","slug":"/altibase/log-lt","permalink":"/altibase/log-lt","draft":false,"unlisted":false,"editUrl":"undefined/docs/altibase/log-lt.mdx","tags":[],"version":"current","frontMatter":{"id":"log-lt","title":"라이브 테일","description":"로그 모니터링 라이브 테일을 안내합니다.","keywords":["로그 모니터링","라이브 테일","UI","Altibase"],"isTranslationMissing":false},"sidebar":"altibaseSidebar","previous":{"title":"적용하기","permalink":"/altibase/log-db"},"next":{"title":"로그 트렌드","permalink":"/altibase/log-exp"}}')
