"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[78018],{
...
const metadata = {
  ...
  "title": "Flex 보드",
  "description": "사용자 정의형 통합 대시보드를 안내합니다. 사용자는 애플리케이션, 서버, 데이터베이스, 컨테이너 등의 데이터로 실시간 대시보드를 만들 수 있습니다. 사전 구성된 템플릿을 제공하며, 다양한 데이터 위젯 추가, 데이터 필터링, 시간 범위 설정 등의 기능을 통해 사용자가 원하는 모니터링 대상을 쉽게 간추리고 중요 데이터를 확인할 수 있습니다.",
  "source": "@site/docs/oracle-v2/flex-board.mdx",
  "sourceDirName": "oracle-v2",
  "slug": "/oracle-v2/flex-board",
  "permalink": "/whatap-docs/oracle-v2/flex-board",
  "draft": false,
  "unlisted": false,
  "editUrl": "undefined/docs/oracle-v2/flex-board.mdx",
  "tags": [
    {
      "inline": true,
      "label": "Oracle",
