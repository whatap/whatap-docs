"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[85875],{
...
;// CONCATENATED MODULE: ./docs/common-items/_db-count-trend.mdx
    ...
    children: [(0,jsx_runtime.jsx)(_components.h2, {
      ...
      children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
        ...
        children: ["\n", (0,jsx_runtime.jsx)(_components.p, {
          ...
          children: ["화면 아래 ", (0,jsx_runtime.jsx)(_components.em, {
            children: (0,jsx_runtime.jsx)(_components.strong, {
              children: "액티브 세션"
            })
          }), " 탭을 선택하세요. 현재 진행 중인 세션들의 정보(Query 포함)를 확인합니다. 10초 이상 진행되고 있는 세션인 경우 ", (0,jsx_runtime.jsx)("span", {
            class: "slow",
            children: "노란색"
          }), " , 20초 이상의 세션인 경우 ", (0,jsx_runtime.jsx)("span", {
            class: "vslow",
            children: "빨간색"
        ...
        children: ["\n", (0,jsx_runtime.jsx)(_components.p, {
          ...
          }), " 탭을 선택하세요. 락에 대한 정보를 확인할 수 있습니다. holder와 waiter의 구조를 트리 형태로 표현하여 제공합니다. 10초 이상 진행되고 있는 세션인 경우 ", (0,jsx_runtime.jsx)("span", {
            class: "slow",
            children: "노란색"
          }), " , 20초 이상의 세션인 경우 ", (0,jsx_runtime.jsx)("span", {
            class: "vslow",
...
;// CONCATENATED MODULE: ./docs/common-items/_db-compare-count-trend.mdx


const _db_compare_count_trend_frontMatter = {};
const _db_compare_count_trend_contentTitle = (/* unused pure expression or super */ null && (undefined));





const _db_compare_count_trend_toc = [{
  "value": "카운트 추이 비교",
  "id": "카운트-추이-비교",
  "level": 2
}];
function _db_compare_count_trend_createMdxContent(props) {
  const _components = {
    em: "em",
    h2: "h2",
    img: "img",
  ...
  if (!ImgLang) _db_compare_count_trend_missingMdxReference("ImgLang", true);
  return (0,jsx_runtime.jsxs)(_components.section, {
    className: "remark-sectionize-h2",
    children: [(0,jsx_runtime.jsx)(_components.h2, {
      id: "카운트-추이-비교",
      ...
      children: ["서로 다른 날짜의 카운트 추이를 비교할 수 있습니다. ", (0,jsx_runtime.jsx)(_components.em, {
        children: (0,jsx_runtime.jsx)(_components.strong, {
          children: "기준 날짜"
        })
      ...
      }), "를 설정한 다음 ", (0,jsx_runtime.jsx)(_components.img, {
        alt: "검색 아이콘",
...
function _db_compare_count_trend_MDXContent(props = {}) {
  const {wrapper: MDXLayout} = {
    ...(0,lib/* useMDXComponents */.R)(),
    ...props.components
  };
  return MDXLayout ? (0,jsx_runtime.jsx)(MDXLayout, {
    ...props,
    children: (0,jsx_runtime.jsx)(_db_compare_count_trend_createMdxContent, {
      ...props
    })
  }) : _db_compare_count_trend_createMdxContent(props);
}
function _db_compare_count_trend_missingMdxReference(id, component) {
  throw new Error("Expected " + (component ? "component" : "object") + " `" + id + "` to be defined: you likely forgot to import, pass, or provide it.");
}


;// CONCATENATED MODULE: ./docs/common-items/_db-using-count-trend-chart.mdx


const _db_using_count_trend_chart_frontMatter = {};
const _db_using_count_trend_chart_contentTitle = (/* unused pure expression or super */ null && (undefined));





const _db_using_count_trend_chart_toc = [{
  "value": "카운트 추이 차트 활용하기",
  "id": "카운트-추이-차트-활용하기",
  "level": 2
}];
function _db_using_count_trend_chart_createMdxContent(props) {
  const _components = {
    em: "em",
    h2: "h2",
    img: "img",
  ...
  if (!ImgLang) _db_using_count_trend_chart_missingMdxReference("ImgLang", true);
  return (0,jsx_runtime.jsxs)(_components.section, {
    className: "remark-sectionize-h2",
    children: [(0,jsx_runtime.jsx)(_components.h2, {
      id: "카운트-추이-차트-활용하기",
      ...
      }), "으로 설정한 다음 ", (0,jsx_runtime.jsx)(_components.em, {
        children: (0,jsx_runtime.jsx)(_components.strong, {
          children: "저장"
        })
      }), " 버튼을 선택하세요. ", (0,jsx_runtime.jsx)(_components.em, {
      ...
      }), "은 ", (0,jsx_runtime.jsx)(_components.em, {
        children: (0,jsx_runtime.jsx)(_components.strong, {
          children: "최근 24시간"
        })
      ...
      children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
        children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
          children: ["지표 차트의 특정 시점을 클릭하면(", (0,jsx_runtime.jsx)(_components.img, {
            alt: "지시선 1",
        ...
        children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
          children: ["액티브 세션 데이터는 5초 단위로 수집하고 있습니다. 화면 아래에 ", (0,jsx_runtime.jsx)(_components.img, {
            alt: "지시선 2",
        ...
        children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
          children: ["1분 단위로 시간을 이동하려면 ", (0,jsx_runtime.jsx)(_components.img, {
            alt: "지시선 3",
        ...
        children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
          children: ["상세 정보 데이터 셀에 표시하는 항목을 더하거나 빼려면 ", (0,jsx_runtime.jsx)(_components.img, {
            alt: "지시선 3",
            src: (__webpack_require__(55522)/* ["default"] */ .A) + "",
            width: "35",
            height: "35"
        ...
        children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
          children: ["화면 아래에 출력된 데이터를 csv 파일로 다운로드할 수 있습니다. ", (0,jsx_runtime.jsx)(_components.img, {
            alt: "지시선 3",
            src: (__webpack_require__(55522)/* ["default"] */ .A) + "",
            width: "35",
            height: "35"
...
function _db_using_count_trend_chart_MDXContent(props = {}) {
  const {wrapper: MDXLayout} = {
    ...(0,lib/* useMDXComponents */.R)(),
    ...props.components
  };
  return MDXLayout ? (0,jsx_runtime.jsx)(MDXLayout, {
    ...props,
    children: (0,jsx_runtime.jsx)(_db_using_count_trend_chart_createMdxContent, {
      ...props
    })
  }) : _db_using_count_trend_chart_createMdxContent(props);
}
function _db_using_count_trend_chart_missingMdxReference(id, component) {
  throw new Error("Expected " + (component ? "component" : "object") + " `" + id + "` to be defined: you likely forgot to import, pass, or provide it.");
}


;// CONCATENATED MODULE: ./docs/common-items/_db-locktree.mdx


const _db_locktree_frontMatter = {};
const _db_locktree_contentTitle = (/* unused pure expression or super */ null && (undefined));





const _db_locktree_toc = [{
  "value": "락 트리",
  "id": "락-트리",
  "level": 2
}];
function _db_locktree_createMdxContent(props) {
  const _components = {
    em: "em",
    h2: "h2",
    p: "p",
  ...
  if (!Youtube) _db_locktree_missingMdxReference("Youtube", true);
  return (0,jsx_runtime.jsxs)(_components.section, {
    className: "remark-sectionize-h2",
    children: [(0,jsx_runtime.jsx)(_components.h2, {
      id: "락-트리",
...
function _db_locktree_MDXContent(props = {}) {
  const {wrapper: MDXLayout} = {
    ...(0,lib/* useMDXComponents */.R)(),
    ...props.components
  };
  return MDXLayout ? (0,jsx_runtime.jsx)(MDXLayout, {
    ...props,
    children: (0,jsx_runtime.jsx)(_db_locktree_createMdxContent, {
      ...props
    })
  }) : _db_locktree_createMdxContent(props);
}
function _db_locktree_missingMdxReference(id, component) {
  throw new Error("Expected " + (component ? "component" : "object") + " `" + id + "` to be defined: you likely forgot to import, pass, or provide it.");
}
...
;// CONCATENATED MODULE: ./docs/altibase-v1/analysis-function.mdx
...
const metadata = {
  "id": "altibase-v1/analysis-function",
  "title": "데이터베이스 분석하기",
  "description": "데이터베이스의 성능을 실시간 모니터링을 통해 분석할 수 있는 지표들에 대한 설명입니다.",
  "source": "@site/docs/altibase-v1/analysis-function.mdx",
  "sourceDirName": "altibase-v1",
  "slug": "/altibase-v1/analysis-function",
  "permalink": "/whatap-docs/altibase-v1/analysis-function",
  "draft": false,
  "unlisted": false,
  "editUrl": "undefined/docs/altibase-v1/analysis-function.mdx",
  "tags": [],
  "version": "current",
  "frontMatter": {
    "id": "analysis-function",
  ...
  "previous": {
    "title": "메트릭스 이상 탐지",
    "permalink": "/whatap-docs/altibase-v1/metrics-detect-anormal"
  },
  "next": {
    "title": "통계 데이터 확인",
    "permalink": "/whatap-docs/altibase-v1/stat"
  }
};
const assets = {
...
const analysis_function_toc = [...toc, ..._db_compare_count_trend_toc, ..._db_using_count_trend_chart_toc, ..._db_locktree_toc, {
  "value": "데이터베이스 파라미터",
  "id": "side_dbParameter",
  "level": 2
...
function analysis_function_createMdxContent(props) {
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    ...
    }), "\n", "\n", (0,jsx_runtime.jsx)(MDXContent, {}), "\n", "\n", (0,jsx_runtime.jsx)(_db_compare_count_trend_MDXContent, {}), "\n", "\n", (0,jsx_runtime.jsx)(_db_using_count_trend_chart_MDXContent, {}), "\n", "\n", (0,jsx_runtime.jsx)(_db_locktree_MDXContent, {}), "\n", "\n", "\n", (0,jsx_runtime.jsxs)(_components.section, {
      className: "remark-sectionize-h2",
      children: [(0,jsx_runtime.jsx)(_components.h2, {
        id: "side_dbParameter",
