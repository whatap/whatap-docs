"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["3099"], {
...
"12910": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_server_labs_mdx_787_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-server-labs-mdx-787.json
var site_docs_server_labs_mdx_787_namespaceObject = JSON.parse('{"id":"server/labs","title":"실험실","description":"사용자에게 새로운 기능 또는 실험적인 기능을 제공하는 메뉴인 실험실에 대해 안내합니다.","source":"@site/docs/server/labs.mdx","sourceDirName":"server","slug":"/server/labs","permalink":"/server/labs","draft":false,"unlisted":false,"editUrl":"undefined/docs/server/labs.mdx","tags":[],"version":"current","frontMatter":{"id":"labs","title":"실험실","description":"사용자에게 새로운 기능 또는 실험적인 기능을 제공하는 메뉴인 실험실에 대해 안내합니다.","keywords":["Server","실험실"],"isTranslationMissing":false},"sidebar":"serverSidebar","previous":{"title":"Log 모니터링","permalink":"/log/introduction"}}')
...
;// CONCATENATED MODULE: ./docs/server/labs.mdx
