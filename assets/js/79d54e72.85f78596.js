"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["51715"], {
"50378": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_browser_flexboard_mode_mdx_79d_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-browser-flexboard-mode-mdx-79d.json
var site_docs_browser_flexboard_mode_mdx_79d_namespaceObject = JSON.parse('{"id":"browser/flexboard-mode","title":"Flex 보드 화면 모드","description":"Flex 보드의 화면 모드에 따라 제공하는 기능에 대해 알아보세요.","source":"@site/docs/browser/flexboard-mode.mdx","sourceDirName":"browser","slug":"/browser/flexboard-mode","permalink":"/browser/flexboard-mode","draft":false,"unlisted":false,"editUrl":"undefined/docs/browser/flexboard-mode.mdx","tags":[],"version":"current","frontMatter":{"id":"flexboard-mode","title":"Flex 보드 화면 모드","description":"Flex 보드의 화면 모드에 따라 제공하는 기능에 대해 알아보세요.","keywords":["브라우저 모니터링","Flex 보드"],"isTranslationMissing":false},"sidebar":"rumsSidebar","previous":{"title":"위젯 템플릿","permalink":"/browser/flexboard-widget-template"},"next":{"title":"Flex 보드 공유하기","permalink":"/browser/flexboard-share"}}')
...
;// CONCATENATED MODULE: ./docs/browser/flexboard-mode.mdx
