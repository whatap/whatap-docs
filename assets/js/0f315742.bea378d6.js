"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["80430"], {
...
"36596": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_golang_dashboard_hitmap_trace_mdx_0f3_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-golang-dashboard-hitmap-trace-mdx-0f3.json
var site_docs_golang_dashboard_hitmap_trace_mdx_0f3_namespaceObject = JSON.parse('{"id":"golang/dashboard-hitmap-trace","title":"히트맵 - 트레이스 분석","description":"히트맵 위젯을 통해 트레이스 분석 창을 열어 트랜잭션 목록과 각 트랜잭션 하위의 스텝 정보를 한 번에 확인할 수 있습니다.","source":"@site/docs/golang/dashboard-hitmap-trace.mdx","sourceDirName":"golang","slug":"/golang/dashboard-hitmap-trace","permalink":"/golang/dashboard-hitmap-trace","draft":false,"unlisted":false,"editUrl":"undefined/docs/golang/dashboard-hitmap-trace.mdx","tags":[],"version":"current","frontMatter":{"id":"dashboard-hitmap-trace","title":"히트맵 - 트레이스 분석","description":"히트맵 위젯을 통해 트레이스 분석 창을 열어 트랜잭션 목록과 각 트랜잭션 하위의 스텝 정보를 한 번에 확인할 수 있습니다.","keywords":["Go","애플리케이션","히트맵","트레이스"],"isTranslationMissing":false},"sidebar":"goSidebar","previous":{"title":"액티브 트랜잭션","permalink":"/golang/dashboard-active-transaction"},"next":{"title":"Flex 보드","permalink":"/golang/flex-board"}}')
...
;// CONCATENATED MODULE: ./docs/golang/dashboard-hitmap-trace.mdx
