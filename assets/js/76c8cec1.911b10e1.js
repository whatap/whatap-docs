"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["64806"], {
...
"24250": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_ncloud_flexboard_widget_template_mdx_76c_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-ncloud-flexboard-widget-template-mdx-76c.json
var site_docs_ncloud_flexboard_widget_template_mdx_76c_namespaceObject = JSON.parse('{"id":"ncloud/flexboard-widget-template","title":"위젯 템플릿","description":"Flex 보드에서 대시보드에 배치할 수 있는 위젯의 종류를 안내합니다.","source":"@site/docs/ncloud/flexboard-widget-template.mdx","sourceDirName":"ncloud","slug":"/ncloud/flexboard-widget-template","permalink":"/ncloud/flexboard-widget-template","draft":false,"unlisted":false,"editUrl":"undefined/docs/ncloud/flexboard-widget-template.mdx","tags":[],"version":"current","frontMatter":{"id":"flexboard-widget-template","title":"위젯 템플릿","description":"Flex 보드에서 대시보드에 배치할 수 있는 위젯의 종류를 안내합니다.","keywords":["Flex 보드","위젯","템플릿"],"isTranslationMissing":false},"sidebar":"ncloudSidebar","previous":{"title":"위젯 관리하기","permalink":"/ncloud/flexboard-widget-manage"},"next":{"title":"Flex 보드 화면 모드","permalink":"/ncloud/flexboard-mode"}}')
...
;// CONCATENATED MODULE: ./docs/ncloud/flexboard-widget-template.mdx
