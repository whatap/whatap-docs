"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["63114"], {
...
"62402": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_ncloud_set_receive_event_mdx_46c_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-ncloud-set-receive-event-mdx-46c.json
var site_docs_ncloud_set_receive_event_mdx_46c_namespaceObject = JSON.parse('{"id":"ncloud/set-receive-event","title":"이벤트 수신 설정","description":"프로젝트에 포함하는 멤버들의 경고 알림 수신과 관련한 다양한 기능을 설정할 수 있습니다.","source":"@site/docs/ncloud/set-receive-event.mdx","sourceDirName":"ncloud","slug":"/ncloud/set-receive-event","permalink":"/ncloud/set-receive-event","draft":false,"unlisted":false,"editUrl":"undefined/docs/ncloud/set-receive-event.mdx","tags":[],"version":"current","frontMatter":{"id":"set-receive-event","title":"이벤트 수신 설정","description":"프로젝트에 포함하는 멤버들의 경고 알림 수신과 관련한 다양한 기능을 설정할 수 있습니다.","keywords":["경고 알림","이벤트 수신 태그","Naver Cloud Monitoring","클라우드"],"isTranslationMissing":false},"sidebar":"ncloudSidebar","previous":{"title":"메트릭스 경고 알림","permalink":"/ncloud/metric-warning-notice"},"next":{"title":"이벤트 기록","permalink":"/ncloud/set-event-history"}}')
...
;// CONCATENATED MODULE: ./docs/ncloud/set-receive-event.mdx
