"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["46847"], {
"66706": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_account_sso_mdx_f49_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-account-sso-mdx-f49.json
var site_docs_account_sso_mdx_f49_namespaceObject = JSON.parse('{"id":"account/sso","title":"Single Sign-On 연동","description":"SSO 계정 연동을 통해서 하나의 아이디와 비밀번호를 이용해 간편하게 계정을 관리하세요.","source":"@site/docs/account/sso.mdx","sourceDirName":"account","slug":"/account/sso","permalink":"/account/sso","draft":false,"unlisted":false,"editUrl":"undefined/docs/account/sso.mdx","tags":[],"version":"current","frontMatter":{"id":"sso","title":"Single Sign-On 연동","description":"SSO 계정 연동을 통해서 하나의 아이디와 비밀번호를 이용해 간편하게 계정을 관리하세요.","keywords":["SSO","계정","보안"],"displayed_sidebar":"manageSidebar","isTranslationMissing":false},"sidebar":"manageSidebar","previous":{"title":"멀티팩터 인증","permalink":"/account/mfa"},"next":{"title":"Okta 연동","permalink":"/account/okta"}}')
...
;// CONCATENATED MODULE: ./docs/account/sso.mdx
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsxs)(_components.p, {
      children: [(0,jsx_runtime.jsx)(_components.strong, {
        ...
        children: "SSO"
      }), ")은 하나의 계정으로 다양한 애플리케이션에 접속할 수 있는 시스템을 구축하는 솔루션입니다. 와탭 모니터링 서비스 계정으로 외부 애플리케이션 계정에 접속하거나 조직 내 계정 또는 외부 애플리케이션 계정으로 와탭 모니터링 서비스에 접속하는 시스템을 구축할 수 있습니다."]
      ...
      children: "와탭 모니터링 서비스에서는 다음 연동 방법을 제공합니다."
