"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["24135"], {
...
"66393": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_dotnet_track_transactions_intro_mdx_703_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-dotnet-track-transactions-intro-mdx-703.json
var site_docs_dotnet_track_transactions_intro_mdx_703_namespaceObject = JSON.parse('{"id":"dotnet/track-transactions-intro","title":"트랜잭션","description":"트랜잭션의 개요를 안내합니다.","source":"@site/docs/dotnet/track-transactions-intro.mdx","sourceDirName":"dotnet","slug":"/dotnet/track-transactions-intro","permalink":"/dotnet/track-transactions-intro","draft":false,"unlisted":false,"editUrl":"undefined/docs/dotnet/track-transactions-intro.mdx","tags":[],"version":"current","frontMatter":{"id":"track-transactions-intro","title":"트랜잭션","description":"트랜잭션의 개요를 안내합니다.","keywords":[".NET","트랜잭션"],"isTranslationMissing":false},"sidebar":"dotNetSidebar","previous":{"title":"메트릭스 이상 탐지","permalink":"/dotnet/metrics-detect-anormal"},"next":{"title":"트랜잭션 분석하기","permalink":"/dotnet/trs-view"}}')
...
;// CONCATENATED MODULE: ./docs/dotnet/track-transactions-intro.mdx
