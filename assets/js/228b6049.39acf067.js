"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["31645"], {
...
"5921": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_mongodb_log_db_mdx_228_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-mongodb-log-db-mdx-228.json
var site_docs_mongodb_log_db_mdx_228_namespaceObject = JSON.parse('{"id":"mongodb/log-db","title":"적용하기","description":"데이터베이스와 AWS RDS의 로그를 수집하는 방법을 안내합니다.","source":"@site/docs/mongodb/log-db.mdx","sourceDirName":"mongodb","slug":"/mongodb/log-db","permalink":"/mongodb/log-db","draft":false,"unlisted":false,"editUrl":"undefined/docs/mongodb/log-db.mdx","tags":[],"version":"current","frontMatter":{"id":"log-db","title":"적용하기","description":"데이터베이스와 AWS RDS의 로그를 수집하는 방법을 안내합니다.","keywords":["로그 모니터링","데이터베이스","MongoDB"],"isTranslationMissing":false},"sidebar":"mongodbSidebar","previous":{"title":"로그","permalink":"/mongodb/log-main"},"next":{"title":"라이브 테일","permalink":"/mongodb/log-lt"}}')
...
;// CONCATENATED MODULE: ./docs/mongodb/log-db.mdx
