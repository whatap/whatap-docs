"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["42955"], {
...
"95373": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_nodejs_set_notification_message_mdx_ed0_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-nodejs-set-notification-message-mdx-ed0.json
var site_docs_nodejs_set_notification_message_mdx_ed0_namespaceObject = JSON.parse('{"id":"nodejs/set-notification-message","title":"알림 메시지 사용자 정의","description":"프로젝트 멤버에게 전달되는 경고 알림 메시지를 수정할 수 있는 사용자 정의 기능을 제공합니다.","source":"@site/docs/nodejs/set-notification-message.mdx","sourceDirName":"nodejs","slug":"/nodejs/set-notification-message","permalink":"/nodejs/set-notification-message","draft":false,"unlisted":false,"editUrl":"undefined/docs/nodejs/set-notification-message.mdx","tags":[],"version":"current","frontMatter":{"id":"set-notification-message","title":"알림 메시지 사용자 정의","description":"프로젝트 멤버에게 전달되는 경고 알림 메시지를 수정할 수 있는 사용자 정의 기능을 제공합니다.","keywords":["Node.js","애플리케이션","경고 알림","메트릭스 이벤트","알림 메시지"],"isTranslationMissing":false},"sidebar":"nodejsSidebar","previous":{"title":"메트릭스 경고 알림","permalink":"/nodejs/metric-warning-notice"},"next":{"title":"AI 기반의 히트맵 패턴 경고 알림","permalink":"/nodejs/hitmap-notice"}}')
...
;// CONCATENATED MODULE: ./docs/nodejs/set-notification-message.mdx
