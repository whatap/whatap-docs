"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["77640"], {
...
"53914": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_mssql_metrics_detect_anormal_mdx_a21_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-mssql-metrics-detect-anormal-mdx-a21.json
var site_docs_mssql_metrics_detect_anormal_mdx_a21_namespaceObject = JSON.parse('{"id":"mssql/metrics-detect-anormal","title":"메트릭스 이상 탐지","description":"다양한 메트릭스 지표의 패턴을 AI가 학습한 예상 패턴과 비교해 볼 수 있습니다.","source":"@site/docs/mssql/metrics-detect-anormal.mdx","sourceDirName":"mssql","slug":"/mssql/metrics-detect-anormal","permalink":"/mssql/metrics-detect-anormal","draft":false,"unlisted":false,"editUrl":"undefined/docs/mssql/metrics-detect-anormal.mdx","tags":[],"version":"current","frontMatter":{"id":"metrics-detect-anormal","title":"메트릭스 이상 탐지","description":"다양한 메트릭스 지표의 패턴을 AI가 학습한 예상 패턴과 비교해 볼 수 있습니다.","keywords":["SQL Server","메트릭스","이상 탐지"],"isTranslationMissing":false},"sidebar":"mssqlSidebar","previous":{"title":"메트릭스 조회","permalink":"/mssql/metrics-search"},"next":{"title":"SQL 통계","permalink":"/mssql/stat"}}')
...
;// CONCATENATED MODULE: ./docs/mssql/metrics-detect-anormal.mdx
