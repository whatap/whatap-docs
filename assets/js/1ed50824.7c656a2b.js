"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["98405"], {
...
"62231": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_mysql_warning_notice_mdx_1ed_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-mysql-warning-notice-mdx-1ed.json
var site_docs_mysql_warning_notice_mdx_1ed_namespaceObject = JSON.parse('{"id":"mysql/warning-notice","title":"데이터베이스 경고 알림","description":"데이터베이스의 지표별 이벤트 조건 설정을 통해 경고 알림을 보냅니다.","source":"@site/docs/mysql/warning-notice.mdx","sourceDirName":"mysql","slug":"/mysql/warning-notice","permalink":"/mysql/warning-notice","draft":false,"unlisted":false,"editUrl":"undefined/docs/mysql/warning-notice.mdx","tags":[],"version":"current","frontMatter":{"id":"warning-notice","title":"데이터베이스 경고 알림","description":"데이터베이스의 지표별 이벤트 조건 설정을 통해 경고 알림을 보냅니다.","keywords":["MySQL","경고 알림","데이터베이스","데이터베이스 모니터링"],"isTranslationMissing":false},"sidebar":"mysqlSidebar","previous":{"title":"알림 설정하기","permalink":"/mysql/set-notice"},"next":{"title":"이벤트 설정","permalink":"/mysql/warning-notice-v2"}}')
...
;// CONCATENATED MODULE: ./docs/mysql/warning-notice.mdx
