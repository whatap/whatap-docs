"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["18587"], {
...
"62764": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_url_real_time_notification_mdx_b37_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-url-real-time-notification-mdx-b37.json
var site_docs_url_real_time_notification_mdx_b37_namespaceObject = JSON.parse('{"id":"url/real-time-notification","title":"실시간 알림","description":"이벤트 설정 메뉴를 통해서 설정한 경고 알림을 실시간으로 확인할 수 있습니다.","source":"@site/docs/url/real-time-notification.mdx","sourceDirName":"url","slug":"/url/real-time-notification","permalink":"/url/real-time-notification","draft":false,"unlisted":false,"editUrl":"undefined/docs/url/real-time-notification.mdx","tags":[],"version":"current","frontMatter":{"id":"real-time-notification","title":"실시간 알림","description":"이벤트 설정 메뉴를 통해서 설정한 경고 알림을 실시간으로 확인할 수 있습니다.","keywords":["실시간 알림"],"isTranslationMissing":false},"sidebar":"urlSidebar","previous":{"title":"이벤트 기록","permalink":"/url/url-event-history"},"next":{"title":"HTTP 상태 코드 유형","permalink":"/url/url-http-status"}}')
...
;// CONCATENATED MODULE: ./docs/url/real-time-notification.mdx
