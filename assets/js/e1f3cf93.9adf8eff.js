"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[44667],{
...
const metadata = {
  "id": "mssql-v1/set-receive-event",
  "title": "이벤트 수신 설정",
  "description": "프로젝트에 포함하는 멤버들의 경고 알림 수신과 관련한 다양한 기능을 설정할 수 있습니다.",
  "source": "@site/docs/mssql-v1/set-receive-event.mdx",
  "sourceDirName": "mssql-v1",
  "slug": "/mssql-v1/set-receive-event",
  "permalink": "/whatap-docs/mssql-v1/set-receive-event",
  "draft": false,
  "unlisted": false,
  "editUrl": "undefined/docs/mssql-v1/set-receive-event.mdx",
  "tags": [],
  "version": "current",
  "frontMatter": {
    "id": "set-receive-event",
  ...
  "next": {
    "title": "이벤트 기록",
    "permalink": "/whatap-docs/mssql-v1/set-event-history"
  }
};
const assets = {
