...
"39085": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_mysql_report_intro_mdx_e29_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-mysql-report-intro-mdx-e29.json
var site_docs_mysql_report_intro_mdx_e29_namespaceObject = JSON.parse('{"id":"mysql/report-intro","title":"보고서","description":"개별 프로젝트에 대해 서비스 이용 현황과 장애 발생 기록을 보고하는 문서에 대해 알아봅니다.","source":"@site/docs/mysql/report-intro.mdx","sourceDirName":"mysql","slug":"/mysql/report-intro","permalink":"/mysql/report-intro","draft":false,"unlisted":false,"editUrl":"undefined/docs/mysql/report-intro.mdx","tags":[],"version":"current","frontMatter":{"id":"report-intro","title":"보고서","description":"개별 프로젝트에 대해 서비스 이용 현황과 장애 발생 기록을 보고하는 문서에 대해 알아봅니다.","keywords":["MySQL","데이터베이스","데이터베이스 모니터링","보고서"],"isTranslationMissing":false},"sidebar":"mysqlSidebar","previous":{"title":"데이터베이스 사이즈","permalink":"/mysql/database-size"},"next":{"title":"로그","permalink":"/mysql/log-main"}}')
...
;// CONCATENATED MODULE: ./docs/mysql/report-intro.mdx
