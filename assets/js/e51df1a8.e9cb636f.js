"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["76972"], {
...
"38591": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_cubrid_metrics_intro_mdx_e51_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-cubrid-metrics-intro-mdx-e51.json
var site_docs_cubrid_metrics_intro_mdx_e51_namespaceObject = JSON.parse('{"id":"cubrid/metrics-intro","title":"메트릭스","description":"데이터베이스 모니터링 분석을 위한 메트릭스 메뉴에 대해 알아봅니다.","source":"@site/docs/cubrid/metrics-intro.mdx","sourceDirName":"cubrid","slug":"/cubrid/metrics-intro","permalink":"/cubrid/metrics-intro","draft":false,"unlisted":false,"editUrl":"undefined/docs/cubrid/metrics-intro.mdx","tags":[],"version":"current","frontMatter":{"id":"metrics-intro","title":"메트릭스","description":"데이터베이스 모니터링 분석을 위한 메트릭스 메뉴에 대해 알아봅니다.","keywords":["CUBRID","메트릭스","데이터베이스","데이터베이스 모니터링"],"isTranslationMissing":false},"sidebar":"cubridSidebar","previous":{"title":"데이터베이스 파라미터","permalink":"/cubrid/analysis-databaseparameter"},"next":{"title":"CUBRID 지표","permalink":"/cubrid/metrics-data-list"}}')
