"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["18147"], {
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_mongodb_troubleshooting_mdx_2e9_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-mongodb-troubleshooting-mdx-2e9.json
var site_docs_mongodb_troubleshooting_mdx_2e9_namespaceObject = JSON.parse('{"id":"mongodb/troubleshooting","title":"설치 문제 해결","description":"MongoDB 데이터베이스 에이전트 설치 시 발생할 수 있는 문제를 확인할 수 있습니다.","source":"@site/docs/mongodb/troubleshooting.mdx","sourceDirName":"mongodb","slug":"/mongodb/troubleshooting","permalink":"/mongodb/troubleshooting","draft":false,"unlisted":false,"editUrl":"undefined/docs/mongodb/troubleshooting.mdx","tags":[],"version":"current","frontMatter":{"id":"troubleshooting","title":"설치 문제 해결","description":"MongoDB 데이터베이스 에이전트 설치 시 발생할 수 있는 문제를 확인할 수 있습니다.","keywords":["MongoDB","데이터베이스","문제 해결","에이전트"],"isTranslationMissing":false},"sidebar":"mongodbSidebar","previous":{"title":"설치 점검 사항","permalink":"/mongodb/after-install-agent"},"next":{"title":"설정하기","permalink":"/mongodb/agent-settings"}}')
...
;// CONCATENATED MODULE: ./docs/mongodb/troubleshooting.mdx
