"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[10527],{
...
const frontMatter = {
	...
	pagination_prev: 'oracle-dma/install-agent'
};
const contentTitle = undefined;
const metadata = {
  "id": "oracle-dma/check-ipckey",
  "title": "ipckey 값 확인하기",
  "description": "한 서버에 여러 개의 데이터베이스를 설치한 환경에서 ipckey를 확인하는 방법을 안내합니다.",
  "source": "@site/docs/oracle-dma/check-ipckey.mdx",
  "sourceDirName": "oracle-dma",
  "slug": "/oracle-dma/check-ipckey",
  "permalink": "/whatap-docs/oracle-dma/check-ipckey",
  "draft": false,
  "unlisted": false,
  "editUrl": "undefined/docs/oracle-dma/check-ipckey.mdx",
  "tags": [
    {
      "inline": true,
      "label": "Oracle DMA",
    ...
    },
    {
      "inline": true,
      "label": "ipckey",
      "permalink": "/whatap-docs/tags/ipckey"
    }
  ],
  "version": "current",
  "frontMatter": {
