...
const toc = [{
  ...
  "value": "Scale In/Out 환경에서 에이전트 이름이 중복되는 이유는 무엇인가요?",
  "id": "scale-inout-환경에서-에이전트-이름이-중복되는-이유는-무엇인가요",
  "level": 3
}, {
  "value": "에이전트 이름 중복 문제를 해결하기 위한 방법은 무엇인가요?",
  "id": "에이전트-이름-중복-문제를-해결하기-위한-방법은-무엇인가요",
  "level": 3
}];
