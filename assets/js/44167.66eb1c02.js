(self["webpackChunkwhatap_origin"] = self["webpackChunkwhatap_origin"] || []).push([[44167],{
...
module.exports = self.fetch || (self.fetch = (__webpack_require__(25869)["default"]) || __webpack_require__(25869));
...
__webpack_require__.d(__webpack_exports__, {
  F6: () => (/* binding */ GoogleFormProvider),
  ck: () => (/* binding */ useCheckboxGridInput),
  xB: () => (/* binding */ useCheckboxInput),
  M$: () => (/* binding */ useDropdownInput),
  h1: () => (/* binding */ useGoogleForm),
  mP: () => (/* binding */ useLinearInput),
  yO: () => (/* binding */ useLongAnswerInput),
  bk: () => (/* binding */ useRadioGridInput),
  Ge: () => (/* binding */ useRadioInput),
  Tx: () => (/* binding */ useShortAnswerInput)
});
...
function prefix (value, length, children) {
	switch ((0,Utility/* hash */.vp)(value, length)) {
		...
		// tab-size
		case 4789:
			return Enum/* MOZ */.uj + value + value
		...
		// align-self
		case 5443:
			return Enum/* WEBKIT */.G$ + value + Enum.MS + 'flex-item-' + (0,Utility/* replace */.gx)(value, /flex-|-self/g, '') + (!(0,Utility/* match */.EQ)(value, /flex-|baseline/) ? Enum.MS + 'grid-row-' + (0,Utility/* replace */.gx)(value, /flex-|-self/g, '') : '') + value
		// align-content
		case 4675:
			return Enum/* WEBKIT */.G$ + value + Enum.MS + 'flex-line-pack' + (0,Utility/* replace */.gx)(value, /align-content|flex-|-self/g, '') + value
		// flex-shrink
		case 5548:
		...
		// justify-self
		case 4200:
			if (!(0,Utility/* match */.EQ)(value, /flex-|baseline/)) return Enum.MS + 'grid-column-align' + (0,Utility/* substr */.tb)(value, length) + value
			break
		// grid-template-(columns|rows)
		case 2592: case 3360:
			return Enum.MS + (0,Utility/* replace */.gx)(value, 'template-', '') + value
		// grid-(row|column)-start
		case 4384: case 3616:
			if (children && children.some(function (element, index) { return length = index, (0,Utility/* match */.EQ)(element.props, /grid-\w+-end/) })) {
				return ~(0,Utility/* indexof */.Cw)(value + (children = children[length].value), 'span') ? value : (Enum.MS + (0,Utility/* replace */.gx)(value, '-start', '') + value + Enum.MS + 'grid-row-span:' + (~(0,Utility/* indexof */.Cw)(children, 'span') ? (0,Utility/* match */.EQ)(children, /\d+/) : +(0,Utility/* match */.EQ)(children, /\d+/) - +(0,Utility/* match */.EQ)(value, /\d+/)) + ';')
			}
			return Enum.MS + (0,Utility/* replace */.gx)(value, '-start', '') + value
		// grid-(row|column)-end
		case 4896: case 4128:
			return (children && children.some(function (element) { return (0,Utility/* match */.EQ)(element.props, /grid-\w+-start/) })) ? value : Enum.MS + (0,Utility/* replace */.gx)((0,Utility/* replace */.gx)(value, '-end', '-span'), 'span ', '') + value
		...
		case 5533: case 5789: case 5021: case 4765:
			...
			if ((0,Utility/* strlen */.to)(value) - 1 - length > 6)
				switch ((0,Utility/* charat */.uO)(value, length + 1)) {
					...
					// (s)tretch
					case 115:
						return ~(0,Utility/* indexof */.Cw)(value, 'stretch') ? prefix((0,Utility/* replace */.gx)(value, 'stretch', 'fill-available'), length, children) + value : value
				}
			break
		// grid-(column|row)
		case 5152: case 5920:
			return (0,Utility/* replace */.gx)(value, /(.+?):(\d+)(\s*\/\s*(span)?\s*(\d+))?(.*)/, function (_, a, b, c, d, e, f) { return (Enum.MS + a + ':' + b + f) + (c ? (Enum.MS + a + '-span:' + (d ? e : +e - +b)) + f : '') + value })
		// position: sticky
		case 4949:
			// stick(y)?
			if ((0,Utility/* charat */.uO)(value, length + 6) === 121)
				return (0,Utility/* replace */.gx)(value, ':', ':' + Enum/* WEBKIT */.G$) + value
			break
		// display: (flex|inline-flex|grid|inline-grid)
		case 6444:
			switch ((0,Utility/* charat */.uO)(value, (0,Utility/* charat */.uO)(value, 14) === 45 ? 18 : 11)) {
				// (inline-)?fle(x)
				case 120:
					return (0,Utility/* replace */.gx)(value, /(.+:)([^;\s!]+)(;|(\s+)?!.+)?/, '$1' + Enum/* WEBKIT */.G$ + ((0,Utility/* charat */.uO)(value, 14) === 45 ? 'inline-' : '') + 'box$3' + '$1' + Enum/* WEBKIT */.G$ + '$2$3' + '$1' + Enum.MS + '$2box$3') + value
				// (inline-)?gri(d)
				case 100:
					return (0,Utility/* replace */.gx)(value, ':', ':' + Enum.MS) + value
			}
			break
		// scroll-margin, scroll-margin-(top|right|bottom|left)
		case 5719: case 2647: case 2135: case 3927: case 2391:
			return (0,Utility/* replace */.gx)(value, 'scroll-', 'scroll-snap-') + value
	}
...
function prefixer (element, index, children, callback) {
	if (element.length > -1)
		if (!element.return)
			switch (element.type) {
				case Enum/* DECLARATION */.h5: element.return = prefix(element.value, element.length, children)
					return
				...
				case Enum/* RULESET */.Fr:
					if (element.length)
						return (0,Utility/* combine */.$e)(children = element.props, function (value) {
							switch ((0,Utility/* match */.EQ)(value, callback = /(::plac\w+|:read-\w+)/)) {
								// :read-(only|write)
								case ':read-only': case ':read-write':
									(0,Tokenizer/* lift */.xb)((0,Tokenizer/* copy */.JG)(element, {props: [(0,Utility/* replace */.gx)(value, /:(read-\w+)/, ':' + Enum/* MOZ */.uj + '$1')]}))
									;(0,Tokenizer/* lift */.xb)((0,Tokenizer/* copy */.JG)(element, {props: [value]}))
									;(0,Utility/* assign */.f0)(element, {props: (0,Utility/* filter */.hX)(children, callback)})
									break
								// :placeholder
								case '::placeholder':
									;(0,Tokenizer/* lift */.xb)((0,Tokenizer/* copy */.JG)(element, {props: [(0,Utility/* replace */.gx)(value, /:(plac\w+)/, ':' + Enum/* WEBKIT */.G$ + 'input-$1')]}))
									;(0,Tokenizer/* lift */.xb)((0,Tokenizer/* copy */.JG)(element, {props: [(0,Utility/* replace */.gx)(value, /:(plac\w+)/, ':' + Enum/* MOZ */.uj + '$1')]}))
									;(0,Tokenizer/* lift */.xb)((0,Tokenizer/* copy */.JG)(element, {props: [(0,Utility/* replace */.gx)(value, /:(plac\w+)/, Enum.MS + 'input-$1')]}))
									;(0,Tokenizer/* lift */.xb)((0,Tokenizer/* copy */.JG)(element, {props: [value]}))
									;(0,Utility/* assign */.f0)(element, {props: (0,Utility/* filter */.hX)(children, callback)})
									break
							}
...
var EditThisPage = __webpack_require__(46229);
...
function TagsListInline({ tags }) {
    return /*#__PURE__*/ react.createElement(react.Fragment, null, /*#__PURE__*/ react.createElement("b", null, /*#__PURE__*/ react.createElement(Translate/* default */.Z, {
        ...
        className: (0,clsx_m/* default */.Z)(styles_module.tags, 'padding--none', 'margin-left--sm')
...
function EditMetaRow({ editUrl, lastUpdatedAt, lastUpdatedBy, formattedLastUpdatedAt }) {
    return /*#__PURE__*/ react.createElement("div", {
        ...
        className: "col"
    }, editUrl && /*#__PURE__*/ react.createElement(EditThisPage/* default */.Z, {
        editUrl: editUrl
    })), /*#__PURE__*/ react.createElement("div", {
...
/* harmony export */   Z: () => (/* binding */ DocItemTOCDesktop)
/* harmony export */ });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(67294);
/* harmony import */ var _docusaurus_theme_common__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(65319);
/* harmony import */ var _docusaurus_theme_common_internal__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(16895);
/* harmony import */ var _theme_TOC__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(48704);
/**
 * Copyright (c) Facebook, Inc. and its affiliates.
 *
 * This source code is licensed under the MIT license found in the
...
function DocItemTOCDesktop() {
    const { toc, frontMatter } = (0,_docusaurus_theme_common_internal__WEBPACK_IMPORTED_MODULE_2__/* .useDoc */ .k)();
    return /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_theme_TOC__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .Z, {
        toc: toc,
        minHeadingLevel: frontMatter.toc_min_heading_level,
        maxHeadingLevel: frontMatter.toc_max_heading_level,
        className: _docusaurus_theme_common__WEBPACK_IMPORTED_MODULE_3__/* .ThemeClassNames */ .k.docs.docTocDesktop
    });
}
...
function TOCCollapsibleCollapseButton(_param) {
    ...
    return /*#__PURE__*/ react.createElement("button", _object_spread_props(_object_spread({
        type: "button"
    }, props), {
        className: (0,clsx_m/* default */.Z)('clean-btn', styles_module.tocCollapsibleButton, !collapsed && styles_module.tocCollapsibleButtonExpanded, props.className)
    }), /*#__PURE__*/ react.createElement(Translate/* default */.Z, {
...
var Layout = __webpack_require__(8451);
...
function DocItem(props) {
    ...
    return /*#__PURE__*/ react.createElement(doc/* DocProvider */.b, {
        content: props.content
    }, /*#__PURE__*/ react.createElement(metadataUtils/* HtmlClassNameProvider */.FG, {
        className: docHtmlClassName
    }, /*#__PURE__*/ react.createElement(DocItemMetadata, null), /*#__PURE__*/ react.createElement(Layout/* default */.Z, null, /*#__PURE__*/ react.createElement(MDXComponent, null))));
}
...
/* harmony import */ var _docusaurus_theme_common__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(65319);
/* harmony import */ var _docusaurus_theme_common_internal__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(27391);
/**
 * Copyright (c) Facebook, Inc. and its affiliates.
 *
 * This source code is licensed under the MIT license found in the
...
function DocVersionBadge({ className }) {
    ...
    if (versionMetadata.badge) {
        return /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_0__.createElement("span", {
            className: (0,clsx__WEBPACK_IMPORTED_MODULE_3__/* ["default"] */ .Z)(className, _docusaurus_theme_common__WEBPACK_IMPORTED_MODULE_4__/* .ThemeClassNames */ .k.docs.docVersionBadge, 'badge badge--secondary')
...
/* harmony import */ var _docusaurus_plugin_content_docs_client__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(55995);
...
"use strict";
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   Z: () => (/* binding */ IconHome)
/* harmony export */ });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(67294);
/**
 * Copyright (c) Facebook, Inc. and its affiliates.
 ...
 */ function useDoc() {
    ...
    if (doc === null) {
        throw new _utils_reactUtils__WEBPACK_IMPORTED_MODULE_1__/* .ReactContextError */ .i6('DocProvider');
    }
    return doc;
