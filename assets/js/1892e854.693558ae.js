"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["37018"], {
...
"3223": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_oracle_pro_dashboard_intro_mdx_189_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-oracle-pro-dashboard-intro-mdx-189.json
var site_docs_oracle_pro_dashboard_intro_mdx_189_namespaceObject = JSON.parse('{"id":"oracle-pro/dashboard-intro","title":"대시보드","description":"와탭 모니터링 대시보드는 프로젝트의 전체 현황을 한 눈에 파악하기 위한 기능을 제공합니다.","source":"@site/docs/oracle-pro/dashboard-intro.mdx","sourceDirName":"oracle-pro","slug":"/oracle-pro/dashboard-intro","permalink":"/oracle-pro/dashboard-intro","draft":false,"unlisted":false,"editUrl":"undefined/docs/oracle-pro/dashboard-intro.mdx","tags":[],"version":"current","frontMatter":{"id":"dashboard-intro","title":"대시보드","description":"와탭 모니터링 대시보드는 프로젝트의 전체 현황을 한 눈에 파악하기 위한 기능을 제공합니다.","keywords":["Oracle Pro","대시보드","인스턴스","데이터베이스"],"isTranslationMissing":false},"sidebar":"dboracledmaSidebar","previous":{"title":"관리하기","permalink":"/oracle-pro/agent-manage"},"next":{"title":"인스턴스 목록","permalink":"/oracle-pro/instance-list"}}')
...
;// CONCATENATED MODULE: ./docs/oracle-pro/dashboard-intro.mdx
...
const toc = [..._db_dashboard_intro/* toc */.d$, ..._db_dashboard_instance_list/* toc */.d$, ..._db_dashboard_instance_monitoring/* toc */.d$, ..._db_dashboard_multi_instance_monitoring/* toc */.d$];
function _createMdxContent(props) {
