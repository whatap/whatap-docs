...
const metadata = {
  "id": "mssql-v1/after-install-agent",
  "title": "설치 점검 사항",
  "description": "데이터베이스 모니터링 설치를 모두 완료했습니다. 설치 후 확인 사항을 점검하세요.",
  "source": "@site/docs/mssql-v1/after-install-agent.mdx",
  "sourceDirName": "mssql-v1",
  "slug": "/mssql-v1/after-install-agent",
  "permalink": "/whatap-docs/mssql-v1/after-install-agent",
  "draft": false,
  "unlisted": false,
  "editUrl": "undefined/docs/mssql-v1/after-install-agent.mdx",
  "tags": [],
  "version": "current",
  "frontMatter": {
    "id": "after-install-agent",
