...
"9146": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_cubrid_v_1_metrics_chart_mdx_afa_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-cubrid-v-1-metrics-chart-mdx-afa.json
var site_docs_cubrid_v_1_metrics_chart_mdx_afa_namespaceObject = JSON.parse('{"id":"cubrid-v1/metrics-chart","title":"메트릭스 차트","description":"메트릭스 데이터를 차트로 조회할 수 있습니다.","source":"@site/docs/cubrid-v1/metrics-chart.mdx","sourceDirName":"cubrid-v1","slug":"/cubrid-v1/metrics-chart","permalink":"/cubrid-v1/metrics-chart","draft":false,"unlisted":false,"editUrl":"undefined/docs/cubrid-v1/metrics-chart.mdx","tags":[],"version":"current","frontMatter":{"id":"metrics-chart","title":"메트릭스 차트","description":"메트릭스 데이터를 차트로 조회할 수 있습니다.","keywords":["메트릭스","메트릭스 차트","UI"],"isTranslationMissing":false},"sidebar":"cubridV1Sidebar","previous":{"title":"CUBRID 지표","permalink":"/cubrid-v1/metrics-data-list"},"next":{"title":"메트릭스 조회","permalink":"/cubrid-v1/metrics-search"}}')
...
;// CONCATENATED MODULE: ./docs/cubrid-v1/metrics-chart.mdx
