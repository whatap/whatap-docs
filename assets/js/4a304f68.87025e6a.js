"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["72349"], {
...
"84338": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_golang_labs_mdx_4a3_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-golang-labs-mdx-4a3.json
var site_docs_golang_labs_mdx_4a3_namespaceObject = JSON.parse('{"id":"golang/labs","title":"실험실","description":"사용자에게 새로운 기능 또는 실험적인 기능을 제공하는 메뉴인 실험실에 대해 안내합니다.","source":"@site/docs/golang/labs.mdx","sourceDirName":"golang","slug":"/golang/labs","permalink":"/golang/labs","draft":false,"unlisted":false,"editUrl":"undefined/docs/golang/labs.mdx","tags":[],"version":"current","frontMatter":{"id":"labs","title":"실험실","description":"사용자에게 새로운 기능 또는 실험적인 기능을 제공하는 메뉴인 실험실에 대해 안내합니다.","keywords":["Go","애플리케이션","실험실"],"isTranslationMissing":false},"sidebar":"goSidebar","previous":{"title":"Log 모니터링","permalink":"/log/introduction"}}')
...
;// CONCATENATED MODULE: ./docs/golang/labs.mdx
