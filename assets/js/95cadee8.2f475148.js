"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["1484"], {
...
"61358": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_dotnet_dashboard_intro_mdx_95c_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-dotnet-dashboard-intro-mdx-95c.json
var site_docs_dotnet_dashboard_intro_mdx_95c_namespaceObject = JSON.parse('{"id":"dotnet/dashboard-intro","title":"대시보드","description":"와탭 모니터링 대시보드는 프로젝트의 전체 현황을 한 눈에 파악하기 위한 기능을 제공합니다.","source":"@site/docs/dotnet/dashboard-intro.mdx","sourceDirName":"dotnet","slug":"/dotnet/dashboard-intro","permalink":"/dotnet/dashboard-intro","draft":false,"unlisted":false,"editUrl":"undefined/docs/dotnet/dashboard-intro.mdx","tags":[],"version":"current","frontMatter":{"id":"dashboard-intro","title":"대시보드","description":"와탭 모니터링 대시보드는 프로젝트의 전체 현황을 한 눈에 파악하기 위한 기능을 제공합니다.","keywords":["대시보드",".NET","애플리케이션","애플리케이션 모니터링"],"isTranslationMissing":false},"sidebar":"dotNetSidebar","previous":{"title":"관리하기","permalink":"/dotnet/agent-manage"},"next":{"title":"애플리케이션 대시보드","permalink":"/dotnet/dashboard"}}')
...
;// CONCATENATED MODULE: ./docs/dotnet/dashboard-intro.mdx
