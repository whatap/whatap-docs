"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["54954"], {
"44096": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_azure_metrics_chart_mdx_4f8_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-azure-metrics-chart-mdx-4f8.json
var site_docs_azure_metrics_chart_mdx_4f8_namespaceObject = JSON.parse('{"id":"azure/metrics-chart","title":"메트릭스 차트","description":"메트릭스 데이터를 차트로 조회할 수 있습니다.","source":"@site/docs/azure/metrics-chart.mdx","sourceDirName":"azure","slug":"/azure/metrics-chart","permalink":"/azure/metrics-chart","draft":false,"unlisted":false,"editUrl":"undefined/docs/azure/metrics-chart.mdx","tags":[],"version":"current","frontMatter":{"id":"metrics-chart","title":"메트릭스 차트","description":"메트릭스 데이터를 차트로 조회할 수 있습니다.","keywords":["메트릭스","메트릭스 차트","UI","Azure Monitor","클라우드"],"isTranslationMissing":false},"sidebar":"azuremonitorSidebar","previous":{"title":"메트릭스 큐브","permalink":"/azure/metrics-cube"},"next":{"title":"메트릭스 이상 탐지","permalink":"/azure/metrics-detect-anormal"}}')
...
;// CONCATENATED MODULE: ./docs/azure/metrics-chart.mdx
