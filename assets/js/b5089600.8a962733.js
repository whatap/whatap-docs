"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["73055"], {
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_postgresql_common_alert_mdx_b50_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-postgresql-common-alert-mdx-b50.json
var site_docs_postgresql_common_alert_mdx_b50_namespaceObject = JSON.parse('{"id":"postgresql/common-alert","title":"시스템 이벤트 안내","description":"와탭 모니터링에서는 플랫폼 전반에서 자동으로 탐지 및 생성되는 공용 이벤트에 대해 안내합니다.","source":"@site/docs/postgresql/common-alert.mdx","sourceDirName":"postgresql","slug":"/postgresql/common-alert","permalink":"/postgresql/common-alert","draft":false,"unlisted":false,"editUrl":"undefined/docs/postgresql/common-alert.mdx","tags":[],"version":"current","frontMatter":{"id":"common-alert","title":"시스템 이벤트 안내","description":"와탭 모니터링에서는 플랫폼 전반에서 자동으로 탐지 및 생성되는 공용 이벤트에 대해 안내합니다.","keywords":["와탭","경고 알림","시스템 이벤트"],"isTranslationMissing":false},"sidebar":"postgreSidebar","previous":{"title":"실시간 알림","permalink":"/postgresql/real-time-notification"},"next":{"title":"연계 프로젝트 관리","permalink":"/postgresql/linked-projects"}}')
...
;// CONCATENATED MODULE: ./docs/postgresql/common-alert.mdx
