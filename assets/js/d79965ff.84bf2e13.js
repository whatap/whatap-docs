"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["34022"], {
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_dotnet_active_transactions_mdx_d79_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-dotnet-active-transactions-mdx-d79.json
var site_docs_dotnet_active_transactions_mdx_d79_namespaceObject = JSON.parse('{"id":"dotnet/active-transactions","title":"액티브 트랜잭션","description":"액티브 트랜잭션을 안내합니다.","source":"@site/docs/dotnet/active-transactions.mdx","sourceDirName":"dotnet","slug":"/dotnet/active-transactions","permalink":"/dotnet/active-transactions","draft":false,"unlisted":false,"editUrl":"undefined/docs/dotnet/active-transactions.mdx","tags":[],"version":"current","frontMatter":{"id":"active-transactions","title":"액티브 트랜잭션","description":"액티브 트랜잭션을 안내합니다.","keywords":[".NET","트랜잭션","액티브 트랜잭션","UI","애플리케이션","애플리케이션 모니터링"],"isTranslationMissing":false},"sidebar":"dotNetSidebar","previous":{"title":"트랜잭션 트레이싱","permalink":"/dotnet/trs-profile"},"next":{"title":"멀티 트랜잭션","permalink":"/dotnet/trs-multi-trace"}}')
// EXTERNAL MODULE: ./node_modules/react/jsx-runtime.js
var jsx_runtime = __webpack_require__("85893");
// EXTERNAL MODULE: ./node_modules/@mdx-js/react/lib/index.js
var lib = __webpack_require__("50065");
...
;// CONCATENATED MODULE: ./docs/dotnet/active-transactions.mdx
