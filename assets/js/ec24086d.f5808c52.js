"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["35326"], {
...
"27194": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_tibero_dashboard_intro_mdx_ec2_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-tibero-dashboard-intro-mdx-ec2.json
var site_docs_tibero_dashboard_intro_mdx_ec2_namespaceObject = JSON.parse('{"id":"tibero/dashboard-intro","title":"대시보드","description":"와탭 모니터링 대시보드는 프로젝트의 전체 현황을 한 눈에 파악하기 위한 기능을 제공합니다.","source":"@site/docs/tibero/dashboard-intro.mdx","sourceDirName":"tibero","slug":"/tibero/dashboard-intro","permalink":"/tibero/dashboard-intro","draft":false,"unlisted":false,"editUrl":"undefined/docs/tibero/dashboard-intro.mdx","tags":[],"version":"current","frontMatter":{"id":"dashboard-intro","title":"대시보드","description":"와탭 모니터링 대시보드는 프로젝트의 전체 현황을 한 눈에 파악하기 위한 기능을 제공합니다.","keywords":["Tibero","대시보드","데이터베이스"],"isTranslationMissing":false},"sidebar":"tiberoSidebar","previous":{"title":"관리하기","permalink":"/tibero/agent-manage"},"next":{"title":"인스턴스 목록","permalink":"/tibero/instance-list"}}')
...
;// CONCATENATED MODULE: ./docs/tibero/dashboard-intro.mdx
