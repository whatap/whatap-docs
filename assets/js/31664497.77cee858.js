...
"1834": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_cubrid_agent_settings_mdx_316_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-cubrid-agent-settings-mdx-316.json
var site_docs_cubrid_agent_settings_mdx_316_namespaceObject = JSON.parse('{"id":"cubrid/agent-settings","title":"설정하기","description":"데이터베이스 에이전트 서버에 있는 whatap.conf 파일을 통해 설정할 수 있는 옵션에 대해 알아봅니다.","source":"@site/docs/cubrid/agent-settings.mdx","sourceDirName":"cubrid","slug":"/cubrid/agent-settings","permalink":"/cubrid/agent-settings","draft":false,"unlisted":false,"editUrl":"undefined/docs/cubrid/agent-settings.mdx","tags":[],"version":"current","frontMatter":{"id":"agent-settings","title":"설정하기","description":"데이터베이스 에이전트 서버에 있는 whatap.conf 파일을 통해 설정할 수 있는 옵션에 대해 알아봅니다.","keywords":["CUBRID","데이터베이스","데이터베이스 모니터링"],"isTranslationMissing":false},"sidebar":"cubridSidebar","previous":{"title":"설치 문제 해결","permalink":"/cubrid/troubleshooting"},"next":{"title":"DBX 에이전트 설정","permalink":"/cubrid/agent-dbx-settings"}}')
...
;// CONCATENATED MODULE: ./docs/cubrid/agent-settings.mdx
