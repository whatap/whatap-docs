"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["59244"], {
...
"37235": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_nodejs_analysis_msa_mdx_3a9_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-nodejs-analysis-msa-mdx-3a9.json
var site_docs_nodejs_analysis_msa_mdx_3a9_namespaceObject = JSON.parse('{"id":"nodejs/analysis-msa","title":"MSA 분석","description":"MSA 분석 기능은 와탭의 MTRACE(멀티 서버간 추적)기능을 통해서 수집된 트랜잭션들 사이의 호출 비중이 어떠한지를 분석합니다.","source":"@site/docs/nodejs/analysis-msa.mdx","sourceDirName":"nodejs","slug":"/nodejs/analysis-msa","permalink":"/nodejs/analysis-msa","draft":false,"unlisted":false,"editUrl":"undefined/docs/nodejs/analysis-msa.mdx","tags":[],"version":"current","frontMatter":{"id":"analysis-msa","title":"MSA 분석","description":"MSA 분석 기능은 와탭의 MTRACE(멀티 서버간 추적)기능을 통해서 수집된 트랜잭션들 사이의 호출 비중이 어떠한지를 분석합니다.","keywords":["Node.js","애플리케이션","분석","MSA"],"isTranslationMissing":false},"sidebar":"nodejsSidebar","previous":{"title":"트랜잭션 검색","permalink":"/nodejs/tx-profile"},"next":{"title":"메트릭스","permalink":"/nodejs/metrics-intro"}}')
...
;// CONCATENATED MODULE: ./docs/nodejs/analysis-msa.mdx
