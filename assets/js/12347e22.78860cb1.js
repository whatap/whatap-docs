"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["97210"], {
"17768": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_browser_metric_warning_notice_mdx_123_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-browser-metric-warning-notice-mdx-123.json
var site_docs_browser_metric_warning_notice_mdx_123_namespaceObject = JSON.parse('{"id":"browser/metric-warning-notice","title":"메트릭스 경고 알림","description":"구체적이고 복잡한 이벤트를 설정하려면 메트릭스 이벤트 설정을 사용하세요.","source":"@site/docs/browser/metric-warning-notice.mdx","sourceDirName":"browser","slug":"/browser/metric-warning-notice","permalink":"/browser/metric-warning-notice","draft":false,"unlisted":false,"editUrl":"undefined/docs/browser/metric-warning-notice.mdx","tags":[],"version":"current","frontMatter":{"id":"metric-warning-notice","title":"메트릭스 경고 알림","description":"구체적이고 복잡한 이벤트를 설정하려면 메트릭스 이벤트 설정을 사용하세요.","keywords":["경고 알림","메트릭스 이벤트","브라우저 모니터링"],"isTranslationMissing":false},"sidebar":"rumsSidebar","previous":{"title":"알림 설정하기","permalink":"/browser/set-notice"},"next":{"title":"이벤트 설정","permalink":"/browser/warning-notice-v2"}}')
...
const toc = [..._metrics_warning_notice/* toc */.d$, ..._composite_metrics_warning_notice/* toc */.d$, ..._metrics_event_modify_delete/* toc */.d$, ..._metrics_event_condition_select_target_guide/* toc */.d$, ..._metrics_warning_notice_browser/* toc */.d$];
