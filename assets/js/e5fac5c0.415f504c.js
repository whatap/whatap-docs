"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["53671"], {
...
"39322": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_kubernetes_flexboard_share_mdx_e5f_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-kubernetes-flexboard-share-mdx-e5f.json
var site_docs_kubernetes_flexboard_share_mdx_e5f_namespaceObject = JSON.parse('{"id":"kubernetes/flexboard-share","title":"Flex 보드 공유하기","description":"Flex 보드를 다른 계정의 사용자와 공유하고 재사용할 수 있습니다.","source":"@site/docs/kubernetes/flexboard-share.mdx","sourceDirName":"kubernetes","slug":"/kubernetes/flexboard-share","permalink":"/kubernetes/flexboard-share","draft":false,"unlisted":false,"editUrl":"undefined/docs/kubernetes/flexboard-share.mdx","tags":[],"version":"current","frontMatter":{"id":"flexboard-share","title":"Flex 보드 공유하기","description":"Flex 보드를 다른 계정의 사용자와 공유하고 재사용할 수 있습니다.","keywords":["Flex 보드","쿠버네티스"],"isTranslationMissing":false},"sidebar":"kubeSidebar","previous":{"title":"Flex 보드 화면 모드","permalink":"/kubernetes/flexboard-mode"},"next":{"title":"컨테이너 목록","permalink":"/kubernetes/resource-container-list"}}')
...
;// CONCATENATED MODULE: ./docs/kubernetes/flexboard-share.mdx
