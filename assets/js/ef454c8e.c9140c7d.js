"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["83715"], {
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_kubernetes_set_receive_event_mdx_ef4_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-kubernetes-set-receive-event-mdx-ef4.json
var site_docs_kubernetes_set_receive_event_mdx_ef4_namespaceObject = JSON.parse('{"id":"kubernetes/set-receive-event","title":"이벤트 수신 설정","description":"프로젝트에 포함하는 멤버들의 경고 알림 수신과 관련한 다양한 기능을 설정할 수 있습니다.","source":"@site/docs/kubernetes/set-receive-event.mdx","sourceDirName":"kubernetes","slug":"/kubernetes/set-receive-event","permalink":"/kubernetes/set-receive-event","draft":false,"unlisted":false,"editUrl":"undefined/docs/kubernetes/set-receive-event.mdx","tags":[],"version":"current","frontMatter":{"id":"set-receive-event","title":"이벤트 수신 설정","description":"프로젝트에 포함하는 멤버들의 경고 알림 수신과 관련한 다양한 기능을 설정할 수 있습니다.","keywords":["경고 알림","이벤트 수신 태그","쿠버네티스 모니터링"],"isTranslationMissing":false},"sidebar":"kubeSidebar","previous":{"title":"로그 경고 알림","permalink":"/kubernetes/set-event-log"},"next":{"title":"이벤트 기록","permalink":"/kubernetes/set-event-history"}}')
...
;// CONCATENATED MODULE: ./docs/kubernetes/set-receive-event.mdx
