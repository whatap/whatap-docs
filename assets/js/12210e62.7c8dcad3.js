"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["3950"], {
...
"99376": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_url_set_receive_event_mdx_122_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-url-set-receive-event-mdx-122.json
var site_docs_url_set_receive_event_mdx_122_namespaceObject = JSON.parse('{"id":"url/set-receive-event","title":"이벤트 수신 설정","description":"프로젝트에 포함하는 멤버들의 경고 알림 수신과 관련한 다양한 기능을 설정할 수 있습니다.","source":"@site/docs/url/set-receive-event.mdx","sourceDirName":"url","slug":"/url/set-receive-event","permalink":"/url/set-receive-event","draft":false,"unlisted":false,"editUrl":"undefined/docs/url/set-receive-event.mdx","tags":[],"version":"current","frontMatter":{"id":"set-receive-event","title":"이벤트 수신 설정","description":"프로젝트에 포함하는 멤버들의 경고 알림 수신과 관련한 다양한 기능을 설정할 수 있습니다.","keywords":["URL","경고 알림","이벤트 수신 태그"],"isTranslationMissing":false},"sidebar":"urlSidebar","previous":{"title":"이벤트 설정","permalink":"/url/url-event"},"next":{"title":"이벤트 기록","permalink":"/url/url-event-history"}}')
...
;// CONCATENATED MODULE: ./docs/url/set-receive-event.mdx
