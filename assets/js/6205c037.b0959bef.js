"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["94005"], {
...
"4014": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_oracle_pro_sga_size_mdx_620_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-oracle-pro-sga-size-mdx-620.json
var site_docs_oracle_pro_sga_size_mdx_620_namespaceObject = JSON.parse('{"id":"oracle-pro/sga-size","title":"SGA 사이즈","description":"오라클 서버 메모리 영역인 SGA 요약 정보를 매 시간 저장하여 시간별 변화량을 모니터링할 수 있습니다.","source":"@site/docs/oracle-pro/sga-size.mdx","sourceDirName":"oracle-pro","slug":"/oracle-pro/sga-size","permalink":"/oracle-pro/sga-size","draft":false,"unlisted":false,"editUrl":"undefined/docs/oracle-pro/sga-size.mdx","tags":[],"version":"current","frontMatter":{"id":"sga-size","title":"SGA 사이즈","description":"오라클 서버 메모리 영역인 SGA 요약 정보를 매 시간 저장하여 시간별 변화량을 모니터링할 수 있습니다.","keywords":["Oracle Pro","데이터베이스","통계"],"isTranslationMissing":false},"sidebar":"dboracledmaSidebar","previous":{"title":"테이블스페이스 사이즈","permalink":"/oracle-pro/table-space-size"},"next":{"title":"보고서","permalink":"/oracle-pro/report-intro"}}')
...
;// CONCATENATED MODULE: ./docs/oracle-pro/sga-size.mdx
