...
"46653": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_dotnet_topology_type_mdx_d52_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-dotnet-topology-type-mdx-d52.json
var site_docs_dotnet_topology_type_mdx_d52_namespaceObject = JSON.parse('{"id":"dotnet/topology-type","title":"유형별 토폴로지","description":"유형별 토폴로지에서 제공하는 기능을 알아봅니다.","source":"@site/docs/dotnet/topology-type.mdx","sourceDirName":"dotnet","slug":"/dotnet/topology-type","permalink":"/dotnet/topology-type","draft":false,"unlisted":false,"editUrl":"undefined/docs/dotnet/topology-type.mdx","tags":[],"version":"current","frontMatter":{"id":"topology-type","title":"유형별 토폴로지","description":"유형별 토폴로지에서 제공하는 기능을 알아봅니다.","keywords":[".NET","토폴로지"],"isTranslationMissing":false},"sidebar":"dotNetSidebar","previous":{"title":"기본 사용법","permalink":"/dotnet/topology-basic"},"next":{"title":"부가 기능","permalink":"/dotnet/topology-add-function"}}')
...
;// CONCATENATED MODULE: ./docs/dotnet/topology-type.mdx
