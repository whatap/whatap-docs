"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[7714],{
...
const metadata = {
  "id": "mssql-v1/agent-manage",
  "title": "관리하기",
  "description": "whatap.conf 파일을 통해 데이터베이스 에이전트를 관리할 수 있습니다.",
  "source": "@site/docs/mssql-v1/agent-manage.mdx",
  "sourceDirName": "mssql-v1",
  "slug": "/mssql-v1/agent-manage",
  "permalink": "/whatap-docs/mssql-v1/agent-manage",
  "draft": false,
  "unlisted": false,
  "editUrl": "undefined/docs/mssql-v1/agent-manage.mdx",
  "tags": [],
  "version": "current",
  "frontMatter": {
    "id": "agent-manage",
