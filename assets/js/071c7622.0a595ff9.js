"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["93554"], {
"8347": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_log_log_function_mdx_071_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-log-log-function-mdx-071.json
var site_docs_log_log_function_mdx_071_namespaceObject = JSON.parse('{"id":"log/log-function","title":"로그 모니터링 적용하기","description":"로그 모니터링 적용 방법을 안내합니다.","source":"@site/docs/log/log-function.mdx","sourceDirName":"log","slug":"/log/log-function","permalink":"/log/log-function","draft":false,"unlisted":false,"editUrl":"undefined/docs/log/log-function.mdx","tags":[],"version":"current","frontMatter":{"id":"log-function","title":"로그 모니터링 적용하기","description":"로그 모니터링 적용 방법을 안내합니다.","keywords":["로그 모니터링"],"isTranslationMissing":false},"sidebar":"logSidebar","previous":{"title":"Log 모니터링","permalink":"/log/introduction"},"next":{"title":"Java","permalink":"/log/log-java"}}')
...
const _log_basics_frontMatter = (/* unused pure expression or super */ null && ({}));
