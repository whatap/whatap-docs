"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["62950"], {
...
"45313": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_golang_track_transactions_intro_mdx_2ea_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-golang-track-transactions-intro-mdx-2ea.json
var site_docs_golang_track_transactions_intro_mdx_2ea_namespaceObject = JSON.parse('{"id":"golang/track-transactions-intro","title":"트랜잭션","description":"트랜잭션의 개요를 안내합니다.","source":"@site/docs/golang/track-transactions-intro.mdx","sourceDirName":"golang","slug":"/golang/track-transactions-intro","permalink":"/golang/track-transactions-intro","draft":false,"unlisted":false,"editUrl":"undefined/docs/golang/track-transactions-intro.mdx","tags":[],"version":"current","frontMatter":{"id":"track-transactions-intro","title":"트랜잭션","description":"트랜잭션의 개요를 안내합니다.","keywords":["Go","트랜잭션"],"isTranslationMissing":false},"sidebar":"goSidebar","previous":{"title":"메트릭스 이상 탐지","permalink":"/golang/metrics-detect-anormal"},"next":{"title":"트랜잭션 분석하기","permalink":"/golang/trs-view"}}')
...
;// CONCATENATED MODULE: ./docs/golang/track-transactions-intro.mdx
