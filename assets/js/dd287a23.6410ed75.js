"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["82344"], {
...
"26631": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_kubernetes_set_event_history_mdx_dd2_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-kubernetes-set-event-history-mdx-dd2.json
var site_docs_kubernetes_set_event_history_mdx_dd2_namespaceObject = JSON.parse('{"id":"kubernetes/set-event-history","title":"이벤트 기록","description":"이벤트 기록 메뉴를 통해 발생한 경고 알림 이력을 확인할 수 있습니다.","source":"@site/docs/kubernetes/set-event-history.mdx","sourceDirName":"kubernetes","slug":"/kubernetes/set-event-history","permalink":"/kubernetes/set-event-history","draft":false,"unlisted":false,"editUrl":"undefined/docs/kubernetes/set-event-history.mdx","tags":[],"version":"current","frontMatter":{"id":"set-event-history","title":"이벤트 기록","description":"이벤트 기록 메뉴를 통해 발생한 경고 알림 이력을 확인할 수 있습니다.","keywords":["경고 알림","이벤트 기록","쿠버네티스 모니터링"],"isTranslationMissing":false},"sidebar":"kubeSidebar","previous":{"title":"이벤트 수신 설정","permalink":"/kubernetes/set-receive-event"},"next":{"title":"실시간 알림","permalink":"/kubernetes/real-time-notification"}}')
...
;// CONCATENATED MODULE: ./docs/kubernetes/set-event-history.mdx
