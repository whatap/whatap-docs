"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["96998"], {
...
"3320": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_tibero_flexboard_create_mdx_8c4_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-tibero-flexboard-create-mdx-8c4.json
var site_docs_tibero_flexboard_create_mdx_8c4_namespaceObject = JSON.parse('{"id":"tibero/flexboard-create","title":"Flex 보드 만들기","description":"Flex 보드 메뉴에서 대시보드를 생성하고, 위젯을 배치하여 사용자 정의 대시보드를 만드는 과정을 안내합니다. 고정 레이아웃과 반응형 레이아웃 중에서 선택할 수 있으며, 메트릭스 위젯 추가 및 사전 정의된 위젯 템플릿을 활용할 수 있습니다. 사용자는 위젯의 위치를 조정하고, 크기를 변경하여 자신만의 대시보드 레이아웃을 완성할 수 있습니다.","source":"@site/docs/tibero/flexboard-create.mdx","sourceDirName":"tibero","slug":"/tibero/flexboard-create","permalink":"/tibero/flexboard-create","draft":false,"unlisted":false,"editUrl":"undefined/docs/tibero/flexboard-create.mdx","tags":[],"version":"current","frontMatter":{"id":"flexboard-create","title":"Flex 보드 만들기","description":"Flex 보드 메뉴에서 대시보드를 생성하고, 위젯을 배치하여 사용자 정의 대시보드를 만드는 과정을 안내합니다. 고정 레이아웃과 반응형 레이아웃 중에서 선택할 수 있으며, 메트릭스 위젯 추가 및 사전 정의된 위젯 템플릿을 활용할 수 있습니다. 사용자는 위젯의 위치를 조정하고, 크기를 변경하여 자신만의 대시보드 레이아웃을 완성할 수 있습니다.","keywords":["Tibero","Flex 보드","위젯","메트릭스"],"isTranslationMissing":false},"sidebar":"tiberoSidebar","previous":{"title":"사전 템플릿 적용","permalink":"/tibero/flexboard-template"},"next":{"title":"Flex 보드 관리하기","permalink":"/tibero/flexboard-manage"}}')
...
;// CONCATENATED MODULE: ./docs/tibero/flexboard-create.mdx
