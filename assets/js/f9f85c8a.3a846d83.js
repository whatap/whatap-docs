"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["59809"], {
...
"90805": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_mssql_v_1_monitoring_support_mdx_f9f_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-mssql-v-1-monitoring-support-mdx-f9f.json
var site_docs_mssql_v_1_monitoring_support_mdx_f9f_namespaceObject = JSON.parse('{"id":"mssql-v1/monitoring-support","title":"지원 환경","description":"데이터베이스 모니터링을 시작하기 전에 지원하는 데이터베이스 종류에 대해서 알아보세요.","source":"@site/docs/mssql-v1/monitoring-support.mdx","sourceDirName":"mssql-v1","slug":"/mssql-v1/monitoring-support","permalink":"/mssql-v1/monitoring-support","draft":false,"unlisted":false,"editUrl":"undefined/docs/mssql-v1/monitoring-support.mdx","tags":[],"version":"current","frontMatter":{"id":"monitoring-support","title":"지원 환경","description":"데이터베이스 모니터링을 시작하기 전에 지원하는 데이터베이스 종류에 대해서 알아보세요.","keywords":["SQL Server","데이터베이스"],"isTranslationMissing":false},"sidebar":"mssqlV1Sidebar","previous":{"title":"SQL Server V1 모니터링","permalink":"/mssql-v1/monitoring-intro"},"next":{"title":"에이전트 설치","permalink":"/mssql-v1/install-agent"}}')
...
;// CONCATENATED MODULE: ./docs/mssql-v1/monitoring-support.mdx
