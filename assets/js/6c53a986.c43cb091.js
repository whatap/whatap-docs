"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["88330"], {
...
"64165": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_cubrid_report_intro_mdx_6c5_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-cubrid-report-intro-mdx-6c5.json
var site_docs_cubrid_report_intro_mdx_6c5_namespaceObject = JSON.parse('{"id":"cubrid/report-intro","title":"보고서","description":"개별 프로젝트에 대해 서비스 이용 현황과 장애 발생 기록을 보고하는 문서에 대해 알아봅니다.","source":"@site/docs/cubrid/report-intro.mdx","sourceDirName":"cubrid","slug":"/cubrid/report-intro","permalink":"/cubrid/report-intro","draft":false,"unlisted":false,"editUrl":"undefined/docs/cubrid/report-intro.mdx","tags":[],"version":"current","frontMatter":{"id":"report-intro","title":"보고서","description":"개별 프로젝트에 대해 서비스 이용 현황과 장애 발생 기록을 보고하는 문서에 대해 알아봅니다.","keywords":["CUBRID","데이터베이스","데이터베이스 모니터링","보고서"],"isTranslationMissing":false},"sidebar":"cubridSidebar","previous":{"title":"데이터베이스 사이즈","permalink":"/cubrid/database-size"},"next":{"title":"로그","permalink":"/cubrid/log-main"}}')
...
;// CONCATENATED MODULE: ./docs/cubrid/report-intro.mdx
