"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["36051"], {
...
"57139": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_php_warning_notice_mdx_794_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-php-warning-notice-mdx-794.json
var site_docs_php_warning_notice_mdx_794_namespaceObject = JSON.parse('{"id":"php/warning-notice","title":"애플리케이션 경고 알림","description":"애플리케이션의 자원 사용량 및, 진행 중 트랜잭션, 에러 상황의 이벤트 조건을 통해 경고 알림을 보냅니다.","source":"@site/docs/php/warning-notice.mdx","sourceDirName":"php","slug":"/php/warning-notice","permalink":"/php/warning-notice","draft":false,"unlisted":false,"editUrl":"undefined/docs/php/warning-notice.mdx","tags":[],"version":"current","frontMatter":{"id":"warning-notice","title":"애플리케이션 경고 알림","description":"애플리케이션의 자원 사용량 및, 진행 중 트랜잭션, 에러 상황의 이벤트 조건을 통해 경고 알림을 보냅니다.","keywords":["PHP","경고 알림","애플리케이션"],"isTranslationMissing":false},"sidebar":"phpSidebar","previous":{"title":"경고 알림","permalink":"/php/apm-set-notice"},"next":{"title":"이벤트 설정","permalink":"/php/warning-notice-v2"}}')
...
;// CONCATENATED MODULE: ./docs/php/warning-notice.mdx
