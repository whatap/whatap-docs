"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["60120"], {
...
"84359": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_golang_install_agent_mdx_dbe_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-golang-install-agent-mdx-dbe.json
var site_docs_golang_install_agent_mdx_dbe_namespaceObject = JSON.parse('{"id":"golang/install-agent","title":"에이전트 설치","description":"Go 환경의 애플리케이션 서버에 에이전트를 설치하는 방법을 제공합니다.","source":"@site/docs/golang/install-agent.mdx","sourceDirName":"golang","slug":"/golang/install-agent","permalink":"/golang/install-agent","draft":false,"unlisted":false,"editUrl":"undefined/docs/golang/install-agent.mdx","tags":[],"version":"current","frontMatter":{"id":"install-agent","title":"에이전트 설치","description":"Go 환경의 애플리케이션 서버에 에이전트를 설치하는 방법을 제공합니다.","keywords":["Go","에이전트 설치"],"isTranslationMissing":false},"sidebar":"goSidebar","previous":{"title":"지원 환경","permalink":"/golang/supported-spec"},"next":{"title":"Docker 환경 설치","permalink":"/golang/install-agent-docker"}}')
...
const install_agent_toc = [..._create_project_v2/* toc */.d$, ..._accesskey_v2/* toc */.d$, {
  "value": "에이전트 다운로드",
  "id": "에이전트-다운로드",
  "level": 2
}, {
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsx)(_components.p, {
      ...
      children: [(0,jsx_runtime.jsx)(_components.h2, {
        ...
        children: "에이전트는 모니터링 정보를 수집하기 위한 트레이서, 수집한 정보를 서버에 전송하기 위한 에이전트, 트레이서와 에이전트를 서버에 동적으로 적용하기 위한 설치 스크립트 파일로 구성합니다. 에이전트 파일에 대한 자세한 설명은 다음을 참조하세요."
      }), (0,jsx_runtime.jsxs)(Filetree, {
        name: "whatap",
        children: [(0,jsx_runtime.jsx)(FiletreeItem, {
          name: "whatap-agent",
          type: "file",
          children: "에이전트, 트레이서에서 UDP로 전달한 정보를 수집 서버로 전송하는 프로그램입니다."
          ...
          name: "whatap.conf",
          type: "file",
          children: "설정 정보 및 수집 서버 IP, 액세스 키를 입력하는 파일입니다."
        }), (0,jsx_runtime.jsxs)(FiletreeItem, {
          name: "whatap-boot-yyyymmdd.log",
          type: "file",
          children: ["에이전트 로그 파일입니다. (경로: ", (0,jsx_runtime.jsx)(_components.em, {
