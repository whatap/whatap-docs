"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["14368"], {
...
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_altibase_v_1_dashboard_intro_mdx_108_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-altibase-v-1-dashboard-intro-mdx-108.json
var site_docs_altibase_v_1_dashboard_intro_mdx_108_namespaceObject = JSON.parse('{"id":"altibase-v1/dashboard-intro","title":"실시간 데이터베이스 성능 지표 확인","description":"와탭 모니터링 대시보드는 프로젝트의 전체 현황을 한 눈에 파악하기 위한 기능을 제공합니다.","source":"@site/docs/altibase-v1/dashboard-intro.mdx","sourceDirName":"altibase-v1","slug":"/altibase-v1/dashboard-intro","permalink":"/altibase-v1/dashboard-intro","draft":false,"unlisted":false,"editUrl":"undefined/docs/altibase-v1/dashboard-intro.mdx","tags":[],"version":"current","frontMatter":{"id":"dashboard-intro","title":"실시간 데이터베이스 성능 지표 확인","description":"와탭 모니터링 대시보드는 프로젝트의 전체 현황을 한 눈에 파악하기 위한 기능을 제공합니다.","keywords":["Altibase","대시보드","인스턴스","데이터베이스 모니터링"],"isTranslationMissing":false},"sidebar":"altibasev1Sidebar","previous":{"title":"관리하기","permalink":"/altibase-v1/agent-manage"},"next":{"title":"인스턴스 목록","permalink":"/altibase-v1/instance-list"}}')
...
const dashboard_intro_toc = [..._db_dashboard_intro/* toc */.d$, ..._db_dashboard_instance_list/* toc */.d$, ..._db_dashboard_instance_monitoring/* toc */.d$, ...toc];
