"use strict";
(self["webpackChunkwhatap_origin"] = self["webpackChunkwhatap_origin"] || []).push([[99656,2512],{
...
var searchUtils = __webpack_require__(84559);
...
var docsVersion = __webpack_require__(51688);
// EXTERNAL MODULE: ./node_modules/@docusaurus/theme-common/lib/contexts/docsSidebar.js
var docsSidebar = __webpack_require__(53024);
...
var useLocationChange = __webpack_require__(61580);
...
/** Wires the logic for the back to top button. */ function useBackToTopButton({ threshold }) {
    ...
    const { startScroll, cancelScroll } = (0,scrollUtils/* useSmoothScrollTo */.yI)();
    (0,scrollUtils/* useScrollPosition */.SM)(({ scrollY: scrollTop }, lastPosition)=>{
    ...
    (0,useLocationChange/* useLocationChange */.c)((locationChangeEvent)=>{
...
function BackToTopButton() {
    ...
    return /*#__PURE__*/ (0,jsx_runtime.jsx)("button", {
        ...
        className: (0,clsx_m/* default */.c)('clean-btn', ThemeClassNames/* ThemeClassNames */.W.common.backToTopButton, styles_module.backToTopButton, shown && styles_module.backToTopButtonShow),
        type: "button",
        onClick: scrollToTop
    });
}
...
var accessibilityUtils = __webpack_require__(32228);
// EXTERNAL MODULE: ./node_modules/react-router/esm/react-router.js
var react_router = __webpack_require__(55592);
// EXTERNAL MODULE: ./node_modules/@docusaurus/theme-common/lib/hooks/useWindowSize.js
var useWindowSize = __webpack_require__(62260);
// EXTERNAL MODULE: ./node_modules/@docusaurus/theme-common/lib/utils/useThemeConfig.js
var useThemeConfig = __webpack_require__(65684);
// EXTERNAL MODULE: ./node_modules/@docusaurus/theme-classic/lib/theme/Logo/index.js
var Logo = __webpack_require__(19232);
...
function CollapseButton({ onClick }) {
    return /*#__PURE__*/ (0,jsx_runtime.jsx)("button", {
        ...
        className: (0,clsx_m/* default */.c)('button button--secondary button--outline', CollapseButton_styles_module.collapseSidebarButton),
        onClick: onClick,
...
var announcementBar = __webpack_require__(46944);
// EXTERNAL MODULE: ./node_modules/@docusaurus/theme-common/lib/utils/reactUtils.js
var reactUtils = __webpack_require__(48476);
...
function useDocSidebarItemsExpandedState() {
    ...
    if (value === EmptyContext) {
        throw new reactUtils/* ReactContextError */.AH('DocSidebarItemsExpandedStateProvider');
    }
    return value;
...
var routesUtils = __webpack_require__(48472);
...
function useAutoExpandActiveCategory({ isActive, collapsed, updateCollapsed }) {
    const wasActive = (0,reactUtils/* usePrevious */.i0)(isActive);
    (0,react.useEffect)(()=>{
 ...
 */ function useCategoryHrefWithSSRFallback(item) {
    ...
    return (0,react.useMemo)(()=>{
        ...
        return (0,docsUtils/* findFirstCategoryLink */.OQ)(item);
    }, [
        item,
        isBrowser
    ]);
...
function DocSidebarItemCategory(_param) {
    ...
    const { docs: { sidebar: { autoCollapseCategories } } } = (0,useThemeConfig/* useThemeConfig */.y)();
    const hrefWithSSRFallback = useCategoryHrefWithSSRFallback(item);
    const isActive = (0,docsUtils/* isActiveSidebarItem */.Md)(item, activePath);
    const isCurrentPage = (0,routesUtils/* isSamePath */.Sc)(href, activePath);
    const { collapsed, setCollapsed } = (0,Collapsible/* useCollapsible */.a)({
    ...
    return /*#__PURE__*/ (0,jsx_runtime.jsxs)("li", {
        className: (0,clsx_m/* default */.c)(ThemeClassNames/* ThemeClassNames */.W.docs.docSidebarItemCategory, ThemeClassNames/* ThemeClassNames */.W.docs.docSidebarItemCategoryLevel(level), 'menu__list-item', {
            'menu__list-item--collapsed': collapsed
        }, className),
        children: [
            /*#__PURE__*/ (0,jsx_runtime.jsxs)("div", {
                className: (0,clsx_m/* default */.c)('menu__list-item-collapsible', {
                    'menu__list-item-collapsible--active': isCurrentPage
                }),
                children: [
                    /*#__PURE__*/ (0,jsx_runtime.jsx)(Link/* default */.c, Category_object_spread_props(Category_object_spread({
                        className: (0,clsx_m/* default */.c)('menu__link', {
...
var ExternalLink = __webpack_require__(11360);
...
function DocSidebarItemLink(_param) {
    ...
    const isActive = (0,docsUtils/* isActiveSidebarItem */.Md)(item, activePath);
    const isInternalLink = (0,isInternalUrl/* default */.c)(href);
    return /*#__PURE__*/ (0,jsx_runtime.jsx)("li", {
        className: (0,clsx_m/* default */.c)(ThemeClassNames/* ThemeClassNames */.W.docs.docSidebarItemLink, ThemeClassNames/* ThemeClassNames */.W.docs.docSidebarItemLinkLevel(level), 'menu__list-item', className),
        children: /*#__PURE__*/ (0,jsx_runtime.jsxs)(Link/* default */.c, Link_object_spread_props(Link_object_spread({
            className: (0,clsx_m/* default */.c)('menu__link', !isInternalLink && Link_styles_module.menuExternalLink, {
                'menu__link--active': isActive
            }),
            ...
            children: [
                label,
                !isInternalLink && /*#__PURE__*/ (0,jsx_runtime.jsx)(ExternalLink/* default */.c, {})
            ]
        }))
    }, label);
}
...
function DocSidebarItemHtml({ item, level, index }) {
    ...
    return /*#__PURE__*/ (0,jsx_runtime.jsx)("li", {
        className: (0,clsx_m/* default */.c)(ThemeClassNames/* ThemeClassNames */.W.docs.docSidebarItemLink, ThemeClassNames/* ThemeClassNames */.W.docs.docSidebarItemLinkLevel(level), defaultStyle && [
...
function useShowAnnouncementBar() {
    const { isActive } = (0,announcementBar/* useAnnouncementBar */.el)();
    const [showAnnouncementBar, setShowAnnouncementBar] = (0,react.useState)(isActive);
    (0,scrollUtils/* useScrollPosition */.SM)(({ scrollY })=>{
        if (isActive) {
...
function DocSidebarDesktopContent({ path, sidebar, className }) {
    ...
    return /*#__PURE__*/ (0,jsx_runtime.jsx)("nav", {
        ...
        className: (0,clsx_m/* default */.c)('menu thin-scrollbar', Content_styles_module.menu, showAnnouncementBar && Content_styles_module.menuWithAnnouncementBar, className),
        children: /*#__PURE__*/ (0,jsx_runtime.jsx)("ul", {
            className: (0,clsx_m/* default */.c)(ThemeClassNames/* ThemeClassNames */.W.docs.docSidebarMenu, 'menu__list'),
            children: /*#__PURE__*/ (0,jsx_runtime.jsx)(theme_DocSidebarItems, {
                items: sidebar,
                activePath: path,
                level: 1
...
var useDocusaurusContext = __webpack_require__(49936);
...
function DocSidebarDesktop({ path, sidebar, onCollapse, isHidden }) {
    const { navbar: { hideOnScroll }, docs: { sidebar: { hideable } } } = (0,useThemeConfig/* useThemeConfig */.y)();
    const { i18n: { currentLocale } } = (0,useDocusaurusContext/* default */.c)();
    ...
    return /*#__PURE__*/ (0,jsx_runtime.jsxs)("div", {
        className: (0,clsx_m/* default */.c)(Desktop_styles_module.sidebar, hideOnScroll && Desktop_styles_module.sidebarWithHideableNavbar, isHidden && Desktop_styles_module.sidebarHidden),
        children: [
                    ...
                    children: [
                        /*#__PURE__*/ (0,jsx_runtime.jsx)("li", {
                            children: /*#__PURE__*/ (0,jsx_runtime.jsx)("a", {
                                href: docshome,
                                className: "home",
                                children: (0,Translate/* translate */.G)({
                                    id: "docs_Name",
                                    message: "WhaTap Docs"
                                })
                            })
            ...
            hideOnScroll && /*#__PURE__*/ (0,jsx_runtime.jsx)(Logo/* default */.c, {
                tabIndex: -1,
...
const DocSidebarMobileSecondaryMenu = ({ sidebar, path })=>{
    const mobileSidebar = (0,navbarMobileSidebar/* useNavbarMobileSidebar */.q)();
...
function DocSidebarMobile(props) {
    return /*#__PURE__*/ (0,jsx_runtime.jsx)(content/* NavbarSecondaryMenuFiller */.Mx, {
...
function DocSidebar(props) {
    const windowSize = (0,useWindowSize/* useWindowSize */.U)();
...
function ResetOnSidebarChange({ children }) {
    const sidebar = (0,docsSidebar/* useDocsSidebar */.m)();
    var _sidebar_name;
...
function DocPageLayoutSidebar({ sidebar, hiddenSidebarContainer, setHiddenSidebarContainer }) {
    const { pathname } = (0,react_router/* useLocation */.IT)();
    ...
    const toggleSidebar = (0,react.useCallback)(()=>{
        ...
        if (!hiddenSidebar && (0,accessibilityUtils/* prefersReducedMotion */.I)()) {
    ...
    return /*#__PURE__*/ (0,jsx_runtime.jsx)("aside", {
        className: (0,clsx_m/* default */.c)(ThemeClassNames/* ThemeClassNames */.W.docs.docSidebarContainer, Sidebar_styles_module.docSidebarContainer, hiddenSidebarContainer && Sidebar_styles_module.docSidebarContainerHidden),
        onTransitionEnd: (e)=>{
        ...
        children: /*#__PURE__*/ (0,jsx_runtime.jsx)(ResetOnSidebarChange, {
            children: /*#__PURE__*/ (0,jsx_runtime.jsxs)("div", {
                className: (0,clsx_m/* default */.c)(Sidebar_styles_module.sidebarViewport, hiddenSidebar && Sidebar_styles_module.sidebarViewportHidden),
                children: [
...
function DocPageLayoutMain({ hiddenSidebarContainer, children }) {
    ...
    return /*#__PURE__*/ (0,jsx_runtime.jsx)("main", {
        className: (0,clsx_m/* default */.c)(Main_styles_module.docMainContainer, (hiddenSidebarContainer || !sidebar) && Main_styles_module.docMainContainerEnhanced),
        children: /*#__PURE__*/ (0,jsx_runtime.jsx)("div", {
            className: (0,clsx_m/* default */.c)('container padding-top--md padding-bottom--lg', Main_styles_module.docItemWrapper, hiddenSidebarContainer && Main_styles_module.docItemWrapperEnhanced),
            children: children
        })
    });
}
...
var NotFound = __webpack_require__(2512);
    ...
    return /*#__PURE__*/ (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
        children: [
            /*#__PURE__*/ (0,jsx_runtime.jsx)(SearchMetadata/* default */.c, {
                ...
                tag: (0,searchUtils/* docVersionSearchTag */.SE)(versionMetadata.pluginId, versionMetadata.version)
            }),
...
function DocPage(props) {
    const { versionMetadata } = props;
    const currentDocRouteMetadata = (0,docsUtils/* useDocRouteMetadata */.sr)(props);
    ...
    return /*#__PURE__*/ (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
        children: [
            ...
            /*#__PURE__*/ (0,jsx_runtime.jsx)(metadataUtils/* HtmlClassNameProvider */.cr, {
                className: (0,clsx_m/* default */.c)(// TODO: it should be removed from here
                ThemeClassNames/* ThemeClassNames */.W.wrapper.docsPages, ThemeClassNames/* ThemeClassNames */.W.page.docsDocPage, props.versionMetadata.className),
                children: /*#__PURE__*/ (0,jsx_runtime.jsx)(docsVersion/* DocsVersionProvider */.Q, {
                    version: versionMetadata,
                    children: /*#__PURE__*/ (0,jsx_runtime.jsx)(docsSidebar/* DocsSidebarProvider */.y, {
                        name: sidebarName,
                        items: sidebarItems,
...
/* harmony import */ var _docusaurus_theme_common__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(38384);
/* harmony import */ var _theme_Layout__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(76008);
/**
 * Copyright (c) Facebook, Inc. and its affiliates.
 *
 * This source code is licensed under the MIT license found in the
...
function NotFound() {
    return /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.Fragment, {
        children: [
            /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_docusaurus_theme_common__WEBPACK_IMPORTED_MODULE_4__/* .PageMetadata */ .U7, {
                title: (0,_docusaurus_Translate__WEBPACK_IMPORTED_MODULE_2__/* .translate */ .G)({
                    id: 'theme.NotFound.title',
                    message: 'Page Not Found'
                })
            }),
            /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_theme_Layout__WEBPACK_IMPORTED_MODULE_3__/* ["default"] */ .c, {
