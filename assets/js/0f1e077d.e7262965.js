"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["88639"], {
...
"75717": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_golang_topology_add_function_mdx_0f1_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-golang-topology-add-function-mdx-0f1.json
var site_docs_golang_topology_add_function_mdx_0f1_namespaceObject = JSON.parse('{"id":"golang/topology-add-function","title":"부가 기능","description":"토폴로지 메뉴에서 이용할 수 있는 부가 기능에 대한 설명을 제공합니다.","source":"@site/docs/golang/topology-add-function.mdx","sourceDirName":"golang","slug":"/golang/topology-add-function","permalink":"/golang/topology-add-function","draft":false,"unlisted":false,"editUrl":"undefined/docs/golang/topology-add-function.mdx","tags":[],"version":"current","frontMatter":{"id":"topology-add-function","title":"부가 기능","description":"토폴로지 메뉴에서 이용할 수 있는 부가 기능에 대한 설명을 제공합니다.","keywords":["Go","토폴로지"],"isTranslationMissing":false},"sidebar":"goSidebar","previous":{"title":"유형별 토폴로지","permalink":"/golang/topology-type"},"next":{"title":"통계","permalink":"/golang/analysis-apm-trs"}}')
...
;// CONCATENATED MODULE: ./docs/golang/topology-add-function.mdx
