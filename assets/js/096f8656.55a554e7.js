"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["48626"], {
...
"74181": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_java_hitmap_notice_mdx_096_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-java-hitmap-notice-mdx-096.json
var site_docs_java_hitmap_notice_mdx_096_namespaceObject = JSON.parse('{"id":"java/hitmap-notice","title":"AI 기반의 히트맵 패턴 경고 알림","description":"애플리케이션 실행 분포 패턴을 머신 러닝을 통해 자동 인식하여 경고 알림을 보냅니다.","source":"@site/docs/java/hitmap-notice.mdx","sourceDirName":"java","slug":"/java/hitmap-notice","permalink":"/java/hitmap-notice","draft":false,"unlisted":false,"editUrl":"undefined/docs/java/hitmap-notice.mdx","tags":[],"version":"current","frontMatter":{"id":"hitmap-notice","title":"AI 기반의 히트맵 패턴 경고 알림","description":"애플리케이션 실행 분포 패턴을 머신 러닝을 통해 자동 인식하여 경고 알림을 보냅니다.","keywords":["Java","히트맵","경고 알림","애플리케이션","애플리케이션 모니터링"],"isTranslationMissing":false},"sidebar":"javaSidebar","previous":{"title":"알림 메시지 사용자 정의","permalink":"/java/set-notification-message"},"next":{"title":"이상치 탐지 경고 알림","permalink":"/java/set-event-detect-anomal"}}')
...
;// CONCATENATED MODULE: ./docs/java/hitmap-notice.mdx
