"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["29691"], {
"16627": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_aws_log_common_alert_mdx_bb0_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-aws-log-common-alert-mdx-bb0.json
var site_docs_aws_log_common_alert_mdx_bb0_namespaceObject = JSON.parse('{"id":"aws-log/common-alert","title":"시스템 이벤트 안내","description":"와탭 모니터링에서는 플랫폼 전반에서 자동으로 탐지 및 생성되는 공용 이벤트에 대해 안내합니다.","source":"@site/docs/aws-log/common-alert.mdx","sourceDirName":"aws-log","slug":"/aws-log/common-alert","permalink":"/aws-log/common-alert","draft":false,"unlisted":false,"editUrl":"undefined/docs/aws-log/common-alert.mdx","tags":[],"version":"current","frontMatter":{"id":"common-alert","title":"시스템 이벤트 안내","description":"와탭 모니터링에서는 플랫폼 전반에서 자동으로 탐지 및 생성되는 공용 이벤트에 대해 안내합니다.","keywords":["와탭","경고 알림","시스템 이벤트"],"isTranslationMissing":false},"sidebar":"awslogSidebar","previous":{"title":"실시간 알림","permalink":"/aws-log/real-time-notification"}}')
...
;// CONCATENATED MODULE: ./docs/aws-log/common-alert.mdx
