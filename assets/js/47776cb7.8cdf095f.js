"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["95706"], {
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_cubrid_agent_manage_mdx_477_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-cubrid-agent-manage-mdx-477.json
var site_docs_cubrid_agent_manage_mdx_477_namespaceObject = JSON.parse('{"id":"cubrid/agent-manage","title":"관리하기","description":"에이전트를 업데이트하거나 삭제하는 방법을 알아봅니다.","source":"@site/docs/cubrid/agent-manage.mdx","sourceDirName":"cubrid","slug":"/cubrid/agent-manage","permalink":"/cubrid/agent-manage","draft":false,"unlisted":false,"editUrl":"undefined/docs/cubrid/agent-manage.mdx","tags":[],"version":"current","frontMatter":{"id":"agent-manage","title":"관리하기","description":"에이전트를 업데이트하거나 삭제하는 방법을 알아봅니다.","keywords":["CUBRID","데이터베이스","데이터베이스 모니터링"],"isTranslationMissing":false},"sidebar":"cubridSidebar","previous":{"title":"XCUB 에이전트 설정","permalink":"/cubrid/agent-xcub-settings"},"next":{"title":"대시보드","permalink":"/cubrid/dashboard-intro"}}')
...
;// CONCATENATED MODULE: ./docs/cubrid/agent-manage.mdx
