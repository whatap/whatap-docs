"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["62437"], {
...
"71420": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_mysql_log_setting_mdx_ff0_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-mysql-log-setting-mdx-ff0.json
var site_docs_mysql_log_setting_mdx_ff0_namespaceObject = JSON.parse('{"id":"mysql/log-setting","title":"로그 설정","description":"로그 모니터링 설정 방법을 안내합니다.","source":"@site/docs/mysql/log-setting.mdx","sourceDirName":"mysql","slug":"/mysql/log-setting","permalink":"/mysql/log-setting","draft":false,"unlisted":false,"editUrl":"undefined/docs/mysql/log-setting.mdx","tags":[],"version":"current","frontMatter":{"id":"log-setting","title":"로그 설정","description":"로그 모니터링 설정 방법을 안내합니다.","toc_max_heading_level":3,"keywords":["로그","로그 모니터링","설정하기","MySQL"],"isTranslationMissing":false},"sidebar":"mysqlSidebar","previous":{"title":"로그 검색","permalink":"/mysql/log-search"},"next":{"title":"로그 파싱하기","permalink":"/mysql/log-parser"}}')
...
;// CONCATENATED MODULE: ./docs/mysql/log-setting.mdx
