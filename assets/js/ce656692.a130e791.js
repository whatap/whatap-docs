"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["24620"], {
...
"62114": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_oracle_v_1_set_receive_event_mdx_ce6_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-oracle-v-1-set-receive-event-mdx-ce6.json
var site_docs_oracle_v_1_set_receive_event_mdx_ce6_namespaceObject = JSON.parse('{"id":"oracle-v1/set-receive-event","title":"이벤트 수신 설정","description":"프로젝트에 포함하는 멤버들의 경고 알림 수신과 관련한 다양한 기능을 설정할 수 있습니다.","source":"@site/docs/oracle-v1/set-receive-event.mdx","sourceDirName":"oracle-v1","slug":"/oracle-v1/set-receive-event","permalink":"/oracle-v1/set-receive-event","draft":false,"unlisted":false,"editUrl":"undefined/docs/oracle-v1/set-receive-event.mdx","tags":[],"version":"current","frontMatter":{"id":"set-receive-event","title":"이벤트 수신 설정","description":"프로젝트에 포함하는 멤버들의 경고 알림 수신과 관련한 다양한 기능을 설정할 수 있습니다.","keywords":["Oracle","경고 알림","이벤트 수신 태그","데이터베이스 모니터링"],"isTranslationMissing":false},"sidebar":"dboracleSidebar","previous":{"title":"이상치 탐지 경고 알림","permalink":"/oracle-v1/set-event-detect-anomal"},"next":{"title":"이벤트 기록","permalink":"/oracle-v1/set-event-history"}}')
...
;// CONCATENATED MODULE: ./docs/oracle-v1/set-receive-event.mdx
