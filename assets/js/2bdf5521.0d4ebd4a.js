"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["19336"], {
...
"75137": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_golang_instance_performance_analysis_mdx_2bd_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-golang-instance-performance-analysis-mdx-2bd.json
var site_docs_golang_instance_performance_analysis_mdx_2bd_namespaceObject = JSON.parse('{"id":"golang/instance-performance-analysis","title":"인스턴스 성능 관리","description":"Go 애플리케이션의 환경을 확인하고 성능과 관련한 설정을 확인할 수 있습니다.","source":"@site/docs/golang/instance-performance-analysis.mdx","sourceDirName":"golang","slug":"/golang/instance-performance-analysis","permalink":"/golang/instance-performance-analysis","draft":false,"unlisted":false,"editUrl":"undefined/docs/golang/instance-performance-analysis.mdx","tags":[],"version":"current","frontMatter":{"id":"instance-performance-analysis","title":"인스턴스 성능 관리","description":"Go 애플리케이션의 환경을 확인하고 성능과 관련한 설정을 확인할 수 있습니다.","keywords":["Go","애플리케이션","인스턴스 성능 관리"],"isTranslationMissing":false},"sidebar":"goSidebar","previous":{"title":"시스템 이벤트 안내","permalink":"/golang/common-alert"},"next":{"title":"연계 프로젝트 관리","permalink":"/golang/linked-projects"}}')
...
;// CONCATENATED MODULE: ./docs/golang/instance-performance-analysis.mdx
...
const toc = [..._import_instance_performance_common/* toc */.d$, ..._import_instance_performance_run_env/* toc */.d$, ..._import_instance_performance_env/* toc */.d$, ..._import_instance_performance_agent_log/* toc */.d$, ..._import_instance_performance_agent_status/* toc */.d$];
function _createMdxContent(props) {
