"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["52137"], {
...
"73625": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_oracle_pro_set_event_format_mdx_369_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-oracle-pro-set-event-format-mdx-369.json
var site_docs_oracle_pro_set_event_format_mdx_369_namespaceObject = JSON.parse('{"id":"oracle-pro/set-event-format","title":"이벤트 수신 포맷","description":"데이터베이스 모니터링에서 제공하는 경고 알림의 이벤트 수신 포맷에 대해 알아봅니다.","source":"@site/docs/oracle-pro/set-event-format.mdx","sourceDirName":"oracle-pro","slug":"/oracle-pro/set-event-format","permalink":"/oracle-pro/set-event-format","draft":false,"unlisted":false,"editUrl":"undefined/docs/oracle-pro/set-event-format.mdx","tags":[],"version":"current","frontMatter":{"id":"set-event-format","title":"이벤트 수신 포맷","description":"데이터베이스 모니터링에서 제공하는 경고 알림의 이벤트 수신 포맷에 대해 알아봅니다.","keywords":["Oracle Pro","경고 알림","이벤트","데이터베이스","데이터베이스","이벤트 수신 포맷"],"isTranslationMissing":false},"sidebar":"dboracledmaSidebar","previous":{"title":"이벤트 기록","permalink":"/oracle-pro/set-event-history"},"next":{"title":"실시간 알림","permalink":"/oracle-pro/real-time-notification"}}')
...
;// CONCATENATED MODULE: ./docs/oracle-pro/set-event-format.mdx
...
const toc = [..._common_event_format/* toc */.d$];
function _createMdxContent(props) {
  return (0,jsx_runtime.jsx)(_common_event_format/* default */.ZP, {});
}
function MDXContent(props = {}) {
  const {wrapper: MDXLayout} = {
