"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["43983"], {
...
"31521": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_java_metric_warning_notice_new_mdx_a30_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-java-metric-warning-notice-new-mdx-a30.json
var site_docs_java_metric_warning_notice_new_mdx_a30_namespaceObject = JSON.parse('{"id":"java/metric-warning-notice-new","title":"메트릭스 경고 알림","description":"구체적이고 복잡한 이벤트를 설정하려면 메트릭스 이벤트 설정을 사용하세요.","source":"@site/docs/java/metric-warning-notice-new.mdx","sourceDirName":"java","slug":"/java/metric-warning-notice-new","permalink":"/java/metric-warning-notice-new","draft":false,"unlisted":false,"editUrl":"undefined/docs/java/metric-warning-notice-new.mdx","tags":[],"version":"current","frontMatter":{"id":"metric-warning-notice-new","title":"메트릭스 경고 알림","description":"구체적이고 복잡한 이벤트를 설정하려면 메트릭스 이벤트 설정을 사용하세요.","displayed_sidebar":"javaSidebar","keywords":["Java","경고 알림","메트릭스 이벤트"],"isTranslationMissing":false},"sidebar":"javaSidebar"}')
...
;// CONCATENATED MODULE: ./docs/java/metric-warning-notice-new.mdx
