"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["71753"], {
"51979": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_altibase_v_1_agent_aws_mdx_ee3_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-altibase-v-1-agent-aws-mdx-ee3.json
var site_docs_altibase_v_1_agent_aws_mdx_ee3_namespaceObject = JSON.parse('{"id":"altibase-v1/agent-aws","title":"AWS CloudWatch 이용","description":"AWS CloudWatch를 이용하는 에이전트 설정에 대한 설명입니다.","source":"@site/docs/altibase-v1/agent-aws.mdx","sourceDirName":"altibase-v1","slug":"/altibase-v1/agent-aws","permalink":"/altibase-v1/agent-aws","draft":false,"unlisted":false,"editUrl":"undefined/docs/altibase-v1/agent-aws.mdx","tags":[],"version":"current","frontMatter":{"id":"agent-aws","title":"AWS CloudWatch 이용","description":"AWS CloudWatch를 이용하는 에이전트 설정에 대한 설명입니다.","keywords":["Altibase","데이터베이스","데이터베이스 모니터링","에이전트","AWS"],"isTranslationMissing":false},"sidebar":"altibasev1Sidebar","previous":{"title":"에이전트 이름 식별","permalink":"/altibase-v1/agent-naming"},"next":{"title":"에이전트 데이터 수집","permalink":"/altibase-v1/agent-data"}}')
...
;// CONCATENATED MODULE: ./docs/altibase-v1/agent-aws.mdx
...
const toc = [..._db_agent_aws/* toc */.d$];
function _createMdxContent(props) {
  return (0,jsx_runtime.jsx)(_db_agent_aws/* default */.ZP, {});
}
