"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["28128"], {
...
"15826": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_redis_agent_xos_settings_mdx_b79_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-redis-agent-xos-settings-mdx-b79.json
var site_docs_redis_agent_xos_settings_mdx_b79_namespaceObject = JSON.parse('{"id":"redis/agent-xos-settings","title":"XOS 에이전트 설정","description":"Redis 데이터베이스 서버의 자원을 추가로 모니터링하기 위한 설정 방법을 제공합니다.","source":"@site/docs/redis/agent-xos-settings.mdx","sourceDirName":"redis","slug":"/redis/agent-xos-settings","permalink":"/redis/agent-xos-settings","draft":false,"unlisted":false,"editUrl":"undefined/docs/redis/agent-xos-settings.mdx","tags":[],"version":"current","frontMatter":{"id":"agent-xos-settings","title":"XOS 에이전트 설정","description":"Redis 데이터베이스 서버의 자원을 추가로 모니터링하기 위한 설정 방법을 제공합니다.","keywords":["Redis","데이터베이스","XOS 에이전트"],"isTranslationMissing":false},"sidebar":"redisSidebar","previous":{"title":"DBX 에이전트 설정","permalink":"/redis/agent-dbx-settings"},"next":{"title":"관리하기","permalink":"/redis/agent-manage"}}')
...
;// CONCATENATED MODULE: ./docs/redis/agent-xos-settings.mdx
