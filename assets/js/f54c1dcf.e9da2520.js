"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["2454"], {
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_mysql_agent_xos_settings_mdx_f54_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-mysql-agent-xos-settings-mdx-f54.json
var site_docs_mysql_agent_xos_settings_mdx_f54_namespaceObject = JSON.parse('{"id":"mysql/agent-xos-settings","title":"XOS 에이전트 설정","description":"데이터베이스 서버의 자원을 추가로 모니터링하기 위한 설정 방법을 제공합니다.","source":"@site/docs/mysql/agent-xos-settings.mdx","sourceDirName":"mysql","slug":"/mysql/agent-xos-settings","permalink":"/mysql/agent-xos-settings","draft":false,"unlisted":false,"editUrl":"undefined/docs/mysql/agent-xos-settings.mdx","tags":[],"version":"current","frontMatter":{"id":"agent-xos-settings","title":"XOS 에이전트 설정","description":"데이터베이스 서버의 자원을 추가로 모니터링하기 위한 설정 방법을 제공합니다.","keywords":["MySQL","데이터베이스 모니터링","XOS 에이전트"],"isTranslationMissing":false},"sidebar":"mysqlSidebar","previous":{"title":"DBX 에이전트 설정","permalink":"/mysql/agent-dbx-settings"},"next":{"title":"클라우드 설정","permalink":"/mysql/cloudsettings"}}')
...
;// CONCATENATED MODULE: ./docs/mysql/agent-xos-settings.mdx
