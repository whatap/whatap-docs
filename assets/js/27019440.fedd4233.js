"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["56207"], {
...
"48690": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_oracle_agent_xos_settings_mdx_270_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-oracle-agent-xos-settings-mdx-270.json
var site_docs_oracle_agent_xos_settings_mdx_270_namespaceObject = JSON.parse('{"id":"oracle/agent-xos-settings","title":"XOS 에이전트 설정","description":"데이터베이스 프로세스 모니터링 설정에 대해 알아봅니다.","source":"@site/docs/oracle/agent-xos-settings.mdx","sourceDirName":"oracle","slug":"/oracle/agent-xos-settings","permalink":"/oracle/agent-xos-settings","draft":false,"unlisted":false,"editUrl":"undefined/docs/oracle/agent-xos-settings.mdx","tags":[],"version":"current","frontMatter":{"id":"agent-xos-settings","title":"XOS 에이전트 설정","description":"데이터베이스 프로세스 모니터링 설정에 대해 알아봅니다.","keywords":["Oracle","데이터베이스","데이터베이스 모니터링","에이전트","XOS"],"isTranslationMissing":false},"sidebar":"dboracleV2Sidebar","previous":{"title":"DBX 에이전트 설정","permalink":"/oracle/agent-dbx-settings"},"next":{"title":"클라우드 설정","permalink":"/oracle/cloudsettings"}}')
...
;// CONCATENATED MODULE: ./docs/oracle/agent-xos-settings.mdx
...
const toc = [..._import_v2_note/* toc */.d$, ..._db_agent_xos_settings_desc/* toc */.d$, ..._db_xos_whatap_conf/* toc */.d$, ..._db_xos_conf/* toc */.d$, ..._import_v2_file_option_note/* toc */.d$, ..._db_run_xos/* toc */.d$];
function _createMdxContent(props) {
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsx)(_import_v2_note/* default */.ZP, {
      product: "Oracle"
    }), "\n", "\n", (0,jsx_runtime.jsx)(_db_agent_xos_settings_desc/* default */.ZP, {}), "\n", "\n", (0,jsx_runtime.jsx)(_db_xos_whatap_conf/* default */.ZP, {}), "\n", "\n", (0,jsx_runtime.jsx)(_db_xos_conf/* default */.ZP, {}), "\n", (0,jsx_runtime.jsx)(_import_v2_file_option_note/* default */.ZP, {
      ver: "1.9.0"
