"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["59165"], {
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_mssql_cloudsettings_mdx_521_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-mssql-cloudsettings-mdx-521.json
var site_docs_mssql_cloudsettings_mdx_521_namespaceObject = JSON.parse('{"id":"mssql/cloudsettings","title":"클라우드 설정","description":"클라우드 데이터베이스 서버의 자원 현황을 수집하고 모니터링할 수 있습니다.","source":"@site/docs/mssql/cloudsettings.mdx","sourceDirName":"mssql","slug":"/mssql/cloudsettings","permalink":"/mssql/cloudsettings","draft":false,"unlisted":false,"editUrl":"undefined/docs/mssql/cloudsettings.mdx","tags":[],"version":"current","frontMatter":{"id":"cloudsettings","title":"클라우드 설정","description":"클라우드 데이터베이스 서버의 자원 현황을 수집하고 모니터링할 수 있습니다.","keywords":["SQL Server","데이터베이스","클라우드"],"isTranslationMissing":false},"sidebar":"mssqlSidebar","previous":{"title":"XOS 에이전트 설정","permalink":"/mssql/agent-xos-settings"},"next":{"title":"관리하기","permalink":"/mssql/agent-manage"}}')
...
;// CONCATENATED MODULE: ./docs/mssql/cloudsettings.mdx
...
const toc = [..._db_cloudsettings_desc/* toc */.d$, ..._db_cloudsettings_awscloudwatch/* toc */.d$];
function _createMdxContent(props) {
