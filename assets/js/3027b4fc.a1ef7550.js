"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["84684"], {
...
"46236": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_cubrid_v_1_stat_mdx_302_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-cubrid-v-1-stat-mdx-302.json
var site_docs_cubrid_v_1_stat_mdx_302_namespaceObject = JSON.parse('{"id":"cubrid-v1/stat","title":"SQL 통계","description":"CUBRID의 데이터베이스별 통계 데이터를 제공합니다.","source":"@site/docs/cubrid-v1/stat.mdx","sourceDirName":"cubrid-v1","slug":"/cubrid-v1/stat","permalink":"/cubrid-v1/stat","draft":false,"unlisted":false,"editUrl":"undefined/docs/cubrid-v1/stat.mdx","tags":[],"version":"current","frontMatter":{"id":"stat","title":"SQL 통계","description":"CUBRID의 데이터베이스별 통계 데이터를 제공합니다.","keywords":["CUBRID","데이터베이스","통계"],"isTranslationMissing":false},"sidebar":"cubridV1Sidebar","previous":{"title":"메트릭스 이상 탐지","permalink":"/cubrid-v1/metrics-detect-anormal"},"next":{"title":"테이블 사이즈 증감","permalink":"/cubrid-v1/table-size"}}')
...
;// CONCATENATED MODULE: ./docs/cubrid-v1/stat.mdx
