"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[76960],{
...
const metadata = {
  "id": "oracle-dma/table-space-size",
  "title": "테이블스페이스 사이즈",
  "description": "각 테이블 스페이스별 최대 용량과 사용량을 시간의 흐름에 따라 조회할 수 있습니다.",
  "source": "@site/docs/oracle-dma/table-space-size.mdx",
  "sourceDirName": "oracle-dma",
  "slug": "/oracle-dma/table-space-size",
  "permalink": "/whatap-docs/oracle-dma/table-space-size",
  "draft": false,
  "unlisted": false,
  "editUrl": "undefined/docs/oracle-dma/table-space-size.mdx",
  "tags": [
    {
      "inline": true,
      "label": "Oracle DMA",
...
/*테이블 스페이스 사이즈 Oracle DMA, tibero*/
