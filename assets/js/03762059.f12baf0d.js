"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["11629"], {
...
"59576": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_dotnet_tx_profile_mdx_037_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-dotnet-tx-profile-mdx-037.json
var site_docs_dotnet_tx_profile_mdx_037_namespaceObject = JSON.parse('{"id":"dotnet/tx-profile","title":"트랜잭션 검색","description":"개별 트랜잭션의 성능 속성을 기반으로 원하는 트랜잭션을 검색할 수 있습니다.","source":"@site/docs/dotnet/tx-profile.mdx","sourceDirName":"dotnet","slug":"/dotnet/tx-profile","permalink":"/dotnet/tx-profile","draft":false,"unlisted":false,"editUrl":"undefined/docs/dotnet/tx-profile.mdx","tags":[],"version":"current","frontMatter":{"id":"tx-profile","title":"트랜잭션 검색","description":"개별 트랜잭션의 성능 속성을 기반으로 원하는 트랜잭션을 검색할 수 있습니다.","keywords":[".NET","애플리케이션","트랜잭션"],"isTranslationMissing":false},"sidebar":"dotNetSidebar","previous":{"title":"멀티 트랜잭션 추적","permalink":"/dotnet/analysis-trace-mtx"},"next":{"title":"MSA 분석","permalink":"/dotnet/analysis-msa"}}')
...
;// CONCATENATED MODULE: ./docs/dotnet/tx-profile.mdx
