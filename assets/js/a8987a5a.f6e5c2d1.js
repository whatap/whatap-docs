"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["88332"], {
...
"46884": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_nodejs_trs_multi_trace_mdx_a89_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-nodejs-trs-multi-trace-mdx-a89.json
var site_docs_nodejs_trs_multi_trace_mdx_a89_namespaceObject = JSON.parse('{"id":"nodejs/trs-multi-trace","title":"멀티 트랜잭션","description":"멀티 트랜잭션 추적을 안내합니다.","source":"@site/docs/nodejs/trs-multi-trace.mdx","sourceDirName":"nodejs","slug":"/nodejs/trs-multi-trace","permalink":"/nodejs/trs-multi-trace","draft":false,"unlisted":false,"editUrl":"undefined/docs/nodejs/trs-multi-trace.mdx","tags":[],"version":"current","frontMatter":{"id":"trs-multi-trace","title":"멀티 트랜잭션","description":"멀티 트랜잭션 추적을 안내합니다.","keywords":["Node.js","트랜잭션","멀티 트랜잭션","UI","애플리케이션","애플리케이션 모니터링"],"isTranslationMissing":false},"sidebar":"nodejsSidebar","previous":{"title":"트랜잭션 트레이싱","permalink":"/nodejs/trs-profile"},"next":{"title":"트랜잭션 엔드포인트 설정","permalink":"/nodejs/trs-endpoint-setting"}}')
...
;// CONCATENATED MODULE: ./docs/nodejs/trs-multi-trace.mdx
