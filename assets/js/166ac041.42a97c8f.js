"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["75426"], {
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_mysql_flexboard_widget_template_mdx_166_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-mysql-flexboard-widget-template-mdx-166.json
var site_docs_mysql_flexboard_widget_template_mdx_166_namespaceObject = JSON.parse('{"id":"mysql/flexboard-widget-template","title":"위젯 템플릿","description":"Flex 보드에서 대시보드에 배치할 수 있는 위젯의 종류를 안내합니다.","source":"@site/docs/mysql/flexboard-widget-template.mdx","sourceDirName":"mysql","slug":"/mysql/flexboard-widget-template","permalink":"/mysql/flexboard-widget-template","draft":false,"unlisted":false,"editUrl":"undefined/docs/mysql/flexboard-widget-template.mdx","tags":[],"version":"current","frontMatter":{"id":"flexboard-widget-template","title":"위젯 템플릿","description":"Flex 보드에서 대시보드에 배치할 수 있는 위젯의 종류를 안내합니다.","keywords":["Flex 보드","위젯","템플릿"],"isTranslationMissing":false},"sidebar":"mysqlSidebar","previous":{"title":"위젯 관리하기","permalink":"/mysql/flexboard-widget-manage"},"next":{"title":"Flex 보드 화면 모드","permalink":"/mysql/flexboard-mode"}}')
...
;// CONCATENATED MODULE: ./docs/mysql/flexboard-widget-template.mdx
