"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["98289"], {
...
"44381": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_postgresql_log_db_mdx_960_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-postgresql-log-db-mdx-960.json
var site_docs_postgresql_log_db_mdx_960_namespaceObject = JSON.parse('{"id":"postgresql/log-db","title":"적용하기","description":"데이터베이스와 AWS RDS의 로그를 수집하는 방법을 안내합니다.","source":"@site/docs/postgresql/log-db.mdx","sourceDirName":"postgresql","slug":"/postgresql/log-db","permalink":"/postgresql/log-db","draft":false,"unlisted":false,"editUrl":"undefined/docs/postgresql/log-db.mdx","tags":[],"version":"current","frontMatter":{"id":"log-db","title":"적용하기","description":"데이터베이스와 AWS RDS의 로그를 수집하는 방법을 안내합니다.","keywords":["로그 모니터링","데이터베이스","PostgreSQL"],"isTranslationMissing":false},"sidebar":"postgreSidebar","previous":{"title":"로그","permalink":"/postgresql/log-main"},"next":{"title":"라이브 테일","permalink":"/postgresql/log-lt"}}')
...
;// CONCATENATED MODULE: ./docs/postgresql/log-db.mdx
