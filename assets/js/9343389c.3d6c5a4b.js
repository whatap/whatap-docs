"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["44818"], {
...
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_amazon_ecs_set_event_history_mdx_934_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-amazon-ecs-set-event-history-mdx-934.json
var site_docs_amazon_ecs_set_event_history_mdx_934_namespaceObject = JSON.parse('{"id":"amazon-ecs/set-event-history","title":"이벤트 기록","description":"이벤트 기록 메뉴를 통해 발생한 경고 알림 이력을 확인할 수 있습니다.","source":"@site/docs/amazon-ecs/set-event-history.mdx","sourceDirName":"amazon-ecs","slug":"/amazon-ecs/set-event-history","permalink":"/amazon-ecs/set-event-history","draft":false,"unlisted":false,"editUrl":"undefined/docs/amazon-ecs/set-event-history.mdx","tags":[],"version":"current","frontMatter":{"id":"set-event-history","title":"이벤트 기록","description":"이벤트 기록 메뉴를 통해 발생한 경고 알림 이력을 확인할 수 있습니다.","keywords":["Amazon ECS","경고 알림","이벤트 기록"],"isTranslationMissing":false},"sidebar":"awsecsSidebar","previous":{"title":"이벤트 수신 설정","permalink":"/amazon-ecs/set-receive-event"},"next":{"title":"실시간 알림","permalink":"/amazon-ecs/real-time-notification"}}')
...
;// CONCATENATED MODULE: ./docs/amazon-ecs/set-event-history.mdx
