"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["35826"], {
...
"10640": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_postgresql_metrics_chart_v_2_mdx_054_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-postgresql-metrics-chart-v-2-mdx-054.json
var site_docs_postgresql_metrics_chart_v_2_mdx_054_namespaceObject = JSON.parse('{"id":"postgresql/metrics-chart-v2","title":"메트릭스 차트","description":"메트릭스 데이터를 차트로 조회할 수 있습니다.","source":"@site/docs/postgresql/metrics-chart-v2.mdx","sourceDirName":"postgresql","slug":"/postgresql/metrics-chart-v2","permalink":"/postgresql/metrics-chart-v2","draft":false,"unlisted":false,"editUrl":"undefined/docs/postgresql/metrics-chart-v2.mdx","tags":[],"version":"current","frontMatter":{"id":"metrics-chart-v2","title":"메트릭스 차트","description":"메트릭스 데이터를 차트로 조회할 수 있습니다.","keywords":["PostgreSQL","데이터베이스","메트릭스","메트릭스 차트"],"isTranslationMissing":false},"sidebar":"postgreSidebar","previous":{"title":"PostgreSQL 지표","permalink":"/postgresql/metrics-data-list"},"next":{"title":"메트릭스 차트","permalink":"/postgresql/metrics-chart"}}')
...
;// CONCATENATED MODULE: ./docs/postgresql/metrics-chart-v2.mdx
