"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[22483],{
...
const metadata = {
  "id": "oracle-v2/metric-warning-notice",
  "title": "메트릭스 경고 알림",
  "description": "구체적이고 복잡한 이벤트를 설정하려면 메트릭스 이벤트 설정을 사용하세요.",
  "source": "@site/docs/oracle-v2/metric-warning-notice.mdx",
  "sourceDirName": "oracle-v2",
  "slug": "/oracle-v2/metric-warning-notice",
  "permalink": "/whatap-docs/oracle-v2/metric-warning-notice",
  "draft": false,
  "unlisted": false,
  "editUrl": "undefined/docs/oracle-v2/metric-warning-notice.mdx",
  "tags": [
    {
      "inline": true,
      "label": "Oracle",
