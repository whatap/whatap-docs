"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["92838"], {
...
"66085": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_nodejs_topology_add_function_mdx_33d_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-nodejs-topology-add-function-mdx-33d.json
var site_docs_nodejs_topology_add_function_mdx_33d_namespaceObject = JSON.parse('{"id":"nodejs/topology-add-function","title":"부가 기능","description":"토폴로지 메뉴에서 이용할 수 있는 부가 기능에 대한 설명을 제공합니다.","source":"@site/docs/nodejs/topology-add-function.mdx","sourceDirName":"nodejs","slug":"/nodejs/topology-add-function","permalink":"/nodejs/topology-add-function","draft":false,"unlisted":false,"editUrl":"undefined/docs/nodejs/topology-add-function.mdx","tags":[],"version":"current","frontMatter":{"id":"topology-add-function","title":"부가 기능","description":"토폴로지 메뉴에서 이용할 수 있는 부가 기능에 대한 설명을 제공합니다.","keywords":["Node.js","토폴로지"],"isTranslationMissing":false},"sidebar":"nodejsSidebar","previous":{"title":"유형별 토폴로지","permalink":"/nodejs/topology-type"},"next":{"title":"에이전트 옵션 설정","permalink":"/nodejs/topology-settings"}}')
...
;// CONCATENATED MODULE: ./docs/nodejs/topology-add-function.mdx
