"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["16999"], {
...
"13850": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_postgresql_labs_mdx_1ee_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-postgresql-labs-mdx-1ee.json
var site_docs_postgresql_labs_mdx_1ee_namespaceObject = JSON.parse('{"id":"postgresql/labs","title":"실험실","description":"사용자에게 새로운 기능 또는 실험적인 기능을 제공하는 메뉴인 실험실에 대해 안내합니다.","source":"@site/docs/postgresql/labs.mdx","sourceDirName":"postgresql","slug":"/postgresql/labs","permalink":"/postgresql/labs","draft":false,"unlisted":false,"editUrl":"undefined/docs/postgresql/labs.mdx","tags":[],"version":"current","frontMatter":{"id":"labs","title":"실험실","description":"사용자에게 새로운 기능 또는 실험적인 기능을 제공하는 메뉴인 실험실에 대해 안내합니다.","keywords":["PostgreSQL","데이터베이스","실험실"],"isTranslationMissing":false},"sidebar":"postgreSidebar","previous":{"title":"연계 프로젝트 관리","permalink":"/postgresql/linked-projects"}}')
...
;// CONCATENATED MODULE: ./docs/postgresql/labs.mdx
