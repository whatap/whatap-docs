"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["52061"], {
"75492": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_altibase_v_1_monitoring_support_mdx_e4e_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-altibase-v-1-monitoring-support-mdx-e4e.json
var site_docs_altibase_v_1_monitoring_support_mdx_e4e_namespaceObject = JSON.parse('{"id":"altibase-v1/monitoring-support","title":"지원 환경","description":"데이터베이스 모니터링을 시작하기 전에 지원하는 데이터베이스 종류에 대해서 알아보세요.","source":"@site/docs/altibase-v1/monitoring-support.mdx","sourceDirName":"altibase-v1","slug":"/altibase-v1/monitoring-support","permalink":"/altibase-v1/monitoring-support","draft":false,"unlisted":false,"editUrl":"undefined/docs/altibase-v1/monitoring-support.mdx","tags":[],"version":"current","frontMatter":{"id":"monitoring-support","title":"지원 환경","description":"데이터베이스 모니터링을 시작하기 전에 지원하는 데이터베이스 종류에 대해서 알아보세요.","keywords":["Altibase","데이터베이스","데이터베이스 모니터링"],"isTranslationMissing":false},"sidebar":"altibasev1Sidebar","previous":{"title":"Altibase V1 모니터링","permalink":"/altibase-v1/monitoring-intro"},"next":{"title":"에이전트 설치","permalink":"/altibase-v1/install-agent"}}')
