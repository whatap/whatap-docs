"use strict";
(self["webpackChunkwhatap_origin"] = self["webpackChunkwhatap_origin"] || []).push([[48727],{
...
const metadata = {
    "unversionedId": "mysql-v1/flexboard-widget-manage",
    "id": "mysql-v1/flexboard-widget-manage",
    "title": "위젯 관리하기",
    "description": "Flex 보드에 배치한 위젯을 관리해 보세요.",
    "source": "@site/docs/mysql-v1/flexboard-widget-manage.mdx",
    "sourceDirName": "mysql-v1",
    "slug": "/mysql-v1/flexboard-widget-manage",
    "permalink": "/whatap-docs/mysql-v1/flexboard-widget-manage",
    "draft": false,
    "editUrl": "undefined/docs/mysql-v1/flexboard-widget-manage.mdx",
    "tags": [
        {
            "label": "MySQL",
    ...
    "previous": {
        "title": "메트릭스 위젯",
        "permalink": "/whatap-docs/mysql-v1/flexboard-metric-widget"
    },
    "next": {
        "title": "Flex 보드 화면 모드",
