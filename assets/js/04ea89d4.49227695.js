"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["61916"], {
...
"49955": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_mssql_multi_instance_monitoring_mdx_04e_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-mssql-multi-instance-monitoring-mdx-04e.json
var site_docs_mssql_multi_instance_monitoring_mdx_04e_namespaceObject = JSON.parse('{"id":"mssql/multi-instance-monitoring","title":"멀티 인스턴스 모니터링","description":"다수의 데이터베이스 인스턴스 핵심 지표를 통합해 확인할 수 있는 기능을 제공합니다.","source":"@site/docs/mssql/multi-instance-monitoring.mdx","sourceDirName":"mssql","slug":"/mssql/multi-instance-monitoring","permalink":"/mssql/multi-instance-monitoring","draft":false,"unlisted":false,"editUrl":"undefined/docs/mssql/multi-instance-monitoring.mdx","tags":[],"version":"current","frontMatter":{"id":"multi-instance-monitoring","title":"멀티 인스턴스 모니터링","description":"다수의 데이터베이스 인스턴스 핵심 지표를 통합해 확인할 수 있는 기능을 제공합니다.","keywords":["SQL Server","인스턴스","대시보드","데이터베이스","멀티 인스턴스 모니터링"],"isTranslationMissing":false},"sidebar":"mssqlSidebar","previous":{"title":"인스턴스 모니터링","permalink":"/mssql/instance-monitoring"},"next":{"title":"Flex 보드","permalink":"/mssql/flex-board"}}')
...
;// CONCATENATED MODULE: ./docs/mssql/multi-instance-monitoring.mdx
