"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["69255"], {
...
"71639": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_kubernetes_real_time_notification_mdx_610_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-kubernetes-real-time-notification-mdx-610.json
var site_docs_kubernetes_real_time_notification_mdx_610_namespaceObject = JSON.parse('{"id":"kubernetes/real-time-notification","title":"실시간 알림","description":"이벤트 설정 메뉴를 통해서 설정한 경고 알림을 실시간으로 확인할 수 있습니다.","source":"@site/docs/kubernetes/real-time-notification.mdx","sourceDirName":"kubernetes","slug":"/kubernetes/real-time-notification","permalink":"/kubernetes/real-time-notification","draft":false,"unlisted":false,"editUrl":"undefined/docs/kubernetes/real-time-notification.mdx","tags":[],"version":"current","frontMatter":{"id":"real-time-notification","title":"실시간 알림","description":"이벤트 설정 메뉴를 통해서 설정한 경고 알림을 실시간으로 확인할 수 있습니다.","keywords":["실시간 알림"],"isTranslationMissing":false},"sidebar":"kubeSidebar","previous":{"title":"이벤트 기록","permalink":"/kubernetes/set-event-history"},"next":{"title":"시스템 이벤트 안내","permalink":"/kubernetes/common-alert"}}')
...
;// CONCATENATED MODULE: ./docs/kubernetes/real-time-notification.mdx
