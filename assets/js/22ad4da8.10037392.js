"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["46816"], {
"22224": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_amazon_ecs_flexboard_mode_mdx_22a_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-amazon-ecs-flexboard-mode-mdx-22a.json
var site_docs_amazon_ecs_flexboard_mode_mdx_22a_namespaceObject = JSON.parse('{"id":"amazon-ecs/flexboard-mode","title":"Flex 보드 화면 모드","description":"Flex 보드의 화면 모드에 따라 제공하는 기능에 대해 알아보세요.","source":"@site/docs/amazon-ecs/flexboard-mode.mdx","sourceDirName":"amazon-ecs","slug":"/amazon-ecs/flexboard-mode","permalink":"/amazon-ecs/flexboard-mode","draft":false,"unlisted":false,"editUrl":"undefined/docs/amazon-ecs/flexboard-mode.mdx","tags":[],"version":"current","frontMatter":{"id":"flexboard-mode","title":"Flex 보드 화면 모드","description":"Flex 보드의 화면 모드에 따라 제공하는 기능에 대해 알아보세요.","keywords":["Amazon ECS","Flex 보드"],"isTranslationMissing":false},"sidebar":"awsecsSidebar","previous":{"title":"위젯 템플릿","permalink":"/amazon-ecs/flexboard-widget-template"},"next":{"title":"Flex 보드 공유하기","permalink":"/amazon-ecs/flexboard-share"}}')
...
;// CONCATENATED MODULE: ./docs/amazon-ecs/flexboard-mode.mdx
