"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["90792"], {
...
"76755": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_oracle_cloud_metric_warning_notice_mdx_9de_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-oracle-cloud-metric-warning-notice-mdx-9de.json
var site_docs_oracle_cloud_metric_warning_notice_mdx_9de_namespaceObject = JSON.parse('{"id":"oracle-cloud/metric-warning-notice","title":"메트릭스 경고 알림","description":"구체적이고 복잡한 이벤트를 설정하려면 메트릭스 이벤트 설정을 사용하세요.","source":"@site/docs/oracle-cloud/metric-warning-notice.mdx","sourceDirName":"oracle-cloud","slug":"/oracle-cloud/metric-warning-notice","permalink":"/oracle-cloud/metric-warning-notice","draft":false,"unlisted":false,"editUrl":"undefined/docs/oracle-cloud/metric-warning-notice.mdx","tags":[],"version":"current","frontMatter":{"id":"metric-warning-notice","title":"메트릭스 경고 알림","description":"구체적이고 복잡한 이벤트를 설정하려면 메트릭스 이벤트 설정을 사용하세요.","keywords":["경고 알림","메트릭스 이벤트","Oracle Cloud Monitor","클라우드"],"isTranslationMissing":false},"sidebar":"oracleSidebar","previous":{"title":"알림 설정하기","permalink":"/oracle-cloud/set-notice"},"next":{"title":"이벤트 수신 설정","permalink":"/oracle-cloud/set-receive-event"}}')
...
;// CONCATENATED MODULE: ./docs/oracle-cloud/metric-warning-notice.mdx
