"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["6438"], {
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_mssql_v_1_dashboard_intro_mdx_b82_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-mssql-v-1-dashboard-intro-mdx-b82.json
var site_docs_mssql_v_1_dashboard_intro_mdx_b82_namespaceObject = JSON.parse('{"id":"mssql-v1/dashboard-intro","title":"대시보드","description":"와탭 모니터링 대시보드는 프로젝트의 전체 현황을 한 눈에 파악하기 위한 기능을 제공합니다.","source":"@site/docs/mssql-v1/dashboard-intro.mdx","sourceDirName":"mssql-v1","slug":"/mssql-v1/dashboard-intro","permalink":"/mssql-v1/dashboard-intro","draft":false,"unlisted":false,"editUrl":"undefined/docs/mssql-v1/dashboard-intro.mdx","tags":[],"version":"current","frontMatter":{"id":"dashboard-intro","title":"대시보드","description":"와탭 모니터링 대시보드는 프로젝트의 전체 현황을 한 눈에 파악하기 위한 기능을 제공합니다.","keywords":["SQL Server","대시보드","데이터베이스"],"isTranslationMissing":false},"sidebar":"mssqlV1Sidebar","previous":{"title":"관리하기","permalink":"/mssql-v1/agent-manage"},"next":{"title":"인스턴스 목록","permalink":"/mssql-v1/instance-list"}}')
...
;// CONCATENATED MODULE: ./docs/mssql-v1/dashboard-intro.mdx
