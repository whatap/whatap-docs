"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["45061"], {
"42083": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_altibase_stat_mdx_4de_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-altibase-stat-mdx-4de.json
var site_docs_altibase_stat_mdx_4de_namespaceObject = JSON.parse('{"id":"altibase/stat","title":"통계","description":"데이터베이스별 통계 데이터를 제공합니다.","source":"@site/docs/altibase/stat.mdx","sourceDirName":"altibase","slug":"/altibase/stat","permalink":"/altibase/stat","draft":false,"unlisted":false,"editUrl":"undefined/docs/altibase/stat.mdx","tags":[],"version":"current","frontMatter":{"id":"stat","title":"통계","description":"데이터베이스별 통계 데이터를 제공합니다.","keywords":["Altibase","데이터베이스","통계"],"isTranslationMissing":false},"sidebar":"altibaseSidebar","previous":{"title":"메트릭스 이상 탐지","permalink":"/altibase/metrics-detect-anormal"},"next":{"title":"테이블스페이스 사이즈","permalink":"/altibase/table-space-size"}}')
...
;// CONCATENATED MODULE: ./docs/altibase/stat.mdx
