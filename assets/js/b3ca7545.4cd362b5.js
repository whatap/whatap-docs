"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["58737"], {
"80359": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_altibase_v_1_agent_network_mdx_b3c_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-altibase-v-1-agent-network-mdx-b3c.json
var site_docs_altibase_v_1_agent_network_mdx_b3c_namespaceObject = JSON.parse('{"id":"altibase-v1/agent-network","title":"에이전트 네트워크 통신","description":"데이터베이스 에이전트의 네트워크 통신에 관한 설정입니다.","source":"@site/docs/altibase-v1/agent-network.mdx","sourceDirName":"altibase-v1","slug":"/altibase-v1/agent-network","permalink":"/altibase-v1/agent-network","draft":false,"unlisted":false,"editUrl":"undefined/docs/altibase-v1/agent-network.mdx","tags":[],"version":"current","frontMatter":{"id":"agent-network","title":"에이전트 네트워크 통신","description":"데이터베이스 에이전트의 네트워크 통신에 관한 설정입니다.","keywords":["Altibase","데이터베이스","데이터베이스 모니터링","에이전트","네트워크","통신"],"isTranslationMissing":false},"sidebar":"altibasev1Sidebar","previous":{"title":"설정하기","permalink":"/altibase-v1/agent-settings"},"next":{"title":"에이전트 이름 식별","permalink":"/altibase-v1/agent-naming"}}')
