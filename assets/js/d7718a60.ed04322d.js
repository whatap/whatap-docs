"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["20200"], {
...
"95589": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_ncloud_metrics_chart_mdx_d77_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-ncloud-metrics-chart-mdx-d77.json
var site_docs_ncloud_metrics_chart_mdx_d77_namespaceObject = JSON.parse('{"id":"ncloud/metrics-chart","title":"메트릭스 차트","description":"메트릭스 데이터를 차트로 조회할 수 있습니다.","source":"@site/docs/ncloud/metrics-chart.mdx","sourceDirName":"ncloud","slug":"/ncloud/metrics-chart","permalink":"/ncloud/metrics-chart","draft":false,"unlisted":false,"editUrl":"undefined/docs/ncloud/metrics-chart.mdx","tags":[],"version":"current","frontMatter":{"id":"metrics-chart","title":"메트릭스 차트","description":"메트릭스 데이터를 차트로 조회할 수 있습니다.","keywords":["Naver Cloud Monitoring","클라우드","메트릭스","메트릭스 차트","UI"],"isTranslationMissing":false},"sidebar":"ncloudSidebar","previous":{"title":"메트릭스 큐브","permalink":"/ncloud/metrics-cube"},"next":{"title":"메트릭스 이상 탐지","permalink":"/ncloud/metrics-detect-anormal"}}')
...
;// CONCATENATED MODULE: ./docs/ncloud/metrics-chart.mdx
