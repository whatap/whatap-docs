"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["16305"], {
"44444": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_azure_flexboard_widget_manage_mdx_dae_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-azure-flexboard-widget-manage-mdx-dae.json
var site_docs_azure_flexboard_widget_manage_mdx_dae_namespaceObject = JSON.parse('{"id":"azure/flexboard-widget-manage","title":"위젯 관리하기","description":"Flex 보드에 배치한 위젯의 추가, 속성 변경, 복사, 삭제 방법을 안내합니다. 사용자는 위젯을 추가하거나 기존 위젯의 속성을 조정하여 대시보드를 개인화할 수 있습니다. 위젯의 데이터 조회 조건 변경, 시간 설정, 데이터 병합 옵션 설정 등 세밀한 관리 기능을 통해 사용자의 모니터링 요구에 맞는 대시보드를 구성할 수 있습니다.","source":"@site/docs/azure/flexboard-widget-manage.mdx","sourceDirName":"azure","slug":"/azure/flexboard-widget-manage","permalink":"/azure/flexboard-widget-manage","draft":false,"unlisted":false,"editUrl":"undefined/docs/azure/flexboard-widget-manage.mdx","tags":[],"version":"current","frontMatter":{"id":"flexboard-widget-manage","title":"위젯 관리하기","description":"Flex 보드에 배치한 위젯의 추가, 속성 변경, 복사, 삭제 방법을 안내합니다. 사용자는 위젯을 추가하거나 기존 위젯의 속성을 조정하여 대시보드를 개인화할 수 있습니다. 위젯의 데이터 조회 조건 변경, 시간 설정, 데이터 병합 옵션 설정 등 세밀한 관리 기능을 통해 사용자의 모니터링 요구에 맞는 대시보드를 구성할 수 있습니다.","keywords":["Flex 보드","위젯","메트릭스","Azure Monitor","클라우드"],"isTranslationMissing":false},"sidebar":"azuremonitorSidebar","previous":{"title":"메트릭스 위젯","permalink":"/azure/flexboard-metric-widget"},"next":{"title":"위젯 템플릿","permalink":"/azure/flexboard-widget-template"}}')
...
;// CONCATENATED MODULE: ./docs/azure/flexboard-widget-manage.mdx
