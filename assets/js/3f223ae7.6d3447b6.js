"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["68030"], {
...
"15575": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_mysql_table_size_mdx_3f2_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-mysql-table-size-mdx-3f2.json
var site_docs_mysql_table_size_mdx_3f2_namespaceObject = JSON.parse('{"id":"mysql/table-size","title":"테이블 사이즈 증감","description":"테이블 및 인덱스의 사용량을 일별 수집해 기간에 따른 전체 및 테이블별 사용량 증감 정보를 제공합니다.","source":"@site/docs/mysql/table-size.mdx","sourceDirName":"mysql","slug":"/mysql/table-size","permalink":"/mysql/table-size","draft":false,"unlisted":false,"editUrl":"undefined/docs/mysql/table-size.mdx","tags":[],"version":"current","frontMatter":{"id":"table-size","title":"테이블 사이즈 증감","description":"테이블 및 인덱스의 사용량을 일별 수집해 기간에 따른 전체 및 테이블별 사용량 증감 정보를 제공합니다.","keywords":["MySQL","데이터베이스","통계","테이블 사이즈 증감"],"isTranslationMissing":false},"sidebar":"mysqlSidebar","previous":{"title":"MYSQL SQL 통계","permalink":"/mysql/mysql-sql-stat"},"next":{"title":"데이터베이스 사이즈","permalink":"/mysql/database-size"}}')
...
;// CONCATENATED MODULE: ./docs/mysql/table-size.mdx
