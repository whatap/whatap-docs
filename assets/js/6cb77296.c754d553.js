"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["40989"], {
...
"80549": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_npm_real_time_notification_mdx_6cb_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-npm-real-time-notification-mdx-6cb.json
var site_docs_npm_real_time_notification_mdx_6cb_namespaceObject = JSON.parse('{"id":"npm/real-time-notification","title":"실시간 알림","description":"이벤트 설정 메뉴를 통해서 설정한 경고 알림을 실시간으로 확인할 수 있습니다.","source":"@site/docs/npm/real-time-notification.mdx","sourceDirName":"npm","slug":"/npm/real-time-notification","permalink":"/npm/real-time-notification","draft":false,"unlisted":false,"editUrl":"undefined/docs/npm/real-time-notification.mdx","tags":[],"version":"current","frontMatter":{"id":"real-time-notification","title":"실시간 알림","description":"이벤트 설정 메뉴를 통해서 설정한 경고 알림을 실시간으로 확인할 수 있습니다.","keywords":["실시간 알림"],"isTranslationMissing":false},"sidebar":"npmsidebar","previous":{"title":"이벤트 기록","permalink":"/npm/set-event-history"},"next":{"title":"시스템 이벤트 안내","permalink":"/npm/common-alert"}}')
...
;// CONCATENATED MODULE: ./docs/npm/real-time-notification.mdx
