...
"46293": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_oracle_v_1_set_event_history_mdx_1e5_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-oracle-v-1-set-event-history-mdx-1e5.json
var site_docs_oracle_v_1_set_event_history_mdx_1e5_namespaceObject = JSON.parse('{"id":"oracle-v1/set-event-history","title":"이벤트 기록","description":"이벤트 기록 메뉴를 통해 발생한 경고 알림 이력을 확인할 수 있습니다.","source":"@site/docs/oracle-v1/set-event-history.mdx","sourceDirName":"oracle-v1","slug":"/oracle-v1/set-event-history","permalink":"/oracle-v1/set-event-history","draft":false,"unlisted":false,"editUrl":"undefined/docs/oracle-v1/set-event-history.mdx","tags":[],"version":"current","frontMatter":{"id":"set-event-history","title":"이벤트 기록","description":"이벤트 기록 메뉴를 통해 발생한 경고 알림 이력을 확인할 수 있습니다.","keywords":["Oracle","경고 알림","이벤트 기록","데이터베이스 모니터링"],"isTranslationMissing":false},"sidebar":"dboracleSidebar","previous":{"title":"이벤트 수신 설정","permalink":"/oracle-v1/set-receive-event"},"next":{"title":"이벤트 수신 포맷","permalink":"/oracle-v1/set-event-format"}}')
...
;// CONCATENATED MODULE: ./docs/oracle-v1/set-event-history.mdx
