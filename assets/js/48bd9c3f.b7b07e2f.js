"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["31533"], {
"70349": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_altibase_metrics_data_list_mdx_48b_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-altibase-metrics-data-list-mdx-48b.json
var site_docs_altibase_metrics_data_list_mdx_48b_namespaceObject = JSON.parse('{"id":"altibase/metrics-data-list","title":"Altibase 지표","description":"Altibase 지표를 안내합니다.","source":"@site/docs/altibase/metrics-data-list.mdx","sourceDirName":"altibase","slug":"/altibase/metrics-data-list","permalink":"/altibase/metrics-data-list","draft":false,"unlisted":false,"editUrl":"undefined/docs/altibase/metrics-data-list.mdx","tags":[],"version":"current","frontMatter":{"id":"metrics-data-list","title":"Altibase 지표","description":"Altibase 지표를 안내합니다.","keywords":["Altibase","메트릭스","데이터베이스","데이터베이스"],"isTranslationMissing":false},"sidebar":"altibaseSidebar","previous":{"title":"메트릭스","permalink":"/altibase/metrics-intro"},"next":{"title":"메트릭스 차트","permalink":"/altibase/metrics-chart-v2"}}')
...
;// CONCATENATED MODULE: ./docs/altibase/metrics-data-list.mdx
