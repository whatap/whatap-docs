"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["68193"], {
...
"84620": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_redis_instance_list_mdx_62f_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-redis-instance-list-mdx-62f.json
var site_docs_redis_instance_list_mdx_62f_namespaceObject = JSON.parse('{"id":"redis/instance-list","title":"인스턴스 목록","description":"에이전트를 설치한 Redis 데이터베이스 서버들의 목록을 확인할 수 있습니다.","source":"@site/docs/redis/instance-list.mdx","sourceDirName":"redis","slug":"/redis/instance-list","permalink":"/redis/instance-list","draft":false,"unlisted":false,"editUrl":"undefined/docs/redis/instance-list.mdx","tags":[],"version":"current","frontMatter":{"id":"instance-list","title":"인스턴스 목록","description":"에이전트를 설치한 Redis 데이터베이스 서버들의 목록을 확인할 수 있습니다.","keywords":["Redis","인스턴스","대시보드","데이터베이스"],"isTranslationMissing":false},"sidebar":"redisSidebar","previous":{"title":"대시보드","permalink":"/redis/dashboard-intro"},"next":{"title":"인스턴스 모니터링","permalink":"/redis/instance-monitoring"}}')
...
;// CONCATENATED MODULE: ./docs/redis/instance-list.mdx
