"use strict";
(self["webpackChunkwhatap_origin"] = self["webpackChunkwhatap_origin"] || []).push([[30143],{
...
const metadata = {
    "unversionedId": "kubernetes/metrics-chart",
    "id": "kubernetes/metrics-chart",
    "title": "메트릭스 차트",
    "description": "메트릭스 데이터를 차트로 조회할 수 있습니다.",
    "source": "@site/docs/kubernetes/metrics-chart.mdx",
    "sourceDirName": "kubernetes",
    "slug": "/kubernetes/metrics-chart",
    "permalink": "/kubernetes/metrics-chart",
    "draft": false,
    "editUrl": "undefined/docs/kubernetes/metrics-chart.mdx",
    "tags": [
        {
            "label": "메트릭스",
            "permalink": "/tags/메트릭스"
    ...
    "next": {
        "title": "메트릭스 이상 탐지",
        "permalink": "/kubernetes/metrics-detect-anormal"
    }
};
const assets = {};
const toc = [
