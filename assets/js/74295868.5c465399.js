"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["6543"], {
...
"15112": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_oracle_labs_mdx_742_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-oracle-labs-mdx-742.json
var site_docs_oracle_labs_mdx_742_namespaceObject = JSON.parse('{"id":"oracle/labs","title":"실험실","description":"사용자에게 새로운 기능 또는 실험적인 기능을 제공하는 메뉴인 실험실에 대해 안내합니다.","source":"@site/docs/oracle/labs.mdx","sourceDirName":"oracle","slug":"/oracle/labs","permalink":"/oracle/labs","draft":false,"unlisted":false,"editUrl":"undefined/docs/oracle/labs.mdx","tags":[],"version":"current","frontMatter":{"id":"labs","title":"실험실","description":"사용자에게 새로운 기능 또는 실험적인 기능을 제공하는 메뉴인 실험실에 대해 안내합니다.","keywords":["Oracle","데이터베이스","실험실"],"isTranslationMissing":false},"sidebar":"dboracleV2Sidebar","previous":{"title":"연계 프로젝트 관리","permalink":"/oracle/linked-projects"}}')
...
;// CONCATENATED MODULE: ./docs/oracle/labs.mdx
