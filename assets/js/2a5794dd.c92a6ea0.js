...
// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_oracle_pro_log_exp_mdx_2a5_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-oracle-pro-log-exp-mdx-2a5.json
var site_docs_oracle_pro_log_exp_mdx_2a5_namespaceObject = JSON.parse('{"id":"oracle-pro/log-exp","title":"로그 트렌드","description":"로그 모니터링의 로그 트렌드 메뉴를 안내합니다.","source":"@site/docs/oracle-pro/log-exp.mdx","sourceDirName":"oracle-pro","slug":"/oracle-pro/log-exp","permalink":"/oracle-pro/log-exp","draft":false,"unlisted":false,"editUrl":"undefined/docs/oracle-pro/log-exp.mdx","tags":[],"version":"current","frontMatter":{"id":"log-exp","title":"로그 트렌드","description":"로그 모니터링의 로그 트렌드 메뉴를 안내합니다.","keywords":["로그 모니터링","로그 트렌드","UI","Oracle Pro"],"isTranslationMissing":false},"sidebar":"dboracledmaSidebar","previous":{"title":"라이브 테일","permalink":"/oracle-pro/log-lt"},"next":{"title":"로그 검색","permalink":"/oracle-pro/log-search"}}')
// EXTERNAL MODULE: ./node_modules/react/jsx-runtime.js
var jsx_runtime = __webpack_require__("85893");
// EXTERNAL MODULE: ./node_modules/@mdx-js/react/lib/index.js
var lib = __webpack_require__("50065");
...
;// CONCATENATED MODULE: ./docs/oracle-pro/log-exp.mdx
