"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["59641"], {
"40077": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_aws_log_set_notice_mdx_4d7_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-aws-log-set-notice-mdx-4d7.json
var site_docs_aws_log_set_notice_mdx_4d7_namespaceObject = JSON.parse('{"id":"aws-log/set-notice","title":"알림 설정하기","description":"로그 이벤트 알림 메뉴를 안내합니다.","source":"@site/docs/aws-log/set-notice.mdx","sourceDirName":"aws-log","slug":"/aws-log/set-notice","permalink":"/aws-log/set-notice","draft":false,"unlisted":false,"editUrl":"undefined/docs/aws-log/set-notice.mdx","tags":[],"version":"current","frontMatter":{"id":"set-notice","title":"알림 설정하기","description":"로그 이벤트 알림 메뉴를 안내합니다.","keywords":["AWS Log","알림","UI"],"isTranslationMissing":false},"sidebar":"awslogSidebar","previous":{"title":"Flex 보드 공유하기","permalink":"/aws-log/flexboard-share"},"next":{"title":"이벤트 수신 설정","permalink":"/aws-log/set-receive-event"}}')
...
;// CONCATENATED MODULE: ./docs/aws-log/set-notice.mdx
...
const toc = [..._log_set_notice/* toc */.d$];
function _createMdxContent(props) {
  return (0,jsx_runtime.jsx)(_log_set_notice/* default */.ZP, {});
}
