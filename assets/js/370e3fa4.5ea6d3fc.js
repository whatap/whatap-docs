"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["27498"], {
...
"29219": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_java_install_agent_mdx_370_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-java-install-agent-mdx-370.json
var site_docs_java_install_agent_mdx_370_namespaceObject = JSON.parse('{"id":"java/install-agent","title":"에이전트 설치","description":"와탭의 자바(Java) 애플리케이션 모니터링 에이전트를 설치하는 데 필요한 모든 단계를 자세하게 설명합니다. 이 문서에서는 에이전트 다운로드 및 설치, 구성 파일, 에이전트 기본 설정 방법을 안내합니다.","source":"@site/docs/java/install-agent.mdx","sourceDirName":"java","slug":"/java/install-agent","permalink":"/java/install-agent","draft":false,"unlisted":false,"editUrl":"undefined/docs/java/install-agent.mdx","tags":[],"version":"current","frontMatter":{"id":"install-agent","title":"에이전트 설치","description":"와탭의 자바(Java) 애플리케이션 모니터링 에이전트를 설치하는 데 필요한 모든 단계를 자세하게 설명합니다. 이 문서에서는 에이전트 다운로드 및 설치, 구성 파일, 에이전트 기본 설정 방법을 안내합니다.","keywords":["Java","에이전트","애플리케이션"],"isTranslationMissing":false},"sidebar":"javaSidebar","previous":{"title":"지원 환경","permalink":"/java/supported-spec"},"next":{"title":"Tomcat","permalink":"/java/add-jvm-opt/tomcat"}}')
...
const _whatap_conf_frontMatter = (/* unused pure expression or super */ null && ({}));
...
const install_agent_toc = [..._agent_signup_guide/* toc */.d$, ..._create_project_v2/* toc */.d$, ..._accesskey_v2/* toc */.d$, ...toc, {
  "value": "에이전트 설치 파일 구성",
  "id": "agent-files",
  "level": 3
}, ..._whatap_conf_toc, {
