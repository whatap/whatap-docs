"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[60262],{
...
const metadata = {
  "id": "cubrid/database-size",
  "title": "데이터베이스 사이즈",
  "description": "각 데이터베이스별 최대 용량과 사용량을 시간의 흐름에 따라 조회할 수 있습니다.",
  "source": "@site/docs/cubrid/database-size.mdx",
  "sourceDirName": "cubrid",
  "slug": "/cubrid/database-size",
  "permalink": "/whatap-docs/cubrid/database-size",
  "draft": false,
  "unlisted": false,
  "editUrl": "undefined/docs/cubrid/database-size.mdx",
  "tags": [],
  "version": "current",
  "frontMatter": {
    "id": "database-size",
