"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["66947"], {
...
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_php_collect_stacks_mdx_875_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-php-collect-stacks-mdx-875.json
var site_docs_php_collect_stacks_mdx_875_namespaceObject = JSON.parse('{"id":"php/collect-stacks","title":"트랜잭션 스텝 수집 방식","description":"트랜잭션 스텝 수집 방식을 안내합니다.","source":"@site/docs/php/collect-stacks.mdx","sourceDirName":"php","slug":"/php/collect-stacks","permalink":"/php/collect-stacks","draft":false,"unlisted":false,"editUrl":"undefined/docs/php/collect-stacks.mdx","tags":[],"version":"current","frontMatter":{"id":"collect-stacks","title":"트랜잭션 스텝 수집 방식","description":"트랜잭션 스텝 수집 방식을 안내합니다.","keywords":["PHP","트랜잭션"],"isTranslationMissing":false},"sidebar":"phpSidebar","previous":{"title":"멀티 트랜잭션","permalink":"/php/trs-multi-trace"},"next":{"title":"토폴로지","permalink":"/php/topology"}}')
