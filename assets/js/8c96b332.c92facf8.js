"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["2037"], {
...
"61350": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_python_dashboard_intro_mdx_8c9_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-python-dashboard-intro-mdx-8c9.json
var site_docs_python_dashboard_intro_mdx_8c9_namespaceObject = JSON.parse('{"id":"python/dashboard-intro","title":"대시보드","description":"와탭 모니터링 대시보드는 프로젝트의 전체 현황을 한 눈에 파악하기 위한 기능을 제공합니다.","source":"@site/docs/python/dashboard-intro.mdx","sourceDirName":"python","slug":"/python/dashboard-intro","permalink":"/python/dashboard-intro","draft":false,"unlisted":false,"editUrl":"undefined/docs/python/dashboard-intro.mdx","tags":[],"version":"current","frontMatter":{"id":"dashboard-intro","title":"대시보드","description":"와탭 모니터링 대시보드는 프로젝트의 전체 현황을 한 눈에 파악하기 위한 기능을 제공합니다.","keywords":["대시보드","Python","애플리케이션","애플리케이션 모니터링"],"isTranslationMissing":false},"sidebar":"pySidebar","previous":{"title":"패키지 관리","permalink":"/python/manage-pkg"},"next":{"title":"애플리케이션 대시보드","permalink":"/python/dashboard"}}')
...
;// CONCATENATED MODULE: ./docs/python/dashboard-intro.mdx
