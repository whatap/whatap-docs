"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["35527"], {
...
"29533": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_mssql_monitoring_support_mdx_34d_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-mssql-monitoring-support-mdx-34d.json
var site_docs_mssql_monitoring_support_mdx_34d_namespaceObject = JSON.parse('{"id":"mssql/monitoring-support","title":"지원 환경","description":"데이터베이스 모니터링을 시작하기 전에 지원하는 데이터베이스 종류에 대해서 알아보세요.","source":"@site/docs/mssql/monitoring-support.mdx","sourceDirName":"mssql","slug":"/mssql/monitoring-support","permalink":"/mssql/monitoring-support","draft":false,"unlisted":false,"editUrl":"undefined/docs/mssql/monitoring-support.mdx","tags":[],"version":"current","frontMatter":{"id":"monitoring-support","title":"지원 환경","description":"데이터베이스 모니터링을 시작하기 전에 지원하는 데이터베이스 종류에 대해서 알아보세요.","keywords":["SQL Server","데이터베이스"],"isTranslationMissing":false},"sidebar":"mssqlSidebar","previous":{"title":"SQL Server V2 모니터링","permalink":"/mssql/monitoring-intro"},"next":{"title":"에이전트 설치","permalink":"/mssql/install-agent"}}')
...
;// CONCATENATED MODULE: ./docs/mssql/monitoring-support.mdx
...
const toc = [..._import_db_support_env_desc/* toc */.d$, {
  "value": "데이터베이스 지원 버전",
  "id": "데이터베이스-지원-버전",
  "level": 2
...
function _createMdxContent(props) {
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsx)(_import_db_support_env_desc/* default */.ZP, {
      name: "SQL Server"
      ...
      children: [(0,jsx_runtime.jsx)(_components.h2, {
        ...
        children: "SQL Server 2005 버전 이상을 지원합니다."
