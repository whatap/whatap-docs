"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["22714"], {
...
"24342": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_tibero_analysis_count_trend_mdx_269_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-tibero-analysis-count-trend-mdx-269.json
var site_docs_tibero_analysis_count_trend_mdx_269_namespaceObject = JSON.parse('{"id":"tibero/analysis-count-trend","title":"카운트 추이 및 비교","description":"데이터베이스 운용 추이를 확인하고 비교할 수 있습니다.","source":"@site/docs/tibero/analysis-count-trend.mdx","sourceDirName":"tibero","slug":"/tibero/analysis-count-trend","permalink":"/tibero/analysis-count-trend","draft":false,"unlisted":false,"editUrl":"undefined/docs/tibero/analysis-count-trend.mdx","tags":[],"version":"current","frontMatter":{"id":"analysis-count-trend","title":"카운트 추이 및 비교","description":"데이터베이스 운용 추이를 확인하고 비교할 수 있습니다.","keywords":["Tibero","데이터베이스","분석","카운트 추이"],"isTranslationMissing":false},"sidebar":"tiberoSidebar","previous":{"title":"Flex 보드 공유하기","permalink":"/tibero/flexboard-share"},"next":{"title":"락 트리","permalink":"/tibero/analysis-lock-and-deadlock"}}')
...
;// CONCATENATED MODULE: ./docs/tibero/analysis-count-trend.mdx
...
const toc = [..._db_count_trend_desc/* toc */.d$, ..._db_compare_count_trend_v2/* toc */.d$, ..._db_using_chart_activesession_area/* toc */.d$, ..._db_tibero_column/* toc */.d$];
function _createMdxContent(props) {
