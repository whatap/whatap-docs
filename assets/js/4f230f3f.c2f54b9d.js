"use strict";
(self["webpackChunkwhatap_origin"] = self["webpackChunkwhatap_origin"] || []).push([[74078],{
...
const metadata = {
    "unversionedId": "python/flexboard-widget-manage",
    "id": "python/flexboard-widget-manage",
    "title": "위젯 관리하기",
    "description": "Flex 보드에 배치한 위젯을 관리해 보세요.",
    "source": "@site/docs/python/flexboard-widget-manage.mdx",
    ...
    "previous": {
        "title": "메트릭스 위젯",
        "permalink": "/python/flexboard-metric-widget"
    },
    "next": {
        "title": "Flex 보드 화면 모드",
