"use strict";
(self["webpackChunkwhatap_origin"] = self["webpackChunkwhatap_origin"] || []).push([[45990],{
...
const metadata = {
    "unversionedId": "mssql/metrics-chart",
    "id": "mssql/metrics-chart",
    "title": "메트릭스 차트",
    "description": "메트릭스 데이터를 차트로 조회할 수 있습니다.",
    "source": "@site/docs/mssql/metrics-chart.mdx",
    "sourceDirName": "mssql",
    "slug": "/mssql/metrics-chart",
    "permalink": "/whatap-docs/mssql/metrics-chart",
    "draft": false,
    "editUrl": "undefined/docs/mssql/metrics-chart.mdx",
    "tags": [
        {
            "label": "메트릭스",
    ...
    "next": {
        "title": "메트릭스 이상 탐지",
        "permalink": "/whatap-docs/mssql/metrics-detect-anormal"
    }
};
const assets = {};
const toc = [
...
function MDXContent(_param) {
    ...
    return /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)(MDXLayout, _object_spread_props(_object_spread({}, layoutProps, props), {
        ...
        parentName: "strong"
    }, `메트릭스 차트`)), ` 메뉴에서 모니터링 대상에서 수집된 메트릭스 데이터를 다음과 같이 차트로 조회할 수 있습니다. 시간과 지표를 지정하는 것은 필수입니다.`), /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)(ProdImg, {
