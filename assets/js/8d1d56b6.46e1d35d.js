"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["87511"], {
...
"3943": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_python_common_alert_mdx_8d1_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-python-common-alert-mdx-8d1.json
var site_docs_python_common_alert_mdx_8d1_namespaceObject = JSON.parse('{"id":"python/common-alert","title":"시스템 이벤트 안내","description":"와탭 모니터링에서는 플랫폼 전반에서 자동으로 탐지 및 생성되는 공용 이벤트에 대해 안내합니다.","source":"@site/docs/python/common-alert.mdx","sourceDirName":"python","slug":"/python/common-alert","permalink":"/python/common-alert","draft":false,"unlisted":false,"editUrl":"undefined/docs/python/common-alert.mdx","tags":[],"version":"current","frontMatter":{"id":"common-alert","title":"시스템 이벤트 안내","description":"와탭 모니터링에서는 플랫폼 전반에서 자동으로 탐지 및 생성되는 공용 이벤트에 대해 안내합니다.","keywords":["와탭","경고 알림","시스템 이벤트"],"isTranslationMissing":false},"sidebar":"pySidebar","previous":{"title":"실시간 알림","permalink":"/python/real-time-notification"},"next":{"title":"인스턴스 성능 관리","permalink":"/python/instance-performance-analysis"}}')
...
;// CONCATENATED MODULE: ./docs/python/common-alert.mdx
