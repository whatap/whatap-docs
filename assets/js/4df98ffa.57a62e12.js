"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["23657"], {
...
"53335": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_python_trs_endpoint_setting_mdx_4df_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-python-trs-endpoint-setting-mdx-4df.json
var site_docs_python_trs_endpoint_setting_mdx_4df_namespaceObject = JSON.parse('{"id":"python/trs-endpoint-setting","title":"트랜잭션 엔드포인트 설정","description":"트랜잭션 엔드포인트 설정을 안내합니다.","source":"@site/docs/python/trs-endpoint-setting.mdx","sourceDirName":"python","slug":"/python/trs-endpoint-setting","permalink":"/python/trs-endpoint-setting","draft":false,"unlisted":false,"editUrl":"undefined/docs/python/trs-endpoint-setting.mdx","tags":[],"version":"current","frontMatter":{"id":"trs-endpoint-setting","title":"트랜잭션 엔드포인트 설정","description":"트랜잭션 엔드포인트 설정을 안내합니다.","keywords":["Python","트랜잭션"],"isTranslationMissing":false},"sidebar":"pySidebar","previous":{"title":"멀티 트랜잭션","permalink":"/python/trs-multi-trace"},"next":{"title":"트랜잭션 스텝 수집 방식","permalink":"/python/collect-stacks"}}')
...
;// CONCATENATED MODULE: ./docs/python/trs-endpoint-setting.mdx
