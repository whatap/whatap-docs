"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[39735],{
...
const metadata = {
  "id": "python/flexboard-widget-template",
  "title": "위젯 템플릿",
  "description": "Flex 보드에서 대시보드에 배치할 수 있는 위젯의 종류를 안내합니다.",
  "source": "@site/docs/python/flexboard-widget-template.mdx",
  "sourceDirName": "python",
  "slug": "/python/flexboard-widget-template",
  "permalink": "/whatap-docs/python/flexboard-widget-template",
  "draft": false,
  "unlisted": false,
  "editUrl": "undefined/docs/python/flexboard-widget-template.mdx",
  "tags": [],
  "version": "current",
  "frontMatter": {
    "id": "flexboard-widget-template",
