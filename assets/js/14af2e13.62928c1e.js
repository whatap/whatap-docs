"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["45929"], {
"64412": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_php_agent_troubleshooting_mdx_14a_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-php-agent-troubleshooting-mdx-14a.json
var site_docs_php_agent_troubleshooting_mdx_14a_namespaceObject = JSON.parse('{"id":"php/agent-troubleshooting","title":"설치 문제 해결","description":"PHP 에이전트 설치 시 발생할 수 있는 문제를 확인할 수 있습니다.","source":"@site/docs/php/agent-troubleshooting.mdx","sourceDirName":"php","slug":"/php/agent-troubleshooting","permalink":"/php/agent-troubleshooting","draft":false,"unlisted":false,"editUrl":"undefined/docs/php/agent-troubleshooting.mdx","tags":[],"version":"current","frontMatter":{"id":"agent-troubleshooting","title":"설치 문제 해결","description":"PHP 에이전트 설치 시 발생할 수 있는 문제를 확인할 수 있습니다.","toc_max_heading_level":2,"keywords":["PHP","PHP 모니터링","애플리케이션","애플리케이션 모니터링","Troubleshooting","문제 해결"],"isTranslationMissing":false},"sidebar":"phpSidebar","previous":{"title":"설치 점검","permalink":"/php/install-check"},"next":{"title":"PHP 에이전트 설정","permalink":"/php/set-agent"}}')
...
const _php_ini_path_error_frontMatter = (/* unused pure expression or super */ null && ({}));
...
const _php_error_not_found_php_ini_dir_frontMatter = (/* unused pure expression or super */ null && ({}));
...
const _php_hitmap_error_frontMatter = (/* unused pure expression or super */ null && ({}));
...
const _php_sig_error_frontMatter = (/* unused pure expression or super */ null && ({}));
