"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["24174"], {
...
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_altibase_v_1_metrics_intro_mdx_417_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-altibase-v-1-metrics-intro-mdx-417.json
var site_docs_altibase_v_1_metrics_intro_mdx_417_namespaceObject = JSON.parse('{"id":"altibase-v1/metrics-intro","title":"메트릭스","description":"데이터베이스 모니터링 분석을 위한 메트릭스 메뉴에 대해 알아봅니다.","source":"@site/docs/altibase-v1/metrics-intro.mdx","sourceDirName":"altibase-v1","slug":"/altibase-v1/metrics-intro","permalink":"/altibase-v1/metrics-intro","draft":false,"unlisted":false,"editUrl":"undefined/docs/altibase-v1/metrics-intro.mdx","tags":[],"version":"current","frontMatter":{"id":"metrics-intro","title":"메트릭스","description":"데이터베이스 모니터링 분석을 위한 메트릭스 메뉴에 대해 알아봅니다.","keywords":["Altibase","메트릭스","데이터베이스","데이터베이스 모니터링"],"isTranslationMissing":false},"sidebar":"altibasev1Sidebar","previous":{"title":"Flex 보드 공유하기","permalink":"/altibase-v1/flexboard-share"},"next":{"title":"메트릭스 차트","permalink":"/altibase-v1/metrics-chart"}}')
