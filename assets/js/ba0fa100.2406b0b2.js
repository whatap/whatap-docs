"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["31335"], {
...
"57237": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_kubernetes_common_alert_mdx_ba0_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-kubernetes-common-alert-mdx-ba0.json
var site_docs_kubernetes_common_alert_mdx_ba0_namespaceObject = JSON.parse('{"id":"kubernetes/common-alert","title":"시스템 이벤트 안내","description":"와탭 모니터링에서는 플랫폼 전반에서 자동으로 탐지 및 생성되는 공용 이벤트에 대해 안내합니다.","source":"@site/docs/kubernetes/common-alert.mdx","sourceDirName":"kubernetes","slug":"/kubernetes/common-alert","permalink":"/kubernetes/common-alert","draft":false,"unlisted":false,"editUrl":"undefined/docs/kubernetes/common-alert.mdx","tags":[],"version":"current","frontMatter":{"id":"common-alert","title":"시스템 이벤트 안내","description":"와탭 모니터링에서는 플랫폼 전반에서 자동으로 탐지 및 생성되는 공용 이벤트에 대해 안내합니다.","keywords":["와탭","경고 알림","시스템 이벤트"],"isTranslationMissing":false},"sidebar":"kubeSidebar","previous":{"title":"실시간 알림","permalink":"/kubernetes/real-time-notification"},"next":{"title":"실험실","permalink":"/kubernetes/labs"}}')
...
;// CONCATENATED MODULE: ./docs/kubernetes/common-alert.mdx
