"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["20118"], {
...
"20439": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_mongodb_agent_settings_mdx_e1d_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-mongodb-agent-settings-mdx-e1d.json
var site_docs_mongodb_agent_settings_mdx_e1d_namespaceObject = JSON.parse('{"id":"mongodb/agent-settings","title":"설정하기","description":"MongoDB 데이터베이스 에이전트 서버에 있는 whatap.conf 파일을 통해 설정할 수 있는 옵션에 대해 알아봅니다.","source":"@site/docs/mongodb/agent-settings.mdx","sourceDirName":"mongodb","slug":"/mongodb/agent-settings","permalink":"/mongodb/agent-settings","draft":false,"unlisted":false,"editUrl":"undefined/docs/mongodb/agent-settings.mdx","tags":[],"version":"current","frontMatter":{"id":"agent-settings","title":"설정하기","description":"MongoDB 데이터베이스 에이전트 서버에 있는 whatap.conf 파일을 통해 설정할 수 있는 옵션에 대해 알아봅니다.","keywords":["MongoDB","데이터베이스","에이전트 설정"],"isTranslationMissing":false},"sidebar":"mongodbSidebar","previous":{"title":"설치 문제 해결","permalink":"/mongodb/troubleshooting"},"next":{"title":"DBX 에이전트 설정","permalink":"/mongodb/agent-dbx-settings"}}')
...
;// CONCATENATED MODULE: ./docs/mongodb/agent-settings.mdx
