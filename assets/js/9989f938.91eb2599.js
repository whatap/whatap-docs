"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["90370"], {
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_oracle_metrics_chart_mdx_998_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-oracle-metrics-chart-mdx-998.json
var site_docs_oracle_metrics_chart_mdx_998_namespaceObject = JSON.parse('{"id":"oracle/metrics-chart","title":"메트릭스 차트","description":"메트릭스 데이터를 차트로 조회할 수 있습니다.","source":"@site/docs/oracle/metrics-chart.mdx","sourceDirName":"oracle","slug":"/oracle/metrics-chart","permalink":"/oracle/metrics-chart","draft":false,"unlisted":false,"editUrl":"undefined/docs/oracle/metrics-chart.mdx","tags":[],"version":"current","frontMatter":{"id":"metrics-chart","title":"메트릭스 차트","description":"메트릭스 데이터를 차트로 조회할 수 있습니다.","keywords":["메트릭스","메트릭스 차트","UI"],"isTranslationMissing":false},"sidebar":"dboracleV2Sidebar","previous":{"title":"메트릭스 차트","permalink":"/oracle/metrics-chart-v2"},"next":{"title":"메트릭스 조회","permalink":"/oracle/metrics-search"}}')
...
;// CONCATENATED MODULE: ./docs/oracle/metrics-chart.mdx
