"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["99975"], {
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_golang_report_intro_mdx_9af_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-golang-report-intro-mdx-9af.json
var site_docs_golang_report_intro_mdx_9af_namespaceObject = JSON.parse('{"id":"golang/report-intro","title":"보고서","description":"보고서를 안내합니다.","source":"@site/docs/golang/report-intro.mdx","sourceDirName":"golang","slug":"/golang/report-intro","permalink":"/golang/report-intro","draft":false,"unlisted":false,"editUrl":"undefined/docs/golang/report-intro.mdx","tags":[],"version":"current","frontMatter":{"id":"report-intro","title":"보고서","description":"보고서를 안내합니다.","keywords":["Go","보고서","분석하기","UI"],"toc_max_heading_level":2,"isTranslationMissing":false},"sidebar":"goSidebar","previous":{"title":"통계","permalink":"/golang/analysis-apm-trs"},"next":{"title":"애플리케이션 보고서","permalink":"/golang/report-apm"}}')
...
;// CONCATENATED MODULE: ./docs/golang/report-intro.mdx
