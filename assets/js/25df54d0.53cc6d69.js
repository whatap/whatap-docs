"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["44873"], {
"40988": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_azure_metric_warning_notice_mdx_25d_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-azure-metric-warning-notice-mdx-25d.json
var site_docs_azure_metric_warning_notice_mdx_25d_namespaceObject = JSON.parse('{"id":"azure/metric-warning-notice","title":"메트릭스 경고 알림","description":"구체적이고 복잡한 이벤트를 설정하려면 메트릭스 이벤트 설정을 사용하세요.","source":"@site/docs/azure/metric-warning-notice.mdx","sourceDirName":"azure","slug":"/azure/metric-warning-notice","permalink":"/azure/metric-warning-notice","draft":false,"unlisted":false,"editUrl":"undefined/docs/azure/metric-warning-notice.mdx","tags":[],"version":"current","frontMatter":{"id":"metric-warning-notice","title":"메트릭스 경고 알림","description":"구체적이고 복잡한 이벤트를 설정하려면 메트릭스 이벤트 설정을 사용하세요.","keywords":["경고 알림","메트릭스 이벤트","Azure Monitor","클라우드"],"isTranslationMissing":false},"sidebar":"azuremonitorSidebar","previous":{"title":"알림 설정하기","permalink":"/azure/set-notice"},"next":{"title":"이벤트 수신 설정","permalink":"/azure/set-receive-event"}}')
...
;// CONCATENATED MODULE: ./docs/azure/metric-warning-notice.mdx
