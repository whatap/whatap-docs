"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["72070"], {
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_oracle_pro_analysis_pq_tree_mdx_e9c_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-oracle-pro-analysis-pq-tree-mdx-e9c.json
var site_docs_oracle_pro_analysis_pq_tree_mdx_e9c_namespaceObject = JSON.parse('{"id":"oracle-pro/analysis-pq-tree","title":"병렬 쿼리 트리","description":"하루 동안 Parallel Query가 발생한 추이를 분석할 수 있는 기능을 제공합니다.","source":"@site/docs/oracle-pro/analysis-pq-tree.mdx","sourceDirName":"oracle-pro","slug":"/oracle-pro/analysis-pq-tree","permalink":"/oracle-pro/analysis-pq-tree","draft":false,"unlisted":false,"editUrl":"undefined/docs/oracle-pro/analysis-pq-tree.mdx","tags":[],"version":"current","frontMatter":{"id":"analysis-pq-tree","title":"병렬 쿼리 트리","description":"하루 동안 Parallel Query가 발생한 추이를 분석할 수 있는 기능을 제공합니다.","keywords":["Oracle Pro","데이터베이스","병렬 쿼리 트리"],"isTranslationMissing":false},"sidebar":"dboracledmaSidebar","previous":{"title":"Top SQL 비교","permalink":"/oracle-pro/analysis-compare-top-sql"},"next":{"title":"데이터베이스 파라미터","permalink":"/oracle-pro/analysis-databaseparameter"}}')
...
;// CONCATENATED MODULE: ./docs/oracle-pro/analysis-pq-tree.mdx
