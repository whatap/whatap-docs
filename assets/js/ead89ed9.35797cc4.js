"use strict";
(self["webpackChunkwhatap_origin"] = self["webpackChunkwhatap_origin"] || []).push([[80882],{
...
const metadata = {
    "unversionedId": "altibase/set-notification-message",
    "id": "altibase/set-notification-message",
    "title": "알림 메시지 사용자 정의",
    "description": "프로젝트 멤버에게 전달되는 경고 알림 메시지를 수정할 수 있는 사용자 정의 기능을 제공합니다.",
    "source": "@site/docs/altibase/set-notification-message.mdx",
    "sourceDirName": "altibase",
    "slug": "/altibase/set-notification-message",
    "permalink": "/altibase/set-notification-message",
    "draft": false,
    "editUrl": "undefined/docs/altibase/set-notification-message.mdx",
    "tags": [
        {
            "label": "Altibase",
    ...
    "next": {
        "title": "이상치 탐지 경고 알림",
        "permalink": "/altibase/set-event-detect-anomal"
    }
};
const assets = {};
const toc = [
