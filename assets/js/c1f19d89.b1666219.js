"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["34290"], {
...
"81883": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_cubrid_real_time_notification_mdx_c1f_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-cubrid-real-time-notification-mdx-c1f.json
var site_docs_cubrid_real_time_notification_mdx_c1f_namespaceObject = JSON.parse('{"id":"cubrid/real-time-notification","title":"실시간 알림","description":"이벤트 설정 메뉴를 통해서 설정한 경고 알림을 실시간으로 확인할 수 있습니다.","source":"@site/docs/cubrid/real-time-notification.mdx","sourceDirName":"cubrid","slug":"/cubrid/real-time-notification","permalink":"/cubrid/real-time-notification","draft":false,"unlisted":false,"editUrl":"undefined/docs/cubrid/real-time-notification.mdx","tags":[],"version":"current","frontMatter":{"id":"real-time-notification","title":"실시간 알림","description":"이벤트 설정 메뉴를 통해서 설정한 경고 알림을 실시간으로 확인할 수 있습니다.","keywords":["실시간 알림"],"isTranslationMissing":false},"sidebar":"cubridSidebar","previous":{"title":"이벤트 수신 포맷","permalink":"/cubrid/set-event-format"},"next":{"title":"시스템 이벤트 안내","permalink":"/cubrid/common-alert"}}')
...
;// CONCATENATED MODULE: ./docs/cubrid/real-time-notification.mdx
