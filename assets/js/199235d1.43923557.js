"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["98839"], {
...
"79473": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_golang_dashboard_active_transaction_mdx_199_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-golang-dashboard-active-transaction-mdx-199.json
var site_docs_golang_dashboard_active_transaction_mdx_199_namespaceObject = JSON.parse('{"id":"golang/dashboard-active-transaction","title":"액티브 트랜잭션","description":"현재 진행 중인 트랜잭션의 URL, SQL, HTTP 호출 정보로 이상 트랜잭션을 신속하게 파악할 수 있으며, 상세 트레이스를 통해서 지연 구간을 상세하게 분석할 수 있습니다.","source":"@site/docs/golang/dashboard-active-transaction.mdx","sourceDirName":"golang","slug":"/golang/dashboard-active-transaction","permalink":"/golang/dashboard-active-transaction","draft":false,"unlisted":false,"editUrl":"undefined/docs/golang/dashboard-active-transaction.mdx","tags":[],"version":"current","frontMatter":{"id":"dashboard-active-transaction","title":"액티브 트랜잭션","description":"현재 진행 중인 트랜잭션의 URL, SQL, HTTP 호출 정보로 이상 트랜잭션을 신속하게 파악할 수 있으며, 상세 트레이스를 통해서 지연 구간을 상세하게 분석할 수 있습니다.","keywords":["Go","액티브 트랜잭션","대시보드","애플리케이션","애플리케이션 모니터링"],"isTranslationMissing":false},"sidebar":"goSidebar","previous":{"title":"트랜잭션 맵","permalink":"/golang/dashboard-transactionmap"},"next":{"title":"히트맵 - 트레이스 분석","permalink":"/golang/dashboard-hitmap-trace"}}')
...
;// CONCATENATED MODULE: ./docs/golang/dashboard-active-transaction.mdx
