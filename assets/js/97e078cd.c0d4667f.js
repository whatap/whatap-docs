"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["14370"], {
"90869": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_kubernetes_metrics_kubernetes_mdx_97e_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-kubernetes-metrics-kubernetes-mdx-97e.json
var site_docs_kubernetes_metrics_kubernetes_mdx_97e_namespaceObject = JSON.parse('{"id":"kubernetes/metrics-kubernetes","title":"쿠버네티스 지표","description":"쿠버네티스에서 수집되는 지표를 안내합니다.","source":"@site/docs/kubernetes/metrics-kubernetes.mdx","sourceDirName":"kubernetes","slug":"/kubernetes/metrics-kubernetes","permalink":"/kubernetes/metrics-kubernetes","draft":false,"unlisted":false,"editUrl":"undefined/docs/kubernetes/metrics-kubernetes.mdx","tags":[],"version":"current","frontMatter":{"id":"metrics-kubernetes","title":"쿠버네티스 지표","description":"쿠버네티스에서 수집되는 지표를 안내합니다.","toc_max_heading_level":2,"keywords":["메트릭스","쿠버네티스","쿠버네티스 모니터링"],"isTranslationMissing":false},"sidebar":"kubeSidebar","previous":{"title":"메트릭스","permalink":"/kubernetes/metrics-intro"},"next":{"title":"메트릭스 조회","permalink":"/kubernetes/metrics-search"}}')
