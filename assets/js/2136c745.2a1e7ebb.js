"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["84026"], {
...
"26622": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_cubrid_v_1_set_event_format_mdx_213_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-cubrid-v-1-set-event-format-mdx-213.json
var site_docs_cubrid_v_1_set_event_format_mdx_213_namespaceObject = JSON.parse('{"id":"cubrid-v1/set-event-format","title":"이벤트 수신 포맷","description":"데이터베이스 모니터링에서 제공하는 경고 알림의 이벤트 수신 포맷에 대해 알아봅니다.","source":"@site/docs/cubrid-v1/set-event-format.mdx","sourceDirName":"cubrid-v1","slug":"/cubrid-v1/set-event-format","permalink":"/cubrid-v1/set-event-format","draft":false,"unlisted":false,"editUrl":"undefined/docs/cubrid-v1/set-event-format.mdx","tags":[],"version":"current","frontMatter":{"id":"set-event-format","title":"이벤트 수신 포맷","description":"데이터베이스 모니터링에서 제공하는 경고 알림의 이벤트 수신 포맷에 대해 알아봅니다.","keywords":["CUBRID","경고 알림","이벤트","데이터베이스","데이터베이스 모니터링","이벤트 수신 포맷"],"isTranslationMissing":false},"sidebar":"cubridV1Sidebar","previous":{"title":"이벤트 기록","permalink":"/cubrid-v1/set-event-history"},"next":{"title":"실시간 알림","permalink":"/cubrid-v1/real-time-notification"}}')
...
;// CONCATENATED MODULE: ./docs/cubrid-v1/set-event-format.mdx
