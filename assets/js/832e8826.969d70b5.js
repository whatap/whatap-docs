"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[64427],{
...
const metadata = {
  "id": "oracle-dma/flexboard-widget-manage",
  "title": "위젯 관리하기",
  "description": "Flex 보드에 배치한 위젯의 추가, 속성 변경, 복사, 삭제 방법을 안내합니다. 사용자는 위젯을 추가하거나 기존 위젯의 속성을 조정하여 대시보드를 개인화할 수 있습니다. 위젯의 데이터 조회 조건 변경, 시간 설정, 데이터 병합 옵션 설정 등 세밀한 관리 기능을 통해 사용자의 모니터링 요구에 맞는 대시보드를 구성할 수 있습니다.",
  "source": "@site/docs/oracle-dma/flexboard-widget-manage.mdx",
  "sourceDirName": "oracle-dma",
  "slug": "/oracle-dma/flexboard-widget-manage",
  "permalink": "/whatap-docs/oracle-dma/flexboard-widget-manage",
  "draft": false,
  "unlisted": false,
  "editUrl": "undefined/docs/oracle-dma/flexboard-widget-manage.mdx",
  "tags": [
    {
      "label": "Oracle DMA",
  ...
  "previous": {
    "title": "메트릭스 위젯",
    "permalink": "/whatap-docs/oracle-dma/flexboard-metric-widget"
  },
  "next": {
    "title": "Flex 보드 화면 모드",
