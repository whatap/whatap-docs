"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["87301"], {
...
"53615": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_kubernetes_install_docker_php_mdx_16f_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-kubernetes-install-docker-php-mdx-16f.json
var site_docs_kubernetes_install_docker_php_mdx_16f_namespaceObject = JSON.parse('{"id":"kubernetes/install-docker-php","title":"Docker PHP 설치","description":"컨테이너 내 PHP 애플리케이션을 모니터링하기 위한 에이전트 설치 단계입니다.","source":"@site/docs/kubernetes/install-docker-php.mdx","sourceDirName":"kubernetes","slug":"/kubernetes/install-docker-php","permalink":"/kubernetes/install-docker-php","draft":false,"unlisted":false,"editUrl":"undefined/docs/kubernetes/install-docker-php.mdx","tags":[],"version":"current","frontMatter":{"id":"install-docker-php","title":"Docker PHP 설치","description":"컨테이너 내 PHP 애플리케이션을 모니터링하기 위한 에이전트 설치 단계입니다.","keywords":["쿠버네티스","쿠버네티스 모니터링","애플리케이션 설치","PHP"],"isTranslationMissing":false},"sidebar":"kubeSidebar","previous":{"title":"Docker Python 설치","permalink":"/kubernetes/install-docker-python"},"next":{"title":"Docker Go 설치","permalink":"/kubernetes/install-docker-go"}}')
...
;// CONCATENATED MODULE: ./docs/kubernetes/install-docker-php.mdx
...
function _createMdxContent(props) {
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    ...
    }), "\n", "\n", (0,jsx_runtime.jsx)(_docker_php/* default */.ZP, {})]
  });
}
function MDXContent(props = {}) {
  const {wrapper: MDXLayout} = {
