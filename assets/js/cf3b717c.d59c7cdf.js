"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["91720"], {
...
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_azure_flexboard_mode_mdx_cf3_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-azure-flexboard-mode-mdx-cf3.json
var site_docs_azure_flexboard_mode_mdx_cf3_namespaceObject = JSON.parse('{"id":"azure/flexboard-mode","title":"Flex 보드 화면 모드","description":"Flex 보드의 화면 모드에 따라 제공하는 기능에 대해 알아보세요.","source":"@site/docs/azure/flexboard-mode.mdx","sourceDirName":"azure","slug":"/azure/flexboard-mode","permalink":"/azure/flexboard-mode","draft":false,"unlisted":false,"editUrl":"undefined/docs/azure/flexboard-mode.mdx","tags":[],"version":"current","frontMatter":{"id":"flexboard-mode","title":"Flex 보드 화면 모드","description":"Flex 보드의 화면 모드에 따라 제공하는 기능에 대해 알아보세요.","keywords":["Flex 보드","Azure Monitor","클라우드"],"isTranslationMissing":false},"sidebar":"azuremonitorSidebar","previous":{"title":"위젯 템플릿","permalink":"/azure/flexboard-widget-template"},"next":{"title":"Flex 보드 공유하기","permalink":"/azure/flexboard-share"}}')
...
;// CONCATENATED MODULE: ./docs/azure/flexboard-mode.mdx
