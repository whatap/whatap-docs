"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["89741"], {
"25175": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_altibase_metrics_chart_v_2_mdx_3e9_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-altibase-metrics-chart-v-2-mdx-3e9.json
var site_docs_altibase_metrics_chart_v_2_mdx_3e9_namespaceObject = JSON.parse('{"id":"altibase/metrics-chart-v2","title":"메트릭스 차트","description":"메트릭스 데이터를 차트로 조회할 수 있습니다.","source":"@site/docs/altibase/metrics-chart-v2.mdx","sourceDirName":"altibase","slug":"/altibase/metrics-chart-v2","permalink":"/altibase/metrics-chart-v2","draft":false,"unlisted":false,"editUrl":"undefined/docs/altibase/metrics-chart-v2.mdx","tags":[],"version":"current","frontMatter":{"id":"metrics-chart-v2","title":"메트릭스 차트","description":"메트릭스 데이터를 차트로 조회할 수 있습니다.","keywords":["Altibase","데이터베이스","메트릭스","메트릭스 차트"],"isTranslationMissing":false},"sidebar":"altibaseSidebar","previous":{"title":"Altibase 지표","permalink":"/altibase/metrics-data-list"},"next":{"title":"메트릭스 차트","permalink":"/altibase/metrics-chart"}}')
...
;// CONCATENATED MODULE: ./docs/altibase/metrics-chart-v2.mdx
