"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[85997],{
...
const metadata = {
  "id": "cubrid-v1/install-agent",
  "title": "에이전트 설치",
  "description": "와탭 데이터베이스 모니터링 서비스 이용을 위한 기본 설치 방법을 안내합니다.",
  "source": "@site/docs/cubrid-v1/install-agent.mdx",
  "sourceDirName": "cubrid-v1",
  "slug": "/cubrid-v1/install-agent",
  "permalink": "/whatap-docs/cubrid-v1/install-agent",
  "draft": false,
  "unlisted": false,
  "editUrl": "undefined/docs/cubrid-v1/install-agent.mdx",
  "tags": [],
  "version": "current",
  "frontMatter": {
    "id": "install-agent",
  ...
  "next": {
    "title": "설치 점검 사항",
    "permalink": "/whatap-docs/cubrid-v1/after-install-agent"
  }
};
const assets = {
