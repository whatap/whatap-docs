"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["3269"], {
...
"56942": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_python_trs_view_mdx_91d_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-python-trs-view-mdx-91d.json
var site_docs_python_trs_view_mdx_91d_namespaceObject = JSON.parse('{"id":"python/trs-view","title":"트랜잭션 분석하기","description":"트랜잭션 관련 메뉴 화면을 안내합니다.","source":"@site/docs/python/trs-view.mdx","sourceDirName":"python","slug":"/python/trs-view","permalink":"/python/trs-view","draft":false,"unlisted":false,"editUrl":"undefined/docs/python/trs-view.mdx","tags":[],"version":"current","frontMatter":{"id":"trs-view","title":"트랜잭션 분석하기","description":"트랜잭션 관련 메뉴 화면을 안내합니다.","keywords":["Python","트랜잭션","트랜잭션 분석하기","히트맵","UI"],"isTranslationMissing":false},"sidebar":"pySidebar","previous":{"title":"트랜잭션","permalink":"/python/track-transactions-intro"},"next":{"title":"트랜잭션 트레이싱","permalink":"/python/trs-profile"}}')
...
;// CONCATENATED MODULE: ./docs/python/trs-view.mdx
...
function _createMdxContent(props) {
  return (0,jsx_runtime.jsx)(_trs_view/* default */.ZP, {});
}
function MDXContent(props = {}) {
  const {wrapper: MDXLayout} = {
