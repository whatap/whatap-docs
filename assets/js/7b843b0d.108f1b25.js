"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["14814"], {
...
"33744": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_java_add_jvm_opt_jboss_mdx_7b8_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-java-add-jvm-opt-jboss-mdx-7b8.json
var site_docs_java_add_jvm_opt_jboss_mdx_7b8_namespaceObject = JSON.parse('{"id":"java/add-jvm-opt/jboss","title":"JBoss","description":"와탭 모니터링 솔루션을 JBoss 애플리케이션에 통합하기 위한 JVM(Java Virtual Machine) 옵션 추가 방법에 대한 상세한 안내를 제공합니다. 사용자는 본 문서를 통해 자바(Java) 에이전트 설치 후 JBoss 애플리케이션의 성능 및 가용성 모니터링을 위해 필요한 JVM 설정을 적용하는 방법을 단계별로 확인할 수 있습니다. 에이전트 설치 과정 중 필수 JVM 옵션의 구성과 JBoss와의 원활한 통합을 위한 최적의 설정 방법, 힙스토그램 조회 방법을 포함하고 있습니다.","source":"@site/docs/java/add-jvm-opt/jboss.mdx","sourceDirName":"java/add-jvm-opt","slug":"/java/add-jvm-opt/jboss","permalink":"/java/add-jvm-opt/jboss","draft":false,"unlisted":false,"editUrl":"undefined/docs/java/add-jvm-opt/jboss.mdx","tags":[],"version":"current","frontMatter":{"id":"jboss","title":"JBoss","description":"와탭 모니터링 솔루션을 JBoss 애플리케이션에 통합하기 위한 JVM(Java Virtual Machine) 옵션 추가 방법에 대한 상세한 안내를 제공합니다. 사용자는 본 문서를 통해 자바(Java) 에이전트 설치 후 JBoss 애플리케이션의 성능 및 가용성 모니터링을 위해 필요한 JVM 설정을 적용하는 방법을 단계별로 확인할 수 있습니다. 에이전트 설치 과정 중 필수 JVM 옵션의 구성과 JBoss와의 원활한 통합을 위한 최적의 설정 방법, 힙스토그램 조회 방법을 포함하고 있습니다.","keywords":["Java","JBoss","애플리케이션","에이전트"],"isTranslationMissing":false},"sidebar":"javaSidebar","previous":{"title":"Tomcat","permalink":"/java/add-jvm-opt/tomcat"},"next":{"title":"JEUS","permalink":"/java/add-jvm-opt/jeus"}}')
...
;// CONCATENATED MODULE: ./docs/java/add-jvm-opt/jboss.mdx
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsxs)(_components.section, {
      ...
      children: [(0,jsx_runtime.jsx)(_components.h2, {
        ...
        children: ["JVM 옵션에 ", (0,jsx_runtime.jsx)(_components.code, {
          children: "-javaagent"
      ...
      children: [(0,jsx_runtime.jsx)(_components.h3, {
        ...
        children: (0,jsx_runtime.jsxs)(_components.p, {
          children: ["JBoss 5.0 버전 이하는 ", (0,jsx_runtime.jsx)(_components.em, {
            children: "(JBoss 설치 경로)/bin/run.conf"
          }), " 경로에서 설정하세요. 에러가 발생하면 ", (0,jsx_runtime.jsx)(_components.code, {
