"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["12938"], {
...
"45931": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_mssql_flexboard_widget_template_mdx_c0f_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-mssql-flexboard-widget-template-mdx-c0f.json
var site_docs_mssql_flexboard_widget_template_mdx_c0f_namespaceObject = JSON.parse('{"id":"mssql/flexboard-widget-template","title":"위젯 템플릿","description":"Flex 보드에서 대시보드에 배치할 수 있는 위젯의 종류를 안내합니다.","source":"@site/docs/mssql/flexboard-widget-template.mdx","sourceDirName":"mssql","slug":"/mssql/flexboard-widget-template","permalink":"/mssql/flexboard-widget-template","draft":false,"unlisted":false,"editUrl":"undefined/docs/mssql/flexboard-widget-template.mdx","tags":[],"version":"current","frontMatter":{"id":"flexboard-widget-template","title":"위젯 템플릿","description":"Flex 보드에서 대시보드에 배치할 수 있는 위젯의 종류를 안내합니다.","keywords":["Flex 보드","위젯","템플릿"],"isTranslationMissing":false},"sidebar":"mssqlSidebar","previous":{"title":"위젯 관리하기","permalink":"/mssql/flexboard-widget-manage"},"next":{"title":"Flex 보드 화면 모드","permalink":"/mssql/flexboard-mode"}}')
...
;// CONCATENATED MODULE: ./docs/mssql/flexboard-widget-template.mdx
