"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["63340"], {
...
"21243": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_server_metric_warning_notice_new_mdx_d82_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-server-metric-warning-notice-new-mdx-d82.json
var site_docs_server_metric_warning_notice_new_mdx_d82_namespaceObject = JSON.parse('{"id":"server/metric-warning-notice-new","title":"메트릭스 경고 알림","description":"구체적이고 복잡한 이벤트를 설정하려면 메트릭스 이벤트 설정을 사용하세요.","source":"@site/docs/server/metric-warning-notice-new.mdx","sourceDirName":"server","slug":"/server/metric-warning-notice-new","permalink":"/server/metric-warning-notice-new","draft":false,"unlisted":false,"editUrl":"undefined/docs/server/metric-warning-notice-new.mdx","tags":[],"version":"current","frontMatter":{"id":"metric-warning-notice-new","title":"메트릭스 경고 알림","description":"구체적이고 복잡한 이벤트를 설정하려면 메트릭스 이벤트 설정을 사용하세요.","displayed_sidebar":"serverSidebar","keywords":["Server","경고 알림","메트릭스 이벤트"],"isTranslationMissing":false},"sidebar":"serverSidebar"}')
...
;// CONCATENATED MODULE: ./docs/server/metric-warning-notice-new.mdx
...
const toc = [..._metric_warning_notice_new/* toc */.d$, ..._event_config_v3_json_share/* toc */.d$, ..._event_config_v2_search/* toc */.d$, ..._metrics_event_condition_select_target_guide/* toc */.d$];
function _createMdxContent(props) {
