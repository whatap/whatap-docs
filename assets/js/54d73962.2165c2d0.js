"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["22622"], {
...
"78195": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_golang_trs_view_mdx_54d_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-golang-trs-view-mdx-54d.json
var site_docs_golang_trs_view_mdx_54d_namespaceObject = JSON.parse('{"id":"golang/trs-view","title":"트랜잭션 분석하기","description":"트랜잭션 관련 메뉴 화면을 안내합니다.","source":"@site/docs/golang/trs-view.mdx","sourceDirName":"golang","slug":"/golang/trs-view","permalink":"/golang/trs-view","draft":false,"unlisted":false,"editUrl":"undefined/docs/golang/trs-view.mdx","tags":[],"version":"current","frontMatter":{"id":"trs-view","title":"트랜잭션 분석하기","description":"트랜잭션 관련 메뉴 화면을 안내합니다.","keywords":["Go","트랜잭션","트랜잭션 분석하기","히트맵","UI"],"isTranslationMissing":false},"sidebar":"goSidebar","previous":{"title":"트랜잭션","permalink":"/golang/track-transactions-intro"},"next":{"title":"트랜잭션 트레이싱","permalink":"/golang/trs-profile"}}')
...
;// CONCATENATED MODULE: ./docs/golang/trs-view.mdx
