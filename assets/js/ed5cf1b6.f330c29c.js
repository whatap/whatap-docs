"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["20864"], {
...
"67113": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_postgresql_report_intro_mdx_ed5_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-postgresql-report-intro-mdx-ed5.json
var site_docs_postgresql_report_intro_mdx_ed5_namespaceObject = JSON.parse('{"id":"postgresql/report-intro","title":"보고서","description":"PostgreSQL 상품의 개별 프로젝트에 대해 서비스 이용 현황과 장애 발생 기록을 보고하는 문서에 대해 알아봅니다.","source":"@site/docs/postgresql/report-intro.mdx","sourceDirName":"postgresql","slug":"/postgresql/report-intro","permalink":"/postgresql/report-intro","draft":false,"unlisted":false,"editUrl":"undefined/docs/postgresql/report-intro.mdx","tags":[],"version":"current","frontMatter":{"id":"report-intro","title":"보고서","description":"PostgreSQL 상품의 개별 프로젝트에 대해 서비스 이용 현황과 장애 발생 기록을 보고하는 문서에 대해 알아봅니다.","keywords":["PostgreSQL","데이터베이스","보고서"],"isTranslationMissing":false},"sidebar":"postgreSidebar","previous":{"title":"데이터베이스 사이즈","permalink":"/postgresql/database-size"},"next":{"title":"로그","permalink":"/postgresql/log-main"}}')
...
;// CONCATENATED MODULE: ./docs/postgresql/report-intro.mdx
