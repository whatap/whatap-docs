"use strict";
(self["webpackChunkwhatap_origin"] = self["webpackChunkwhatap_origin"] || []).push([[66592],{
...
function TabItem({ children, hidden, className }) {
    return /*#__PURE__*/ (0,jsx_runtime.jsx)("div", {
        role: "tabpanel",
        className: (0,clsx_m/* default */.c)(styles_module.tabItem, className),
        hidden,
        children: children
    });
}
...
var scrollUtils = __webpack_require__(60476);
// EXTERNAL MODULE: ./node_modules/react-router/esm/react-router.js
var react_router = __webpack_require__(55592);
// EXTERNAL MODULE: ./node_modules/@docusaurus/theme-common/lib/utils/historyUtils.js
var historyUtils = __webpack_require__(9016);
// EXTERNAL MODULE: ./node_modules/@docusaurus/theme-common/lib/utils/jsUtils.js
var jsUtils = __webpack_require__(43744);
// EXTERNAL MODULE: ./node_modules/@docusaurus/theme-common/lib/utils/storageUtils.js
var storageUtils = __webpack_require__(82496);
...
function ensureNoDuplicateValue(values) {
    const dup = (0,jsUtils/* duplicates */.w)(values, (a, b)=>a.value === b.value);
    if (dup.length > 0) {
...
function useTabQueryString({ queryString = false, groupId }) {
    const history = (0,react_router/* useHistory */.Uz)();
    const key = getQueryStringKey({
        queryString,
        groupId
    });
    const value = (0,historyUtils/* useQueryStringValue */._M)(key);
...
function useTabStorage({ groupId }) {
    ...
    const [value, storageSlot] = (0,storageUtils/* useStorageSlot */.IN)(key);
    const setValue = (0,react.useCallback)((newValue)=>{
        if (!key) {
            return; // no-op
        }
...
var useIsBrowser = __webpack_require__(28952);
...
function TabList({ className, block, selectedValue, selectValue, tabValues }) {
    const tabRefs = [];
    const { blockElementScrollPositionUntilNextRender } = (0,scrollUtils/* useScrollPositionBlocker */.MV)();
    ...
    return /*#__PURE__*/ (0,jsx_runtime.jsx)("ul", {
        ...
        className: (0,clsx_m/* default */.c)('tabs', {
            'tabs--block': block
        }, className),
        children: tabValues.map(({ value, label, attributes })=>/*#__PURE__*/ (0,jsx_runtime.jsx)("li", Tabs_object_spread_props(Tabs_object_spread({
                ...
                className: (0,clsx_m/* default */.c)('tabs__item', styles_module.tabItem, attributes === null || attributes === void 0 ? void 0 : attributes.className, {
...
function TabsComponent(props) {
    ...
    return /*#__PURE__*/ (0,jsx_runtime.jsxs)("div", {
        className: (0,clsx_m/* default */.c)('tabs-container', styles_module.tabList),
        children: [
...
function Tabs(props) {
    const isBrowser = (0,useIsBrowser/* default */.c)();
    return /*#__PURE__*/ (0,jsx_runtime.jsx)(TabsComponent, Tabs_object_spread({}, props), String(isBrowser));
}
