"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["35705"], {
"34312": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_azure_flexboard_widget_template_mdx_fb1_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-azure-flexboard-widget-template-mdx-fb1.json
var site_docs_azure_flexboard_widget_template_mdx_fb1_namespaceObject = JSON.parse('{"id":"azure/flexboard-widget-template","title":"위젯 템플릿","description":"Flex 보드에서 대시보드에 배치할 수 있는 위젯의 종류를 안내합니다.","source":"@site/docs/azure/flexboard-widget-template.mdx","sourceDirName":"azure","slug":"/azure/flexboard-widget-template","permalink":"/azure/flexboard-widget-template","draft":false,"unlisted":false,"editUrl":"undefined/docs/azure/flexboard-widget-template.mdx","tags":[],"version":"current","frontMatter":{"id":"flexboard-widget-template","title":"위젯 템플릿","description":"Flex 보드에서 대시보드에 배치할 수 있는 위젯의 종류를 안내합니다.","keywords":["Flex 보드","위젯","템플릿"],"isTranslationMissing":false},"sidebar":"azuremonitorSidebar","previous":{"title":"위젯 관리하기","permalink":"/azure/flexboard-widget-manage"},"next":{"title":"Flex 보드 화면 모드","permalink":"/azure/flexboard-mode"}}')
...
;// CONCATENATED MODULE: ./docs/azure/flexboard-widget-template.mdx
