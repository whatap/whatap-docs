"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["54323"], {
...
"44042": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_php_analysis_msa_mdx_95a_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-php-analysis-msa-mdx-95a.json
var site_docs_php_analysis_msa_mdx_95a_namespaceObject = JSON.parse('{"id":"php/analysis-msa","title":"MSA 분석","description":"MSA 분석 기능은 와탭의 MTRACE(멀티 서버간 추적)기능을 통해서 수집된 트랜잭션들 사이의 호출 비중이 어떠한지를 분석합니다.","source":"@site/docs/php/analysis-msa.mdx","sourceDirName":"php","slug":"/php/analysis-msa","permalink":"/php/analysis-msa","draft":false,"unlisted":false,"editUrl":"undefined/docs/php/analysis-msa.mdx","tags":[],"version":"current","frontMatter":{"id":"analysis-msa","title":"MSA 분석","description":"MSA 분석 기능은 와탭의 MTRACE(멀티 서버간 추적)기능을 통해서 수집된 트랜잭션들 사이의 호출 비중이 어떠한지를 분석합니다.","keywords":["PHP","애플리케이션","분석","MSA"],"isTranslationMissing":false},"sidebar":"phpSidebar","previous":{"title":"트랜잭션 검색","permalink":"/php/tx-profile"},"next":{"title":"메트릭스","permalink":"/php/metrics-intro"}}')
...
;// CONCATENATED MODULE: ./docs/php/analysis-msa.mdx
