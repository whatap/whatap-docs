"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["39629"], {
...
"14471": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_redis_log_setting_mdx_883_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-redis-log-setting-mdx-883.json
var site_docs_redis_log_setting_mdx_883_namespaceObject = JSON.parse('{"id":"redis/log-setting","title":"로그 설정","description":"로그 모니터링 설정 방법을 안내합니다.","source":"@site/docs/redis/log-setting.mdx","sourceDirName":"redis","slug":"/redis/log-setting","permalink":"/redis/log-setting","draft":false,"unlisted":false,"editUrl":"undefined/docs/redis/log-setting.mdx","tags":[],"version":"current","frontMatter":{"id":"log-setting","title":"로그 설정","description":"로그 모니터링 설정 방법을 안내합니다.","toc_max_heading_level":3,"keywords":["로그","로그 모니터링","설정하기","Redis"],"isTranslationMissing":false},"sidebar":"redisSidebar","previous":{"title":"로그 검색","permalink":"/redis/log-search"},"next":{"title":"로그 파싱하기","permalink":"/redis/log-parser"}}')
...
;// CONCATENATED MODULE: ./docs/redis/log-setting.mdx
