"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["9407"], {
...
"53321": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_mssql_v_1_report_intro_mdx_92b_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-mssql-v-1-report-intro-mdx-92b.json
var site_docs_mssql_v_1_report_intro_mdx_92b_namespaceObject = JSON.parse('{"id":"mssql-v1/report-intro","title":"보고서","description":"개별 프로젝트에 대해 서비스 이용 현황과 장애 발생 기록을 보고하는 문서에 대해 알아봅니다.","source":"@site/docs/mssql-v1/report-intro.mdx","sourceDirName":"mssql-v1","slug":"/mssql-v1/report-intro","permalink":"/mssql-v1/report-intro","draft":false,"unlisted":false,"editUrl":"undefined/docs/mssql-v1/report-intro.mdx","tags":[],"version":"current","frontMatter":{"id":"report-intro","title":"보고서","description":"개별 프로젝트에 대해 서비스 이용 현황과 장애 발생 기록을 보고하는 문서에 대해 알아봅니다.","keywords":["SQL Server","데이터베이스","보고서"],"isTranslationMissing":false},"sidebar":"mssqlV1Sidebar","previous":{"title":"SQL 통계","permalink":"/mssql-v1/stat"},"next":{"title":"알림 설정하기","permalink":"/mssql-v1/set-notice"}}')
...
;// CONCATENATED MODULE: ./docs/mssql-v1/report-intro.mdx
