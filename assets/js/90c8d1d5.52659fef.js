"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["30085"], {
...
"82934": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_kubernetes_container_warning_notice_mdx_90c_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-kubernetes-container-warning-notice-mdx-90c.json
var site_docs_kubernetes_container_warning_notice_mdx_90c_namespaceObject = JSON.parse('{"id":"kubernetes/container-warning-notice","title":"컨테이너 경고 알림","description":"컨테이너의 자원 사용량 및, 진행 중 트랜잭션, 에러 상황의 이벤트 조건을 통해 경고 알림을 보냅니다.","source":"@site/docs/kubernetes/container-warning-notice.mdx","sourceDirName":"kubernetes","slug":"/kubernetes/container-warning-notice","permalink":"/kubernetes/container-warning-notice","draft":false,"unlisted":false,"editUrl":"undefined/docs/kubernetes/container-warning-notice.mdx","tags":[],"version":"current","frontMatter":{"id":"container-warning-notice","title":"컨테이너 경고 알림","description":"컨테이너의 자원 사용량 및, 진행 중 트랜잭션, 에러 상황의 이벤트 조건을 통해 경고 알림을 보냅니다.","keywords":["경고 알림","쿠버네티스","쿠버네티스 모니터링","컨테이너"],"isTranslationMissing":false},"sidebar":"kubeSidebar","previous":{"title":"경고 알림","permalink":"/kubernetes/set-notice"},"next":{"title":"이벤트 설정","permalink":"/kubernetes/warning-notice-v2"}}')
...
;// CONCATENATED MODULE: ./docs/kubernetes/container-warning-notice.mdx
