"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["2266"], {
...
"92429": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_npm_set_event_history_mdx_702_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-npm-set-event-history-mdx-702.json
var site_docs_npm_set_event_history_mdx_702_namespaceObject = JSON.parse('{"id":"npm/set-event-history","title":"이벤트 기록","description":"이벤트 기록 메뉴를 통해 발생한 경고 알림 이력을 확인할 수 있습니다.","source":"@site/docs/npm/set-event-history.mdx","sourceDirName":"npm","slug":"/npm/set-event-history","permalink":"/npm/set-event-history","draft":false,"unlisted":false,"editUrl":"undefined/docs/npm/set-event-history.mdx","tags":[],"version":"current","frontMatter":{"id":"set-event-history","title":"이벤트 기록","description":"이벤트 기록 메뉴를 통해 발생한 경고 알림 이력을 확인할 수 있습니다.","keywords":["네트워크 성능 모니터링","경고 알림","이벤트 기록"],"isTranslationMissing":false},"sidebar":"npmsidebar","previous":{"title":"이벤트 수신 설정","permalink":"/npm/set-receive-event"},"next":{"title":"실시간 알림","permalink":"/npm/real-time-notification"}}')
...
;// CONCATENATED MODULE: ./docs/npm/set-event-history.mdx
