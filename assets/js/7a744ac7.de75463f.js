"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["5886"], {
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_java_analysis_trace_mtx_mdx_7a7_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-java-analysis-trace-mtx-mdx-7a7.json
var site_docs_java_analysis_trace_mtx_mdx_7a7_namespaceObject = JSON.parse('{"id":"java/analysis-trace-mtx","title":"멀티 트랜잭션 추적","description":"시스템 내 또는 시스템 간에 발생하는 다양한 호출 관계를 한 눈에 파악하고 어느 부분에서 문제가 발생했는지 식별하여 개선할 수 있도록 트랜잭션과 트레이스 정보를 제공합니다.","source":"@site/docs/java/analysis-trace-mtx.mdx","sourceDirName":"java","slug":"/java/analysis-trace-mtx","permalink":"/java/analysis-trace-mtx","draft":false,"unlisted":false,"editUrl":"undefined/docs/java/analysis-trace-mtx.mdx","tags":[],"version":"current","frontMatter":{"id":"analysis-trace-mtx","title":"멀티 트랜잭션 추적","description":"시스템 내 또는 시스템 간에 발생하는 다양한 호출 관계를 한 눈에 파악하고 어느 부분에서 문제가 발생했는지 식별하여 개선할 수 있도록 트랜잭션과 트레이스 정보를 제공합니다.","keywords":["Java","애플리케이션","멀티 트랜잭션"],"isTranslationMissing":false},"sidebar":"javaSidebar","previous":{"title":"히트맵","permalink":"/java/analysis-hitmap"},"next":{"title":"트랜잭션 검색","permalink":"/java/tx-profile"}}')
...
;// CONCATENATED MODULE: ./docs/java/analysis-trace-mtx.mdx
