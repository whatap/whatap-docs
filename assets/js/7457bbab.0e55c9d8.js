"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["49925"], {
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_postgresql_flexboard_manage_mdx_745_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-postgresql-flexboard-manage-mdx-745.json
var site_docs_postgresql_flexboard_manage_mdx_745_namespaceObject = JSON.parse('{"id":"postgresql/flexboard-manage","title":"Flex 보드 관리하기","description":"Flex 보드에서 대시보드를 편집하고 관리하는 방법을 안내합니다. 대시보드의 이름 변경, 프로젝트 선택, 레이아웃 조정 등을 포함하며, 위젯의 추가, 이동, 크기 조절, 삭제 방법도 확인할 수 있습니다. 또한, 위젯의 데이터 소스를 선택하는 방법과 대시보드의 json 형식으로의 내보내기 기능도 제공합니다.","source":"@site/docs/postgresql/flexboard-manage.mdx","sourceDirName":"postgresql","slug":"/postgresql/flexboard-manage","permalink":"/postgresql/flexboard-manage","draft":false,"unlisted":false,"editUrl":"undefined/docs/postgresql/flexboard-manage.mdx","tags":[],"version":"current","frontMatter":{"id":"flexboard-manage","title":"Flex 보드 관리하기","description":"Flex 보드에서 대시보드를 편집하고 관리하는 방법을 안내합니다. 대시보드의 이름 변경, 프로젝트 선택, 레이아웃 조정 등을 포함하며, 위젯의 추가, 이동, 크기 조절, 삭제 방법도 확인할 수 있습니다. 또한, 위젯의 데이터 소스를 선택하는 방법과 대시보드의 json 형식으로의 내보내기 기능도 제공합니다.","keywords":["PostgreSQL","Flex 보드","위젯","메트릭스"],"isTranslationMissing":false},"sidebar":"postgreSidebar","previous":{"title":"Flex 보드 만들기","permalink":"/postgresql/flexboard-create"},"next":{"title":"메트릭스 위젯","permalink":"/postgresql/flexboard-metric-widget"}}')
...
;// CONCATENATED MODULE: ./docs/postgresql/flexboard-manage.mdx
