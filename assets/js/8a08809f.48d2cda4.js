"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["89871"], {
"70882": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_altibase_analysis_lock_and_deadlock_mdx_8a0_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-altibase-analysis-lock-and-deadlock-mdx-8a0.json
var site_docs_altibase_analysis_lock_and_deadlock_mdx_8a0_namespaceObject = JSON.parse('{"id":"altibase/analysis-lock-and-deadlock","title":"락 트리","description":"하루 동안 발생한 Lock 추이를 분석하고 교착 상태의 쿼리를 확인할 수 있습니다.","source":"@site/docs/altibase/analysis-lock-and-deadlock.mdx","sourceDirName":"altibase","slug":"/altibase/analysis-lock-and-deadlock","permalink":"/altibase/analysis-lock-and-deadlock","draft":false,"unlisted":false,"editUrl":"undefined/docs/altibase/analysis-lock-and-deadlock.mdx","tags":[],"version":"current","frontMatter":{"id":"analysis-lock-and-deadlock","title":"락 트리","description":"하루 동안 발생한 Lock 추이를 분석하고 교착 상태의 쿼리를 확인할 수 있습니다.","keywords":["Altibase","데이터베이스","Lock","락 트리"],"isTranslationMissing":false},"sidebar":"altibaseSidebar","previous":{"title":"카운트 추이 비교","permalink":"/altibase/analysis-count-trend"},"next":{"title":"데이터베이스 파라미터","permalink":"/altibase/analysis-databaseparameter"}}')
...
const toc = [..._analysis_lock_desc/* toc */.d$, ..._db_locktree_desc/* toc */.d$, ..._db_locktree_using_basic/* toc */.d$, ..._db_altibase_column/* toc */.d$];
