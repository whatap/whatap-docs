...
const metadata = {
    "unversionedId": "kubernetes/install-master-node-agent-ja",
    "id": "kubernetes/install-master-node-agent-ja",
    "title": "マスターおよびNodeエージェントのインストール",
    "description": "インストール手順のページに従って、マスターおよびNodeエージェントのインストールプロセスを進めてください。",
    "source": "@site/docs/kubernetes/install-master-node-agent-ja.mdx",
    "sourceDirName": "kubernetes",
    "slug": "/kubernetes/install-master-node-agent-ja",
    "permalink": "/whatap-docs/kubernetes/install-master-node-agent-ja",
    "draft": false,
...
`))), /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .yg)("li", {
        ...
        parentName: "p"
    }, `マスターエージェントのリソース使用量は、コンテナ数の増加によって影響を受ける可能性があります`), `。デフォルトで設定されたメモリlimit(350MB) を超えてリソースを使用する場合、OOM(Out Of Memory)が発生する可能性があります。 ユーザーは、`, /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .yg)("em", {
        parentName: "p"
