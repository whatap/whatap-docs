"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["49235"], {
...
"28877": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_oracle_cloud_metrics_chart_mdx_298_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-oracle-cloud-metrics-chart-mdx-298.json
var site_docs_oracle_cloud_metrics_chart_mdx_298_namespaceObject = JSON.parse('{"id":"oracle-cloud/metrics-chart","title":"메트릭스 차트","description":"메트릭스 데이터를 차트로 조회할 수 있습니다.","source":"@site/docs/oracle-cloud/metrics-chart.mdx","sourceDirName":"oracle-cloud","slug":"/oracle-cloud/metrics-chart","permalink":"/oracle-cloud/metrics-chart","draft":false,"unlisted":false,"editUrl":"undefined/docs/oracle-cloud/metrics-chart.mdx","tags":[],"version":"current","frontMatter":{"id":"metrics-chart","title":"메트릭스 차트","description":"메트릭스 데이터를 차트로 조회할 수 있습니다.","keywords":["Oracle Cloud Monitor","클라우드","메트릭스","메트릭스 차트","UI"],"isTranslationMissing":false},"sidebar":"oracleSidebar","previous":{"title":"메트릭스 큐브","permalink":"/oracle-cloud/metrics-cube"},"next":{"title":"메트릭스 이상 탐지","permalink":"/oracle-cloud/metrics-detect-anormal"}}')
...
;// CONCATENATED MODULE: ./docs/oracle-cloud/metrics-chart.mdx
...
function _createMdxContent(props) {
  return (0,jsx_runtime.jsx)(_metrics_item_chart/* default */.ZP, {});
}
function MDXContent(props = {}) {
  const {wrapper: MDXLayout} = {
