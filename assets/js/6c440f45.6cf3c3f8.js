"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["88805"], {
...
"81476": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_server_report_intro_mdx_6c4_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-server-report-intro-mdx-6c4.json
var site_docs_server_report_intro_mdx_6c4_namespaceObject = JSON.parse('{"id":"server/report-intro","title":"보고서","description":"모니터링 보고서 메뉴를 안내합니다.","source":"@site/docs/server/report-intro.mdx","sourceDirName":"server","slug":"/server/report-intro","permalink":"/server/report-intro","draft":false,"unlisted":false,"editUrl":"undefined/docs/server/report-intro.mdx","tags":[],"version":"current","frontMatter":{"id":"report-intro","title":"보고서","description":"모니터링 보고서 메뉴를 안내합니다.","toc_max_heading_level":2,"keywords":["보고서","분석하기","UI"],"isTranslationMissing":false},"sidebar":"serverSidebar","previous":{"title":"큐브","permalink":"/server/cube"},"next":{"title":"서버 보고서","permalink":"/server/report"}}')
...
;// CONCATENATED MODULE: ./docs/server/report-intro.mdx
...
const toc = [..._report_intro/* toc */.d$];
function _createMdxContent(props) {
  return (0,jsx_runtime.jsx)(_report_intro/* default */.ZP, {});
}
function MDXContent(props = {}) {
  const {wrapper: MDXLayout} = {
