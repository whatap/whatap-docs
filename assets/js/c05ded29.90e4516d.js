"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["54300"], {
...
"67096": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_oracle_metrics_data_list_mdx_c05_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-oracle-metrics-data-list-mdx-c05.json
var site_docs_oracle_metrics_data_list_mdx_c05_namespaceObject = JSON.parse('{"id":"oracle/metrics-data-list","title":"Oracle 지표","description":"Oracle 지표를 안내합니다.","source":"@site/docs/oracle/metrics-data-list.mdx","sourceDirName":"oracle","slug":"/oracle/metrics-data-list","permalink":"/oracle/metrics-data-list","draft":false,"unlisted":false,"editUrl":"undefined/docs/oracle/metrics-data-list.mdx","tags":[],"version":"current","frontMatter":{"id":"metrics-data-list","title":"Oracle 지표","description":"Oracle 지표를 안내합니다.","toc_max_heading_level":2,"keywords":["Oracle","메트릭스","데이터베이스","데이터베이스"],"isTranslationMissing":false},"sidebar":"dboracleV2Sidebar","previous":{"title":"메트릭스","permalink":"/oracle/metrics-intro"},"next":{"title":"메트릭스 차트","permalink":"/oracle/metrics-chart-v2"}}')
...
;// CONCATENATED MODULE: ./docs/oracle/metrics-data-list.mdx
...
function _createMdxContent(props) {
  return (0,jsx_runtime.jsxs)("div", {
    className: "metricslist",
    children: [(0,jsx_runtime.jsx)(_oracle_metrics_data_list/* default */.ZP, {}), (0,jsx_runtime.jsx)(_db_xos_metrics/* default */.ZP, {})]
  });
}
function MDXContent(props = {}) {
  const {wrapper: MDXLayout} = {
