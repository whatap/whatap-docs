"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["29194"], {
...
"31878": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_postgresql_monitoring_intro_mdx_967_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-postgresql-monitoring-intro-mdx-967.json
var site_docs_postgresql_monitoring_intro_mdx_967_namespaceObject = JSON.parse('{"id":"postgresql/monitoring-intro","title":"PostgreSQL 모니터링","description":"와탭 데이터베이스 모니터링 서비스(DBX)은 Query 기반으로 데이터를 수집하여 성능 모니터링 서비스를 제공합니다.","source":"@site/docs/postgresql/monitoring-intro.mdx","sourceDirName":"postgresql","slug":"/postgresql/monitoring-intro","permalink":"/postgresql/monitoring-intro","draft":false,"unlisted":false,"editUrl":"undefined/docs/postgresql/monitoring-intro.mdx","tags":[],"version":"current","frontMatter":{"id":"monitoring-intro","title":"PostgreSQL 모니터링","description":"와탭 데이터베이스 모니터링 서비스(DBX)은 Query 기반으로 데이터를 수집하여 성능 모니터링 서비스를 제공합니다.","displayed_sidebar":"postgreSidebar","hide_table_of_contents":false,"keywords":["PostgreSQL","데이터베이스 모니터링","데이터베이스","모니터링","DBX"],"isTranslationMissing":false},"sidebar":"postgreSidebar","next":{"title":"지원 환경","permalink":"/postgresql/monitoring-support"}}')
...
;// CONCATENATED MODULE: ./docs/postgresql/monitoring-intro.mdx
