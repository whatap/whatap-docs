"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["96019"], {
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_python_flexboard_widget_template_mdx_aa1_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-python-flexboard-widget-template-mdx-aa1.json
var site_docs_python_flexboard_widget_template_mdx_aa1_namespaceObject = JSON.parse('{"id":"python/flexboard-widget-template","title":"위젯 템플릿","description":"Flex 보드에서 대시보드에 배치할 수 있는 위젯의 종류를 안내합니다.","source":"@site/docs/python/flexboard-widget-template.mdx","sourceDirName":"python","slug":"/python/flexboard-widget-template","permalink":"/python/flexboard-widget-template","draft":false,"unlisted":false,"editUrl":"undefined/docs/python/flexboard-widget-template.mdx","tags":[],"version":"current","frontMatter":{"id":"flexboard-widget-template","title":"위젯 템플릿","description":"Flex 보드에서 대시보드에 배치할 수 있는 위젯의 종류를 안내합니다.","keywords":["Flex 보드","위젯","템플릿"],"isTranslationMissing":false},"sidebar":"pySidebar","previous":{"title":"위젯 관리하기","permalink":"/python/flexboard-widget-manage"},"next":{"title":"Flex 보드 화면 모드","permalink":"/python/flexboard-mode"}}')
...
;// CONCATENATED MODULE: ./docs/python/flexboard-widget-template.mdx
