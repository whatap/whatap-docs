"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[3470],{
...
const metadata = {
  "id": "oracle-v2/log-setting",
  "title": "로그 설정",
  "description": "로그 모니터링 설정 방법을 안내합니다.",
  "source": "@site/docs/oracle-v2/log-setting.mdx",
  "sourceDirName": "oracle-v2",
  "slug": "/oracle-v2/log-setting",
  "permalink": "/whatap-docs/oracle-v2/log-setting",
  "draft": false,
  "unlisted": false,
  "editUrl": "undefined/docs/oracle-v2/log-setting.mdx",
  "tags": [
    {
      "inline": true,
      "label": "로그",
