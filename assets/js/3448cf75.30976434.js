"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["73259"], {
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_oracle_pro_real_time_notification_mdx_344_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-oracle-pro-real-time-notification-mdx-344.json
var site_docs_oracle_pro_real_time_notification_mdx_344_namespaceObject = JSON.parse('{"id":"oracle-pro/real-time-notification","title":"실시간 알림","description":"이벤트 설정 메뉴를 통해서 설정한 경고 알림을 실시간으로 확인할 수 있습니다.","source":"@site/docs/oracle-pro/real-time-notification.mdx","sourceDirName":"oracle-pro","slug":"/oracle-pro/real-time-notification","permalink":"/oracle-pro/real-time-notification","draft":false,"unlisted":false,"editUrl":"undefined/docs/oracle-pro/real-time-notification.mdx","tags":[],"version":"current","frontMatter":{"id":"real-time-notification","title":"실시간 알림","description":"이벤트 설정 메뉴를 통해서 설정한 경고 알림을 실시간으로 확인할 수 있습니다.","keywords":["실시간 알림"],"isTranslationMissing":false},"sidebar":"dboracledmaSidebar","previous":{"title":"이벤트 수신 포맷","permalink":"/oracle-pro/set-event-format"},"next":{"title":"시스템 이벤트 안내","permalink":"/oracle-pro/common-alert"}}')
...
;// CONCATENATED MODULE: ./docs/oracle-pro/real-time-notification.mdx
