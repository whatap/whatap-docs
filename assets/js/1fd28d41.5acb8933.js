"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["80335"], {
"86593": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_altibase_metrics_chart_mdx_1fd_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-altibase-metrics-chart-mdx-1fd.json
var site_docs_altibase_metrics_chart_mdx_1fd_namespaceObject = JSON.parse('{"id":"altibase/metrics-chart","title":"메트릭스 차트","description":"메트릭스 데이터를 차트로 조회할 수 있습니다.","source":"@site/docs/altibase/metrics-chart.mdx","sourceDirName":"altibase","slug":"/altibase/metrics-chart","permalink":"/altibase/metrics-chart","draft":false,"unlisted":false,"editUrl":"undefined/docs/altibase/metrics-chart.mdx","tags":[],"version":"current","frontMatter":{"id":"metrics-chart","title":"메트릭스 차트","description":"메트릭스 데이터를 차트로 조회할 수 있습니다.","keywords":["메트릭스","메트릭스 차트","UI"],"isTranslationMissing":false},"sidebar":"altibaseSidebar","previous":{"title":"메트릭스 차트","permalink":"/altibase/metrics-chart-v2"},"next":{"title":"메트릭스 조회","permalink":"/altibase/metrics-search"}}')
...
;// CONCATENATED MODULE: ./docs/altibase/metrics-chart.mdx
