"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["39972"], {
...
"11691": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_mysql_log_main_mdx_f3c_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-mysql-log-main-mdx-f3c.json
var site_docs_mysql_log_main_mdx_f3c_namespaceObject = JSON.parse('{"id":"mysql/log-main","title":"로그","description":"로그 모니터링의 주요 메뉴를 안내합니다.","source":"@site/docs/mysql/log-main.mdx","sourceDirName":"mysql","slug":"/mysql/log-main","permalink":"/mysql/log-main","draft":false,"unlisted":false,"editUrl":"undefined/docs/mysql/log-main.mdx","tags":[],"version":"current","frontMatter":{"id":"log-main","title":"로그","description":"로그 모니터링의 주요 메뉴를 안내합니다.","keywords":["MySQL","로그 모니터링","UI"],"isTranslationMissing":false},"sidebar":"mysqlSidebar","previous":{"title":"보고서","permalink":"/mysql/report-intro"},"next":{"title":"적용하기","permalink":"/mysql/log-db"}}')
...
;// CONCATENATED MODULE: ./docs/mysql/log-main.mdx
