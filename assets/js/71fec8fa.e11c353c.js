"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["24178"], {
"29230": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
"93257": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_oracle_v_1_analysis_databaseparameter_mdx_71f_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-oracle-v-1-analysis-databaseparameter-mdx-71f.json
var site_docs_oracle_v_1_analysis_databaseparameter_mdx_71f_namespaceObject = JSON.parse('{"id":"oracle-v1/analysis-databaseparameter","title":"데이터베이스 파라미터","description":"데이터베이스의 파라미터 값을 조회하고 날짜별로 비교할 수 있습니다.","source":"@site/docs/oracle-v1/analysis-databaseparameter.mdx","sourceDirName":"oracle-v1","slug":"/oracle-v1/analysis-databaseparameter","permalink":"/oracle-v1/analysis-databaseparameter","draft":false,"unlisted":false,"editUrl":"undefined/docs/oracle-v1/analysis-databaseparameter.mdx","tags":[],"version":"current","frontMatter":{"id":"analysis-databaseparameter","title":"데이터베이스 파라미터","description":"데이터베이스의 파라미터 값을 조회하고 날짜별로 비교할 수 있습니다.","keywords":["Oracle","데이터베이스","분석","데이터베이스 파라미터"],"isTranslationMissing":false},"sidebar":"dboracleSidebar","previous":{"title":"병렬 쿼리 트리","permalink":"/oracle-v1/analysis-pq-tree"},"next":{"title":"메트릭스","permalink":"/oracle-v1/metrics-intro"}}')
...
var _db_databaseparameter_desc = __webpack_require__("29230");
;// CONCATENATED MODULE: ./docs/oracle-v1/analysis-databaseparameter.mdx
...
const toc = [..._db_databaseparameter_desc/* toc */.d$];
function _createMdxContent(props) {
  return (0,jsx_runtime.jsx)(_db_databaseparameter_desc/* default */.ZP, {});
}
function MDXContent(props = {}) {
  const {wrapper: MDXLayout} = {
