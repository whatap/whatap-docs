"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[28232],{
...
const metadata = {
  "id": "cubrid-v1/set-notification-message",
  "title": "알림 메시지 사용자 정의",
  "description": "프로젝트 멤버에게 전달되는 경고 알림 메시지를 수정할 수 있는 사용자 정의 기능을 제공합니다.",
  "source": "@site/docs/cubrid-v1/set-notification-message.mdx",
  "sourceDirName": "cubrid-v1",
  "slug": "/cubrid-v1/set-notification-message",
  "permalink": "/whatap-docs/cubrid-v1/set-notification-message",
  "draft": false,
  "unlisted": false,
  "editUrl": "undefined/docs/cubrid-v1/set-notification-message.mdx",
  "tags": [],
  "version": "current",
  "frontMatter": {
    "id": "set-notification-message",
  ...
  "next": {
    "title": "이상치 탐지 경고 알림",
    "permalink": "/whatap-docs/cubrid-v1/set-event-detect-anomal"
  }
};
const assets = {
