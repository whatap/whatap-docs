"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["39817"], {
...
"53325": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_mongodb_after_install_agent_mdx_371_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-mongodb-after-install-agent-mdx-371.json
var site_docs_mongodb_after_install_agent_mdx_371_namespaceObject = JSON.parse('{"id":"mongodb/after-install-agent","title":"설치 점검 사항","description":"데이터베이스 모니터링 설치를 모두 완료했습니다. 설치 후 확인 사항을 점검하세요.","source":"@site/docs/mongodb/after-install-agent.mdx","sourceDirName":"mongodb","slug":"/mongodb/after-install-agent","permalink":"/mongodb/after-install-agent","draft":false,"unlisted":false,"editUrl":"undefined/docs/mongodb/after-install-agent.mdx","tags":[],"version":"current","frontMatter":{"id":"after-install-agent","title":"설치 점검 사항","description":"데이터베이스 모니터링 설치를 모두 완료했습니다. 설치 후 확인 사항을 점검하세요.","keywords":["MongoDB","데이터베이스","에이전트"],"isTranslationMissing":false},"sidebar":"mongodbSidebar","previous":{"title":"에이전트 설치","permalink":"/mongodb/install-agent"},"next":{"title":"설치 문제 해결","permalink":"/mongodb/troubleshooting"}}')
...
;// CONCATENATED MODULE: ./docs/mongodb/after-install-agent.mdx
