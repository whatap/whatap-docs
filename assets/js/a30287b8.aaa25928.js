"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["142"], {
...
"55582": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_oracle_pro_report_intro_mdx_a30_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-oracle-pro-report-intro-mdx-a30.json
var site_docs_oracle_pro_report_intro_mdx_a30_namespaceObject = JSON.parse('{"id":"oracle-pro/report-intro","title":"보고서","description":"개별 프로젝트에 대해 서비스 이용 현황과 장애 발생 기록을 보고하는 문서에 대해 알아봅니다.","source":"@site/docs/oracle-pro/report-intro.mdx","sourceDirName":"oracle-pro","slug":"/oracle-pro/report-intro","permalink":"/oracle-pro/report-intro","draft":false,"unlisted":false,"editUrl":"undefined/docs/oracle-pro/report-intro.mdx","tags":[],"version":"current","frontMatter":{"id":"report-intro","title":"보고서","description":"개별 프로젝트에 대해 서비스 이용 현황과 장애 발생 기록을 보고하는 문서에 대해 알아봅니다.","keywords":["Oracle Pro","데이터베이스","데이터베이스","보고서"],"isTranslationMissing":false},"sidebar":"dboracledmaSidebar","previous":{"title":"SGA 사이즈","permalink":"/oracle-pro/sga-size"},"next":{"title":"로그","permalink":"/oracle-pro/log-main"}}')
...
;// CONCATENATED MODULE: ./docs/oracle-pro/report-intro.mdx
