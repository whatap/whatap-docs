"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["30186"], {
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_dotnet_cube_mdx_a34_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-dotnet-cube-mdx-a34.json
var site_docs_dotnet_cube_mdx_a34_namespaceObject = JSON.parse('{"id":"dotnet/cube","title":"큐브","description":"큐브를 안내합니다.","source":"@site/docs/dotnet/cube.mdx","sourceDirName":"dotnet","slug":"/dotnet/cube","permalink":"/dotnet/cube","draft":false,"unlisted":false,"editUrl":"undefined/docs/dotnet/cube.mdx","tags":[],"version":"current","frontMatter":{"id":"cube","title":"큐브","description":"큐브를 안내합니다.","keywords":[".NET","큐브","분석하기","UI"],"isTranslationMissing":false},"sidebar":"dotNetSidebar","previous":{"title":"스택","permalink":"/dotnet/analysis-apm"},"next":{"title":"히트맵","permalink":"/dotnet/analysis-hitmap"}}')
...
;// CONCATENATED MODULE: ./docs/dotnet/cube.mdx
