"use strict";
(self["webpackChunkwhatap_origin"] = self["webpackChunkwhatap_origin"] || []).push([[4938],{
...
const metadata = {
    "unversionedId": "tibero/set-notification-message",
    "id": "tibero/set-notification-message",
    "title": "알림 메시지 사용자 정의",
    "description": "프로젝트 멤버에게 전달되는 경고 알림 메시지를 수정할 수 있는 사용자 정의 기능을 제공합니다.",
    "source": "@site/docs/tibero/set-notification-message.mdx",
    "sourceDirName": "tibero",
    "slug": "/tibero/set-notification-message",
    "permalink": "/whatap-docs/tibero/set-notification-message",
    "draft": false,
    "editUrl": "undefined/docs/tibero/set-notification-message.mdx",
    "tags": [
        {
            "label": "Tibero",
