"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["34863"], {
"13038": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_nodejs_control_function_mdx_0b3_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-nodejs-control-function-mdx-0b3.json
var site_docs_nodejs_control_function_mdx_0b3_namespaceObject = JSON.parse('{"id":"nodejs/agent-control-function","title":"에이전트 기능 제어","description":"Node.js 애플리케이션 서버의 기능을 제어할 수 있습니다.","source":"@site/docs/nodejs/control-function.mdx","sourceDirName":"nodejs","slug":"/nodejs/agent-control-function","permalink":"/nodejs/agent-control-function","draft":false,"unlisted":false,"editUrl":"undefined/docs/nodejs/control-function.mdx","tags":[],"version":"current","frontMatter":{"id":"agent-control-function","title":"에이전트 기능 제어","description":"Node.js 애플리케이션 서버의 기능을 제어할 수 있습니다.","keywords":["Node.js"],"isTranslationMissing":false},"sidebar":"nodejsSidebar","previous":{"title":"에이전트 이름 식별","permalink":"/nodejs/agent-name"},"next":{"title":"에이전트 통신 설정","permalink":"/nodejs/agent-network"}}')
