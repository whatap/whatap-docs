"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["14055"], {
...
"28427": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_golang_hitmap_notice_mdx_8fa_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-golang-hitmap-notice-mdx-8fa.json
var site_docs_golang_hitmap_notice_mdx_8fa_namespaceObject = JSON.parse('{"id":"golang/hitmap-notice","title":"AI 기반의 히트맵 패턴 경고 알림","description":"애플리케이션 실행 분포 패턴을 머신 러닝을 통해 자동 인식하여 경고 알림을 보냅니다.","source":"@site/docs/golang/hitmap-notice.mdx","sourceDirName":"golang","slug":"/golang/hitmap-notice","permalink":"/golang/hitmap-notice","draft":false,"unlisted":false,"editUrl":"undefined/docs/golang/hitmap-notice.mdx","tags":[],"version":"current","frontMatter":{"id":"hitmap-notice","title":"AI 기반의 히트맵 패턴 경고 알림","description":"애플리케이션 실행 분포 패턴을 머신 러닝을 통해 자동 인식하여 경고 알림을 보냅니다.","keywords":["Go","히트맵","경고 알림","애플리케이션","애플리케이션 모니터링"],"isTranslationMissing":false},"sidebar":"goSidebar","previous":{"title":"알림 메시지 사용자 정의","permalink":"/golang/set-notification-message"},"next":{"title":"이상치 탐지 경고 알림","permalink":"/golang/set-event-detect-anomal"}}')
...
;// CONCATENATED MODULE: ./docs/golang/hitmap-notice.mdx
