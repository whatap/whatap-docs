"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["79909"], {
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_mysql_monitoring_intro_mdx_385_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-mysql-monitoring-intro-mdx-385.json
var site_docs_mysql_monitoring_intro_mdx_385_namespaceObject = JSON.parse('{"id":"mysql/monitoring-intro","title":"MySQL 모니터링","description":"와탭 데이터베이스 모니터링 서비스(DBX)은 Query 기반으로 데이터를 수집하여 성능 모니터링 서비스를 제공합니다.","source":"@site/docs/mysql/monitoring-intro.mdx","sourceDirName":"mysql","slug":"/mysql/monitoring-intro","permalink":"/mysql/monitoring-intro","draft":false,"unlisted":false,"editUrl":"undefined/docs/mysql/monitoring-intro.mdx","tags":[],"version":"current","frontMatter":{"id":"monitoring-intro","title":"MySQL 모니터링","description":"와탭 데이터베이스 모니터링 서비스(DBX)은 Query 기반으로 데이터를 수집하여 성능 모니터링 서비스를 제공합니다.","displayed_sidebar":"mysqlSidebar","hide_table_of_contents":false,"keywords":["MySQL","데이터베이스 모니터링","데이터베이스","모니터링","DBX"],"isTranslationMissing":false},"sidebar":"mysqlSidebar","next":{"title":"지원 환경","permalink":"/mysql/monitoring-support"}}')
...
;// CONCATENATED MODULE: ./docs/mysql/monitoring-intro.mdx
