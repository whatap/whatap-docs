"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["87411"], {
...
"21367": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_tibero_metrics_intro_mdx_c9d_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-tibero-metrics-intro-mdx-c9d.json
var site_docs_tibero_metrics_intro_mdx_c9d_namespaceObject = JSON.parse('{"id":"tibero/metrics-intro","title":"메트릭스","description":"데이터베이스 모니터링 분석을 위한 메트릭스 메뉴에 대해 알아봅니다.","source":"@site/docs/tibero/metrics-intro.mdx","sourceDirName":"tibero","slug":"/tibero/metrics-intro","permalink":"/tibero/metrics-intro","draft":false,"unlisted":false,"editUrl":"undefined/docs/tibero/metrics-intro.mdx","tags":[],"version":"current","frontMatter":{"id":"metrics-intro","title":"메트릭스","description":"데이터베이스 모니터링 분석을 위한 메트릭스 메뉴에 대해 알아봅니다.","keywords":["Tibero","메트릭스","데이터베이스","데이터베이스 모니터링"],"isTranslationMissing":false},"sidebar":"tiberoSidebar","previous":{"title":"데이터베이스 파라미터","permalink":"/tibero/analysis-databaseparameter"},"next":{"title":"Tibero 지표","permalink":"/tibero/metrics-data-list"}}')
...
;// CONCATENATED MODULE: ./docs/tibero/metrics-intro.mdx
