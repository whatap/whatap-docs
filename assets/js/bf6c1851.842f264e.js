"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["94361"], {
...
"68528": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_postgresql_metrics_intro_mdx_bf6_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-postgresql-metrics-intro-mdx-bf6.json
var site_docs_postgresql_metrics_intro_mdx_bf6_namespaceObject = JSON.parse('{"id":"postgresql/metrics-intro","title":"메트릭스","description":"데이터베이스 모니터링 분석을 위한 메트릭스 메뉴에 대해 알아봅니다.","source":"@site/docs/postgresql/metrics-intro.mdx","sourceDirName":"postgresql","slug":"/postgresql/metrics-intro","permalink":"/postgresql/metrics-intro","draft":false,"unlisted":false,"editUrl":"undefined/docs/postgresql/metrics-intro.mdx","tags":[],"version":"current","frontMatter":{"id":"metrics-intro","title":"메트릭스","description":"데이터베이스 모니터링 분석을 위한 메트릭스 메뉴에 대해 알아봅니다.","keywords":["PostgreSQL","메트릭스","데이터베이스","데이터베이스 모니터링"],"isTranslationMissing":false},"sidebar":"postgreSidebar","previous":{"title":"데이터베이스 파라미터","permalink":"/postgresql/analysis-databaseparameter"},"next":{"title":"PostgreSQL 지표","permalink":"/postgresql/metrics-data-list"}}')
...
;// CONCATENATED MODULE: ./docs/postgresql/metrics-intro.mdx
