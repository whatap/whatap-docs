"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[76477],{
...
const metadata = {
  ...
  "title": "적용하기",
  "description": "데이터베이스와 AWS RDS의 로그를 수집하는 방법을 안내합니다.",
  "source": "@site/docs/mssql/log-db.mdx",
  "sourceDirName": "mssql",
  "slug": "/mssql/log-db",
  "permalink": "/whatap-docs/mssql/log-db",
  "draft": false,
  "unlisted": false,
  "editUrl": "undefined/docs/mssql/log-db.mdx",
  "tags": [],
  "version": "current",
  "frontMatter": {
    "id": "log-db",
  ...
  "next": {
    "title": "라이브 테일",
    "permalink": "/whatap-docs/mssql/log-lt"
  }
};
const assets = {
