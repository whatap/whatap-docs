"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[18049],{
...
const metadata = {
  "id": "cubrid-v1/metrics-search",
  "title": "메트릭스 조회",
  "description": "메트릭스 Raw Data를 조회할 수 있습니다.",
  "source": "@site/docs/cubrid-v1/metrics-search.mdx",
  "sourceDirName": "cubrid-v1",
  "slug": "/cubrid-v1/metrics-search",
  "permalink": "/whatap-docs/cubrid-v1/metrics-search",
  "draft": false,
  "unlisted": false,
  "editUrl": "undefined/docs/cubrid-v1/metrics-search.mdx",
  "tags": [],
  "version": "current",
  "frontMatter": {
    "id": "metrics-search",
