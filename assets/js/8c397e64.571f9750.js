"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["99604"], {
...
"53564": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_ncloud_set_event_history_mdx_8c3_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-ncloud-set-event-history-mdx-8c3.json
var site_docs_ncloud_set_event_history_mdx_8c3_namespaceObject = JSON.parse('{"id":"ncloud/set-event-history","title":"이벤트 기록","description":"이벤트 기록 메뉴를 통해 발생한 경고 알림 이력을 확인할 수 있습니다.","source":"@site/docs/ncloud/set-event-history.mdx","sourceDirName":"ncloud","slug":"/ncloud/set-event-history","permalink":"/ncloud/set-event-history","draft":false,"unlisted":false,"editUrl":"undefined/docs/ncloud/set-event-history.mdx","tags":[],"version":"current","frontMatter":{"id":"set-event-history","title":"이벤트 기록","description":"이벤트 기록 메뉴를 통해 발생한 경고 알림 이력을 확인할 수 있습니다.","keywords":["Naver Cloud Monitoring","클라우드","경고 알림","이벤트 기록"],"isTranslationMissing":false},"sidebar":"ncloudSidebar","previous":{"title":"이벤트 수신 설정","permalink":"/ncloud/set-receive-event"},"next":{"title":"실시간 알림","permalink":"/ncloud/real-time-notification"}}')
...
;// CONCATENATED MODULE: ./docs/ncloud/set-event-history.mdx
