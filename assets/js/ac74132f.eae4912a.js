"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["9145"], {
...
"93131": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_java_add_jvm_opt_weblogic_mdx_ac7_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-java-add-jvm-opt-weblogic-mdx-ac7.json
var site_docs_java_add_jvm_opt_weblogic_mdx_ac7_namespaceObject = JSON.parse('{"id":"java/add-jvm-opt/weblogic","title":"WebLogic","description":"와탭 모니터링 솔루션을 웹로직(WebLogic) 애플리케이션에 통합하기 위한 JVM(Java Virtual Machine) 옵션 추가 방법에 대한 상세한 안내를 제공합니다. 사용자는 본 문서를 통해 자바(Java) 에이전트 설치 후 웹로직(WebLogic) 애플리케이션의 성능 및 가용성 모니터링을 위해 필요한 JVM 설정을 적용하는 방법을 단계별로 확인할 수 있습니다. 에이전트 설치 과정 중 필수 JVM 옵션의 구성과 웹로직(WebLogic)과의 원활한 통합을 위한 최적의 설정 방법, 힙스토그램 조회 방법을 포함하고 있습니다.","source":"@site/docs/java/add-jvm-opt/weblogic.mdx","sourceDirName":"java/add-jvm-opt","slug":"/java/add-jvm-opt/weblogic","permalink":"/java/add-jvm-opt/weblogic","draft":false,"unlisted":false,"editUrl":"undefined/docs/java/add-jvm-opt/weblogic.mdx","tags":[],"version":"current","frontMatter":{"id":"weblogic","title":"WebLogic","description":"와탭 모니터링 솔루션을 웹로직(WebLogic) 애플리케이션에 통합하기 위한 JVM(Java Virtual Machine) 옵션 추가 방법에 대한 상세한 안내를 제공합니다. 사용자는 본 문서를 통해 자바(Java) 에이전트 설치 후 웹로직(WebLogic) 애플리케이션의 성능 및 가용성 모니터링을 위해 필요한 JVM 설정을 적용하는 방법을 단계별로 확인할 수 있습니다. 에이전트 설치 과정 중 필수 JVM 옵션의 구성과 웹로직(WebLogic)과의 원활한 통합을 위한 최적의 설정 방법, 힙스토그램 조회 방법을 포함하고 있습니다.","keywords":["Java","WebLogic","애플리케이션","에이전트"],"isTranslationMissing":false},"sidebar":"javaSidebar","previous":{"title":"JEUS","permalink":"/java/add-jvm-opt/jeus"},"next":{"title":"WebSphere","permalink":"/java/add-jvm-opt/websphere"}}')
...
;// CONCATENATED MODULE: ./docs/java/add-jvm-opt/weblogic.mdx
