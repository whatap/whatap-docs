"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["23135"], {
...
"9439": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_oracle_pro_flexboard_widget_template_mdx_727_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-oracle-pro-flexboard-widget-template-mdx-727.json
var site_docs_oracle_pro_flexboard_widget_template_mdx_727_namespaceObject = JSON.parse('{"id":"oracle-pro/flexboard-widget-template","title":"위젯 템플릿","description":"Flex 보드에서 대시보드에 배치할 수 있는 위젯의 종류를 안내합니다.","source":"@site/docs/oracle-pro/flexboard-widget-template.mdx","sourceDirName":"oracle-pro","slug":"/oracle-pro/flexboard-widget-template","permalink":"/oracle-pro/flexboard-widget-template","draft":false,"unlisted":false,"editUrl":"undefined/docs/oracle-pro/flexboard-widget-template.mdx","tags":[],"version":"current","frontMatter":{"id":"flexboard-widget-template","title":"위젯 템플릿","description":"Flex 보드에서 대시보드에 배치할 수 있는 위젯의 종류를 안내합니다.","keywords":["Flex 보드","위젯","템플릿"],"isTranslationMissing":false},"sidebar":"dboracledmaSidebar","previous":{"title":"위젯 관리하기","permalink":"/oracle-pro/flexboard-widget-manage"},"next":{"title":"Flex 보드 화면 모드","permalink":"/oracle-pro/flexboard-mode"}}')
...
;// CONCATENATED MODULE: ./docs/oracle-pro/flexboard-widget-template.mdx
