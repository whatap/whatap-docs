"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["87725"], {
...
"21928": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_nodejs_flexboard_mode_mdx_145_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-nodejs-flexboard-mode-mdx-145.json
var site_docs_nodejs_flexboard_mode_mdx_145_namespaceObject = JSON.parse('{"id":"nodejs/flexboard-mode","title":"Flex 보드 화면 모드","description":"Flex 보드의 화면 모드에 따라 제공하는 기능에 대해 알아보세요.","source":"@site/docs/nodejs/flexboard-mode.mdx","sourceDirName":"nodejs","slug":"/nodejs/flexboard-mode","permalink":"/nodejs/flexboard-mode","draft":false,"unlisted":false,"editUrl":"undefined/docs/nodejs/flexboard-mode.mdx","tags":[],"version":"current","frontMatter":{"id":"flexboard-mode","title":"Flex 보드 화면 모드","description":"Flex 보드의 화면 모드에 따라 제공하는 기능에 대해 알아보세요.","keywords":["Node.js","애플리케이션","애플리케이션 모니터링","Flex 보드"],"isTranslationMissing":false},"sidebar":"nodejsSidebar","previous":{"title":"위젯 템플릿","permalink":"/nodejs/flexboard-widget-template"},"next":{"title":"Flex 보드 공유하기","permalink":"/nodejs/flexboard-share"}}')
...
;// CONCATENATED MODULE: ./docs/nodejs/flexboard-mode.mdx
