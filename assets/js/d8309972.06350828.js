"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["3664"], {
...
"17924": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_oracle_flexboard_mode_mdx_d83_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-oracle-flexboard-mode-mdx-d83.json
var site_docs_oracle_flexboard_mode_mdx_d83_namespaceObject = JSON.parse('{"id":"oracle/flexboard-mode","title":"Flex 보드 화면 모드","description":"Flex 보드의 화면 모드에 따라 제공하는 기능에 대해 알아보세요.","source":"@site/docs/oracle/flexboard-mode.mdx","sourceDirName":"oracle","slug":"/oracle/flexboard-mode","permalink":"/oracle/flexboard-mode","draft":false,"unlisted":false,"editUrl":"undefined/docs/oracle/flexboard-mode.mdx","tags":[],"version":"current","frontMatter":{"id":"flexboard-mode","title":"Flex 보드 화면 모드","description":"Flex 보드의 화면 모드에 따라 제공하는 기능에 대해 알아보세요.","keywords":["Oracle","DB","데이터베이스","데이터베이스","Flex 보드"],"isTranslationMissing":false},"sidebar":"dboracleV2Sidebar","previous":{"title":"위젯 템플릿","permalink":"/oracle/flexboard-widget-template"},"next":{"title":"Flex 보드 공유하기","permalink":"/oracle/flexboard-share"}}')
...
;// CONCATENATED MODULE: ./docs/oracle/flexboard-mode.mdx
