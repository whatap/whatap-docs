"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[38285],{
...
const metadata = {
  "id": "cubrid-v1/table-size",
  "title": "테이블 사이즈 증감",
  "description": "테이블 및 인덱스의 사용량을 일별 수집해 기간에 따른 전체 및 테이블별 사용량 증감 정보를 제공합니다.",
  "source": "@site/docs/cubrid-v1/table-size.mdx",
  "sourceDirName": "cubrid-v1",
  "slug": "/cubrid-v1/table-size",
  "permalink": "/whatap-docs/cubrid-v1/table-size",
  "draft": false,
  "unlisted": false,
  "editUrl": "undefined/docs/cubrid-v1/table-size.mdx",
  "tags": [],
  "version": "current",
  "frontMatter": {
    "id": "table-size",
  ...
  "next": {
    "title": "테이블스페이스 사이즈",
    "permalink": "/whatap-docs/cubrid-v1/table-space-size"
  }
};
const assets = {
