"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["31847"], {
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_java_dashboard_intro_mdx_3a9_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-java-dashboard-intro-mdx-3a9.json
var site_docs_java_dashboard_intro_mdx_3a9_namespaceObject = JSON.parse('{"id":"java/dashboard-intro","title":"대시보드","description":"와탭 모니터링 서비스에서 제공하는 자바(Java) 애플리케이션 모니터링의 대시보드 기능과 이를 통해 얻을 수 있는 정보에 대해 안내합니다. 대시보드는 프로젝트의 전체 현황을 한눈에 파악할 수 있으며, 응답 시간, 트랜잭션 상태, 시스템 자원 사용량 등을 실시간으로 시각화하여 제공합니다. 대시보드를 통해 운영자는 서비스 상태를 직관적으로 이해하고, 장애를 즉각적으로 인지할 수 있습니다.","source":"@site/docs/java/dashboard-intro.mdx","sourceDirName":"java","slug":"/java/dashboard-intro","permalink":"/java/dashboard-intro","draft":false,"unlisted":false,"editUrl":"undefined/docs/java/dashboard-intro.mdx","tags":[],"version":"current","frontMatter":{"id":"dashboard-intro","title":"대시보드","description":"와탭 모니터링 서비스에서 제공하는 자바(Java) 애플리케이션 모니터링의 대시보드 기능과 이를 통해 얻을 수 있는 정보에 대해 안내합니다. 대시보드는 프로젝트의 전체 현황을 한눈에 파악할 수 있으며, 응답 시간, 트랜잭션 상태, 시스템 자원 사용량 등을 실시간으로 시각화하여 제공합니다. 대시보드를 통해 운영자는 서비스 상태를 직관적으로 이해하고, 장애를 즉각적으로 인지할 수 있습니다.","keywords":["대시보드","Java","애플리케이션"],"isTranslationMissing":false},"sidebar":"javaSidebar","previous":{"title":"Scale In에서 에이전트 자동 삭제","permalink":"/java/scale-in-auto-delete"},"next":{"title":"애플리케이션 대시보드","permalink":"/java/dashboard"}}')
...
;// CONCATENATED MODULE: ./docs/java/dashboard-intro.mdx
