"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["37006"], {
...
"87890": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_php_install_agent_docker_mdx_227_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-php-install-agent-docker-mdx-227.json
var site_docs_php_install_agent_docker_mdx_227_namespaceObject = JSON.parse('{"id":"php/install-agent-docker","title":"Docker 환경 설치","description":"Docker 환경에서 컨테이너 내 PHP 애플리케이션을 모니터링하기 위한 에이전트 설치를 안내합니다.","source":"@site/docs/php/install-agent-docker.mdx","sourceDirName":"php","slug":"/php/install-agent-docker","permalink":"/php/install-agent-docker","draft":false,"unlisted":false,"editUrl":"undefined/docs/php/install-agent-docker.mdx","tags":[],"version":"current","frontMatter":{"id":"install-agent-docker","title":"Docker 환경 설치","description":"Docker 환경에서 컨테이너 내 PHP 애플리케이션을 모니터링하기 위한 에이전트 설치를 안내합니다.","keywords":["PHP","에이전트 설치","Docker","컨테이너","애플리케이션"],"isTranslationMissing":false},"sidebar":"phpSidebar","previous":{"title":"AWS Elastic beanstalk","permalink":"/php/php-os/aws-eb"},"next":{"title":"설치 점검","permalink":"/php/install-check"}}')
// EXTERNAL MODULE: ./node_modules/react/jsx-runtime.js
var jsx_runtime = __webpack_require__("85893");
// EXTERNAL MODULE: ./node_modules/@mdx-js/react/lib/index.js
var lib = __webpack_require__("50065");
// EXTERNAL MODULE: ./docs/common-items/_docker-php.mdx
var _docker_php = __webpack_require__("17166");
;// CONCATENATED MODULE: ./docs/php/install-agent-docker.mdx
...
const toc = [..._docker_php/* toc */.d$];
function _createMdxContent(props) {
  return (0,jsx_runtime.jsx)(_docker_php/* default */.ZP, {});
}
function MDXContent(props = {}) {
  const {wrapper: MDXLayout} = {
