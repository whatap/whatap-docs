"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[58058],{
...
const metadata = {
  ...
  "title": "메트릭스",
  "description": "데이터베이스 모니터링 분석을 위한 메트릭스 메뉴에 대해 알아봅니다.",
  "source": "@site/docs/mssql-v1/metrics-intro.mdx",
  "sourceDirName": "mssql-v1",
  "slug": "/mssql-v1/metrics-intro",
  "permalink": "/whatap-docs/mssql-v1/metrics-intro",
  "draft": false,
  "unlisted": false,
  "editUrl": "undefined/docs/mssql-v1/metrics-intro.mdx",
  "tags": [],
  "version": "current",
  "frontMatter": {
    "id": "metrics-intro",
