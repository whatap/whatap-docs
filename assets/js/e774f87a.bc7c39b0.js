"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["42191"], {
...
"34681": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_java_flexboard_widget_template_mdx_e77_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-java-flexboard-widget-template-mdx-e77.json
var site_docs_java_flexboard_widget_template_mdx_e77_namespaceObject = JSON.parse('{"id":"java/flexboard-widget-template","title":"위젯 템플릿","description":"Flex 보드에서 대시보드에 배치할 수 있는 위젯의 종류를 안내합니다.","source":"@site/docs/java/flexboard-widget-template.mdx","sourceDirName":"java","slug":"/java/flexboard-widget-template","permalink":"/java/flexboard-widget-template","draft":false,"unlisted":false,"editUrl":"undefined/docs/java/flexboard-widget-template.mdx","tags":[],"version":"current","frontMatter":{"id":"flexboard-widget-template","title":"위젯 템플릿","description":"Flex 보드에서 대시보드에 배치할 수 있는 위젯의 종류를 안내합니다.","keywords":["Flex 보드","위젯","템플릿"],"isTranslationMissing":false},"sidebar":"javaSidebar","previous":{"title":"위젯 관리하기","permalink":"/java/flexboard-widget-manage"},"next":{"title":"Flex 보드 화면 모드","permalink":"/java/flexboard-mode"}}')
...
;// CONCATENATED MODULE: ./docs/java/flexboard-widget-template.mdx
