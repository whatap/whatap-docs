"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["67189"], {
"3641": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_best_practice_guides_about_instance_performance_analysis_mdx_5a6_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-best-practice-guides-about-instance-performance-analysis-mdx-5a6.json
var site_docs_best_practice_guides_about_instance_performance_analysis_mdx_5a6_namespaceObject = JSON.parse('{"id":"best-practice-guides/about-instance-performance-analysis","title":"인스턴스 성능 관리 활용하기","description":"애플리케이션 모니터링 메뉴 중 인스턴스 성능 관리 메뉴의 주요 기능 및 활용 예시를 안내합니다.","source":"@site/docs/best-practice-guides/about-instance-performance-analysis.mdx","sourceDirName":"best-practice-guides","slug":"/best-practice-guides/about-instance-performance-analysis","permalink":"/best-practice-guides/about-instance-performance-analysis","draft":false,"unlisted":false,"editUrl":"undefined/docs/best-practice-guides/about-instance-performance-analysis.mdx","tags":[],"version":"current","frontMatter":{"id":"about-instance-performance-analysis","title":"인스턴스 성능 관리 활용하기","description":"애플리케이션 모니터링 메뉴 중 인스턴스 성능 관리 메뉴의 주요 기능 및 활용 예시를 안내합니다.","keywords":["애플리케이션","애플리케이션 모니터링","APM","인스턴스 성능 관리"],"toc_max_heading_level":2,"displayed_sidebar":"learningSidebar","isTranslationMissing":false},"sidebar":"learningSidebar","previous":{"title":"데이터베이스","permalink":"/best-practice-guides/set-db-metric-warning-notice"},"next":{"title":"TCP 포트 감시 활용","permalink":"/best-practice-guides/about-tcp-port"}}')
// EXTERNAL MODULE: ./node_modules/react/jsx-runtime.js
var jsx_runtime = __webpack_require__("85893");
// EXTERNAL MODULE: ./node_modules/@mdx-js/react/lib/index.js
var lib = __webpack_require__("50065");
;// CONCATENATED MODULE: ./docs/best-practice-guides/about-instance-performance-analysis.mdx
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsxs)(_components.p, {
      children: [(0,jsx_runtime.jsx)(Cmdname, {
        ...
        className: "uitext"
      }), " 메뉴는 애플리케이션의 환경을 확인하고 성능을 관리하는데에 유용한 기능을 제공합니다. ", (0,jsx_runtime.jsx)(Cmdname, {
        sid: "side_agentsConfiguration",
        className: "uitext"
      ...
      children: [(0,jsx_runtime.jsx)(_components.h2, {
        ...
        children: [(0,jsx_runtime.jsx)(Cmdname, {
          sid: "side_loadedClasses",
          className: "uitext"
        }), " 메뉴는 애플리케이션에 로딩된 클래스의 구조와 메소드 시그니처 등 상세 정보를 제공하고 또한 중단없는 클래스 동작 변경이 가능하도록 ", (0,jsx_runtime.jsx)(Cmdname, {
          sid: "redefine",
          className: "uitext"
        }), " 기능을 제공합니다."]
      })]
      ...
      children: [(0,jsx_runtime.jsx)(_components.h4, {
        ...
        }), " 메소드를 호출하여 애플리케이션을 중단시키지 않고도 런타임 중에 이미 로딩된 클래스의 동작을 변경할 수 있게 합니다. 이는 운영 중인 서비스에 대한 수정이나 변경이 필요한 경우 유용합니다. 예를 들어 새로운 서비스 패턴 지정으로 추가적인 트랜잭션 시작점을 설정하고 응답 시간을 측정하고자 할 때, 관련된 와탭 설정 변경 후 해당 클래스를 ", (0,jsx_runtime.jsx)(Cmdname, {
          sid: "side_loadedClasses",
          className: "uitext"
        }), " 목록에서 찾아 ", (0,jsx_runtime.jsx)(_components.img, {
          alt: "수정 아이콘",
          src: (__webpack_require__(59979)/* ["default"] */.Z) + "",
          width: "24",
          height: "24"
        }), " 아이콘을 클릭해 ", (0,jsx_runtime.jsx)(Cmdname, {
          sid: "redefine",
          className: "uitext"
        }), "할 수 있습니다."]
      ...
      children: [(0,jsx_runtime.jsx)(_components.h4, {
        ...
        children: [(0,jsx_runtime.jsx)(Cmdname, {
          sid: "resource",
          className: "uitext"
        }), " 컬럼을 통해 해당 클래스가 물리적으로 어느 파일에서 로딩되었는지 조회할 수 있습니다. 자바 애플리케이션의 다계층 구조 특성상 이와 같은 ", (0,jsx_runtime.jsx)(Cmdname, {
          sid: "resource",
          className: "uitext"
        }), " 정보 확인이 필요합니다. 복잡한 애플리케이션 환경에서는 클래스가 정확히 어느 ", (0,jsx_runtime.jsx)(_components.em, {
          children: "jar"
        }), " 파일에서 로딩되었는지 파악하는 것이 중요합니다."]
      }), (0,jsx_runtime.jsxs)(_components.p, {
        children: ["특정 클래스가 의도하지 않은 ", (0,jsx_runtime.jsx)(_components.em, {
          children: "jar"
      ...
      children: [(0,jsx_runtime.jsx)(_components.h2, {
        ...
        children: [(0,jsx_runtime.jsx)(Cmdname, {
          sid: "side_threadList",
          className: "uitext"
        }), " 메뉴는 현재 실행 중인 스레드 목록을 확인하고 해당 스레드의 개별 스냅샷 및 전체 스레드 덤프 정보를 조회할 수 있습니다. ", (0,jsx_runtime.jsx)(Cmdname, {
          sid: "hitmap",
          className: "uitext"
        }), "이 트랜잭션 응답 시간 위주 최적화 작업의 핵심이라면 ", (0,jsx_runtime.jsx)(Cmdname, {
          sid: "side_threadList",
          className: "uitext"
        }), "는 CPU 최적화의 핵심 요소라고 할 수 있으며 이는 애플리케이션의 성능 최적화, 문제 진단, 그리고 안정성 유지에 중요한 역할을 합니다."]
      }), (0,jsx_runtime.jsxs)(_components.p, {
        children: ["어떤 스레드가 CPU를 많이 사용하고 있는지 파악하는 것은 병목 발생 원인 식별에 있어 중요합니다. 특히 특정 시간대에 CPU 사용이 급증한 스레드 식별을 위해 시계열 데이터를 조회할 수 있어야 합니다. ", (0,jsx_runtime.jsx)(Cmdname, {
          sid: "side_threadList",
          className: "uitext"
        }), " 메뉴의 ", (0,jsx_runtime.jsx)(Cmdname, {
          sid: "thread_cpu_time",
          className: "uitext"
        }), "은 해당 스레드가 CPU를 점유한 총 누적 시간을 의미합니다. ", (0,jsx_runtime.jsx)(_components.em, {
          children: (0,jsx_runtime.jsx)(_components.strong, {
            children: "새로 고침"
          })
        }), " 시 현재 스레드 CPU 시간과 기존 스레드 CPU 시간의 차이인 ", (0,jsx_runtime.jsx)(Cmdname, {
          sid: "TTL08126",
          className: "uitext"
        }), "을 제공하여 조회 시점에 가장 많이 CPU를 사용하고 있는 스레드를 특정할 수 있습니다. ", (0,jsx_runtime.jsx)(Cmdname, {
          sid: "TTL08126",
          className: "uitext"
      ...
      children: [(0,jsx_runtime.jsx)(_components.h4, {
        ...
        children: ["이때 가장 먼저 확인하는 것은 식별이 용이한 힙 메모리입니다. 힙 메모리가 가득 찬 경우 JVM이 GC를 빈번히 실행해 CPU 사용량이 급증할 수 있습니다. 이 경우 ", (0,jsx_runtime.jsx)(Cmdname, {
          sid: "application_dashboard",
          className: "uitext"
        }), "의 ", (0,jsx_runtime.jsx)(Cmdname, {
          sid: "AA010",
          className: "uitext"
        }), " 그래프를 통해 쉽게 확인할 수 있습니다. 두 번째는 실제 요청이 많은 것으로 애플리케이션이 많은 수의 클라이언트 요청을 처리해 CPU 사용량이 높아진 경우입니다. 각 요청은 자바 스레드를 생성해 처리되기에 CPU가 많은 작업을 수행하게 됩니다. 이 경우 ", (0,jsx_runtime.jsx)(Cmdname, {
          sid: "application_dashboard",
          className: "uitext"
        }), "에서 TPS 관련 지표를 통해 확인할 수 있습니다."]
      }), (0,jsx_runtime.jsxs)(_components.p, {
        children: ["세 번째로 애플리케이션 코드에 비효율적인 알고리즘이나 무한 루프 등이 포함되어 있을 경우 CPU 사용률이 비정상적으로 높아질 수 있습니다. 이 경우 ", (0,jsx_runtime.jsx)(Cmdname, {
          sid: "side_threadList",
          className: "uitext"
        ...
        children: [(0,jsx_runtime.jsx)(_components.mdxAdmonitionTitle, {}), (0,jsx_runtime.jsxs)(_components.p, {
          children: [(0,jsx_runtime.jsx)(Cmdname, {
            sid: "thread_cpu_time",
            className: "uitext"
          }), " 확인 → ", (0,jsx_runtime.jsx)(Cmdname, {
            sid: "refresh",
            className: "uitext"
          }), " → ", (0,jsx_runtime.jsx)(Cmdname, {
            sid: "TTL08126",
            className: "uitext"
          }), " 기준으로 목록 정렬 → ", (0,jsx_runtime.jsx)(_components.strong, {
