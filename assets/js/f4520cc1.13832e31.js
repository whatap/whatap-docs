"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["25071"], {
...
"93780": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_postgresql_analysis_session_history_mdx_f45_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-postgresql-analysis-session-history-mdx-f45.json
var site_docs_postgresql_analysis_session_history_mdx_f45_namespaceObject = JSON.parse('{"id":"postgresql/analysis-session-history","title":"세션 히스토리","description":"장시간 수행된 세션에 대해 수행 중인 SQL이 얼마나 자원을 사용했는지 확인하고 원인을 분석할 수 있습니다.","source":"@site/docs/postgresql/analysis-session-history.mdx","sourceDirName":"postgresql","slug":"/postgresql/analysis-session-history","permalink":"/postgresql/analysis-session-history","draft":false,"unlisted":false,"editUrl":"undefined/docs/postgresql/analysis-session-history.mdx","tags":[],"version":"current","frontMatter":{"id":"analysis-session-history","title":"세션 히스토리","description":"장시간 수행된 세션에 대해 수행 중인 SQL이 얼마나 자원을 사용했는지 확인하고 원인을 분석할 수 있습니다.","keywords":["PostgreSQL","데이터베이스","분석","세션 히스토리"],"isTranslationMissing":false},"sidebar":"postgreSidebar","previous":{"title":"락 트리","permalink":"/postgresql/analysis-lock-and-deadlock"},"next":{"title":"Wait 분석","permalink":"/postgresql/analysis-wait-events"}}')
...
;// CONCATENATED MODULE: ./docs/postgresql/analysis-session-history.mdx
