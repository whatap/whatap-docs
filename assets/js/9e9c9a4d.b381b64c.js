"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["94836"], {
"30716": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_altibase_agent_settings_mdx_9e9_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-altibase-agent-settings-mdx-9e9.json
var site_docs_altibase_agent_settings_mdx_9e9_namespaceObject = JSON.parse('{"id":"altibase/agent-settings","title":"설정하기","description":"데이터베이스 에이전트 서버에 있는 whatap.conf 파일을 통해 설정할 수 있는 옵션에 대해 알아봅니다.","source":"@site/docs/altibase/agent-settings.mdx","sourceDirName":"altibase","slug":"/altibase/agent-settings","permalink":"/altibase/agent-settings","draft":false,"unlisted":false,"editUrl":"undefined/docs/altibase/agent-settings.mdx","tags":[],"version":"current","frontMatter":{"id":"agent-settings","title":"설정하기","description":"데이터베이스 에이전트 서버에 있는 whatap.conf 파일을 통해 설정할 수 있는 옵션에 대해 알아봅니다.","keywords":["Altibase","데이터베이스","데이터베이스 모니터링"],"isTranslationMissing":false},"sidebar":"altibaseSidebar","previous":{"title":"설치 문제 해결","permalink":"/altibase/troubleshooting"},"next":{"title":"DBX 에이전트 설정","permalink":"/altibase/agent-dbx-settings"}}')
...
;// CONCATENATED MODULE: ./docs/altibase/agent-settings.mdx
