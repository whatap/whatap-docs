...
"65866": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_oracle_pro_metrics_chart_mdx_ddd_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-oracle-pro-metrics-chart-mdx-ddd.json
var site_docs_oracle_pro_metrics_chart_mdx_ddd_namespaceObject = JSON.parse('{"id":"oracle-pro/metrics-chart","title":"메트릭스 차트","description":"메트릭스 데이터를 차트로 조회할 수 있습니다.","source":"@site/docs/oracle-pro/metrics-chart.mdx","sourceDirName":"oracle-pro","slug":"/oracle-pro/metrics-chart","permalink":"/oracle-pro/metrics-chart","draft":false,"unlisted":false,"editUrl":"undefined/docs/oracle-pro/metrics-chart.mdx","tags":[],"version":"current","frontMatter":{"id":"metrics-chart","title":"메트릭스 차트","description":"메트릭스 데이터를 차트로 조회할 수 있습니다.","keywords":["메트릭스","메트릭스 차트","UI"],"isTranslationMissing":false},"sidebar":"dboracledmaSidebar","previous":{"title":"메트릭스 차트","permalink":"/oracle-pro/metrics-chart-v2"},"next":{"title":"메트릭스 조회","permalink":"/oracle-pro/metrics-search"}}')
...
;// CONCATENATED MODULE: ./docs/oracle-pro/metrics-chart.mdx
