"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["53181"], {
...
"5463": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_python_report_apm_mdx_580_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-python-report-apm-mdx-580.json
var site_docs_python_report_apm_mdx_580_namespaceObject = JSON.parse('{"id":"python/report-apm","title":"애플리케이션 보고서","description":"애플리케이션의 주요 성능에 대한 보고서를 제공합니다.","source":"@site/docs/python/report-apm.mdx","sourceDirName":"python","slug":"/python/report-apm","permalink":"/python/report-apm","draft":false,"unlisted":false,"editUrl":"undefined/docs/python/report-apm.mdx","tags":[],"version":"current","frontMatter":{"id":"report-apm","title":"애플리케이션 보고서","description":"애플리케이션의 주요 성능에 대한 보고서를 제공합니다.","toc_max_heading_level":3,"keywords":["Python","애플리케이션","보고서"],"isTranslationMissing":false},"sidebar":"pySidebar","previous":{"title":"보고서","permalink":"/python/report-intro"},"next":{"title":"통합 보고서","permalink":"/python/integrated-report"}}')
...
;// CONCATENATED MODULE: ./docs/python/report-apm.mdx
