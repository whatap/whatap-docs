"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["826"], {
...
"96750": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_oracle_monitoring_support_mdx_af5_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-oracle-monitoring-support-mdx-af5.json
var site_docs_oracle_monitoring_support_mdx_af5_namespaceObject = JSON.parse('{"id":"oracle/monitoring-support","title":"지원 환경","description":"데이터베이스 모니터링을 시작하기 전에 지원하는 데이터베이스 종류에 대해서 알아보세요.","source":"@site/docs/oracle/monitoring-support.mdx","sourceDirName":"oracle","slug":"/oracle/monitoring-support","permalink":"/oracle/monitoring-support","draft":false,"unlisted":false,"editUrl":"undefined/docs/oracle/monitoring-support.mdx","tags":[],"version":"current","frontMatter":{"id":"monitoring-support","title":"지원 환경","description":"데이터베이스 모니터링을 시작하기 전에 지원하는 데이터베이스 종류에 대해서 알아보세요.","keywords":["데이터베이스","데이터베이스","Oracle"],"isTranslationMissing":false},"sidebar":"dboracleV2Sidebar","previous":{"title":"Oracle V2 모니터링","permalink":"/oracle/monitoring-intro"},"next":{"title":"에이전트 설치","permalink":"/oracle/install-agent"}}')
...
;// CONCATENATED MODULE: ./docs/oracle/monitoring-support.mdx
