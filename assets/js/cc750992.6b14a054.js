"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["9906"], {
...
"8543": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_java_analysis_report_intro_mdx_cc7_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-java-analysis-report-intro-mdx-cc7.json
var site_docs_java_analysis_report_intro_mdx_cc7_namespaceObject = JSON.parse('{"id":"java/analysis-report-intro","title":"분석","description":"Java 환경의 애플리케이션 성능을 분석하고 발생할 수 있는 문제에 대처할 수 있습니다.","source":"@site/docs/java/analysis-report-intro.mdx","sourceDirName":"java","slug":"/java/analysis-report-intro","permalink":"/java/analysis-report-intro","draft":false,"unlisted":false,"editUrl":"undefined/docs/java/analysis-report-intro.mdx","tags":[],"version":"current","frontMatter":{"id":"analysis-report-intro","title":"분석","description":"Java 환경의 애플리케이션 성능을 분석하고 발생할 수 있는 문제에 대처할 수 있습니다.","keywords":["Java","애플리케이션","분석"],"isTranslationMissing":false},"sidebar":"javaSidebar","previous":{"title":"Flex 보드 공유하기","permalink":"/java/flexboard-share"},"next":{"title":"일자별 애플리케이션 현황","permalink":"/java/application-daily-stat"}}')
...
;// CONCATENATED MODULE: ./docs/java/analysis-report-intro.mdx
