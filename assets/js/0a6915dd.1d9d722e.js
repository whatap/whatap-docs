"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["32701"], {
...
"23149": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_log_set_event_history_mdx_0a6_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-log-set-event-history-mdx-0a6.json
var site_docs_log_set_event_history_mdx_0a6_namespaceObject = JSON.parse('{"id":"log/set-event-history","title":"이벤트 기록","description":"이벤트 기록 메뉴를 통해 발생한 경고 알림 이력을 확인할 수 있습니다.","source":"@site/docs/log/set-event-history.mdx","sourceDirName":"log","slug":"/log/set-event-history","permalink":"/log/set-event-history","draft":false,"unlisted":false,"editUrl":"undefined/docs/log/set-event-history.mdx","tags":[],"version":"current","frontMatter":{"id":"set-event-history","title":"이벤트 기록","description":"이벤트 기록 메뉴를 통해 발생한 경고 알림 이력을 확인할 수 있습니다.","keywords":["로그 모니터링","경고 알림","이벤트 기록"],"isTranslationMissing":false},"sidebar":"logSidebar","previous":{"title":"이벤트 수신 설정","permalink":"/log/set-receive-event"},"next":{"title":"실시간 알림","permalink":"/log/real-time-notification"}}')
...
;// CONCATENATED MODULE: ./docs/log/set-event-history.mdx
