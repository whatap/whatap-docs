"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["39354"], {
...
"90918": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_php_topology_settings_mdx_d32_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-php-topology-settings-mdx-d32.json
var site_docs_php_topology_settings_mdx_d32_namespaceObject = JSON.parse('{"id":"php/topology-settings","title":"에이전트 옵션 설정","description":"토폴로지 기능을 이용하기 위해 에이전트에 옵션을 적용하는 방법을 제공합니다.","source":"@site/docs/php/topology-settings.mdx","sourceDirName":"php","slug":"/php/topology-settings","permalink":"/php/topology-settings","draft":false,"unlisted":false,"editUrl":"undefined/docs/php/topology-settings.mdx","tags":[],"version":"current","frontMatter":{"id":"topology-settings","title":"에이전트 옵션 설정","description":"토폴로지 기능을 이용하기 위해 에이전트에 옵션을 적용하는 방법을 제공합니다.","keywords":["PHP","토폴로지","에이전트"],"isTranslationMissing":false},"sidebar":"phpSidebar","previous":{"title":"부가 기능","permalink":"/php/topology-add-function"},"next":{"title":"통계","permalink":"/php/analysis-apm-trs"}}')
// EXTERNAL MODULE: ./node_modules/react/jsx-runtime.js
var jsx_runtime = __webpack_require__("85893");
// EXTERNAL MODULE: ./node_modules/@mdx-js/react/lib/index.js
var lib = __webpack_require__("50065");
...
;// CONCATENATED MODULE: ./docs/php/topology-settings.mdx
