"use strict";
(self["webpackChunkwhatap_origin"] = self["webpackChunkwhatap_origin"] || []).push([[23257],{
...
const metadata = {
    "unversionedId": "mysql-v1/set-event-history",
    "id": "mysql-v1/set-event-history",
    "title": "이벤트 기록",
    "description": "이벤트 기록 메뉴를 통해 발생한 경고 알림 이력을 확인할 수 있습니다.",
    "source": "@site/docs/mysql-v1/set-event-history.mdx",
    "sourceDirName": "mysql-v1",
    "slug": "/mysql-v1/set-event-history",
    "permalink": "/whatap-docs/mysql-v1/set-event-history",
    "draft": false,
    "editUrl": "undefined/docs/mysql-v1/set-event-history.mdx",
    "tags": [
        {
            "label": "MySQL",
