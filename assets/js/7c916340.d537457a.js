"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["39200"], {
"72173": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_altibase_flexboard_widget_manage_mdx_7c9_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-altibase-flexboard-widget-manage-mdx-7c9.json
var site_docs_altibase_flexboard_widget_manage_mdx_7c9_namespaceObject = JSON.parse('{"id":"altibase/flexboard-widget-manage","title":"위젯 관리하기","description":"Flex 보드에 배치한 위젯의 추가, 속성 변경, 복사, 삭제 방법을 안내합니다. 사용자는 위젯을 추가하거나 기존 위젯의 속성을 조정하여 대시보드를 개인화할 수 있습니다. 위젯의 데이터 조회 조건 변경, 시간 설정, 데이터 병합 옵션 설정 등 세밀한 관리 기능을 통해 사용자의 모니터링 요구에 맞는 대시보드를 구성할 수 있습니다.","source":"@site/docs/altibase/flexboard-widget-manage.mdx","sourceDirName":"altibase","slug":"/altibase/flexboard-widget-manage","permalink":"/altibase/flexboard-widget-manage","draft":false,"unlisted":false,"editUrl":"undefined/docs/altibase/flexboard-widget-manage.mdx","tags":[],"version":"current","frontMatter":{"id":"flexboard-widget-manage","title":"위젯 관리하기","description":"Flex 보드에 배치한 위젯의 추가, 속성 변경, 복사, 삭제 방법을 안내합니다. 사용자는 위젯을 추가하거나 기존 위젯의 속성을 조정하여 대시보드를 개인화할 수 있습니다. 위젯의 데이터 조회 조건 변경, 시간 설정, 데이터 병합 옵션 설정 등 세밀한 관리 기능을 통해 사용자의 모니터링 요구에 맞는 대시보드를 구성할 수 있습니다.","keywords":["Altibase","Flex 보드","위젯","메트릭스"],"isTranslationMissing":false},"sidebar":"altibaseSidebar","previous":{"title":"메트릭스 위젯","permalink":"/altibase/flexboard-metric-widget"},"next":{"title":"위젯 템플릿","permalink":"/altibase/flexboard-widget-template"}}')
...
;// CONCATENATED MODULE: ./docs/altibase/flexboard-widget-manage.mdx
