"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["40449"], {
...
"74563": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_server_flexboard_mode_mdx_c97_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-server-flexboard-mode-mdx-c97.json
var site_docs_server_flexboard_mode_mdx_c97_namespaceObject = JSON.parse('{"id":"server/flexboard-mode","title":"Flex 보드 화면 모드","description":"Flex 보드의 화면 모드에 따라 제공하는 기능에 대해 알아보세요.","source":"@site/docs/server/flexboard-mode.mdx","sourceDirName":"server","slug":"/server/flexboard-mode","permalink":"/server/flexboard-mode","draft":false,"unlisted":false,"editUrl":"undefined/docs/server/flexboard-mode.mdx","tags":[],"version":"current","frontMatter":{"id":"flexboard-mode","title":"Flex 보드 화면 모드","description":"Flex 보드의 화면 모드에 따라 제공하는 기능에 대해 알아보세요.","keywords":["tags"],"isTranslationMissing":false},"sidebar":"serverSidebar","previous":{"title":"위젯 템플릿","permalink":"/server/flexboard-widget-template"},"next":{"title":"Flex 보드 공유하기","permalink":"/server/flexboard-share"}}')
...
;// CONCATENATED MODULE: ./docs/server/flexboard-mode.mdx
