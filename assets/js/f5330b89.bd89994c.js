"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[16285],{
...
const metadata = {
  "id": "altibase/real-time-notification",
  "title": "실시간 알림",
  "description": "이벤트 설정 메뉴를 통해서 설정한 경고 알림을 실시간으로 확인할 수 있습니다.",
  "source": "@site/docs/altibase/real-time-notification.mdx",
  "sourceDirName": "altibase",
  "slug": "/altibase/real-time-notification",
  "permalink": "/whatap-docs/altibase/real-time-notification",
  "draft": false,
  "unlisted": false,
  "editUrl": "undefined/docs/altibase/real-time-notification.mdx",
  "tags": [],
  "version": "current",
  "frontMatter": {
    "id": "real-time-notification",
  ...
  "next": {
    "title": "시스템 이벤트 안내",
    "permalink": "/whatap-docs/altibase/common-alert"
  }
};
const assets = {
