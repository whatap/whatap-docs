"use strict";
(self["webpackChunkwhatap_origin"] = self["webpackChunkwhatap_origin"] || []).push([[84342],{
...
const metadata = {
    "unversionedId": "postgresql-v1/metrics-chart",
    "id": "postgresql-v1/metrics-chart",
    "title": "메트릭스 차트",
    "description": "메트릭스 데이터를 차트로 조회할 수 있습니다.",
    "source": "@site/docs/postgresql-v1/metrics-chart.mdx",
    "sourceDirName": "postgresql-v1",
    "slug": "/postgresql-v1/metrics-chart",
    "permalink": "/whatap-docs/postgresql-v1/metrics-chart",
    "draft": false,
    "editUrl": "undefined/docs/postgresql-v1/metrics-chart.mdx",
    "tags": [
        {
            "label": "메트릭스",
