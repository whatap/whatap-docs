"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["88626"], {
...
"27383": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_php_set_event_format_mdx_2b1_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-php-set-event-format-mdx-2b1.json
var site_docs_php_set_event_format_mdx_2b1_namespaceObject = JSON.parse('{"id":"php/set-event-format","title":"이벤트 수신 포맷","description":"애플리케이션 모니터링에서 제공하는 경고 알림의 이벤트 수신 포맷에 대해 알아봅니다.","source":"@site/docs/php/set-event-format.mdx","sourceDirName":"php","slug":"/php/set-event-format","permalink":"/php/set-event-format","draft":false,"unlisted":false,"editUrl":"undefined/docs/php/set-event-format.mdx","tags":[],"version":"current","frontMatter":{"id":"set-event-format","title":"이벤트 수신 포맷","description":"애플리케이션 모니터링에서 제공하는 경고 알림의 이벤트 수신 포맷에 대해 알아봅니다.","keywords":["PHP","경고 알림","이벤트","애플리케이션","애플리케이션 모니터링","이벤트 수신 포맷"],"isTranslationMissing":false},"sidebar":"phpSidebar","previous":{"title":"이벤트 기록","permalink":"/php/set-event-history"},"next":{"title":"실시간 알림","permalink":"/php/real-time-notification"}}')
...
;// CONCATENATED MODULE: ./docs/php/set-event-format.mdx
