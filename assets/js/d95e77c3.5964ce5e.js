"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["30075"], {
...
"76971": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_server_set_event_log_mdx_d95_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-server-set-event-log-mdx-d95.json
var site_docs_server_set_event_log_mdx_d95_namespaceObject = JSON.parse('{"id":"server/set-event-log","title":"로그 경고 알림","description":"로그 메시지를 필터링해 경고 알림을 설정할 수 있습니다.","source":"@site/docs/server/set-event-log.mdx","sourceDirName":"server","slug":"/server/set-event-log","permalink":"/server/set-event-log","draft":false,"unlisted":false,"editUrl":"undefined/docs/server/set-event-log.mdx","tags":[],"version":"current","frontMatter":{"id":"set-event-log","title":"로그 경고 알림","description":"로그 메시지를 필터링해 경고 알림을 설정할 수 있습니다.","keywords":["경고 알림","로그"],"isTranslationMissing":false},"sidebar":"serverSidebar","previous":{"title":"이상치 탐지 경고 알림","permalink":"/server/set-event-detect-anomal"},"next":{"title":"이벤트 수신 설정","permalink":"/server/set-receive-event"}}')
...
;// CONCATENATED MODULE: ./docs/server/set-event-log.mdx
