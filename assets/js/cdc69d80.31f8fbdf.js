"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["96267"], {
...
"54993": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_python_set_event_history_mdx_cdc_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-python-set-event-history-mdx-cdc.json
var site_docs_python_set_event_history_mdx_cdc_namespaceObject = JSON.parse('{"id":"python/set-event-history","title":"이벤트 기록","description":"이벤트 기록 메뉴를 통해 발생한 경고 알림 이력을 확인할 수 있습니다.","source":"@site/docs/python/set-event-history.mdx","sourceDirName":"python","slug":"/python/set-event-history","permalink":"/python/set-event-history","draft":false,"unlisted":false,"editUrl":"undefined/docs/python/set-event-history.mdx","tags":[],"version":"current","frontMatter":{"id":"set-event-history","title":"이벤트 기록","description":"이벤트 기록 메뉴를 통해 발생한 경고 알림 이력을 확인할 수 있습니다.","keywords":["Python","경고 알림","이벤트 기록","애플리케이션 모니터링"],"isTranslationMissing":false},"sidebar":"pySidebar","previous":{"title":"이벤트 수신 설정","permalink":"/python/set-receive-event"},"next":{"title":"이벤트 수신 포맷","permalink":"/python/set-event-format"}}')
...
;// CONCATENATED MODULE: ./docs/python/set-event-history.mdx
