"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["239"], {
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_postgresql_flexboard_share_mdx_898_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-postgresql-flexboard-share-mdx-898.json
var site_docs_postgresql_flexboard_share_mdx_898_namespaceObject = JSON.parse('{"id":"postgresql/flexboard-share","title":"Flex 보드 공유하기","description":"Flex 보드를 다른 계정의 사용자와 공유하고 재사용할 수 있습니다.","source":"@site/docs/postgresql/flexboard-share.mdx","sourceDirName":"postgresql","slug":"/postgresql/flexboard-share","permalink":"/postgresql/flexboard-share","draft":false,"unlisted":false,"editUrl":"undefined/docs/postgresql/flexboard-share.mdx","tags":[],"version":"current","frontMatter":{"id":"flexboard-share","title":"Flex 보드 공유하기","description":"Flex 보드를 다른 계정의 사용자와 공유하고 재사용할 수 있습니다.","keywords":["PostgreSQL","Flex 보드"],"isTranslationMissing":false},"sidebar":"postgreSidebar","previous":{"title":"Flex 보드 화면 모드","permalink":"/postgresql/flexboard-mode"},"next":{"title":"카운트 추이 비교","permalink":"/postgresql/analysis-count-trend"}}')
...
;// CONCATENATED MODULE: ./docs/postgresql/flexboard-share.mdx
