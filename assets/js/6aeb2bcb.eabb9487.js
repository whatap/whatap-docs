"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["68293"], {
"15461": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_altibase_log_setting_mdx_6ae_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-altibase-log-setting-mdx-6ae.json
var site_docs_altibase_log_setting_mdx_6ae_namespaceObject = JSON.parse('{"id":"altibase/log-setting","title":"로그 설정","description":"로그 모니터링 설정 방법을 안내합니다.","source":"@site/docs/altibase/log-setting.mdx","sourceDirName":"altibase","slug":"/altibase/log-setting","permalink":"/altibase/log-setting","draft":false,"unlisted":false,"editUrl":"undefined/docs/altibase/log-setting.mdx","tags":[],"version":"current","frontMatter":{"id":"log-setting","title":"로그 설정","description":"로그 모니터링 설정 방법을 안내합니다.","toc_max_heading_level":3,"keywords":["로그","로그 모니터링","설정하기","Altibase"],"isTranslationMissing":false},"sidebar":"altibaseSidebar","previous":{"title":"로그 검색","permalink":"/altibase/log-search"},"next":{"title":"로그 파싱하기","permalink":"/altibase/log-parser"}}')
