"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[98205],{
...
const metadata = {
  "id": "oracle-v2/agent-manage",
  "title": "관리하기",
  "description": "whatap.conf 파일을 통해 데이터베이스 에이전트를 관리할 수 있습니다.",
  "source": "@site/docs/oracle-v2/agent-manage.mdx",
  "sourceDirName": "oracle-v2",
  "slug": "/oracle-v2/agent-manage",
  "permalink": "/whatap-docs/oracle-v2/agent-manage",
  "draft": false,
  "unlisted": false,
  "editUrl": "undefined/docs/oracle-v2/agent-manage.mdx",
  "tags": [
    {
      "inline": true,
      "label": "Oracle",
  ...
  "next": {
    "title": "대시보드",
    "permalink": "/whatap-docs/oracle-v2/dashboard-intro"
  }
};
const assets = {
