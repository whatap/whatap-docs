"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["30427"], {
...
"15735": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_php_metrics_chart_v_2_mdx_100_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-php-metrics-chart-v-2-mdx-100.json
var site_docs_php_metrics_chart_v_2_mdx_100_namespaceObject = JSON.parse('{"id":"php/metrics-chart-v2","title":"메트릭스 차트","description":"메트릭스 데이터를 차트로 조회할 수 있습니다.","source":"@site/docs/php/metrics-chart-v2.mdx","sourceDirName":"php","slug":"/php/metrics-chart-v2","permalink":"/php/metrics-chart-v2","draft":false,"unlisted":false,"editUrl":"undefined/docs/php/metrics-chart-v2.mdx","tags":[],"version":"current","frontMatter":{"id":"metrics-chart-v2","title":"메트릭스 차트","description":"메트릭스 데이터를 차트로 조회할 수 있습니다.","keywords":["PHP","애플리케이션","메트릭스","메트릭스 차트"],"isTranslationMissing":false},"sidebar":"phpSidebar","previous":{"title":"애플리케이션 성능 카운터","permalink":"/php/metrics-performance-counter"},"next":{"title":"메트릭스 차트","permalink":"/php/metrics-chart"}}')
...
;// CONCATENATED MODULE: ./docs/php/metrics-chart-v2.mdx
