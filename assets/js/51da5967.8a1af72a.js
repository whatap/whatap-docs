"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["35401"], {
...
"80703": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_mysql_slow_query_mdx_51d_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-mysql-slow-query-mdx-51d.json
var site_docs_mysql_slow_query_mdx_51d_namespaceObject = JSON.parse('{"id":"mysql/slow-query","title":"슬로우 쿼리","description":"특정 시점에 진행중이었던 세션을 파악해 느렸던 쿼리를 분석할 수 있습니다.","source":"@site/docs/mysql/slow-query.mdx","sourceDirName":"mysql","slug":"/mysql/slow-query","permalink":"/mysql/slow-query","draft":false,"unlisted":false,"editUrl":"undefined/docs/mysql/slow-query.mdx","tags":[],"version":"current","frontMatter":{"id":"slow-query","title":"슬로우 쿼리","description":"특정 시점에 진행중이었던 세션을 파악해 느렸던 쿼리를 분석할 수 있습니다.","keywords":["MySQL","인스턴스","대시보드","데이터베이스 모니터링","슬로우 쿼리"],"isTranslationMissing":false},"sidebar":"mysqlSidebar","previous":{"title":"멀티 인스턴스 모니터링","permalink":"/mysql/multi-instance-monitoring"},"next":{"title":"Flex 보드","permalink":"/mysql/flex-board"}}')
...
;// CONCATENATED MODULE: ./docs/mysql/slow-query.mdx
