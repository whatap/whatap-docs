...
// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_python_warning_notice_mdx_b74_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-python-warning-notice-mdx-b74.json
var site_docs_python_warning_notice_mdx_b74_namespaceObject = JSON.parse('{"id":"python/warning-notice","title":"애플리케이션 경고 알림","description":"애플리케이션의 자원 사용량 및, 진행 중 트랜잭션, 에러 상황의 이벤트 조건을 통해 경고 알림을 보냅니다.","source":"@site/docs/python/warning-notice.mdx","sourceDirName":"python","slug":"/python/warning-notice","permalink":"/python/warning-notice","draft":false,"unlisted":false,"editUrl":"undefined/docs/python/warning-notice.mdx","tags":[],"version":"current","frontMatter":{"id":"warning-notice","title":"애플리케이션 경고 알림","description":"애플리케이션의 자원 사용량 및, 진행 중 트랜잭션, 에러 상황의 이벤트 조건을 통해 경고 알림을 보냅니다.","keywords":["Python","경고 알림","애플리케이션"],"isTranslationMissing":false},"sidebar":"pySidebar","previous":{"title":"경고 알림","permalink":"/python/apm-set-notice"},"next":{"title":"이벤트 설정","permalink":"/python/warning-notice-v2"}}')
...
;// CONCATENATED MODULE: ./docs/python/warning-notice.mdx
