"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[1748],{
...
const metadata = {
  "id": "oracle-v2/analysis-compare-top-sql",
  "title": "Top SQL 비교",
  "description": "특정 날짜를 기준으로 설정된 시간대의 SQL의 추이를 비교하고 등락을 확인할 수 있습니다.",
  "source": "@site/docs/oracle-v2/analysis-compare-top-sql.mdx",
  "sourceDirName": "oracle-v2",
  "slug": "/oracle-v2/analysis-compare-top-sql",
  "permalink": "/whatap-docs/oracle-v2/analysis-compare-top-sql",
  "draft": false,
  "unlisted": false,
  "editUrl": "undefined/docs/oracle-v2/analysis-compare-top-sql.mdx",
  "tags": [
    {
      "inline": true,
      "label": "Oracle",
