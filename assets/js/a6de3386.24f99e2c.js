"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["86324"], {
...
"56466": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_mysql_monitoring_support_mdx_a6d_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-mysql-monitoring-support-mdx-a6d.json
var site_docs_mysql_monitoring_support_mdx_a6d_namespaceObject = JSON.parse('{"id":"mysql/monitoring-support","title":"지원 환경","description":"데이터베이스 모니터링을 시작하기 전에 지원하는 데이터베이스 종류에 대해서 알아보세요.","source":"@site/docs/mysql/monitoring-support.mdx","sourceDirName":"mysql","slug":"/mysql/monitoring-support","permalink":"/mysql/monitoring-support","draft":false,"unlisted":false,"editUrl":"undefined/docs/mysql/monitoring-support.mdx","tags":[],"version":"current","frontMatter":{"id":"monitoring-support","title":"지원 환경","description":"데이터베이스 모니터링을 시작하기 전에 지원하는 데이터베이스 종류에 대해서 알아보세요.","keywords":["MySQL","데이터베이스","데이터베이스 모니터링"],"isTranslationMissing":false},"sidebar":"mysqlSidebar","previous":{"title":"MySQL 모니터링","permalink":"/mysql/monitoring-intro"},"next":{"title":"에이전트 설치","permalink":"/mysql/install-agent"}}')
...
;// CONCATENATED MODULE: ./docs/mysql/monitoring-support.mdx
