"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["81727"], {
...
"71728": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_cubrid_monitoring_intro_mdx_36f_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-cubrid-monitoring-intro-mdx-36f.json
var site_docs_cubrid_monitoring_intro_mdx_36f_namespaceObject = JSON.parse('{"id":"cubrid/monitoring-intro","title":"CUBRID V2 모니터링","description":"와탭 데이터베이스 모니터링 서비스(DBX)은 Query 기반으로 데이터를 수집하여 성능 모니터링 서비스를 제공합니다.","source":"@site/docs/cubrid/monitoring-intro.mdx","sourceDirName":"cubrid","slug":"/cubrid/monitoring-intro","permalink":"/cubrid/monitoring-intro","draft":false,"unlisted":false,"editUrl":"undefined/docs/cubrid/monitoring-intro.mdx","tags":[],"version":"current","frontMatter":{"id":"monitoring-intro","title":"CUBRID V2 모니터링","description":"와탭 데이터베이스 모니터링 서비스(DBX)은 Query 기반으로 데이터를 수집하여 성능 모니터링 서비스를 제공합니다.","displayed_sidebar":"cubridSidebar","hide_table_of_contents":false,"keywords":["CUBRID","데이터베이스 모니터링","데이터베이스","모니터링","DBX"],"isTranslationMissing":false},"sidebar":"cubridSidebar","next":{"title":"지원 환경","permalink":"/cubrid/monitoring-support"}}')
...
;// CONCATENATED MODULE: ./docs/cubrid/monitoring-intro.mdx
