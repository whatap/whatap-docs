"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["12159"], {
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_dotnet_flexboard_share_mdx_1a4_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-dotnet-flexboard-share-mdx-1a4.json
var site_docs_dotnet_flexboard_share_mdx_1a4_namespaceObject = JSON.parse('{"id":"dotnet/flexboard-share","title":"Flex 보드 공유하기","description":"Flex 보드를 다른 계정의 사용자와 공유하고 재사용할 수 있습니다.","source":"@site/docs/dotnet/flexboard-share.mdx","sourceDirName":"dotnet","slug":"/dotnet/flexboard-share","permalink":"/dotnet/flexboard-share","draft":false,"unlisted":false,"editUrl":"undefined/docs/dotnet/flexboard-share.mdx","tags":[],"version":"current","frontMatter":{"id":"flexboard-share","title":"Flex 보드 공유하기","description":"Flex 보드를 다른 계정의 사용자와 공유하고 재사용할 수 있습니다.","keywords":[".NET","Flex 보드"],"isTranslationMissing":false},"sidebar":"dotNetSidebar","previous":{"title":"Flex 보드 화면 모드","permalink":"/dotnet/flexboard-mode"},"next":{"title":"분석","permalink":"/dotnet/analysis-report-intro"}}')
...
;// CONCATENATED MODULE: ./docs/dotnet/flexboard-share.mdx
