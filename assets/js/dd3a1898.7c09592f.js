"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["51476"], {
...
"11340": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_oracle_v_1_set_event_format_mdx_dd3_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-oracle-v-1-set-event-format-mdx-dd3.json
var site_docs_oracle_v_1_set_event_format_mdx_dd3_namespaceObject = JSON.parse('{"id":"oracle-v1/set-event-format","title":"이벤트 수신 포맷","description":"데이터베이스 모니터링에서 제공하는 경고 알림의 이벤트 수신 포맷에 대해 알아봅니다.","source":"@site/docs/oracle-v1/set-event-format.mdx","sourceDirName":"oracle-v1","slug":"/oracle-v1/set-event-format","permalink":"/oracle-v1/set-event-format","draft":false,"unlisted":false,"editUrl":"undefined/docs/oracle-v1/set-event-format.mdx","tags":[],"version":"current","frontMatter":{"id":"set-event-format","title":"이벤트 수신 포맷","description":"데이터베이스 모니터링에서 제공하는 경고 알림의 이벤트 수신 포맷에 대해 알아봅니다.","keywords":["Oracle","경고 알림","이벤트","데이터베이스","데이터베이스 모니터링","이벤트 수신 포맷"],"isTranslationMissing":false},"sidebar":"dboracleSidebar","previous":{"title":"이벤트 기록","permalink":"/oracle-v1/set-event-history"},"next":{"title":"실시간 알림","permalink":"/oracle-v1/real-time-notification"}}')
...
;// CONCATENATED MODULE: ./docs/oracle-v1/set-event-format.mdx
