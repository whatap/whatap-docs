"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["39078"], {
...
"85": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_php_php_os_redhat_centos_mdx_efb_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-php-php-os-redhat-centos-mdx-efb.json
var site_docs_php_php_os_redhat_centos_mdx_efb_namespaceObject = JSON.parse('{"id":"php/php-os/redhat-centos","title":"Red Hat/CentOS","description":"Red Hat/CentOS","source":"@site/docs/php/php-os/redhat-centos.mdx","sourceDirName":"php/php-os","slug":"/php/php-os/redhat-centos","permalink":"/php/php-os/redhat-centos","draft":false,"unlisted":false,"editUrl":"undefined/docs/php/php-os/redhat-centos.mdx","tags":[],"version":"current","frontMatter":{"id":"redhat-centos","title":"Red Hat/CentOS","description":"Red Hat/CentOS","keywords":["Red Hat","CentOSX","Linux","PHP"],"isTranslationMissing":false},"sidebar":"phpSidebar","previous":{"title":"에이전트 설치","permalink":"/php/install-agent"},"next":{"title":"Debian/Ubuntu","permalink":"/php/php-os/debian-ubuntu"}}')
...
;// CONCATENATED MODULE: ./docs/php/php-os/redhat-centos.mdx
