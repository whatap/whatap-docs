"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["57554"], {
...
"37279": (function (__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) {
__webpack_require__.d(__webpack_exports__, {
...
var DEFAULT_PIE_CONFIG = _chunk_P27NXTFD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .defaultConfig_default.pie */.vZ.pie;
var DEFAULT_PIE_DB = {
...
var getConfig2 = /* @__PURE__ */ (0,_chunk_P27NXTFD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */.eW)(() => structuredClone(config), "getConfig");
...
var addSection = /* @__PURE__ */ (0,_chunk_P27NXTFD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */.eW)(({ label, value }) => {
  if (!sections.has(label)) {
    sections.set(label, value);
    _chunk_P27NXTFD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .log.debug */.cM.debug(`added new section: ${label}, with value: ${value}`);
  }
}, "addSection");
var getSections = /* @__PURE__ */ (0,_chunk_P27NXTFD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */.eW)(() => sections, "getSections");
var setShowData = /* @__PURE__ */ (0,_chunk_P27NXTFD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */.eW)((toggle) => {
  showData = toggle;
}, "setShowData");
var getShowData = /* @__PURE__ */ (0,_chunk_P27NXTFD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */.eW)(() => showData, "getShowData");
var db = {
...
// src/diagrams/pie/pieParser.ts
var populateDb = /* @__PURE__ */ (0,_chunk_P27NXTFD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */.eW)((ast, db2) => {
  (0,_chunk_BAOP5US2_mjs__WEBPACK_IMPORTED_MODULE_0__/* .populateCommonDb */.A)(ast, db2);
...
var createPieArcs = /* @__PURE__ */ (0,_chunk_P27NXTFD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */.eW)((sections2) => {
...
var draw = /* @__PURE__ */ (0,_chunk_P27NXTFD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */.eW)((text, id, _version, diagObj) => {
  _chunk_P27NXTFD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .log.debug */.cM.debug("rendering pie chart\n" + text);
  const db2 = diagObj.db;
  const globalConfig = (0,_chunk_P27NXTFD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .getConfig2 */.nV)();
  const pieConfig = (0,_chunk_MCANT3UC_mjs__WEBPACK_IMPORTED_MODULE_1__/* .cleanAndMerge */.Rb)(db2.getConfig(), globalConfig.pie);
  const MARGIN = 40;
  ...
  let [outerStrokeWidth] = (0,_chunk_MCANT3UC_mjs__WEBPACK_IMPORTED_MODULE_1__/* .parseFontSize */.VG)(themeVariables.pieOuterStrokeWidth);
  outerStrokeWidth ??= 2;
  ...
  (0,_chunk_P27NXTFD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .configureSvgSize */.v2)(svg, height, totalWidth, pieConfig.useMaxWidth);
}, "draw");
var renderer = { draw };
