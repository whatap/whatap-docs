"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["22982"], {
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_mongodb_common_alert_mdx_1fb_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-mongodb-common-alert-mdx-1fb.json
var site_docs_mongodb_common_alert_mdx_1fb_namespaceObject = JSON.parse('{"id":"mongodb/common-alert","title":"시스템 이벤트 안내","description":"와탭 모니터링에서는 플랫폼 전반에서 자동으로 탐지 및 생성되는 공용 이벤트에 대해 안내합니다.","source":"@site/docs/mongodb/common-alert.mdx","sourceDirName":"mongodb","slug":"/mongodb/common-alert","permalink":"/mongodb/common-alert","draft":false,"unlisted":false,"editUrl":"undefined/docs/mongodb/common-alert.mdx","tags":[],"version":"current","frontMatter":{"id":"common-alert","title":"시스템 이벤트 안내","description":"와탭 모니터링에서는 플랫폼 전반에서 자동으로 탐지 및 생성되는 공용 이벤트에 대해 안내합니다.","keywords":["와탭","경고 알림","시스템 이벤트"],"isTranslationMissing":false},"sidebar":"mongodbSidebar","previous":{"title":"실시간 알림","permalink":"/mongodb/real-time-notification"},"next":{"title":"실험실","permalink":"/mongodb/labs"}}')
...
;// CONCATENATED MODULE: ./docs/mongodb/common-alert.mdx
