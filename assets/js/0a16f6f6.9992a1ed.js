"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["36244"], {
...
"10983": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_dotnet_set_event_history_mdx_0a1_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-dotnet-set-event-history-mdx-0a1.json
var site_docs_dotnet_set_event_history_mdx_0a1_namespaceObject = JSON.parse('{"id":"dotnet/set-event-history","title":"이벤트 기록","description":"이벤트 기록 메뉴를 통해 발생한 경고 알림 이력을 확인할 수 있습니다.","source":"@site/docs/dotnet/set-event-history.mdx","sourceDirName":"dotnet","slug":"/dotnet/set-event-history","permalink":"/dotnet/set-event-history","draft":false,"unlisted":false,"editUrl":"undefined/docs/dotnet/set-event-history.mdx","tags":[],"version":"current","frontMatter":{"id":"set-event-history","title":"이벤트 기록","description":"이벤트 기록 메뉴를 통해 발생한 경고 알림 이력을 확인할 수 있습니다.","keywords":[".NET","경고 알림","이벤트 기록","애플리케이션 모니터링"],"isTranslationMissing":false},"sidebar":"dotNetSidebar","previous":{"title":"이벤트 수신 설정","permalink":"/dotnet/set-receive-event"},"next":{"title":"이벤트 수신 포맷","permalink":"/dotnet/set-event-format"}}')
...
;// CONCATENATED MODULE: ./docs/dotnet/set-event-history.mdx
