"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["96428"], {
...
"20556": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_python_metric_warning_notice_new_mdx_fb6_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-python-metric-warning-notice-new-mdx-fb6.json
var site_docs_python_metric_warning_notice_new_mdx_fb6_namespaceObject = JSON.parse('{"id":"python/metric-warning-notice-new","title":"메트릭스 경고 알림","description":"구체적이고 복잡한 이벤트를 설정하려면 메트릭스 이벤트 설정을 사용하세요.","source":"@site/docs/python/metric-warning-notice-new.mdx","sourceDirName":"python","slug":"/python/metric-warning-notice-new","permalink":"/python/metric-warning-notice-new","draft":false,"unlisted":false,"editUrl":"undefined/docs/python/metric-warning-notice-new.mdx","tags":[],"version":"current","frontMatter":{"id":"metric-warning-notice-new","title":"메트릭스 경고 알림","description":"구체적이고 복잡한 이벤트를 설정하려면 메트릭스 이벤트 설정을 사용하세요.","displayed_sidebar":"pySidebar","keywords":["Python","경고 알림","메트릭스 이벤트"],"isTranslationMissing":false},"sidebar":"pySidebar"}')
...
;// CONCATENATED MODULE: ./docs/python/metric-warning-notice-new.mdx
