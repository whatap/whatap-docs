"use strict";
(self["webpackChunkwhatap_origin"] = self["webpackChunkwhatap_origin"] || []).push([[77954],{
...
const metadata = {
    ...
    "title": "Node.js 환경 설정",
    "description": "Node.js 에이전트의 기본 설정 방법을 제공합니다.",
    "source": "@site/docs/nodejs/set-agent.mdx",
...
function MDXContent(_param) {
    ...
    return /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)(MDXLayout, _object_spread_props(_object_spread({}, layoutProps, props), {
        ...
        parentName: "p"
    }, `whatap.conf`), ` 파일에 작성합니다. 에이전트는 환경변수를 통해 설정 파일의 위치를 파악하고 로딩합니다. 컨테이너나 PaaS 환경에서 Node.js 서버가 동작하는 경우 환경 변수를 통해 에이전트 설정을 구성합니다. 사용자의 편의성을 위해 `, /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("a", {
        parentName: "p",
        "href": "https://service.whatap.io"
