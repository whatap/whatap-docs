"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["74651"], {
...
"71596": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_dotnet_integrated_report_mdx_887_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-dotnet-integrated-report-mdx-887.json
var site_docs_dotnet_integrated_report_mdx_887_namespaceObject = JSON.parse('{"id":"dotnet/integrated-report","title":"통합 보고서","description":"통합 보고서를 안내합니다.","source":"@site/docs/dotnet/integrated-report.mdx","sourceDirName":"dotnet","slug":"/dotnet/integrated-report","permalink":"/dotnet/integrated-report","draft":false,"unlisted":false,"editUrl":"undefined/docs/dotnet/integrated-report.mdx","tags":[],"version":"current","frontMatter":{"id":"integrated-report","title":"통합 보고서","description":"통합 보고서를 안내합니다.","keywords":[".NET","통합 보고서","분석하기","UI"],"isTranslationMissing":false},"sidebar":"dotNetSidebar","previous":{"title":"애플리케이션 보고서","permalink":"/dotnet/report-apm"},"next":{"title":"경고 알림","permalink":"/dotnet/apm-set-notice"}}')
...
;// CONCATENATED MODULE: ./docs/dotnet/integrated-report.mdx
