"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[86118],{
...
const metadata = {
  "id": "cubrid-v1/metric-warning-notice-new",
  "title": "메트릭스 경고 알림",
  "description": "구체적이고 복잡한 이벤트를 설정하려면 메트릭스 이벤트 설정을 사용하세요.",
  "source": "@site/docs/cubrid-v1/metric-warning-notice-new.mdx",
  "sourceDirName": "cubrid-v1",
  "slug": "/cubrid-v1/metric-warning-notice-new",
  "permalink": "/whatap-docs/cubrid-v1/metric-warning-notice-new",
  "draft": false,
  "unlisted": false,
  "editUrl": "undefined/docs/cubrid-v1/metric-warning-notice-new.mdx",
  "tags": [],
  "version": "current",
  "frontMatter": {
    "id": "metric-warning-notice-new",
