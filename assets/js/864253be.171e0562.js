"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["63012"], {
...
"64403": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_oracle_pro_flexboard_mode_mdx_864_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-oracle-pro-flexboard-mode-mdx-864.json
var site_docs_oracle_pro_flexboard_mode_mdx_864_namespaceObject = JSON.parse('{"id":"oracle-pro/flexboard-mode","title":"Flex 보드 화면 모드","description":"Flex 보드의 화면 모드에 따라 제공하는 기능에 대해 알아보세요.","source":"@site/docs/oracle-pro/flexboard-mode.mdx","sourceDirName":"oracle-pro","slug":"/oracle-pro/flexboard-mode","permalink":"/oracle-pro/flexboard-mode","draft":false,"unlisted":false,"editUrl":"undefined/docs/oracle-pro/flexboard-mode.mdx","tags":[],"version":"current","frontMatter":{"id":"flexboard-mode","title":"Flex 보드 화면 모드","description":"Flex 보드의 화면 모드에 따라 제공하는 기능에 대해 알아보세요.","keywords":["Oracle Pro","DB","데이터베이스","데이터베이스","Flex 보드"],"isTranslationMissing":false},"sidebar":"dboracledmaSidebar","previous":{"title":"위젯 템플릿","permalink":"/oracle-pro/flexboard-widget-template"},"next":{"title":"Flex 보드 공유하기","permalink":"/oracle-pro/flexboard-share"}}')
...
;// CONCATENATED MODULE: ./docs/oracle-pro/flexboard-mode.mdx
