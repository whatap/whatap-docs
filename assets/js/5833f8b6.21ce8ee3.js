"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["35220"], {
...
"49937": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_golang_analysis_apm_trs_mdx_583_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-golang-analysis-apm-trs-mdx-583.json
var site_docs_golang_analysis_apm_trs_mdx_583_namespaceObject = JSON.parse('{"id":"golang/analysis-apm-trs","title":"통계","description":"Go 애플리케이션 환경에서 수집한 다양한 지표를 통해 통계 정보를 제공합니다.","source":"@site/docs/golang/analysis-apm-trs.mdx","sourceDirName":"golang","slug":"/golang/analysis-apm-trs","permalink":"/golang/analysis-apm-trs","draft":false,"unlisted":false,"editUrl":"undefined/docs/golang/analysis-apm-trs.mdx","tags":[],"version":"current","frontMatter":{"id":"analysis-apm-trs","title":"통계","description":"Go 애플리케이션 환경에서 수집한 다양한 지표를 통해 통계 정보를 제공합니다.","toc_max_heading_level":2,"keywords":["Go","트랜잭션","애플리케이션","분석하기","통계","UI"],"isTranslationMissing":false},"sidebar":"goSidebar","previous":{"title":"부가 기능","permalink":"/golang/topology-add-function"},"next":{"title":"보고서","permalink":"/golang/report-intro"}}')
...
;// CONCATENATED MODULE: ./docs/golang/analysis-apm-trs.mdx
