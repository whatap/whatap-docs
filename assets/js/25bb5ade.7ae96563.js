"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["97553"], {
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_tibero_stat_mdx_25b_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-tibero-stat-mdx-25b.json
var site_docs_tibero_stat_mdx_25b_namespaceObject = JSON.parse('{"id":"tibero/stat","title":"SQL 통계","description":"Tibero의 데이터베이스별 통계 데이터를 제공합니다.","source":"@site/docs/tibero/stat.mdx","sourceDirName":"tibero","slug":"/tibero/stat","permalink":"/tibero/stat","draft":false,"unlisted":false,"editUrl":"undefined/docs/tibero/stat.mdx","tags":[],"version":"current","frontMatter":{"id":"stat","title":"SQL 통계","description":"Tibero의 데이터베이스별 통계 데이터를 제공합니다.","keywords":["Tibero","데이터베이스","통계"],"isTranslationMissing":false},"sidebar":"tiberoSidebar","previous":{"title":"메트릭스 이상 탐지","permalink":"/tibero/metrics-detect-anormal"},"next":{"title":"테이블스페이스 사이즈","permalink":"/tibero/table-space-size"}}')
...
;// CONCATENATED MODULE: ./docs/tibero/stat.mdx
