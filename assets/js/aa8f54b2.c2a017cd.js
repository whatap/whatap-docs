"use strict";
(self["webpackChunkwhatap_origin"] = self["webpackChunkwhatap_origin"] || []).push([[27539],{
...
const metadata = {
    "unversionedId": "dotnet/metrics-chart",
    "id": "dotnet/metrics-chart",
    "title": "메트릭스 차트",
    "description": "메트릭스 데이터를 차트로 조회할 수 있습니다.",
    "source": "@site/docs/dotnet/metrics-chart.mdx",
    "sourceDirName": "dotnet",
    "slug": "/dotnet/metrics-chart",
    "permalink": "/whatap-docs/dotnet/metrics-chart",
    "draft": false,
    "editUrl": "undefined/docs/dotnet/metrics-chart.mdx",
    "tags": [
        {
            "label": "메트릭스",
    ...
    "previous": {
        "title": "메트릭스 조회",
        "permalink": "/whatap-docs/dotnet/metrics-search"
    },
    "next": {
        "title": "메트릭스 이상 탐지",
