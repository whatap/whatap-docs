"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["76276"], {
...
"64850": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_mssql_after_install_agent_mdx_9a5_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-mssql-after-install-agent-mdx-9a5.json
var site_docs_mssql_after_install_agent_mdx_9a5_namespaceObject = JSON.parse('{"id":"mssql/after-install-agent","title":"설치 점검 사항","description":"데이터베이스 모니터링 설치를 모두 완료했습니다. 설치 후 확인 사항을 점검하세요.","source":"@site/docs/mssql/after-install-agent.mdx","sourceDirName":"mssql","slug":"/mssql/after-install-agent","permalink":"/mssql/after-install-agent","draft":false,"unlisted":false,"editUrl":"undefined/docs/mssql/after-install-agent.mdx","tags":[],"version":"current","frontMatter":{"id":"after-install-agent","title":"설치 점검 사항","description":"데이터베이스 모니터링 설치를 모두 완료했습니다. 설치 후 확인 사항을 점검하세요.","keywords":["SQL Server","데이터베이스","에이전트"],"isTranslationMissing":false},"sidebar":"mssqlSidebar","previous":{"title":"에이전트 설치","permalink":"/mssql/install-agent"},"next":{"title":"설치 문제 해결","permalink":"/mssql/troubleshooting"}}')
...
;// CONCATENATED MODULE: ./docs/mssql/after-install-agent.mdx
...
const toc = [..._db_check_agent_log/* toc */.d$, ..._db_check_db_logs/* toc */.d$, ..._db_check_agent_process/* toc */.d$, ..._db_check_monitoring_agent_lists/* toc */.d$];
function _createMdxContent(props) {
  const _components = {
    p: "p",
