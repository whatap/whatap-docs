"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["38647"], {
...
"15190": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_oracle_pro_log_setting_mdx_87e_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-oracle-pro-log-setting-mdx-87e.json
var site_docs_oracle_pro_log_setting_mdx_87e_namespaceObject = JSON.parse('{"id":"oracle-pro/log-setting","title":"로그 설정","description":"로그 모니터링 설정 방법을 안내합니다.","source":"@site/docs/oracle-pro/log-setting.mdx","sourceDirName":"oracle-pro","slug":"/oracle-pro/log-setting","permalink":"/oracle-pro/log-setting","draft":false,"unlisted":false,"editUrl":"undefined/docs/oracle-pro/log-setting.mdx","tags":[],"version":"current","frontMatter":{"id":"log-setting","title":"로그 설정","description":"로그 모니터링 설정 방법을 안내합니다.","toc_max_heading_level":3,"keywords":["로그","로그 모니터링","설정하기","Oracle Pro"],"isTranslationMissing":false},"sidebar":"dboracledmaSidebar","previous":{"title":"로그 검색","permalink":"/oracle-pro/log-search"},"next":{"title":"로그 파싱하기","permalink":"/oracle-pro/log-parser"}}')
...
;// CONCATENATED MODULE: ./docs/oracle-pro/log-setting.mdx
