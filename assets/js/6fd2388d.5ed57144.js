"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["82585"], {
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_oracle_pro_metrics_chart_v_2_mdx_6fd_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-oracle-pro-metrics-chart-v-2-mdx-6fd.json
var site_docs_oracle_pro_metrics_chart_v_2_mdx_6fd_namespaceObject = JSON.parse('{"id":"oracle-pro/metrics-chart-v2","title":"메트릭스 차트","description":"메트릭스 데이터를 차트로 조회할 수 있습니다.","source":"@site/docs/oracle-pro/metrics-chart-v2.mdx","sourceDirName":"oracle-pro","slug":"/oracle-pro/metrics-chart-v2","permalink":"/oracle-pro/metrics-chart-v2","draft":false,"unlisted":false,"editUrl":"undefined/docs/oracle-pro/metrics-chart-v2.mdx","tags":[],"version":"current","frontMatter":{"id":"metrics-chart-v2","title":"메트릭스 차트","description":"메트릭스 데이터를 차트로 조회할 수 있습니다.","keywords":["Oracle Pro","데이터베이스","메트릭스","메트릭스 차트"],"isTranslationMissing":false},"sidebar":"dboracledmaSidebar","previous":{"title":"Oracle Pro 지표","permalink":"/oracle-pro/metrics-data-list"},"next":{"title":"메트릭스 차트","permalink":"/oracle-pro/metrics-chart"}}')
...
;// CONCATENATED MODULE: ./docs/oracle-pro/metrics-chart-v2.mdx
