"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["28749"], {
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_oracle_set_event_format_mdx_3f5_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-oracle-set-event-format-mdx-3f5.json
var site_docs_oracle_set_event_format_mdx_3f5_namespaceObject = JSON.parse('{"id":"oracle/set-event-format","title":"이벤트 수신 포맷","description":"데이터베이스 모니터링에서 제공하는 경고 알림의 이벤트 수신 포맷에 대해 알아봅니다.","source":"@site/docs/oracle/set-event-format.mdx","sourceDirName":"oracle","slug":"/oracle/set-event-format","permalink":"/oracle/set-event-format","draft":false,"unlisted":false,"editUrl":"undefined/docs/oracle/set-event-format.mdx","tags":[],"version":"current","frontMatter":{"id":"set-event-format","title":"이벤트 수신 포맷","description":"데이터베이스 모니터링에서 제공하는 경고 알림의 이벤트 수신 포맷에 대해 알아봅니다.","keywords":["Oracle","경고 알림","이벤트","데이터베이스","데이터베이스","이벤트 수신 포맷"],"isTranslationMissing":false},"sidebar":"dboracleV2Sidebar","previous":{"title":"이벤트 기록","permalink":"/oracle/set-event-history"},"next":{"title":"실시간 알림","permalink":"/oracle/real-time-notification"}}')
...
;// CONCATENATED MODULE: ./docs/oracle/set-event-format.mdx
