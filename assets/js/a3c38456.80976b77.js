"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[69760],{
...
const metadata = {
  "id": "cubrid-v1/report-intro",
  "title": "보고서",
  "description": "개별 프로젝트에 대해 서비스 이용 현황과 장애 발생 기록을 보고하는 문서에 대해 알아봅니다.",
  "source": "@site/docs/cubrid-v1/report-intro.mdx",
  "sourceDirName": "cubrid-v1",
  "slug": "/cubrid-v1/report-intro",
  "permalink": "/whatap-docs/cubrid-v1/report-intro",
  "draft": false,
  "unlisted": false,
  "editUrl": "undefined/docs/cubrid-v1/report-intro.mdx",
  "tags": [],
  "version": "current",
  "frontMatter": {
    "id": "report-intro",
