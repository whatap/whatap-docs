"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["17356"], {
...
"18031": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_golang_topology_basic_mdx_c88_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-golang-topology-basic-mdx-c88.json
var site_docs_golang_topology_basic_mdx_c88_namespaceObject = JSON.parse('{"id":"golang/topology-basic","title":"기본 사용법","description":"토폴로지 메뉴에서 기본 동작 방법을 알아봅니다.","source":"@site/docs/golang/topology-basic.mdx","sourceDirName":"golang","slug":"/golang/topology-basic","permalink":"/golang/topology-basic","draft":false,"unlisted":false,"editUrl":"undefined/docs/golang/topology-basic.mdx","tags":[],"version":"current","frontMatter":{"id":"topology-basic","title":"기본 사용법","description":"토폴로지 메뉴에서 기본 동작 방법을 알아봅니다.","keywords":["Go","토폴로지"],"isTranslationMissing":false},"sidebar":"goSidebar","previous":{"title":"토폴로지","permalink":"/golang/topology"},"next":{"title":"유형별 토폴로지","permalink":"/golang/topology-type"}}')
...
;// CONCATENATED MODULE: ./docs/golang/topology-basic.mdx
