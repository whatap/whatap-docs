"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[4733],{
...
/* harmony import */ var _common_items_metrics_warning_notice_db_mdx__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(22489);
...
const metadata = {
  "id": "oracle-v1/metric-warning-notice-new",
  "title": "메트릭스 경고 알림",
  "description": "구체적이고 복잡한 이벤트를 설정하려면 메트릭스 이벤트 설정을 사용하세요.",
  "source": "@site/docs/oracle-v1/metric-warning-notice-new.mdx",
  "sourceDirName": "oracle-v1",
  "slug": "/oracle-v1/metric-warning-notice-new",
  "permalink": "/whatap-docs/oracle-v1/metric-warning-notice-new",
  "draft": false,
  "unlisted": false,
  "editUrl": "undefined/docs/oracle-v1/metric-warning-notice-new.mdx",
  "tags": [],
  "version": "current",
  "frontMatter": {
    "id": "metric-warning-notice-new",
