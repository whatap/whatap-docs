"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["16291"], {
...
"98092": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_mssql_v_1_instance_monitoring_mdx_5b9_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-mssql-v-1-instance-monitoring-mdx-5b9.json
var site_docs_mssql_v_1_instance_monitoring_mdx_5b9_namespaceObject = JSON.parse('{"id":"mssql-v1/instance-monitoring","title":"인스턴스 모니터링","description":"인스턴스 모니터링 메뉴에서는 데이터베이스 서버의 핵심 지표들에 대한 상세 정보를 실시간으로 확인할 수 있습니다.","source":"@site/docs/mssql-v1/instance-monitoring.mdx","sourceDirName":"mssql-v1","slug":"/mssql-v1/instance-monitoring","permalink":"/mssql-v1/instance-monitoring","draft":false,"unlisted":false,"editUrl":"undefined/docs/mssql-v1/instance-monitoring.mdx","tags":[],"version":"current","frontMatter":{"id":"instance-monitoring","title":"인스턴스 모니터링","description":"인스턴스 모니터링 메뉴에서는 데이터베이스 서버의 핵심 지표들에 대한 상세 정보를 실시간으로 확인할 수 있습니다.","keywords":["SQL Server","인스턴스","대시보드","데이터베이스"],"isTranslationMissing":false},"sidebar":"mssqlV1Sidebar","previous":{"title":"인스턴스 목록","permalink":"/mssql-v1/instance-list"},"next":{"title":"멀티 인스턴스 모니터링","permalink":"/mssql-v1/multi-instance-monitoring"}}')
...
;// CONCATENATED MODULE: ./docs/mssql-v1/instance-monitoring.mdx
...
const toc = [..._db_instance_monitoring_desc/* toc */.d$, {
  ...
  "id": "기본-화면-안내",
  "level": 2
}, ..._db_instance_monitoring_basic_usage/* toc */.d$, ..._db_select_metric_data_widget/* toc */.d$, ..._db_set_layout/* toc */.d$, ..._db_using_area_active_session/* toc */.d$, ..._db_query_details/* toc */.d$, ..._db_data_edit_column/* toc */.d$, ..._db_mssql_column/* toc */.d$];
function _createMdxContent(props) {
  const _components = {
    h2: "h2",
    section: "section",
