"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["64110"], {
...
"9555": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_kubernetes_set_event_log_mdx_333_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-kubernetes-set-event-log-mdx-333.json
var site_docs_kubernetes_set_event_log_mdx_333_namespaceObject = JSON.parse('{"id":"kubernetes/set-event-log","title":"로그 경고 알림","description":"로그 메시지를 필터링해 경고 알림을 설정할 수 있습니다.","source":"@site/docs/kubernetes/set-event-log.mdx","sourceDirName":"kubernetes","slug":"/kubernetes/set-event-log","permalink":"/kubernetes/set-event-log","draft":false,"unlisted":false,"editUrl":"undefined/docs/kubernetes/set-event-log.mdx","tags":[],"version":"current","frontMatter":{"id":"set-event-log","title":"로그 경고 알림","description":"로그 메시지를 필터링해 경고 알림을 설정할 수 있습니다.","keywords":["경고 알림","로그","쿠버네티스","쿠버네티스 모니터링"],"isTranslationMissing":false},"sidebar":"kubeSidebar","previous":{"title":"이상치 탐지 경고 알림","permalink":"/kubernetes/set-event-detect-anomal"},"next":{"title":"이벤트 수신 설정","permalink":"/kubernetes/set-receive-event"}}')
...
;// CONCATENATED MODULE: ./docs/kubernetes/set-event-log.mdx
