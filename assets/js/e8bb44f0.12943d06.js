"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["90481"], {
"23026": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_altibase_report_intro_mdx_e8b_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-altibase-report-intro-mdx-e8b.json
var site_docs_altibase_report_intro_mdx_e8b_namespaceObject = JSON.parse('{"id":"altibase/report-intro","title":"보고서","description":"개별 프로젝트에 대해 서비스 이용 현황과 장애 발생 기록을 보고하는 문서에 대해 알아봅니다.","source":"@site/docs/altibase/report-intro.mdx","sourceDirName":"altibase","slug":"/altibase/report-intro","permalink":"/altibase/report-intro","draft":false,"unlisted":false,"editUrl":"undefined/docs/altibase/report-intro.mdx","tags":[],"version":"current","frontMatter":{"id":"report-intro","title":"보고서","description":"개별 프로젝트에 대해 서비스 이용 현황과 장애 발생 기록을 보고하는 문서에 대해 알아봅니다.","keywords":["Altibase","데이터베이스","보고서"],"isTranslationMissing":false},"sidebar":"altibaseSidebar","previous":{"title":"테이블스페이스 사이즈","permalink":"/altibase/table-space-size"},"next":{"title":"로그","permalink":"/altibase/log-main"}}')
...
;// CONCATENATED MODULE: ./docs/altibase/report-intro.mdx
