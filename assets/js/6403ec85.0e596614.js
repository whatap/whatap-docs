"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["5182"], {
...
"17122": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_python_dashboard_hitmap_trace_mdx_640_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-python-dashboard-hitmap-trace-mdx-640.json
var site_docs_python_dashboard_hitmap_trace_mdx_640_namespaceObject = JSON.parse('{"id":"python/dashboard-hitmap-trace","title":"히트맵 - 트레이스 분석","description":"히트맵 위젯을 통해 트레이스 분석 창을 열어 트랜잭션 목록과 각 트랜잭션 하위의 스텝 정보를 한 번에 확인할 수 있습니다.","source":"@site/docs/python/dashboard-hitmap-trace.mdx","sourceDirName":"python","slug":"/python/dashboard-hitmap-trace","permalink":"/python/dashboard-hitmap-trace","draft":false,"unlisted":false,"editUrl":"undefined/docs/python/dashboard-hitmap-trace.mdx","tags":[],"version":"current","frontMatter":{"id":"dashboard-hitmap-trace","title":"히트맵 - 트레이스 분석","description":"히트맵 위젯을 통해 트레이스 분석 창을 열어 트랜잭션 목록과 각 트랜잭션 하위의 스텝 정보를 한 번에 확인할 수 있습니다.","keywords":["Python","애플리케이션","히트맵","트레이스"],"isTranslationMissing":false},"sidebar":"pySidebar","previous":{"title":"액티브 트랜잭션","permalink":"/python/dashboard-active-transaction"},"next":{"title":"Flex 보드","permalink":"/python/flex-board"}}')
...
;// CONCATENATED MODULE: ./docs/python/dashboard-hitmap-trace.mdx
