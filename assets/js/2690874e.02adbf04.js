"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["86073"], {
...
"65851": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_oracle_analysis_wait_events_mdx_269_namespaceObject),
  contentTitle: () => (/* binding */ analysis_wait_events_contentTitle),
  "default": () => (/* binding */ analysis_wait_events_MDXContent),
  assets: () => (/* binding */ assets),
  toc: () => (/* binding */ analysis_wait_events_toc),
  frontMatter: () => (/* binding */ analysis_wait_events_frontMatter)
});

;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-oracle-analysis-wait-events-mdx-269.json
var site_docs_oracle_analysis_wait_events_mdx_269_namespaceObject = JSON.parse('{"id":"oracle/analysis-wait-events","title":"Wait 분석","description":"수행 중인 세션이 어떤 대기 이벤트로 대기 중인지, 빈번하게 발생하는 대기 이벤트들은 무엇인지 확인할 수 있습니다.","source":"@site/docs/oracle/analysis-wait-events.mdx","sourceDirName":"oracle","slug":"/oracle/analysis-wait-events","permalink":"/oracle/analysis-wait-events","draft":false,"unlisted":false,"editUrl":"undefined/docs/oracle/analysis-wait-events.mdx","tags":[],"version":"current","frontMatter":{"id":"analysis-wait-events","title":"Wait 분석","description":"수행 중인 세션이 어떤 대기 이벤트로 대기 중인지, 빈번하게 발생하는 대기 이벤트들은 무엇인지 확인할 수 있습니다.","keywords":["Oracle","데이터베이스","분석","Wait 분석"],"isTranslationMissing":false},"sidebar":"dboracleV2Sidebar","previous":{"title":"세션 히스토리","permalink":"/oracle/analysis-session-history"},"next":{"title":"SQL 분석","permalink":"/oracle/analysis-sql"}}')
...
;// CONCATENATED MODULE: ./docs/common-items/_db-analysis-wait-event-basic-guide.mdx
...
;// CONCATENATED MODULE: ./docs/oracle/analysis-wait-events.mdx


const analysis_wait_events_frontMatter = {
...
const analysis_wait_events_contentTitle = undefined;
...
const analysis_wait_events_toc = [..._import_v2_note/* toc */.d$, ..._db_analysis_wait_event_short_desc/* toc */.d$, ...toc, ..._db_table_data_filtering/* toc */.d$, ..._db_v2_data_edit_column/* toc */.d$];
function analysis_wait_events_createMdxContent(props) {
...
function analysis_wait_events_MDXContent(props = {}) {
  const {wrapper: MDXLayout} = {
    ...(0,lib/* useMDXComponents */.a)(),
    ...props.components
  };
  return MDXLayout ? (0,jsx_runtime.jsx)(MDXLayout, {
    ...props,
    children: (0,jsx_runtime.jsx)(analysis_wait_events_createMdxContent, {
      ...props
    })
  }) : analysis_wait_events_createMdxContent(props);
}
