"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[2658],{
...
const metadata = {
  "id": "amazon-ecs/real-time-notification",
  "title": "실시간 알림",
  "description": "이벤트 설정 메뉴를 통해서 설정한 경고 알림을 실시간으로 확인할 수 있습니다.",
  "source": "@site/docs/amazon-ecs/real-time-notification.mdx",
  "sourceDirName": "amazon-ecs",
  "slug": "/amazon-ecs/real-time-notification",
  "permalink": "/whatap-docs/amazon-ecs/real-time-notification",
  "draft": false,
  "unlisted": false,
  "editUrl": "undefined/docs/amazon-ecs/real-time-notification.mdx",
  "tags": [],
  "version": "current",
  "frontMatter": {
    "id": "real-time-notification",
  ...
  "next": {
    "title": "시스템 이벤트 안내",
    "permalink": "/whatap-docs/amazon-ecs/common-alert"
  }
};
const assets = {
