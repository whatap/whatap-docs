"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["30633"], {
...
"93526": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_oracle_log_setting_mdx_c46_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-oracle-log-setting-mdx-c46.json
var site_docs_oracle_log_setting_mdx_c46_namespaceObject = JSON.parse('{"id":"oracle/log-setting","title":"로그 설정","description":"로그 모니터링 설정 방법을 안내합니다.","source":"@site/docs/oracle/log-setting.mdx","sourceDirName":"oracle","slug":"/oracle/log-setting","permalink":"/oracle/log-setting","draft":false,"unlisted":false,"editUrl":"undefined/docs/oracle/log-setting.mdx","tags":[],"version":"current","frontMatter":{"id":"log-setting","title":"로그 설정","description":"로그 모니터링 설정 방법을 안내합니다.","toc_max_heading_level":3,"keywords":["로그","로그 모니터링","설정하기","Oracle"],"isTranslationMissing":false},"sidebar":"dboracleV2Sidebar","previous":{"title":"로그 검색","permalink":"/oracle/log-search"},"next":{"title":"로그 파싱하기","permalink":"/oracle/log-parser"}}')
...
;// CONCATENATED MODULE: ./docs/oracle/log-setting.mdx
