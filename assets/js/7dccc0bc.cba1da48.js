"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["71266"], {
...
"65870": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_postgresql_database_size_mdx_7dc_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-postgresql-database-size-mdx-7dc.json
var site_docs_postgresql_database_size_mdx_7dc_namespaceObject = JSON.parse('{"id":"postgresql/database-size","title":"데이터베이스 사이즈","description":"PostgreSQL 데이터베이스별 테이블의 사이즈를 집계하여 추이 정보를 차트로 제공합니다.","source":"@site/docs/postgresql/database-size.mdx","sourceDirName":"postgresql","slug":"/postgresql/database-size","permalink":"/postgresql/database-size","draft":false,"unlisted":false,"editUrl":"undefined/docs/postgresql/database-size.mdx","tags":[],"version":"current","frontMatter":{"id":"database-size","title":"데이터베이스 사이즈","description":"PostgreSQL 데이터베이스별 테이블의 사이즈를 집계하여 추이 정보를 차트로 제공합니다.","keywords":["PostgreSQL","데이터베이스","데이터베이스 사이즈"],"isTranslationMissing":false},"sidebar":"postgreSidebar","previous":{"title":"PG SQL 통계","permalink":"/postgresql/pg-sql-stat"},"next":{"title":"보고서","permalink":"/postgresql/report-intro"}}')
...
;// CONCATENATED MODULE: ./docs/postgresql/database-size.mdx
