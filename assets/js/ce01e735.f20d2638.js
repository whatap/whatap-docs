"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[2754],{
...
const metadata = {
  "id": "ncloud/real-time-notification",
  "title": "실시간 알림",
  "description": "이벤트 설정 메뉴를 통해서 설정한 경고 알림을 실시간으로 확인할 수 있습니다.",
  "source": "@site/docs/ncloud/real-time-notification.mdx",
  "sourceDirName": "ncloud",
  "slug": "/ncloud/real-time-notification",
  "permalink": "/whatap-docs/ncloud/real-time-notification",
  "draft": false,
  "unlisted": false,
  "editUrl": "undefined/docs/ncloud/real-time-notification.mdx",
  "tags": [],
  "version": "current",
  "frontMatter": {
    "id": "real-time-notification",
  ...
  "next": {
    "title": "시스템 이벤트 안내",
    "permalink": "/whatap-docs/ncloud/common-alert"
  }
};
const assets = {
