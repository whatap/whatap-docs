"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["61708"], {
...
"70495": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_golang_set_agent_mdx_e18_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-golang-set-agent-mdx-e18.json
var site_docs_golang_set_agent_mdx_e18_namespaceObject = JSON.parse('{"id":"golang/set-agent","title":"설정하기","description":"Go 에이전트의 기본 설정 방법을 제공합니다.","source":"@site/docs/golang/set-agent.mdx","sourceDirName":"golang","slug":"/golang/set-agent","permalink":"/golang/set-agent","draft":false,"unlisted":false,"editUrl":"undefined/docs/golang/set-agent.mdx","tags":[],"version":"current","frontMatter":{"id":"set-agent","title":"설정하기","description":"Go 에이전트의 기본 설정 방법을 제공합니다.","keywords":["Go","설정하기"],"isTranslationMissing":false},"sidebar":"goSidebar","previous":{"title":"설치 점검 사항","permalink":"/golang/install-check"},"next":{"title":"에이전트 이름 식별","permalink":"/golang/agent-name"}}')
...
;// CONCATENATED MODULE: ./docs/golang/set-agent.mdx
...
function _createMdxContent(props) {
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsxs)(_components.p, {
      ...
      children: ["별도 설정이 없는 경우 에이전트는 자기 자신이 위치한 경로에서 ", (0,jsx_runtime.jsx)(_components.em, {
        children: "whatap.conf"
