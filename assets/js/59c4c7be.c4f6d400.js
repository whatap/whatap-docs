"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["45309"], {
...
"44304": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_java_agent_name_mdx_59c_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-java-agent-name-mdx-59c.json
var site_docs_java_agent_name_mdx_59c_namespaceObject = JSON.parse('{"id":"java/agent-name","title":"에이전트 이름 식별","description":"모니터링 대상을 구별하기 위한 애플리케이션 서버의 고유 식별자 설정에 대해 안내합니다. 모니터링 대상 시스템 내에서 애플리케이션 서버를 정확히 구분하는 데 필수적입니다. 서버 유형, IP 등의 정보를 기반으로 한 자동 이름 지정 방식과 사용자가 직접 whatap.conf 파일이나 JVM 옵션을 통해 에이전트 이름을 설정하는 방법을 확인할 수 있습니다.","source":"@site/docs/java/agent-name.mdx","sourceDirName":"java","slug":"/java/agent-name","permalink":"/java/agent-name","draft":false,"unlisted":false,"editUrl":"undefined/docs/java/agent-name.mdx","tags":[],"version":"current","frontMatter":{"id":"agent-name","title":"에이전트 이름 식별","description":"모니터링 대상을 구별하기 위한 애플리케이션 서버의 고유 식별자 설정에 대해 안내합니다. 모니터링 대상 시스템 내에서 애플리케이션 서버를 정확히 구분하는 데 필수적입니다. 서버 유형, IP 등의 정보를 기반으로 한 자동 이름 지정 방식과 사용자가 직접 whatap.conf 파일이나 JVM 옵션을 통해 에이전트 이름을 설정하는 방법을 확인할 수 있습니다.","keywords":["Java","애플리케이션","에이전트","whatap.conf"],"isTranslationMissing":false},"sidebar":"javaSidebar","previous":{"title":"에이전트 설정","permalink":"/java/set-agent"},"next":{"title":"에이전트 기능 제어","permalink":"/java/agent-control-function"}}')
...
const agent_name_toc = [..._apm_name_description/* toc */.d$, ..._agent_name_warning/* toc */.d$, {
  "value": "기본 이름 결정 방식",
  "id": "기본-이름-결정-방식",
  "level": 2
}, {
  ...
  "id": "에이전트-이름-설정",
  "level": 2
}, ...toc, ..._agent_name_okind_onode_desc/* toc */.d$];
function agent_name_createMdxContent(props) {
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsx)(_apm_name_description/* default */.ZP, {}), "\n", "\n", (0,jsx_runtime.jsx)(_agent_name_warning/* default */.ZP, {}), "\n", (0,jsx_runtime.jsx)(_components.admonition, {
      ...
      }), (0,jsx_runtime.jsx)(MDXContent, {}), (0,jsx_runtime.jsx)(_agent_name_okind_onode_desc/* default */.ZP, {})]
    })]
  });
}
