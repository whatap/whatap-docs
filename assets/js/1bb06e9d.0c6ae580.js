"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["70060"], {
...
"98182": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_golang_set_event_history_mdx_1bb_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-golang-set-event-history-mdx-1bb.json
var site_docs_golang_set_event_history_mdx_1bb_namespaceObject = JSON.parse('{"id":"golang/set-event-history","title":"이벤트 기록","description":"이벤트 기록 메뉴를 통해 발생한 경고 알림 이력을 확인할 수 있습니다.","source":"@site/docs/golang/set-event-history.mdx","sourceDirName":"golang","slug":"/golang/set-event-history","permalink":"/golang/set-event-history","draft":false,"unlisted":false,"editUrl":"undefined/docs/golang/set-event-history.mdx","tags":[],"version":"current","frontMatter":{"id":"set-event-history","title":"이벤트 기록","description":"이벤트 기록 메뉴를 통해 발생한 경고 알림 이력을 확인할 수 있습니다.","keywords":["Go","경고 알림","이벤트 기록","애플리케이션 모니터링"],"isTranslationMissing":false},"sidebar":"goSidebar","previous":{"title":"이벤트 수신 설정","permalink":"/golang/set-receive-event"},"next":{"title":"이벤트 수신 포맷","permalink":"/golang/set-event-format"}}')
...
;// CONCATENATED MODULE: ./docs/golang/set-event-history.mdx
