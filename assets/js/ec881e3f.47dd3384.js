"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["52690"], {
...
"88374": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_mssql_v_1_agent_manage_mdx_ec8_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-mssql-v-1-agent-manage-mdx-ec8.json
var site_docs_mssql_v_1_agent_manage_mdx_ec8_namespaceObject = JSON.parse('{"id":"mssql-v1/agent-manage","title":"관리하기","description":"whatap.conf 파일을 통해 데이터베이스 에이전트를 관리할 수 있습니다.","source":"@site/docs/mssql-v1/agent-manage.mdx","sourceDirName":"mssql-v1","slug":"/mssql-v1/agent-manage","permalink":"/mssql-v1/agent-manage","draft":false,"unlisted":false,"editUrl":"undefined/docs/mssql-v1/agent-manage.mdx","tags":[],"version":"current","frontMatter":{"id":"agent-manage","title":"관리하기","description":"whatap.conf 파일을 통해 데이터베이스 에이전트를 관리할 수 있습니다.","keywords":["SQL Server","데이터베이스"],"isTranslationMissing":false},"sidebar":"mssqlV1Sidebar","previous":{"title":"DBX 에이전트 설정","permalink":"/mssql-v1/agent-dbx-settings"},"next":{"title":"대시보드","permalink":"/mssql-v1/dashboard-intro"}}')
...
;// CONCATENATED MODULE: ./docs/mssql-v1/agent-manage.mdx
