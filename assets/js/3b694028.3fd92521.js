"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["56719"], {
...
"26037": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_redis_set_event_detect_anomal_mdx_3b6_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-redis-set-event-detect-anomal-mdx-3b6.json
var site_docs_redis_set_event_detect_anomal_mdx_3b6_namespaceObject = JSON.parse('{"id":"redis/set-event-detect-anomal","title":"이상치 탐지 경고 알림","description":"예상치 못한 패턴을 찾는 일련의 활동을 탐지해 경고 알림을 보내도록 설정할 수 있습니다.","source":"@site/docs/redis/set-event-detect-anomal.mdx","sourceDirName":"redis","slug":"/redis/set-event-detect-anomal","permalink":"/redis/set-event-detect-anomal","draft":false,"unlisted":false,"editUrl":"undefined/docs/redis/set-event-detect-anomal.mdx","tags":[],"version":"current","frontMatter":{"id":"set-event-detect-anomal","title":"이상치 탐지 경고 알림","description":"예상치 못한 패턴을 찾는 일련의 활동을 탐지해 경고 알림을 보내도록 설정할 수 있습니다.","keywords":["Redis","경고 알림","이상치 탐지","데이터베이스 모니터링"],"isTranslationMissing":false},"sidebar":"redisSidebar","previous":{"title":"알림 메시지 사용자 정의","permalink":"/redis/set-notification-message"},"next":{"title":"이벤트 수신 설정","permalink":"/redis/set-receive-event"}}')
...
;// CONCATENATED MODULE: ./docs/redis/set-event-detect-anomal.mdx
