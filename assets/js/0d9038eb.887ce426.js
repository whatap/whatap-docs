"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["77118"], {
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_mysql_set_event_detect_anomal_mdx_0d9_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-mysql-set-event-detect-anomal-mdx-0d9.json
var site_docs_mysql_set_event_detect_anomal_mdx_0d9_namespaceObject = JSON.parse('{"id":"mysql/set-event-detect-anomal","title":"이상치 탐지 경고 알림","description":"예상치 못한 패턴을 찾는 일련의 활동을 탐지해 경고 알림을 보내도록 설정할 수 있습니다.","source":"@site/docs/mysql/set-event-detect-anomal.mdx","sourceDirName":"mysql","slug":"/mysql/set-event-detect-anomal","permalink":"/mysql/set-event-detect-anomal","draft":false,"unlisted":false,"editUrl":"undefined/docs/mysql/set-event-detect-anomal.mdx","tags":[],"version":"current","frontMatter":{"id":"set-event-detect-anomal","title":"이상치 탐지 경고 알림","description":"예상치 못한 패턴을 찾는 일련의 활동을 탐지해 경고 알림을 보내도록 설정할 수 있습니다.","keywords":["MySQL","경고 알림","이상치 탐지","데이터베이스 모니터링"],"isTranslationMissing":false},"sidebar":"mysqlSidebar","previous":{"title":"알림 메시지 사용자 정의","permalink":"/mysql/set-notification-message"},"next":{"title":"로그 알림 설정하기","permalink":"/mysql/set-event-log"}}')
...
;// CONCATENATED MODULE: ./docs/mysql/set-event-detect-anomal.mdx
