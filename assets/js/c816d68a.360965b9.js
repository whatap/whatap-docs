"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["77358"], {
...
"98657": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_tibero_flexboard_widget_template_mdx_c81_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-tibero-flexboard-widget-template-mdx-c81.json
var site_docs_tibero_flexboard_widget_template_mdx_c81_namespaceObject = JSON.parse('{"id":"tibero/flexboard-widget-template","title":"위젯 템플릿","description":"Flex 보드에서 대시보드에 배치할 수 있는 위젯의 종류를 안내합니다.","source":"@site/docs/tibero/flexboard-widget-template.mdx","sourceDirName":"tibero","slug":"/tibero/flexboard-widget-template","permalink":"/tibero/flexboard-widget-template","draft":false,"unlisted":false,"editUrl":"undefined/docs/tibero/flexboard-widget-template.mdx","tags":[],"version":"current","frontMatter":{"id":"flexboard-widget-template","title":"위젯 템플릿","description":"Flex 보드에서 대시보드에 배치할 수 있는 위젯의 종류를 안내합니다.","keywords":["Flex 보드","위젯","템플릿"],"isTranslationMissing":false},"sidebar":"tiberoSidebar","previous":{"title":"위젯 관리하기","permalink":"/tibero/flexboard-widget-manage"},"next":{"title":"Flex 보드 화면 모드","permalink":"/tibero/flexboard-mode"}}')
...
;// CONCATENATED MODULE: ./docs/tibero/flexboard-widget-template.mdx
