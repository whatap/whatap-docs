"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["26754"], {
...
"20157": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_oracle_agent_dbx_settings_mdx_e39_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-oracle-agent-dbx-settings-mdx-e39.json
var site_docs_oracle_agent_dbx_settings_mdx_e39_namespaceObject = JSON.parse('{"id":"oracle/agent-dbx-settings","title":"DBX 에이전트 설정","description":"whatap.conf 파일에 설정할 수 있는 옵션에 대해 안내합니다.","source":"@site/docs/oracle/agent-dbx-settings.mdx","sourceDirName":"oracle","slug":"/oracle/agent-dbx-settings","permalink":"/oracle/agent-dbx-settings","draft":false,"unlisted":false,"editUrl":"undefined/docs/oracle/agent-dbx-settings.mdx","tags":[],"version":"current","frontMatter":{"id":"agent-dbx-settings","title":"DBX 에이전트 설정","description":"whatap.conf 파일에 설정할 수 있는 옵션에 대해 안내합니다.","keywords":["Oracle","데이터베이스 모니터링","DBX 에이전트"],"isTranslationMissing":false},"sidebar":"dboracleV2Sidebar","previous":{"title":"설정하기","permalink":"/oracle/agent-settings"},"next":{"title":"XOS 에이전트 설정","permalink":"/oracle/agent-xos-settings"}}')
...
;// CONCATENATED MODULE: ./docs/oracle/agent-dbx-settings.mdx
