"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["50836"], {
...
"57397": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_java_flexboard_mode_mdx_440_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-java-flexboard-mode-mdx-440.json
var site_docs_java_flexboard_mode_mdx_440_namespaceObject = JSON.parse('{"id":"java/flexboard-mode","title":"Flex 보드 화면 모드","description":"Flex 보드의 화면 모드에 따라 제공하는 기능에 대해 알아보세요.","source":"@site/docs/java/flexboard-mode.mdx","sourceDirName":"java","slug":"/java/flexboard-mode","permalink":"/java/flexboard-mode","draft":false,"unlisted":false,"editUrl":"undefined/docs/java/flexboard-mode.mdx","tags":[],"version":"current","frontMatter":{"id":"flexboard-mode","title":"Flex 보드 화면 모드","description":"Flex 보드의 화면 모드에 따라 제공하는 기능에 대해 알아보세요.","keywords":["Java","애플리케이션","애플리케이션 모니터링","Flex 보드"],"isTranslationMissing":false},"sidebar":"javaSidebar","previous":{"title":"위젯 템플릿","permalink":"/java/flexboard-widget-template"},"next":{"title":"Flex 보드 공유하기","permalink":"/java/flexboard-share"}}')
...
;// CONCATENATED MODULE: ./docs/java/flexboard-mode.mdx
