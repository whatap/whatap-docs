"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["94544"], {
...
"34908": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_mongodb_labs_mdx_643_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-mongodb-labs-mdx-643.json
var site_docs_mongodb_labs_mdx_643_namespaceObject = JSON.parse('{"id":"mongodb/labs","title":"실험실","description":"사용자에게 새로운 기능 또는 실험적인 기능을 제공하는 메뉴인 실험실에 대해 안내합니다.","source":"@site/docs/mongodb/labs.mdx","sourceDirName":"mongodb","slug":"/mongodb/labs","permalink":"/mongodb/labs","draft":false,"unlisted":false,"editUrl":"undefined/docs/mongodb/labs.mdx","tags":[],"version":"current","frontMatter":{"id":"labs","title":"실험실","description":"사용자에게 새로운 기능 또는 실험적인 기능을 제공하는 메뉴인 실험실에 대해 안내합니다.","keywords":["MongoDB","데이터베이스","실험실"],"isTranslationMissing":false},"sidebar":"mongodbSidebar","previous":{"title":"시스템 이벤트 안내","permalink":"/mongodb/common-alert"}}')
...
;// CONCATENATED MODULE: ./docs/mongodb/labs.mdx
