"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["15393"], {
...
"13014": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_postgresql_after_install_agent_mdx_9d2_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-postgresql-after-install-agent-mdx-9d2.json
var site_docs_postgresql_after_install_agent_mdx_9d2_namespaceObject = JSON.parse('{"id":"postgresql/after-install-agent","title":"설치 점검 사항","description":"데이터베이스 모니터링 설치를 모두 완료했습니다. 설치 후 확인 사항을 점검하세요.","source":"@site/docs/postgresql/after-install-agent.mdx","sourceDirName":"postgresql","slug":"/postgresql/after-install-agent","permalink":"/postgresql/after-install-agent","draft":false,"unlisted":false,"editUrl":"undefined/docs/postgresql/after-install-agent.mdx","tags":[],"version":"current","frontMatter":{"id":"after-install-agent","title":"설치 점검 사항","description":"데이터베이스 모니터링 설치를 모두 완료했습니다. 설치 후 확인 사항을 점검하세요.","keywords":["PostgreSQL","데이터베이스 모니터링","에이전트"],"isTranslationMissing":false},"sidebar":"postgreSidebar","previous":{"title":"빠른 에이전트 설정","permalink":"/postgresql/install-agent-quick-setup"},"next":{"title":"설치 문제 해결","permalink":"/postgresql/troubleshooting"}}')
...
;// CONCATENATED MODULE: ./docs/postgresql/after-install-agent.mdx
