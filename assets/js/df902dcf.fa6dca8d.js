"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["43786"], {
...
"97975": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_php_topology_add_function_mdx_df9_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-php-topology-add-function-mdx-df9.json
var site_docs_php_topology_add_function_mdx_df9_namespaceObject = JSON.parse('{"id":"php/topology-add-function","title":"부가 기능","description":"토폴로지 메뉴에서 이용할 수 있는 부가 기능에 대한 설명을 제공합니다.","source":"@site/docs/php/topology-add-function.mdx","sourceDirName":"php","slug":"/php/topology-add-function","permalink":"/php/topology-add-function","draft":false,"unlisted":false,"editUrl":"undefined/docs/php/topology-add-function.mdx","tags":[],"version":"current","frontMatter":{"id":"topology-add-function","title":"부가 기능","description":"토폴로지 메뉴에서 이용할 수 있는 부가 기능에 대한 설명을 제공합니다.","keywords":["PHP","토폴로지"],"isTranslationMissing":false},"sidebar":"phpSidebar","previous":{"title":"유형별 토폴로지","permalink":"/php/topology-type"},"next":{"title":"에이전트 옵션 설정","permalink":"/php/topology-settings"}}')
...
;// CONCATENATED MODULE: ./docs/php/topology-add-function.mdx
