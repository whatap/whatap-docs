"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["50493"], {
...
"3082": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_redis_labs_mdx_a9d_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-redis-labs-mdx-a9d.json
var site_docs_redis_labs_mdx_a9d_namespaceObject = JSON.parse('{"id":"redis/labs","title":"실험실","description":"사용자에게 새로운 기능 또는 실험적인 기능을 제공하는 메뉴인 실험실에 대해 안내합니다.","source":"@site/docs/redis/labs.mdx","sourceDirName":"redis","slug":"/redis/labs","permalink":"/redis/labs","draft":false,"unlisted":false,"editUrl":"undefined/docs/redis/labs.mdx","tags":[],"version":"current","frontMatter":{"id":"labs","title":"실험실","description":"사용자에게 새로운 기능 또는 실험적인 기능을 제공하는 메뉴인 실험실에 대해 안내합니다.","keywords":["Redis","데이터베이스","실험실"],"isTranslationMissing":false},"sidebar":"redisSidebar","previous":{"title":"시스템 이벤트 안내","permalink":"/redis/common-alert"}}')
...
;// CONCATENATED MODULE: ./docs/redis/labs.mdx
