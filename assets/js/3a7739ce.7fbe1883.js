"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["75339"], {
...
"32390": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_php_metrics_detect_anormal_mdx_3a7_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-php-metrics-detect-anormal-mdx-3a7.json
var site_docs_php_metrics_detect_anormal_mdx_3a7_namespaceObject = JSON.parse('{"id":"php/metrics-detect-anormal","title":"메트릭스 이상 탐지","description":"다양한 메트릭스 지표의 패턴을 AI가 학습한 예상 패턴과 비교해 볼 수 있습니다.","source":"@site/docs/php/metrics-detect-anormal.mdx","sourceDirName":"php","slug":"/php/metrics-detect-anormal","permalink":"/php/metrics-detect-anormal","draft":false,"unlisted":false,"editUrl":"undefined/docs/php/metrics-detect-anormal.mdx","tags":[],"version":"current","frontMatter":{"id":"metrics-detect-anormal","title":"메트릭스 이상 탐지","description":"다양한 메트릭스 지표의 패턴을 AI가 학습한 예상 패턴과 비교해 볼 수 있습니다.","keywords":["PHP","메트릭스","이상 탐지"],"isTranslationMissing":false},"sidebar":"phpSidebar","previous":{"title":"메트릭스 조회","permalink":"/php/metrics-search"},"next":{"title":"트랜잭션","permalink":"/php/track-transactions-intro"}}')
...
;// CONCATENATED MODULE: ./docs/php/metrics-detect-anormal.mdx
