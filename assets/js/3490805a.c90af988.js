"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["78966"], {
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_python_flexboard_mode_mdx_349_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-python-flexboard-mode-mdx-349.json
var site_docs_python_flexboard_mode_mdx_349_namespaceObject = JSON.parse('{"id":"python/flexboard-mode","title":"Flex 보드 화면 모드","description":"Flex 보드의 화면 모드에 따라 제공하는 기능에 대해 알아보세요.","source":"@site/docs/python/flexboard-mode.mdx","sourceDirName":"python","slug":"/python/flexboard-mode","permalink":"/python/flexboard-mode","draft":false,"unlisted":false,"editUrl":"undefined/docs/python/flexboard-mode.mdx","tags":[],"version":"current","frontMatter":{"id":"flexboard-mode","title":"Flex 보드 화면 모드","description":"Flex 보드의 화면 모드에 따라 제공하는 기능에 대해 알아보세요.","keywords":["Python","애플리케이션","애플리케이션 모니터링","Flex 보드"],"isTranslationMissing":false},"sidebar":"pySidebar","previous":{"title":"위젯 템플릿","permalink":"/python/flexboard-widget-template"},"next":{"title":"Flex 보드 공유하기","permalink":"/python/flexboard-share"}}')
...
;// CONCATENATED MODULE: ./docs/python/flexboard-mode.mdx
