"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[40127],{
...
const metadata = {
  "id": "oracle-v2/log-exp",
  "title": "로그 트렌드",
  "description": "로그 모니터링의 로그 트렌드 메뉴를 안내합니다.",
  "source": "@site/docs/oracle-v2/log-exp.mdx",
  "sourceDirName": "oracle-v2",
  "slug": "/oracle-v2/log-exp",
  "permalink": "/whatap-docs/oracle-v2/log-exp",
  "draft": false,
  "unlisted": false,
  "editUrl": "undefined/docs/oracle-v2/log-exp.mdx",
  "tags": [
    {
      "inline": true,
      "label": "로그 모니터링",
