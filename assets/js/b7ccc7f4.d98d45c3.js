"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["29018"], {
...
"96194": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_log_log_go_mdx_b7c_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-log-log-go-mdx-b7c.json
var site_docs_log_log_go_mdx_b7c_namespaceObject = JSON.parse('{"id":"log/log-go","title":"Go","description":"Go 애플리케이션에서 로그를 수집하는 방법을 안내합니다.","source":"@site/docs/log/log-go.mdx","sourceDirName":"log","slug":"/log/log-go","permalink":"/log/log-go","draft":false,"unlisted":false,"editUrl":"undefined/docs/log/log-go.mdx","tags":[],"version":"current","frontMatter":{"id":"log-go","title":"Go","description":"Go 애플리케이션에서 로그를 수집하는 방법을 안내합니다.","keywords":["로그 모니터링","Go","로그"],"isTranslationMissing":false},"sidebar":"logSidebar","previous":{"title":"Python","permalink":"/log/log-python"},"next":{"title":"Server","permalink":"/log/log-server"}}')
...
;// CONCATENATED MODULE: ./docs/log/log-go.mdx
