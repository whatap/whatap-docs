"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["61639"], {
"85879": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_aws_log_set_event_history_mdx_08d_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-aws-log-set-event-history-mdx-08d.json
var site_docs_aws_log_set_event_history_mdx_08d_namespaceObject = JSON.parse('{"id":"aws-log/set-event-history","title":"이벤트 기록","description":"이벤트 기록 메뉴를 통해 발생한 경고 알림 이력을 확인할 수 있습니다.","source":"@site/docs/aws-log/set-event-history.mdx","sourceDirName":"aws-log","slug":"/aws-log/set-event-history","permalink":"/aws-log/set-event-history","draft":false,"unlisted":false,"editUrl":"undefined/docs/aws-log/set-event-history.mdx","tags":[],"version":"current","frontMatter":{"id":"set-event-history","title":"이벤트 기록","description":"이벤트 기록 메뉴를 통해 발생한 경고 알림 이력을 확인할 수 있습니다.","keywords":["AWS Log","경고 알림","이벤트 기록"],"isTranslationMissing":false},"sidebar":"awslogSidebar","previous":{"title":"이벤트 수신 설정","permalink":"/aws-log/set-receive-event"},"next":{"title":"실시간 알림","permalink":"/aws-log/real-time-notification"}}')
...
;// CONCATENATED MODULE: ./docs/aws-log/set-event-history.mdx
