"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["1118"], {
"80674": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_amazon_ecs_set_receive_event_mdx_2b7_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-amazon-ecs-set-receive-event-mdx-2b7.json
var site_docs_amazon_ecs_set_receive_event_mdx_2b7_namespaceObject = JSON.parse('{"id":"amazon-ecs/set-receive-event","title":"이벤트 수신 설정","description":"프로젝트에 포함하는 멤버들의 경고 알림 수신과 관련한 다양한 기능을 설정할 수 있습니다.","source":"@site/docs/amazon-ecs/set-receive-event.mdx","sourceDirName":"amazon-ecs","slug":"/amazon-ecs/set-receive-event","permalink":"/amazon-ecs/set-receive-event","draft":false,"unlisted":false,"editUrl":"undefined/docs/amazon-ecs/set-receive-event.mdx","tags":[],"version":"current","frontMatter":{"id":"set-receive-event","title":"이벤트 수신 설정","description":"프로젝트에 포함하는 멤버들의 경고 알림 수신과 관련한 다양한 기능을 설정할 수 있습니다.","keywords":["Amazon ECS","경고 알림","이벤트 수신 태그"],"isTranslationMissing":false},"sidebar":"awsecsSidebar","previous":{"title":"메트릭스 경고 알림","permalink":"/amazon-ecs/metric-warning-notice"},"next":{"title":"이벤트 기록","permalink":"/amazon-ecs/set-event-history"}}')
...
;// CONCATENATED MODULE: ./docs/amazon-ecs/set-receive-event.mdx
