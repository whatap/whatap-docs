"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["90787"], {
...
"37797": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_redis_monitoring_support_mdx_9d7_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-redis-monitoring-support-mdx-9d7.json
var site_docs_redis_monitoring_support_mdx_9d7_namespaceObject = JSON.parse('{"id":"redis/monitoring-support","title":"지원 환경","description":"데이터베이스 모니터링을 시작하기 전에 지원하는 데이터베이스 종류에 대해서 알아보세요.","source":"@site/docs/redis/monitoring-support.mdx","sourceDirName":"redis","slug":"/redis/monitoring-support","permalink":"/redis/monitoring-support","draft":false,"unlisted":false,"editUrl":"undefined/docs/redis/monitoring-support.mdx","tags":[],"version":"current","frontMatter":{"id":"monitoring-support","title":"지원 환경","description":"데이터베이스 모니터링을 시작하기 전에 지원하는 데이터베이스 종류에 대해서 알아보세요.","keywords":["Redis","데이터베이스","데이터베이스 모니터링"],"isTranslationMissing":false},"sidebar":"redisSidebar","previous":{"title":"Redis 모니터링","permalink":"/redis/monitoring-intro"},"next":{"title":"에이전트 설치","permalink":"/redis/install-agent"}}')
...
;// CONCATENATED MODULE: ./docs/redis/monitoring-support.mdx
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsx)(_import_db_support_env_desc/* default */.ZP, {
      ...
      children: [(0,jsx_runtime.jsx)(_components.h2, {
        ...
        children: "Redis 3.2 버전 이상을 지원합니다."
