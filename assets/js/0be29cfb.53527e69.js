"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["88996"], {
...
"22496": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_postgresql_metrics_chart_mdx_0be_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-postgresql-metrics-chart-mdx-0be.json
var site_docs_postgresql_metrics_chart_mdx_0be_namespaceObject = JSON.parse('{"id":"postgresql/metrics-chart","title":"메트릭스 차트","description":"메트릭스 데이터를 차트로 조회할 수 있습니다.","source":"@site/docs/postgresql/metrics-chart.mdx","sourceDirName":"postgresql","slug":"/postgresql/metrics-chart","permalink":"/postgresql/metrics-chart","draft":false,"unlisted":false,"editUrl":"undefined/docs/postgresql/metrics-chart.mdx","tags":[],"version":"current","frontMatter":{"id":"metrics-chart","title":"메트릭스 차트","description":"메트릭스 데이터를 차트로 조회할 수 있습니다.","keywords":["메트릭스","메트릭스 차트","UI"],"isTranslationMissing":false},"sidebar":"postgreSidebar","previous":{"title":"메트릭스 차트","permalink":"/postgresql/metrics-chart-v2"},"next":{"title":"메트릭스 조회","permalink":"/postgresql/metrics-search"}}')
...
;// CONCATENATED MODULE: ./docs/postgresql/metrics-chart.mdx
