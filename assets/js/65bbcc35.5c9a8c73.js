"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["3841"], {
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_kubernetes_hitmap_notice_mdx_65b_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-kubernetes-hitmap-notice-mdx-65b.json
var site_docs_kubernetes_hitmap_notice_mdx_65b_namespaceObject = JSON.parse('{"id":"kubernetes/hitmap-notice","title":"AI 기반의 히트맵 패턴 경고 알림","description":"애플리케이션 실행 분포 패턴을 머신 러닝을 통해 자동 인식하여 경고 알림을 보냅니다.","source":"@site/docs/kubernetes/hitmap-notice.mdx","sourceDirName":"kubernetes","slug":"/kubernetes/hitmap-notice","permalink":"/kubernetes/hitmap-notice","draft":false,"unlisted":false,"editUrl":"undefined/docs/kubernetes/hitmap-notice.mdx","tags":[],"version":"current","frontMatter":{"id":"hitmap-notice","title":"AI 기반의 히트맵 패턴 경고 알림","description":"애플리케이션 실행 분포 패턴을 머신 러닝을 통해 자동 인식하여 경고 알림을 보냅니다.","keywords":["히트맵","경고 알림","쿠버네티스","쿠버네티스 모니터링"],"isTranslationMissing":false},"sidebar":"kubeSidebar","previous":{"title":"알림 메시지 사용자 정의","permalink":"/kubernetes/set-notification-message"},"next":{"title":"이상치 탐지 경고 알림","permalink":"/kubernetes/set-event-detect-anomal"}}')
...
;// CONCATENATED MODULE: ./docs/kubernetes/hitmap-notice.mdx
