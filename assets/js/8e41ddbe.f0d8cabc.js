"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["85905"], {
"65374": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
"30585": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_java_agent_network_mdx_8e4_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-java-agent-network-mdx-8e4.json
var site_docs_java_agent_network_mdx_8e4_namespaceObject = JSON.parse('{"id":"java/agent-network","title":"에이전트 통신 설정","description":"자바(Java) 에이전트가 애플리케이션 서버로부터 수집한 데이터를 서버로 전송하기 위한 네트워크 설정 방법을 안내합니다. 주요 설정 옵션으로는 수집 서버 호스트, 포트, 타임아웃 값, 네트워크 전송 크기, 데이터 전송 큐 크기 등이 있으며, 에이전트의 효율적인 데이터 관리 및 안정적인 서버 통신을 보장하는 데 중요합니다.","source":"@site/docs/java/agent-network.mdx","sourceDirName":"java","slug":"/java/agent-network","permalink":"/java/agent-network","draft":false,"unlisted":false,"editUrl":"undefined/docs/java/agent-network.mdx","tags":[],"version":"current","frontMatter":{"id":"agent-network","title":"에이전트 통신 설정","description":"자바(Java) 에이전트가 애플리케이션 서버로부터 수집한 데이터를 서버로 전송하기 위한 네트워크 설정 방법을 안내합니다. 주요 설정 옵션으로는 수집 서버 호스트, 포트, 타임아웃 값, 네트워크 전송 크기, 데이터 전송 큐 크기 등이 있으며, 에이전트의 효율적인 데이터 관리 및 안정적인 서버 통신을 보장하는 데 중요합니다.","keywords":["Java","애플리케이션","에이전트"],"isTranslationMissing":false},"sidebar":"javaSidebar","previous":{"title":"CPU/메모리/디스크 사용량 수집","permalink":"/java/agent-usage"},"next":{"title":"에이전트 성능","permalink":"/java/agent-performance"}}')
// EXTERNAL MODULE: ./node_modules/react/jsx-runtime.js
var jsx_runtime = __webpack_require__("85893");
// EXTERNAL MODULE: ./node_modules/@mdx-js/react/lib/index.js
var lib = __webpack_require__("50065");
// EXTERNAL MODULE: ./docs/common-items/_common-network.mdx
var _common_network = __webpack_require__("65374");
;// CONCATENATED MODULE: ./docs/java/agent-network.mdx
...
const toc = [..._common_network/* toc */.d$];
function _createMdxContent(props) {
  const _components = {
    code: "code",
    li: "li",
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsx)(_common_network/* default */.ZP, {}), "\n", (0,jsx_runtime.jsxs)(_components.ul, {
