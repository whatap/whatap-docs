"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["76591"], {
...
"26684": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_cubrid_v_1_flexboard_widget_template_mdx_fb9_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-cubrid-v-1-flexboard-widget-template-mdx-fb9.json
var site_docs_cubrid_v_1_flexboard_widget_template_mdx_fb9_namespaceObject = JSON.parse('{"id":"cubrid-v1/flexboard-widget-template","title":"위젯 템플릿","description":"Flex 보드에서 대시보드에 배치할 수 있는 위젯의 종류를 안내합니다.","source":"@site/docs/cubrid-v1/flexboard-widget-template.mdx","sourceDirName":"cubrid-v1","slug":"/cubrid-v1/flexboard-widget-template","permalink":"/cubrid-v1/flexboard-widget-template","draft":false,"unlisted":false,"editUrl":"undefined/docs/cubrid-v1/flexboard-widget-template.mdx","tags":[],"version":"current","frontMatter":{"id":"flexboard-widget-template","title":"위젯 템플릿","description":"Flex 보드에서 대시보드에 배치할 수 있는 위젯의 종류를 안내합니다.","keywords":["Flex 보드","위젯","템플릿"],"isTranslationMissing":false},"sidebar":"cubridV1Sidebar","previous":{"title":"위젯 관리하기","permalink":"/cubrid-v1/flexboard-widget-manage"},"next":{"title":"Flex 보드 화면 모드","permalink":"/cubrid-v1/flexboard-mode"}}')
...
;// CONCATENATED MODULE: ./docs/cubrid-v1/flexboard-widget-template.mdx
