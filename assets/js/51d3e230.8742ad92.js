"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["86240"], {
...
"56103": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_redis_dashboard_intro_mdx_51d_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-redis-dashboard-intro-mdx-51d.json
var site_docs_redis_dashboard_intro_mdx_51d_namespaceObject = JSON.parse('{"id":"redis/dashboard-intro","title":"대시보드","description":"와탭 모니터링 대시보드는 Redis 데이터베이스 프로젝트의 전체 현황을 한 눈에 파악하기 위한 기능을 제공합니다.","source":"@site/docs/redis/dashboard-intro.mdx","sourceDirName":"redis","slug":"/redis/dashboard-intro","permalink":"/redis/dashboard-intro","draft":false,"unlisted":false,"editUrl":"undefined/docs/redis/dashboard-intro.mdx","tags":[],"version":"current","frontMatter":{"id":"dashboard-intro","title":"대시보드","description":"와탭 모니터링 대시보드는 Redis 데이터베이스 프로젝트의 전체 현황을 한 눈에 파악하기 위한 기능을 제공합니다.","keywords":["Redis","대시보드","인스턴스","데이터베이스"],"isTranslationMissing":false},"sidebar":"redisSidebar","previous":{"title":"관리하기","permalink":"/redis/agent-manage"},"next":{"title":"인스턴스 목록","permalink":"/redis/instance-list"}}')
...
;// CONCATENATED MODULE: ./docs/redis/dashboard-intro.mdx
