"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["40553"], {
...
"33980": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_mysql_install_agent_quick_setup_mdx_16f_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-mysql-install-agent-quick-setup-mdx-16f.json
var site_docs_mysql_install_agent_quick_setup_mdx_16f_namespaceObject = JSON.parse('{"id":"mysql/install-agent-quick-setup","title":"빠른 에이전트 설정","description":"DBX 에이전트의 구성 파일 중 setup.sh 파일을 실행하면 에이전트 설정을 빠르고 쉽게 진행할 수 있습니다.","source":"@site/docs/mysql/install-agent-quick-setup.mdx","sourceDirName":"mysql","slug":"/mysql/install-agent-quick-setup","permalink":"/mysql/install-agent-quick-setup","draft":false,"unlisted":false,"editUrl":"undefined/docs/mysql/install-agent-quick-setup.mdx","tags":[],"version":"current","frontMatter":{"id":"install-agent-quick-setup","title":"빠른 에이전트 설정","description":"DBX 에이전트의 구성 파일 중 setup.sh 파일을 실행하면 에이전트 설정을 빠르고 쉽게 진행할 수 있습니다.","keywords":["MySQL","데이터베이스","에이전트"],"isTranslationMissing":false},"sidebar":"mysqlSidebar","previous":{"title":"에이전트 설치","permalink":"/mysql/install-agent"},"next":{"title":"설치 점검 사항","permalink":"/mysql/after-install-agent"}}')
...
;// CONCATENATED MODULE: ./docs/mysql/install-agent-quick-setup.mdx
