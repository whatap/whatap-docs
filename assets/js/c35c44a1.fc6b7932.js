"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[47599],{
...
const metadata = {
  ...
  "title": "대시보드",
  "description": "와탭 모니터링 대시보드는 프로젝트의 전체 현황을 한 눈에 파악하기 위한 기능을 제공합니다.",
  "source": "@site/docs/oracle-v2/dashboard-intro.mdx",
  "sourceDirName": "oracle-v2",
  "slug": "/oracle-v2/dashboard-intro",
  "permalink": "/whatap-docs/oracle-v2/dashboard-intro",
  "draft": false,
  "unlisted": false,
  "editUrl": "undefined/docs/oracle-v2/dashboard-intro.mdx",
  "tags": [
    {
      "inline": true,
      "label": "Oracle",
