"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["22000"], {
...
"24073": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_dotnet_set_agent_mdx_830_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-dotnet-set-agent-mdx-830.json
var site_docs_dotnet_set_agent_mdx_830_namespaceObject = JSON.parse('{"id":"dotnet/set-agent","title":"설정하기","description":".NET 에이전트의 기본 설정 방법을 제공합니다.","source":"@site/docs/dotnet/set-agent.mdx","sourceDirName":"dotnet","slug":"/dotnet/set-agent","permalink":"/dotnet/set-agent","draft":false,"unlisted":false,"editUrl":"undefined/docs/dotnet/set-agent.mdx","tags":[],"version":"current","frontMatter":{"id":"set-agent","title":"설정하기","description":".NET 에이전트의 기본 설정 방법을 제공합니다.","keywords":[".NET","환경 설정"],"isTranslationMissing":false},"sidebar":"dotNetSidebar","previous":{"title":"빠른 설치 및 문제 해결","permalink":"/dotnet/quick-start"},"next":{"title":"에이전트 이름 식별","permalink":"/dotnet/agent-name"}}')
...
;// CONCATENATED MODULE: ./docs/dotnet/set-agent.mdx
