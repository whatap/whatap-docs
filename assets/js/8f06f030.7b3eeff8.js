"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["51034"], {
...
"88470": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_php_topology_basic_mdx_8f0_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-php-topology-basic-mdx-8f0.json
var site_docs_php_topology_basic_mdx_8f0_namespaceObject = JSON.parse('{"id":"php/topology-basic","title":"기본 사용법","description":"토폴로지 메뉴에서 기본 동작 방법을 알아봅니다.","source":"@site/docs/php/topology-basic.mdx","sourceDirName":"php","slug":"/php/topology-basic","permalink":"/php/topology-basic","draft":false,"unlisted":false,"editUrl":"undefined/docs/php/topology-basic.mdx","tags":[],"version":"current","frontMatter":{"id":"topology-basic","title":"기본 사용법","description":"토폴로지 메뉴에서 기본 동작 방법을 알아봅니다.","keywords":["PHP","토폴로지"],"isTranslationMissing":false},"sidebar":"phpSidebar","previous":{"title":"토폴로지","permalink":"/php/topology"},"next":{"title":"유형별 토폴로지","permalink":"/php/topology-type"}}')
...
;// CONCATENATED MODULE: ./docs/php/topology-basic.mdx
