"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[88071],{
...
const metadata = {
  "id": "oracle-v2/check-ipckey",
  "title": "ipckey 값 확인하기",
  "description": "한 서버에 여러 개의 데이터베이스를 설치한 환경에서 ipckey를 확인하는 방법을 안내합니다.",
  "source": "@site/docs/oracle-v2/check-ipckey.mdx",
  "sourceDirName": "oracle-v2",
  "slug": "/oracle-v2/check-ipckey",
  "permalink": "/whatap-docs/oracle-v2/check-ipckey",
  "draft": false,
  "unlisted": false,
  "editUrl": "undefined/docs/oracle-v2/check-ipckey.mdx",
  "tags": [
    {
      "inline": true,
      "label": "Oracle",
