"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["57353"], {
...
"50143": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_mongodb_monitoring_intro_mdx_9e4_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-mongodb-monitoring-intro-mdx-9e4.json
var site_docs_mongodb_monitoring_intro_mdx_9e4_namespaceObject = JSON.parse('{"id":"mongodb/monitoring-intro","title":"MongoDB 모니터링","description":"와탭 MongoDB 데이터베이스 모니터링 서비스(DBX)은 Query 기반으로 데이터를 수집하여 성능 모니터링 서비스를 제공합니다.","source":"@site/docs/mongodb/monitoring-intro.mdx","sourceDirName":"mongodb","slug":"/mongodb/monitoring-intro","permalink":"/mongodb/monitoring-intro","draft":false,"unlisted":false,"editUrl":"undefined/docs/mongodb/monitoring-intro.mdx","tags":[],"version":"current","frontMatter":{"id":"monitoring-intro","title":"MongoDB 모니터링","description":"와탭 MongoDB 데이터베이스 모니터링 서비스(DBX)은 Query 기반으로 데이터를 수집하여 성능 모니터링 서비스를 제공합니다.","displayed_sidebar":"mongodbSidebar","hide_table_of_contents":false,"keywords":["MongoDB","데이터베이스","모니터링","DBX"],"isTranslationMissing":false},"sidebar":"mongodbSidebar","next":{"title":"지원 환경","permalink":"/mongodb/monitoring-support"}}')
...
;// CONCATENATED MODULE: ./docs/mongodb/monitoring-intro.mdx
