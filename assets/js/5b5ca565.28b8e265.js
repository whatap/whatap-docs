"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["56567"], {
...
"54893": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_tibero_monitoring_support_mdx_5b5_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-tibero-monitoring-support-mdx-5b5.json
var site_docs_tibero_monitoring_support_mdx_5b5_namespaceObject = JSON.parse('{"id":"tibero/monitoring-support","title":"지원 환경","description":"데이터베이스 모니터링을 시작하기 전에 지원하는 데이터베이스 종류에 대해서 알아보세요.","source":"@site/docs/tibero/monitoring-support.mdx","sourceDirName":"tibero","slug":"/tibero/monitoring-support","permalink":"/tibero/monitoring-support","draft":false,"unlisted":false,"editUrl":"undefined/docs/tibero/monitoring-support.mdx","tags":[],"version":"current","frontMatter":{"id":"monitoring-support","title":"지원 환경","description":"데이터베이스 모니터링을 시작하기 전에 지원하는 데이터베이스 종류에 대해서 알아보세요.","keywords":["Tibero","데이터베이스","지원 환경"],"isTranslationMissing":false},"sidebar":"tiberoSidebar","previous":{"title":"Tibero 모니터링","permalink":"/tibero/monitoring-intro"},"next":{"title":"에이전트 설치","permalink":"/tibero/install-agent"}}')
...
;// CONCATENATED MODULE: ./docs/tibero/monitoring-support.mdx
