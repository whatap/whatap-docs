"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[81141],{
...
const metadata = {
  "id": "redis/metric-warning-notice-new",
  "title": "메트릭스 경고 알림",
  "description": "구체적이고 복잡한 이벤트를 설정하려면 메트릭스 이벤트 설정을 사용하세요.",
  "source": "@site/docs/redis/metric-warning-notice-new.mdx",
  "sourceDirName": "redis",
  "slug": "/redis/metric-warning-notice-new",
  "permalink": "/whatap-docs/redis/metric-warning-notice-new",
  "draft": false,
  "unlisted": false,
  "editUrl": "undefined/docs/redis/metric-warning-notice-new.mdx",
  "tags": [],
  "version": "current",
  "frontMatter": {
    "id": "metric-warning-notice-new",
