"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["63412"], {
...
"86931": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_redis_set_event_format_mdx_e19_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-redis-set-event-format-mdx-e19.json
var site_docs_redis_set_event_format_mdx_e19_namespaceObject = JSON.parse('{"id":"redis/set-event-format","title":"이벤트 수신 포맷","description":"데이터베이스 모니터링에서 제공하는 경고 알림의 이벤트 수신 포맷에 대해 알아봅니다.","source":"@site/docs/redis/set-event-format.mdx","sourceDirName":"redis","slug":"/redis/set-event-format","permalink":"/redis/set-event-format","draft":false,"unlisted":false,"editUrl":"undefined/docs/redis/set-event-format.mdx","tags":[],"version":"current","frontMatter":{"id":"set-event-format","title":"이벤트 수신 포맷","description":"데이터베이스 모니터링에서 제공하는 경고 알림의 이벤트 수신 포맷에 대해 알아봅니다.","keywords":["Redis","경고 알림","이벤트","데이터베이스","데이터베이스 모니터링","이벤트 수신 포맷"],"isTranslationMissing":false},"sidebar":"redisSidebar","previous":{"title":"이벤트 기록","permalink":"/redis/set-event-history"},"next":{"title":"실시간 알림","permalink":"/redis/real-time-notification"}}')
...
;// CONCATENATED MODULE: ./docs/redis/set-event-format.mdx
