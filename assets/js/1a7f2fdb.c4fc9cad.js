"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["15473"], {
...
"9071": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_mongodb_metrics_chart_mdx_1a7_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-mongodb-metrics-chart-mdx-1a7.json
var site_docs_mongodb_metrics_chart_mdx_1a7_namespaceObject = JSON.parse('{"id":"mongodb/metrics-chart","title":"메트릭스 차트","description":"메트릭스 데이터를 차트로 조회할 수 있습니다.","source":"@site/docs/mongodb/metrics-chart.mdx","sourceDirName":"mongodb","slug":"/mongodb/metrics-chart","permalink":"/mongodb/metrics-chart","draft":false,"unlisted":false,"editUrl":"undefined/docs/mongodb/metrics-chart.mdx","tags":[],"version":"current","frontMatter":{"id":"metrics-chart","title":"메트릭스 차트","description":"메트릭스 데이터를 차트로 조회할 수 있습니다.","keywords":["메트릭스","메트릭스 차트","UI"],"isTranslationMissing":false},"sidebar":"mongodbSidebar","previous":{"title":"메트릭스 차트","permalink":"/mongodb/metrics-chart-v2"},"next":{"title":"메트릭스 조회","permalink":"/mongodb/metrics-search"}}')
...
;// CONCATENATED MODULE: ./docs/mongodb/metrics-chart.mdx
