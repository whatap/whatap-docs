"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["20687"], {
...
"88293": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_python_set_event_detect_anomal_mdx_9b8_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-python-set-event-detect-anomal-mdx-9b8.json
var site_docs_python_set_event_detect_anomal_mdx_9b8_namespaceObject = JSON.parse('{"id":"python/set-event-detect-anomal","title":"이상치 탐지 경고 알림","description":"예상치 못한 패턴을 찾는 일련의 활동을 탐지해 경고 알림을 보내도록 설정할 수 있습니다.","source":"@site/docs/python/set-event-detect-anomal.mdx","sourceDirName":"python","slug":"/python/set-event-detect-anomal","permalink":"/python/set-event-detect-anomal","draft":false,"unlisted":false,"editUrl":"undefined/docs/python/set-event-detect-anomal.mdx","tags":[],"version":"current","frontMatter":{"id":"set-event-detect-anomal","title":"이상치 탐지 경고 알림","description":"예상치 못한 패턴을 찾는 일련의 활동을 탐지해 경고 알림을 보내도록 설정할 수 있습니다.","keywords":["Python","경고 알림","이상치 탐지","애플리케이션 모니터링"],"isTranslationMissing":false},"sidebar":"pySidebar","previous":{"title":"AI 기반의 히트맵 패턴 경고 알림","permalink":"/python/hitmap-notice"},"next":{"title":"로그 경고 알림","permalink":"/python/set-event-log"}}')
...
;// CONCATENATED MODULE: ./docs/python/set-event-detect-anomal.mdx
