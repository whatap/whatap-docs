"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["93987"], {
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_oracle_pro_log_lt_mdx_229_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-oracle-pro-log-lt-mdx-229.json
var site_docs_oracle_pro_log_lt_mdx_229_namespaceObject = JSON.parse('{"id":"oracle-pro/log-lt","title":"라이브 테일","description":"로그 모니터링 라이브 테일을 안내합니다.","source":"@site/docs/oracle-pro/log-lt.mdx","sourceDirName":"oracle-pro","slug":"/oracle-pro/log-lt","permalink":"/oracle-pro/log-lt","draft":false,"unlisted":false,"editUrl":"undefined/docs/oracle-pro/log-lt.mdx","tags":[],"version":"current","frontMatter":{"id":"log-lt","title":"라이브 테일","description":"로그 모니터링 라이브 테일을 안내합니다.","keywords":["로그 모니터링","라이브 테일","UI","Oracle Pro"],"isTranslationMissing":false},"sidebar":"dboracledmaSidebar","previous":{"title":"적용하기","permalink":"/oracle-pro/log-db"},"next":{"title":"로그 트렌드","permalink":"/oracle-pro/log-exp"}}')
...
;// CONCATENATED MODULE: ./docs/oracle-pro/log-lt.mdx
