...
"20459": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_java_trs_multi_trace_mdx_335_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-java-trs-multi-trace-mdx-335.json
var site_docs_java_trs_multi_trace_mdx_335_namespaceObject = JSON.parse('{"id":"java/trs-multi-trace","title":"멀티 트랜잭션","description":"멀티 트랜잭션 추적을 안내합니다.","source":"@site/docs/java/trs-multi-trace.mdx","sourceDirName":"java","slug":"/java/trs-multi-trace","permalink":"/java/trs-multi-trace","draft":false,"unlisted":false,"editUrl":"undefined/docs/java/trs-multi-trace.mdx","tags":[],"version":"current","frontMatter":{"id":"trs-multi-trace","title":"멀티 트랜잭션","description":"멀티 트랜잭션 추적을 안내합니다.","keywords":["Java","트랜잭션","멀티 트랜잭션","UI","애플리케이션"],"isTranslationMissing":false},"sidebar":"javaSidebar","previous":{"title":"액티브 트랜잭션","permalink":"/java/active-transactions"},"next":{"title":"트랜잭션 엔드포인트 설정","permalink":"/java/trs-endpoint-setting"}}')
...
;// CONCATENATED MODULE: ./docs/java/trs-multi-trace.mdx
