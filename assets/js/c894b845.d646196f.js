"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["36913"], {
...
"48135": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_oracle_v_1_dashboard_intro_mdx_c89_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-oracle-v-1-dashboard-intro-mdx-c89.json
var site_docs_oracle_v_1_dashboard_intro_mdx_c89_namespaceObject = JSON.parse('{"id":"oracle-v1/dashboard-intro","title":"대시보드","description":"와탭 모니터링 대시보드는 프로젝트의 전체 현황을 한 눈에 파악하기 위한 기능을 제공합니다.","source":"@site/docs/oracle-v1/dashboard-intro.mdx","sourceDirName":"oracle-v1","slug":"/oracle-v1/dashboard-intro","permalink":"/oracle-v1/dashboard-intro","draft":false,"unlisted":false,"editUrl":"undefined/docs/oracle-v1/dashboard-intro.mdx","tags":[],"version":"current","frontMatter":{"id":"dashboard-intro","title":"대시보드","description":"와탭 모니터링 대시보드는 프로젝트의 전체 현황을 한 눈에 파악하기 위한 기능을 제공합니다.","keywords":["Oracle","대시보드","인스턴스","데이터베이스 모니터링"],"isTranslationMissing":false},"sidebar":"dboracleSidebar","previous":{"title":"관리하기","permalink":"/oracle-v1/agent-manage"},"next":{"title":"인스턴스 목록","permalink":"/oracle-v1/instance-list"}}')
...
;// CONCATENATED MODULE: ./docs/oracle-v1/dashboard-intro.mdx
