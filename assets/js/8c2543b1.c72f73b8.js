"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["61173"], {
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_nodejs_collect_stacks_mdx_8c2_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-nodejs-collect-stacks-mdx-8c2.json
var site_docs_nodejs_collect_stacks_mdx_8c2_namespaceObject = JSON.parse('{"id":"nodejs/collect-stacks","title":"트랜잭션 스텝 수집 방식","description":"트랜잭션 스텝 수집 방식을 안내합니다.","source":"@site/docs/nodejs/collect-stacks.mdx","sourceDirName":"nodejs","slug":"/nodejs/collect-stacks","permalink":"/nodejs/collect-stacks","draft":false,"unlisted":false,"editUrl":"undefined/docs/nodejs/collect-stacks.mdx","tags":[],"version":"current","frontMatter":{"id":"collect-stacks","title":"트랜잭션 스텝 수집 방식","description":"트랜잭션 스텝 수집 방식을 안내합니다.","keywords":["Node.js","트랜잭션","트랜잭션 스텝"],"isTranslationMissing":false},"sidebar":"nodejsSidebar","previous":{"title":"트랜잭션 엔드포인트 설정","permalink":"/nodejs/trs-endpoint-setting"},"next":{"title":"토폴로지","permalink":"/nodejs/topology"}}')
...
;// CONCATENATED MODULE: ./docs/nodejs/collect-stacks.mdx
