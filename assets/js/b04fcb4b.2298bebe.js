"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["39013"], {
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_mongodb_set_notification_message_mdx_b04_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-mongodb-set-notification-message-mdx-b04.json
var site_docs_mongodb_set_notification_message_mdx_b04_namespaceObject = JSON.parse('{"id":"mongodb/set-notification-message","title":"알림 메시지 사용자 정의","description":"프로젝트 멤버에게 전달되는 경고 알림 메시지를 수정할 수 있는 사용자 정의 기능을 제공합니다.","source":"@site/docs/mongodb/set-notification-message.mdx","sourceDirName":"mongodb","slug":"/mongodb/set-notification-message","permalink":"/mongodb/set-notification-message","draft":false,"unlisted":false,"editUrl":"undefined/docs/mongodb/set-notification-message.mdx","tags":[],"version":"current","frontMatter":{"id":"set-notification-message","title":"알림 메시지 사용자 정의","description":"프로젝트 멤버에게 전달되는 경고 알림 메시지를 수정할 수 있는 사용자 정의 기능을 제공합니다.","keywords":["MongoDB","데이터베이스","경고 알림","메트릭스 이벤트","알림 메시지"],"isTranslationMissing":false},"sidebar":"mongodbSidebar","previous":{"title":"메트릭스 경고 알림","permalink":"/mongodb/metric-warning-notice"},"next":{"title":"이상치 탐지 경고 알림","permalink":"/mongodb/set-event-detect-anomal"}}')
...
;// CONCATENATED MODULE: ./docs/mongodb/set-notification-message.mdx
