"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["27681"], {
...
"61719": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_mongodb_metrics_chart_v_2_mdx_31f_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-mongodb-metrics-chart-v-2-mdx-31f.json
var site_docs_mongodb_metrics_chart_v_2_mdx_31f_namespaceObject = JSON.parse('{"id":"mongodb/metrics-chart-v2","title":"메트릭스 차트","description":"메트릭스 데이터를 차트로 조회할 수 있습니다.","source":"@site/docs/mongodb/metrics-chart-v2.mdx","sourceDirName":"mongodb","slug":"/mongodb/metrics-chart-v2","permalink":"/mongodb/metrics-chart-v2","draft":false,"unlisted":false,"editUrl":"undefined/docs/mongodb/metrics-chart-v2.mdx","tags":[],"version":"current","frontMatter":{"id":"metrics-chart-v2","title":"메트릭스 차트","description":"메트릭스 데이터를 차트로 조회할 수 있습니다.","keywords":["MongoDB","데이터베이스","메트릭스","메트릭스 차트"],"isTranslationMissing":false},"sidebar":"mongodbSidebar","previous":{"title":"MongoDB 지표","permalink":"/mongodb/metrics-data-list"},"next":{"title":"메트릭스 차트","permalink":"/mongodb/metrics-chart"}}')
...
;// CONCATENATED MODULE: ./docs/mongodb/metrics-chart-v2.mdx
