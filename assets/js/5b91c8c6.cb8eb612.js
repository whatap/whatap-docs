"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["62034"], {
"48177": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_browser_common_alert_mdx_5b9_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-browser-common-alert-mdx-5b9.json
var site_docs_browser_common_alert_mdx_5b9_namespaceObject = JSON.parse('{"id":"browser/common-alert","title":"시스템 이벤트 안내","description":"와탭 모니터링에서는 플랫폼 전반에서 자동으로 탐지 및 생성되는 공용 이벤트에 대해 안내합니다.","source":"@site/docs/browser/common-alert.mdx","sourceDirName":"browser","slug":"/browser/common-alert","permalink":"/browser/common-alert","draft":false,"unlisted":false,"editUrl":"undefined/docs/browser/common-alert.mdx","tags":[],"version":"current","frontMatter":{"id":"common-alert","title":"시스템 이벤트 안내","description":"와탭 모니터링에서는 플랫폼 전반에서 자동으로 탐지 및 생성되는 공용 이벤트에 대해 안내합니다.","keywords":["와탭","경고 알림","시스템 이벤트"],"isTranslationMissing":false},"sidebar":"rumsSidebar","previous":{"title":"실시간 알림","permalink":"/browser/real-time-notification"},"next":{"title":"브라우저 에이전트 수집 데이터","permalink":"/browser/collect-data"}}')
...
;// CONCATENATED MODULE: ./docs/browser/common-alert.mdx
