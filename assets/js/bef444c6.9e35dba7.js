"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["43636"], {
...
"23488": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_cubrid_log_setting_mdx_bef_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-cubrid-log-setting-mdx-bef.json
var site_docs_cubrid_log_setting_mdx_bef_namespaceObject = JSON.parse('{"id":"cubrid/log-setting","title":"로그 설정","description":"로그 모니터링 설정 방법을 안내합니다.","source":"@site/docs/cubrid/log-setting.mdx","sourceDirName":"cubrid","slug":"/cubrid/log-setting","permalink":"/cubrid/log-setting","draft":false,"unlisted":false,"editUrl":"undefined/docs/cubrid/log-setting.mdx","tags":[],"version":"current","frontMatter":{"id":"log-setting","title":"로그 설정","description":"로그 모니터링 설정 방법을 안내합니다.","toc_max_heading_level":3,"keywords":["로그","로그 모니터링","설정하기","CUBRID"],"isTranslationMissing":false},"sidebar":"cubridSidebar","previous":{"title":"로그 검색","permalink":"/cubrid/log-search"},"next":{"title":"로그 파싱하기","permalink":"/cubrid/log-parser"}}')
...
;// CONCATENATED MODULE: ./docs/cubrid/log-setting.mdx
