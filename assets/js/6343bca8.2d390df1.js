"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["17662"], {
...
"60684": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_oracle_pro_log_parser_mdx_634_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-oracle-pro-log-parser-mdx-634.json
var site_docs_oracle_pro_log_parser_mdx_634_namespaceObject = JSON.parse('{"id":"oracle-pro/log-parser","title":"로그 파싱하기","description":"와탭이 제공하는 로그 파서에 대해 안내합니다.","source":"@site/docs/oracle-pro/log-parser.mdx","sourceDirName":"oracle-pro","slug":"/oracle-pro/log-parser","permalink":"/oracle-pro/log-parser","draft":false,"unlisted":false,"editUrl":"undefined/docs/oracle-pro/log-parser.mdx","tags":[],"version":"current","frontMatter":{"id":"log-parser","title":"로그 파싱하기","description":"와탭이 제공하는 로그 파서에 대해 안내합니다.","toc_max_heading_level":3,"keywords":["로그","로그 모니터링","설정하기","로그 파서","로그 파싱","Oracle Pro"],"isTranslationMissing":false},"sidebar":"dboracledmaSidebar","previous":{"title":"로그 설정","permalink":"/oracle-pro/log-setting"},"next":{"title":"알림 설정하기","permalink":"/oracle-pro/set-notice"}}')
...
;// CONCATENATED MODULE: ./docs/oracle-pro/log-parser.mdx
