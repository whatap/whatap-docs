"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[61749],{
...
const metadata = {
  "id": "mssql-v1/set-event-format",
  "title": "이벤트 수신 포맷",
  "description": "데이터베이스 모니터링에서 제공하는 경고 알림의 이벤트 수신 포맷에 대해 알아봅니다.",
  "source": "@site/docs/mssql-v1/set-event-format.mdx",
  "sourceDirName": "mssql-v1",
  "slug": "/mssql-v1/set-event-format",
  "permalink": "/whatap-docs/mssql-v1/set-event-format",
  "draft": false,
  "unlisted": false,
  "editUrl": "undefined/docs/mssql-v1/set-event-format.mdx",
  "tags": [],
  "version": "current",
  "frontMatter": {
    "id": "set-event-format",
