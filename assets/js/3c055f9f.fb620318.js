"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["8671"], {
"15746": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_amazon_cloudwatch_flexboard_mdx_3c0_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-amazon-cloudwatch-flexboard-mdx-3c0.json
var site_docs_amazon_cloudwatch_flexboard_mdx_3c0_namespaceObject = JSON.parse('{"id":"amazon-cloudwatch/flexboard","title":"Flex 보드","description":"사용자 정의형 통합 대시보드를 안내합니다. 사용자는 애플리케이션, 서버, 데이터베이스, 컨테이너 등의 데이터로 실시간 대시보드를 만들 수 있습니다. 사전 구성된 템플릿을 제공하며, 다양한 데이터 위젯 추가, 데이터 필터링, 시간 범위 설정 등의 기능을 통해 사용자가 원하는 모니터링 대상을 쉽게 간추리고 중요 데이터를 확인할 수 있습니다.","source":"@site/docs/amazon-cloudwatch/flexboard.mdx","sourceDirName":"amazon-cloudwatch","slug":"/amazon-cloudwatch/flexboard","permalink":"/amazon-cloudwatch/flexboard","draft":false,"unlisted":false,"editUrl":"undefined/docs/amazon-cloudwatch/flexboard.mdx","tags":[],"version":"current","frontMatter":{"id":"flexboard","title":"Flex 보드","description":"사용자 정의형 통합 대시보드를 안내합니다. 사용자는 애플리케이션, 서버, 데이터베이스, 컨테이너 등의 데이터로 실시간 대시보드를 만들 수 있습니다. 사전 구성된 템플릿을 제공하며, 다양한 데이터 위젯 추가, 데이터 필터링, 시간 범위 설정 등의 기능을 통해 사용자가 원하는 모니터링 대상을 쉽게 간추리고 중요 데이터를 확인할 수 있습니다.","keywords":["클라우드","Amazon CloudWatch","대시보드","Flex 보드","위젯","메트릭스"],"isTranslationMissing":false},"sidebar":"amazoncloudwatchSidebar","previous":{"title":"아이템별 대시보드","permalink":"/amazon-cloudwatch/dashboard"},"next":{"title":"사전 템플릿 적용","permalink":"/amazon-cloudwatch/flexboard-template"}}')
...
;// CONCATENATED MODULE: ./docs/amazon-cloudwatch/flexboard.mdx
