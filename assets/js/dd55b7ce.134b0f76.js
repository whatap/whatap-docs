"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["30906"], {
...
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_altibase_v_1_metric_warning_notice_mdx_dd5_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-altibase-v-1-metric-warning-notice-mdx-dd5.json
var site_docs_altibase_v_1_metric_warning_notice_mdx_dd5_namespaceObject = JSON.parse('{"id":"altibase-v1/metric-warning-notice","title":"메트릭스 경고 알림","description":"구체적이고 복잡한 이벤트를 설정하려면 메트릭스 이벤트 설정을 사용하세요.","source":"@site/docs/altibase-v1/metric-warning-notice.mdx","sourceDirName":"altibase-v1","slug":"/altibase-v1/metric-warning-notice","permalink":"/altibase-v1/metric-warning-notice","draft":false,"unlisted":false,"editUrl":"undefined/docs/altibase-v1/metric-warning-notice.mdx","tags":[],"version":"current","frontMatter":{"id":"metric-warning-notice","title":"메트릭스 경고 알림","description":"구체적이고 복잡한 이벤트를 설정하려면 메트릭스 이벤트 설정을 사용하세요.","keywords":["Altibase","경고 알림","메트릭스 이벤트","데이터베이스 모니터링"],"isTranslationMissing":false},"sidebar":"altibasev1Sidebar","previous":{"title":"이벤트 설정","permalink":"/altibase-v1/warning-notice-v2"},"next":{"title":"알림 메시지 사용자 정의","permalink":"/altibase-v1/set-notification-message"}}')
