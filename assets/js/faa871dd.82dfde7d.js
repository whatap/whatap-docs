"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["29765"], {
...
"45663": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_mongodb_log_main_mdx_faa_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-mongodb-log-main-mdx-faa.json
var site_docs_mongodb_log_main_mdx_faa_namespaceObject = JSON.parse('{"id":"mongodb/log-main","title":"로그","description":"로그 모니터링의 주요 메뉴를 안내합니다.","source":"@site/docs/mongodb/log-main.mdx","sourceDirName":"mongodb","slug":"/mongodb/log-main","permalink":"/mongodb/log-main","draft":false,"unlisted":false,"editUrl":"undefined/docs/mongodb/log-main.mdx","tags":[],"version":"current","frontMatter":{"id":"log-main","title":"로그","description":"로그 모니터링의 주요 메뉴를 안내합니다.","keywords":["MongoDB","로그 모니터링","UI"],"isTranslationMissing":false},"sidebar":"mongodbSidebar","previous":{"title":"데이터베이스 사이즈","permalink":"/mongodb/database-size"},"next":{"title":"적용하기","permalink":"/mongodb/log-db"}}')
...
;// CONCATENATED MODULE: ./docs/mongodb/log-main.mdx
