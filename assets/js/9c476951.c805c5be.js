"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["43853"], {
...
"21797": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_php_track_transactions_intro_mdx_9c4_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-php-track-transactions-intro-mdx-9c4.json
var site_docs_php_track_transactions_intro_mdx_9c4_namespaceObject = JSON.parse('{"id":"php/track-transactions-intro","title":"트랜잭션","description":"트랜잭션의 개요를 안내합니다.","source":"@site/docs/php/track-transactions-intro.mdx","sourceDirName":"php","slug":"/php/track-transactions-intro","permalink":"/php/track-transactions-intro","draft":false,"unlisted":false,"editUrl":"undefined/docs/php/track-transactions-intro.mdx","tags":[],"version":"current","frontMatter":{"id":"track-transactions-intro","title":"트랜잭션","description":"트랜잭션의 개요를 안내합니다.","keywords":["PHP","트랜잭션"],"isTranslationMissing":false},"sidebar":"phpSidebar","previous":{"title":"메트릭스 이상 탐지","permalink":"/php/metrics-detect-anormal"},"next":{"title":"트랜잭션 분석하기","permalink":"/php/trs-view"}}')
...
;// CONCATENATED MODULE: ./docs/php/track-transactions-intro.mdx
