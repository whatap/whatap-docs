"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["24562"], {
...
"55920": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_golang_flexboard_share_mdx_0ca_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-golang-flexboard-share-mdx-0ca.json
var site_docs_golang_flexboard_share_mdx_0ca_namespaceObject = JSON.parse('{"id":"golang/flexboard-share","title":"Flex 보드 공유하기","description":"Flex 보드를 다른 계정의 사용자와 공유하고 재사용할 수 있습니다.","source":"@site/docs/golang/flexboard-share.mdx","sourceDirName":"golang","slug":"/golang/flexboard-share","permalink":"/golang/flexboard-share","draft":false,"unlisted":false,"editUrl":"undefined/docs/golang/flexboard-share.mdx","tags":[],"version":"current","frontMatter":{"id":"flexboard-share","title":"Flex 보드 공유하기","description":"Flex 보드를 다른 계정의 사용자와 공유하고 재사용할 수 있습니다.","keywords":["Go","Flex 보드"],"isTranslationMissing":false},"sidebar":"goSidebar","previous":{"title":"Flex 보드 화면 모드","permalink":"/golang/flexboard-mode"},"next":{"title":"분석","permalink":"/golang/analysis-report-intro"}}')
...
;// CONCATENATED MODULE: ./docs/golang/flexboard-share.mdx
