"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["41978"], {
...
"57340": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_cubrid_set_event_format_mdx_e07_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-cubrid-set-event-format-mdx-e07.json
var site_docs_cubrid_set_event_format_mdx_e07_namespaceObject = JSON.parse('{"id":"cubrid/set-event-format","title":"이벤트 수신 포맷","description":"데이터베이스 모니터링에서 제공하는 경고 알림의 이벤트 수신 포맷에 대해 알아봅니다.","source":"@site/docs/cubrid/set-event-format.mdx","sourceDirName":"cubrid","slug":"/cubrid/set-event-format","permalink":"/cubrid/set-event-format","draft":false,"unlisted":false,"editUrl":"undefined/docs/cubrid/set-event-format.mdx","tags":[],"version":"current","frontMatter":{"id":"set-event-format","title":"이벤트 수신 포맷","description":"데이터베이스 모니터링에서 제공하는 경고 알림의 이벤트 수신 포맷에 대해 알아봅니다.","keywords":["CUBRID","경고 알림","이벤트","데이터베이스","데이터베이스 모니터링","이벤트 수신 포맷"],"isTranslationMissing":false},"sidebar":"cubridSidebar","previous":{"title":"이벤트 기록","permalink":"/cubrid/set-event-history"},"next":{"title":"실시간 알림","permalink":"/cubrid/real-time-notification"}}')
...
;// CONCATENATED MODULE: ./docs/cubrid/set-event-format.mdx
