"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["38219"], {
...
"67926": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_postgresql_analysis_lock_and_deadlock_mdx_91d_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-postgresql-analysis-lock-and-deadlock-mdx-91d.json
var site_docs_postgresql_analysis_lock_and_deadlock_mdx_91d_namespaceObject = JSON.parse('{"id":"postgresql/analysis-lock-and-deadlock","title":"락 트리","description":"하루 동안 발생한 Lock 추이를 분석하고 교착 상태의 쿼리를 확인할 수 있습니다.","source":"@site/docs/postgresql/analysis-lock-and-deadlock.mdx","sourceDirName":"postgresql","slug":"/postgresql/analysis-lock-and-deadlock","permalink":"/postgresql/analysis-lock-and-deadlock","draft":false,"unlisted":false,"editUrl":"undefined/docs/postgresql/analysis-lock-and-deadlock.mdx","tags":[],"version":"current","frontMatter":{"id":"analysis-lock-and-deadlock","title":"락 트리","description":"하루 동안 발생한 Lock 추이를 분석하고 교착 상태의 쿼리를 확인할 수 있습니다.","keywords":["PostgreSQL","데이터베이스","Lock","락 트리"],"isTranslationMissing":false},"sidebar":"postgreSidebar","previous":{"title":"카운트 추이 비교","permalink":"/postgresql/analysis-count-trend"},"next":{"title":"세션 히스토리","permalink":"/postgresql/analysis-session-history"}}')
...
;// CONCATENATED MODULE: ./docs/postgresql/analysis-lock-and-deadlock.mdx
...
const toc = [..._analysis_lock_desc/* toc */.d$, ..._db_locktree_desc/* toc */.d$, ..._db_locktree_using_basic/* toc */.d$, ..._db_postgresql_column/* toc */.d$];
function _createMdxContent(props) {
