"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["77000"], {
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_oracle_v_1_metrics_data_list_mdx_f0b_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-oracle-v-1-metrics-data-list-mdx-f0b.json
var site_docs_oracle_v_1_metrics_data_list_mdx_f0b_namespaceObject = JSON.parse('{"id":"oracle-v1/metrics-data-list","title":"Oracle 지표","description":"Oracle 지표를 안내합니다.","source":"@site/docs/oracle-v1/metrics-data-list.mdx","sourceDirName":"oracle-v1","slug":"/oracle-v1/metrics-data-list","permalink":"/oracle-v1/metrics-data-list","draft":false,"unlisted":false,"editUrl":"undefined/docs/oracle-v1/metrics-data-list.mdx","tags":[],"version":"current","frontMatter":{"id":"metrics-data-list","title":"Oracle 지표","description":"Oracle 지표를 안내합니다.","keywords":["Oracle","메트릭스","데이터베이스","데이터베이스 모니터링"],"isTranslationMissing":false},"sidebar":"dboracleSidebar","previous":{"title":"메트릭스","permalink":"/oracle-v1/metrics-intro"},"next":{"title":"메트릭스 차트","permalink":"/oracle-v1/metrics-chart"}}')
...
;// CONCATENATED MODULE: ./docs/oracle-v1/metrics-data-list.mdx
...
const toc = [..._oracle_metrics_data_list/* toc */.d$];
function _createMdxContent(props) {
  return (0,jsx_runtime.jsx)(_oracle_metrics_data_list/* default */.ZP, {});
}
function MDXContent(props = {}) {
  const {wrapper: MDXLayout} = {
