"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["81378"], {
"50269": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_altibase_agent_xos_settings_mdx_d11_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-altibase-agent-xos-settings-mdx-d11.json
var site_docs_altibase_agent_xos_settings_mdx_d11_namespaceObject = JSON.parse('{"id":"altibase/agent-xos-settings","title":"XOS 에이전트 설정","description":"데이터베이스 프로세스 모니터링 설정에 대해 알아봅니다.","source":"@site/docs/altibase/agent-xos-settings.mdx","sourceDirName":"altibase","slug":"/altibase/agent-xos-settings","permalink":"/altibase/agent-xos-settings","draft":false,"unlisted":false,"editUrl":"undefined/docs/altibase/agent-xos-settings.mdx","tags":[],"version":"current","frontMatter":{"id":"agent-xos-settings","title":"XOS 에이전트 설정","description":"데이터베이스 프로세스 모니터링 설정에 대해 알아봅니다.","keywords":["Altibase","데이터베이스","에이전트","XOS"],"isTranslationMissing":false},"sidebar":"altibaseSidebar","previous":{"title":"DBX 에이전트 설정","permalink":"/altibase/agent-dbx-settings"},"next":{"title":"관리하기","permalink":"/altibase/agent-manage"}}')
