"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["71716"], {
...
"76487": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_nodejs_install_agent_docker_mdx_ae4_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-nodejs-install-agent-docker-mdx-ae4.json
var site_docs_nodejs_install_agent_docker_mdx_ae4_namespaceObject = JSON.parse('{"id":"nodejs/install-agent-docker","title":"Docker 환경 설치","description":"Docker 환경에서 DockerFile을 작성해 Node.js 에이전트를 설치한 다음 실행하는 방법을 안내합니다.","source":"@site/docs/nodejs/install-agent-docker.mdx","sourceDirName":"nodejs","slug":"/nodejs/install-agent-docker","permalink":"/nodejs/install-agent-docker","draft":false,"unlisted":false,"editUrl":"undefined/docs/nodejs/install-agent-docker.mdx","tags":[],"version":"current","frontMatter":{"id":"install-agent-docker","title":"Docker 환경 설치","description":"Docker 환경에서 DockerFile을 작성해 Node.js 에이전트를 설치한 다음 실행하는 방법을 안내합니다.","keywords":["Node.js","에이전트","DockerFile"],"isTranslationMissing":false},"sidebar":"nodejsSidebar","previous":{"title":"Node.js 에이전트 설치","permalink":"/nodejs/install-agent"},"next":{"title":"Next.js 환경 설치","permalink":"/nodejs/install-agent-nextjs"}}')
...
;// CONCATENATED MODULE: ./docs/nodejs/install-agent-docker.mdx
...
function _createMdxContent(props) {
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsxs)(_components.p, {
      children: ["Docker 환경에서 DockerFile을 작성해 Node.js 에이전트를 설치한 다음 실행하는 방법을 안내합니다. 다음 안내에서 사용한 예제 파일은 ", (0,jsx_runtime.jsx)(_components.a, {
