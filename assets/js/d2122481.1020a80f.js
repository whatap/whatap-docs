"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["50021"], {
...
"73677": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_golang_trs_multi_trace_mdx_d21_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-golang-trs-multi-trace-mdx-d21.json
var site_docs_golang_trs_multi_trace_mdx_d21_namespaceObject = JSON.parse('{"id":"golang/trs-multi-trace","title":"멀티 트랜잭션","description":"멀티 트랜잭션 추적을 안내합니다.","source":"@site/docs/golang/trs-multi-trace.mdx","sourceDirName":"golang","slug":"/golang/trs-multi-trace","permalink":"/golang/trs-multi-trace","draft":false,"unlisted":false,"editUrl":"undefined/docs/golang/trs-multi-trace.mdx","tags":[],"version":"current","frontMatter":{"id":"trs-multi-trace","title":"멀티 트랜잭션","description":"멀티 트랜잭션 추적을 안내합니다.","keywords":["Go","트랜잭션","멀티 트랜잭션","UI","애플리케이션","애플리케이션 모니터링"],"isTranslationMissing":false},"sidebar":"goSidebar","previous":{"title":"트랜잭션 트레이싱","permalink":"/golang/trs-profile"},"next":{"title":"트랜잭션 스텝 수집 방식","permalink":"/golang/collect-stacks"}}')
...
;// CONCATENATED MODULE: ./docs/golang/trs-multi-trace.mdx
