"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["95210"], {
...
"38980": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_mssql_v_1_flexboard_create_mdx_28e_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-mssql-v-1-flexboard-create-mdx-28e.json
var site_docs_mssql_v_1_flexboard_create_mdx_28e_namespaceObject = JSON.parse('{"id":"mssql-v1/flexboard-create","title":"Flex 보드 만들기","description":"Flex 보드 메뉴에서 대시보드를 생성하고, 위젯을 배치하여 사용자 정의 대시보드를 만드는 과정을 안내합니다. 고정 레이아웃과 반응형 레이아웃 중에서 선택할 수 있으며, 메트릭스 위젯 추가 및 사전 정의된 위젯 템플릿을 활용할 수 있습니다. 사용자는 위젯의 위치를 조정하고, 크기를 변경하여 자신만의 대시보드 레이아웃을 완성할 수 있습니다.","source":"@site/docs/mssql-v1/flexboard-create.mdx","sourceDirName":"mssql-v1","slug":"/mssql-v1/flexboard-create","permalink":"/mssql-v1/flexboard-create","draft":false,"unlisted":false,"editUrl":"undefined/docs/mssql-v1/flexboard-create.mdx","tags":[],"version":"current","frontMatter":{"id":"flexboard-create","title":"Flex 보드 만들기","description":"Flex 보드 메뉴에서 대시보드를 생성하고, 위젯을 배치하여 사용자 정의 대시보드를 만드는 과정을 안내합니다. 고정 레이아웃과 반응형 레이아웃 중에서 선택할 수 있으며, 메트릭스 위젯 추가 및 사전 정의된 위젯 템플릿을 활용할 수 있습니다. 사용자는 위젯의 위치를 조정하고, 크기를 변경하여 자신만의 대시보드 레이아웃을 완성할 수 있습니다.","keywords":["SQL Server","Flex 보드","위젯","메트릭스"],"isTranslationMissing":false},"sidebar":"mssqlV1Sidebar","previous":{"title":"사전 템플릿 적용","permalink":"/mssql-v1/flexboard-template"},"next":{"title":"Flex 보드 관리하기","permalink":"/mssql-v1/flexboard-manage"}}')
...
;// CONCATENATED MODULE: ./docs/mssql-v1/flexboard-create.mdx
