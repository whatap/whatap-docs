"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[38143],{
...
const metadata = {
  "id": "oracle-dma/set-event-format",
  "title": "이벤트 수신 포맷",
  "description": "데이터베이스 모니터링에서 제공하는 경고 알림의 이벤트 수신 포맷에 대해 알아봅니다.",
  "source": "@site/docs/oracle-dma/set-event-format.mdx",
  "sourceDirName": "oracle-dma",
  "slug": "/oracle-dma/set-event-format",
  "permalink": "/whatap-docs/oracle-dma/set-event-format",
  "draft": false,
  "unlisted": false,
  "editUrl": "undefined/docs/oracle-dma/set-event-format.mdx",
  "tags": [
    {
      "label": "Oracle DMA",
