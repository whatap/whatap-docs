"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["59648"], {
...
"48721": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_golang_install_check_mdx_80d_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-golang-install-check-mdx-80d.json
var site_docs_golang_install_check_mdx_80d_namespaceObject = JSON.parse('{"id":"golang/install-check","title":"설치 점검 사항","description":"에이전트를 설치한 다음 확인해야할 사항입니다.","source":"@site/docs/golang/install-check.mdx","sourceDirName":"golang","slug":"/golang/install-check","permalink":"/golang/install-check","draft":false,"unlisted":false,"editUrl":"undefined/docs/golang/install-check.mdx","tags":[],"version":"current","frontMatter":{"id":"install-check","title":"설치 점검 사항","description":"에이전트를 설치한 다음 확인해야할 사항입니다.","keywords":["Go"],"isTranslationMissing":false},"sidebar":"goSidebar","previous":{"title":"API 가이드","permalink":"/golang/api-guide"},"next":{"title":"설정하기","permalink":"/golang/set-agent"}}')
...
;// CONCATENATED MODULE: ./docs/golang/install-check.mdx
...
function _createMdxContent(props) {
  ...
  return (0,jsx_runtime.jsxs)(_components.section, {
    ...
    children: [(0,jsx_runtime.jsx)(_components.h2, {
      ...
      children: "다음 명령어를 이용해 와탭 에이전트(whata-agent) 서비스 상태를 확인하세요."
    }), (0,jsx_runtime.jsx)(_components.pre, {
      children: (0,jsx_runtime.jsx)(_components.code, {
        className: "language-bash",
        metastring: "title='SH'",
        children: "$ service whatap-agent status\n"
      })
    }), (0,jsx_runtime.jsx)(_check_agent_connection/* default */.ZP, {})]
  });
}
function MDXContent(props = {}) {
  const {wrapper: MDXLayout} = {
