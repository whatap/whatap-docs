"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["857"], {
...
"51750": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_oracle_v_1_agent_dbx_settings_mdx_492_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-oracle-v-1-agent-dbx-settings-mdx-492.json
var site_docs_oracle_v_1_agent_dbx_settings_mdx_492_namespaceObject = JSON.parse('{"id":"oracle-v1/agent-dbx-settings","title":"DBX 에이전트 설정","description":"whatap.conf 파일에 설정할 수 있는 옵션에 대해 안내합니다.","source":"@site/docs/oracle-v1/agent-dbx-settings.mdx","sourceDirName":"oracle-v1","slug":"/oracle-v1/agent-dbx-settings","permalink":"/oracle-v1/agent-dbx-settings","draft":false,"unlisted":false,"editUrl":"undefined/docs/oracle-v1/agent-dbx-settings.mdx","tags":[],"version":"current","frontMatter":{"id":"agent-dbx-settings","title":"DBX 에이전트 설정","description":"whatap.conf 파일에 설정할 수 있는 옵션에 대해 안내합니다.","keywords":["MySQL","데이터베이스 모니터링","DBX 에이전트"],"isTranslationMissing":false},"sidebar":"dboracleSidebar","previous":{"title":"설정하기","permalink":"/oracle-v1/agent-settings"},"next":{"title":"XOS 에이전트 설정","permalink":"/oracle-v1/agent-xos-settings"}}')
...
;// CONCATENATED MODULE: ./docs/oracle-v1/agent-dbx-settings.mdx
