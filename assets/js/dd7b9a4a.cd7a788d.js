"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["74776"], {
...
"60109": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_oracle_agent_settings_mdx_dd7_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-oracle-agent-settings-mdx-dd7.json
var site_docs_oracle_agent_settings_mdx_dd7_namespaceObject = JSON.parse('{"id":"oracle/agent-settings","title":"설정하기","description":"데이터베이스 에이전트 서버에 있는 whatap.conf 파일을 통해 설정할 수 있는 옵션에 대해 알아봅니다.","source":"@site/docs/oracle/agent-settings.mdx","sourceDirName":"oracle","slug":"/oracle/agent-settings","permalink":"/oracle/agent-settings","draft":false,"unlisted":false,"editUrl":"undefined/docs/oracle/agent-settings.mdx","tags":[],"version":"current","frontMatter":{"id":"agent-settings","title":"설정하기","description":"데이터베이스 에이전트 서버에 있는 whatap.conf 파일을 통해 설정할 수 있는 옵션에 대해 알아봅니다.","keywords":["Oracle","데이터베이스"],"isTranslationMissing":false},"sidebar":"dboracleV2Sidebar","previous":{"title":"설치 문제 해결","permalink":"/oracle/troubleshooting"},"next":{"title":"DBX 에이전트 설정","permalink":"/oracle/agent-dbx-settings"}}')
...
;// CONCATENATED MODULE: ./docs/oracle/agent-settings.mdx
...
const toc = [..._import_v2_note/* toc */.d$, ..._db_agent_settings_desc/* toc */.d$, ..._db_structure_of_agent/* toc */.d$, ..._db_set_agent_desc/* toc */.d$];
function _createMdxContent(props) {
  const {DocCardList} = {
