"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["76627"], {
...
"85497": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_oracle_pro_labs_mdx_08b_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-oracle-pro-labs-mdx-08b.json
var site_docs_oracle_pro_labs_mdx_08b_namespaceObject = JSON.parse('{"id":"oracle-pro/labs","title":"실험실","description":"사용자에게 새로운 기능 또는 실험적인 기능을 제공하는 메뉴인 실험실에 대해 안내합니다.","source":"@site/docs/oracle-pro/labs.mdx","sourceDirName":"oracle-pro","slug":"/oracle-pro/labs","permalink":"/oracle-pro/labs","draft":false,"unlisted":false,"editUrl":"undefined/docs/oracle-pro/labs.mdx","tags":[],"version":"current","frontMatter":{"id":"labs","title":"실험실","description":"사용자에게 새로운 기능 또는 실험적인 기능을 제공하는 메뉴인 실험실에 대해 안내합니다.","keywords":["Oracle Pro","데이터베이스","실험실"],"isTranslationMissing":false},"sidebar":"dboracledmaSidebar","previous":{"title":"연계 프로젝트 관리","permalink":"/oracle-pro/linked-projects"}}')
...
;// CONCATENATED MODULE: ./docs/oracle-pro/labs.mdx
