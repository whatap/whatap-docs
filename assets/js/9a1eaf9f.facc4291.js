"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["4882"], {
...
"9380": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_mssql_metric_warning_notice_new_mdx_9a1_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-mssql-metric-warning-notice-new-mdx-9a1.json
var site_docs_mssql_metric_warning_notice_new_mdx_9a1_namespaceObject = JSON.parse('{"id":"mssql/metric-warning-notice-new","title":"메트릭스 경고 알림","description":"구체적이고 복잡한 이벤트를 설정하려면 메트릭스 이벤트 설정을 사용하세요.","source":"@site/docs/mssql/metric-warning-notice-new.mdx","sourceDirName":"mssql","slug":"/mssql/metric-warning-notice-new","permalink":"/mssql/metric-warning-notice-new","draft":false,"unlisted":false,"editUrl":"undefined/docs/mssql/metric-warning-notice-new.mdx","tags":[],"version":"current","frontMatter":{"id":"metric-warning-notice-new","title":"메트릭스 경고 알림","description":"구체적이고 복잡한 이벤트를 설정하려면 메트릭스 이벤트 설정을 사용하세요.","displayed_sidebar":"mssqlSidebar","keywords":["SQL Server","경고 알림","메트릭스 이벤트"],"isTranslationMissing":false},"sidebar":"mssqlSidebar"}')
...
;// CONCATENATED MODULE: ./docs/mssql/metric-warning-notice-new.mdx
