"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[1958],{
...
const frontMatter = {
	id: 'dashboard-intro',
	title: '대시보드',
	description: '와탭 모니터링 대시보드는 MongoDB 데이터베이스 프로젝트의 전체 현황을 한 눈에 파악하기 위한 기능을 제공합니다.',
	keywords: [
		'MongoDB',
		'대시보드',
		'인스턴스',
...
const metadata = {
  ...
  "previous": {
    "title": "관리하기",
    "permalink": "/mongodb/agent-manage"
  },
  "next": {
    "title": "인스턴스 목록",
