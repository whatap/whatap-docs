"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["66724"], {
...
"29322": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_ncloud_metric_warning_notice_mdx_1ff_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-ncloud-metric-warning-notice-mdx-1ff.json
var site_docs_ncloud_metric_warning_notice_mdx_1ff_namespaceObject = JSON.parse('{"id":"ncloud/metric-warning-notice","title":"메트릭스 경고 알림","description":"구체적이고 복잡한 이벤트를 설정하려면 메트릭스 이벤트 설정을 사용하세요.","source":"@site/docs/ncloud/metric-warning-notice.mdx","sourceDirName":"ncloud","slug":"/ncloud/metric-warning-notice","permalink":"/ncloud/metric-warning-notice","draft":false,"unlisted":false,"editUrl":"undefined/docs/ncloud/metric-warning-notice.mdx","tags":[],"version":"current","frontMatter":{"id":"metric-warning-notice","title":"메트릭스 경고 알림","description":"구체적이고 복잡한 이벤트를 설정하려면 메트릭스 이벤트 설정을 사용하세요.","keywords":["경고 알림","메트릭스 이벤트","Naver Cloud Monitoring","클라우드"],"isTranslationMissing":false},"sidebar":"ncloudSidebar","previous":{"title":"알림 설정하기","permalink":"/ncloud/set-notice"},"next":{"title":"이벤트 수신 설정","permalink":"/ncloud/set-receive-event"}}')
...
;// CONCATENATED MODULE: ./docs/ncloud/metric-warning-notice.mdx
