"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["90537"], {
...
"99859": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_java_add_jvm_opt_jetty_mdx_c58_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-java-add-jvm-opt-jetty-mdx-c58.json
var site_docs_java_add_jvm_opt_jetty_mdx_c58_namespaceObject = JSON.parse('{"id":"java/add-jvm-opt/jetty","title":"Jetty","description":"와탭 모니터링 솔루션을 Jetty 애플리케이션에 통합하기 위한 JVM(Java Virtual Machine) 옵션 추가 방법에 대한 상세한 안내를 제공합니다. 사용자는 본 문서를 통해 자바(Java) 에이전트 설치 후 Jetty 애플리케이션의 성능 및 가용성 모니터링을 위해 필요한 JVM 설정을 적용하는 방법을 단계별로 확인할 수 있습니다. 에이전트 설치 과정 중 필수 JVM 옵션의 구성과 Jetty와의 원활한 통합을 위한 최적의 설정 방법, 힙스토그램 조회 방법을 포함하고 있습니다.","source":"@site/docs/java/add-jvm-opt/jetty.mdx","sourceDirName":"java/add-jvm-opt","slug":"/java/add-jvm-opt/jetty","permalink":"/java/add-jvm-opt/jetty","draft":false,"unlisted":false,"editUrl":"undefined/docs/java/add-jvm-opt/jetty.mdx","tags":[],"version":"current","frontMatter":{"id":"jetty","title":"Jetty","description":"와탭 모니터링 솔루션을 Jetty 애플리케이션에 통합하기 위한 JVM(Java Virtual Machine) 옵션 추가 방법에 대한 상세한 안내를 제공합니다. 사용자는 본 문서를 통해 자바(Java) 에이전트 설치 후 Jetty 애플리케이션의 성능 및 가용성 모니터링을 위해 필요한 JVM 설정을 적용하는 방법을 단계별로 확인할 수 있습니다. 에이전트 설치 과정 중 필수 JVM 옵션의 구성과 Jetty와의 원활한 통합을 위한 최적의 설정 방법, 힙스토그램 조회 방법을 포함하고 있습니다.","keywords":["Java","Jetty","애플리케이션","에이전트"],"isTranslationMissing":false},"sidebar":"javaSidebar","previous":{"title":"Liberty","permalink":"/java/add-jvm-opt/liberty"},"next":{"title":"Spring Boot","permalink":"/java/add-jvm-opt/spring-boot"}}')
...
;// CONCATENATED MODULE: ./docs/java/add-jvm-opt/jetty.mdx
...
function _createMdxContent(props) {
  ...
  return (0,jsx_runtime.jsxs)(_components.section, {
    ...
    children: [(0,jsx_runtime.jsx)(_components.h2, {
      ...
      children: "Jetty 애플리케이션 서버 환경에서 Java 모니터링 에이전트를 효과적으로 사용하기 위해 필요한 JVM 옵션을 추가하는 방법을 안내합니다."
      ...
      children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
        children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
          ...
          children: (0,jsx_runtime.jsx)(_components.code, {
            className: "language-bash",
            metastring: "title='$JETTY_HOME/bin/jetty.sh' {2} showLineNumbers",
        ...
        children: ["\n", (0,jsx_runtime.jsx)(_components.p, {
          children: "쉘 스크립트 없이 Jetty 시작하기"
        }), "\n", (0,jsx_runtime.jsx)(_components.pre, {
          children: (0,jsx_runtime.jsx)(_components.code, {
            className: "language-bash",
            children: "$ java -javaagent:/home/vagrant/whatap/whatap.agent-X.Y.Z.jar -Dwhatap.port=8080 -jar start.jar &\n"
          })
        }), "\n"]
      }), "\n"]
