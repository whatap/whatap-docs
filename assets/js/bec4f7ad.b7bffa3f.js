"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[14123],{
...
const metadata = {
  "id": "mssql/log-setting",
  "title": "로그 설정",
  "description": "로그 모니터링 설정 방법을 안내합니다.",
  "source": "@site/docs/mssql/log-setting.mdx",
  "sourceDirName": "mssql",
  "slug": "/mssql/log-setting",
  "permalink": "/whatap-docs/mssql/log-setting",
  "draft": false,
  "unlisted": false,
  "editUrl": "undefined/docs/mssql/log-setting.mdx",
  "tags": [],
  "version": "current",
  "frontMatter": {
    "id": "log-setting",
  ...
  "previous": {
    "title": "로그 검색",
    "permalink": "/whatap-docs/mssql/log-search"
  },
  "next": {
    "title": "로그 파싱하기",
    "permalink": "/whatap-docs/mssql/log-parser"
  }
};
const assets = {
