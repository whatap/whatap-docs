"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["76922"], {
...
"68703": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_redis_monitoring_intro_mdx_d0c_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-redis-monitoring-intro-mdx-d0c.json
var site_docs_redis_monitoring_intro_mdx_d0c_namespaceObject = JSON.parse('{"id":"redis/monitoring-intro","title":"Redis 모니터링","description":"와탭 Redis 데이터베이스 모니터링 서비스(DBX)은 Query 기반으로 데이터를 수집하여 성능 모니터링 서비스를 제공합니다.","source":"@site/docs/redis/monitoring-intro.mdx","sourceDirName":"redis","slug":"/redis/monitoring-intro","permalink":"/redis/monitoring-intro","draft":false,"unlisted":false,"editUrl":"undefined/docs/redis/monitoring-intro.mdx","tags":[],"version":"current","frontMatter":{"id":"monitoring-intro","title":"Redis 모니터링","description":"와탭 Redis 데이터베이스 모니터링 서비스(DBX)은 Query 기반으로 데이터를 수집하여 성능 모니터링 서비스를 제공합니다.","displayed_sidebar":"redisSidebar","hide_table_of_contents":false,"keywords":["Redis","데이터베이스","모니터링","DBX"],"isTranslationMissing":false},"sidebar":"redisSidebar","next":{"title":"지원 환경","permalink":"/redis/monitoring-support"}}')
...
;// CONCATENATED MODULE: ./docs/redis/monitoring-intro.mdx
