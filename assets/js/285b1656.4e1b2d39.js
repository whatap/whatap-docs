"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["91003"], {
...
"86739": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_nodejs_warning_notice_mdx_285_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-nodejs-warning-notice-mdx-285.json
var site_docs_nodejs_warning_notice_mdx_285_namespaceObject = JSON.parse('{"id":"nodejs/warning-notice","title":"애플리케이션 경고 알림","description":"애플리케이션의 자원 사용량 및, 진행 중 트랜잭션, 에러 상황의 이벤트 조건을 통해 경고 알림을 보냅니다.","source":"@site/docs/nodejs/warning-notice.mdx","sourceDirName":"nodejs","slug":"/nodejs/warning-notice","permalink":"/nodejs/warning-notice","draft":false,"unlisted":false,"editUrl":"undefined/docs/nodejs/warning-notice.mdx","tags":[],"version":"current","frontMatter":{"id":"warning-notice","title":"애플리케이션 경고 알림","description":"애플리케이션의 자원 사용량 및, 진행 중 트랜잭션, 에러 상황의 이벤트 조건을 통해 경고 알림을 보냅니다.","keywords":["Node.js","경고 알림","애플리케이션"],"isTranslationMissing":false},"sidebar":"nodejsSidebar","previous":{"title":"경고 알림","permalink":"/nodejs/apm-set-notice"},"next":{"title":"이벤트 설정","permalink":"/nodejs/warning-notice-v2"}}')
...
;// CONCATENATED MODULE: ./docs/nodejs/warning-notice.mdx
