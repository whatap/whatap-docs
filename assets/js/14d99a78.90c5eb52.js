"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["35336"], {
...
"97101": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_redis_flexboard_share_mdx_14d_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-redis-flexboard-share-mdx-14d.json
var site_docs_redis_flexboard_share_mdx_14d_namespaceObject = JSON.parse('{"id":"redis/flexboard-share","title":"Flex 보드 공유하기","description":"Flex 보드를 다른 계정의 사용자와 공유하고 재사용할 수 있습니다.","source":"@site/docs/redis/flexboard-share.mdx","sourceDirName":"redis","slug":"/redis/flexboard-share","permalink":"/redis/flexboard-share","draft":false,"unlisted":false,"editUrl":"undefined/docs/redis/flexboard-share.mdx","tags":[],"version":"current","frontMatter":{"id":"flexboard-share","title":"Flex 보드 공유하기","description":"Flex 보드를 다른 계정의 사용자와 공유하고 재사용할 수 있습니다.","keywords":["Redis","Flex 보드"],"isTranslationMissing":false},"sidebar":"redisSidebar","previous":{"title":"Flex 보드 화면 모드","permalink":"/redis/flexboard-mode"},"next":{"title":"카운트 추이 비교","permalink":"/redis/analysis-count-trend"}}')
...
;// CONCATENATED MODULE: ./docs/redis/flexboard-share.mdx
