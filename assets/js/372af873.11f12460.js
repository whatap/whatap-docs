"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["2620"], {
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_oracle_v_1_warning_notice_mdx_372_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-oracle-v-1-warning-notice-mdx-372.json
var site_docs_oracle_v_1_warning_notice_mdx_372_namespaceObject = JSON.parse('{"id":"oracle-v1/warning-notice","title":"데이터베이스 경고 알림","description":"데이터베이스의 지표별 이벤트 조건 설정을 통해 경고 알림을 보냅니다.","source":"@site/docs/oracle-v1/warning-notice.mdx","sourceDirName":"oracle-v1","slug":"/oracle-v1/warning-notice","permalink":"/oracle-v1/warning-notice","draft":false,"unlisted":false,"editUrl":"undefined/docs/oracle-v1/warning-notice.mdx","tags":[],"version":"current","frontMatter":{"id":"warning-notice","title":"데이터베이스 경고 알림","description":"데이터베이스의 지표별 이벤트 조건 설정을 통해 경고 알림을 보냅니다.","keywords":["Oracle","경고 알림","데이터베이스","데이터베이스 모니터링"],"isTranslationMissing":false},"sidebar":"dboracleSidebar","previous":{"title":"알림 설정하기","permalink":"/oracle-v1/set-notice"},"next":{"title":"이벤트 설정","permalink":"/oracle-v1/warning-notice-v2"}}')
...
;// CONCATENATED MODULE: ./docs/oracle-v1/warning-notice.mdx
