"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["64134"], {
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_oracle_v_1_metrics_intro_mdx_7ae_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-oracle-v-1-metrics-intro-mdx-7ae.json
var site_docs_oracle_v_1_metrics_intro_mdx_7ae_namespaceObject = JSON.parse('{"id":"oracle-v1/metrics-intro","title":"메트릭스","description":"데이터베이스 모니터링 분석을 위한 메트릭스 메뉴에 대해 알아봅니다.","source":"@site/docs/oracle-v1/metrics-intro.mdx","sourceDirName":"oracle-v1","slug":"/oracle-v1/metrics-intro","permalink":"/oracle-v1/metrics-intro","draft":false,"unlisted":false,"editUrl":"undefined/docs/oracle-v1/metrics-intro.mdx","tags":[],"version":"current","frontMatter":{"id":"metrics-intro","title":"메트릭스","description":"데이터베이스 모니터링 분석을 위한 메트릭스 메뉴에 대해 알아봅니다.","keywords":["Oracle","메트릭스","데이터베이스","데이터베이스 모니터링"],"isTranslationMissing":false},"sidebar":"dboracleSidebar","previous":{"title":"데이터베이스 파라미터","permalink":"/oracle-v1/analysis-databaseparameter"},"next":{"title":"Oracle 지표","permalink":"/oracle-v1/metrics-data-list"}}')
...
;// CONCATENATED MODULE: ./docs/oracle-v1/metrics-intro.mdx
