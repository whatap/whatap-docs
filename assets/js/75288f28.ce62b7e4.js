"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["11071"], {
...
"60829": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_oracle_v_1_set_event_detect_anomal_mdx_752_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-oracle-v-1-set-event-detect-anomal-mdx-752.json
var site_docs_oracle_v_1_set_event_detect_anomal_mdx_752_namespaceObject = JSON.parse('{"id":"oracle-v1/set-event-detect-anomal","title":"이상치 탐지 경고 알림","description":"예상치 못한 패턴을 찾는 일련의 활동을 탐지해 경고 알림을 보내도록 설정할 수 있습니다.","source":"@site/docs/oracle-v1/set-event-detect-anomal.mdx","sourceDirName":"oracle-v1","slug":"/oracle-v1/set-event-detect-anomal","permalink":"/oracle-v1/set-event-detect-anomal","draft":false,"unlisted":false,"editUrl":"undefined/docs/oracle-v1/set-event-detect-anomal.mdx","tags":[],"version":"current","frontMatter":{"id":"set-event-detect-anomal","title":"이상치 탐지 경고 알림","description":"예상치 못한 패턴을 찾는 일련의 활동을 탐지해 경고 알림을 보내도록 설정할 수 있습니다.","keywords":["Oracle","경고 알림","이상치 탐지","데이터베이스 모니터링"],"isTranslationMissing":false},"sidebar":"dboracleSidebar","previous":{"title":"알림 메시지 사용자 정의","permalink":"/oracle-v1/set-notification-message"},"next":{"title":"이벤트 수신 설정","permalink":"/oracle-v1/set-receive-event"}}')
...
;// CONCATENATED MODULE: ./docs/oracle-v1/set-event-detect-anomal.mdx
