"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[17081],{
...
const metadata = {
  "id": "mssql-v1/agent-dbx-settings",
  "title": "DBX 에이전트 설정",
  "description": "whatap.conf 파일에 설정할 수 있는 옵션에 대해 안내합니다.",
  "source": "@site/docs/mssql-v1/agent-dbx-settings.mdx",
  "sourceDirName": "mssql-v1",
  "slug": "/mssql-v1/agent-dbx-settings",
  "permalink": "/whatap-docs/mssql-v1/agent-dbx-settings",
  "draft": false,
  "unlisted": false,
  "editUrl": "undefined/docs/mssql-v1/agent-dbx-settings.mdx",
  "tags": [],
  "version": "current",
  "frontMatter": {
    "id": "agent-dbx-settings",
  ...
  "previous": {
    "title": "설정하기",
    "permalink": "/whatap-docs/mssql-v1/agent-settings"
  },
  "next": {
    "title": "관리하기",
    "permalink": "/whatap-docs/mssql-v1/agent-manage"
  }
};
const assets = {
