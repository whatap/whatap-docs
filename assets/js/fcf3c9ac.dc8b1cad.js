"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["41208"], {
...
"66394": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_mssql_v_1_agent_settings_mdx_fcf_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-mssql-v-1-agent-settings-mdx-fcf.json
var site_docs_mssql_v_1_agent_settings_mdx_fcf_namespaceObject = JSON.parse('{"id":"mssql-v1/agent-settings","title":"설정하기","description":"데이터베이스 에이전트 서버에 있는 whatap.conf 파일을 통해 설정할 수 있는 옵션에 대해 알아봅니다.","source":"@site/docs/mssql-v1/agent-settings.mdx","sourceDirName":"mssql-v1","slug":"/mssql-v1/agent-settings","permalink":"/mssql-v1/agent-settings","draft":false,"unlisted":false,"editUrl":"undefined/docs/mssql-v1/agent-settings.mdx","tags":[],"version":"current","frontMatter":{"id":"agent-settings","title":"설정하기","description":"데이터베이스 에이전트 서버에 있는 whatap.conf 파일을 통해 설정할 수 있는 옵션에 대해 알아봅니다.","keywords":["SQL Server","데이터베이스"],"isTranslationMissing":false},"sidebar":"mssqlV1Sidebar","previous":{"title":"설치 문제 해결","permalink":"/mssql-v1/troubleshooting"},"next":{"title":"DBX 에이전트 설정","permalink":"/mssql-v1/agent-dbx-settings"}}')
...
;// CONCATENATED MODULE: ./docs/mssql-v1/agent-settings.mdx
