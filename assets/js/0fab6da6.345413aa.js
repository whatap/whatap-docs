"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["47606"], {
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_php_analysis_hitmap_mdx_0fa_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-php-analysis-hitmap-mdx-0fa.json
var site_docs_php_analysis_hitmap_mdx_0fa_namespaceObject = JSON.parse('{"id":"php/analysis-hitmap","title":"히트맵","description":"애플리케이션에서 세부적인 트랜잭션 프로파일링을 구성하는 방법을 안내합니다. 트랜잭션 프로파일링을 통해 사용자는 애플리케이션 내부의 각각의 트랜잭션에 대한 성능 데이터를 수집하고 분석할 수 있으며, 이를 통해 애플리케이션의 성능을 개선하는 데 도움을 받을 수 있습니다.","source":"@site/docs/php/analysis-hitmap.mdx","sourceDirName":"php","slug":"/php/analysis-hitmap","permalink":"/php/analysis-hitmap","draft":false,"unlisted":false,"editUrl":"undefined/docs/php/analysis-hitmap.mdx","tags":[],"version":"current","frontMatter":{"id":"analysis-hitmap","title":"히트맵","description":"애플리케이션에서 세부적인 트랜잭션 프로파일링을 구성하는 방법을 안내합니다. 트랜잭션 프로파일링을 통해 사용자는 애플리케이션 내부의 각각의 트랜잭션에 대한 성능 데이터를 수집하고 분석할 수 있으며, 이를 통해 애플리케이션의 성능을 개선하는 데 도움을 받을 수 있습니다.","keywords":["애플리케이션","PHP","분석","히트맵","트랜잭션"],"isTranslationMissing":false},"sidebar":"phpSidebar","previous":{"title":"큐브","permalink":"/php/cube"},"next":{"title":"멀티 트랜잭션 추적","permalink":"/php/analysis-trace-mtx"}}')
...
;// CONCATENATED MODULE: ./docs/php/analysis-hitmap.mdx
