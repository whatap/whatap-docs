"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[10896],{
...
/* harmony import */ var _common_items_db_set_agent_desc_mdx__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(22613);


const frontMatter = {
	id: 'agent-settings',
	title: '설정하기',
	description: 'Redis 데이터베이스 에이전트 서버에 있는 whatap.conf 파일을 통해 설정할 수 있는 옵션에 대해 알아봅니다.',
	tags: [
		'Redis',
		'데이터베이스',
		'에이전트 설정'
...
const metadata = {
  ...
  "title": "설정하기",
  "description": "Redis 데이터베이스 에이전트 서버에 있는 whatap.conf 파일을 통해 설정할 수 있는 옵션에 대해 알아봅니다.",
  "source": "@site/docs/redis/agent-settings.mdx",
  "sourceDirName": "redis",
  "slug": "/redis/agent-settings",
  "permalink": "/whatap-docs/redis/agent-settings",
  "draft": false,
  "unlisted": false,
  "editUrl": "undefined/docs/redis/agent-settings.mdx",
  "tags": [
    {
      "label": "Redis",
