"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["86226"], {
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_oracle_agent_manage_mdx_f2c_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-oracle-agent-manage-mdx-f2c.json
var site_docs_oracle_agent_manage_mdx_f2c_namespaceObject = JSON.parse('{"id":"oracle/agent-manage","title":"관리하기","description":"whatap.conf 파일을 통해 데이터베이스 에이전트를 관리할 수 있습니다.","source":"@site/docs/oracle/agent-manage.mdx","sourceDirName":"oracle","slug":"/oracle/agent-manage","permalink":"/oracle/agent-manage","draft":false,"unlisted":false,"editUrl":"undefined/docs/oracle/agent-manage.mdx","tags":[],"version":"current","frontMatter":{"id":"agent-manage","title":"관리하기","description":"whatap.conf 파일을 통해 데이터베이스 에이전트를 관리할 수 있습니다.","keywords":["Oracle","데이터베이스","데이터베이스"],"isTranslationMissing":false},"sidebar":"dboracleV2Sidebar","previous":{"title":"클라우드 설정","permalink":"/oracle/cloudsettings"},"next":{"title":"대시보드","permalink":"/oracle/dashboard-intro"}}')
...
;// CONCATENATED MODULE: ./docs/oracle/agent-manage.mdx
