"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["90866"], {
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_mysql_log_db_mdx_4c2_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-mysql-log-db-mdx-4c2.json
var site_docs_mysql_log_db_mdx_4c2_namespaceObject = JSON.parse('{"id":"mysql/log-db","title":"적용하기","description":"데이터베이스와 AWS RDS의 로그를 수집하는 방법을 안내합니다.","source":"@site/docs/mysql/log-db.mdx","sourceDirName":"mysql","slug":"/mysql/log-db","permalink":"/mysql/log-db","draft":false,"unlisted":false,"editUrl":"undefined/docs/mysql/log-db.mdx","tags":[],"version":"current","frontMatter":{"id":"log-db","title":"적용하기","description":"데이터베이스와 AWS RDS의 로그를 수집하는 방법을 안내합니다.","keywords":["로그 모니터링","데이터베이스","MySQL"],"isTranslationMissing":false},"sidebar":"mysqlSidebar","previous":{"title":"로그","permalink":"/mysql/log-main"},"next":{"title":"라이브 테일","permalink":"/mysql/log-lt"}}')
...
;// CONCATENATED MODULE: ./docs/mysql/log-db.mdx
