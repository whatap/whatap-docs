"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["71674"], {
...
"40318": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_tibero_agent_dbx_setttings_mdx_9be_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-tibero-agent-dbx-setttings-mdx-9be.json
var site_docs_tibero_agent_dbx_setttings_mdx_9be_namespaceObject = JSON.parse('{"id":"tibero/agent-dbx-settings","title":"DBX 에이전트 설정","description":"whatap.conf 파일에 설정할 수 있는 옵션에 대해 안내합니다.","source":"@site/docs/tibero/agent-dbx-setttings.mdx","sourceDirName":"tibero","slug":"/tibero/agent-dbx-settings","permalink":"/tibero/agent-dbx-settings","draft":false,"unlisted":false,"editUrl":"undefined/docs/tibero/agent-dbx-setttings.mdx","tags":[],"version":"current","frontMatter":{"id":"agent-dbx-settings","title":"DBX 에이전트 설정","description":"whatap.conf 파일에 설정할 수 있는 옵션에 대해 안내합니다.","keywords":["Tibero","데이터베이스","DBX 에이전트"],"isTranslationMissing":false},"sidebar":"tiberoSidebar","previous":{"title":"설정하기","permalink":"/tibero/agent-settings"},"next":{"title":"XOS 에이전트 설정","permalink":"/tibero/agent-xos-settings"}}')
...
;// CONCATENATED MODULE: ./docs/tibero/agent-dbx-setttings.mdx
