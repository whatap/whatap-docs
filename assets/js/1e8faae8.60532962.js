"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["36795"], {
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_python_metrics_chart_mdx_1e8_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-python-metrics-chart-mdx-1e8.json
var site_docs_python_metrics_chart_mdx_1e8_namespaceObject = JSON.parse('{"id":"python/metrics-chart","title":"메트릭스 차트","description":"메트릭스 데이터를 차트로 조회할 수 있습니다.","source":"@site/docs/python/metrics-chart.mdx","sourceDirName":"python","slug":"/python/metrics-chart","permalink":"/python/metrics-chart","draft":false,"unlisted":false,"editUrl":"undefined/docs/python/metrics-chart.mdx","tags":[],"version":"current","frontMatter":{"id":"metrics-chart","title":"메트릭스 차트","description":"메트릭스 데이터를 차트로 조회할 수 있습니다.","keywords":["메트릭스","메트릭스 차트","UI"],"isTranslationMissing":false},"sidebar":"pySidebar","previous":{"title":"메트릭스 차트","permalink":"/python/metrics-chart-v2"},"next":{"title":"메트릭스 조회","permalink":"/python/metrics-search"}}')
...
;// CONCATENATED MODULE: ./docs/python/metrics-chart.mdx
