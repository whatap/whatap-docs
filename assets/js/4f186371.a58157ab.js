"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[10803],{
...
const metadata = {
  "id": "java/real-time-notification",
  "title": "실시간 알림",
  "description": "이벤트 설정 메뉴를 통해서 설정한 경고 알림을 실시간으로 확인할 수 있습니다.",
  "source": "@site/docs/java/real-time-notification.mdx",
  "sourceDirName": "java",
  "slug": "/java/real-time-notification",
  "permalink": "/whatap-docs/java/real-time-notification",
  "draft": false,
  "unlisted": false,
  "editUrl": "undefined/docs/java/real-time-notification.mdx",
  "tags": [],
  "version": "current",
  "frontMatter": {
    "id": "real-time-notification",
