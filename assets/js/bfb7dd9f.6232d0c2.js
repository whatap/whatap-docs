"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["78401"], {
"24533": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_altibase_instance_list_mdx_bfb_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-altibase-instance-list-mdx-bfb.json
var site_docs_altibase_instance_list_mdx_bfb_namespaceObject = JSON.parse('{"id":"altibase/instance-list","title":"인스턴스 목록","description":"에이전트를 설치한 데이터베이스 서버들의 목록을 확인할 수 있습니다.","source":"@site/docs/altibase/instance-list.mdx","sourceDirName":"altibase","slug":"/altibase/instance-list","permalink":"/altibase/instance-list","draft":false,"unlisted":false,"editUrl":"undefined/docs/altibase/instance-list.mdx","tags":[],"version":"current","frontMatter":{"id":"instance-list","title":"인스턴스 목록","description":"에이전트를 설치한 데이터베이스 서버들의 목록을 확인할 수 있습니다.","keywords":["Altibase","인스턴스","대시보드","데이터베이스 모니터링"],"isTranslationMissing":false},"sidebar":"altibaseSidebar","previous":{"title":"대시보드","permalink":"/altibase/dashboard-intro"},"next":{"title":"인스턴스 모니터링","permalink":"/altibase/instance-monitoring"}}')
...
;// CONCATENATED MODULE: ./docs/altibase/instance-list.mdx
