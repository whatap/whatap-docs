"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["1663"], {
...
"99918": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_oracle_warning_notice_mdx_8b3_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-oracle-warning-notice-mdx-8b3.json
var site_docs_oracle_warning_notice_mdx_8b3_namespaceObject = JSON.parse('{"id":"oracle/warning-notice","title":"데이터베이스 경고 알림","description":"데이터베이스의 지표별 이벤트 조건 설정을 통해 경고 알림을 보냅니다.","source":"@site/docs/oracle/warning-notice.mdx","sourceDirName":"oracle","slug":"/oracle/warning-notice","permalink":"/oracle/warning-notice","draft":false,"unlisted":false,"editUrl":"undefined/docs/oracle/warning-notice.mdx","tags":[],"version":"current","frontMatter":{"id":"warning-notice","title":"데이터베이스 경고 알림","description":"데이터베이스의 지표별 이벤트 조건 설정을 통해 경고 알림을 보냅니다.","keywords":["Oracle","경고 알림","데이터베이스","데이터베이스"],"isTranslationMissing":false},"sidebar":"dboracleV2Sidebar","previous":{"title":"알림 설정하기","permalink":"/oracle/set-notice"},"next":{"title":"이벤트 설정","permalink":"/oracle/warning-notice-v2"}}')
...
;// CONCATENATED MODULE: ./docs/oracle/warning-notice.mdx
