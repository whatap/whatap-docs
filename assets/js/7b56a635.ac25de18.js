"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[20328],{
...
/* harmony import */ var _common_items_db_agent_dbx_naming_mdx__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(16761);
...
const metadata = {
  "id": "cubrid-v1/agent-dbx-settings",
  "title": "DBX 에이전트 설정",
  "description": "whatap.conf 파일에 설정할 수 있는 옵션에 대해 안내합니다.",
  "source": "@site/docs/cubrid-v1/agent-dbx-settings.mdx",
  "sourceDirName": "cubrid-v1",
  "slug": "/cubrid-v1/agent-dbx-settings",
  "permalink": "/whatap-docs/cubrid-v1/agent-dbx-settings",
  "draft": false,
  "unlisted": false,
  "editUrl": "undefined/docs/cubrid-v1/agent-dbx-settings.mdx",
  "tags": [],
  "version": "current",
  "frontMatter": {
    "id": "agent-dbx-settings",
  ...
  "previous": {
    "title": "설정하기",
    "permalink": "/whatap-docs/cubrid-v1/agent-settings"
  },
  "next": {
    "title": "XOS 에이전트 설정",
