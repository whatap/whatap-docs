"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["63305"], {
...
"73398": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_postgresql_log_parser_mdx_e87_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-postgresql-log-parser-mdx-e87.json
var site_docs_postgresql_log_parser_mdx_e87_namespaceObject = JSON.parse('{"id":"postgresql/log-parser","title":"로그 파싱하기","description":"와탭이 제공하는 로그 파서에 대해 안내합니다.","source":"@site/docs/postgresql/log-parser.mdx","sourceDirName":"postgresql","slug":"/postgresql/log-parser","permalink":"/postgresql/log-parser","draft":false,"unlisted":false,"editUrl":"undefined/docs/postgresql/log-parser.mdx","tags":[],"version":"current","frontMatter":{"id":"log-parser","title":"로그 파싱하기","description":"와탭이 제공하는 로그 파서에 대해 안내합니다.","toc_max_heading_level":3,"keywords":["로그","로그 모니터링","설정하기","로그 파서","로그 파싱","PostgreSQL"],"isTranslationMissing":false},"sidebar":"postgreSidebar","previous":{"title":"로그 설정","permalink":"/postgresql/log-setting"},"next":{"title":"알림 설정하기","permalink":"/postgresql/set-notice"}}')
...
;// CONCATENATED MODULE: ./docs/postgresql/log-parser.mdx
