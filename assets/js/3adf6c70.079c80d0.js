"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["93890"], {
...
"20709": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_kubernetes_metrics_chart_mdx_3ad_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-kubernetes-metrics-chart-mdx-3ad.json
var site_docs_kubernetes_metrics_chart_mdx_3ad_namespaceObject = JSON.parse('{"id":"kubernetes/metrics-chart","title":"메트릭스 차트","description":"메트릭스 데이터를 차트로 조회할 수 있습니다.","source":"@site/docs/kubernetes/metrics-chart.mdx","sourceDirName":"kubernetes","slug":"/kubernetes/metrics-chart","permalink":"/kubernetes/metrics-chart","draft":false,"unlisted":false,"editUrl":"undefined/docs/kubernetes/metrics-chart.mdx","tags":[],"version":"current","frontMatter":{"id":"metrics-chart","title":"메트릭스 차트","description":"메트릭스 데이터를 차트로 조회할 수 있습니다.","keywords":["메트릭스","메트릭스 차트","UI"],"isTranslationMissing":false},"sidebar":"kubeSidebar","previous":{"title":"메트릭스 차트","permalink":"/kubernetes/metrics-chart-v2"},"next":{"title":"메트릭스 이상 탐지","permalink":"/kubernetes/metrics-detect-anormal"}}')
...
;// CONCATENATED MODULE: ./docs/kubernetes/metrics-chart.mdx
