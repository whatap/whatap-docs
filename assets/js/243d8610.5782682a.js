"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["98479"], {
...
"82870": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_server_set_receive_event_mdx_243_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-server-set-receive-event-mdx-243.json
var site_docs_server_set_receive_event_mdx_243_namespaceObject = JSON.parse('{"id":"server/set-receive-event","title":"이벤트 수신 설정","description":"프로젝트에 포함하는 멤버들의 경고 알림 수신과 관련한 다양한 기능을 설정할 수 있습니다.","source":"@site/docs/server/set-receive-event.mdx","sourceDirName":"server","slug":"/server/set-receive-event","permalink":"/server/set-receive-event","draft":false,"unlisted":false,"editUrl":"undefined/docs/server/set-receive-event.mdx","tags":[],"version":"current","frontMatter":{"id":"set-receive-event","title":"이벤트 수신 설정","description":"프로젝트에 포함하는 멤버들의 경고 알림 수신과 관련한 다양한 기능을 설정할 수 있습니다.","keywords":["경고 알림","이벤트 수신 태그","서버"],"isTranslationMissing":false},"sidebar":"serverSidebar","previous":{"title":"로그 경고 알림","permalink":"/server/set-event-log"},"next":{"title":"이벤트 기록","permalink":"/server/set-event-history"}}')
...
;// CONCATENATED MODULE: ./docs/server/set-receive-event.mdx
