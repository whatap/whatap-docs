"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["95810"], {
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_python_set_agent_mdx_c21_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-python-set-agent-mdx-c21.json
var site_docs_python_set_agent_mdx_c21_namespaceObject = JSON.parse('{"id":"python/set-agent","title":"에이전트 설정","description":"Python 에이전트의 기본 설정 방법을 제공합니다.","source":"@site/docs/python/set-agent.mdx","sourceDirName":"python","slug":"/python/set-agent","permalink":"/python/set-agent","draft":false,"unlisted":false,"editUrl":"undefined/docs/python/set-agent.mdx","tags":[],"version":"current","frontMatter":{"id":"set-agent","title":"에이전트 설정","description":"Python 에이전트의 기본 설정 방법을 제공합니다.","keywords":["Python","설정하기"],"isTranslationMissing":false},"sidebar":"pySidebar","previous":{"title":"설치 문제 해결","permalink":"/python/agent-troubleshooting"},"next":{"title":"에이전트 이름 식별","permalink":"/python/agent-name"}}')
...
;// CONCATENATED MODULE: ./docs/python/set-agent.mdx
...
function _createMdxContent(props) {
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsxs)(_components.p, {
      ...
      }), " 파일에 작성합니다. 에이전트는 환경변수를 통해 설정 파일의 위치를 파악하고 로딩합니다. 사용자의 편의성을 위해 ", (0,jsx_runtime.jsx)(_components.a, {
        href: "https://service.whatap.io",
        children: "와탭 모니터링 서비스"
