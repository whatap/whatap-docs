"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["19018"], {
...
"69084": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_mongodb_set_event_format_mdx_000_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-mongodb-set-event-format-mdx-000.json
var site_docs_mongodb_set_event_format_mdx_000_namespaceObject = JSON.parse('{"id":"mongodb/set-event-format","title":"이벤트 수신 포맷","description":"데이터베이스 모니터링에서 제공하는 경고 알림의 이벤트 수신 포맷에 대해 알아봅니다.","source":"@site/docs/mongodb/set-event-format.mdx","sourceDirName":"mongodb","slug":"/mongodb/set-event-format","permalink":"/mongodb/set-event-format","draft":false,"unlisted":false,"editUrl":"undefined/docs/mongodb/set-event-format.mdx","tags":[],"version":"current","frontMatter":{"id":"set-event-format","title":"이벤트 수신 포맷","description":"데이터베이스 모니터링에서 제공하는 경고 알림의 이벤트 수신 포맷에 대해 알아봅니다.","keywords":["MongoDB","경고 알림","이벤트","데이터베이스","데이터베이스 모니터링","이벤트 수신 포맷"],"isTranslationMissing":false},"sidebar":"mongodbSidebar","previous":{"title":"이벤트 기록","permalink":"/mongodb/set-event-history"},"next":{"title":"실시간 알림","permalink":"/mongodb/real-time-notification"}}')
...
;// CONCATENATED MODULE: ./docs/mongodb/set-event-format.mdx
