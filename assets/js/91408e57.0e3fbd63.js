"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["24890"], {
...
"73064": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_redis_flexboard_mode_mdx_914_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-redis-flexboard-mode-mdx-914.json
var site_docs_redis_flexboard_mode_mdx_914_namespaceObject = JSON.parse('{"id":"redis/flexboard-mode","title":"Flex 보드 화면 모드","description":"Flex 보드의 화면 모드에 따라 제공하는 기능에 대해 알아보세요.","source":"@site/docs/redis/flexboard-mode.mdx","sourceDirName":"redis","slug":"/redis/flexboard-mode","permalink":"/redis/flexboard-mode","draft":false,"unlisted":false,"editUrl":"undefined/docs/redis/flexboard-mode.mdx","tags":[],"version":"current","frontMatter":{"id":"flexboard-mode","title":"Flex 보드 화면 모드","description":"Flex 보드의 화면 모드에 따라 제공하는 기능에 대해 알아보세요.","keywords":["Redis","DB","데이터베이스","데이터베이스 모니터링","Flex 보드"],"isTranslationMissing":false},"sidebar":"redisSidebar","previous":{"title":"위젯 템플릿","permalink":"/redis/flexboard-widget-template"},"next":{"title":"Flex 보드 공유하기","permalink":"/redis/flexboard-share"}}')
...
;// CONCATENATED MODULE: ./docs/redis/flexboard-mode.mdx
