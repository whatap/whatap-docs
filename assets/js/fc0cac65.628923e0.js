"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["32453"], {
...
"85546": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_mongodb_dashboard_intro_mdx_fc0_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-mongodb-dashboard-intro-mdx-fc0.json
var site_docs_mongodb_dashboard_intro_mdx_fc0_namespaceObject = JSON.parse('{"id":"mongodb/dashboard-intro","title":"대시보드","description":"와탭 모니터링 대시보드는 MongoDB 데이터베이스 프로젝트의 전체 현황을 한 눈에 파악하기 위한 기능을 제공합니다.","source":"@site/docs/mongodb/dashboard-intro.mdx","sourceDirName":"mongodb","slug":"/mongodb/dashboard-intro","permalink":"/mongodb/dashboard-intro","draft":false,"unlisted":false,"editUrl":"undefined/docs/mongodb/dashboard-intro.mdx","tags":[],"version":"current","frontMatter":{"id":"dashboard-intro","title":"대시보드","description":"와탭 모니터링 대시보드는 MongoDB 데이터베이스 프로젝트의 전체 현황을 한 눈에 파악하기 위한 기능을 제공합니다.","keywords":["MongoDB","대시보드","인스턴스","데이터베이스"],"isTranslationMissing":false},"sidebar":"mongodbSidebar","previous":{"title":"관리하기","permalink":"/mongodb/agent-manage"},"next":{"title":"인스턴스 목록","permalink":"/mongodb/instance-list"}}')
...
;// CONCATENATED MODULE: ./docs/mongodb/dashboard-intro.mdx
