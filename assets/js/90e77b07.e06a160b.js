"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["84302"], {
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_java_collect_stacks_mdx_90e_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-java-collect-stacks-mdx-90e.json
var site_docs_java_collect_stacks_mdx_90e_namespaceObject = JSON.parse('{"id":"java/collect-stacks","title":"트랜잭션 스텝 수집 방식","description":"트랜잭션 스텝 수집 방식을 안내합니다.","source":"@site/docs/java/collect-stacks.mdx","sourceDirName":"java","slug":"/java/collect-stacks","permalink":"/java/collect-stacks","draft":false,"unlisted":false,"editUrl":"undefined/docs/java/collect-stacks.mdx","tags":[],"version":"current","frontMatter":{"id":"collect-stacks","title":"트랜잭션 스텝 수집 방식","description":"트랜잭션 스텝 수집 방식을 안내합니다.","keywords":["Java","트랜잭션"],"isTranslationMissing":false},"sidebar":"javaSidebar","previous":{"title":"트랜잭션 엔드포인트 설정","permalink":"/java/trs-endpoint-setting"},"next":{"title":"토폴로지","permalink":"/java/topology"}}')
...
;// CONCATENATED MODULE: ./docs/java/collect-stacks.mdx
