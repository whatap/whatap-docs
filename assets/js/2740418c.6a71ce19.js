"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["28754"], {
...
"15155": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_redis_flexboard_widget_template_mdx_274_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-redis-flexboard-widget-template-mdx-274.json
var site_docs_redis_flexboard_widget_template_mdx_274_namespaceObject = JSON.parse('{"id":"redis/flexboard-widget-template","title":"위젯 템플릿","description":"Flex 보드에서 대시보드에 배치할 수 있는 위젯의 종류를 안내합니다.","source":"@site/docs/redis/flexboard-widget-template.mdx","sourceDirName":"redis","slug":"/redis/flexboard-widget-template","permalink":"/redis/flexboard-widget-template","draft":false,"unlisted":false,"editUrl":"undefined/docs/redis/flexboard-widget-template.mdx","tags":[],"version":"current","frontMatter":{"id":"flexboard-widget-template","title":"위젯 템플릿","description":"Flex 보드에서 대시보드에 배치할 수 있는 위젯의 종류를 안내합니다.","keywords":["Flex 보드","위젯","템플릿"],"isTranslationMissing":false},"sidebar":"redisSidebar","previous":{"title":"위젯 관리하기","permalink":"/redis/flexboard-widget-manage"},"next":{"title":"Flex 보드 화면 모드","permalink":"/redis/flexboard-mode"}}')
...
;// CONCATENATED MODULE: ./docs/redis/flexboard-widget-template.mdx
