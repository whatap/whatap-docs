"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["61780"], {
...
"1293": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_php_dashboard_intro_mdx_086_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-php-dashboard-intro-mdx-086.json
var site_docs_php_dashboard_intro_mdx_086_namespaceObject = JSON.parse('{"id":"php/dashboard-intro","title":"대시보드","description":"와탭 모니터링 대시보드는 프로젝트의 전체 현황을 한 눈에 파악하기 위한 기능을 제공합니다.","source":"@site/docs/php/dashboard-intro.mdx","sourceDirName":"php","slug":"/php/dashboard-intro","permalink":"/php/dashboard-intro","draft":false,"unlisted":false,"editUrl":"undefined/docs/php/dashboard-intro.mdx","tags":[],"version":"current","frontMatter":{"id":"dashboard-intro","title":"대시보드","description":"와탭 모니터링 대시보드는 프로젝트의 전체 현황을 한 눈에 파악하기 위한 기능을 제공합니다.","keywords":["대시보드","PHP","애플리케이션","애플리케이션 모니터링"],"isTranslationMissing":false},"sidebar":"phpSidebar","previous":{"title":"에이전트 삭제","permalink":"/php/agent-remove"},"next":{"title":"애플리케이션 대시보드","permalink":"/php/dashboard"}}')
...
;// CONCATENATED MODULE: ./docs/php/dashboard-intro.mdx
