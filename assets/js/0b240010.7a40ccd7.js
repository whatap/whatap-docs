"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["87018"], {
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_php_supported_spec_mdx_0b2_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-php-supported-spec-mdx-0b2.json
var site_docs_php_supported_spec_mdx_0b2_namespaceObject = JSON.parse('{"id":"php/supported-spec","title":"지원 환경","description":"PHP 에이전트 지원 환경","source":"@site/docs/php/supported-spec.mdx","sourceDirName":"php","slug":"/php/supported-spec","permalink":"/php/supported-spec","draft":false,"unlisted":false,"editUrl":"undefined/docs/php/supported-spec.mdx","tags":[],"version":"current","frontMatter":{"id":"supported-spec","title":"지원 환경","displayed_sidebar":"phpSidebar","keywords":["PHP","PHP 모니터링","애플리케이션","애플리케이션 모니터링","지원 환경"],"isTranslationMissing":false},"sidebar":"phpSidebar","previous":{"title":"PHP 모니터링","permalink":"/php/introduction"},"next":{"title":"에이전트 설치","permalink":"/php/install-agent"}}')
...
;// CONCATENATED MODULE: ./docs/php/supported-spec.mdx
