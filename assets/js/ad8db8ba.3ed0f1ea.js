"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["10257"], {
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_redis_metric_warning_notice_new_mdx_ad8_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-redis-metric-warning-notice-new-mdx-ad8.json
var site_docs_redis_metric_warning_notice_new_mdx_ad8_namespaceObject = JSON.parse('{"id":"redis/metric-warning-notice-new","title":"메트릭스 경고 알림","description":"구체적이고 복잡한 이벤트를 설정하려면 메트릭스 이벤트 설정을 사용하세요.","source":"@site/docs/redis/metric-warning-notice-new.mdx","sourceDirName":"redis","slug":"/redis/metric-warning-notice-new","permalink":"/redis/metric-warning-notice-new","draft":false,"unlisted":false,"editUrl":"undefined/docs/redis/metric-warning-notice-new.mdx","tags":[],"version":"current","frontMatter":{"id":"metric-warning-notice-new","title":"메트릭스 경고 알림","description":"구체적이고 복잡한 이벤트를 설정하려면 메트릭스 이벤트 설정을 사용하세요.","displayed_sidebar":"redisSidebar","keywords":["Redis","경고 알림","메트릭스 이벤트"],"isTranslationMissing":false},"sidebar":"redisSidebar"}')
...
;// CONCATENATED MODULE: ./docs/redis/metric-warning-notice-new.mdx
