"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[35327],{
...
const metadata = {
  "id": "cubrid-v1/set-receive-event",
  "title": "이벤트 수신 설정",
  "description": "프로젝트에 포함하는 멤버들의 경고 알림 수신과 관련한 다양한 기능을 설정할 수 있습니다.",
  "source": "@site/docs/cubrid-v1/set-receive-event.mdx",
  "sourceDirName": "cubrid-v1",
  "slug": "/cubrid-v1/set-receive-event",
  "permalink": "/whatap-docs/cubrid-v1/set-receive-event",
  "draft": false,
  "unlisted": false,
  "editUrl": "undefined/docs/cubrid-v1/set-receive-event.mdx",
  "tags": [],
  "version": "current",
  "frontMatter": {
    "id": "set-receive-event",
