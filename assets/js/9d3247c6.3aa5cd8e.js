"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["71644"], {
...
"39540": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_java_warning_notice_mdx_9d3_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-java-warning-notice-mdx-9d3.json
var site_docs_java_warning_notice_mdx_9d3_namespaceObject = JSON.parse('{"id":"java/warning-notice","title":"애플리케이션 경고 알림","description":"애플리케이션의 자원 사용량 및, 진행 중 트랜잭션, 에러 상황의 이벤트 조건을 통해 경고 알림을 보냅니다.","source":"@site/docs/java/warning-notice.mdx","sourceDirName":"java","slug":"/java/warning-notice","permalink":"/java/warning-notice","draft":false,"unlisted":false,"editUrl":"undefined/docs/java/warning-notice.mdx","tags":[],"version":"current","frontMatter":{"id":"warning-notice","title":"애플리케이션 경고 알림","description":"애플리케이션의 자원 사용량 및, 진행 중 트랜잭션, 에러 상황의 이벤트 조건을 통해 경고 알림을 보냅니다.","keywords":["Java","경고 알림","애플리케이션"],"isTranslationMissing":false},"sidebar":"javaSidebar","previous":{"title":"경고 알림","permalink":"/java/apm-set-notice"},"next":{"title":"이벤트 설정","permalink":"/java/warning-notice-v2"}}')
...
;// CONCATENATED MODULE: ./docs/java/warning-notice.mdx
