"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["52588"], {
"70888": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_altibase_set_event_history_mdx_217_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-altibase-set-event-history-mdx-217.json
var site_docs_altibase_set_event_history_mdx_217_namespaceObject = JSON.parse('{"id":"altibase/set-event-history","title":"이벤트 기록","description":"이벤트 기록 메뉴를 통해 발생한 경고 알림 이력을 확인할 수 있습니다.","source":"@site/docs/altibase/set-event-history.mdx","sourceDirName":"altibase","slug":"/altibase/set-event-history","permalink":"/altibase/set-event-history","draft":false,"unlisted":false,"editUrl":"undefined/docs/altibase/set-event-history.mdx","tags":[],"version":"current","frontMatter":{"id":"set-event-history","title":"이벤트 기록","description":"이벤트 기록 메뉴를 통해 발생한 경고 알림 이력을 확인할 수 있습니다.","keywords":["Altibase","경고 알림","이벤트 기록","데이터베이스 모니터링"],"isTranslationMissing":false},"sidebar":"altibaseSidebar","previous":{"title":"이벤트 수신 설정","permalink":"/altibase/set-receive-event"},"next":{"title":"이벤트 수신 포맷","permalink":"/altibase/set-event-format"}}')
...
;// CONCATENATED MODULE: ./docs/altibase/set-event-history.mdx
