"use strict";
(self["webpackChunkwhatap_origin"] = self["webpackChunkwhatap_origin"] || []).push([[97920],{
...
var ExecutionEnvironment = __webpack_require__(58087);
...
var usePluralForm = __webpack_require__(40060);
...
var useAlgoliaThemeConfig = __webpack_require__(49704);
...
/* eslint-disable jsx-a11y/no-autofocus */ function _define_property(obj, key, value) {
    if (key in obj) {
...
function useDocsSearchVersionsHelpers() {
    ...
    const [searchVersions, setSearchVersions] = (0,react.useState)(()=>Object.entries(allDocsData).reduce((acc, [pluginId, pluginData])=>_object_spread_props(_object_spread({}, acc), {
                [pluginId]: pluginData.versions[0].name
            }), {}));
    // Set the value of a single select menu
    const setSearchVersion = (pluginId, searchVersion)=>setSearchVersions((s)=>_object_spread_props(_object_spread({}, s), {
...
function SearchVersionSelectList({ docsSearchVersionsHelpers }) {
    ...
    return /*#__PURE__*/ react.createElement("div", {
        className: (0,clsx_m/* default */.Z)('col', 'col--3', 'padding-left--none', styles_module.searchVersionColumn)
        ...
        }, docsData.versions.map((version, i)=>/*#__PURE__*/ react.createElement("option", {
                key: i,
...
function SearchPageContent() {
    ...
    const { algolia: { appId, apiKey, indexName } } = (0,useAlgoliaThemeConfig/* useAlgoliaThemeConfig */.L)();
    ...
    const algoliaClient = algoliasearch_lite_umd_default()(appId, apiKey);
    ...
    algoliaHelper.on('result', ({ results: { query, hits, page, nbHits, nbPages } })=>{
        ...
        const items = hits.map(({ url, _highlightResult: { hierarchy }, _snippetResult: snippet = {}, breadcrums })=>{
    ...
    const observer = (0,react.useRef)(ExecutionEnvironment/* default */.Z.canUseIntersectionObserver && new IntersectionObserver((entries)=>{
    ...
    const makeSearch = (0,reactUtils/* useEvent */.zX)((page = 0)=>{
    ...
    return /*#__PURE__*/ react.createElement(Layout/* default */.Z, null, /*#__PURE__*/ react.createElement(Head/* default */.Z, null, /*#__PURE__*/ react.createElement("title", null, (0,generalUtils/* useTitleFormatter */.p)(getTitle())), /*#__PURE__*/ react.createElement("meta", {
        property: "robots",
        content: "noindex, follow"
    })), /*#__PURE__*/ react.createElement("div", {
        className: "container margin-vert--lg"
    }, /*#__PURE__*/ react.createElement("h1", null, getTitle()), /*#__PURE__*/ react.createElement("form", {
        className: "row",
        onSubmit: (e)=>e.preventDefault()
    }, /*#__PURE__*/ react.createElement("div", {
        className: (0,clsx_m/* default */.Z)('col', styles_module.searchQueryColumn, {
        ...
        autoComplete: "off",
        autoFocus: true
    })), docsSearchVersionsHelpers.versioningEnabled && /*#__PURE__*/ react.createElement(SearchVersionSelectList, {
        docsSearchVersionsHelpers: docsSearchVersionsHelpers
    })), /*#__PURE__*/ react.createElement("div", {
        className: "row"
    }, /*#__PURE__*/ react.createElement("div", {
        className: (0,clsx_m/* default */.Z)('col', 'col--8', styles_module.searchResultsColumn)
    }, !!searchResultState.totalResults && documentsFoundPlural(searchResultState.totalResults)), /*#__PURE__*/ react.createElement("div", {
        className: (0,clsx_m/* default */.Z)('col', 'col--4', 'text--right', styles_module.searchLogoColumn)
        ...
        d: "M89.632 5.967v-.772a.978.978 0 0 0-.978-.977h-2.28a.978.978 0 0 0-.978.977v.793c0 .088.082.15.171.13a7.127 7.127 0 0 1 1.984-.28c.65 0 1.295.088 1.917.259.082.02.164-.04.164-.13m-6.248 1.01l-.39-.389a.977.977 0 0 0-1.382 0l-.465.465a.973.973 0 0 0 0 1.38l.383.383c.062.061.15.047.205-.014.226-.307.472-.601.746-.874.281-.28.568-.526.883-.751.068-.042.075-.137.02-.2m4.16 2.453v3.341c0 .096.104.165.192.117l2.97-1.537c.068-.034.089-.117.055-.184a3.695 3.695 0 0 0-3.08-1.866c-.068 0-.136.054-.136.13m0 8.048a4.489 4.489 0 0 1-4.49-4.482 4.488 4.488 0 0 1 4.49-4.482 4.488 4.488 0 0 1 4.489 4.482 4.484 4.484 0 0 1-4.49 4.482m0-10.85a6.363 6.363 0 1 0 0 12.729 6.37 6.37 0 0 0 6.372-6.368 6.358 6.358 0 0 0-6.371-6.36"
    })))))), searchResultState.items.length > 0 ? /*#__PURE__*/ react.createElement("main", null, searchResultState.items.map(({ title, url, summary, breadcrumbs, docpath }, i)=>/*#__PURE__*/ react.createElement("article", {
            key: i,
            className: styles_module.searchResultItem
        }, /*#__PURE__*/ react.createElement("h2", {
            className: styles_module.searchResultItemHeading
        }, docpath == "" ? /*#__PURE__*/ react.createElement(Link/* default */.Z, {
            to: url,
            ...
            to: url,
            dangerouslySetInnerHTML: {
                __html: docpath.replace("Docs > ", "")
            }
        })), breadcrumbs.length > 1 && /*#__PURE__*/ react.createElement("h3", {
            className: (0,clsx_m/* default */.Z)('breadcrumbs', styles_module.searchResultItemPath)
        }, breadcrumbs.slice(1).map((html, index)=>/*#__PURE__*/ react.createElement("span", {
                key: index,
        ...
        searchQuery && !searchResultState.loading && /*#__PURE__*/ react.createElement("p", {
            key: "no-results"
        }, /*#__PURE__*/ react.createElement(Translate/* default */.Z, {
            id: "theme.SearchPage.noResultsText",
            description: "The paragraph for empty search result"
        }, "No results were found")),
        !!searchResultState.loading && /*#__PURE__*/ react.createElement("div", {
            key: "spinner",
            className: styles_module.loadingSpinner
        })
    ], searchResultState.hasMore && /*#__PURE__*/ react.createElement("div", {
...
function SearchPage() {
    ...
    }, /*#__PURE__*/ react.createElement(SearchPageContent, null));
}
