"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["73870"], {
...
"71905": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_java_track_transactions_intro_mdx_f45_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-java-track-transactions-intro-mdx-f45.json
var site_docs_java_track_transactions_intro_mdx_f45_namespaceObject = JSON.parse('{"id":"java/track-transactions-intro","title":"트랜잭션","description":"트랜잭션의 개요를 안내합니다.","source":"@site/docs/java/track-transactions-intro.mdx","sourceDirName":"java","slug":"/java/track-transactions-intro","permalink":"/java/track-transactions-intro","draft":false,"unlisted":false,"editUrl":"undefined/docs/java/track-transactions-intro.mdx","tags":[],"version":"current","frontMatter":{"id":"track-transactions-intro","title":"트랜잭션","description":"트랜잭션의 개요를 안내합니다.","keywords":["Java","트랜잭션"],"isTranslationMissing":false},"sidebar":"javaSidebar","previous":{"title":"메트릭스 이상 탐지","permalink":"/java/metrics-detect-anormal"},"next":{"title":"트랜잭션 분석하기","permalink":"/java/trs-view"}}')
...
;// CONCATENATED MODULE: ./docs/java/track-transactions-intro.mdx
