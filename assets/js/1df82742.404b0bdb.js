"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["21933"], {
...
"28933": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_golang_metrics_chart_v_2_mdx_1df_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-golang-metrics-chart-v-2-mdx-1df.json
var site_docs_golang_metrics_chart_v_2_mdx_1df_namespaceObject = JSON.parse('{"id":"golang/metrics-chart-v2","title":"메트릭스 차트","description":"메트릭스 데이터를 차트로 조회할 수 있습니다.","source":"@site/docs/golang/metrics-chart-v2.mdx","sourceDirName":"golang","slug":"/golang/metrics-chart-v2","permalink":"/golang/metrics-chart-v2","draft":false,"unlisted":false,"editUrl":"undefined/docs/golang/metrics-chart-v2.mdx","tags":[],"version":"current","frontMatter":{"id":"metrics-chart-v2","title":"메트릭스 차트","description":"메트릭스 데이터를 차트로 조회할 수 있습니다.","keywords":["Go","애플리케이션","메트릭스","메트릭스 차트"],"isTranslationMissing":false},"sidebar":"goSidebar","previous":{"title":"애플리케이션 성능 카운터","permalink":"/golang/metrics-performance-counter"},"next":{"title":"메트릭스 차트","permalink":"/golang/metrics-chart"}}')
...
;// CONCATENATED MODULE: ./docs/golang/metrics-chart-v2.mdx
