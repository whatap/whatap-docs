"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["41664"], {
...
"15510": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_python_analysis_apm_mdx_8e7_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-python-analysis-apm-mdx-8e7.json
var site_docs_python_analysis_apm_mdx_8e7_namespaceObject = JSON.parse('{"id":"python/analysis-apm","title":"스택","description":"특정 시간대의 호출 스택의 빈도와 메소드, 트랜잭션에 대한 상세 정보를 확인할 수 있습니다.","source":"@site/docs/python/analysis-apm.mdx","sourceDirName":"python","slug":"/python/analysis-apm","permalink":"/python/analysis-apm","draft":false,"unlisted":false,"editUrl":"undefined/docs/python/analysis-apm.mdx","tags":[],"version":"current","frontMatter":{"id":"analysis-apm","title":"스택","description":"특정 시간대의 호출 스택의 빈도와 메소드, 트랜잭션에 대한 상세 정보를 확인할 수 있습니다.","keywords":["Python","애플리케이션","분석","스택"],"isTranslationMissing":false},"sidebar":"pySidebar","previous":{"title":"성능 추이","permalink":"/python/performance-trend"},"next":{"title":"큐브","permalink":"/python/cube"}}')
...
;// CONCATENATED MODULE: ./docs/python/analysis-apm.mdx
