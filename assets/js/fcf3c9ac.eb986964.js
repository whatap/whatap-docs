...
const metadata = {
  ...
  "title": "설정하기",
  "description": "데이터베이스 에이전트 서버에 있는 whatap.conf 파일을 통해 설정할 수 있는 옵션에 대해 알아봅니다.",
  "source": "@site/docs/mssql-v1/agent-settings.mdx",
  "sourceDirName": "mssql-v1",
  "slug": "/mssql-v1/agent-settings",
  "permalink": "/whatap-docs/mssql-v1/agent-settings",
  "draft": false,
  "unlisted": false,
  "editUrl": "undefined/docs/mssql-v1/agent-settings.mdx",
  "tags": [],
  "version": "current",
  "frontMatter": {
    "id": "agent-settings",
  ...
  "previous": {
    "title": "설치 문제 해결",
    "permalink": "/whatap-docs/mssql-v1/troubleshooting"
  },
  "next": {
    "title": "DBX 에이전트 설정",
