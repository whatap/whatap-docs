"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["18994"], {
"28213": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_azure_real_time_notification_mdx_f48_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-azure-real-time-notification-mdx-f48.json
var site_docs_azure_real_time_notification_mdx_f48_namespaceObject = JSON.parse('{"id":"azure/real-time-notification","title":"실시간 알림","description":"이벤트 설정 메뉴를 통해서 설정한 경고 알림을 실시간으로 확인할 수 있습니다.","source":"@site/docs/azure/real-time-notification.mdx","sourceDirName":"azure","slug":"/azure/real-time-notification","permalink":"/azure/real-time-notification","draft":false,"unlisted":false,"editUrl":"undefined/docs/azure/real-time-notification.mdx","tags":[],"version":"current","frontMatter":{"id":"real-time-notification","title":"실시간 알림","description":"이벤트 설정 메뉴를 통해서 설정한 경고 알림을 실시간으로 확인할 수 있습니다.","keywords":["실시간 알림"],"isTranslationMissing":false},"sidebar":"azuremonitorSidebar","previous":{"title":"이벤트 기록","permalink":"/azure/set-event-history"},"next":{"title":"시스템 이벤트 안내","permalink":"/azure/common-alert"}}')
...
;// CONCATENATED MODULE: ./docs/azure/real-time-notification.mdx
