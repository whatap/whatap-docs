"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[86897],{
...
const metadata = {
  "id": "cubrid-v1/agent-xcub-settings",
  "title": "XCUB 에이전트 설정",
  "description": "CUBRID DB 모니터링을 위해서는 부가 에이전트인 XCUB 설치를 통해 sql_text와 지표의 델타 계산을 위한 정보를 제공합니다.",
  "source": "@site/docs/cubrid-v1/agent-xcub-settings.mdx",
  "sourceDirName": "cubrid-v1",
  "slug": "/cubrid-v1/agent-xcub-settings",
  "permalink": "/whatap-docs/cubrid-v1/agent-xcub-settings",
  "draft": false,
  "unlisted": false,
  "editUrl": "undefined/docs/cubrid-v1/agent-xcub-settings.mdx",
  "tags": [],
  "version": "current",
  "frontMatter": {
    "id": "agent-xcub-settings",
