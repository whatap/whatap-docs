"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["16719"], {
...
"90239": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_php_analysis_report_intro_mdx_3f5_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-php-analysis-report-intro-mdx-3f5.json
var site_docs_php_analysis_report_intro_mdx_3f5_namespaceObject = JSON.parse('{"id":"php/analysis-report-intro","title":"분석","description":"PHP 환경의 애플리케이션 성능을 분석하고 발생할 수 있는 문제에 대처할 수 있습니다.","source":"@site/docs/php/analysis-report-intro.mdx","sourceDirName":"php","slug":"/php/analysis-report-intro","permalink":"/php/analysis-report-intro","draft":false,"unlisted":false,"editUrl":"undefined/docs/php/analysis-report-intro.mdx","tags":[],"version":"current","frontMatter":{"id":"analysis-report-intro","title":"분석","description":"PHP 환경의 애플리케이션 성능을 분석하고 발생할 수 있는 문제에 대처할 수 있습니다.","keywords":["PHP","애플리케이션","분석"],"isTranslationMissing":false},"sidebar":"phpSidebar","previous":{"title":"Flex 보드 공유하기","permalink":"/php/flexboard-share"},"next":{"title":"일자별 애플리케이션 현황","permalink":"/php/application-daily-stat"}}')
...
;// CONCATENATED MODULE: ./docs/php/analysis-report-intro.mdx
