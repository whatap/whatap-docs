"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["22152"], {
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_mongodb_agent_manage_mdx_93a_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-mongodb-agent-manage-mdx-93a.json
var site_docs_mongodb_agent_manage_mdx_93a_namespaceObject = JSON.parse('{"id":"mongodb/agent-manage","title":"관리하기","description":"MongoDB 데이터베이스의 에이전트를 업데이트하거나 삭제하는 방법을 알아봅니다.","source":"@site/docs/mongodb/agent-manage.mdx","sourceDirName":"mongodb","slug":"/mongodb/agent-manage","permalink":"/mongodb/agent-manage","draft":false,"unlisted":false,"editUrl":"undefined/docs/mongodb/agent-manage.mdx","tags":[],"version":"current","frontMatter":{"id":"agent-manage","title":"관리하기","description":"MongoDB 데이터베이스의 에이전트를 업데이트하거나 삭제하는 방법을 알아봅니다.","keywords":["MongoDB","데이터베이스","에이전트"],"isTranslationMissing":false},"sidebar":"mongodbSidebar","previous":{"title":"XOS 에이전트 설정","permalink":"/mongodb/agent-xos-settings"},"next":{"title":"대시보드","permalink":"/mongodb/dashboard-intro"}}')
...
;// CONCATENATED MODULE: ./docs/mongodb/agent-manage.mdx
