"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["14998"], {
...
"11402": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_java_flexboard_widget_manage_mdx_8e6_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-java-flexboard-widget-manage-mdx-8e6.json
var site_docs_java_flexboard_widget_manage_mdx_8e6_namespaceObject = JSON.parse('{"id":"java/flexboard-widget-manage","title":"위젯 관리하기","description":"Flex 보드에 배치한 위젯의 추가, 속성 변경, 복사, 삭제 방법을 안내합니다. 사용자는 위젯을 추가하거나 기존 위젯의 속성을 조정하여 대시보드를 개인화할 수 있습니다. 위젯의 데이터 조회 조건 변경, 시간 설정, 데이터 병합 옵션 설정 등 세밀한 관리 기능을 통해 사용자의 모니터링 요구에 맞는 대시보드를 구성할 수 있습니다.","source":"@site/docs/java/flexboard-widget-manage.mdx","sourceDirName":"java","slug":"/java/flexboard-widget-manage","permalink":"/java/flexboard-widget-manage","draft":false,"unlisted":false,"editUrl":"undefined/docs/java/flexboard-widget-manage.mdx","tags":[],"version":"current","frontMatter":{"id":"flexboard-widget-manage","title":"위젯 관리하기","description":"Flex 보드에 배치한 위젯의 추가, 속성 변경, 복사, 삭제 방법을 안내합니다. 사용자는 위젯을 추가하거나 기존 위젯의 속성을 조정하여 대시보드를 개인화할 수 있습니다. 위젯의 데이터 조회 조건 변경, 시간 설정, 데이터 병합 옵션 설정 등 세밀한 관리 기능을 통해 사용자의 모니터링 요구에 맞는 대시보드를 구성할 수 있습니다.","keywords":["Java","Flex 보드","위젯","메트릭스"],"isTranslationMissing":false},"sidebar":"javaSidebar","previous":{"title":"메트릭스 위젯","permalink":"/java/flexboard-metric-widget"},"next":{"title":"위젯 템플릿","permalink":"/java/flexboard-widget-template"}}')
...
;// CONCATENATED MODULE: ./docs/java/flexboard-widget-manage.mdx
