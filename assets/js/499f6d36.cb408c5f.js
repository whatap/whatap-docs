"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[88542],{
...
/* harmony import */ var _common_items_analysis_trace_mtx_mdx__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(83806);
...
const metadata = {
  "id": "python/analysis-trace-mtx",
  "title": "멀티 트랜잭션 추적",
  "description": "시스템 내 또는 시스템 간에 발생하는 다양한 호출 관계를 한 눈에 파악하고 어느 부분에서 문제가 발생했는지 식별하여 개선할 수 있도록 트랜잭션과 트레이스 정보를 제공합니다.",
  "source": "@site/docs/python/analysis-trace-mtx.mdx",
  "sourceDirName": "python",
  "slug": "/python/analysis-trace-mtx",
  "permalink": "/whatap-docs/python/analysis-trace-mtx",
  "draft": false,
  "unlisted": false,
  "editUrl": "undefined/docs/python/analysis-trace-mtx.mdx",
  "tags": [
    {
      "label": "Python",
  ...
  "next": {
    "title": "트랜잭션 검색",
    "permalink": "/whatap-docs/python/tx-profile"
  }
};
const assets = {
