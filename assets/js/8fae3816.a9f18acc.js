"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["89684"], {
"9543": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_altibase_metric_warning_notice_mdx_8fa_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-altibase-metric-warning-notice-mdx-8fa.json
var site_docs_altibase_metric_warning_notice_mdx_8fa_namespaceObject = JSON.parse('{"id":"altibase/metric-warning-notice","title":"메트릭스 경고 알림","description":"구체적이고 복잡한 이벤트를 설정하려면 메트릭스 이벤트 설정을 사용하세요.","source":"@site/docs/altibase/metric-warning-notice.mdx","sourceDirName":"altibase","slug":"/altibase/metric-warning-notice","permalink":"/altibase/metric-warning-notice","draft":false,"unlisted":false,"editUrl":"undefined/docs/altibase/metric-warning-notice.mdx","tags":[],"version":"current","frontMatter":{"id":"metric-warning-notice","title":"메트릭스 경고 알림","description":"구체적이고 복잡한 이벤트를 설정하려면 메트릭스 이벤트 설정을 사용하세요.","keywords":["Altibase","경고 알림","메트릭스 이벤트","데이터베이스 모니터링"],"isTranslationMissing":false},"sidebar":"altibaseSidebar","previous":{"title":"이벤트 설정","permalink":"/altibase/warning-notice-v2"},"next":{"title":"알림 메시지 사용자 정의","permalink":"/altibase/set-notification-message"}}')
...
;// CONCATENATED MODULE: ./docs/altibase/metric-warning-notice.mdx
