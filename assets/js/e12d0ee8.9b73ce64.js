...
"25487": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_oracle_pro_common_alert_mdx_e12_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-oracle-pro-common-alert-mdx-e12.json
var site_docs_oracle_pro_common_alert_mdx_e12_namespaceObject = JSON.parse('{"id":"oracle-pro/common-alert","title":"시스템 이벤트 안내","description":"와탭 모니터링에서는 플랫폼 전반에서 자동으로 탐지 및 생성되는 공용 이벤트에 대해 안내합니다.","source":"@site/docs/oracle-pro/common-alert.mdx","sourceDirName":"oracle-pro","slug":"/oracle-pro/common-alert","permalink":"/oracle-pro/common-alert","draft":false,"unlisted":false,"editUrl":"undefined/docs/oracle-pro/common-alert.mdx","tags":[],"version":"current","frontMatter":{"id":"common-alert","title":"시스템 이벤트 안내","description":"와탭 모니터링에서는 플랫폼 전반에서 자동으로 탐지 및 생성되는 공용 이벤트에 대해 안내합니다.","keywords":["와탭","경고 알림","시스템 이벤트"],"isTranslationMissing":false},"sidebar":"dboracledmaSidebar","previous":{"title":"실시간 알림","permalink":"/oracle-pro/real-time-notification"},"next":{"title":"연계 프로젝트 관리","permalink":"/oracle-pro/linked-projects"}}')
...
;// CONCATENATED MODULE: ./docs/oracle-pro/common-alert.mdx
