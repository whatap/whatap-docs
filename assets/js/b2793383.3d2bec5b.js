"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["66715"], {
...
"59810": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_java_set_event_history_mdx_b27_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-java-set-event-history-mdx-b27.json
var site_docs_java_set_event_history_mdx_b27_namespaceObject = JSON.parse('{"id":"java/set-event-history","title":"이벤트 기록","description":"이벤트 기록 메뉴를 통해 발생한 경고 알림 이력을 확인할 수 있습니다.","source":"@site/docs/java/set-event-history.mdx","sourceDirName":"java","slug":"/java/set-event-history","permalink":"/java/set-event-history","draft":false,"unlisted":false,"editUrl":"undefined/docs/java/set-event-history.mdx","tags":[],"version":"current","frontMatter":{"id":"set-event-history","title":"이벤트 기록","description":"이벤트 기록 메뉴를 통해 발생한 경고 알림 이력을 확인할 수 있습니다.","keywords":["Java","경고 알림","이벤트 기록","애플리케이션 모니터링"],"isTranslationMissing":false},"sidebar":"javaSidebar","previous":{"title":"이벤트 수신 설정","permalink":"/java/set-receive-event"},"next":{"title":"이벤트 수신 포맷","permalink":"/java/set-event-format"}}')
...
;// CONCATENATED MODULE: ./docs/java/set-event-history.mdx
