"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["39431"], {
...
"29060": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_oracle_v_1_stat_mdx_bbe_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-oracle-v-1-stat-mdx-bbe.json
var site_docs_oracle_v_1_stat_mdx_bbe_namespaceObject = JSON.parse('{"id":"oracle-v1/stat","title":"SQL 통계","description":"Oracle의 데이터베이스별 통계 데이터를 제공합니다.","source":"@site/docs/oracle-v1/stat.mdx","sourceDirName":"oracle-v1","slug":"/oracle-v1/stat","permalink":"/oracle-v1/stat","draft":false,"unlisted":false,"editUrl":"undefined/docs/oracle-v1/stat.mdx","tags":[],"version":"current","frontMatter":{"id":"stat","title":"SQL 통계","description":"Oracle의 데이터베이스별 통계 데이터를 제공합니다.","keywords":["Oracle","데이터베이스","통계"],"isTranslationMissing":false},"sidebar":"dboracleSidebar","previous":{"title":"메트릭스 이상 탐지","permalink":"/oracle-v1/metrics-detect-anormal"},"next":{"title":"테이블스페이스 사이즈","permalink":"/oracle-v1/table-space-size"}}')
...
;// CONCATENATED MODULE: ./docs/oracle-v1/stat.mdx
