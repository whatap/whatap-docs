"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["10667"], {
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_oracle_pro_analysis_sql_mdx_a6b_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-oracle-pro-analysis-sql-mdx-a6b.json
var site_docs_oracle_pro_analysis_sql_mdx_a6b_namespaceObject = JSON.parse('{"id":"oracle-pro/analysis-sql","title":"SQL 분석","description":"데이터베이스에서 실행되는 SQL 문을 분석하여 성능 문제를 진단하는 데 유용한 자료를 제공합니다.","source":"@site/docs/oracle-pro/analysis-sql.mdx","sourceDirName":"oracle-pro","slug":"/oracle-pro/analysis-sql","permalink":"/oracle-pro/analysis-sql","draft":false,"unlisted":false,"editUrl":"undefined/docs/oracle-pro/analysis-sql.mdx","tags":[],"version":"current","frontMatter":{"id":"analysis-sql","title":"SQL 분석","description":"데이터베이스에서 실행되는 SQL 문을 분석하여 성능 문제를 진단하는 데 유용한 자료를 제공합니다.","keywords":["Oracle Pro","데이터베이스","분석","SQL"],"isTranslationMissing":false},"sidebar":"dboracledmaSidebar","previous":{"title":"Wait 분석","permalink":"/oracle-pro/analysis-wait-events"},"next":{"title":"Top SQL 비교","permalink":"/oracle-pro/analysis-compare-top-sql"}}')
...
;// CONCATENATED MODULE: ./docs/oracle-pro/analysis-sql.mdx
...
const toc = [..._analysis_sql/* toc */.d$, ..._db_sql_filter/* toc */.d$];
function _createMdxContent(props) {
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsx)(_analysis_sql/* default */.ZP, {}), "\n", "\n", "\n", (0,jsx_runtime.jsx)(_db_sql_filter/* default */.ZP, {
      level: 3
    })]
  });
}
