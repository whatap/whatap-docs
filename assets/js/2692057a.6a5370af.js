"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["45939"], {
...
"29630": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_golang_metrics_chart_mdx_269_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-golang-metrics-chart-mdx-269.json
var site_docs_golang_metrics_chart_mdx_269_namespaceObject = JSON.parse('{"id":"golang/metrics-chart","title":"메트릭스 차트","description":"메트릭스 데이터를 차트로 조회할 수 있습니다.","source":"@site/docs/golang/metrics-chart.mdx","sourceDirName":"golang","slug":"/golang/metrics-chart","permalink":"/golang/metrics-chart","draft":false,"unlisted":false,"editUrl":"undefined/docs/golang/metrics-chart.mdx","tags":[],"version":"current","frontMatter":{"id":"metrics-chart","title":"메트릭스 차트","description":"메트릭스 데이터를 차트로 조회할 수 있습니다.","keywords":["메트릭스","메트릭스 차트","UI"],"isTranslationMissing":false},"sidebar":"goSidebar","previous":{"title":"메트릭스 차트","permalink":"/golang/metrics-chart-v2"},"next":{"title":"메트릭스 조회","permalink":"/golang/metrics-search"}}')
...
;// CONCATENATED MODULE: ./docs/golang/metrics-chart.mdx
