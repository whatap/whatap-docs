"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["16151"], {
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_tibero_agent_settings_mdx_a33_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-tibero-agent-settings-mdx-a33.json
var site_docs_tibero_agent_settings_mdx_a33_namespaceObject = JSON.parse('{"id":"tibero/agent-settings","title":"설정하기","description":"데이터베이스 에이전트 서버에 있는 whatap.conf 파일을 통해 설정할 수 있는 옵션에 대해 알아봅니다.","source":"@site/docs/tibero/agent-settings.mdx","sourceDirName":"tibero","slug":"/tibero/agent-settings","permalink":"/tibero/agent-settings","draft":false,"unlisted":false,"editUrl":"undefined/docs/tibero/agent-settings.mdx","tags":[],"version":"current","frontMatter":{"id":"agent-settings","title":"설정하기","description":"데이터베이스 에이전트 서버에 있는 whatap.conf 파일을 통해 설정할 수 있는 옵션에 대해 알아봅니다.","keywords":["Tibero","데이터베이스"],"isTranslationMissing":false},"sidebar":"tiberoSidebar","previous":{"title":"설치 문제 해결","permalink":"/tibero/troubleshooting"},"next":{"title":"DBX 에이전트 설정","permalink":"/tibero/agent-dbx-settings"}}')
...
;// CONCATENATED MODULE: ./docs/tibero/agent-settings.mdx
