"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["4516"], {
...
"14031": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_tibero_real_time_notification_mdx_4ea_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-tibero-real-time-notification-mdx-4ea.json
var site_docs_tibero_real_time_notification_mdx_4ea_namespaceObject = JSON.parse('{"id":"tibero/real-time-notification","title":"실시간 알림","description":"이벤트 설정 메뉴를 통해서 설정한 경고 알림을 실시간으로 확인할 수 있습니다.","source":"@site/docs/tibero/real-time-notification.mdx","sourceDirName":"tibero","slug":"/tibero/real-time-notification","permalink":"/tibero/real-time-notification","draft":false,"unlisted":false,"editUrl":"undefined/docs/tibero/real-time-notification.mdx","tags":[],"version":"current","frontMatter":{"id":"real-time-notification","title":"실시간 알림","description":"이벤트 설정 메뉴를 통해서 설정한 경고 알림을 실시간으로 확인할 수 있습니다.","keywords":["실시간 알림"],"isTranslationMissing":false},"sidebar":"tiberoSidebar","previous":{"title":"이벤트 수신 포맷","permalink":"/tibero/set-event-format"},"next":{"title":"시스템 이벤트 안내","permalink":"/tibero/common-alert"}}')
...
;// CONCATENATED MODULE: ./docs/tibero/real-time-notification.mdx
