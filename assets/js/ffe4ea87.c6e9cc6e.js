"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["60973"], {
...
"8643": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_dotnet_analysis_hitmap_mdx_ffe_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-dotnet-analysis-hitmap-mdx-ffe.json
var site_docs_dotnet_analysis_hitmap_mdx_ffe_namespaceObject = JSON.parse('{"id":"dotnet/analysis-hitmap","title":"히트맵","description":"애플리케이션에서 세부적인 트랜잭션 프로파일링을 구성하는 방법을 안내합니다. 트랜잭션 프로파일링을 통해 사용자는 애플리케이션 내부의 각각의 트랜잭션에 대한 성능 데이터를 수집하고 분석할 수 있으며, 이를 통해 애플리케이션의 성능을 개선하는 데 도움을 받을 수 있습니다.","source":"@site/docs/dotnet/analysis-hitmap.mdx","sourceDirName":"dotnet","slug":"/dotnet/analysis-hitmap","permalink":"/dotnet/analysis-hitmap","draft":false,"unlisted":false,"editUrl":"undefined/docs/dotnet/analysis-hitmap.mdx","tags":[],"version":"current","frontMatter":{"id":"analysis-hitmap","title":"히트맵","description":"애플리케이션에서 세부적인 트랜잭션 프로파일링을 구성하는 방법을 안내합니다. 트랜잭션 프로파일링을 통해 사용자는 애플리케이션 내부의 각각의 트랜잭션에 대한 성능 데이터를 수집하고 분석할 수 있으며, 이를 통해 애플리케이션의 성능을 개선하는 데 도움을 받을 수 있습니다.","keywords":["애플리케이션",".NET","분석","히트맵","트랜잭션"],"isTranslationMissing":false},"sidebar":"dotNetSidebar","previous":{"title":"큐브","permalink":"/dotnet/cube"},"next":{"title":"멀티 트랜잭션 추적","permalink":"/dotnet/analysis-trace-mtx"}}')
...
;// CONCATENATED MODULE: ./docs/dotnet/analysis-hitmap.mdx
