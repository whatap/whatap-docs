"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["49694"], {
...
"94987": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_oracle_v_1_analysis_pq_tree_mdx_161_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-oracle-v-1-analysis-pq-tree-mdx-161.json
var site_docs_oracle_v_1_analysis_pq_tree_mdx_161_namespaceObject = JSON.parse('{"id":"oracle-v1/analysis-pq-tree","title":"병렬 쿼리 트리","description":"하루 동안 Parallel Query가 발생한 추이를 분석할 수 있는 기능을 제공합니다.","source":"@site/docs/oracle-v1/analysis-pq-tree.mdx","sourceDirName":"oracle-v1","slug":"/oracle-v1/analysis-pq-tree","permalink":"/oracle-v1/analysis-pq-tree","draft":false,"unlisted":false,"editUrl":"undefined/docs/oracle-v1/analysis-pq-tree.mdx","tags":[],"version":"current","frontMatter":{"id":"analysis-pq-tree","title":"병렬 쿼리 트리","description":"하루 동안 Parallel Query가 발생한 추이를 분석할 수 있는 기능을 제공합니다.","keywords":["Oracle","데이터베이스","병렬 쿼리 트리"],"isTranslationMissing":false},"sidebar":"dboracleSidebar","previous":{"title":"락 트리","permalink":"/oracle-v1/analysis-lock-and-deadlock"},"next":{"title":"데이터베이스 파라미터","permalink":"/oracle-v1/analysis-databaseparameter"}}')
...
;// CONCATENATED MODULE: ./docs/oracle-v1/analysis-pq-tree.mdx
...
const toc = [..._db_pq_tree/* toc */.d$, ..._db_oracle_column/* toc */.d$];
function _createMdxContent(props) {
