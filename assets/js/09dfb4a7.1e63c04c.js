"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["1660"], {
...
"77070": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_dotnet_flexboard_mode_mdx_09d_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-dotnet-flexboard-mode-mdx-09d.json
var site_docs_dotnet_flexboard_mode_mdx_09d_namespaceObject = JSON.parse('{"id":"dotnet/flexboard-mode","title":"Flex 보드 화면 모드","description":"Flex 보드의 화면 모드에 따라 제공하는 기능에 대해 알아보세요.","source":"@site/docs/dotnet/flexboard-mode.mdx","sourceDirName":"dotnet","slug":"/dotnet/flexboard-mode","permalink":"/dotnet/flexboard-mode","draft":false,"unlisted":false,"editUrl":"undefined/docs/dotnet/flexboard-mode.mdx","tags":[],"version":"current","frontMatter":{"id":"flexboard-mode","title":"Flex 보드 화면 모드","description":"Flex 보드의 화면 모드에 따라 제공하는 기능에 대해 알아보세요.","keywords":[".NET","애플리케이션","애플리케이션 모니터링","Flex 보드"],"isTranslationMissing":false},"sidebar":"dotNetSidebar","previous":{"title":"위젯 템플릿","permalink":"/dotnet/flexboard-widget-template"},"next":{"title":"Flex 보드 공유하기","permalink":"/dotnet/flexboard-share"}}')
...
;// CONCATENATED MODULE: ./docs/dotnet/flexboard-mode.mdx
