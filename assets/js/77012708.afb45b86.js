"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["78969"], {
...
"53178": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_cubrid_set_notification_message_mdx_770_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-cubrid-set-notification-message-mdx-770.json
var site_docs_cubrid_set_notification_message_mdx_770_namespaceObject = JSON.parse('{"id":"cubrid/set-notification-message","title":"알림 메시지 사용자 정의","description":"프로젝트 멤버에게 전달되는 경고 알림 메시지를 수정할 수 있는 사용자 정의 기능을 제공합니다.","source":"@site/docs/cubrid/set-notification-message.mdx","sourceDirName":"cubrid","slug":"/cubrid/set-notification-message","permalink":"/cubrid/set-notification-message","draft":false,"unlisted":false,"editUrl":"undefined/docs/cubrid/set-notification-message.mdx","tags":[],"version":"current","frontMatter":{"id":"set-notification-message","title":"알림 메시지 사용자 정의","description":"프로젝트 멤버에게 전달되는 경고 알림 메시지를 수정할 수 있는 사용자 정의 기능을 제공합니다.","keywords":["CUBRID","데이터베이스","경고 알림","메트릭스 이벤트","알림 메시지"],"isTranslationMissing":false},"sidebar":"cubridSidebar","previous":{"title":"메트릭스 경고 알림","permalink":"/cubrid/metric-warning-notice"},"next":{"title":"이상치 탐지 경고 알림","permalink":"/cubrid/set-event-detect-anomal"}}')
...
;// CONCATENATED MODULE: ./docs/cubrid/set-notification-message.mdx
