"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["38479"], {
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_golang_report_apm_mdx_620_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-golang-report-apm-mdx-620.json
var site_docs_golang_report_apm_mdx_620_namespaceObject = JSON.parse('{"id":"golang/report-apm","title":"애플리케이션 보고서","description":"애플리케이션의 주요 성능에 대한 보고서를 제공합니다.","source":"@site/docs/golang/report-apm.mdx","sourceDirName":"golang","slug":"/golang/report-apm","permalink":"/golang/report-apm","draft":false,"unlisted":false,"editUrl":"undefined/docs/golang/report-apm.mdx","tags":[],"version":"current","frontMatter":{"id":"report-apm","title":"애플리케이션 보고서","description":"애플리케이션의 주요 성능에 대한 보고서를 제공합니다.","toc_max_heading_level":3,"keywords":["Go","애플리케이션","보고서"],"isTranslationMissing":false},"sidebar":"goSidebar","previous":{"title":"보고서","permalink":"/golang/report-intro"},"next":{"title":"통합 보고서","permalink":"/golang/integrated-report"}}')
...
;// CONCATENATED MODULE: ./docs/golang/report-apm.mdx
