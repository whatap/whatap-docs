"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["11338"], {
...
"12646": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_mssql_agent_xos_settings_mdx_912_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-mssql-agent-xos-settings-mdx-912.json
var site_docs_mssql_agent_xos_settings_mdx_912_namespaceObject = JSON.parse('{"id":"mssql/agent-xos-settings","title":"XOS 에이전트 설정","description":"데이터베이스 프로세스 모니터링 설정에 대해 알아봅니다.","source":"@site/docs/mssql/agent-xos-settings.mdx","sourceDirName":"mssql","slug":"/mssql/agent-xos-settings","permalink":"/mssql/agent-xos-settings","draft":false,"unlisted":false,"editUrl":"undefined/docs/mssql/agent-xos-settings.mdx","tags":[],"version":"current","frontMatter":{"id":"agent-xos-settings","title":"XOS 에이전트 설정","description":"데이터베이스 프로세스 모니터링 설정에 대해 알아봅니다.","keywords":["SQL Server","데이터베이스","에이전트","XOS"],"isTranslationMissing":false},"sidebar":"mssqlSidebar","previous":{"title":"DBX 에이전트 설정","permalink":"/mssql/agent-dbx-settings"},"next":{"title":"클라우드 설정","permalink":"/mssql/cloudsettings"}}')
...
;// CONCATENATED MODULE: ./docs/mssql/agent-xos-settings.mdx
