"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["77093"], {
...
"81647": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_cubrid_dashboard_intro_mdx_d23_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-cubrid-dashboard-intro-mdx-d23.json
var site_docs_cubrid_dashboard_intro_mdx_d23_namespaceObject = JSON.parse('{"id":"cubrid/dashboard-intro","title":"대시보드","description":"와탭 모니터링 대시보드는 프로젝트의 전체 현황을 한 눈에 파악하기 위한 기능을 제공합니다.","source":"@site/docs/cubrid/dashboard-intro.mdx","sourceDirName":"cubrid","slug":"/cubrid/dashboard-intro","permalink":"/cubrid/dashboard-intro","draft":false,"unlisted":false,"editUrl":"undefined/docs/cubrid/dashboard-intro.mdx","tags":[],"version":"current","frontMatter":{"id":"dashboard-intro","title":"대시보드","description":"와탭 모니터링 대시보드는 프로젝트의 전체 현황을 한 눈에 파악하기 위한 기능을 제공합니다.","keywords":["CUBRID","대시보드","인스턴스","데이터베이스 모니터링"],"isTranslationMissing":false},"sidebar":"cubridSidebar","previous":{"title":"관리하기","permalink":"/cubrid/agent-manage"},"next":{"title":"인스턴스 목록","permalink":"/cubrid/instance-list"}}')
...
;// CONCATENATED MODULE: ./docs/cubrid/dashboard-intro.mdx
