"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["2418"], {
"25626": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_altibase_log_exp_mdx_776_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-altibase-log-exp-mdx-776.json
var site_docs_altibase_log_exp_mdx_776_namespaceObject = JSON.parse('{"id":"altibase/log-exp","title":"로그 트렌드","description":"로그 모니터링의 로그 트렌드 메뉴를 안내합니다.","source":"@site/docs/altibase/log-exp.mdx","sourceDirName":"altibase","slug":"/altibase/log-exp","permalink":"/altibase/log-exp","draft":false,"unlisted":false,"editUrl":"undefined/docs/altibase/log-exp.mdx","tags":[],"version":"current","frontMatter":{"id":"log-exp","title":"로그 트렌드","description":"로그 모니터링의 로그 트렌드 메뉴를 안내합니다.","keywords":["로그 모니터링","로그 트렌드","UI","Altibase"],"isTranslationMissing":false},"sidebar":"altibaseSidebar","previous":{"title":"라이브 테일","permalink":"/altibase/log-lt"},"next":{"title":"로그 검색","permalink":"/altibase/log-search"}}')
...
;// CONCATENATED MODULE: ./docs/altibase/log-exp.mdx
