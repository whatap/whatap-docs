"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["54499"], {
"73751": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_manage_mdx_42f_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-manage-mdx-42f.json
var site_docs_manage_mdx_42f_namespaceObject = JSON.parse('{"id":"manage","title":"관리 기능","description":"와탭 모니터링 서비스의 계정, 프로젝트, 그룹 등을 관리하는 방법에 대해 알아봅니다.","source":"@site/docs/manage.mdx","sourceDirName":".","slug":"/manage","permalink":"/manage","draft":false,"unlisted":false,"editUrl":"undefined/docs/manage.mdx","tags":[],"version":"current","frontMatter":{"id":"manage","title":"관리 기능","description":"와탭 모니터링 서비스의 계정, 프로젝트, 그룹 등을 관리하는 방법에 대해 알아봅니다.","displayed_sidebar":"manageSidebar","keywords":["관리","프로젝트","계정","그룹"],"isTranslationMissing":false},"sidebar":"manageSidebar","next":{"title":"계정 관리","permalink":"/account/account-manage"}}')
...
;// CONCATENATED MODULE: ./docs/manage.mdx
