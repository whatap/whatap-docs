"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["12464"], {
...
"98697": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_cubrid_v_1_flexboard_mode_mdx_bee_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-cubrid-v-1-flexboard-mode-mdx-bee.json
var site_docs_cubrid_v_1_flexboard_mode_mdx_bee_namespaceObject = JSON.parse('{"id":"cubrid-v1/flexboard-mode","title":"Flex 보드 화면 모드","description":"Flex 보드의 화면 모드에 따라 제공하는 기능에 대해 알아보세요.","source":"@site/docs/cubrid-v1/flexboard-mode.mdx","sourceDirName":"cubrid-v1","slug":"/cubrid-v1/flexboard-mode","permalink":"/cubrid-v1/flexboard-mode","draft":false,"unlisted":false,"editUrl":"undefined/docs/cubrid-v1/flexboard-mode.mdx","tags":[],"version":"current","frontMatter":{"id":"flexboard-mode","title":"Flex 보드 화면 모드","description":"Flex 보드의 화면 모드에 따라 제공하는 기능에 대해 알아보세요.","keywords":["CUBRID","DB","데이터베이스","데이터베이스 모니터링","Flex 보드"],"isTranslationMissing":false},"sidebar":"cubridV1Sidebar","previous":{"title":"위젯 템플릿","permalink":"/cubrid-v1/flexboard-widget-template"},"next":{"title":"Flex 보드 공유하기","permalink":"/cubrid-v1/flexboard-share"}}')
...
;// CONCATENATED MODULE: ./docs/cubrid-v1/flexboard-mode.mdx
