"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["63741"], {
...
"50903": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_cubrid_v_1_agent_xos_settings_mdx_2d7_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-cubrid-v-1-agent-xos-settings-mdx-2d7.json
var site_docs_cubrid_v_1_agent_xos_settings_mdx_2d7_namespaceObject = JSON.parse('{"id":"cubrid-v1/agent-xos-settings","title":"XOS 에이전트 설정","description":"데이터베이스 서버의 자원을 추가로 모니터링하기 위한 설정 방법을 제공합니다.","source":"@site/docs/cubrid-v1/agent-xos-settings.mdx","sourceDirName":"cubrid-v1","slug":"/cubrid-v1/agent-xos-settings","permalink":"/cubrid-v1/agent-xos-settings","draft":false,"unlisted":false,"editUrl":"undefined/docs/cubrid-v1/agent-xos-settings.mdx","tags":[],"version":"current","frontMatter":{"id":"agent-xos-settings","title":"XOS 에이전트 설정","description":"데이터베이스 서버의 자원을 추가로 모니터링하기 위한 설정 방법을 제공합니다.","keywords":["CUBRID","데이터베이스 모니터링","XOS 에이전트"],"isTranslationMissing":false},"sidebar":"cubridV1Sidebar","previous":{"title":"DBX 에이전트 설정","permalink":"/cubrid-v1/agent-dbx-settings"},"next":{"title":"XCUB 에이전트 설정","permalink":"/cubrid-v1/agent-xcub-settings"}}')
...
;// CONCATENATED MODULE: ./docs/cubrid-v1/agent-xos-settings.mdx
