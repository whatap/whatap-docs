"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["81164"], {
...
"11502": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_postgresql_monitoring_support_mdx_596_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-postgresql-monitoring-support-mdx-596.json
var site_docs_postgresql_monitoring_support_mdx_596_namespaceObject = JSON.parse('{"id":"postgresql/monitoring-support","title":"지원 환경","description":"데이터베이스 모니터링을 시작하기 전에 지원하는 데이터베이스 종류에 대해서 알아보세요.","source":"@site/docs/postgresql/monitoring-support.mdx","sourceDirName":"postgresql","slug":"/postgresql/monitoring-support","permalink":"/postgresql/monitoring-support","draft":false,"unlisted":false,"editUrl":"undefined/docs/postgresql/monitoring-support.mdx","tags":[],"version":"current","frontMatter":{"id":"monitoring-support","title":"지원 환경","description":"데이터베이스 모니터링을 시작하기 전에 지원하는 데이터베이스 종류에 대해서 알아보세요.","keywords":["데이터베이스","데이터베이스 모니터링","PostgreSQL"],"isTranslationMissing":false},"sidebar":"postgreSidebar","previous":{"title":"PostgreSQL 모니터링","permalink":"/postgresql/monitoring-intro"},"next":{"title":"에이전트 설치","permalink":"/postgresql/install-agent"}}')
...
;// CONCATENATED MODULE: ./docs/postgresql/monitoring-support.mdx
