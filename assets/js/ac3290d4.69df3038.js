"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["66859"], {
...
"56760": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_python_integrated_report_mdx_ac3_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-python-integrated-report-mdx-ac3.json
var site_docs_python_integrated_report_mdx_ac3_namespaceObject = JSON.parse('{"id":"python/integrated-report","title":"통합 보고서","description":"통합 보고서를 안내합니다.","source":"@site/docs/python/integrated-report.mdx","sourceDirName":"python","slug":"/python/integrated-report","permalink":"/python/integrated-report","draft":false,"unlisted":false,"editUrl":"undefined/docs/python/integrated-report.mdx","tags":[],"version":"current","frontMatter":{"id":"integrated-report","title":"통합 보고서","description":"통합 보고서를 안내합니다.","keywords":["Python","통합 보고서","분석하기","UI"],"isTranslationMissing":false},"sidebar":"pySidebar","previous":{"title":"애플리케이션 보고서","permalink":"/python/report-apm"},"next":{"title":"경고 알림","permalink":"/python/apm-set-notice"}}')
...
;// CONCATENATED MODULE: ./docs/python/integrated-report.mdx
