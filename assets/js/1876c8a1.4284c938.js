"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["80498"], {
...
"31582": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_kubernetes_metric_warning_notice_mdx_187_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-kubernetes-metric-warning-notice-mdx-187.json
var site_docs_kubernetes_metric_warning_notice_mdx_187_namespaceObject = JSON.parse('{"id":"kubernetes/metric-warning-notice","title":"메트릭스 경고 알림","description":"구체적이고 복잡한 이벤트를 설정하려면 메트릭스 이벤트 설정을 사용하세요.","source":"@site/docs/kubernetes/metric-warning-notice.mdx","sourceDirName":"kubernetes","slug":"/kubernetes/metric-warning-notice","permalink":"/kubernetes/metric-warning-notice","draft":false,"unlisted":false,"editUrl":"undefined/docs/kubernetes/metric-warning-notice.mdx","tags":[],"version":"current","frontMatter":{"id":"metric-warning-notice","title":"메트릭스 경고 알림","description":"구체적이고 복잡한 이벤트를 설정하려면 메트릭스 이벤트 설정을 사용하세요.","keywords":["경고 알림","메트릭스 이벤트","쿠버네티스 모니터링"],"isTranslationMissing":false},"sidebar":"kubeSidebar","previous":{"title":"이벤트 설정","permalink":"/kubernetes/warning-notice-v2"},"next":{"title":"알림 메시지 사용자 정의","permalink":"/kubernetes/set-notification-message"}}')
...
;// CONCATENATED MODULE: ./docs/kubernetes/metric-warning-notice.mdx
...
const toc = [..._metrics_warning_notice/* toc */.d$, ..._composite_metrics_warning_notice/* toc */.d$, ..._metrics_event_modify_delete/* toc */.d$, ..._metrics_event_condition_select_target_guide/* toc */.d$, ..._metrics_warning_notice_k8s/* toc */.d$];
function _createMdxContent(props) {
