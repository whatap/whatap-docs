"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["41258"], {
"37577": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_dotnet_agent_performance_mdx_188_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-dotnet-agent-performance-mdx-188.json
var site_docs_dotnet_agent_performance_mdx_188_namespaceObject = JSON.parse('{"id":"dotnet/agent-performance","title":"에이전트 성능","description":"에이전트 성능에 관한 옵션입니다.","source":"@site/docs/dotnet/agent-performance.mdx","sourceDirName":"dotnet","slug":"/dotnet/agent-performance","permalink":"/dotnet/agent-performance","draft":false,"unlisted":false,"editUrl":"undefined/docs/dotnet/agent-performance.mdx","tags":[],"version":"current","frontMatter":{"id":"agent-performance","title":"에이전트 성능","description":"에이전트 성능에 관한 옵션입니다.","keywords":[".NET","에이전트 성능"],"isTranslationMissing":false},"sidebar":"dotNetSidebar","previous":{"title":"에이전트 통신 설정","permalink":"/dotnet/agent-network"},"next":{"title":"에이전트 로그","permalink":"/dotnet/agent-log"}}')
