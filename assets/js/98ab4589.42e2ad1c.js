"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["12755"], {
...
"18840": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_java_active_transactions_mdx_98a_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-java-active-transactions-mdx-98a.json
var site_docs_java_active_transactions_mdx_98a_namespaceObject = JSON.parse('{"id":"java/active-transactions","title":"액티브 트랜잭션","description":"액티브 트랜잭션을 안내합니다.","source":"@site/docs/java/active-transactions.mdx","sourceDirName":"java","slug":"/java/active-transactions","permalink":"/java/active-transactions","draft":false,"unlisted":false,"editUrl":"undefined/docs/java/active-transactions.mdx","tags":[],"version":"current","frontMatter":{"id":"active-transactions","title":"액티브 트랜잭션","description":"액티브 트랜잭션을 안내합니다.","keywords":["Java","트랜잭션","액티브 트랜잭션","UI","애플리케이션","애플리케이션 모니터링"],"isTranslationMissing":false},"sidebar":"javaSidebar","previous":{"title":"트랜잭션 트레이싱","permalink":"/java/trs-profile"},"next":{"title":"멀티 트랜잭션","permalink":"/java/trs-multi-trace"}}')
...
const _active_transaction_frontMatter = (/* unused pure expression or super */ null && ({}));
...
const _active_transaction_toc = [...toc, ..._background_thread/* toc */.d$, {
  "value": "참고 자료",
  "id": "참고-자료",
  "level": 2
}];
