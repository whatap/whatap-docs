"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["44102"], {
...
"60846": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_redis_log_main_mdx_991_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-redis-log-main-mdx-991.json
var site_docs_redis_log_main_mdx_991_namespaceObject = JSON.parse('{"id":"redis/log-main","title":"로그","description":"로그 모니터링의 주요 메뉴를 안내합니다.","source":"@site/docs/redis/log-main.mdx","sourceDirName":"redis","slug":"/redis/log-main","permalink":"/redis/log-main","draft":false,"unlisted":false,"editUrl":"undefined/docs/redis/log-main.mdx","tags":[],"version":"current","frontMatter":{"id":"log-main","title":"로그","description":"로그 모니터링의 주요 메뉴를 안내합니다.","keywords":["Redis","로그 모니터링","UI"],"isTranslationMissing":false},"sidebar":"redisSidebar","previous":{"title":"메트릭스 이상 탐지","permalink":"/redis/metrics-detect-anormal"},"next":{"title":"적용하기","permalink":"/redis/log-db"}}')
...
;// CONCATENATED MODULE: ./docs/redis/log-main.mdx
