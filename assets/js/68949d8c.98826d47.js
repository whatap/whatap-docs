"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["63573"], {
...
"52289": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_golang_flexboard_mode_mdx_689_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-golang-flexboard-mode-mdx-689.json
var site_docs_golang_flexboard_mode_mdx_689_namespaceObject = JSON.parse('{"id":"golang/flexboard-mode","title":"Flex 보드 화면 모드","description":"Flex 보드의 화면 모드에 따라 제공하는 기능에 대해 알아보세요.","source":"@site/docs/golang/flexboard-mode.mdx","sourceDirName":"golang","slug":"/golang/flexboard-mode","permalink":"/golang/flexboard-mode","draft":false,"unlisted":false,"editUrl":"undefined/docs/golang/flexboard-mode.mdx","tags":[],"version":"current","frontMatter":{"id":"flexboard-mode","title":"Flex 보드 화면 모드","description":"Flex 보드의 화면 모드에 따라 제공하는 기능에 대해 알아보세요.","keywords":["Go","애플리케이션","애플리케이션 모니터링","Flex 보드"],"isTranslationMissing":false},"sidebar":"goSidebar","previous":{"title":"위젯 템플릿","permalink":"/golang/flexboard-widget-template"},"next":{"title":"Flex 보드 공유하기","permalink":"/golang/flexboard-share"}}')
...
;// CONCATENATED MODULE: ./docs/golang/flexboard-mode.mdx
