"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["16349"], {
...
"11822": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_golang_integrated_report_mdx_5db_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-golang-integrated-report-mdx-5db.json
var site_docs_golang_integrated_report_mdx_5db_namespaceObject = JSON.parse('{"id":"golang/integrated-report","title":"통합 보고서","description":"통합 보고서를 안내합니다.","source":"@site/docs/golang/integrated-report.mdx","sourceDirName":"golang","slug":"/golang/integrated-report","permalink":"/golang/integrated-report","draft":false,"unlisted":false,"editUrl":"undefined/docs/golang/integrated-report.mdx","tags":[],"version":"current","frontMatter":{"id":"integrated-report","title":"통합 보고서","description":"통합 보고서를 안내합니다.","keywords":["Go","통합 보고서","분석하기","UI"],"isTranslationMissing":false},"sidebar":"goSidebar","previous":{"title":"애플리케이션 보고서","permalink":"/golang/report-apm"},"next":{"title":"경고 알림","permalink":"/golang/apm-set-notice"}}')
...
;// CONCATENATED MODULE: ./docs/golang/integrated-report.mdx
