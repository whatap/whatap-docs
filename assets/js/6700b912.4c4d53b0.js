"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["47461"], {
...
"99369": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_python_metric_warning_notice_mdx_670_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-python-metric-warning-notice-mdx-670.json
var site_docs_python_metric_warning_notice_mdx_670_namespaceObject = JSON.parse('{"id":"python/metric-warning-notice","title":"메트릭스 경고 알림","description":"구체적이고 복잡한 이벤트를 설정하려면 메트릭스 이벤트 설정을 사용하세요.","source":"@site/docs/python/metric-warning-notice.mdx","sourceDirName":"python","slug":"/python/metric-warning-notice","permalink":"/python/metric-warning-notice","draft":false,"unlisted":false,"editUrl":"undefined/docs/python/metric-warning-notice.mdx","tags":[],"version":"current","frontMatter":{"id":"metric-warning-notice","title":"메트릭스 경고 알림","description":"구체적이고 복잡한 이벤트를 설정하려면 메트릭스 이벤트 설정을 사용하세요.","keywords":["Python","경고 알림","메트릭스 이벤트","애플리케이션 모니터링"],"isTranslationMissing":false},"sidebar":"pySidebar","previous":{"title":"이벤트 설정","permalink":"/python/warning-notice-v2"},"next":{"title":"알림 메시지 사용자 정의","permalink":"/python/set-notification-message"}}')
...
;// CONCATENATED MODULE: ./docs/python/metric-warning-notice.mdx
