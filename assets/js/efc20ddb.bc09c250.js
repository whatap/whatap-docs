"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["69146"], {
"66795": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_altibase_monitoring_intro_mdx_efc_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-altibase-monitoring-intro-mdx-efc.json
var site_docs_altibase_monitoring_intro_mdx_efc_namespaceObject = JSON.parse('{"id":"altibase/monitoring-intro","title":"Altibase V2 모니터링","description":"와탭 데이터베이스 모니터링 서비스(DBX)은 Query 기반으로 데이터를 수집하여 성능 모니터링 서비스를 제공합니다.","source":"@site/docs/altibase/monitoring-intro.mdx","sourceDirName":"altibase","slug":"/altibase/monitoring-intro","permalink":"/altibase/monitoring-intro","draft":false,"unlisted":false,"editUrl":"undefined/docs/altibase/monitoring-intro.mdx","tags":[],"version":"current","frontMatter":{"id":"monitoring-intro","title":"Altibase V2 모니터링","description":"와탭 데이터베이스 모니터링 서비스(DBX)은 Query 기반으로 데이터를 수집하여 성능 모니터링 서비스를 제공합니다.","displayed_sidebar":"altibaseSidebar","hide_table_of_contents":false,"keywords":["Altibase","데이터베이스 모니터링","데이터베이스","모니터링","DBX"],"isTranslationMissing":false},"sidebar":"altibaseSidebar","next":{"title":"지원 환경","permalink":"/altibase/monitoring-support"}}')
...
;// CONCATENATED MODULE: ./docs/altibase/monitoring-intro.mdx
