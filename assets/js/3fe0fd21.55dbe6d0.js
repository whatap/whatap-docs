"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["96030"], {
"67907": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_altibase_v_1_instance_list_mdx_3fe_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-altibase-v-1-instance-list-mdx-3fe.json
var site_docs_altibase_v_1_instance_list_mdx_3fe_namespaceObject = JSON.parse('{"id":"altibase-v1/instance-list","title":"인스턴스 목록","description":"에이전트를 설치한 데이터베이스 서버들의 목록을 확인할 수 있습니다.","source":"@site/docs/altibase-v1/instance-list.mdx","sourceDirName":"altibase-v1","slug":"/altibase-v1/instance-list","permalink":"/altibase-v1/instance-list","draft":false,"unlisted":false,"editUrl":"undefined/docs/altibase-v1/instance-list.mdx","tags":[],"version":"current","frontMatter":{"id":"instance-list","title":"인스턴스 목록","description":"에이전트를 설치한 데이터베이스 서버들의 목록을 확인할 수 있습니다.","keywords":["Altibase","인스턴스","대시보드","데이터베이스 모니터링"],"isTranslationMissing":false},"sidebar":"altibasev1Sidebar","previous":{"title":"실시간 데이터베이스 성능 지표 확인","permalink":"/altibase-v1/dashboard-intro"},"next":{"title":"인스턴스 모니터링","permalink":"/altibase-v1/instance-monitoring"}}')
...
const instance_list_toc = [...toc, ..._db_instance_list_set_name_guide/* toc */.d$];
