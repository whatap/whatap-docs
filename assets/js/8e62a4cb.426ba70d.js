"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["2172"], {
...
"22041": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_mssql_v_1_metrics_detect_anormal_mdx_8e6_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-mssql-v-1-metrics-detect-anormal-mdx-8e6.json
var site_docs_mssql_v_1_metrics_detect_anormal_mdx_8e6_namespaceObject = JSON.parse('{"id":"mssql-v1/metrics-detect-anormal","title":"메트릭스 이상 탐지","description":"다양한 메트릭스 지표의 패턴을 AI가 학습한 예상 패턴과 비교해 볼 수 있습니다.","source":"@site/docs/mssql-v1/metrics-detect-anormal.mdx","sourceDirName":"mssql-v1","slug":"/mssql-v1/metrics-detect-anormal","permalink":"/mssql-v1/metrics-detect-anormal","draft":false,"unlisted":false,"editUrl":"undefined/docs/mssql-v1/metrics-detect-anormal.mdx","tags":[],"version":"current","frontMatter":{"id":"metrics-detect-anormal","title":"메트릭스 이상 탐지","description":"다양한 메트릭스 지표의 패턴을 AI가 학습한 예상 패턴과 비교해 볼 수 있습니다.","keywords":["SQL Server","메트릭스","이상 탐지"],"isTranslationMissing":false},"sidebar":"mssqlV1Sidebar","previous":{"title":"메트릭스 조회","permalink":"/mssql-v1/metrics-search"},"next":{"title":"SQL 통계","permalink":"/mssql-v1/stat"}}')
...
;// CONCATENATED MODULE: ./docs/mssql-v1/metrics-detect-anormal.mdx
