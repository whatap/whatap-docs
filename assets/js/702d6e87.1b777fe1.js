"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["67215"], {
...
"7394": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_oracle_pro_log_db_mdx_702_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-oracle-pro-log-db-mdx-702.json
var site_docs_oracle_pro_log_db_mdx_702_namespaceObject = JSON.parse('{"id":"oracle-pro/log-db","title":"적용하기","description":"데이터베이스와 AWS RDS의 로그를 수집하는 방법을 안내합니다.","source":"@site/docs/oracle-pro/log-db.mdx","sourceDirName":"oracle-pro","slug":"/oracle-pro/log-db","permalink":"/oracle-pro/log-db","draft":false,"unlisted":false,"editUrl":"undefined/docs/oracle-pro/log-db.mdx","tags":[],"version":"current","frontMatter":{"id":"log-db","title":"적용하기","description":"데이터베이스와 AWS RDS의 로그를 수집하는 방법을 안내합니다.","keywords":["로그 모니터링","데이터베이스","Oracle Pro"],"isTranslationMissing":false},"sidebar":"dboracledmaSidebar","previous":{"title":"로그","permalink":"/oracle-pro/log-main"},"next":{"title":"라이브 테일","permalink":"/oracle-pro/log-lt"}}')
...
;// CONCATENATED MODULE: ./docs/oracle-pro/log-db.mdx
