"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["7396"], {
...
"23110": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_npm_labs_mdx_deb_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-npm-labs-mdx-deb.json
var site_docs_npm_labs_mdx_deb_namespaceObject = JSON.parse('{"id":"npm/labs","title":"실험실","description":"사용자에게 새로운 기능 또는 실험적인 기능을 제공하는 메뉴인 실험실에 대해 안내합니다.","source":"@site/docs/npm/labs.mdx","sourceDirName":"npm","slug":"/npm/labs","permalink":"/npm/labs","draft":false,"unlisted":false,"editUrl":"undefined/docs/npm/labs.mdx","tags":[],"version":"current","frontMatter":{"id":"labs","title":"실험실","description":"사용자에게 새로운 기능 또는 실험적인 기능을 제공하는 메뉴인 실험실에 대해 안내합니다.","keywords":["네트워크 성능 모니터링","실험실"],"isTranslationMissing":false},"sidebar":"npmsidebar","previous":{"title":"시스템 이벤트 안내","permalink":"/npm/common-alert"}}')
...
;// CONCATENATED MODULE: ./docs/npm/labs.mdx
