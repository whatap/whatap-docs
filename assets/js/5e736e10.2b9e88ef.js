"use strict";
(self["webpackChunkwhatap_origin"] = self["webpackChunkwhatap_origin"] || []).push([[58859],{
...
const metadata = {
    "unversionedId": "java/metrics-chart",
    "id": "java/metrics-chart",
    "title": "메트릭스 차트",
    "description": "메트릭스 데이터를 차트로 조회할 수 있습니다.",
    "source": "@site/docs/java/metrics-chart.mdx",
    "sourceDirName": "java",
    "slug": "/java/metrics-chart",
    "permalink": "/whatap-docs/java/metrics-chart",
    "draft": false,
    "editUrl": "undefined/docs/java/metrics-chart.mdx",
    "tags": [
        {
            "label": "메트릭스",
