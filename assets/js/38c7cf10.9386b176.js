"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["20428"], {
"49285": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_browser_set_receive_event_mdx_38c_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-browser-set-receive-event-mdx-38c.json
var site_docs_browser_set_receive_event_mdx_38c_namespaceObject = JSON.parse('{"id":"browser/set-receive-event","title":"이벤트 수신 설정","description":"프로젝트에 포함하는 멤버들의 경고 알림 수신과 관련한 다양한 기능을 설정할 수 있습니다.","source":"@site/docs/browser/set-receive-event.mdx","sourceDirName":"browser","slug":"/browser/set-receive-event","permalink":"/browser/set-receive-event","draft":false,"unlisted":false,"editUrl":"undefined/docs/browser/set-receive-event.mdx","tags":[],"version":"current","frontMatter":{"id":"set-receive-event","title":"이벤트 수신 설정","description":"프로젝트에 포함하는 멤버들의 경고 알림 수신과 관련한 다양한 기능을 설정할 수 있습니다.","keywords":["경고 알림","이벤트 수신 태그","브라우저 모니터링"],"isTranslationMissing":false},"sidebar":"rumsSidebar","previous":{"title":"AJAX 히트맵 패턴","permalink":"/browser/hitmap-notice"},"next":{"title":"이벤트 기록","permalink":"/browser/set-event-history"}}')
...
;// CONCATENATED MODULE: ./docs/browser/set-receive-event.mdx
