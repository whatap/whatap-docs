"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["17197"], {
...
"4729": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_mongodb_set_event_detect_anomal_mdx_47f_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-mongodb-set-event-detect-anomal-mdx-47f.json
var site_docs_mongodb_set_event_detect_anomal_mdx_47f_namespaceObject = JSON.parse('{"id":"mongodb/set-event-detect-anomal","title":"이상치 탐지 경고 알림","description":"예상치 못한 패턴을 찾는 일련의 활동을 탐지해 경고 알림을 보내도록 설정할 수 있습니다.","source":"@site/docs/mongodb/set-event-detect-anomal.mdx","sourceDirName":"mongodb","slug":"/mongodb/set-event-detect-anomal","permalink":"/mongodb/set-event-detect-anomal","draft":false,"unlisted":false,"editUrl":"undefined/docs/mongodb/set-event-detect-anomal.mdx","tags":[],"version":"current","frontMatter":{"id":"set-event-detect-anomal","title":"이상치 탐지 경고 알림","description":"예상치 못한 패턴을 찾는 일련의 활동을 탐지해 경고 알림을 보내도록 설정할 수 있습니다.","keywords":["MongoDB","경고 알림","이상치 탐지","데이터베이스 모니터링"],"isTranslationMissing":false},"sidebar":"mongodbSidebar","previous":{"title":"알림 메시지 사용자 정의","permalink":"/mongodb/set-notification-message"},"next":{"title":"이벤트 수신 설정","permalink":"/mongodb/set-receive-event"}}')
...
;// CONCATENATED MODULE: ./docs/mongodb/set-event-detect-anomal.mdx
