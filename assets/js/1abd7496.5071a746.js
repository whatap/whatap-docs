"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["32823"], {
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_mssql_v_1_flexboard_widget_template_mdx_1ab_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-mssql-v-1-flexboard-widget-template-mdx-1ab.json
var site_docs_mssql_v_1_flexboard_widget_template_mdx_1ab_namespaceObject = JSON.parse('{"id":"mssql-v1/flexboard-widget-template","title":"위젯 템플릿","description":"Flex 보드에서 대시보드에 배치할 수 있는 위젯의 종류를 안내합니다.","source":"@site/docs/mssql-v1/flexboard-widget-template.mdx","sourceDirName":"mssql-v1","slug":"/mssql-v1/flexboard-widget-template","permalink":"/mssql-v1/flexboard-widget-template","draft":false,"unlisted":false,"editUrl":"undefined/docs/mssql-v1/flexboard-widget-template.mdx","tags":[],"version":"current","frontMatter":{"id":"flexboard-widget-template","title":"위젯 템플릿","description":"Flex 보드에서 대시보드에 배치할 수 있는 위젯의 종류를 안내합니다.","keywords":["Flex 보드","위젯","템플릿"],"isTranslationMissing":false},"sidebar":"mssqlV1Sidebar","previous":{"title":"위젯 관리하기","permalink":"/mssql-v1/flexboard-widget-manage"},"next":{"title":"Flex 보드 화면 모드","permalink":"/mssql-v1/flexboard-mode"}}')
...
;// CONCATENATED MODULE: ./docs/mssql-v1/flexboard-widget-template.mdx
