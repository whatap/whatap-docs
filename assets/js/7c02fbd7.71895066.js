"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["90902"], {
...
"96217": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_kubernetes_labs_mdx_7c0_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-kubernetes-labs-mdx-7c0.json
var site_docs_kubernetes_labs_mdx_7c0_namespaceObject = JSON.parse('{"id":"kubernetes/labs","title":"실험실","description":"사용자에게 새로운 기능 또는 실험적인 기능을 제공하는 메뉴인 실험실에 대해 안내합니다.","source":"@site/docs/kubernetes/labs.mdx","sourceDirName":"kubernetes","slug":"/kubernetes/labs","permalink":"/kubernetes/labs","draft":false,"unlisted":false,"editUrl":"undefined/docs/kubernetes/labs.mdx","tags":[],"version":"current","frontMatter":{"id":"labs","title":"실험실","description":"사용자에게 새로운 기능 또는 실험적인 기능을 제공하는 메뉴인 실험실에 대해 안내합니다.","keywords":["쿠버네티스","실험실"],"isTranslationMissing":false},"sidebar":"kubeSidebar","previous":{"title":"시스템 이벤트 안내","permalink":"/kubernetes/common-alert"}}')
...
;// CONCATENATED MODULE: ./docs/kubernetes/labs.mdx
