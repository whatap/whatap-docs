"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["89564"], {
...
"45907": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_golang_flexboard_widget_template_mdx_23a_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-golang-flexboard-widget-template-mdx-23a.json
var site_docs_golang_flexboard_widget_template_mdx_23a_namespaceObject = JSON.parse('{"id":"golang/flexboard-widget-template","title":"위젯 템플릿","description":"Flex 보드에서 대시보드에 배치할 수 있는 위젯의 종류를 안내합니다.","source":"@site/docs/golang/flexboard-widget-template.mdx","sourceDirName":"golang","slug":"/golang/flexboard-widget-template","permalink":"/golang/flexboard-widget-template","draft":false,"unlisted":false,"editUrl":"undefined/docs/golang/flexboard-widget-template.mdx","tags":[],"version":"current","frontMatter":{"id":"flexboard-widget-template","title":"위젯 템플릿","description":"Flex 보드에서 대시보드에 배치할 수 있는 위젯의 종류를 안내합니다.","keywords":["Flex 보드","위젯","템플릿"],"isTranslationMissing":false},"sidebar":"goSidebar","previous":{"title":"위젯 관리하기","permalink":"/golang/flexboard-widget-manage"},"next":{"title":"Flex 보드 화면 모드","permalink":"/golang/flexboard-mode"}}')
...
;// CONCATENATED MODULE: ./docs/golang/flexboard-widget-template.mdx
