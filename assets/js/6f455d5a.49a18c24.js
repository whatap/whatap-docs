"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[39891],{
...
const metadata = {
  "id": "oracle-v2/flexboard-metric-widget",
  "title": "메트릭스 위젯",
  "description": "프로젝트의 성능 지표를 나타내는 메트릭스 데이터를 위젯 형태로 대시보드에 추가하는 방법을 안내합니다. 메트릭스는 카테고리로 분류되고, 태그를 이용해 데이터를 탐색할 수 있으며, 테이블 위젯과 시리즈 위젯 두 가지 유형으로 제공합니다.",
  "source": "@site/docs/oracle-v2/flexboard-metric-widget.mdx",
  "sourceDirName": "oracle-v2",
  "slug": "/oracle-v2/flexboard-metric-widget",
  "permalink": "/whatap-docs/oracle-v2/flexboard-metric-widget",
  "draft": false,
  "unlisted": false,
  "editUrl": "undefined/docs/oracle-v2/flexboard-metric-widget.mdx",
  "tags": [
    {
      "inline": true,
      "label": "Oracle",
  ...
  "previous": {
    "title": "Flex 보드 관리하기",
    "permalink": "/whatap-docs/oracle-v2/flexboard-manage"
  },
  "next": {
    "title": "위젯 관리하기",
    "permalink": "/whatap-docs/oracle-v2/flexboard-widget-manage"
  }
};
const assets = {
