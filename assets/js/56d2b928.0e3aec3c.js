"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["37308"], {
...
"12963": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_tibero_report_intro_mdx_56d_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-tibero-report-intro-mdx-56d.json
var site_docs_tibero_report_intro_mdx_56d_namespaceObject = JSON.parse('{"id":"tibero/report-intro","title":"보고서","description":"개별 프로젝트에 대해 서비스 이용 현황과 장애 발생 기록을 보고하는 문서에 대해 알아봅니다.","source":"@site/docs/tibero/report-intro.mdx","sourceDirName":"tibero","slug":"/tibero/report-intro","permalink":"/tibero/report-intro","draft":false,"unlisted":false,"editUrl":"undefined/docs/tibero/report-intro.mdx","tags":[],"version":"current","frontMatter":{"id":"report-intro","title":"보고서","description":"개별 프로젝트에 대해 서비스 이용 현황과 장애 발생 기록을 보고하는 문서에 대해 알아봅니다.","keywords":["Tibero","데이터베이스","보고서"],"isTranslationMissing":false},"sidebar":"tiberoSidebar","previous":{"title":"SGA 사이즈","permalink":"/tibero/sga-size"},"next":{"title":"알림 설정하기","permalink":"/tibero/set-notice"}}')
...
;// CONCATENATED MODULE: ./docs/tibero/report-intro.mdx
