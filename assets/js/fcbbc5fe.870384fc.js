"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["65222"], {
...
"55847": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_cubrid_metric_warning_notice_mdx_fcb_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-cubrid-metric-warning-notice-mdx-fcb.json
var site_docs_cubrid_metric_warning_notice_mdx_fcb_namespaceObject = JSON.parse('{"id":"cubrid/metric-warning-notice","title":"메트릭스 경고 알림","description":"구체적이고 복잡한 이벤트를 설정하려면 메트릭스 이벤트 설정을 사용하세요.","source":"@site/docs/cubrid/metric-warning-notice.mdx","sourceDirName":"cubrid","slug":"/cubrid/metric-warning-notice","permalink":"/cubrid/metric-warning-notice","draft":false,"unlisted":false,"editUrl":"undefined/docs/cubrid/metric-warning-notice.mdx","tags":[],"version":"current","frontMatter":{"id":"metric-warning-notice","title":"메트릭스 경고 알림","description":"구체적이고 복잡한 이벤트를 설정하려면 메트릭스 이벤트 설정을 사용하세요.","keywords":["CUBRID","경고 알림","메트릭스 이벤트","데이터베이스 모니터링"],"isTranslationMissing":false},"sidebar":"cubridSidebar","previous":{"title":"이벤트 설정","permalink":"/cubrid/warning-notice-v2"},"next":{"title":"알림 메시지 사용자 정의","permalink":"/cubrid/set-notification-message"}}')
...
;// CONCATENATED MODULE: ./docs/cubrid/metric-warning-notice.mdx
