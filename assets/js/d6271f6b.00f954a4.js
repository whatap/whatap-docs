"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["4746"], {
...
"18076": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_cubrid_v_1_analysis_databaseparameter_mdx_d62_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-cubrid-v-1-analysis-databaseparameter-mdx-d62.json
var site_docs_cubrid_v_1_analysis_databaseparameter_mdx_d62_namespaceObject = JSON.parse('{"id":"cubrid-v1/analysis-databaseparameter","title":"데이터베이스 파라미터","description":"데이터베이스의 파라미터 값을 조회하고 날짜별로 비교할 수 있습니다.","source":"@site/docs/cubrid-v1/analysis-databaseparameter.mdx","sourceDirName":"cubrid-v1","slug":"/cubrid-v1/analysis-databaseparameter","permalink":"/cubrid-v1/analysis-databaseparameter","draft":false,"unlisted":false,"editUrl":"undefined/docs/cubrid-v1/analysis-databaseparameter.mdx","tags":[],"version":"current","frontMatter":{"id":"analysis-databaseparameter","title":"데이터베이스 파라미터","description":"데이터베이스의 파라미터 값을 조회하고 날짜별로 비교할 수 있습니다.","keywords":["CUBRID","데이터베이스","분석","데이터베이스 파라미터"],"isTranslationMissing":false},"sidebar":"cubridV1Sidebar","previous":{"title":"카운트 추이 비교","permalink":"/cubrid-v1/analysis-count-trend"},"next":{"title":"락 트리","permalink":"/cubrid-v1/analysis-lock-and-deadlock"}}')
...
;// CONCATENATED MODULE: ./docs/cubrid-v1/analysis-databaseparameter.mdx
