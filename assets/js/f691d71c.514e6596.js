"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["59635"], {
...
"10057": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_nodejs_set_agent_mdx_f69_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-nodejs-set-agent-mdx-f69.json
var site_docs_nodejs_set_agent_mdx_f69_namespaceObject = JSON.parse('{"id":"nodejs/set-agent","title":"Node.js 환경 설정","description":"Node.js 에이전트의 기본 설정 방법을 제공합니다.","source":"@site/docs/nodejs/set-agent.mdx","sourceDirName":"nodejs","slug":"/nodejs/set-agent","permalink":"/nodejs/set-agent","draft":false,"unlisted":false,"editUrl":"undefined/docs/nodejs/set-agent.mdx","tags":[],"version":"current","frontMatter":{"id":"set-agent","title":"Node.js 환경 설정","description":"Node.js 에이전트의 기본 설정 방법을 제공합니다.","keywords":["Node.js"],"isTranslationMissing":false},"sidebar":"nodejsSidebar","previous":{"title":"설치 점검","permalink":"/nodejs/install-check"},"next":{"title":"에이전트 이름 식별","permalink":"/nodejs/agent-name"}}')
...
;// CONCATENATED MODULE: ./docs/nodejs/set-agent.mdx
...
function _createMdxContent(props) {
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsxs)(_components.p, {
      ...
      }), " 파일에 작성합니다. 에이전트는 환경변수를 통해 설정 파일의 위치를 파악하고 로딩합니다. 컨테이너나 PaaS 환경에서 Node.js 서버가 동작하는 경우 환경 변수를 통해 에이전트 설정을 구성합니다. 사용자의 편의성을 위해 ", (0,jsx_runtime.jsx)(_components.a, {
        href: "https://service.whatap.io",
        children: "와탭 모니터링 서비스"
