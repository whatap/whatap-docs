"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["13142"], {
...
"98642": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_postgresql_log_exp_mdx_cb8_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-postgresql-log-exp-mdx-cb8.json
var site_docs_postgresql_log_exp_mdx_cb8_namespaceObject = JSON.parse('{"id":"postgresql/log-exp","title":"로그 트렌드","description":"로그 모니터링의 로그 트렌드 메뉴를 안내합니다.","source":"@site/docs/postgresql/log-exp.mdx","sourceDirName":"postgresql","slug":"/postgresql/log-exp","permalink":"/postgresql/log-exp","draft":false,"unlisted":false,"editUrl":"undefined/docs/postgresql/log-exp.mdx","tags":[],"version":"current","frontMatter":{"id":"log-exp","title":"로그 트렌드","description":"로그 모니터링의 로그 트렌드 메뉴를 안내합니다.","keywords":["로그 모니터링","로그 트렌드","UI","PostgreSQL"],"isTranslationMissing":false},"sidebar":"postgreSidebar","previous":{"title":"라이브 테일","permalink":"/postgresql/log-lt"},"next":{"title":"로그 검색","permalink":"/postgresql/log-search"}}')
// EXTERNAL MODULE: ./node_modules/react/jsx-runtime.js
var jsx_runtime = __webpack_require__("85893");
// EXTERNAL MODULE: ./node_modules/@mdx-js/react/lib/index.js
var lib = __webpack_require__("50065");
...
;// CONCATENATED MODULE: ./docs/postgresql/log-exp.mdx
