"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["61937"], {
...
"81935": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_php_set_agent_mdx_985_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-php-set-agent-mdx-985.json
var site_docs_php_set_agent_mdx_985_namespaceObject = JSON.parse('{"id":"php/set-agent","title":"PHP 에이전트 설정","description":"PHP 에이전트 설정 파일 구성 요소를 설명합니다.","source":"@site/docs/php/set-agent.mdx","sourceDirName":"php","slug":"/php/set-agent","permalink":"/php/set-agent","draft":false,"unlisted":false,"editUrl":"undefined/docs/php/set-agent.mdx","tags":[],"version":"current","frontMatter":{"id":"set-agent","title":"PHP 에이전트 설정","description":"PHP 에이전트 설정 파일 구성 요소를 설명합니다.","keywords":["PHP","PHP 모니터링","애플리케이션","애플리케이션 모니터링","설정하기"],"isTranslationMissing":false},"sidebar":"phpSidebar","previous":{"title":"설치 문제 해결","permalink":"/php/agent-troubleshooting"},"next":{"title":"에이전트 이름 식별","permalink":"/php/agent-name"}}')
...
;// CONCATENATED MODULE: ./docs/php/set-agent.mdx
...
function _createMdxContent(props) {
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsxs)(_components.p, {
      children: ["PHP 에이전트는 필요한 설정을 ", (0,jsx_runtime.jsx)(_components.em, {
        children: "whatap.ini"
      }), " 파일에 작성하고 변경할 수 있습니다. 사용자의 편의성을 위해 ", (0,jsx_runtime.jsx)(_components.a, {
        href: "https://service.whatap.io",
        children: "와탭 모니터링 서비스"
      ...
      children: (0,jsx_runtime.jsx)(_components.p, {
        children: "일반적으로 설정은 런타임에 바로 reload 됩니다. 다만 해당 설정의 메커니즘상 Apache 또는 PHP-FPM이 기동될 때 적용되는 옵션들은 다시 시작해야 할 수 있습니다."
      })
