"use strict";
(self["webpackChunkwhatap_origin"] = self["webpackChunkwhatap_origin"] || []).push([[62108],{
...
function MDXContent(_param) {
    ...
    }, `Telegraf 플러그인 또는 에이전트는 사용자가 해당 서비스에 직접 설치하고 설정해야 합니다.`)), /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .yg)("p", null, `플러그인 또는 에이전트 설치 방법 및 사용 예시 안내를 다음과 같이 제공합니다.`), /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .yg)(_theme_DocCardList__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .c, {
        mdxType: "DocCardList"
    }));
}
