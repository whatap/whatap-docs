"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["47079"], {
...
"57497": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_oracle_pro_log_main_mdx_ec5_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-oracle-pro-log-main-mdx-ec5.json
var site_docs_oracle_pro_log_main_mdx_ec5_namespaceObject = JSON.parse('{"id":"oracle-pro/log-main","title":"로그","description":"로그 모니터링의 주요 메뉴를 안내합니다.","source":"@site/docs/oracle-pro/log-main.mdx","sourceDirName":"oracle-pro","slug":"/oracle-pro/log-main","permalink":"/oracle-pro/log-main","draft":false,"unlisted":false,"editUrl":"undefined/docs/oracle-pro/log-main.mdx","tags":[],"version":"current","frontMatter":{"id":"log-main","title":"로그","description":"로그 모니터링의 주요 메뉴를 안내합니다.","keywords":["Oracle Pro","로그 모니터링","UI"],"isTranslationMissing":false},"sidebar":"dboracledmaSidebar","previous":{"title":"보고서","permalink":"/oracle-pro/report-intro"},"next":{"title":"적용하기","permalink":"/oracle-pro/log-db"}}')
...
;// CONCATENATED MODULE: ./docs/oracle-pro/log-main.mdx
