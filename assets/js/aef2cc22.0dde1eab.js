"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["34592"], {
...
"95877": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_server_flexboard_share_mdx_aef_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-server-flexboard-share-mdx-aef.json
var site_docs_server_flexboard_share_mdx_aef_namespaceObject = JSON.parse('{"id":"server/flexboard-share","title":"Flex 보드 공유하기","description":"Flex 보드를 다른 계정의 사용자와 공유하고 재사용할 수 있습니다.","source":"@site/docs/server/flexboard-share.mdx","sourceDirName":"server","slug":"/server/flexboard-share","permalink":"/server/flexboard-share","draft":false,"unlisted":false,"editUrl":"undefined/docs/server/flexboard-share.mdx","tags":[],"version":"current","frontMatter":{"id":"flexboard-share","title":"Flex 보드 공유하기","description":"Flex 보드를 다른 계정의 사용자와 공유하고 재사용할 수 있습니다.","keywords":["Flex 보드"],"isTranslationMissing":false},"sidebar":"serverSidebar","previous":{"title":"Flex 보드 화면 모드","permalink":"/server/flexboard-mode"},"next":{"title":"메트릭스","permalink":"/server/metrics-intro"}}')
...
;// CONCATENATED MODULE: ./docs/server/flexboard-share.mdx
