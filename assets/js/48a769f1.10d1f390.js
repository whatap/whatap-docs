"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["28017"], {
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_java_dashboard_transactionmap_mdx_48a_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-java-dashboard-transactionmap-mdx-48a.json
var site_docs_java_dashboard_transactionmap_mdx_48a_namespaceObject = JSON.parse('{"id":"java/dashboard-transactionmap","title":"트랜잭션 맵","description":"자바(Java) 모니터링에서 개별 트랜잭션의 응답 시간을 분포도 형태로 시각화하여 제공하는 트랜잭션 맵 기능을 안내합니다. 실시간 및 과거 데이터 조회 기능을 통해 트랜잭션의 세부 정보를 분석할 수 있으며, 이를 통해 문제점을 식별하고 분석하는 데 유용합니다. 특히 히트맵과 달리 개별 트랜잭션을 표시하여 더 상세한 분석을 할 수 있습니다.","source":"@site/docs/java/dashboard-transactionmap.mdx","sourceDirName":"java","slug":"/java/dashboard-transactionmap","permalink":"/java/dashboard-transactionmap","draft":false,"unlisted":false,"editUrl":"undefined/docs/java/dashboard-transactionmap.mdx","tags":[],"version":"current","frontMatter":{"id":"dashboard-transactionmap","title":"트랜잭션 맵","description":"자바(Java) 모니터링에서 개별 트랜잭션의 응답 시간을 분포도 형태로 시각화하여 제공하는 트랜잭션 맵 기능을 안내합니다. 실시간 및 과거 데이터 조회 기능을 통해 트랜잭션의 세부 정보를 분석할 수 있으며, 이를 통해 문제점을 식별하고 분석하는 데 유용합니다. 특히 히트맵과 달리 개별 트랜잭션을 표시하여 더 상세한 분석을 할 수 있습니다.","keywords":["Java","트랜잭션 맵","대시보드","애플리케이션"],"isTranslationMissing":false},"sidebar":"javaSidebar","previous":{"title":"애플리케이션 대시보드","permalink":"/java/dashboard"},"next":{"title":"액티브 트랜잭션","permalink":"/java/dashboard-active-transaction"}}')
...
;// CONCATENATED MODULE: ./docs/java/dashboard-transactionmap.mdx
