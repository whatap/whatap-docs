"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["38850"], {
"46037": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_php_dashboard_active_transaction_mdx_8ec_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-php-dashboard-active-transaction-mdx-8ec.json
var site_docs_php_dashboard_active_transaction_mdx_8ec_namespaceObject = JSON.parse('{"id":"php/dashboard-active-transaction","title":"액티브 트랜잭션","description":"현재 진행 중인 트랜잭션의 URL, SQL, HTTP 호출 정보로 이상 트랜잭션을 신속하게 파악할 수 있으며, 상세 트레이스를 통해서 지연 구간을 상세하게 분석할 수 있습니다.","source":"@site/docs/php/dashboard-active-transaction.mdx","sourceDirName":"php","slug":"/php/dashboard-active-transaction","permalink":"/php/dashboard-active-transaction","draft":false,"unlisted":false,"editUrl":"undefined/docs/php/dashboard-active-transaction.mdx","tags":[],"version":"current","frontMatter":{"id":"dashboard-active-transaction","title":"액티브 트랜잭션","description":"현재 진행 중인 트랜잭션의 URL, SQL, HTTP 호출 정보로 이상 트랜잭션을 신속하게 파악할 수 있으며, 상세 트레이스를 통해서 지연 구간을 상세하게 분석할 수 있습니다.","keywords":["PHP","액티브 트랜잭션","대시보드","애플리케이션","애플리케이션 모니터링"],"isTranslationMissing":false},"sidebar":"phpSidebar","previous":{"title":"트랜잭션 맵","permalink":"/php/dashboard-transactionmap"},"next":{"title":"히트맵 - 트레이스 분석","permalink":"/php/dashboard-hitmap-trace"}}')
