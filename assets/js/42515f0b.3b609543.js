"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["73484"], {
...
"98205": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_oracle_flexboard_widget_template_mdx_425_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-oracle-flexboard-widget-template-mdx-425.json
var site_docs_oracle_flexboard_widget_template_mdx_425_namespaceObject = JSON.parse('{"id":"oracle/flexboard-widget-template","title":"위젯 템플릿","description":"Flex 보드에서 대시보드에 배치할 수 있는 위젯의 종류를 안내합니다.","source":"@site/docs/oracle/flexboard-widget-template.mdx","sourceDirName":"oracle","slug":"/oracle/flexboard-widget-template","permalink":"/oracle/flexboard-widget-template","draft":false,"unlisted":false,"editUrl":"undefined/docs/oracle/flexboard-widget-template.mdx","tags":[],"version":"current","frontMatter":{"id":"flexboard-widget-template","title":"위젯 템플릿","description":"Flex 보드에서 대시보드에 배치할 수 있는 위젯의 종류를 안내합니다.","keywords":["Flex 보드","위젯","템플릿"],"isTranslationMissing":false},"sidebar":"dboracleV2Sidebar","previous":{"title":"위젯 관리하기","permalink":"/oracle/flexboard-widget-manage"},"next":{"title":"Flex 보드 화면 모드","permalink":"/oracle/flexboard-mode"}}')
...
;// CONCATENATED MODULE: ./docs/oracle/flexboard-widget-template.mdx
