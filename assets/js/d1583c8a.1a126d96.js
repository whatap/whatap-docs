"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["29033"], {
...
"37656": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_ncloud_flexboard_share_mdx_d15_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-ncloud-flexboard-share-mdx-d15.json
var site_docs_ncloud_flexboard_share_mdx_d15_namespaceObject = JSON.parse('{"id":"ncloud/flexboard-share","title":"Flex 보드 공유하기","description":"Flex 보드를 다른 계정의 사용자와 공유하고 재사용할 수 있습니다.","source":"@site/docs/ncloud/flexboard-share.mdx","sourceDirName":"ncloud","slug":"/ncloud/flexboard-share","permalink":"/ncloud/flexboard-share","draft":false,"unlisted":false,"editUrl":"undefined/docs/ncloud/flexboard-share.mdx","tags":[],"version":"current","frontMatter":{"id":"flexboard-share","title":"Flex 보드 공유하기","description":"Flex 보드를 다른 계정의 사용자와 공유하고 재사용할 수 있습니다.","keywords":["Flex 보드","Naver Cloud Monitoring","클라우드"],"isTranslationMissing":false},"sidebar":"ncloudSidebar","previous":{"title":"Flex 보드 화면 모드","permalink":"/ncloud/flexboard-mode"},"next":{"title":"메트릭스","permalink":"/ncloud/metrics-intro"}}')
...
;// CONCATENATED MODULE: ./docs/ncloud/flexboard-share.mdx
