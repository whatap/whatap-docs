"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["85366"], {
...
"36679": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_java_topology_add_function_mdx_2f6_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-java-topology-add-function-mdx-2f6.json
var site_docs_java_topology_add_function_mdx_2f6_namespaceObject = JSON.parse('{"id":"java/topology-add-function","title":"부가 기능","description":"토폴로지 메뉴에서 이용할 수 있는 부가 기능에 대한 설명을 제공합니다.","source":"@site/docs/java/topology-add-function.mdx","sourceDirName":"java","slug":"/java/topology-add-function","permalink":"/java/topology-add-function","draft":false,"unlisted":false,"editUrl":"undefined/docs/java/topology-add-function.mdx","tags":[],"version":"current","frontMatter":{"id":"topology-add-function","title":"부가 기능","description":"토폴로지 메뉴에서 이용할 수 있는 부가 기능에 대한 설명을 제공합니다.","keywords":["Java","토폴로지"],"isTranslationMissing":false},"sidebar":"javaSidebar","previous":{"title":"유형별 토폴로지","permalink":"/java/topology-type"},"next":{"title":"에이전트 옵션 설정","permalink":"/java/topology-settings"}}')
...
;// CONCATENATED MODULE: ./docs/java/topology-add-function.mdx
