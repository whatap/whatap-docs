"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["33039"], {
"30013": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_altibase_log_search_mdx_cab_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-altibase-log-search-mdx-cab.json
var site_docs_altibase_log_search_mdx_cab_namespaceObject = JSON.parse('{"id":"altibase/log-search","title":"로그 검색","description":"로그 모니터링의 로그 검색 메뉴를 안내합니다.","source":"@site/docs/altibase/log-search.mdx","sourceDirName":"altibase","slug":"/altibase/log-search","permalink":"/altibase/log-search","draft":false,"unlisted":false,"editUrl":"undefined/docs/altibase/log-search.mdx","tags":[],"version":"current","frontMatter":{"id":"log-search","title":"로그 검색","description":"로그 모니터링의 로그 검색 메뉴를 안내합니다.","keywords":["로그 모니터링","로그","로그 검색","UI","Altibase"],"isTranslationMissing":false},"sidebar":"altibaseSidebar","previous":{"title":"로그 트렌드","permalink":"/altibase/log-exp"},"next":{"title":"로그 설정","permalink":"/altibase/log-setting"}}')
