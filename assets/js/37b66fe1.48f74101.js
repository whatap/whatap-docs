"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["80824"], {
...
"35399": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_oracle_v_1_labs_mdx_37b_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-oracle-v-1-labs-mdx-37b.json
var site_docs_oracle_v_1_labs_mdx_37b_namespaceObject = JSON.parse('{"id":"oracle-v1/labs","title":"실험실","description":"사용자에게 새로운 기능 또는 실험적인 기능을 제공하는 메뉴인 실험실에 대해 안내합니다.","source":"@site/docs/oracle-v1/labs.mdx","sourceDirName":"oracle-v1","slug":"/oracle-v1/labs","permalink":"/oracle-v1/labs","draft":false,"unlisted":false,"editUrl":"undefined/docs/oracle-v1/labs.mdx","tags":[],"version":"current","frontMatter":{"id":"labs","title":"실험실","description":"사용자에게 새로운 기능 또는 실험적인 기능을 제공하는 메뉴인 실험실에 대해 안내합니다.","keywords":["Oracle","데이터베이스","실험실"],"isTranslationMissing":false},"sidebar":"dboracleSidebar","previous":{"title":"시스템 이벤트 안내","permalink":"/oracle-v1/common-alert"}}')
...
;// CONCATENATED MODULE: ./docs/oracle-v1/labs.mdx
