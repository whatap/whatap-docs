"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["33580"], {
...
"67458": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_kubernetes_set_notification_message_mdx_fbc_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-kubernetes-set-notification-message-mdx-fbc.json
var site_docs_kubernetes_set_notification_message_mdx_fbc_namespaceObject = JSON.parse('{"id":"kubernetes/set-notification-message","title":"알림 메시지 사용자 정의","description":"프로젝트 멤버에게 전달되는 경고 알림 메시지를 수정할 수 있는 사용자 정의 기능을 제공합니다.","source":"@site/docs/kubernetes/set-notification-message.mdx","sourceDirName":"kubernetes","slug":"/kubernetes/set-notification-message","permalink":"/kubernetes/set-notification-message","draft":false,"unlisted":false,"editUrl":"undefined/docs/kubernetes/set-notification-message.mdx","tags":[],"version":"current","frontMatter":{"id":"set-notification-message","title":"알림 메시지 사용자 정의","description":"프로젝트 멤버에게 전달되는 경고 알림 메시지를 수정할 수 있는 사용자 정의 기능을 제공합니다.","keywords":["쿠버네티스","경고 알림","메트릭스 이벤트","알림 메시지"],"isTranslationMissing":false},"sidebar":"kubeSidebar","previous":{"title":"메트릭스 경고 알림","permalink":"/kubernetes/metric-warning-notice"},"next":{"title":"AI 기반의 히트맵 패턴 경고 알림","permalink":"/kubernetes/hitmap-notice"}}')
...
;// CONCATENATED MODULE: ./docs/kubernetes/set-notification-message.mdx
