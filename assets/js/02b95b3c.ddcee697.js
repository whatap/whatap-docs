"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["50902"], {
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_mssql_v_1_agent_dbx_settings_mdx_02b_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-mssql-v-1-agent-dbx-settings-mdx-02b.json
var site_docs_mssql_v_1_agent_dbx_settings_mdx_02b_namespaceObject = JSON.parse('{"id":"mssql-v1/agent-dbx-settings","title":"DBX 에이전트 설정","description":"whatap.conf 파일에 설정할 수 있는 옵션에 대해 안내합니다.","source":"@site/docs/mssql-v1/agent-dbx-settings.mdx","sourceDirName":"mssql-v1","slug":"/mssql-v1/agent-dbx-settings","permalink":"/mssql-v1/agent-dbx-settings","draft":false,"unlisted":false,"editUrl":"undefined/docs/mssql-v1/agent-dbx-settings.mdx","tags":[],"version":"current","frontMatter":{"id":"agent-dbx-settings","title":"DBX 에이전트 설정","description":"whatap.conf 파일에 설정할 수 있는 옵션에 대해 안내합니다.","keywords":["SQL Server","데이터베이스","DBX 에이전트"],"isTranslationMissing":false},"sidebar":"mssqlV1Sidebar","previous":{"title":"설정하기","permalink":"/mssql-v1/agent-settings"},"next":{"title":"관리하기","permalink":"/mssql-v1/agent-manage"}}')
...
;// CONCATENATED MODULE: ./docs/mssql-v1/agent-dbx-settings.mdx
