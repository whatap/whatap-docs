"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["854"], {
...
"19188": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_oracle_pro_flexboard_share_mdx_ee0_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-oracle-pro-flexboard-share-mdx-ee0.json
var site_docs_oracle_pro_flexboard_share_mdx_ee0_namespaceObject = JSON.parse('{"id":"oracle-pro/flexboard-share","title":"Flex 보드 공유하기","description":"Flex 보드를 다른 계정의 사용자와 공유하고 재사용할 수 있습니다.","source":"@site/docs/oracle-pro/flexboard-share.mdx","sourceDirName":"oracle-pro","slug":"/oracle-pro/flexboard-share","permalink":"/oracle-pro/flexboard-share","draft":false,"unlisted":false,"editUrl":"undefined/docs/oracle-pro/flexboard-share.mdx","tags":[],"version":"current","frontMatter":{"id":"flexboard-share","title":"Flex 보드 공유하기","description":"Flex 보드를 다른 계정의 사용자와 공유하고 재사용할 수 있습니다.","keywords":["Oracle Pro","Flex 보드"],"isTranslationMissing":false},"sidebar":"dboracledmaSidebar","previous":{"title":"Flex 보드 화면 모드","permalink":"/oracle-pro/flexboard-mode"},"next":{"title":"카운트 추이 비교","permalink":"/oracle-pro/analysis-count-trend"}}')
...
;// CONCATENATED MODULE: ./docs/oracle-pro/flexboard-share.mdx
