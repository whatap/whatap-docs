"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["3129"], {
"29743": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_kubernetes_agent_update_mdx_cc7_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-kubernetes-agent-update-mdx-cc7.json
var site_docs_kubernetes_agent_update_mdx_cc7_namespaceObject = JSON.parse('{"id":"kubernetes/agent-update","title":"에이전트 업데이트","description":"쿠버네티스 에이전트를 업데이트하는 방법에 대해 알아봅니다.","source":"@site/docs/kubernetes/agent-update.mdx","sourceDirName":"kubernetes","slug":"/kubernetes/agent-update","permalink":"/kubernetes/agent-update","draft":false,"unlisted":false,"editUrl":"undefined/docs/kubernetes/agent-update.mdx","tags":[],"version":"current","frontMatter":{"id":"agent-update","title":"에이전트 업데이트","description":"쿠버네티스 에이전트를 업데이트하는 방법에 대해 알아봅니다.","keywords":["쿠버네티스","쿠버네티스 모니터링","에이전트 업데이트"],"isTranslationMissing":false},"sidebar":"kubeSidebar","previous":{"title":"쿠버네티스 에이전트 목록","permalink":"/kubernetes/agent-list"},"next":{"title":"에이전트 삭제","permalink":"/kubernetes/uninstall-agent"}}')
...
;// CONCATENATED MODULE: ./docs/kubernetes/agent-update.mdx
      ...
      children: [(0,jsx_runtime.jsx)(_components.mdxAdmonitionTitle, {}), (0,jsx_runtime.jsxs)(_components.ul, {
        children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
          ...
          children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
            children: ["와탭 쿠버네티스 에이전트의 최신 버전은 ", (0,jsx_runtime.jsx)(_components.a, {
