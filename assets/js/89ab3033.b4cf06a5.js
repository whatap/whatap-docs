"use strict";
(self["webpackChunkWhaTap_Docs"] = self["webpackChunkWhaTap_Docs"] || []).push([[54392],{
...
const metadata = {
  "id": "oracle-v2/set-event-detect-anomal",
  "title": "이상치 탐지 경고 알림",
  "description": "예상치 못한 패턴을 찾는 일련의 활동을 탐지해 경고 알림을 보내도록 설정할 수 있습니다.",
  "source": "@site/docs/oracle-v2/set-event-detect-anomal.mdx",
  "sourceDirName": "oracle-v2",
  "slug": "/oracle-v2/set-event-detect-anomal",
  "permalink": "/whatap-docs/oracle-v2/set-event-detect-anomal",
  "draft": false,
  "unlisted": false,
  "editUrl": "undefined/docs/oracle-v2/set-event-detect-anomal.mdx",
  "tags": [
    {
      "inline": true,
      "label": "Oracle",
