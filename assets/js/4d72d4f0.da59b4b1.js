"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["47878"], {
"26380": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_amazon_ecs_labs_mdx_4d7_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-amazon-ecs-labs-mdx-4d7.json
var site_docs_amazon_ecs_labs_mdx_4d7_namespaceObject = JSON.parse('{"id":"amazon-ecs/labs","title":"실험실","description":"사용자에게 새로운 기능 또는 실험적인 기능을 제공하는 메뉴인 실험실에 대해 안내합니다.","source":"@site/docs/amazon-ecs/labs.mdx","sourceDirName":"amazon-ecs","slug":"/amazon-ecs/labs","permalink":"/amazon-ecs/labs","draft":false,"unlisted":false,"editUrl":"undefined/docs/amazon-ecs/labs.mdx","tags":[],"version":"current","frontMatter":{"id":"labs","title":"실험실","description":"사용자에게 새로운 기능 또는 실험적인 기능을 제공하는 메뉴인 실험실에 대해 안내합니다.","keywords":["Amazon ECS","클라우드","실험실"],"isTranslationMissing":false},"sidebar":"awsecsSidebar","previous":{"title":"시스템 이벤트 안내","permalink":"/amazon-ecs/common-alert"}}')
...
;// CONCATENATED MODULE: ./docs/amazon-ecs/labs.mdx
