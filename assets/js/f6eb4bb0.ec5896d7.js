"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["43860"], {
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_mongodb_metric_warning_notice_mdx_f6e_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-mongodb-metric-warning-notice-mdx-f6e.json
var site_docs_mongodb_metric_warning_notice_mdx_f6e_namespaceObject = JSON.parse('{"id":"mongodb/metric-warning-notice","title":"메트릭스 경고 알림","description":"구체적이고 복잡한 이벤트를 설정하려면 메트릭스 이벤트 설정을 사용하세요.","source":"@site/docs/mongodb/metric-warning-notice.mdx","sourceDirName":"mongodb","slug":"/mongodb/metric-warning-notice","permalink":"/mongodb/metric-warning-notice","draft":false,"unlisted":false,"editUrl":"undefined/docs/mongodb/metric-warning-notice.mdx","tags":[],"version":"current","frontMatter":{"id":"metric-warning-notice","title":"메트릭스 경고 알림","description":"구체적이고 복잡한 이벤트를 설정하려면 메트릭스 이벤트 설정을 사용하세요.","keywords":["MongoDB","경고 알림","메트릭스 이벤트","데이터베이스 모니터링"],"isTranslationMissing":false},"sidebar":"mongodbSidebar","previous":{"title":"이벤트 설정","permalink":"/mongodb/warning-notice-v2"},"next":{"title":"알림 메시지 사용자 정의","permalink":"/mongodb/set-notification-message"}}')
...
;// CONCATENATED MODULE: ./docs/mongodb/metric-warning-notice.mdx
