"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["63220"], {
...
"17991": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_mssql_v_1_labs_mdx_2d0_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-mssql-v-1-labs-mdx-2d0.json
var site_docs_mssql_v_1_labs_mdx_2d0_namespaceObject = JSON.parse('{"id":"mssql-v1/labs","title":"실험실","description":"사용자에게 새로운 기능 또는 실험적인 기능을 제공하는 메뉴인 실험실에 대해 안내합니다.","source":"@site/docs/mssql-v1/labs.mdx","sourceDirName":"mssql-v1","slug":"/mssql-v1/labs","permalink":"/mssql-v1/labs","draft":false,"unlisted":false,"editUrl":"undefined/docs/mssql-v1/labs.mdx","tags":[],"version":"current","frontMatter":{"id":"labs","title":"실험실","description":"사용자에게 새로운 기능 또는 실험적인 기능을 제공하는 메뉴인 실험실에 대해 안내합니다.","keywords":["SQL Server","데이터베이스","실험실"],"isTranslationMissing":false},"sidebar":"mssqlV1Sidebar","previous":{"title":"시스템 이벤트 안내","permalink":"/mssql-v1/common-alert"}}')
...
;// CONCATENATED MODULE: ./docs/mssql-v1/labs.mdx
