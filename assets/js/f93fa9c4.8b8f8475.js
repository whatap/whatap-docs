"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["32460"], {
...
"53612": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_mysql_agent_manage_mdx_f93_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-mysql-agent-manage-mdx-f93.json
var site_docs_mysql_agent_manage_mdx_f93_namespaceObject = JSON.parse('{"id":"mysql/agent-manage","title":"관리하기","description":"에이전트를 업데이트하거나 삭제하는 방법을 알아봅니다.","source":"@site/docs/mysql/agent-manage.mdx","sourceDirName":"mysql","slug":"/mysql/agent-manage","permalink":"/mysql/agent-manage","draft":false,"unlisted":false,"editUrl":"undefined/docs/mysql/agent-manage.mdx","tags":[],"version":"current","frontMatter":{"id":"agent-manage","title":"관리하기","description":"에이전트를 업데이트하거나 삭제하는 방법을 알아봅니다.","keywords":["MySQL","데이터베이스","데이터베이스 모니터링"],"isTranslationMissing":false},"sidebar":"mysqlSidebar","previous":{"title":"클라우드 설정","permalink":"/mysql/cloudsettings"},"next":{"title":"대시보드","permalink":"/mysql/dashboard-intro"}}')
...
;// CONCATENATED MODULE: ./docs/mysql/agent-manage.mdx
