"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["57318"], {
...
"46324": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_mssql_stat_mdx_f08_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-mssql-stat-mdx-f08.json
var site_docs_mssql_stat_mdx_f08_namespaceObject = JSON.parse('{"id":"mssql/stat","title":"SQL 통계","description":"SQL Server의 데이터베이스별 통계 데이터를 제공합니다.","source":"@site/docs/mssql/stat.mdx","sourceDirName":"mssql","slug":"/mssql/stat","permalink":"/mssql/stat","draft":false,"unlisted":false,"editUrl":"undefined/docs/mssql/stat.mdx","tags":[],"version":"current","frontMatter":{"id":"stat","title":"SQL 통계","description":"SQL Server의 데이터베이스별 통계 데이터를 제공합니다.","keywords":["SQL Server","데이터베이스","통계"],"isTranslationMissing":false},"sidebar":"mssqlSidebar","previous":{"title":"메트릭스 이상 탐지","permalink":"/mssql/metrics-detect-anormal"},"next":{"title":"프로시저 통계","permalink":"/mssql/procedure-stat"}}')
...
;// CONCATENATED MODULE: ./docs/mssql/stat.mdx
