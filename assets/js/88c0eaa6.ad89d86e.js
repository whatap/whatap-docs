"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["75065"], {
...
"23573": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_oracle_v_1_agent_xos_settings_mdx_88c_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-oracle-v-1-agent-xos-settings-mdx-88c.json
var site_docs_oracle_v_1_agent_xos_settings_mdx_88c_namespaceObject = JSON.parse('{"id":"oracle-v1/agent-xos-settings","title":"XOS 에이전트 설정","description":"데이터베이스 프로세스 모니터링 설정에 대해 알아봅니다.","source":"@site/docs/oracle-v1/agent-xos-settings.mdx","sourceDirName":"oracle-v1","slug":"/oracle-v1/agent-xos-settings","permalink":"/oracle-v1/agent-xos-settings","draft":false,"unlisted":false,"editUrl":"undefined/docs/oracle-v1/agent-xos-settings.mdx","tags":[],"version":"current","frontMatter":{"id":"agent-xos-settings","title":"XOS 에이전트 설정","description":"데이터베이스 프로세스 모니터링 설정에 대해 알아봅니다.","keywords":["Oracle","데이터베이스","데이터베이스 모니터링","에이전트","XOS"],"isTranslationMissing":false},"sidebar":"dboracleSidebar","previous":{"title":"DBX 에이전트 설정","permalink":"/oracle-v1/agent-dbx-settings"},"next":{"title":"관리하기","permalink":"/oracle-v1/agent-manage"}}')
...
;// CONCATENATED MODULE: ./docs/oracle-v1/agent-xos-settings.mdx
...
const toc = [..._db_agent_xos_settings_desc/* toc */.d$, ..._db_xos_whatap_conf/* toc */.d$, ..._db_xos_conf/* toc */.d$, ..._db_run_xos/* toc */.d$];
function _createMdxContent(props) {
