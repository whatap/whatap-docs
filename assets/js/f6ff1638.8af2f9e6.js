"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["42261"], {
...
"69799": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_php_metrics_app_mdx_f6f_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-php-metrics-app-mdx-f6f.json
var site_docs_php_metrics_app_mdx_f6f_namespaceObject = JSON.parse('{"id":"php/metrics-app","title":"애플리케이션 지표","description":"애플리케이션 지표를 안내합니다.","source":"@site/docs/php/metrics-app.mdx","sourceDirName":"php","slug":"/php/metrics-app","permalink":"/php/metrics-app","draft":false,"unlisted":false,"editUrl":"undefined/docs/php/metrics-app.mdx","tags":[],"version":"current","frontMatter":{"id":"metrics-app","title":"애플리케이션 지표","description":"애플리케이션 지표를 안내합니다.","toc_max_heading_level":2,"keywords":["PHP","메트릭스","애플리케이션","UI"],"isTranslationMissing":false},"sidebar":"phpSidebar","previous":{"title":"메트릭스","permalink":"/php/metrics-intro"},"next":{"title":"애플리케이션 성능 카운터","permalink":"/php/metrics-performance-counter"}}')
