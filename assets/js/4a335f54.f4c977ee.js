"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["1955"], {
...
"14102": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_mongodb_real_time_notification_mdx_4a3_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-mongodb-real-time-notification-mdx-4a3.json
var site_docs_mongodb_real_time_notification_mdx_4a3_namespaceObject = JSON.parse('{"id":"mongodb/real-time-notification","title":"실시간 알림","description":"이벤트 설정 메뉴를 통해서 설정한 경고 알림을 실시간으로 확인할 수 있습니다.","source":"@site/docs/mongodb/real-time-notification.mdx","sourceDirName":"mongodb","slug":"/mongodb/real-time-notification","permalink":"/mongodb/real-time-notification","draft":false,"unlisted":false,"editUrl":"undefined/docs/mongodb/real-time-notification.mdx","tags":[],"version":"current","frontMatter":{"id":"real-time-notification","title":"실시간 알림","description":"이벤트 설정 메뉴를 통해서 설정한 경고 알림을 실시간으로 확인할 수 있습니다.","keywords":["실시간 알림"],"isTranslationMissing":false},"sidebar":"mongodbSidebar","previous":{"title":"이벤트 수신 포맷","permalink":"/mongodb/set-event-format"},"next":{"title":"시스템 이벤트 안내","permalink":"/mongodb/common-alert"}}')
...
;// CONCATENATED MODULE: ./docs/mongodb/real-time-notification.mdx
