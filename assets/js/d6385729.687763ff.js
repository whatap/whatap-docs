"use strict";
(self['webpackChunkWhaTap_Docs'] = self['webpackChunkWhaTap_Docs'] || []).push([["28799"], {
...
"82361": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  metadata: () => (/* reexport */ site_docs_golang_dashboard_mdx_d63_namespaceObject),
...
;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-golang-dashboard-mdx-d63.json
var site_docs_golang_dashboard_mdx_d63_namespaceObject = JSON.parse('{"id":"golang/dashboard","title":"애플리케이션 대시보드","description":"웹 애플리케이션 서버의 리소스를 실시간으로 모니터링할 수 있습니다.","source":"@site/docs/golang/dashboard.mdx","sourceDirName":"golang","slug":"/golang/dashboard","permalink":"/golang/dashboard","draft":false,"unlisted":false,"editUrl":"undefined/docs/golang/dashboard.mdx","tags":[],"version":"current","frontMatter":{"id":"dashboard","title":"애플리케이션 대시보드","description":"웹 애플리케이션 서버의 리소스를 실시간으로 모니터링할 수 있습니다.","keywords":["Go","대시보드","애플리케이션","애플리케이션 모니터링"],"isTranslationMissing":false},"sidebar":"goSidebar","previous":{"title":"대시보드","permalink":"/golang/dashboard-intro"},"next":{"title":"트랜잭션 맵","permalink":"/golang/dashboard-transactionmap"}}')
...
;// CONCATENATED MODULE: ./docs/golang/dashboard.mdx
