...
Home &gt; Select Project &gt; <Cmdname sid="side_analysis" className="uitext" /> &gt; <Cmdname sid="side_dbScriptManager" className="uitext" />
...
2. In the <Cmdname sid="TTL08478" className="uitext" /> section of <Cmdname sid="side_analysis" className="uitext" /> &gt; <Cmdname sid="side_dbScriptManager" className="uitext" />, select an agent on which the SQL script is to be run.
