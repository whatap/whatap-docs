...
After creating a **Feature Project** (<code class='Features'>Features</code>), the **_KAFKA Agent Installation_** screen appears. Proceed with installation according to the following instructions. 
