...
-   **Per-container view**
    ...
    <ImgLang img='whatap_kubernetes_container_map_container_category.png' desc='Per-container view' />

-   **Per-pod view**

    <ImgLang img='whatap_kubernetes_container_map_pod_category.png' desc='Per-pod view' />
