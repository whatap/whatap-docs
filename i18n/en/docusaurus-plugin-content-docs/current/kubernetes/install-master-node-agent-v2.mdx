...
Check the access key and then select the **_Choose installation method_** tab on the **_Setup guide_** screen. Select a desired installation method out of the **Helm** chart and **Yaml** installation methods supported by the WhaTap Kubernetes agent, and then select an appropriate item according to your Kubernetes environment. 

<ImgLang img='k8s-install-master-node-method.png' desc='Select installation method'/>

1. Select a desired **installation method** out of **_Helm_** chart and **_Yaml_**. 

2. Select an applicable **Kubernetes version**: **_1.16 or later_** or **_less than 1.16_**. 

3. Select **Container runtime** from **_containerd_**, **_Docker Engine_**, and **_CRI-O_**. 

4. Select a **User Kubernetes environment** (GKE, OpenShift, Istio, GPU Cluster), if applicable.

5. After selecting an installation method, click **_Next_** at the lower right of the screen or select the **_Apply additional features_** tab on the left to move to the next step.
...
When installing the WhaTap Kubernetes agent, we provide installation instructions based on the **Helm** chart and **Yaml** file default installation instructions as follows. 
