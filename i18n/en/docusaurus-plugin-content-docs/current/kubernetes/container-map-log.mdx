...
-   By defining the ![number 2](/img/number-02.png) category, you can search data. For more information about the categories that can be searched, see the following guide for blocks and groups.
...
#### General blocks and micro blocks
