...
Select Home screen &gt; cluster project (<code class='my'>CP</code>) &gt; <Cmdname sid="side_cluster" className="uitext" /> &gt; <Cmdname sid="side_etcdDashboard" className="uitext" />
...
{/* •	etcd 리소스 사용량
•	Provision of data for CPU and memory usage, number of Pod restarts, and related log data
•	Job processing status
•	Numbers of etcd commits and applies
•	Reader status tracking
•	etcd reader existence and reader change history */}
