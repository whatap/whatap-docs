...
<ImgLang img='whatap_kubernetes_container_map_trace_example.png' desc='Trace' />
...
**_Transaction list_** screen provides the transaction list for a specified time period. To check the transaction distribution chart and check only the transactions in a specific section, select (drag) a target from the hitmap chart of the above trace **_Dashboard_**.

<ImgLang img='k8s-tx-list.png' desc='Transaction List' />
