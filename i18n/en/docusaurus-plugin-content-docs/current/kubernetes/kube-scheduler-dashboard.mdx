...
Home &gt; cluster project (<code class='my'>CP</code>) &gt; <Cmdname sid="side_cluster" className="uitext" /> &gt; ***kube-scheduler Dashboard***
...
The ***kube-scheduler dashboard*** provides visualization of key metrics collected over the past 1 hour, broken down at 1-minute intervals. The key metrics you can see on the dashboard are as follows. For the metrics details, see the [metric guide](#kube-scheduler-metrics) at the bottom. 
