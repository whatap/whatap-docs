...
Home Screen &gt; Select Project &gt; <Cmdname sid="side_analysis" className="uitext" /> &gt; <Cmdname sid="openmetrics_explorer" className="uitext" /> <code class="Beta">Beta</code>

<Cmdname sid="openmetrics_explorer" className="uitext" /> allows you to directly explore custom Prometheus-based metrics using PromQL, visualize them in various formats, and check the status of metrics or gain insights.
...
To use the <Cmdname sid="openmetrics_explorer" className="uitext" />, the Open Agent must be installed.
...
In <Cmdname sid="openmetrics_explorer" className="uitext" />, you can run PromQL queries and view the results with various visualization options.
