...
Home &gt; Project Select &gt; <Cmdname sid="side_node" className="uitext" /> &gt; <Cmdname sid="node_detail" className="uitext" />

The <Cmdname sid="node_detail" className="uitext" /> screen consists of four charts at the top and ***container*** and ***Pod*** details in the node. The node selector allows you to select a node to search.
...
- When the <Cmdname sid="overview" className="uitext" /> column is selected, you can see <Cmdname sid="TTL08230" className="uitext" />.
...
- When the <Cmdname sid="overview" className="uitext" /> column is selected, you can see <Cmdname sid="TTL08317" className="uitext" type="kube_pod" />.
