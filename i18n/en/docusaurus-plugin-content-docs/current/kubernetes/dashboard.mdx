...
Application dashboard > Application service dashboard 
System CPU > Container CPU

Dashboard image
Container CPU image

Temporarily remove the reference links such as agent configuration and transaction profile.

*/}

Home > Select Project > **_Application_** > <Cmdname sid="dashboard" className="uitext" /> > <Cmdname sid="serviceDashboard" className="uitext" /> 
...
- You can access it through the **_Dashboard_** menu under **_Dashboard_** or **_Application_**.
...
If you add a database project through the <Cmdname sid="side_correlatedProjectManagement" className="uitext" /> menu for the Java platform, you can see the performance metrics of the project linked in the following widget.
...
- For more information about the configuration of agent options for aggregating the user count, see [the following](../java/agent-number-of-user).
