...
- ![Leader line 2](/img/number-02.png) **\*Summary Info List**
  ...
  - If you select ![More icon](/img/right-arrow.svg) **_More_** icon on the left of the ![Leader line 3](/img/number-03.png) target selected from the list, the metrics for **_Node_**, **_Namespace_**, **_Deployment_**, **_ReplicaSet_**, **_Pod_**, **_ContainerName_**, **_ContainerId_**, **_Image_**, and **_Agent_** appear.
...
- ![Leader line 4](/img/number-04.png) **Trace**, **Metrics**, **Log**, **Event**, **Call Information**
