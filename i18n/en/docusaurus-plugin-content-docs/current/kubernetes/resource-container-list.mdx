...
<ImgLang img='whatap_kubernetes_resource_container_list.png' desc='Container List' />
...
<ImgLang img='whatap_kubernetes_resource_container_detail.png' desc='Container List Detail' />
