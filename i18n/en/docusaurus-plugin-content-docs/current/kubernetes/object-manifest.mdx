...
Home > Select Project > <Cmdname sid="cluster" className="uitext" /> > **_Object Manifest Information_** 

:::note 

**Requirements**

WhaTap Master Agent 1.5.5 or later is required. If the version is less than 1.5.5, the **_master meta info_** screen appears.
