...
| `num_sort_data_pages`                      | Number of pages found from page buffer while sorting. A higher value indicates that it is less efficient.                                                                                       | Page buffer      |
| `num_sort_io_pages`                        | Number of pages fetched from disk while sorting. A higher value indicates that it is less efficient.                                                                                            | Page buffer      |
