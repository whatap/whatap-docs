...
-   ![Customer Support icon](/img/ic-message-filled.svg) **Customer Support** / **Setting and Information**
...
-   **_+ Project_**: You can add a new project. For more information about project addition, see [the following](project#create-project).
