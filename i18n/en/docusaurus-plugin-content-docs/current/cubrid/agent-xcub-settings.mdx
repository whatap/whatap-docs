...
- **xcub_port** <span class='type'>String</span>
  ...
  Set the port to communicate with the XCUB agent. If you have installed the XOS agent together, you do not need to set this option because it shares the XOS port.
