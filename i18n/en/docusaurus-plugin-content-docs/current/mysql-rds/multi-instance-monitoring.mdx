...
-   **_Acitive Sessions_** 
    ...
    You can view active sessions and queries. If you select an item in the rightmost **_query_** column in the table, the **_Show SQL_** window appears. You can see the full text and plan information for the selected query. For more information about the columns in the table, see the following.
