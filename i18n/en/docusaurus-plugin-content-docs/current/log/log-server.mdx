...
Set whether or not to generate separate log collection statistics.

Specify the file path for log monitoring as follows. If you enter the command, the log monitoring starts.
...
Home > Select Project > ***Log*** > ***Setting***
