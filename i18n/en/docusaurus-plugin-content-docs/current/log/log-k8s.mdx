...
1.  Select ![number4](/img/number-04.png) **_Apply_**. You can collect logs to the Kubernetes container.
...
1.  Select ![number4](/img/number-04.png) **_Apply_**. You can collect application logs in the Kubernetes containers.
...
-   For more information about the collection of Golang application logs, see [the following](log-go).
...
After the above configuration to collect logs into the Kubernetes container, set to collect logs for applications running on the container. 
