...
<Cmdname sid="side_integratedDashboard" className="uitext" /> is **discontinued on July 24, 2024**.

We recommend using the <Cmdname sid="side_flexboard" className="uitext" /> menu that has improved the convenience and functionality of <Cmdname sid="side_integratedDashboard" className="uitext" />. For more information about <Cmdname sid="side_flexboard" className="uitext" />, see the documents for each product.
