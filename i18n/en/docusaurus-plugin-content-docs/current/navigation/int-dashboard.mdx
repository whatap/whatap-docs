...
1.  If you select a desired template, the **_Dashboard Templates_** window appears.

  ![Dashboard Template](/img/main-int-dashboard-sel-template.png)

1.  Enter the dashboard name and description, and then select a project to import data from. The number of selectable projects may differ depending on the template.
...
1.  If the **_Create dashboard_** window appears, enter the name and description, and then select **_Save_**.

2.  You can see the dashboard created in the **_Integrated Dashboard_** list. To select the created dashboard from the list, the dashboard screen appears.

3.  Select **_+ Add Widget_** and then add desired widgets.
