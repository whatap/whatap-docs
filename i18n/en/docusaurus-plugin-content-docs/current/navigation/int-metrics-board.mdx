...
Home > **_Sitemap_** > **_Integrated Metrics Board_**
...
<Cmdname sid="side_integratedMetricsBoard" className="uitext" /> is **discontinued on July 24, 2024**.

We recommend using the <Cmdname sid="side_flexboard" className="uitext" /> menu that has improved the convenience and functionality of <Cmdname sid="side_integratedMetricsBoard" className="uitext" />. For more information about <Cmdname sid="side_flexboard" className="uitext" />, see the documents for each product.
...
- **_Title Style_**
  ...
  - **_description_**: Enter the description of the metric chart widget.
