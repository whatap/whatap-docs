...
If you use **_Integrated Metrics Board_** for the first time, it is recommended to use **_Flex Board_**. For more information about **_Flex Board_**, see documents for each product.
