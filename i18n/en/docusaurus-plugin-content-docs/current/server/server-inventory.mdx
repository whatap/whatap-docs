...
If you click <Cmdname sid="BTN06223" className="uitext" /> after entering the filters, you can view the filtered list in the ![Instruction line 2](/img/number-02.png) server inventory list area. 
...
<ImgLang img='server-inventory-cl.png' desc='Server inventory column setting' />
