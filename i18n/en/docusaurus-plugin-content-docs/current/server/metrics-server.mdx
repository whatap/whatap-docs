...
| epochtime            | Positive number | 메트릭이 수집된 시간의 epoch time                | Common  |
| memory_available     | Byte            | 메모리 available 크기                       | Common  |
...
| ioPercent        | Percentage      | IO 사용률 `일부 디스크 유형에서는 부정확한 값이 측정될 수 있습니다.` | Linux   |
