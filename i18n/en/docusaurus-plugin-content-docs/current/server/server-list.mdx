...
-   ![Column icon](/img/ic-column.svg) **_Column selection_**\
...
-   **Column sorting**\
        By clicking the column title, you can sort in ascending or descending order.
    :::note
    The settings for **column width** and **column sorting** are stored in the browser cookies and the status is maintained after refreshing the page. If an error occurs between settings due to cookie deletion or other reasons, it is initialized to the unset state.
    :::
