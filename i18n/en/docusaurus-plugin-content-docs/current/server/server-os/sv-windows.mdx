...
If you select **_Windows_** on the OS selection window of **_Agent Installation_** and check the project access key, proceed with the installation according to the following instructions. 

1. Download the **agent file**.

   In the **_Download installation file_** tab, select _whatap_infra.exe_ or _whatap_infra.zip_ to download the agent installation file.  
