...
| Stateful                                    | 해결된 이벤트 알림                                   | `true`   | 해결된 이벤트 알림 기능 사용 중이면 `true`, 아니면 `false`                                                                                       |
...
| Repeat Duration                             | 이벤트 반복 시간                                    | `true`   | (메트릭스 알림) 이벤트 조건이 이벤트 반복 시간동안 이벤트 반복 횟수만큼 만족해야 이벤트가 발생됩니다. 해결된 이벤트 알림입니다.                                                      |
| IP                                          | IP                                           | `true`   | -                                                                                                                              |
