...
Only supported on Linux. Requires agent version 2.8.5 or higher.
...
* To add new columns, use the **+ Add Column** button in the inventory list. Server additions or deletions are not applied.
