...
- When you select the ***query*** column in the table list of the ***Parallel Query Tree*** section, the <Cmdname sid="TTL06224" className="uitext" /> window appears. See [Next document](usage-ui#query-details) for more information.
