...
> Can I back up and recover the logs?

Collected logs are saved by date. You can back up your old files and restore them back to the folder. 

### Log data deletion cycle

> What is the log data deletion cycle?

It is the same as **_Data Retention_** set in **_Log Setting_**. However, because the loaded log retention period is in hours, data may remain for 1 hour in addition to the setting in **_Data Retention_**.
