...
| Q. Metalocks (locks obtained when changing the names or structures of database objects) cannot be viewed in the lock tree of MySQL. How can I monitor metalocks as well? |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |

> A. DB and WhaTap agent configurations are required.
>
> **DB Configuration**
>
> ```sql
