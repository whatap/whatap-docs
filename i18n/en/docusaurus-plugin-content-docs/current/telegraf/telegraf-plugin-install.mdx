...
The following operating systems are available for installation via download. For other operating systems, proceed with [Compiled installation](#installcompile).
...
- **Red Hat & CentOS**  
  - https://repo.whatap.io/telegraf/telegraf-release-1.21.1/linux/amd64/telegraf (executable file)
...
## Compiled installation {#installcompile}
