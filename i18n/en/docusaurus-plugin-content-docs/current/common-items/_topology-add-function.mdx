...
Select <Cmdname sid="node_selection" className="uitext" />. On the right of the screen, you can see the projects, DB calls, and outbound call nodes that are grouped on a diagram.
...
In <Cmdname sid="side_groupStatTopology" className="uitext" />, the function is provided using the <Cmdname sid="node_selection" className="uitext" /><span class='uitext'>(</span><Cmdname sid="double_click" className="uitext" /><span class='uitext'>)</span> button on the lower right of the screen.
