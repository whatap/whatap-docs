...
When a session is selected in the session table list, you can see <Cmdname sid="session_detail" className="uitext" />. See [Next document](usage-ui#checksessioninfo) for more information.
