...
<Xclude product='cubrid,mysql,oracle,postgresql,redis,tibero,altibase,mongodb,mssql,oracle-pro,oracle-v1'><ImgLang img='metrics-chart-widget-upper.png' desc=''/></Xclude>

<InDoc product='cubrid,mysql,oracle,postgresql,redis,tibero,altibase,mongodb,mssql,oracle-pro,oracle-v1'><ProdImg img='metrics-chart-widget-upper.png' desc=''/></InDoc>
