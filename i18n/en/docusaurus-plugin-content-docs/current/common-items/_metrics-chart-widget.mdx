...
<Xclude product='cubrid,mysql,oracle,postgresql,redis,tibero,altibase,mongodb,mssql'>

<ImgLang img='metrics-chart-widget-upper.png' desc=''/>

</Xclude>

<InDoc product='cubrid,mysql,oracle,postgresql,redis,tibero,altibase,mongodb,mssql'>
