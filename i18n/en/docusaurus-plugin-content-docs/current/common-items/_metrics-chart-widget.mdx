...
<Xclude product='cubrid,mysql,mysql-v1,oracle,postgresql,postgresql-v1,redis,tibero'>

<ImgLang img='metrics-chart-widget-upper.png' desc=''/>

</Xclude>

<InDoc product='cubrid,mysql,mysql-v1,oracle,postgresql,postgresql-v1,redis,tibero'>
