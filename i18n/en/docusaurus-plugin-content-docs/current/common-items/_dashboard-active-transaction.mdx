...
- If a transaction has already ended, the <Cmdname sid="show_trace" className="uitext" /> button appears. When you select the button, the <Cmdname sid="TTL06527" className="uitext" /> window appears. For more information about <Cmdname sid="TTL06527" className="uitext" />, see [the following](dashboard-hitmap-trace#basic-usage).
