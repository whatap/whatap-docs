...
whatap.app_context_enabled=true
```
...
whatap.app_context_parser=default

# Reset parser's internal cache/settings
whatap.app_context_parser_reset=0

# Depth of path segment to extract
whatap.app_context_path_depth=1

# Mapping of names to monitored paths (comma-separated)
whatap.app_context_path_set=name1@url1,name2@url2,url3,name4@url4
```
