...
- **trace_tx_name_with_method_enabled** <span class='type'>Boolean</span>
  ...
  Statistical data can be collected using URL+method where the URL has been changed. You can check with URL+method in <Cmdname sid="side_statistics" className="uitext" /> or <Cmdname sid="side_txSearch" className="uitext" />.
