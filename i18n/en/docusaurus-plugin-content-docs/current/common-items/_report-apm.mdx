...
-   **Visitor**(**DAU**, Daily Active User)<br/>
...
-   **Error Rate**<br/>
    Rate of the number of errors divided by the number of transactions.
...
-   **APDEX\*100** (Application Performance Index) <br/>
    Customer performance satisfaction on the application during the query period.

-   **Throughput**(TPS, Transactions Per Second)<br/>
    It indicates the number of transactions processed per second and is the criterion for service performance metrics.
...
Based on the steps on the stack trace, you can view simplified data calculated as call frequency rates between steps. In **_Analysis_** > **_Stack_** > **_Top Stack_**, you can see the stack details.
...
-   Example<br/>
    `4/25 00:00` to `23:59` data inquiry → comparison with `4/22 00:00` to `4/24 23:59` data<br/>
...
-   **Weekly Active User**<br/>
    Number of users logged on for the week

-   **Weekly Transaction Count**<br/>
    Numbers of processed requests and responses returned for the week  
...
-   **Inc/Dec Time**<br/>
    The figure is used to compare the response times between the week and the previous week of inquiry, and the rate is a percentage.

### Top 10 top stacks

![](https://img.whatap.io/media/images/app_weekly_report_07.png)

This is the rate of call frequency between steps based on the steps on the stack trace.
You can compare data for the previous week and the data for the week of inquiry for that stack.

-   **Inc/Dec**<br/>
    The figure is used to compare the stack call counts between the week and the previous week of inquiry, and the rate is a percentage.
...
-   **Monthly Transaction Count**<br/>
    Total number of transactions received for the month.

-   **Monthly User Count**(**MAU**, Monthly Active User)<br/>
    Number of users who accessed during the selected query period.
...
-   **Daily Transaction Count**<br/>
    This graph displays the number of incoming transactions for the day.

-   **Transaction Count per Hour**<br/>
    This graph displays the numbers of incoming transactions for each hour.

-   **Error Count per Hour**<br/>
    This graph displays the numbers of incoming transaction errors per hour by date.

-   **Active Transaction**<br/>
    This graph displays the numbers of incoming active transactions per hour by date.

-   **Throughput**<br/>
    This graph displays the transaction throughput per second calculated every hour by date.

-   **Average Response Time per Hour**<br/>
    This graph displays the average response times of incoming transactions per hour by date.

-   **Heap Use**<br/>
    This graph displays the used Java heap memory amount per hour by date.

-   **CPU SYS Utilization**<br/>
    This graph displays the CPU SYS usage % for the day by date.

-   **Process CPU Utilization**<br/>
...
-   **Transaction Count**<br/>
    It indicates the number of responses returned by the application after processing. It becomes a metric to see which service (URL) was most active during the week.
...
This is the rate of call frequency between steps based on the steps on the stack trace. You can compare the data between the previous month and the month of inquiry for the stack.

-   **Inc/Dec**<br/>
    The figure is used to compare the stack call counts between the month and the previous month of inquiry, and the rate is a percentage.
