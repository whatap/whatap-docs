...
<Cmdname sid="A001_AppDailyReport" className="uitext" /> displays the application performance records for the day with figures and charts. You can search by setting the start date, start time, and end time.
...
<ImgLang img='app_daily_report_06.png' desc='' />

Based on the steps on the stack trace, you can view simplified data calculated as call frequency rates between steps. In <Cmdname sid="side_analysis" className="uitext" /> > <Cmdname sid="side_stack" className="uitext" /> > <Cmdname sid="topstack" className="uitext" />, you can see the stack details.

### Top 10 SQL average response times

<ImgLang img='app_daily_report_07.png' desc='' />

It is the statistical data sorted by the average response time for SQL queries during the query period. In <Cmdname sid="side_statistics" className="uitext" /> > <Cmdname sid="side_statSql" className="uitext" />, you can see the times and performances for each query in detail.
...
For detailed information for each transaction, you can see in <Cmdname sid="side_statistics" className="uitext" /> > <Cmdname sid="side_tx" className="uitext" />.
