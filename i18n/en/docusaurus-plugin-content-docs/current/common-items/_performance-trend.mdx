Home > Select Project > **_Analysis_** > **_Perf. trend_**

Select a project in the initial screen of the WhaTap monitoring service, and then select **_Analysis_** > **_Perf. trend_** under **_Project Menu_**. You can check the **_Perf. trend_** menu for several performance metrics within the specific time range to search. 

![Performance Trend sc](/img/performance-trend.png)
...
### ![number 2](/img/number-02.png) Perf. trend Chart
