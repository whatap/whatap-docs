...
<InDoc product='log,postgresql,mysql,oracle-v2,oracle-pro'>
...
<InDoc product='postgresql,mysql,oracle-v2,oracle-pro'>

<ImgLang img='log-getting-started-db.png' desc='Start Log Monitoring'/>

</InDoc>

<Xclude product='postgresql,mysql,oracle-v2,oracle-pro'>
...
You can specify the log data retention periods for each category. **Log Count** means the log lines stacked for the period. For example, <Cmdname sid="daily_log_count" className="uitext" /> is the number of log lines accumulated during the day, and <Cmdname sid="expected_log_count" className="uitext" /> is the number of log lines of the today's log count multiplied by the days of data retention. 
...
3. In the <Cmdname sid="category" className="uitext" /> selection window, select a category or enter it.

4. Select a <Cmdname sid="ITM06429" className="uitext" /> and <Cmdname sid="ITM06430" className="uitext" /> for the <Cmdname sid="ITM06439" className="uitext" /> or directly enter them.
...
5. Enter the <Cmdname sid="pattern" className="uitext" />.

6. To check whether the pattern is normal, click <Cmdname sid="simulation" className="uitext" /> and then measure the performance of simulation and pattern.

   For more information about the simulation and performance measurement, see [the following](#parser-simulation).

7. If the simulation result is normal, select <Cmdname sid="add" className="uitext" /> and then register the parser.
...
1. Enter a pattern in the parser addition screen, and then select <Cmdname sid="simulation" className="uitext" />. The <Cmdname sid="parser" className="uitext" /> <Cmdname sid="simulation" className="uitext" /> window appears. 

2. Enter the <Cmdname sid="log" className="uitext" /> in the <Cmdname sid="parser" className="uitext" /> <Cmdname sid="simulation" className="uitext" /> window.

3. Check the entered <Cmdname sid="log" className="uitext" /> and <Cmdname sid="pattern" className="uitext" />.

<ImgLang img='log-parser-simulation.png' desc='Parser simulation'/>

1. Select <Cmdname sid="simulation" className="uitext" /> and then check whether parsing is successful with the pattern to register.
...
2. When you click <Cmdname sid="apply_pattern" className="uitext" />, the pattern that has been entered for the selected parser is applied.
...
4. Select <Cmdname sid="ITM06439" className="uitext" /> or enter it.

5. Enter the <Cmdname sid="ITM06255" className="uitext" />.
