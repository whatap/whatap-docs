...
<ImgLang img='log-1st-parser-list.png' desc='Log Parser List'/>
...
<ImgLang img='log-1st-grok.png' desc='GROK Pattern Parser'/>
...
1.  Select **_Simulation_** and then check whether parsing is successful with the pattern to register. 
    ...
    -   **Simulation Failure Screen**
        ...
        <ImgLang img='log-simulation-fail.png' desc='Simulation Failure Screen'/>
...
<ImgLang img='log-2nd-parser-add.png' desc='Parser registration order'/>
