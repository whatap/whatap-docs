...
Looking at the **_app_counter_** sample data, you can see that tags and fields have been collected from both agents (-1012315416, 1664920292) at the same time (2021-11-17 13:57:15).
...
The metric chart screen example displays the metric (inddo) collected from the monitoring targets at the selected time as a chart. At this time, the collection server uses the "**_app_counter_** category metric, which has the selected metric value (TPS) as a field.
