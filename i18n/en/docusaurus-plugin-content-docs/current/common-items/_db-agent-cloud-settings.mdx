...
| `accessKey`             | Access key for API calls to Naver Cloud<br />- Note. [How to Create an Access Key and Secret Key](/postgresql/agent-cloud-settings#access-key--secret-key-발급-방법)                                                                                                                                            |
