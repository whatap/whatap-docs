...
In **_Live Tail_**, complex logs can be easily accessed. You can search the logs in real time by using the functions such as **_Filter_** or **_Highlight_**, if necessary. The log data search cycle is 2 seconds. <Loguimainterm />
