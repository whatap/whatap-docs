...
<ImgLang img='log-content-search.png' desc='Application of non-parsing keyword filters'/>
...
-   In case of **_Live Tail_**, all logs can be viewed. Thus, the category is not required to be set.
