...
In the following image, the blue boxed part is the search key for parsing. The search key can be set by registering the parsing logic in **_Log Parser Setting_** under **_Log_** > **_Setting_**.
