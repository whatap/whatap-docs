...
When the **_Disabled Database Alert_** option is enabled, if the agent fails to receive data during the set time period, the **_INACTIVE MONITORING AGENT_** alert appears.
