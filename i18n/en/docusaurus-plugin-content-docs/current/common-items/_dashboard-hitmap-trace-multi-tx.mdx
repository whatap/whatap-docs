...
To trace multi-transactions, set the `mtrace_enabled` option to `true` in **_Management_** > **_Agent Settings_**. For more information about the agent configuration, see [the following](../java/set-agent#set-agent-service).
