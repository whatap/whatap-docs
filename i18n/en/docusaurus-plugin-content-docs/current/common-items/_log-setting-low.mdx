...
2.  Specify the **_category_** and **_key_** for data search and then select **_Apply_**.\
...
3.  With the added settings, you can check the **_long-term archive statistical data_** as follows:\
