...
![4XX 5XX Status Code Parser](https://img.whatap.io/22/11/28/085706log_020_status_parser.png)<br/>
...
-   **status parser registration example**<br/>
...
1.  In **_Widget Templates_** of **_Flex Board_**, search for **_Log long-term archive statistics_** to create a widget.<br/>
    ![Long-term Archive Statistics Widget Templates](https://img.whatap.io/22/11/28/090932log_024_long_period_widget_template.png)
2.  Specify the **_category_** and **_key_** for data search and then select **_Apply_**.<br/>
...
3.  With the added settings, you can check the **_long-term archive statistical data_** as follows:<br/>
