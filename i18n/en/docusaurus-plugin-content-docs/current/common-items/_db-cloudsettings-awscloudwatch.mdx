...
<Xclude product="oracle"><ImgLang img="db-cloudsettings-select-service.png" desc="Select service" /></Xclude>

<InDoc product="oracle"><ImgLang img="db-cloudsettings-select-service-oracle.png" desc="Select service" /></InDoc>
