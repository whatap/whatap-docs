...
-   \*_php config file
      Set the full path of php.ini installed on the server (_/etc/php.ini\*). Proceed with the configuration of the PHP extension.

-   \*_php cli
      Using the executable command on the command line in the PHP command's full path (_/usr/bin/php\*), you can check the basic PHP environment.
