...
- **_Default (RAC)_**: If you are using Oracle Real Application Cluster (RAC), this preset allows you to check metrics based on the instances running on the RAC database.
