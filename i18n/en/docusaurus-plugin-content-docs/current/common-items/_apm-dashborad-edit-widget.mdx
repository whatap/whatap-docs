...
<InDoc product="postgresql,mysql,redis,mongodb,oracle-pro,oracle,altibase,cubrid,mssql"><ImgLang img="db-dashboard-widget-add.png" desc="Adding a widget" /></InDoc>
...
- In addition to the metrics provided by default on the dashboard, you can add the desired metrics. For more information about custom widgets, see [the following](#customwidget).
