...
<InDoc product="postgresql,mysql,redis,mongodb,oracle-pro,oracle,altibase,cubrid,mssql,db2"><ImgLang img="db-dashboard-widget-add.png" desc="Add Widget" /></InDoc>
