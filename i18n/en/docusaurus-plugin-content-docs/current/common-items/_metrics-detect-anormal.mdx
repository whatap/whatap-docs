...
![Metric Anomaly Detection](/img/metrics-detect-abnormal.png)
...
![Metric Anomaly Detection](/img/metrics-detect-abnormal-set-widget.png)
...
![Metric Anomaly Detection](/img/metrics-detect-anormal-details.png)
