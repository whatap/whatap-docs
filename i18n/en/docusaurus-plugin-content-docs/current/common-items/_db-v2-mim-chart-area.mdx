...
You can see a desired chart by selecting one of **_XOS_**, **_RDS_**, and **_All_** tabs. If you select <span class='mark'>i</span>, the meaning of the metric appears through the tooltip.
