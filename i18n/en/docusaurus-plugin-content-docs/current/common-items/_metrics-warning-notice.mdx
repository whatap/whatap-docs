...
-   **_Network Jitter Alert_**
    ...
    When the average **jitter** exceeds 30/ms, the corresponding alert is sent.

-   **_Network Latency Warning_**

    When the average **latency** exceeds 200/ms, the corresponding alert is sent.

-   **_Data transfer warning_**

    When the network **bps** exceeds 128 Mib/s, the corresponding alert is sent.
