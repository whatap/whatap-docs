...
<ImgLang img='set-event-cmetric-test.png' desc='Test Event Rules' />
...
-   **_Jitter > 30ms_**
    ...
    When **jitter** exceeds 30/ms, the corresponding alert is sent.

-   **_Latency > 200ms_**

    When the **latency** exceeds 200/ms, the corresponding alert is sent.

-   **_Bps > 128 Mib/s_**

    When **bps** exceeds 128 Mib/s, the corresponding alert is sent.

-   **_Pps > 50k/s_**

    When **pps** exceeds 50 k/s, the corresponding alert is sent.

-   **_Sessions > 100_**

    When the unique session count exceeds 100, the corresponding alert is sent.
