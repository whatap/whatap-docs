...
-   **_Jitter > 30ms_**
    ...
    **jitter**가 30/ms를 초과하면 경고 알림을 보냅니다.

-   **_Latency > 200ms_**

    **latency**가 200/ms를 초과하면 경고 알림을 보냅니다.

-   **_Bps > 128 Mib/s_**

    **bps**가 128Mib/s를 초과하면 경고 알림을 보냅니다.

-   **_Pps > 50k/s_**

    **pps**가 50k/s를 초과하면 경고 알림을 보냅니다.

-   **_Sessions > 100_**

    고유 세션 수가 100을 넘어가면 경고 알림을 보냅니다.
