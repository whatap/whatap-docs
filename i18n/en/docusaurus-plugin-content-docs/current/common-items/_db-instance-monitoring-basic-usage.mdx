...
- ![number3](/img/number-03.png) **_Active Sessions_** | **_Lock Tree_** | **_Process Info_**
  ...
  * ***Active Sessions***
    ...
    You can view active sessions and queries. If you select an item in the rightmost ***query*** column in the table, the ***Show SQL*** window appears. You can see the full text and plan information for the selected query. For more information about the columns in the table, see [the following](#column-info).
...
- For more information about the columns, see [the following](#info-of-column).
