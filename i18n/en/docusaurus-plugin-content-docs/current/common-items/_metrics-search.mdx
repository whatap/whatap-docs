...
Home > Select Project > <Cmdname sid="metrics" className="uitext" /> > <Cmdname sid="tag_count" className="uitext" />

</InDoc>

<InDoc product="browser">

Home > Select Project > <Cmdname sid="laboratory" className="uitext" /> > <Cmdname sid="tag_count" className="uitext" />
