...
Application alerts provide both Event Title and Event Message. If the <Cmdname sid="resolved_event_notification" className="uitext" /> function is used and the event occurrence condition is released, the Event Off message is transmitted.
