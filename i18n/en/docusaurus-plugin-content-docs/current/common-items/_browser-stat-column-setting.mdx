...
You can hide table header columns or add desired items in <Cmdname sid="TTL08862" className="uitext" />. You can also change the column order. Select ![Column icon](/img/ic-column.svg) <Cmdname sid="BTN06441" className="uitext" />.

<ImgLang img="browser-resourceload-stat-setting-column.png" desc="Column setting" />
