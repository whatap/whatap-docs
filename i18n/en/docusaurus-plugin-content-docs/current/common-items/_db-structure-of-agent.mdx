...
<Xclude product='cubrid,oracle-pro'><ImgLang img='agent-xos-architecture.png' desc='Agent structure map' /></Xclude>

<InDoc product='cubrid'><ImgLang img='agent-xos-xcub-architecture.png' desc='Agent structure map' /></InDoc>
