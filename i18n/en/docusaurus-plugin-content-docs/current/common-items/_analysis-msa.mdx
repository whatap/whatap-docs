...
- The time range that can be searched in <Cmdname sid="time_selector" className="uitext" /> is up to 1 day (24 hours). For more information on how to use the <Cmdname sid="time_selector" className="uitext" /> option, see [the following](usage-ui#timeselector).
