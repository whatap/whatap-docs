...
The <Cmdname sid="side_eventSetting" className="uitext" />  menu allows you to set the events based on the field (**Field**) rather than the category (**Category**). By providing basic event templates for the products of the created project, you can quickly and easily configure the warning notification events.
...
See the following for a new way to configure events using the <Cmdname sid="side_eventSetting" className="uitext" />  menu.
