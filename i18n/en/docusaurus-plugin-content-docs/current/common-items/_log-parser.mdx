...
3. Enter values for <Cmdname sid="category" className="uitext" />, <Cmdname sid="ITM06439" className="uitext" />, and <Cmdname sid="pattern" className="uitext" />. The components of the <Cmdname sid="parser" className="uitext" /> <Cmdname sid="add" className="uitext" /> window are as follows:
...
4. Select <Cmdname sid="add" className="uitext" /> to register a parser.
...
- Before registering a parser, you can check whether the pattern to register is normal through <Cmdname sid="simulation" className="uitext" />. 
...
You can check the parsed result in advance by entering <Cmdname sid="log" className="uitext" /> and <Cmdname sid="pattern" className="uitext" /> in the <Cmdname sid="parser" className="uitext" /> <Cmdname sid="simulation" className="uitext" /> window.
...
>
> <Cmdname sid="pattern" className="uitext" /> example: `[%{TIMESTAMP_ISO8601:date}\sGMT\][%{LOGLEVEL:level}\s\][%{DATA:caller}\]\s(?<projectCode>\d)\s(?<logCategory>\w*)\s(?<dexBuildStartTime>\d{8}\s\d{2}:\d{2}:\d{2}\.\d{3})\s\{area=(?<areaEnum>\d),\scity=(?<cityEnum>\d)\}\s(?<dexBuildElapsed>\d{2})ms`

1. In the <Cmdname sid="parser" className="uitext" /> <Cmdname sid="add" className="uitext" /> window, select <Cmdname sid="simulation" className="uitext" />.

2. In the <Cmdname sid="parser" className="uitext" /> <Cmdname sid="simulation" className="uitext" /> window, enter values for <Cmdname sid="log" className="uitext" /> and <Cmdname sid="pattern" className="uitext" />.

3. After entry <Cmdname sid="log" className="uitext" /> and <Cmdname sid="pattern" className="uitext" />, select <Cmdname sid="simulation" className="uitext" />. You can check the <Cmdname sid="simulation_result" className="uitext" /> as follows:
...
2. Select **_+_** <Cmdname sid="adding" className="uitext" /> and then select the **_JSON_** parser in the <Cmdname sid="parser" className="uitext" /> field.
...
3. Enter values for <Cmdname sid="category" className="uitext" />, <Cmdname sid="ITM06439" className="uitext" />, and <Cmdname sid="pattern" className="uitext" />. The components of the <Cmdname sid="parser" className="uitext" /> <Cmdname sid="add" className="uitext" /> window are as follows:
   ...
   - <Cmdname sid="pattern" className="uitext" />
     ...
     - Example of JSON pattern
       ...
       In the example log, if **_Prefix_** and **_Postfix_** are specified as `--` and `url` is specified in **_Ignore_**, only three <Cmdname sid="tag" className="uitext" /> (`host`, `method`, `status`) are created.
...
If the above sample log has been collected, select the **_JSON_** parser in the <Cmdname sid="parser" className="uitext" /> <Cmdname sid="add" className="uitext" /> window. Without having to write a complex parsing logic, you can extract the <Cmdname sid="tag" className="uitext" /> for log analysis as follows:
