...
- **Supporting multiple projects**
  ...
  In **_Integrated Report_**, you can easily select and create multiple projects at a time. Under the previous **_Report_** menu, the reports must be created for each project. 
...
1. **Selecting the report type**  
   ...
   {/* 프로젝트 플랫폼 아이콘 안내는 ~~다음 설명서~~를 참조하세요. _/}
   {/* 아이콘 안내 필요?? 디테일 써머리 인클루드, 노트, 혹은 페이지 링크 활용_/}
