...
2. If the <Cmdname sid="share_dashboard" className="uitext" /> window appears, select <LinkImage img="ico-add.svg" className="ico" /> <Cmdname sid="account" className="uitext" />.

   <ImgLang img="flexboard-share-02.png" desc="Flex board Shared" />

3. Select a member to share the dashboard.

   <ImgLang img="flexboard-share-06.png" desc="Flex board Shared" />

   - To add more members for sharing, select <LinkImage img="ico-add.svg" className="ico" /> <Cmdname sid="account" className="uitext" />. You can add any member.

   - You can share any dashboard with the members invited to one or more projects that are included in the dashboard. Check that the members to be shared or copied belong to the project.

4. Select <Cmdname sid="share_dashboard" className="uitext" />.
   ...
   - To share the dashboard with the members to be shared as read-only, select <Cmdname sid="ITM07634" className="uitext" />.
...
- Among the projects on the shared dashboard, you cannot view the data for the projects with no **Analysis view** role.
