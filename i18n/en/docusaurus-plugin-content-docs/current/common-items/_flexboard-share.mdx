...
1.  Select ![Share icon](/img/ico-flexboard-share.svg) of the dashboard you want to share from **_Dashboard list_** in **_Flex Board_**.
    ...
    ![Flex Board Sharing](/img/flexboard-share-01.png)

1.  If the **_Sharing a Dashboard_** window appears, select **_+ Account_**.

    ![Flex Board Sharing](/img/flexboard-share-02.png)

1.  Select a user account to share the dashboard.

    ![Flex Board Sharing](/img/flexboard-share-06.png)

    * Select ***+ Account*** to add any target. You can select additional user accounts.
    * The user accounts that can share the dashboard are the ones that belong to the selected project.
    * If you do not have **Edit role** for all projects in the dashboard, the `Read only` tag appears.

1.  Select **_Sharing a Dashboard_**. If you select **_Read Only_**, the shared users cannot edit the dashboard.

  ![Flex Board Sharing](/img/flexboard-share-03.png)
...
| -------------------------------------------------- | -------------------------------------------------- |
| ![Flex Board Sharing](/img/flexboard-share-04.png) | ![Flex Board Sharing](/img/flexboard-share-05.png) |
...
-   The dashboard sharing button is displayed only when the sharing conditions are met.
    ...
    ![Flex Board Sharing](/img/flexboard-sharable-list.png)
