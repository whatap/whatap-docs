...
- To set alerts for other accounts, you must have a permission of <Cmdname sid="edit" className="b600" />, <Cmdname sid="sms_alert_settings" className="b600" />, and <Cmdname sid="member_management" className="b600" />.
