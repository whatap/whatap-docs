...
- ![Number 2](/img/number-02.png) **Transaction classification**: By separating ![Active Stack icon](/img/ic-s-active-stack.svg) <Cmdname sid="active_stack" className="uitext" />, ![Multi-transaction icon](/img/ic-s-mult-transation.svg) <Cmdname sid="multi_transaction" className="uitext" />, and errors, you can view the list.
