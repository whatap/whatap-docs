...
| Application Name                                     | 에이전트 이름                  | All (optional)          | oname                                                                                                          |
| Event Message                                        | 이벤트 메시지               | All                     | -                                                                                                              |
...
| Event Rule                                           | 이벤트 규칙                  | Metrics Alert           | -                                                                                                              |
...
| Disk Name \| Used Percent \| Free Size \| IO Percent | 디스크 퍼포먼스            | Server Alert All        | Snapshot at the time of event                                                                                  |
| Name \| Bps \| Pps                                   | 트래픽 퍼포먼스         | Server Alert All        | Snapshot at the time of event                                                                                  |
| Message \| Time \| Name                              | 처리내역 메시지         | Server Alert All        | -                                                                                                              |
