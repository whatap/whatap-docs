...
<<<<<<< HEAD
3. If the PHP extension module has not been applied, it indicates abnormal installation. Check whether the path of _whatap.so_ or *whatap.ini* meets the PHP environment.
=======
3. If the PHP extension module has not been applied, it indicates abnormal installation. Check whether the path of *whatap.so* or _whatap.ini_ meets the PHP environment.
