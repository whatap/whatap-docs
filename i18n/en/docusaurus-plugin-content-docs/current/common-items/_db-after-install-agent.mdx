...
![Agent Architecture](https://img.whatap.io/media/agent_oracle/install/agent_architecture.png)
...
-   **Additional agent (XOS agent)**
    ...
    ![XOS Agent Architecture](https://img.whatap.io/media/agent_oracle/install/agent_xos_architecture.png)
