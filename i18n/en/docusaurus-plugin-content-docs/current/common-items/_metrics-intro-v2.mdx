...
<ImgLang img='metrics-views.png' desc='Metrics View'/>

</Xclude>

<InDoc product='browser'>

WhaTap provides a list of original data collected according to the conditions specified by user and various charts visualized for convenience as follows. See the menus such as **_Metrics Search_** that can look up the original data of metrics and **_Metrics Chart_** that can look up metrics data through visualized charts.
