...
For example, to monitor **_Node.js applications_**, you need to install the WhaTap agent first. See [the following](../nodejs/install-agent). For more information about the related metrics, see the [product-specific page](../hodejs/metrics-app).
