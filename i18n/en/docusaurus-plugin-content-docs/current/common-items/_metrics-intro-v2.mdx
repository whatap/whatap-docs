...
For example, to monitor **_Golang applications_**, you need to install the WhaTap agent first. See [the following](install-agent). For more information about the related metrics, see the [product-specific page](metrics-app).
