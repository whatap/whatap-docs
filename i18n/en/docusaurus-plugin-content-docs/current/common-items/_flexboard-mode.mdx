...
The created Flex board can be registered as a favorite under **_Dashboard_**. In **_Dashboard_** > **_Flex Board_**, select ![Favorite icon](/img/ico-favorite.svg) from the **_Dashboard list_** list. The item set as a favorite is changed to ![Favorite setting icon](/img/ico-favorite-check.svg).
