...
-   **Application Monitoring**\
       Under **_Apply_**, check the guides for each application. See the following guides: [Java](log-java), [PHP](log-php), [Python](log-python), [Go](log-go).

-   **Server Monitoring**\
       Under **_Apply_**, check the guides for each application. See [the following](log-server). According to the instructions, add the settings for the log monitoring target file in _whatap.conf_.

-   **Kubernetes Monitoring**\
       Under **_Apply_**, check the guides for each application. See [the following](log-k8s). 
...
4.  **Status Code Success Rate Parser** 
    <!-- It provides 2 types of parsers: **Grok** and **JSON format parser**. In the parser selection window of ![number-s](/img/number-04.png), you can see the results. -->
