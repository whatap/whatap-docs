...
![Record summary](/img/tx-trace-dt-up.png)
...
![Display Detail of Multi-transaction](/img/multi-tx-additional-info.png)

### Table{#trace-multi-tx-table}

If you select the **_Table_** button, you can see the data for each transaction included in multi-transactions in a table. Select the ![Column Icon](/img/ic-column.svg) **_Column settings_** icon to edit the column in the table. 

![Multi-transaction table mode](/img/multi-tx-table-mode.png)
...
![Multi-transaction tree mode](/img/multi-tx-tree-mode.png)
