...
-   **Message step** <span class='type'>ADD</span><br/>
      While collecting transaction traces, the message steps are used to collect the records of all irregular sections.  

-   **SOCKET step**<span class='type'>ADD</span><br/>
      Step to represent the socket open.

-   **METHOD step**<span class='type'>START-END</span><br/>
      The method response time is traced.

-   **ACTIVE STACK step**<span class='type'>START-END</span><br/>
