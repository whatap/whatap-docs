...
| <Cmdname sid="TTL06959" /> (ms)    | Average of the total HTTP call time                  |
| <Cmdname sid="TTL06097" />         | SQL execution count                                  |
| <Cmdname sid="TTL06956" /> (ms)    | Average SQL execution time                           |
| <Cmdname sid="sqlFetch" />         | SQL Fetch Count                                      |
| <Cmdname sid="TTL06953" /> (ms)    | Average of the total SQL patch time                  |
...
- If there are a lot of selected transactions, the loading time may increase.
