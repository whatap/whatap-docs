...
- **whatap.profile_step_heavy_time** <span class='type'>Millisecond</span> {/* 문장 부자연스러움 _/}
...
- **whatap.profile_internal_method_time** <span class='type'>Milliseconds</span> {/* 두 개가 어떻게 다른지? 0309 수정완_/}
