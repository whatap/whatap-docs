After installing the WhaTap agent, log in [WhaTap Monitoring Service](https://service.whatap.io). The initial screen is **_Project list _**. In **_Project list _**, you can see the installed project. If a project is selected from the **_project list_**, you can enter **_[Instance List](instance-list)_**.
