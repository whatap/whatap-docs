...
The filter **_favorites_** feature is provided. You can select the ![Favorites icon](/img/ic-star.svg) **_Favorites_** icon on the right of the input window to **_add_**, **_delete_**, and select desired filter search conditions in the favorites. **_Favorites_** can store up to 50 cases. 
