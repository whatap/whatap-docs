...
<ImgLang img='project-01.png' desc='Create project'/>
...
For more information about the project hierarchical structure, see [the following](project-structure).
...
<ImgLang img='project-member-list.png' desc='Checking the project members'/>
