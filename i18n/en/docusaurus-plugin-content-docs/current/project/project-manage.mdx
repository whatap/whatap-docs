...
- If you invite an account that has not signed up for the WhaTab monitoring service, the name appears as <Cmdname sid="pending_invitation" className="uitext" /> until the invitee signs up. To resend the invitation email, select **_Reinvite_**.
