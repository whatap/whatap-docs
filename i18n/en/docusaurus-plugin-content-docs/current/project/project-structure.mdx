...
| Project flexboard update | **_Flex Board_** editing of the project                            |
...
It is the role to edit the dashboards in the project's **_Flex Board_** menu. In **_Flex Board_** under the project, you can access to **_Edit Mode_**, **_Admin_** Mode, and **_Filtering_**.
