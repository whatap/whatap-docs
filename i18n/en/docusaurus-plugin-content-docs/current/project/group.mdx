...
1.  On the upper right of a project entry in the **_Project list_** of Home screen, select ![Configuration icon](/img/ico-setting.svg). 
  ...
  ![Project configuration](/img/project-add-group.png)

1.  Select **_Add to Group_**.

2.  Select a group to add a project in.

3.  Select **_Add to Group_**.
...
![Project Group Selection](/img/project-select-group.png)
...
1.  On the upper right of a project entry in the **_Project list_** of Home screen, select ![Configuration icon](/img/ico-setting.svg). 
  ...
  ![Deletion from group](/img/remove-project-from-group.png)

1.  Select **_Delete from Group_**.

2.  If the **_Remove project from group_** window appears, click **_OK_**.
...
![Checking Project Member](/img/group-memer-by-project.png)
