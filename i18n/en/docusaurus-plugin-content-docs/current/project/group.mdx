...
1.  On the upper right of a project entry in the **_Project list_** of Home screen, select ![Configuration icon](/img/ico-setting.svg). 
  ...
  <ImgLang img='project-add-group.png' desc='Project configuration' />
...
<ImgLang img='project-select-group.png' desc='Project Group Selection' />
...
1.  On the upper right of a project entry in the **_Project list_** of Home screen, select ![Configuration icon](/img/ico-setting.svg). 
    ...
    <ImgLang img='remove-project-from-group.png' desc='Deletion from group' />
...
<ImgLang img='group-memer-by-project.png' desc='Checking Project Member' />
