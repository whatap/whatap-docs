...
To apply settings tailored to each environment of the application, you can modify the settings in the entry point file of the application instead of the _whatap.conf_ file. Noting the code below, apply the settings tailored to your environment.
