...
-   **net_send_queue1_size** <span class='type'>Int</span><br/>
    Default `512`<br/>It sets the size of the queue to be used for data transmission except for trace data.

-   **net_send_queue2_size** <span class='type'>Int</span><br/>
    Default `1024`<br/>It sets the size of the queue to be used for trace data transmission.
