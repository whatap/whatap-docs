...
5. In the <Cmdname sid="register_billing_info" className="uitext" /> window, specify the payment information.

6. Select a payment method and then fill in the relevant information for <Cmdname sid="creditcard" className="uitext" />Regular payment or tax<Cmdname sid="payment_type_banktransfer" className="uitext" />.

7. Specify the <Cmdname sid="billing_reception_info" className="uitext" />.

8. Select <Cmdname sid="registration" className="uitext" />.
