...
After registration of the payment information, the <Cmdname sid="project_subscription" className="uitext" /> menu appears. You can see the entire <Cmdname sid="project_list" className="uitext" /> owned by the account as follows: 
...
-   For more information about <Cmdname sid="project_subscription" className="uitext" />, see <Link to="management/billing#project-subscription">the following</Link>.
