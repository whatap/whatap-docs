...
### Top 10 ANR Elapsed Time by Screen (Bar Chart)
...
### Top 10 ANR Occurrences by Screen (Bar Chart)

- Displays the top 10 screens with the highest ANR frequency  
- **Display**: Total number of ANRs per screen  
- **Use**: Identify priority screens with frequent ANRs  
