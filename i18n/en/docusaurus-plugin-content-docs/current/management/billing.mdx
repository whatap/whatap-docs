...
5. If the <Cmdname sid="register_billing_info" className="uitext" /> window appears, first select a country.

6. Enter the company or corporation name.

7. Check the values for <Cmdname sid="phone" className="uitext" /> and <Cmdname sid="TTL06768" className="uitext" />, and then change them if necessary.

8. Enter the department name. It is optional.

9. Select <Cmdname sid="next" className="uitext" />.
...
<ImgLang img='billing-edit-mail-tax.png' desc='Modify e-tax billing account' />

To change the email address for receiving tax invoices, change the **_Payment method_** in payment information. 

From <Cmdname sid="payment_information" className="uitext" />, select <LinkImage img="ico-edit.svg" className='ico' /> <Cmdname sid="edit" className="uitext" /> on the right of the payment method. When the <Cmdname sid="billing_info_edit" className="uitext" /> window appears, change the ***Electronic Tax Invoice Email*** and then select <Cmdname sid="registration" className="uitext" />.
