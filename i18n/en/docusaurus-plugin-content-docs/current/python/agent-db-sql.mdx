...
-   **stat_sql_max_count** <span class='type'>Int</span>
    ...
    The number of SQL statistics is limited. It limits the maximum number of records for statistics collected for 5 minutes that are delivered to the server.
