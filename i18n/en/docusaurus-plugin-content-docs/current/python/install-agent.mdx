...
The _whatap.conf_ file is created and set in the path specified in `$WHATAP_HOME`. Execute the following command to check whether the _whatap.conf_ file has been created.
