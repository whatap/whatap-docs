...
-   **whatap.profile_sql_param_enabled**Boolean\*_<span class='type'>Boolean</span><br/>
        Default `false`<br/>
    ...
    :::note
    Specify the security key to a 6-letter value in the WAS server's _/usr/whatap/php/paramkey.txt_ file. If _paramkey.txt\* does not exist, it is automatically created as random values.
    :::
