...
It explains how to configure metric alerts by product and project.

### [Database alert configuration](best-practice-guides/set-db-metric-warning-notice)

The methods are explained how to configure metric path alerts based on the key metrics in the database in the following order.
