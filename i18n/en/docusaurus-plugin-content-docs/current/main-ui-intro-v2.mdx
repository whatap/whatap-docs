...
You can see ![Notification icon](/img/ico-noti.svg) at the top of the screen you enter by selecting a project. When you select this button, the <Cmdname sid="sms_alert_status" className="uitext" /> window appears on the right of the screen. You can see up to 100 alerts for the last 24 hours of the project.

<ImgLang img="ui-home/main-ui-realtime-notification.png" desc="Alert status" />

- You can turn on or off the browser notifications by selecting the toggle button.

- To clear the notification list, select ![Delete icon](/img/ico-trash.svg). The task takes 30 to 60 seconds to complete.

- ![Setting icon](/img/ico-setting.svg) <Cmdname sid="sms_alert_settings" className="uitext" />

  - To turn the notification sound on or off, select the notification icon for <Cmdname sid="critical" className="uitext" /> or <Cmdname sid="warn" className="uitext" />.

  - To check a notification sound in your browser, select <Cmdname sid="alert_ativate_sound" className="uitext" />.
