...
![Network Trend (TCP)](/img/npm-dashboard-network-trend.png)
...
![Session information table](/img/npm-network-trend-sessions.png)

It displays the session data collected by agents in tabular format. Through the charts merged by section, you can identify macroscopic problems and use them to analyze the problems microscopically.
