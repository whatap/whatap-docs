...
:::note
To add, edit, and delete a maintenance plan, you need the `edit` permission on the project. For more information about member roles, see [the following](../project/project-structure#project-auth).
:::
...
-   f you select the maintenance plan banner at the top, the **_maintenance plan_** list appears. You can see a list of maintenance plans scheduled to run within an hour and maintenance plans in progress.
