...
4.  Select the region of the nearest data server.
5.  Select **_Time Zone_**. <br/>The default value is (GMT +9:00) Seoul, Tokyo, Yakutsk.
6.  Select **_Save_**.

:::note

-   The WhaTap monitoring project means a monitoring unit. For more information about **_project_**, see [the following](../project-manage).
