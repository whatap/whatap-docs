...
![Event History](/img/event-history-aws.png)
...
-   **_CSV_**: You can save the viewed event records as a CSV file. If **\*CSV** is clicked, enter the **_maximum CSV lines_** and then select **_Download_**.
