...
-   **_Alert Policy_**: Goes to the **_Event Configuration_** menu of the project where you can set the alert notification. For more information about **_Event Setting_**, see the following.
    ...
    -   Amazon ECS > [Alert Notification Setting and History](../amazon-ecs/warning-and-history)
    -   Amazon CloudWatch > [Alert Notification Setting and History](../amazon-cloudwatch/warning-and-history)
    -   Azure Monitor > [Alert Notification Setting and History](../azure/warning-and-history)
    -   Naver Cloud Monitoring > [Alert Notification Setting and History](../ncloud/warning-and-history)
    -   Oracle Cloud Monitor > [Alert Notification Setting and History](../oracle-cloud/warning-and-history)
