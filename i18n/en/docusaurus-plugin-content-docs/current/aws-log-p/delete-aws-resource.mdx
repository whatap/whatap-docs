...
![Deleting cloudformation resources](/img/aws-log-p/aws-log-cloudformation-resource.png)
...
![Deleting subscription filters](/img/aws-log-p/aws-log-delete-subscription-filter.png)
...
![Deleting event notifications](/img/aws-log-p/aws-log-delete-event-notification.png)
