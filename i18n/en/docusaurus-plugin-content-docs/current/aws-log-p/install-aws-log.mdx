...
![IAM Policy Creation sc](/img/aws-log-p/aws-log-create-policy.png)
...
1.  Select ![number2](/img/number-02.png) **_Next_** at the bottom.
...
![AWS CloudWatch Log Search and Subscription sc](/img/aws-log-p/aws-log-cloudwatch-subs.png)

1.  Select the ![number1](/img/number-01.png) **_AWS region_** where AWS Log has been installed. 
2.  Enter ![number2](/img/number-02.png) **_AWS IAM Role ARN_**.
...
5.  Copy **Whatap Forwarder ARN** from the [previous step](#whatapforwarder-arn) and paste to ![number5](/img/number-05.png).
6.  Select ![number6](/img/number-06.png) **_Register_**.
...
![AWS S3 Bucket Search and Subscription sc](/img/aws-log-p/aws-log-s3-subs.png)
...
![Starting the AWS Log Monitoring](/img/aws-log-p/aws-log-start.png)
