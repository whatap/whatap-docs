...
2.  On the upper right area, select <Link to='https://www.whatap.io/ko/signup/' target='_blank'><cmdname sid="freetrial" /></Link>.
3.  Enter your name, email address, password, and company name in order.
4.  Select <cmdname sid="sign_up" className="uitext" />.
