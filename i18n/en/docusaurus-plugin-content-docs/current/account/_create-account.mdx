...
STo receive alerts via SMS, log in the service and then select the profile icon > **_Manage Account INFO._** on the upper right of the screen. Go to the **_User Phone_** section and then enter your phone number.
