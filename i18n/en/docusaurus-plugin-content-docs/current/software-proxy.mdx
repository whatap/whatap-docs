...
You can download the proxy installation file from https://repo.whatap.io/agent_proxy/whatap_agent_proxy.zip.
After extracting the file, store it on a server that can communicate with the WhaTap collection server.
