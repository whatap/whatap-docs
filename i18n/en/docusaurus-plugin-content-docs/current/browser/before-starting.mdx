...
For example, the URL path such as _/v2/project/sms/_`12`_/dashboard/resource_board_ is provided in the form of _/v2/project/sms/_`?`_/dashboard/resource_board_.
