...
<ImgLang img='rum-lcp.png' desc='Average Largest Content Rendering Time' />
...
<ImgLang img='rum-pageload-fid.png' desc='Average Largest Input Response Time' />
...
<ImgLang img='rum-pageload-cls.png' desc='Average Cumulative Layout Shift' />
...
<ImgLang img='rum-pageload-timing.png' desc='Avg Page Load Time, Page Load Count' />
...
<ImgLang img='rum-pageload-router.png' desc='Avg Router Change Time, Router Change Count' />
...
<ImgLang img='rum-pageload-timing-table.png' desc='Page Load Timing Table' />
