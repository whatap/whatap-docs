...
Drag the chart area of the ![Leader line 1](/img/number-01.png) **_Page Load Hitmap_** widget. The page load event list of the dragged area is loaded to ![Leader line 2](/img/number-02.png) **_Page List_** at the bottom of the screen. In ![Leader line 3](/img/number-03.png) **_Page URL Search_**, the desired page list can be searched.
...
### ![](/img/number-03.png) Page URL Search

You can search the desired page load list based on the **_page URL item_**.
