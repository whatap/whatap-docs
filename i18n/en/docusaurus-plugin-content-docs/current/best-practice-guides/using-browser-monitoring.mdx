...
This guide explains how to quickly identify and respond to problems in your web applications that use the browser monitoring service. Browser 모니터링에 대한 기본 안내 문서는 [다음 문서](../browser)를 참조하세요.
...
![Resource List](/img/rum-pageload-event-04.png)
...
-   **Checking the page loading time and load count by browser**

    ![Pageload by browsers](/img/learn-browser-page-load.png)

    It provides the page load times and page load counts per browser for browser applications. This makes it easy to compare the page load performances for each browser.
