...
After activating ***Port*** in the WhaTab server Monitoring event template, set the monitoring target endpoint and TCP port through the following script. 
...
By enabling various features of the WhaTap server monitoring, you can quickly understand and respond to the network and server issues of the operating system. WhaTab can help you ensure business continuity and maximize the stability of the services.
