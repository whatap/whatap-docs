...
- To completely avoid incurring costs, go to Naver Cloud Account Management > Authentication Key Management, and then disable **API Authentication Key Management**.
