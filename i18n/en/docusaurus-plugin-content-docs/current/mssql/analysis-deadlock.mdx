...
The query time can be set up to 3 weeks. Select the clock display area to query a random date and time. If you click the text range for date and time, the option appears to select the date and time.
