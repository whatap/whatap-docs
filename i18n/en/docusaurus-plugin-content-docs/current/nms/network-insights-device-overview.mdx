...
The number of active interfaces is displayed as **Connected** / **Total Interfaces**, allowing you to check how many interfaces are active. When hovering over a device, status information is displayed. Clicking the device takes you to <Cmdname sid="side_usageStatus" className="uitext" />.  

* Example: `8 / 22` → 8 active out of 22 total

:::note
Interface information requires collecting SNMP ifTable (1.3.6.1.2.1.2.2) and ifXTable (1.3.6.1.2.1.31.1.1) data. Support may vary by device.
:::
