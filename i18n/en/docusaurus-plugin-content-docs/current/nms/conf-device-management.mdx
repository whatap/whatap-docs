...
description: It guides you to the device management menu.
keywords:
  - NMS
  - Configuration
  - Device management
...
Home &gt; Select Project &gt; <Cmdname sid="side_setting" className="uitext" /> &gt; <Cmdname sid="side_deviceManagement" className="uitext" />

In <Cmdname sid="side_deviceManagement" className="uitext" />, the devices to monitor are registered and managed to activate the network management system.
