...
description: Complete the additional settings for JVM options in Java 1.6 or earlier.
tags:
  - Java
---

You can apply the WhaTap agent on Java 1.6 or earlier. However, some functions are limited.
...
Create _boot.jar_ by using the _setup.sh_ file.\
If [JAVA_HOME] is not entered, it automatically recognizes the current path as the location of JDK.
