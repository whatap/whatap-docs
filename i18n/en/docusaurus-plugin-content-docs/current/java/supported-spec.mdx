...
### Supported Versions
  ...
  <thead>
  <tr>
  <th>Category / JDK Version</th>
  <th>JDK 1.5 or earlier</th>
  <th>Java 6 ~ 21</th>
  <th>Java 22</th>
  <th>Java 23</th>
  <th>Java 24</th>
...
### Application Server
  ...
  Supports all application servers that comply with Java EE Spec. See [this link](https://www.oracle.com/technetwork/java/javaee/overview/compatibility-jsp-136984.html) for details.
