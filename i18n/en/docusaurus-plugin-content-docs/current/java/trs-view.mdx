...
Agent settings can be configured by editing the _whatap.conf_ file or using <Cmdname sid="management" className="uitext" /> &gt; <Cmdname sid="agent_configuration" className="uitext" />. For more information, see [the following](set-agent).
