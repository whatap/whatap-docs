...
| ------------------------------- | :----------: | :---------: | :---------------------------------------------------------------------------: |
| Red Hat / CentOS / Amazon linux |    x86 x64   |     RPM     | [Download](http://repo.whatap.io/centos/6/x86_64/whatap-php-2.6-2.x86_64.rpm) |
| Ubuntu 12 and above / Debian    |     amd64    |     DEB     |  [Download](http://repo.whatap.io/debian/unstable/whatap-php_2.6.2_amd64.deb) |
| Freebsd 10 or later             |    x86 x64   |     TXZ     |       [Download](http://repo.whatap.io/freebsd/10/whatap-php-2.6.2.txz)       |
| Alpine linux                    |    x86 x64   |   tar gzip  |    [Download](http://repo.whatap.io/alpine/x86_64/whatap-php-2.6.2.tar.gz)    |
