...
- **active_stack_enabled** <span class='type'>Boolean</span>
  ...
  It enables the active stack tracing. They are <Cmdname sid="topstack" className="uitext" />, <Cmdname sid="uniquestack" className="uitext" />, and <Cmdname sid="activestack" className="uitext" /> in the <Cmdname sid="side_analysis" className="uitext" /> &gt; <Cmdname sid="side_stack" className="uitext" /> menu.
