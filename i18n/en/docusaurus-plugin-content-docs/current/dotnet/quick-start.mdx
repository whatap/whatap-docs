...
1. Download and install the agent for debugging from the following link.

   - [Agent for debugging](https://whatap-dotnet.s3.ap-northeast-2.amazonaws.com/whatap_dotnet_debug.exe)

2. Download and run the monitoring program (*UdpMonitor.exe*) from the following link. 
...
1. Download the *GetNamesapces.exe* file from the following link. 
   ...
   - <https://repo.whatap.io/windows/GetNamesapces.exe>
