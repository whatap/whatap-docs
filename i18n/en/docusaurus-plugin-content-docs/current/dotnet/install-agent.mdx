...
2.  According to the on-screen instructions, enter the access key in **_License Key_** and the IP address in **_WhaTap IP_**.<br/>On the project creation screen of the WhaTap monitoring service, you can copy the **_access key_** and **_WhaTap IP_** values.
