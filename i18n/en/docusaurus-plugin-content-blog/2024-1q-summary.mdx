...
<ImgLang img='release/release-main-ui.png' desc='Reorganize side menu cl quarterly example' />
...
![Event v2 cl branch example](/img/changelog/changelog-common-event-v2.png)
...
<ImgLang img='browser-search-user-session-log-analysis.png' desc='User session anlaysis quarterly example' className='changelog-img'/>
...
![Log agent option cl branch example](/img/log-agent-option-level.png)
