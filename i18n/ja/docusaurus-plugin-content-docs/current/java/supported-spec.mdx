...
### サポートバージョン
  ...
  <tr>
  <td>サポート範囲</td>
  <td align="center">限定サポート</td>
  <td align="center" colspan="2">完全サポート</td>
  </tr>
  </tbody>
  </table>
...
### アプリケーションサーバー
  ...
  Java EE Specに準拠するすべてのアプリケーションサーバーをサポートします。詳細は[こちらのリンク](https://www.oracle.com/technetwork/java/javaee/overview/compatibility-jsp-136984.html)を参照してください。

  :::

### フレームワーク / ライブラリ

  | カテゴリー           | フレームワーク    | サポートバージョン |
  | -------------------- | ----------------- | ------------------ |
  | Webフレームワーク    | Spring Boot       | 1.5.x ~ 3.x        |
  | 非同期フレームワーク | Netty             | -                  |
  | ^                    | Akka HTTP         | -                  |
  | ^                    | Play Framework    | -                  |
  | マイクロサービス     | Quarkus           | -                  |
  | ^                    | Quarkus Reactive  | 1.x ~ 2.x          |
  | 統合フレームワーク   | Mule Framework    | 3.9.5, 4.5         |

  :::note

  Java EE Specに準拠するアプリケーションサーバーで動作するすべてのライブラリをサポートします。

  :::

### データベースドライバー

  | カテゴリー | データベース         | ドライバー | サポートバージョン   |
  | ---------- | -------------------- | ---------- | -------------------- |
