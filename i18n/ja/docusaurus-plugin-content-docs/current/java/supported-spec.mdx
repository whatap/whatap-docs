...
Web Application Server(WAS)だけでなく、デーモンやバッチ アプリケーションなど、JVMで動作するすべてのアプリケーションに適用できます。Java 1.6未満は、support@whatap.ioに問い合わせまたは[次の文書](add-jvm-opt/java-under-ver)をご参照ください。
