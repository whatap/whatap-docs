...
<Cmdname sid="AA005" className="uitext" />ウィジェット、<Cmdname sid="TTL06209" className="uitext" />ウィンドウから確認できる<Cmdname sid="TTL06087" className="uitext" />は、大体<span class="slow">WARNING</span>レベルに該当します。
...
エージェント設定は、_whatap.conf_ファイルを編集するか<Cmdname sid="management" className="uitext" /> > <Cmdname sid="agent_configuration" className="uitext" />メニューで確認できます。詳しい内容は、[次の文書](../java/set-agent)を参考にしてください。
