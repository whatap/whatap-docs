...
[WhaTapモニタリングサービス](https://service.whatap.io/)にログインし、プロジェクトを選択してください。**_アプリケーション_** > **_インスタンス性能分析_**メニューを選択し、**_実行環境変数_**タブを選択してください。**_whatap.name_**と**_whatap.type_**項目を確認してください。***whatap.name***項目の最後の要素は、コンテナ名にしてください。**_whatap.type_**項目には、アプリケーションサーバーの種類を明示してください。
