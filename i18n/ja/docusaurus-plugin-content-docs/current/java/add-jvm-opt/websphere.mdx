...
3. **_Servers_** > **_Server Types_** > **_Websphere application servers_**項目に移動し、エージェントをインストールするサーバーを選択します。

   ![WebSpherer application servers](https://img.whatap.io/media/agent_java/install/300.png)

4. 選択したサーバー画面から**_Configuration_**タブを選択し、**_Server Infrastructure_**セクションの**_Java and Process Management_** > **_Process definition_**メニューを選択します。

   ![WebSphere Configuration](https://img.whatap.io/media/agent_java/install/310.png)

5. 右側のメニューから**_Additional Properties_** > **_Java Virtual Machine_**メニューを選択します。

6. **_Configuration_**タブから**_Generic JVM arguments_**テキストボックスに`-javaagent`と`-Dwhatap.port`を追加します。
