...
| spring-boot               | spring-boot-2.5以降       | `weaving=spring-boot-2.5`       |    <Link to="../release-notes/java/java-2_2_9" target="_blank">v2.2.9</Link>    | kafka-clients, r2dbc-mysql, redis(lettuce), spring-cloud-gateway, spring-webflux, tomcat9, undertow含む                     |
