...
Javaエージェントを通じて追跡しているフレームワークまたはオープンソースに対する設定方法は以下を参照してください。
...
| mule framework            | mule-3.9.5以降            | `weaving=mule-4.9.5`            |   <Link to="../release-notes/java/java-2_2_23" target="_blank">v2.2.23</Link>   | -                                                                                                                         |
...
| retrofit                  | retrofit2-2.5以降         | `weaving=retrofit-2.5`          |                                        -                                        | （配布予定）                                                                                                                    |
| ribbon                    | ribbon                  | `weaving=ribbon`                |   <Link to="../release-notes/java/java-2_2_10" target="_blank">v2.2.10</Link>   | -                                                                                                                         |
| spring-boot               | spring-boot-2.1以降       | `weaving=spring-boot-2.1`       |   <Link to="../release-notes/java/java-2_2_23" target="_blank">v2.2.23</Link>   | kafka-clients, r2dbc-mysql, spring-cloud-gateway, spring-webflux, tomcat9, undertow含む                                     |
| ^                         | spring-boot-2.5以降       | `weaving=spring-boot-2.5`       |    <Link to="../release-notes/java/java-2_2_9" target="_blank">v2.2.9</Link>    | kafka-clients, r2dbc-mysql, redis(lettuce), spring-cloud-gateway, spring-webflux, tomcat9, undertow含む                     |
| ^                         | spring-boot-2.7以降       | `weaving=spring-boot-2.7`       |    <Link to="../release-notes/java/java-2_2_9" target="_blank">v2.2.9</Link>    | jasync-r2dbc-mysql, kafka-clients, r2dbc-mysql, redis(lettuce), spring-cloud-gateway, spring-webflux, tomcat9, undertow含む |
| ^                         | spring-boot-3.0以降       | `weaving=spring-boot-3.0`       |    <Link to="../release-notes/java/java-2_2_9" target="_blank">v2.2.9</Link>    | jasync-r2dbc-mysql, kafka-clients, r2dbc-mysql, redis(lettuce), spring-cloud-gateway,spring-webflux, tomcat10, undertow含む |
