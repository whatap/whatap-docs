...
2023年7月25日にリリースされたトレース分析機能の変更をご案内します。 トレース分析機能の詳細については、[次の文書](../java/dashboard-hitmap-trace)を参照にしてください。
...
- <Cmdname sid="side_analysis" className="uitext" /> &gt; <Cmdname sid="side_multi_server_tx_trace" className="uitext" />メニューのツリービュー機能を適用しました。

- <Cmdname sid="BTN06327" className="uitext" />ボタンを追加しました。
