...
2. <Cmdname sid="side_lab" className="uitext" /> &gt; <Cmdname sid="side_dbScriptManager" className="uitext" />の<Cmdname sid="TTL08478" className="uitext" />セクションでSQLスクリプトを実行するエージェントを選択します。
