...
Amazon ECS起動タイプ(Launch Type)の詳しい説明は[次の文書](https://docs.aws.amazon.com/AmazonECS/latest/developerguide/launch_types.html)をご参照ください。
...
- モニタリングサービスを開始できる状態
  ...
  <ImgLang img='amazon-ecs-monitoring-on.png' desc='モニタリングの活性化' />

- モニタリングサービスを開始できない状態

  <ImgLang img='amazon-ecs-monitoring-off.png' desc='モニタリングの活性化不可' />
