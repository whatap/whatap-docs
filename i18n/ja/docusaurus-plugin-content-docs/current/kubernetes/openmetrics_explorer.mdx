...
ホーム画面 &gt; プロジェクトを選択 &gt; <Cmdname sid="side_analysis" className="uitext" /> &gt; <Cmdname sid="openmetrics_explorer" className="uitext" /> <code class="Beta">ベータ</code>

<Cmdname sid="openmetrics_explorer" className="uitext" />は、PrometheusベースのカスタムメトリックをPromQLで直接探索し、さまざまな形式で視覚化してメトリックの状態を確認したり、インサイトを得ることができる機能です。
...
<Cmdname sid="openmetrics_explorer" className="uitext" />でPromQLを実行し、さまざまな可視化オプションで結果を確認できます。
