...
- `license`および`whatap.server.host`オプションの場合、**コンテナ環境変数**設定を活用します。 
...
1. インストールファイル(*whatap.agent.java.tar.gz*)をダウンロードするには、**_ダウンロード_**ボタンを選択してください。
