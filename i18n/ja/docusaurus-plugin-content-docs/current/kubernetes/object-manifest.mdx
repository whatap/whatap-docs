...
**_オブジェクトマニフェスト詳細_**ウィンドウで<code class='pay'>Warning ![アイコン](/img/ic-popup-wh.svg)</code>ボタンをクリックすると、次のようにKubernetesイベントを確認できます。 

<ImgLang img='k8s-object-manifest-event.png' desc='クバネティスイベント連携' />
