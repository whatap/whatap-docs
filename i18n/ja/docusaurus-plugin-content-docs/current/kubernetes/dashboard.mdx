...
ホーム画面 > プロジェクト選択 > ***アプリケーション*** > <Cmdname sid="dashboard" className="uitext" />> <Cmdname sid="serviceDashboard" className="uitext" /> 
...
- ***ダッシュボード***メニューまたは***アプリケーション***メニュー下位の***ダッシュボード***メニューからアクセスできます。
...
エージェントを1つ以上選択した状態で再度すべてのエージェントを選択するには、選択を解除するか、***Total***を選択します。
