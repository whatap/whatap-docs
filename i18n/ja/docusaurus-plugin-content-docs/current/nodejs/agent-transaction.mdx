...
- **hook_method_patterns** <span class='type'>String</span>
  ...
  - このオプションで登録したメソッドは、<Cmdname sid="side_hitmap" className="uitext" />、<Cmdname sid="TTL06209" className="uitext" />または<Cmdname sid="TTL06527" className="uitext" />画面でMethodステップで確認できます。

  - なるべく局所範囲に適用することをお勧めします。幅広い範囲で適用すると、アプリケーションの性能が低下する可能性があります。
