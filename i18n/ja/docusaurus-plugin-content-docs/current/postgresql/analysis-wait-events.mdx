...
- **_Active Session_**セクションの一覧で**_query_**カラム項目を選択すると、<Cmdname sid="TTL06224" className="uitext" /> 画面が表示されます。 <Cmdname sid="TTL06224" className="uitext" />ウィンドウの詳細については[次の文書](multi-instance-monitoring#query-details)を参照してください。
