...
| <Cmdname sid="dashboard" className="uitext" /> &gt; <Cmdname sid="slow_query" className="uitext" />             | **DBパラメータ**：<br/>`log_min_duration_statement=500`<br/>(ex. 500ms以上かかるSQL記録)<br/><br/>**DB権限**<br/>`grant PG_READ_ALL_SETTINGS to whatap;` | _xos.conf_<br/>`slow_query_interval=30` (既定値30秒)<br/><br/>*whatap.conf*<br/>`slow_query_log=ON` | -                                                                                                                                                                                                                           |
