...
| ^                       | ^     | コンテナ全体ブロックデバイスの1秒当たり読み込んだ件数の合計                                                                                                        |
...
| ^                       | ^     | コンテナ全体ブロックデバイスの1秒当たり書き込んだ件数の合計                                                                                                        |
...
| namespaceHash  | ファドが所属するネームスペースハッシュ値               | -     |
...
| metric_pod_cpu_avg    | ミリコア     | HPA CPU使用量                         | -  |
| metric_pod_memory_avg | バイト      | HPA Memory使用量                      | -  |
| resource_cpu          | パーセント    | HPA CPU平均使用率                       | -  |
| resource_memory       | パーセント    | HPA Memory平均使用率                    | -  |
