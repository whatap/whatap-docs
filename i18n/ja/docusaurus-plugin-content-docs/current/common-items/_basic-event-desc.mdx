...
モニタリング対象プラットフォームに基づいて提供する基本イベントテンプレートの追加、修正、共有方法を案内します。 <Cmdname sid="side_eventSetting" className="uitext" /> <code class="newfunc">New</code>メニューで<Cmdname sid="default" className="uitext" />タブを選択します。
