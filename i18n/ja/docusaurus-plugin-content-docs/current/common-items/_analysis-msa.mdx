...
- <Cmdname sid="time_selector" className="uitext" />で照会できる時間範囲は、最大1日(24時間)となります。 <Cmdname sid="time_selector" className="uitext" />オプションの利用方法の詳細については、[次の文書](usage-ui#timeselector)を参照してください。
