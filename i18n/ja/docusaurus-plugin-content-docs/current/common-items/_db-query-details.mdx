...
<InDoc product="db2"><ImgLang img="db-sql-details-db2.png" desc="SQL詳細" /></InDoc>

<Xclude product="postgresql,mysql,oracle-pro,oracle,mssql,db2"><ImgLang img="db-sql-details-common.png" desc="SQL詳細" /></Xclude>
