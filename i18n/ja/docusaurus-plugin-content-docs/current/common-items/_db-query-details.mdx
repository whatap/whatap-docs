...
現在実行中のセッションのSQLクエリ情報を確認するには、<Cmdname sid="active_sessions" className="uitext" />セクションの**_query_**(または**_sql_text_**) カラム項目を選択します。 <Cmdname sid="TTL06224" className="uitext" />画面が表示されます。 SQLクエリ文とPlan情報を確認することができます。
