...
SQLステップで確認したバインド変数の値をコピーして<Cmdname sid="TTL07860" className="uitext" />ウィンドウ<UI>SQL Text</UI>タブで貼り付けることができます。 <Cmdname sid="TTL06209" className="uitext" />ウィンドウでSQLステップを確認してください。
...
3. <Cmdname sid="BTN08518" className="uitext" />ボタンを選択してください。
