...
次は`db_oracle_counter`カテゴリに収集されるタグ値のガイダンスです。
...
次は`db_oracle_counter`カテゴリに収集されるフィールド値の案内です。
...
次は`db_oracle_dma_counter`カテゴリに収集されるタグ値の案内です。
...
次は`db_oracle_dma_counter`カテゴリに収集されるフィールド値の案内です。
...
| `parse_count_(hard)`                                         | 構文解析呼び出しの合計数(実際の構文解析)となります。                                                          | Performance    |
| `parse_count_(total)`                                        | 構文解析呼び出しの合計数(hard, soft, describe)となります。                                             | Performance    |
