...
ホーム画面 &gt; プロジェクトの選択 &gt; <Cmdname sid="side_event" className="uitext" /> &gt; <Cmdname sid="side_eventSetting" className="uitext" /> &gt; <Cmdname sid="server" className="uitext" />タブを選択して、***+*** <Cmdname sid="add_alert_setting" className="uitext" />ボタンを選択します。

<ImgLang img='server-adf-tcp-port.png' desc='TCPポート'/>

- ![number-s](/img/number-01.png)<Cmdname sid="port" className="uitext" />指標のトグルボタンをクリックして、***使用***状態に変更します。
