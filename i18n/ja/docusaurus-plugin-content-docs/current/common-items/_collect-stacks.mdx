...
-   **profile_step_max_count**<br/>
      デフォルト値「1024」<br/>
      最大で収集可能なステップ数です。

-   **profile_step_normal_count**<br/>
      デフォルト値「800」<br />
      通常、何の制約もなく収集されるステップの数です。

-   **profile_step_heavy_count**<br/>
      デフォルト値「1000」<br/>
      normal countを超過した場合、ステップは応答時間が遅いステップとアクティブスタックステップのみを収集します。

-   **profile_step_heavy_time**<br/>
      デフォルト値「100」<br/>
      heavy count以内で収集されるステップの基準時間は、「profile_step_heavy_time」です。
...
バッファサイズは「profile_step_max_count」に設定します。
