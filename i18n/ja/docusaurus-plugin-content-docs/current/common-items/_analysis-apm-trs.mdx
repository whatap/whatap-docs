...
<Cmdname sid="TTL06975" className="uitext" />は、エージェント設定(*whatap.conf*)で<code>trace_malloc_enabled=true</code>オプションを設定しないと収集できません。デフォルト値は<code>false</code>です。

</Xclude>

<InDoc product="php">

<Cmdname sid="TTL06975" className="uitext" />は、エージェント設定(*whatap.ini*)で<code>trace_malloc_enabled=true</code>オプションを設定しないと収集できません。デフォルト値は<code>false</code>です。
