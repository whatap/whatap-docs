...
1. GROKパターンパーサを適用するには、<Cmdname sid="side_logSetting" className="uitext" />メニューの<Cmdname sid="log_parser_setting_primary" className="uitext" />タブに移動します。
   ...
   <ImgLang img='log-1st-parser-list.png' desc='ログパーサ一覧'/>

2. **_+_** <Cmdname sid="adding" className="uitext" />を選択した後<Cmdname sid="parser" className="uitext" />入力欄で**_GROK_**パーサを選択します。

   <ImgLang img='log-1st-grok.png' desc='Grokパターンパーサ登録'/>

3. <Cmdname sid="category" className="uitext" />および<Cmdname sid="ITM06439" className="uitext" />、<Cmdname sid="pattern" className="uitext" />を入力します。 <Cmdname sid="parser" className="uitext" /> <Cmdname sid="add" className="uitext" />画面の構成内容は、次の通りです。

   - <Cmdname sid="category" className="uitext" />

     ログカテゴリを選択してください。 <Cmdname sid="category" className="uitext" />は必須入力項目です。
...
4. <Cmdname sid="add" className="uitext" />ボタンを選択してパーサを登録します。
...
- パーサを登録する前に<Cmdname sid="simulation" className="uitext" />を通じて登録するパターンが正常であるか確認できます。 
...
<Cmdname sid="parser" className="uitext" /> <Cmdname sid="simulation" className="uitext" />画面で<Cmdname sid="log" className="uitext" />と<Cmdname sid="pattern" className="uitext" />を入力するとパーシング結果を確認できます。
...
1. <Cmdname sid="parser" className="uitext" /> <Cmdname sid="add" className="uitext" />画面で<Cmdname sid="simulation" className="uitext" />ボタンを選択します。

2. <Cmdname sid="parser" className="uitext" /> <Cmdname sid="simulation" className="uitext" />画面から<Cmdname sid="log" className="uitext" />と<Cmdname sid="pattern" className="uitext" />を入力します。

3. <Cmdname sid="log" className="uitext" />と<Cmdname sid="pattern" className="uitext" />入力後<Cmdname sid="simulation" className="uitext" />ボタンを選択します。 次のように<Cmdname sid="simulation_result" className="uitext" />を確認できます。

   <ImgLang img='log-grok-parser-simulation.png' desc='GROKパーサシミュレーション'/>
...
2. **_+_** <Cmdname sid="adding" className="uitext" />を選択した後<Cmdname sid="parser" className="uitext" />入力欄で**_JSON_**パーサを選択します。
   ...
   <ImgLang img='log-1st-json.png' desc='JSONパーサパターンの登録'/>
...
上記のようなサンプルログが収集された場合<Cmdname sid="parser" className="uitext" /> <Cmdname sid="add" className="uitext" />画面で**_JSON_**パーサを選択します。 複雑なパーシングロジックを作成する必要なく、ログ分析に必要な<Cmdname sid="tag" className="uitext" />を次のように抽出できます。
