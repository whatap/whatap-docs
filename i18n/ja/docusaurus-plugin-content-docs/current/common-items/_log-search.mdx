...
<ImgLang img='log-search.png' desc='ログ検索' />
...
-   **検索**
    ...
    **_検索_**オプションを選択すると**_フィルター_**に該当タグが次のように含まれる('+')条件として入力されます。

    <ImgLang img='log-search-tag-se.png' desc='ログタグ検索'/>

-   **除外検索**

    **_除外検索_**オプションを選択すると**_フィルター_**に該当タグが次のように除外される('-')条件として入力されます。

    <ImgLang img='log-search-tag-ese.png' desc='ログタグ除外検索'/>

-   **隣接ログ**

    **_隣接ログ_**オプションを選択すると**_隣接ログ_**詳細ウィンドウが表示されます。選択したログのサーバーを対象に、選択したログと隣接する時間帯のログを照会します。**_時間選択_**ボタンをクリックして、隣接する時間帯のログを照会できます。 基準のログは青地で表示されます。
