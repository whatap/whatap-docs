...
- テーブル一覧で***query_text***項目を選択すると<Cmdname sid="TTL06224" className="uitext" />画面が表示されます。 <Cmdname sid="TTL06224" className="uitext" />ウィンドウの詳細については[次の文書](usage-ui#query-details)を参照してください。
...
5. 選択した条件をSQLリストに反映するには、![検索アイコン](/img/ico-btn-search.png)ボタンを選択してください。
