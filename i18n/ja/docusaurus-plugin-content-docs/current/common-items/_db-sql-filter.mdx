...
1. <Cmdname sid="filter" className="uitext" />オプションで<LinkImage img="ico-add.svg" className="ico" />ボタンを選択します。
   ...
   <InDoc pages="stat,top-sql"><ImgLang img='db-sql-filter-adding.png' desc='条件を追加する' /></InDoc>
...
<InDoc pages="stat,top-sql"><ImgLang img='db-sql-filter-modify.png' desc='フィルターの修正' /></InDoc>
