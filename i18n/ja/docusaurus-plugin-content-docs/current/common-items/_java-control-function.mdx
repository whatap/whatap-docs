...
- **stat_ip_enabled** <span class='type'>Boolean</span>
  ...
  [WhaTapモニタリングサービス](https://service.whatap.io)の***プロジェクトメニュー***で、***統計/レポート*** > ***統計*** > ***クライアントIP***項目のIP統計の使用を有効にします。

- **realtime_user_enabled** <span class='type'>Boolean</span>

  既定値 `true`

  [WhaTapモニタリングサービス](https://service.whatap.io)の***ダッシュボード*** > ***アプリケーションダッシュボード***メニューで確認できる指標のうち、***同時接続ユーザー***指標を収集するかどうかを設定します。
...
- **trace_component_enabled** <span class='type'>Boolean</span>
  ...
  [WhaTapモニタリングサービス](https://service.whatap.io)の***プロジェクトメニュー***で***アプリケーション*** > ***インスタンスパフォーマンス分析***メニューで***ライブラリバージョン***機能をアクティブにします。
