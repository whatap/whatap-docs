...
- **_Default_**：XOS指標とAWS RDS CloudWatch指標、主要DB指標で構成されたプリセットです。

- **_Default(xos)_**：XOS指標と主要DB指標で構成されたプリセットです。 

- **_Default(rds)_**：AWS RDS CloudWatch指標と主要DB指標で構成されたプリセットです。
