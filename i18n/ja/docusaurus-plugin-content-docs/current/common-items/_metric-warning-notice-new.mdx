...
<Cmdname sid="select_category" className="uitext" />、<Cmdname sid="TTL07365" className="uitext" />、<Cmdname sid="TTL07363" /> 項目でメトリクス検索機でメトリクスを検索し、メトリクス情報を確認します。 選択したメトリクスが画面に適用されます。
