...
<Cmdname sid="side_agentsConfiguration" className="uitext" /> &gt; <Cmdname sid="side_threadList" className="uitext" />メニューのスレッドリストで**WhaTap-ActiveStackDump**スレッドの<Cmdname sid="cpu_time" className="uitext" />を確認することでオーバーヘッドを判断できます。
