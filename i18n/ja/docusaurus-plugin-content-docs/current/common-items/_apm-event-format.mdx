...
アプリケーションの通知は、Event Title、Event Messageの両方を提供します。<Cmdname sid="resolved_event_notification" className="uitext" />機能を使用すると、イベント発生条件が解除されるとEvnet Off Messageが送信されます。
