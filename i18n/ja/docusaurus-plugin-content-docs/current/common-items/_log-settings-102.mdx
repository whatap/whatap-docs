...
ログパーサに関する詳細は[こちらの文書](log-parser)をご覧ください。
...
- 右上の**+**<Cmdname sid="adding" className="uitext" />ボタンをクリックすると、<Cmdname sid="parser" className="uitext" /> <Cmdname sid="add" className="uitext" />画面が表示されます。
