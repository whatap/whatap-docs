...
<Xclude product='redis,mongodb,oracle,oracle-v1,altibase,db2'>
...
<Xclude product='cubrid,redis,mongodb,altibase,mssql,db2'>
...
<Xclude product='cubrid,redis,mongodb,db2'>
...
<InDoc product="postgresql,mysql,oracle,oracle-pro,altibase,db2">
