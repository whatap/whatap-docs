...
WhaTapインフラエージェントは、特定のRedisアドレスに接続し、接続数を含む複数の性能指数を収集します。収集された性能情報は、**_カテゴリ_**`server_redis`で確認できます。次のコマンドでチェックするRedisサーバーの接続情報を追加できます。
...
WhaTapインフラエージェントは、特定のMemcachedアドレスに接続し、接続数を含む複数の性能指数を収集します。収集された情報は、**_カテゴリ_**`server_memcached`で確認できます。次のコマンドでチェックするMemcachedサーバーの接続情報を追加できます。
