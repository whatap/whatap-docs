...
- <Cmdname sid="enable_events" className="uitext" />：トグルボタンをクリックして、アラート通知を有効にするかどうかを選択できます。
...
- <Cmdname sid="event_tag" className="uitext" />：イベント受信タグを選択すると、該当タグを持つプロジェクトメンバーと3rd-partyプラグインに通知を送信できます。 イベント受信タグを選択しない場合は、プロジェクトの全体メンバーに警告通知を送信します。
  ...
  タグを追加しない場合は、全体メンバーに警告通知を送信します。 **_+_** <Cmdname sid="add_tag" className="uitext" />をクリックし、<Cmdname sid="event_tag_list" className="uitext" />で警告通知の受信対象を選択してください。 **_+_** <Cmdname sid="create_new_eventtag" className="uitext" />を選択してタグを追加できます。
...
- <Cmdname sid="data_time_range" className="uitext" />：選択した時間の間に収集されたログを表示します。 データの表示時間を5分に選択すると、直近5分間に収集されたデータを表示してイベントが発生する条件を確認できます。
...
4. <Cmdname sid="event_setting" className="uitext" />ウィンドウが表示されたら、オプションを変更して、<Cmdname sid="save" className="uitext" />ボタンを選択します。

選択したログイベントを削除するには、イベント設定ウィンドウの右上の<Cmdname sid="delete" className="uitext" />ボタンをクリックします。
...
3. ログイベント一覧上の**_JSON_**![書き出しアイコン](/img/ico-export.svg)ボタンをクリックしてください。 <Cmdname sid="export_json" className="uitext" />画面が表示されます。
...
8. <Cmdname sid="import_json" className="uitext" />ウィンドウが表示されたら、内容を修正して、***+*** <Cmdname sid="add_to_list" className="uitext" />ボタンを選択します。

:::note 

**イベントIDが存在します。 IDを削除した後、もう一度やり直してください。**

- メッセージが表示されると、<Cmdname sid="import_json" className="uitext" />ウィンドウで `id`項目を削除し、**_+_** <Cmdname sid="add_to_list" className="uitext" />ボタンをクリックします。
