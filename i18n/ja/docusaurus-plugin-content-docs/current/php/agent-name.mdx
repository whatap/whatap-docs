...
-   **whatap.object_name**<span class='type'>String</span><br/>
      ...
      アプリケーションを識別するエージェント名（ONAME）体系です。 ONAMEに基づいてOIDが生成されます。<br/>
    {@include: ../common-items/_php-restart-whatap-service.mdx}

-   **whatap.app_name**<span class='type'>String</span><br/>
        アプリケーションを識別するエージェント名（ONAME）体系に使用されるアプリケーション名で、「object_name」の「{type}」に該当する値です。<br/>
    {@include: ../common-items/_php-restart-whatap-service.mdx}

-   **whatap.app_process_name**<span class='type'>String</span><br/>
        アプリケーションを識別するエージェント名（ONAME）システムに使用されるアプリケーションプロセス名で、アプリケーションサーバのCPU、Heap Memoryなどを収集する対象プロセスを設定します。 「object_name」の「{process}」に該当する値です。<br/>
    {@include: ../common-items/_php-restart-whatap-service.mdx}
