...
- <Status>Fixed</Status>エージェント起動時のエラー防止のために<code>hook_db_native_enabled</code>オプションの既定値を<code>false</code>に修正
...
- <Status>Fixed</Status>r2dbc呼び出し時に一部パラメータが収集されない現象の修正
