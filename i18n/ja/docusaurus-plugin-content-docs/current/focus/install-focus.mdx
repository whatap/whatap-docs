...
id: install-focus
title: インストール
description: WhaTap Focusをインストールする方法を提供します。
tags:
  - Focus
  - インストール
---

WhaTap Focusは、単一実行ファイルで構成され、別途のインストールプロセスや登録プロセスが不要です。実行ファイルをダウンロードして任意の場所で実行できます。

<!-- 구성 수정 필요 -->

## 実行ファイルダウンロード

WhaTap Focusは、単一実行ファイルで構成され、バージョン別にダウンロードしてすぐに使用できます。
