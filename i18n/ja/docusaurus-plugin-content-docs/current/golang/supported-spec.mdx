...
id: supported-spec
title: サポート環境
description: WhaTapモニタリングサービスが動作するGolangアプリケーションサーバーの基本スペックを調べてください。
tags:
  - Golang
---
...
フレームワークまたはライブラリの適用方法および例は、[GitHubサイト](https://github.com/whatap/go-api-example)を参考にしてください。
