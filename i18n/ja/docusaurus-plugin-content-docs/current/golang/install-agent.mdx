...
<FiletreeItem name="whatap-agent" type="file">エージェントおよび、トレーサーからUDPで送信された情報を収集サーバーに送信するプログラムです。</FiletreeItem>
...
<FiletreeItem name="whatap-boot-yyyymmdd.log" type="file">エージェントログファイルです。(パス：*/usr/whata/agent/log*)</FiletreeItem>
