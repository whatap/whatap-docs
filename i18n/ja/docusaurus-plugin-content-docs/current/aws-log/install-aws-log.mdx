...
1.  Logical IDがWhaTapAWSLOGとして指定されたリソースの![number 2](/img/number-02.png)**_Pyhsical ID_**を選択し、**WhaTap Forwarder**の詳細画面に移動してください。
2.  詳細画面右側の**_Description_**領域で![number 3](/img/number-03.png)**_Function ARN_**(**WhaTap Forwarder ARN**)を確認することができます。
