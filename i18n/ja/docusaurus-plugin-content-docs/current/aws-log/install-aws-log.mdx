...
1.  次のステップのため、**_IAM Role ARN_**をコピーしてください。 
...
WhaTap**_エージェントのインストール_** > **_インストール案内_**セクションの**_AWS Resource Logの照会およびサブスクリプション_**タブで上段の**_AWS Cloud Watch Log Group_**を選択して進めてください。 
...
WhaTap**_エージェントインストール_** > **_インストール案内_**セクションの**_AWS Resource Log照会およびサブスクリプション_**タブで上段の**_AWS3 Bucket_**を選択して進めてください。 
