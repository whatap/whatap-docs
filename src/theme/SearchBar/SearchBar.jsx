...
export default function SearchBar({ handleSearchBarToggle, }) {
    ...
    return (<div className={clsx("navbar__search", styles.searchBarContainer, {
      ...
      <input placeholder={translate({
        ...
        })} aria-label="Search" className="navbar__search-input" onMouseEnter={onInputMouseEnter} onFocus={onInputFocus} onBlur={onInputBlur} onChange={onInputChange} onKeyDown={onInputKeyPress} ref={searchBarRef} value={inputValue}/>
