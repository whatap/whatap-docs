...
import { SvpdfList } from './pdfList.js';
        ...
        <>
            ...
            <div>
                <input
                    ...
                    checked={selectedFiles.length === SvpdfList.length}
                />
                <label htmlFor='select-all'>Select All</label>
            </div>
            <div className={styles.dlList}>
                {SvpdfList.map((pdf, index) => (
                    ...
                    />
                    <label htmlFor={`service-${index}`}>{pdf.name}</label>
                    </div>
                ))}
            </div>
