        ...
        features.forEach(feature => {
            if (feature.line) {
                ...
                feature.details.forEach(detail => {
                    documentContent += `- <code class='changelog-overview'>${feature.feature}</code> ${detail}<code class='changelog-service'>${feature.version}</code><code class='changelog-date'>${feature.date}</code>\n\n`;
                });
            }
        });
