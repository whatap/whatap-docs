...
const config = {
  title: "WhaTap Docs",
  tagline:
    "와탭 기술 문서 :: WhaTap, 와탭 기술 문서 페이지에 오신 것을 진심으로 환영합니다.",
  ...
  headTags: [
    ...
    },
    {
      ...
      attributes: {
        name: "description",
        Content:
          "WhaTap Docs 페이지입니다. 애플리케이션, 서버, 쿠버네티스, 데이터베이스, 브라우저 등 다양한 모니터링 솔루션의 사용법을 제공합니다.",
      },
    },
    {
      tagName: "meta",
  ...
  themeConfig:
    ...
    ({
      ...
      announcementBar: {
        id: "announce-banner",
        content:
          '<div id="announce-banner"> <a class="left" href="https://event.whatap.io/ko/summit_/index.html#" target="_blank"> WhaTap Observe Summit 2025 등록 오픈 🚀 </a> <a class="right" href="https://event.whatap.io/ko/summit_/index.html#" target="_blank"> 11월 21일(금) 09:00, 삼성동 COEX ↗ </a> </div>',
