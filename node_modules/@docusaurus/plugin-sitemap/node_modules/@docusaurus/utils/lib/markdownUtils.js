...
exports.writeMarkdownHeadingId = exports.parseMarkdownString = exports.parseMarkdownContentTitle = exports.parseFrontMatter = exports.createExcerpt = exports.admonitionTitleToDirectiveLabel = exports.unwrapMdxCodeBlocks = exports.escapeMarkdownHeadingIds = exports.parseMarkdownHeadingId = void 0;
...
function admonitionTitleToDirectiveLabel(content, admonitionContainerDirectives) {
    ...
    const regexp = new RegExp(`^(?<directive>:{3,}${directiveNameGroup}) +(?<title>.*)$`, 'gm');
