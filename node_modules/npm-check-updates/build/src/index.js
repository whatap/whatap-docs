...
async function run(runOptions = {}, { cli } = {}) {
    ...
    async function runUpgrades() {
        ...
        // --workspace
        if ((_a = options.workspace) === null || _a === void 0 ? void 0 : _a.length) {
            ...
            const workspaces = (typeof pkgData === 'string' ? JSON.parse(pkgData) : pkgData)
                .workspaces;
            if (!workspaces) {
                (0, programError_1.default)(options, chalk_1.default.red(`workspaces property missing from package.json. --workspace only works when you specify a "workspaces" property in your package.json.`));
            }
            const workspacePackageGlob = []
                .concat(workspaces || [])
                .map(workspace => path_1.default.join(workspace, defaultPackageFilename).replace(/\\/g, '/'));
            pkgs = [
        ...
        // --workspaces and --root
            ...
            const workspaces = (typeof pkgData === 'string' ? JSON.parse(pkgData) : pkgData)
                .workspaces;
            if (!workspaces) {
                (0, programError_1.default)(options, chalk_1.default.red(`workspaces property missing from package.json. --workspaces only works when you specify a "workspaces" property in your package.json.`));
            }
            const workspacePackageGlob = []
                .concat(workspaces || [])
                .map(workspace => path_1.default.join(workspace, defaultPackageFilename).replace(/\\/g, '/'));
        ...
        const isWorkspace = options.workspaces || !!((_b = options.workspace) === null || _b === void 0 ? void 0 : _b.length);
