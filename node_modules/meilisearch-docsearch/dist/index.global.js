...
var __docsearch_meilisearch__ = (() => {
  ...
  var require_browser_polyfill = __commonJS({
    "node_modules/.pnpm/cross-fetch@3.1.8/node_modules/cross-fetch/dist/browser-polyfill.js"(exports) {
      "use strict";
      (function(self2) {
  ...
  var require_meilisearch_umd = __commonJS({
    "node_modules/.pnpm/meilisearch@0.35.0/node_modules/meilisearch/dist/bundles/meilisearch.umd.js"(exports, module) {
      "use strict";
      (function(global, factory) {
        ...
        var MeiliSearchCommunicationError = /* @__PURE__ */ function(_Error) {
          ...
          function MeiliSearchCommunicationError2(message, body, url, stack) {
            ...
            Object.setPrototypeOf(_assertThisInitialized(_this), MeiliSearchCommunicationError2.prototype);
            ...
            if (stack) {
              ...
              if (Error.captureStackTrace) {
                Error.captureStackTrace(_assertThisInitialized(_this), MeiliSearchCommunicationError2);
              }
            }
            return _this;
          }
        ...
        var MeiliSearchApiError = /* @__PURE__ */ function(_Error) {
          ...
          function MeiliSearchApiError2(error, status) {
            ...
            Object.setPrototypeOf(_assertThisInitialized(_this), MeiliSearchApiError2.prototype);
            ...
            if (Error.captureStackTrace) {
              Error.captureStackTrace(_assertThisInitialized(_this), MeiliSearchApiError2);
            }
            return _this;
          }
        ...
        var MeiliSearchError = /* @__PURE__ */ function(_Error) {
          ...
          function MeiliSearchError2(message) {
            ...
            _this = _super.call(this, message);
            Object.setPrototypeOf(_assertThisInitialized(_this), MeiliSearchError2.prototype);
            _this.name = "MeiliSearchError";
            if (Error.captureStackTrace) {
              Error.captureStackTrace(_assertThisInitialized(_this), MeiliSearchError2);
            }
            return _this;
          }
        ...
        var MeiliSearchTimeOutError = /* @__PURE__ */ function(_Error) {
          ...
          function MeiliSearchTimeOutError2(message) {
            ...
            _this = _super.call(this, message);
            Object.setPrototypeOf(_assertThisInitialized(_this), MeiliSearchTimeOutError2.prototype);
            _this.name = "MeiliSearchTimeOutError";
            if (Error.captureStackTrace) {
              Error.captureStackTrace(_assertThisInitialized(_this), MeiliSearchTimeOutError2);
            }
            return _this;
          }
        ...
        function removeUndefinedFromObject(obj) {
          return Object.entries(obj).reduce(function(acc, curEntry) {
            var _curEntry = _slicedToArray(curEntry, 2), key = _curEntry[0], val = _curEntry[1];
            if (val !== void 0)
              acc[key] = val;
            return acc;
          }, {});
        ...
        var EnqueuedTask = /* @__PURE__ */ _createClass(function EnqueuedTask2(task) {
        ...
        var TaskClient = /* @__PURE__ */ function() {
          ...
          _createClass(TaskClient2, [{
            ...
            value: function waitForTasks(taskUids) {
              var _ref2 = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {}, _ref2$timeOutMs = _ref2.timeOutMs, timeOutMs = _ref2$timeOutMs === void 0 ? 5e3 : _ref2$timeOutMs, _ref2$intervalMs = _ref2.intervalMs, intervalMs = _ref2$intervalMs === void 0 ? 50 : _ref2$intervalMs;
              return __awaiter(this, void 0, void 0, /* @__PURE__ */ _regeneratorRuntime().mark(function _callee4() {
                    ...
                    switch (_context3.prev = _context3.next) {
                      ...
                      case 2:
                        ...
                        indexes = rawIndexes.results.map(function(index) {
                          return new Index2(_this.config, index.uid, index.primaryKey);
                        });
  ...
  var _tmpl$ = /* @__PURE__ */ template(`<svg xmlns=http://www.w3.org/2000/svg width=24 height=24 viewBox="0 0 24 24"><path fill=currentColor d="M21.71 20.29L18 16.61A9 9 0 1 0 16.61 18l3.68 3.68a1 1 0 0 0 1.42 0a1 1 0 0 0 0-1.39ZM11 18a7 7 0 1 1 7-7a7 7 0 0 1-7 7Z">`);
  ...
  var _tmpl$2 = /* @__PURE__ */ template(`<button type=button class=docsearch-btn><span class=docsearch-btn-icon-container></span><span class=docsearch-btn-placeholder> <!> `);
  ...
  var DocSearchButton = ({
    ...
    return (() => {
      ...
      insert(_el$2, createComponent(MagnifierIcon, {
  ...
  // src/icons/Down.tsx
  var _tmpl$4 = /* @__PURE__ */ template(`<svg xmlns=http://www.w3.org/2000/svg width=15 height=15 viewBox="0 0 24 24"><path fill=currentColor d="M12 4a1 1 0 0 1 1 1v11.586l4.293-4.293a1 1 0 0 1 1.414 1.414l-6 6a1 1 0 0 1-1.414 0l-6-6a1 1 0 1 1 1.414-1.414L11 16.586V5a1 1 0 0 1 1-1z">`);
  var DownIcon = (props) => {
    return (() => {
      const _el$ = _tmpl$4();
  ...
  // src/icons/Enter.tsx
  var _tmpl$5 = /* @__PURE__ */ template(`<svg xmlns=http://www.w3.org/2000/svg width=15 height=15 viewBox="0 0 24 24"><g fill=currentColor fill-rule=evenodd clip-rule=evenodd><path d="M3 14a1 1 0 0 1 1-1h12a3 3 0 0 0 3-3V6a1 1 0 1 1 2 0v4a5 5 0 0 1-5 5H4a1 1 0 0 1-1-1z"></path><path d="M3.293 14.707a1 1 0 0 1 0-1.414l4-4a1 1 0 0 1 1.414 1.414L5.414 14l3.293 3.293a1 1 0 1 1-1.414 1.414l-4-4z">`);
  var EnterIcon = (props) => {
    return (() => {
      const _el$ = _tmpl$5();
      createRenderEffect((_p$) => {
  ...
  // src/icons/Up.tsx
  var _tmpl$9 = /* @__PURE__ */ template(`<svg xmlns=http://www.w3.org/2000/svg width=15 height=15 viewBox="0 0 24 24"><path fill=currentColor d="M12 4a1 1 0 0 1 .707.293l6 6a1 1 0 0 1-1.414 1.414L13 7.414V19a1 1 0 1 1-2 0V7.414l-4.293 4.293a1 1 0 0 1-1.414-1.414l6-6A1 1 0 0 1 12 4z">`);
  var UpIcon = (props) => {
    return (() => {
      const _el$ = _tmpl$9();
      createRenderEffect((_p$) => {
  ...
  var _tmpl$10 = /* @__PURE__ */ template(`<span class=docsearch-modal-footer-commands><li><kbd class=docsearch-modal-footer-commands-key></kbd><span class=docsearch-modal-footer-commands-label></span></li><li><kbd class=docsearch-modal-footer-commands-key></kbd><kbd class=docsearch-modal-footer-commands-key></kbd><span class=docsearch-modal-footer-commands-label></span></li><li><kbd class=docsearch-modal-footer-commands-key></kbd><span class=docsearch-modal-footer-commands-label>`);
  var _tmpl$23 = /* @__PURE__ */ template(`<span class=docsearch-modal-footer-logo><span class=docsearch-modal-footer-logo-label></span><a href=https://www.meilisearch.com/>`);
  var DocSearchModalFooter = ({
    ...
    return [(() => {
      ...
      insert(_el$3, createComponent(EnterIcon, {
        "aria-label": selectKeyAriaLabel
      }));
      insert(_el$4, selectText);
      insert(_el$6, createComponent(DownIcon, {
        "aria-label": navigateDownKeyAriaLabel
      }));
      insert(_el$7, createComponent(UpIcon, {
        "aria-label": navigateUpKeyAriaLabel
      }));
      insert(_el$8, navigateText);
      insert(_el$10, createComponent(EscIcon, {
      ...
      insert(_el$14, createComponent(MeilisearchLightIcon, {
        "class": "docsearch-modal-footer-logo-icon docsearch-modal-footer-logo-light"
      }), null);
      insert(_el$14, createComponent(MeilisearchDarkIcon, {
  ...
  // src/icons/Close.tsx
  var _tmpl$11 = /* @__PURE__ */ template(`<svg width=20 height=20 xmlns=http://www.w3.org/2000/svg><path d="M10 10l5.09-5.09L10 10l5.09 5.09L10 10zm0 0L4.91 4.91 10 10l-5.09 5.09L10 10z"stroke=currentColor fill=none fill-rule=evenodd stroke-linecap=round stroke-linejoin=round>`);
  var CloseIcon = (props) => {
    return (() => {
      const _el$ = _tmpl$11();
      createRenderEffect(() => setAttribute(_el$, "class", props.class));
  ...
  var _tmpl$12 = /* @__PURE__ */ template(`<svg width=24 height=24 xmlns=http://www.w3.org/2000/svg><path fill=currentColor d="M12 4V2A10 10 0 0 0 2 12h2a8 8 0 0 1 8-8Z">`);
  ...
  var _tmpl$13 = /* @__PURE__ */ template(`<form class=docsearch-modal-search-input-form><input type=search class=docsearch-modal-search-input><button type=reset class=docsearch-modal-search-input-reset>`);
  var _tmpl$24 = /* @__PURE__ */ template(`<button type=reset class=docsearch-modal-search-cancel-btn>`);
  var DocSearchModalSearchBox = ({
    ...
    return [(() => {
      ...
      typeof _ref$ === "function" ? use(_ref$, _el$2) : searchInputRef = _el$2;
  ...
  var _tmpl$14 = /* @__PURE__ */ template(`<div class=docsearch-modal-empty-query>`);
  var _tmpl$25 = /* @__PURE__ */ template(`<div class=docsearch-modal-error><p class=docsearch-modal-title>An error has occured. Please try again...`);
  var _tmpl$32 = /* @__PURE__ */ template(`<div class=docsearch-modal-no-search-hits-suggestions-list><p class=docsearch-modal-no-search-hits-help-text>Try searching for:</p><ul>`);
  var _tmpl$42 = /* @__PURE__ */ template(`<div class=docsearch-modal-no-search-hits><p class=docsearch-modal-title>No results for "<!>"`);
  var _tmpl$52 = /* @__PURE__ */ template(`<div class=docsearch-modal-container role=button tabindex=0><div class=docsearch-modal><header class=docsearch-modal-search-container></header><main class=docsearch-modal-search-hits-container></main><footer class=docsearch-modal-footer>`);
  var _tmpl$62 = /* @__PURE__ */ template(`<li><button class=docsearch-modal-no-search-hits-suggestion type=button>`);
  var _tmpl$72 = /* @__PURE__ */ template(`<section><div class=docsearch-modal-search-hits-category></div><ul role=listbox>`);
  var _tmpl$82 = /* @__PURE__ */ template(`<li role=option class=docsearch-modal-search-hits-item><a><span class=docsearch-modal-search-hits-item-text-container><p class=docsearch-modal-search-hits-item-title></p><p class=docsearch-modal-search-hits-item-text></p></span><span class=docsearch-modal-search-hits-item-trailing-icon-container aria-hidden>`);
  var _d_ = false;
  if (_d_)
    trapFocus;
  ...
  var DocSearchModal = ({
    ...
    return (() => {
      ...
      insert(_el$3, createComponent(DocSearchModalSearchBox, {
        loading,
        query,
        onInput,
        onKeyDown,
                ...
                children: (category) => (() => {
                  ...
                  insert(_el$20, createComponent(For, {
                    ...
                    children: (hit) => (() => {
                      ...
                      setAttribute(_el$22, "aria-label", linkToTheResultAriaLabel);
                      insert(_el$26, createComponent(EnterIcon, {
                      ...
                      createRenderEffect((_p$) => {
                        ...
                        _v$ !== _p$._v$ && setAttribute(_el$21, "aria-selected", _p$._v$ = _v$);
                        _v$2 !== _p$._v$2 && setAttribute(_el$21, "id", _p$._v$2 = _v$2);
                        _v$3 !== _p$._v$3 && _el$21.classList.toggle("docsearch-modal-search-hits-item--active", _p$._v$3 = _v$3);
                        _v$4 !== _p$._v$4 && setAttribute(_el$22, "href", _p$._v$4 = _v$4);
      ...
      insert(_el$15, createComponent(DocSearchModalFooter, {
        translations
      }));
      return _el$;
    })();
  ...
  var DocSearch = (props) => {
    ...
    return [createComponent(DocSearchButton, {
      get translations() {
      ...
      return () => _c$() && createComponent(Portal, {
        ...
        get children() {
          return createComponent(DocSearchModal, mergeProps(props, {
            get initialQuery() {
              return initialQuery();
            },
            onClose,
