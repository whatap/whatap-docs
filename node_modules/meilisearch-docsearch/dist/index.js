...
var DocSearchButton = ({
  ...
  return (() => {
    ...
    _$insert(_el$, (() => {
      const _c$ = _$memo(() => !!(hotKeys && hotKeys.length > 0));
      return () => _c$() && (() => {
        ...
        _$insert(_el$7, _$createComponent(For, {
          ...
          children: (k) => (() => {
            const _el$8 = _tmpl$3();
            _$insert(_el$8, (() => {
              const _c$2 = _$memo(() => !!isCtrl(k));
              return () => _c$2() ? ctrlKey() : (() => {
                const _c$3 = _$memo(() => !!isAlt(k));
...
var DownIcon = (props) => {
  return (() => {
    ...
    _$effect2((_p$) => {
      ...
      _v$ !== _p$._v$ && _$setAttribute3(_el$, "class", _p$._v$ = _v$);
      _v$2 !== _p$._v$2 && _$setAttribute3(_el$, "aria-label", _p$._v$2 = _v$2);
      return _p$;
    }, {
      _v$: void 0,
      _v$2: void 0
...
var EnterIcon = (props) => {
  return (() => {
    ...
    _$effect3((_p$) => {
      const _v$ = props.class, _v$2 = props["aria-label"];
      _v$ !== _p$._v$ && _$setAttribute4(_el$, "class", _p$._v$ = _v$);
      _v$2 !== _p$._v$2 && _$setAttribute4(_el$, "aria-label", _p$._v$2 = _v$2);
      return _p$;
    }, {
      _v$: void 0,
      _v$2: void 0
...
var EscIcon = (props) => {
  return (() => {
    ...
    _$effect4((_p$) => {
      const _v$ = props.class, _v$2 = props["aria-label"];
      _v$ !== _p$._v$ && _$setAttribute5(_el$, "class", _p$._v$ = _v$);
      _v$2 !== _p$._v$2 && _$setAttribute5(_el$, "aria-label", _p$._v$2 = _v$2);
      return _p$;
    }, {
      _v$: void 0,
      _v$2: void 0
...
var UpIcon = (props) => {
  return (() => {
    ...
    _$effect7((_p$) => {
      const _v$ = props.class, _v$2 = props["aria-label"];
      _v$ !== _p$._v$ && _$setAttribute8(_el$, "class", _p$._v$ = _v$);
      _v$2 !== _p$._v$2 && _$setAttribute8(_el$, "aria-label", _p$._v$2 = _v$2);
      return _p$;
    }, {
      _v$: void 0,
      _v$2: void 0
                ...
                _$insert4(_el$20, _$createComponent4(For2, {
                  ...
                  children: (hit) => (() => {
                    ...
                    _$effect11((_p$) => {
                      ...
                      _v$ !== _p$._v$ && _$setAttribute12(_el$21, "aria-selected", _p$._v$ = _v$);
                      _v$2 !== _p$._v$2 && _$setAttribute12(_el$21, "id", _p$._v$2 = _v$2);
                      _v$3 !== _p$._v$3 && _el$21.classList.toggle("docsearch-modal-search-hits-item--active", _p$._v$3 = _v$3);
                      _v$4 !== _p$._v$4 && _$setAttribute12(_el$22, "href", _p$._v$4 = _v$4);
...
var DocSearch = (props) => {
  ...
  return [_$createComponent5(DocSearchButton, {
    ...
    const _c$ = _$memo2(() => !!isOpen());
    return () => _c$() && _$createComponent5(Portal, {
      get mount() {
