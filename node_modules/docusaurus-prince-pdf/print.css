...
@import url('https://fonts.googleapis.com/css?family=Noto+Sans+Coptic&display=swap');
...
@media print {
  ...
  .markdown .tabs-container div.margin-top--md div[role='tabpanel'] {
    display: block;
  }
}
